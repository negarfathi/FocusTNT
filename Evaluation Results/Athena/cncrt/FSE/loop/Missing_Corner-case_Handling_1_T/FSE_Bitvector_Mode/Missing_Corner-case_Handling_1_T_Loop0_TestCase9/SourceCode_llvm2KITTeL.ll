...
define i32 @main() #0 {
main_bb6:
  %"9" = load i32* @"'count", align 4, !dbg !36
  call void @llvm.dbg.value(metadata !20, i64 0, metadata !39), !dbg !40
  call void @llvm.dbg.value(metadata !20, i64 0, metadata !39), !dbg !40
...
main_bb7:                                         ; preds = %main_read.exit, %main_bb6
  ...
  %"12" = icmp sgt i32 %"9", 100, !dbg !43
  %or.cond.i = or i1 %"11", %"12", !dbg !42
  br i1 %or.cond.i, label %main_read.exit, label %main_bb8, !dbg !42

main_bb8:                                         ; preds = %main_bb7
  store i32 1, i32* @"'flag", align 4, !dbg !44
  br label %main_read.exit, !dbg !45

main_read.exit:                                   ; preds = %main_bb7, %main_bb8
  %"13" = icmp sle i32 0, 0, !dbg !36
  br i1 %"13", label %main_bb9, label %main_bb7, !dbg !36
...
!36 = metadata !{i32 41, i32 13, metadata !37, null}
!37 = metadata !{i32 786443, metadata !1, metadata !38, i32 41, i32 13, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!38 = metadata !{i32 786443, metadata !1, metadata !9, i32 40, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!39 = metadata !{i32 786688, metadata !4, metadata !"num", metadata !5, i32 16, metadata !8, i32 0, metadata !36} ; [ DW_TAG_auto_variable ] [num] [line 16]
!40 = metadata !{i32 16, i32 9, metadata !4, metadata !36}
!41 = metadata !{i32 39, i32 5, metadata !9, null}
!42 = metadata !{i32 14, i32 9, metadata !17, metadata !36}
!43 = metadata !{i32 14, i32 9, metadata !19, metadata !36}
!44 = metadata !{i32 31, i32 13, metadata !33, metadata !36}
!45 = metadata !{i32 32, i32 13, metadata !33, metadata !36}
!46 = metadata !{i32 44, i32 5, metadata !9, null}
