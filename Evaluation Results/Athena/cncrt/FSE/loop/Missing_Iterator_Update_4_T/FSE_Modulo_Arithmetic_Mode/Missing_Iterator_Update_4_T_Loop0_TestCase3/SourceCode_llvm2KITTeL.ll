...
main_bb5:
  ...
  %"12" = icmp slt i64 -1, 0, !dbg !46
  %"13" = icmp slt i64 5, 0, !dbg !48
  %or.cond = or i1 %"12", %"13", !dbg !46
  %"14" = icmp sgt i64 -1, 65534, !dbg !50
  %or.cond5 = or i1 %or.cond, %"14", !dbg !46
  %"15" = icmp sgt i64 5, 65534, !dbg !52
...
main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb5
  %z.0 = phi i64 [ 5, %main_bb5 ], [ %.0.i3, %main_bb14 ], [ %.0.i3, %main_bb15 ], [ %.0.i3, %main_bb16 ]
  %x.0 = phi i64 [ 0, %main_bb5 ], [ %"45", %main_bb14 ], [ %"50", %main_bb16 ], [ %"40", %main_bb15 ]
  %"16" = icmp slt i64 %x.0, -1, !dbg !54
