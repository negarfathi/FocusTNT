...
read_wrap_around.exit:                            ; preds = %read_bb11, %read_bb10, %read_bb9, %read_bb7
  %num.0 = phi i64 [ 997, %read_bb7 ], [ %"22", %read_bb9 ], [ %"27", %read_bb11 ], [ %"17", %read_bb10 ]
...
main_wrap_around.exit7:                           ; preds = %main_bb39, %main_bb38, %main_bb37, %main_bb32, %main_bb31, %main_bb30, %main_bb21
  ...
  %count.0 = phi i64 [ 20, %main_bb21 ], [ %count.0, %main_bb30 ], [ %count.0, %main_bb31 ], [ %count.0, %main_bb32 ], [ %.0.i2, %main_bb37 ], [ %.0.i2, %main_bb38 ], [ %.0.i2, %main_bb39 ]
