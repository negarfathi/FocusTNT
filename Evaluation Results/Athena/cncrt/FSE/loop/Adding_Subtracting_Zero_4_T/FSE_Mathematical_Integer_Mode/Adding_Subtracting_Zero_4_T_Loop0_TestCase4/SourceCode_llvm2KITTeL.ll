...
read_bb2:                                         ; preds = %read_bb1
  %"3" = icmp eq i32 -250, 0, !dbg !28
  br i1 %"3", label %read_bb6, label %read_bb3, !dbg !28

read_bb3:                                         ; preds = %read_bb2
  %"4" = icmp slt i32 -250, 0, !dbg !31
  %"5" = sub nsw i32 0, -250, !dbg !34
  %. = select i1 %"4", i32 %"5", i32 -250, !dbg !31
...
main_bb7:
  ...
  %"10" = icmp sle i32 6, 0, !dbg !49
  br i1 %"10", label %main_bb16, label %main_bb8, !dbg !49
...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %buf.0}, i64 0, metadata !55), !dbg !58
  call void @llvm.dbg.value(metadata !{i32 %count.0}, i64 0, metadata !59), !dbg !60
  call void @llvm.dbg.value(metadata !21, i64 0, metadata !61), !dbg !62
  %"11" = load i32* @"'flag", align 4, !dbg !63
  call void @llvm.dbg.value(metadata !{i32 %.0.i}, i64 0, metadata !64), !dbg !65
  call void @llvm.dbg.value(metadata !{i32 %"19"}, i64 0, metadata !53), !dbg !54
  call void @llvm.dbg.value(metadata !{i32 %"21"}, i64 0, metadata !47), !dbg !48
  call void @llvm.dbg.value(metadata !{i32 %"22"}, i64 0, metadata !51), !dbg !52
  br label %main_bb9, !dbg !66

main_bb9:                                         ; preds = %main_bb14, %main_bb15, %main_bb8
  %tries.0 = phi i32 [ 0, %main_bb8 ], [ %tries.0, %main_bb15 ], [ %"19", %main_bb14 ]
  %buf.0 = phi i32 [ 0, %main_bb8 ], [ %"22", %main_bb15 ], [ %buf.0, %main_bb14 ]
  %count.0 = phi i32 [ 6, %main_bb8 ], [ %"21", %main_bb15 ], [ %count.0, %main_bb14 ]
  %"12" = icmp sgt i32 %count.0, 0, !dbg !67
  br i1 %"12", label %main_bb10, label %main_bb16, !dbg !67

main_bb10:                                        ; preds = %main_bb9
  %"13" = icmp eq i32 %"11", 1, !dbg !63
  br i1 %"13", label %main_read.exit, label %main_bb11, !dbg !63

main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %count.0.i = phi i32 [ %"15", %main_bb12 ], [ 0, %main_bb10 ], !dbg !56
  %.01.i = phi i32 [ %"16", %main_bb12 ], [ %buf.0, %main_bb10 ], !dbg !56
  %"14" = icmp slt i32 %.01.i, %count.0, !dbg !69
  br i1 %"14", label %main_bb12, label %main_read.exit, !dbg !69

main_bb12:                                        ; preds = %main_bb11
  %"15" = add nsw i32 %count.0.i, 1, !dbg !70
  %"16" = add nsw i32 %.01.i, 1, !dbg !71
  br label %main_bb11, !dbg !72

main_read.exit:                                   ; preds = %main_bb10, %main_bb11
  %.0.i = phi i32 [ 0, %main_bb10 ], [ %count.0.i, %main_bb11 ], !dbg !56
  %"17" = icmp sle i32 %.0.i, 0, !dbg !73
  br i1 %"17", label %main_bb13, label %main_bb15, !dbg !73

main_bb13:                                        ; preds = %main_read.exit
  %"18" = icmp eq i32 %.0.i, 0, !dbg !75
  br i1 %"18", label %main_bb14, label %main_bb16, !dbg !75

main_bb14:                                        ; preds = %main_bb13
  %"19" = add nsw i32 %tries.0, 1, !dbg !78
  %"20" = icmp slt i32 %tries.0, 5, !dbg !78
  br i1 %"20", label %main_bb9, label %main_bb16, !dbg !78

main_bb15:                                        ; preds = %main_read.exit
  %"21" = sub nsw i32 %count.0, %.0.i, !dbg !80
  %"22" = add nsw i32 %buf.0, %.0.i, !dbg !81
  br label %main_bb9, !dbg !82

main_bb16:                                        ; preds = %main_bb9, %main_bb13, %main_bb14, %main_bb7
  ret i32 0, !dbg !83
}
...
!27 = metadata !{i32 786443, metadata !1, metadata !4, i32 15, i32 5, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!51 = metadata !{i32 786688, metadata !9, metadata !"buf", metadata !5, i32 48, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [buf] [line 48]
!52 = metadata !{i32 48, i32 9, metadata !9, null}
!53 = metadata !{i32 786688, metadata !9, metadata !"tries", metadata !5, i32 49, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tries] [line 49]
!54 = metadata !{i32 49, i32 9, metadata !9, null}
!55 = metadata !{i32 786689, metadata !4, metadata !"loc", metadata !5, i32 16777226, metadata !8, i32 0, metadata !56} ; [ DW_TAG_arg_variable ] [loc] [line 10]
!56 = metadata !{i32 52, i32 15, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !9, i32 51, i32 5, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 10, i32 15, metadata !4, metadata !56}
!59 = metadata !{i32 786689, metadata !4, metadata !"len", metadata !5, i32 33554442, metadata !8, i32 0, metadata !56} ; [ DW_TAG_arg_variable ] [len] [line 10]
!60 = metadata !{i32 10, i32 25, metadata !4, metadata !56}
!61 = metadata !{i32 786688, metadata !4, metadata !"count", metadata !5, i32 12, metadata !8, i32 0, metadata !56} ; [ DW_TAG_auto_variable ] [count] [line 12]
!62 = metadata !{i32 12, i32 9, metadata !4, metadata !56}
!63 = metadata !{i32 13, i32 9, metadata !25, metadata !56}
!64 = metadata !{i32 786688, metadata !9, metadata !"ret", metadata !5, i32 47, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ret] [line 47]
!65 = metadata !{i32 47, i32 9, metadata !9, null}
!66 = metadata !{i32 50, i32 5, metadata !9, null}
!67 = metadata !{i32 50, i32 5, metadata !68, null}
!68 = metadata !{i32 786443, metadata !1, metadata !9, i32 50, i32 5, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 15, i32 5, metadata !27, metadata !56}
!70 = metadata !{i32 27, i32 13, metadata !33, metadata !56}
!71 = metadata !{i32 30, i32 17, metadata !40, metadata !56}
!72 = metadata !{i32 31, i32 17, metadata !40, metadata !56}
!73 = metadata !{i32 53, i32 13, metadata !74, null}
!74 = metadata !{i32 786443, metadata !1, metadata !57, i32 53, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!75 = metadata !{i32 55, i32 17, metadata !76, null}
!76 = metadata !{i32 786443, metadata !1, metadata !77, i32 55, i32 17, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!77 = metadata !{i32 786443, metadata !1, metadata !74, i32 54, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!78 = metadata !{i32 55, i32 17, metadata !79, null}
!79 = metadata !{i32 786443, metadata !1, metadata !76, i32 55, i32 17, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!80 = metadata !{i32 59, i32 9, metadata !57, null}
!81 = metadata !{i32 60, i32 9, metadata !57, null}
!82 = metadata !{i32 61, i32 5, metadata !57, null}
!83 = metadata !{i32 63, i32 1, metadata !9, null}
