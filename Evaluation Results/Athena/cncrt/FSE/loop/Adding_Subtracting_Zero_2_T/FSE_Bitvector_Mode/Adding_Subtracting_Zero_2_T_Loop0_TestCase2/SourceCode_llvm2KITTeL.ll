...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !33), !dbg !34
  %"6" = icmp slt i32 10, 0, !dbg !35
  %"7" = icmp slt i32 5, 0, !dbg !37
  %or.cond = or i1 %"6", %"7", !dbg !35
  br i1 %or.cond, label %main_bb9, label %main_bb6, !dbg !35

main_bb6:                                         ; preds = %main_bb5
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !39), !dbg !42
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !39), !dbg !42
  %"8" = load i32* @"'flag", align 4, !dbg !43
  call void @llvm.dbg.value(metadata !{i32 %.}, i64 0, metadata !44), !dbg !45
  call void @llvm.dbg.value(metadata !{i32 %"12"}, i64 0, metadata !31), !dbg !32
  br label %main_bb7, !dbg !46

main_bb7:                                         ; preds = %main_bb8, %main_bb6
  %b.0 = phi i32 [ 10, %main_bb6 ], [ %"12", %main_bb8 ]
  %"9" = icmp slt i32 %b.0, 5, !dbg !47
  br i1 %"9", label %main_ff_subtitles_next_line.exit, label %main_bb9, !dbg !47

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb7
  %"10" = icmp eq i32 %"8", 1, !dbg !43
  %. = select i1 %"10", i32 0, i32 5, !dbg !49
  %"11" = icmp ne i32 %., 0, !dbg !50
  br i1 %"11", label %main_bb8, label %main_bb9, !dbg !50

main_bb8:                                         ; preds = %main_ff_subtitles_next_line.exit
  %"12" = add nsw i32 %b.0, %., !dbg !52
  %"13" = sub nsw i32 5, 4, !dbg !53
  %"14" = icmp sge i32 %"12", %"13", !dbg !53
  br i1 %"14", label %main_bb9, label %main_bb7, !dbg !53
...
!39 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 13, metadata !8, i32 0, metadata !40} ; [ DW_TAG_auto_variable ] [i] [line 13]
!40 = metadata !{i32 36, i32 19, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !9, i32 35, i32 5, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 13, i32 9, metadata !4, metadata !40}
!43 = metadata !{i32 15, i32 9, metadata !20, metadata !40}
!44 = metadata !{i32 786688, metadata !41, metadata !"inc", metadata !5, i32 36, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [inc] [line 36]
!45 = metadata !{i32 36, i32 13, metadata !41, null}
!46 = metadata !{i32 34, i32 5, metadata !9, null}
!47 = metadata !{i32 34, i32 5, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 26, i32 1, metadata !4, metadata !40}
!50 = metadata !{i32 37, i32 13, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !41, i32 37, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 39, i32 9, metadata !41, null}
!53 = metadata !{i32 40, i32 13, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !41, i32 40, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 44, i32 1, metadata !9, null}
