...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  br i1 %"33", label %main_bb12, label %main_wrap_around.exit2, !dbg !74

main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb17, %main_bb16, %main_bb15, %main_bb11
  %entry.0 = phi i64 [ -1, %main_bb11 ], [ %"43", %main_bb15 ], [ %"48", %main_bb17 ], [ %"38", %main_bb16 ], [ %entry.0, %main_bb13 ]
  %"34" = icmp sge i64 %entry.0, 5, !dbg !76
  br i1 %"34", label %main_bb12, label %main_bb13, !dbg !76

main_bb12:                                        ; preds = %main_wrap_around.exit2, %main_bb11, %main_bb5
  ret i32 0, !dbg !80

main_bb13:                                        ; preds = %main_wrap_around.exit2
  %"35" = getelementptr inbounds [5 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !81
  %"36" = load i64* %"35", align 8, !dbg !81
  %"37" = icmp ne i64 %"36", 0, !dbg !81
  br i1 %"37", label %main_bb14, label %main_wrap_around.exit2, !dbg !81

main_bb14:                                        ; preds = %main_bb13
  %"38" = add nsw i64 %entry.0, 1, !dbg !83
  %"39" = icmp sgt i64 %"38", 2147483647, !dbg !85
  br i1 %"39", label %main_bb15, label %main_bb16, !dbg !85

main_bb15:                                        ; preds = %main_bb14
  %"40" = sub nsw i64 %"38", 2147483647, !dbg !86
  %"41" = sub nsw i64 %"40", 1, !dbg !86
  %"42" = srem i64 %"41", 4294967296, !dbg !86
  %"43" = add nsw i64 -2147483648, %"42", !dbg !86
  br label %main_wrap_around.exit2, !dbg !86

main_bb16:                                        ; preds = %main_bb14
  %"44" = icmp slt i64 %"38", -2147483648, !dbg !87
  br i1 %"44", label %main_bb17, label %main_wrap_around.exit2, !dbg !87

main_bb17:                                        ; preds = %main_bb16
  %"45" = sub nsw i64 -2147483648, %"38", !dbg !88
  %"46" = sub nsw i64 %"45", 1, !dbg !88
  %"47" = srem i64 %"46", 4294967296, !dbg !88
  %"48" = sub nsw i64 2147483647, %"47", !dbg !88
