...
main_bb5:
  ...
  %"7" = icmp slt i32 10, 0, !dbg !38
  %or.cond = or i1 %"6", %"7", !dbg !36
  br i1 %or.cond, label %main_bb8, label %main_bb6, !dbg !36
...
main_bb7:                                         ; preds = %main_ff_subtitles_next_line.exit, %main_bb6
  %b.0 = phi i32 [ -1, %main_bb6 ], [ %"11", %main_ff_subtitles_next_line.exit ]
  %"9" = icmp slt i32 %b.0, 10, !dbg !46
  br i1 %"9", label %main_ff_subtitles_next_line.exit, label %main_bb8, !dbg !46

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb7
  %"10" = icmp eq i32 %"8", 1, !dbg !44
  %. = select i1 %"10", i32 0, i32 5, !dbg !48
  %"11" = add nsw i32 %b.0, %., !dbg !41
  %"12" = sub nsw i32 10, 4, !dbg !49
  %"13" = icmp sge i32 %"11", %"12", !dbg !49
  br i1 %"13", label %main_bb8, label %main_bb7, !dbg !49
...
!41 = metadata !{i32 35, i32 14, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 5, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 12, i32 9, metadata !4, metadata !41}
!44 = metadata !{i32 14, i32 9, metadata !20, metadata !41}
!45 = metadata !{i32 33, i32 5, metadata !9, null}
!46 = metadata !{i32 33, i32 5, metadata !47, null}
!47 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 5, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 25, i32 1, metadata !4, metadata !41}
!49 = metadata !{i32 36, i32 13, metadata !50, null}
!50 = metadata !{i32 786443, metadata !1, metadata !42, i32 36, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
