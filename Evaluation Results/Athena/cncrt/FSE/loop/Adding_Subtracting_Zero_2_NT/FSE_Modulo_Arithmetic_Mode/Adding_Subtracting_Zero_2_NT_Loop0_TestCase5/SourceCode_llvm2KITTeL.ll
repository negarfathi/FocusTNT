...
main_bb14:                                        ; preds = %main_bb13
  ...
  br label %main_bb15, !dbg !121

main_bb15:                                        ; preds = %main_wrap_around.exit, %main_bb14
  %b.0 = phi i64 [ 0, %main_bb14 ], [ %.0.i2, %main_wrap_around.exit ]
  %"31" = icmp slt i64 %b.0, 15, !dbg !122
  br i1 %"31", label %main_ff_subtitles_next_line.exit, label %main_bb22, !dbg !122

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb15
  %"32" = icmp eq i64 %"30", 1, !dbg !101
  %. = select i1 %"32", i64 0, i64 10, !dbg !101
  %"33" = add nsw i64 %b.0, %., !dbg !89
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !124
  br i1 %"34", label %main_bb16, label %main_bb17, !dbg !124

main_bb16:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"35" = sub nsw i64 %"33", 2147483647, !dbg !125
  %"36" = sub nsw i64 %"35", 1, !dbg !125
  %"37" = srem i64 %"36", 4294967296, !dbg !125
  %"38" = add nsw i64 -2147483648, %"37", !dbg !125
  br label %main_wrap_around.exit3, !dbg !125

main_bb17:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"39" = icmp slt i64 %"33", -2147483648, !dbg !126
  br i1 %"39", label %main_bb18, label %main_wrap_around.exit3, !dbg !126

main_bb18:                                        ; preds = %main_bb17
  %"40" = sub nsw i64 -2147483648, %"33", !dbg !127
  %"41" = sub nsw i64 %"40", 1, !dbg !127
  %"42" = srem i64 %"41", 4294967296, !dbg !127
  %"43" = sub nsw i64 2147483647, %"42", !dbg !127
  br label %main_wrap_around.exit3, !dbg !127

main_wrap_around.exit3:                           ; preds = %main_bb16, %main_bb17, %main_bb18
  %.0.i2 = phi i64 [ %"38", %main_bb16 ], [ %"43", %main_bb18 ], [ %"33", %main_bb17 ], !dbg !103
  %"44" = sub nsw i64 15, 4, !dbg !112
  %"45" = icmp sgt i64 %"44", 2147483647, !dbg !128
  br i1 %"45", label %main_bb19, label %main_bb20, !dbg !128

main_bb19:                                        ; preds = %main_wrap_around.exit3
  %"46" = sub nsw i64 %"44", 2147483647, !dbg !129
  %"47" = sub nsw i64 %"46", 1, !dbg !129
  %"48" = srem i64 %"47", 4294967296, !dbg !129
  %"49" = add nsw i64 -2147483648, %"48", !dbg !129
  br label %main_wrap_around.exit, !dbg !129

main_bb20:                                        ; preds = %main_wrap_around.exit3
  %"50" = icmp slt i64 %"44", -2147483648, !dbg !130
  br i1 %"50", label %main_bb21, label %main_wrap_around.exit, !dbg !130

main_bb21:                                        ; preds = %main_bb20
  %"51" = sub nsw i64 -2147483648, %"44", !dbg !131
  %"52" = sub nsw i64 %"51", 1, !dbg !131
  %"53" = srem i64 %"52", 4294967296, !dbg !131
  %"54" = sub nsw i64 2147483647, %"53", !dbg !131
...
!121 = metadata !{i32 51, i32 5, metadata !12, null}
!122 = metadata !{i32 51, i32 5, metadata !123, null}
!123 = metadata !{i32 786443, metadata !1, metadata !12, i32 51, i32 5, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!124 = metadata !{i32 14, i32 9, metadata !31, metadata !103}
!125 = metadata !{i32 15, i32 9, metadata !33, metadata !103}
!126 = metadata !{i32 17, i32 14, metadata !35, metadata !103}
!127 = metadata !{i32 18, i32 9, metadata !37, metadata !103}
!128 = metadata !{i32 14, i32 9, metadata !31, metadata !112}
!129 = metadata !{i32 15, i32 9, metadata !33, metadata !112}
!130 = metadata !{i32 17, i32 14, metadata !35, metadata !112}
!131 = metadata !{i32 18, i32 9, metadata !37, metadata !112}
!132 = metadata !{i32 60, i32 1, metadata !12, null}
