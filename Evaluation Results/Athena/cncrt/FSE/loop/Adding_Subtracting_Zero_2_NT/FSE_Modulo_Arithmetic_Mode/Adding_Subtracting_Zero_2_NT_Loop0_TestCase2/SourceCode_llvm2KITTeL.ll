...
main_bb13:
  ...
  br i1 %or.cond, label %main_bb22, label %main_bb14, !dbg !83
...
main_bb14:                                        ; preds = %main_bb13
  ...
  call void @llvm.dbg.value(metadata !{i64 %"33"}, i64 0, metadata !101), !dbg !103
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !104), !dbg !105
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !106), !dbg !107
  ...
  call void @llvm.dbg.value(metadata !{i64 %"44"}, i64 0, metadata !110), !dbg !113
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !114), !dbg !115
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !116), !dbg !117
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !118), !dbg !119
...
main_bb15:                                        ; preds = %main_wrap_around.exit, %main_bb14
  ...
  %"31" = icmp slt i64 %b.0, 5, !dbg !121
  br i1 %"31", label %main_ff_subtitles_next_line.exit, label %main_bb22, !dbg !121

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb15
  %"32" = icmp eq i64 %"30", 1, !dbg !100
  %. = select i1 %"32", i64 0, i64 5, !dbg !100
  %"33" = add nsw i64 %b.0, %., !dbg !88
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !123
  br i1 %"34", label %main_bb16, label %main_bb17, !dbg !123

main_bb16:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"35" = sub nsw i64 %"33", 2147483647, !dbg !124
  %"36" = sub nsw i64 %"35", 1, !dbg !124
  %"37" = srem i64 %"36", 4294967296, !dbg !124
  %"38" = add nsw i64 -2147483648, %"37", !dbg !124
  br label %main_wrap_around.exit3, !dbg !124

main_bb17:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"39" = icmp slt i64 %"33", -2147483648, !dbg !125
  br i1 %"39", label %main_bb18, label %main_wrap_around.exit3, !dbg !125

main_bb18:                                        ; preds = %main_bb17
  %"40" = sub nsw i64 -2147483648, %"33", !dbg !126
  %"41" = sub nsw i64 %"40", 1, !dbg !126
  %"42" = srem i64 %"41", 4294967296, !dbg !126
  %"43" = sub nsw i64 2147483647, %"42", !dbg !126
  br label %main_wrap_around.exit3, !dbg !126

main_wrap_around.exit3:                           ; preds = %main_bb16, %main_bb17, %main_bb18
  %.0.i2 = phi i64 [ %"38", %main_bb16 ], [ %"43", %main_bb18 ], [ %"33", %main_bb17 ], !dbg !102
  %"44" = sub nsw i64 5, 4, !dbg !111
...
main_bb20:                                        ; preds = %main_wrap_around.exit3
  ...
  br i1 %"50", label %main_bb21, label %main_wrap_around.exit, !dbg !129
...
main_wrap_around.exit:                            ; preds = %main_bb19, %main_bb20, %main_bb21
  %.0.i1 = phi i64 [ %"49", %main_bb19 ], [ %"54", %main_bb21 ], [ %"44", %main_bb20 ], !dbg !111
  %"55" = icmp sge i64 %.0.i2, %.0.i1, !dbg !111
  br i1 %"55", label %main_bb22, label %main_bb15, !dbg !111
...
!81 = metadata !{i32 786688, metadata !12, metadata !"end", metadata !5, i32 46, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [end] [line 46]
!82 = metadata !{i32 46, i32 15, metadata !12, null}
!83 = metadata !{i32 47, i32 9, metadata !84, null}
!84 = metadata !{i32 786443, metadata !1, metadata !12, i32 47, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!85 = metadata !{i32 47, i32 9, metadata !86, null}
!86 = metadata !{i32 786443, metadata !1, metadata !84, i32 47, i32 9, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!88 = metadata !{i32 53, i32 30, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 5, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!92 = metadata !{i32 25, i32 9, metadata !9, metadata !88}
...
!100 = metadata !{i32 26, i32 9, metadata !55, metadata !88}
!101 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !102} ; [ DW_TAG_arg_variable ] [value] [line 12]
!102 = metadata !{i32 53, i32 13, metadata !89, null}
!103 = metadata !{i32 12, i32 33, metadata !4, metadata !102}
!104 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !102} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!105 = metadata !{i32 12, i32 50, metadata !4, metadata !102}
!106 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !102} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!107 = metadata !{i32 12, i32 73, metadata !4, metadata !102}
!108 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !102} ; [ DW_TAG_auto_variable ] [range] [line 13]
!109 = metadata !{i32 13, i32 15, metadata !4, metadata !102}
...
!111 = metadata !{i32 54, i32 18, metadata !112, null}
!112 = metadata !{i32 786443, metadata !1, metadata !89, i32 54, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!113 = metadata !{i32 12, i32 33, metadata !4, metadata !111}
!114 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !111} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!115 = metadata !{i32 12, i32 50, metadata !4, metadata !111}
!116 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !111} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!117 = metadata !{i32 12, i32 73, metadata !4, metadata !111}
!118 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !111} ; [ DW_TAG_auto_variable ] [range] [line 13]
!119 = metadata !{i32 13, i32 15, metadata !4, metadata !111}
!120 = metadata !{i32 51, i32 5, metadata !12, null}
!121 = metadata !{i32 51, i32 5, metadata !122, null}
!122 = metadata !{i32 786443, metadata !1, metadata !12, i32 51, i32 5, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!123 = metadata !{i32 14, i32 9, metadata !31, metadata !102}
!124 = metadata !{i32 15, i32 9, metadata !33, metadata !102}
!125 = metadata !{i32 17, i32 14, metadata !35, metadata !102}
!126 = metadata !{i32 18, i32 9, metadata !37, metadata !102}
!127 = metadata !{i32 14, i32 9, metadata !31, metadata !111}
!128 = metadata !{i32 15, i32 9, metadata !33, metadata !111}
!129 = metadata !{i32 17, i32 14, metadata !35, metadata !111}
!130 = metadata !{i32 18, i32 9, metadata !37, metadata !111}
!131 = metadata !{i32 60, i32 1, metadata !12, null}
