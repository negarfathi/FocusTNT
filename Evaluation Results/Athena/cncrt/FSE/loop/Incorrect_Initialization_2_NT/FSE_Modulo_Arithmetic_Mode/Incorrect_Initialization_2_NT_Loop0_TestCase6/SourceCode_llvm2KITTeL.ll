...
main_bb16:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"41"}, i64 0, metadata !98), !dbg !102
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !103), !dbg !104
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !105), !dbg !106
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !107), !dbg !108
  call void @llvm.dbg.value(metadata !{i64 %"41"}, i64 0, metadata !109), !dbg !111
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !112), !dbg !113
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !114), !dbg !115
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !116), !dbg !117
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !118), !dbg !122
  ...
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !127), !dbg !131
  ...
  call void @llvm.dbg.value(metadata !136, i64 0, metadata !88), !dbg !89
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !137), !dbg !139
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !140), !dbg !141
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !142), !dbg !143
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !144), !dbg !146
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !147), !dbg !148
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !149), !dbg !150
  br label %main_bb17, !dbg !151

main_bb17:                                        ; preds = %main_NewDefault, %main_bb18, %main_bb16
  %res.0 = phi i64 [ 0, %main_bb16 ], [ %res.1, %main_NewDefault ], [ %res.1, %main_bb18 ]
  %matroska.0 = phi i64 [ 2, %main_bb16 ], [ 1, %main_bb18 ], [ %matroska.0, %main_NewDefault ]
  %"36" = icmp eq i64 %matroska.0, 1, !dbg !152
  %..i = select i1 %"36", i64 0, i64 1, !dbg !153
...
main_res_return.exit:                             ; preds = %main_wrap_around.exit.i, %main_wrap_around.exit2.i, %main_bb17
  %res.1 = phi i64 [ %res.0, %main_bb17 ], [ 5, %main_wrap_around.exit.i ], [ -1, %main_wrap_around.exit2.i ]
...
main_bb18:                                        ; preds = %main_LeafBlock
  call void @llvm.dbg.value(metadata !136, i64 0, metadata !85), !dbg !86
...
main_bb19:                                        ; preds = %main_LeafBlock13
  %"38" = load i64* @"'flag", align 8, !dbg !157
  %"39" = add nsw i64 %"38", 1, !dbg !157
  store i64 %"39", i64* @"'flag", align 8, !dbg !157
  %"40" = icmp slt i64 %"38", 100, !dbg !157
  %"41" = load i64* @"'flag", align 8, !dbg !99
  %"42" = icmp sgt i64 %"41", 2147483647, !dbg !158
  br i1 %"40", label %main_bb20, label %main_bb24, !dbg !157

main_bb20:                                        ; preds = %main_bb19
  br i1 %"42", label %main_bb21, label %main_bb22, !dbg !158

main_bb21:                                        ; preds = %main_bb20
  %"43" = sub nsw i64 %"41", 2147483647, !dbg !159
  %"44" = sub nsw i64 %"43", 1, !dbg !159
  %"45" = srem i64 %"44", 4294967296, !dbg !159
  %"46" = add nsw i64 -2147483648, %"45", !dbg !159
  br label %main_wrap_around.exit.i, !dbg !159

main_bb22:                                        ; preds = %main_bb20
  %"47" = icmp slt i64 %"41", -2147483648, !dbg !160
  br i1 %"47", label %main_bb23, label %main_wrap_around.exit.i, !dbg !160

main_bb23:                                        ; preds = %main_bb22
  %"48" = sub nsw i64 -2147483648, %"41", !dbg !161
  %"49" = sub nsw i64 %"48", 1, !dbg !161
  %"50" = srem i64 %"49", 4294967296, !dbg !161
  %"51" = sub nsw i64 2147483647, %"50", !dbg !161
  br label %main_wrap_around.exit.i, !dbg !161

main_wrap_around.exit.i:                          ; preds = %main_bb23, %main_bb22, %main_bb21
  %.0.i.i = phi i64 [ %"46", %main_bb21 ], [ %"51", %main_bb23 ], [ %"41", %main_bb22 ], !dbg !99
  store i64 %.0.i.i, i64* @"'flag", align 8, !dbg !99
  br label %main_res_return.exit, !dbg !162

main_bb24:                                        ; preds = %main_bb19
  br i1 %"42", label %main_bb25, label %main_bb26, !dbg !163

main_bb25:                                        ; preds = %main_bb24
  %"52" = sub nsw i64 %"41", 2147483647, !dbg !164
  %"53" = sub nsw i64 %"52", 1, !dbg !164
  %"54" = srem i64 %"53", 4294967296, !dbg !164
  %"55" = add nsw i64 -2147483648, %"54", !dbg !164
  br label %main_wrap_around.exit2.i, !dbg !164

main_bb26:                                        ; preds = %main_bb24
  %"56" = icmp slt i64 %"41", -2147483648, !dbg !165
  br i1 %"56", label %main_bb27, label %main_wrap_around.exit2.i, !dbg !165

main_bb27:                                        ; preds = %main_bb26
  %"57" = sub nsw i64 -2147483648, %"41", !dbg !166
  %"58" = sub nsw i64 %"57", 1, !dbg !166
  %"59" = srem i64 %"58", 4294967296, !dbg !166
  %"60" = sub nsw i64 2147483647, %"59", !dbg !166
  br label %main_wrap_around.exit2.i, !dbg !166

main_wrap_around.exit2.i:                         ; preds = %main_bb27, %main_bb26, %main_bb25
  %.0.i1.i = phi i64 [ %"55", %main_bb25 ], [ %"60", %main_bb27 ], [ %"41", %main_bb26 ], !dbg !110
  store i64 %.0.i1.i, i64* @"'flag", align 8, !dbg !110
  br label %main_res_return.exit, !dbg !167
...
!94 = metadata !{i32 786688, metadata !95, metadata !"id", metadata !5, i32 50, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [id] [line 50]
!95 = metadata !{i32 786443, metadata !1, metadata !96, i32 49, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!96 = metadata !{i32 786443, metadata !1, metadata !15, i32 47, i32 5, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!97 = metadata !{i32 50, i32 23, metadata !95, null}
!98 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !99} ; [ DW_TAG_arg_variable ] [value] [line 12]
!99 = metadata !{i32 36, i32 8, metadata !52, metadata !100}
!100 = metadata !{i32 65, i32 27, metadata !101, null}
!101 = metadata !{i32 786443, metadata !1, metadata !95, i32 51, i32 25, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!102 = metadata !{i32 12, i32 33, metadata !4, metadata !99}
!103 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !99} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!104 = metadata !{i32 12, i32 50, metadata !4, metadata !99}
!105 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !99} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!106 = metadata !{i32 12, i32 73, metadata !4, metadata !99}
!107 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !99} ; [ DW_TAG_auto_variable ] [range] [line 13]
!108 = metadata !{i32 13, i32 15, metadata !4, metadata !99}
!109 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !110} ; [ DW_TAG_arg_variable ] [value] [line 12]
!110 = metadata !{i32 39, i32 8, metadata !12, metadata !100}
!111 = metadata !{i32 12, i32 33, metadata !4, metadata !110}
!112 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !110} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!113 = metadata !{i32 12, i32 50, metadata !4, metadata !110}
!114 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !110} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!115 = metadata !{i32 12, i32 73, metadata !4, metadata !110}
!116 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !110} ; [ DW_TAG_auto_variable ] [range] [line 13]
!117 = metadata !{i32 13, i32 15, metadata !4, metadata !110}
!118 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !119} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!119 = metadata !{i32 36, i32 8, metadata !52, metadata !120}
!120 = metadata !{i32 53, i32 31, metadata !121, null}
!121 = metadata !{i32 786443, metadata !1, metadata !101, i32 53, i32 25, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!122 = metadata !{i32 12, i32 50, metadata !4, metadata !119}
!123 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !119} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!124 = metadata !{i32 12, i32 73, metadata !4, metadata !119}
!125 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !119} ; [ DW_TAG_auto_variable ] [range] [line 13]
!126 = metadata !{i32 13, i32 15, metadata !4, metadata !119}
!127 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !128} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!128 = metadata !{i32 36, i32 8, metadata !52, metadata !129}
!129 = metadata !{i32 57, i32 31, metadata !130, null}
!130 = metadata !{i32 786443, metadata !1, metadata !101, i32 57, i32 25, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!131 = metadata !{i32 12, i32 50, metadata !4, metadata !128}
!132 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !128} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!133 = metadata !{i32 12, i32 73, metadata !4, metadata !128}
!134 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !128} ; [ DW_TAG_auto_variable ] [range] [line 13]
!135 = metadata !{i32 13, i32 15, metadata !4, metadata !128}
!136 = metadata !{i64 1}
!137 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !138} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!138 = metadata !{i32 39, i32 8, metadata !12, metadata !129}
!139 = metadata !{i32 12, i32 50, metadata !4, metadata !138}
!140 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !138} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!141 = metadata !{i32 12, i32 73, metadata !4, metadata !138}
!142 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !138} ; [ DW_TAG_auto_variable ] [range] [line 13]
!143 = metadata !{i32 13, i32 15, metadata !4, metadata !138}
!144 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !145} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!145 = metadata !{i32 39, i32 8, metadata !12, metadata !120}
!146 = metadata !{i32 12, i32 50, metadata !4, metadata !145}
!147 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !145} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!148 = metadata !{i32 12, i32 73, metadata !4, metadata !145}
!149 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !145} ; [ DW_TAG_auto_variable ] [range] [line 13]
!150 = metadata !{i32 13, i32 15, metadata !4, metadata !145}
!151 = metadata !{i32 46, i32 5, metadata !15, null}
!152 = metadata !{i32 24, i32 9, metadata !45, metadata !91}
!153 = metadata !{i32 26, i32 9, metadata !47, metadata !91}
!154 = metadata !{i32 72, i32 1, metadata !155, null}
!155 = metadata !{i32 786443, metadata !1, metadata !156, i32 70, i32 1, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!156 = metadata !{i32 786443, metadata !1, metadata !96, i32 69, i32 13, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!157 = metadata !{i32 34, i32 9, metadata !50, metadata !100}
!158 = metadata !{i32 14, i32 9, metadata !34, metadata !99}
!159 = metadata !{i32 15, i32 9, metadata !36, metadata !99}
!160 = metadata !{i32 17, i32 14, metadata !38, metadata !99}
!161 = metadata !{i32 18, i32 9, metadata !40, metadata !99}
!162 = metadata !{i32 37, i32 9, metadata !52, metadata !100}
!163 = metadata !{i32 14, i32 9, metadata !34, metadata !110}
!164 = metadata !{i32 15, i32 9, metadata !36, metadata !110}
!165 = metadata !{i32 17, i32 14, metadata !38, metadata !110}
!166 = metadata !{i32 18, i32 9, metadata !40, metadata !110}
!167 = metadata !{i32 40, i32 5, metadata !12, metadata !100}
!168 = metadata !{i32 74, i32 5, metadata !15, null}
