...
res_return_bb15:                                  ; preds = %res_return_wrap_around.exit2, %res_return_wrap_around.exit
  %.0 = phi i64 [ 5, %res_return_wrap_around.exit ], [ -1, %res_return_wrap_around.exit2 ]
  ret i64 %.0, !dbg !83
}
...
main_bb16:
  ...
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !108), !dbg !110
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !111), !dbg !112
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !113), !dbg !114
  call void @llvm.dbg.value(metadata !{i64 %"41"}, i64 0, metadata !115), !dbg !119
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !120), !dbg !121
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !122), !dbg !123
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !124), !dbg !125
  call void @llvm.dbg.value(metadata !{i64 %"63"}, i64 0, metadata !88), !dbg !89
  call void @llvm.dbg.value(metadata !{i64 %"68"}, i64 0, metadata !126), !dbg !130
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !131), !dbg !132
  ...
  call void @llvm.dbg.value(metadata !{i64 %"68"}, i64 0, metadata !137), !dbg !139
  ...
  call void @llvm.dbg.value(metadata !{i64 %"41"}, i64 0, metadata !146), !dbg !148
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !149), !dbg !150
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !151), !dbg !152
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !153), !dbg !154
  br label %main_bb17, !dbg !155

main_bb17:                                        ; preds = %main_NewDefault, %main_bb19, %main_bb16
  %res.0 = phi i64 [ 0, %main_bb16 ], [ %res.1, %main_NewDefault ], [ %res.1, %main_bb19 ]
  %matroska.0 = phi i64 [ 2, %main_bb16 ], [ 1, %main_bb19 ], [ %matroska.0, %main_NewDefault ]
  %"36" = icmp eq i64 %matroska.0, 1, !dbg !156
  %..i = select i1 %"36", i64 0, i64 1, !dbg !157
...
main_bb18:                                        ; preds = %main_res_return.exit6, %main_res_return.exit12, %main_bb17
  %res.1 = phi i64 [ %res.0, %main_bb17 ], [ %., %main_res_return.exit6 ], [ %"63", %main_res_return.exit12 ]
...
main_bb20:                                        ; preds = %main_LeafBlock13
  %"38" = load i64* @"'flag", align 8, !dbg !161
  %"39" = add nsw i64 %"38", 1, !dbg !161
  store i64 %"39", i64* @"'flag", align 8, !dbg !161
  %"40" = icmp slt i64 %"38", 100, !dbg !161
  %"41" = load i64* @"'flag", align 8, !dbg !116
  %"42" = icmp sgt i64 %"41", 2147483647, !dbg !162
  br i1 %"40", label %main_bb21, label %main_bb25, !dbg !161

main_bb21:                                        ; preds = %main_bb20
  br i1 %"42", label %main_bb22, label %main_bb23, !dbg !162

main_bb22:                                        ; preds = %main_bb21
  %"43" = sub nsw i64 %"41", 2147483647, !dbg !163
  %"44" = sub nsw i64 %"43", 1, !dbg !163
  %"45" = srem i64 %"44", 4294967296, !dbg !163
  %"46" = add nsw i64 -2147483648, %"45", !dbg !163
  br label %main_wrap_around.exit.i8, !dbg !163

main_bb23:                                        ; preds = %main_bb21
  %"47" = icmp slt i64 %"41", -2147483648, !dbg !164
  br i1 %"47", label %main_bb24, label %main_wrap_around.exit.i8, !dbg !164

main_bb24:                                        ; preds = %main_bb23
  %"48" = sub nsw i64 -2147483648, %"41", !dbg !165
  %"49" = sub nsw i64 %"48", 1, !dbg !165
  %"50" = srem i64 %"49", 4294967296, !dbg !165
  %"51" = sub nsw i64 2147483647, %"50", !dbg !165
  br label %main_wrap_around.exit.i8, !dbg !165

main_wrap_around.exit.i8:                         ; preds = %main_bb24, %main_bb23, %main_bb22
  %.0.i.i7 = phi i64 [ %"46", %main_bb22 ], [ %"51", %main_bb24 ], [ %"41", %main_bb23 ], !dbg !116
  store i64 %.0.i.i7, i64* @"'flag", align 8, !dbg !116
  br label %main_res_return.exit12, !dbg !166

main_bb25:                                        ; preds = %main_bb20
  br i1 %"42", label %main_bb26, label %main_bb27, !dbg !167

main_bb26:                                        ; preds = %main_bb25
  %"52" = sub nsw i64 %"41", 2147483647, !dbg !168
  %"53" = sub nsw i64 %"52", 1, !dbg !168
  %"54" = srem i64 %"53", 4294967296, !dbg !168
  %"55" = add nsw i64 -2147483648, %"54", !dbg !168
  br label %main_wrap_around.exit2.i10, !dbg !168

main_bb27:                                        ; preds = %main_bb25
  %"56" = icmp slt i64 %"41", -2147483648, !dbg !169
  br i1 %"56", label %main_bb28, label %main_wrap_around.exit2.i10, !dbg !169

main_bb28:                                        ; preds = %main_bb27
  %"57" = sub nsw i64 -2147483648, %"41", !dbg !170
  %"58" = sub nsw i64 %"57", 1, !dbg !170
  %"59" = srem i64 %"58", 4294967296, !dbg !170
  %"60" = sub nsw i64 2147483647, %"59", !dbg !170
  br label %main_wrap_around.exit2.i10, !dbg !170

main_wrap_around.exit2.i10:                       ; preds = %main_bb28, %main_bb27, %main_bb26
  %.0.i1.i9 = phi i64 [ %"55", %main_bb26 ], [ %"60", %main_bb28 ], [ %"41", %main_bb27 ], !dbg !147
  store i64 %.0.i1.i9, i64* @"'flag", align 8, !dbg !147
  br label %main_res_return.exit12, !dbg !171

main_res_return.exit12:                           ; preds = %main_wrap_around.exit.i8, %main_wrap_around.exit2.i10
  %.0.i11 = phi i64 [ 5, %main_wrap_around.exit.i8 ], [ -1, %main_wrap_around.exit2.i10 ], !dbg !117
  %"61" = icmp slt i64 %.0.i11, 0, !dbg !117
  %"62" = zext i1 %"61" to i32, !dbg !117
  %"63" = sext i32 %"62" to i64, !dbg !117
  %"64" = icmp ne i64 %"63", 0, !dbg !117
  br i1 %"64", label %main_bb18, label %main_bb29, !dbg !117

main_bb29:                                        ; preds = %main_res_return.exit12
  %"65" = load i64* @"'flag", align 8, !dbg !172
  %"66" = add nsw i64 %"65", 1, !dbg !172
  store i64 %"66", i64* @"'flag", align 8, !dbg !172
  %"67" = icmp slt i64 %"65", 100, !dbg !172
  %"68" = load i64* @"'flag", align 8, !dbg !127
  %"69" = icmp sgt i64 %"68", 2147483647, !dbg !173
  br i1 %"67", label %main_bb30, label %main_bb34, !dbg !172

main_bb30:                                        ; preds = %main_bb29
  br i1 %"69", label %main_bb31, label %main_bb32, !dbg !173

main_bb31:                                        ; preds = %main_bb30
  %"70" = sub nsw i64 %"68", 2147483647, !dbg !174
  %"71" = sub nsw i64 %"70", 1, !dbg !174
  %"72" = srem i64 %"71", 4294967296, !dbg !174
  %"73" = add nsw i64 -2147483648, %"72", !dbg !174
  br label %main_wrap_around.exit.i2, !dbg !174

main_bb32:                                        ; preds = %main_bb30
  %"74" = icmp slt i64 %"68", -2147483648, !dbg !175
  br i1 %"74", label %main_bb33, label %main_wrap_around.exit.i2, !dbg !175

main_bb33:                                        ; preds = %main_bb32
  %"75" = sub nsw i64 -2147483648, %"68", !dbg !176
  %"76" = sub nsw i64 %"75", 1, !dbg !176
  %"77" = srem i64 %"76", 4294967296, !dbg !176
  %"78" = sub nsw i64 2147483647, %"77", !dbg !176
  br label %main_wrap_around.exit.i2, !dbg !176

main_wrap_around.exit.i2:                         ; preds = %main_bb33, %main_bb32, %main_bb31
  %.0.i.i1 = phi i64 [ %"73", %main_bb31 ], [ %"78", %main_bb33 ], [ %"68", %main_bb32 ], !dbg !127
  store i64 %.0.i.i1, i64* @"'flag", align 8, !dbg !127
  br label %main_res_return.exit6, !dbg !177

main_bb34:                                        ; preds = %main_bb29
  br i1 %"69", label %main_bb35, label %main_bb36, !dbg !178

main_bb35:                                        ; preds = %main_bb34
  %"79" = sub nsw i64 %"68", 2147483647, !dbg !179
  %"80" = sub nsw i64 %"79", 1, !dbg !179
  %"81" = srem i64 %"80", 4294967296, !dbg !179
  %"82" = add nsw i64 -2147483648, %"81", !dbg !179
  br label %main_wrap_around.exit2.i4, !dbg !179

main_bb36:                                        ; preds = %main_bb34
  %"83" = icmp slt i64 %"68", -2147483648, !dbg !180
  br i1 %"83", label %main_bb37, label %main_wrap_around.exit2.i4, !dbg !180

main_bb37:                                        ; preds = %main_bb36
  %"84" = sub nsw i64 -2147483648, %"68", !dbg !181
  %"85" = sub nsw i64 %"84", 1, !dbg !181
  %"86" = srem i64 %"85", 4294967296, !dbg !181
  %"87" = sub nsw i64 2147483647, %"86", !dbg !181
  br label %main_wrap_around.exit2.i4, !dbg !181

main_wrap_around.exit2.i4:                        ; preds = %main_bb37, %main_bb36, %main_bb35
  %.0.i1.i3 = phi i64 [ %"82", %main_bb35 ], [ %"87", %main_bb37 ], [ %"68", %main_bb36 ], !dbg !138
  store i64 %.0.i1.i3, i64* @"'flag", align 8, !dbg !138
  br label %main_res_return.exit6, !dbg !182

main_res_return.exit6:                            ; preds = %main_wrap_around.exit.i2, %main_wrap_around.exit2.i4
  %.0.i5 = phi i64 [ 5, %main_wrap_around.exit.i2 ], [ -1, %main_wrap_around.exit2.i4 ], !dbg !128
  %"88" = icmp eq i64 %.0.i5, 0, !dbg !128
  %"89" = zext i1 %"88" to i32, !dbg !128
  %"90" = sext i32 %"89" to i64, !dbg !128
  %"91" = icmp ne i64 %"90", 0, !dbg !128
  %. = select i1 %"91", i64 1, i64 %"90", !dbg !128
  br label %main_bb18, !dbg !183
...
!99 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !100} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
...
!103 = metadata !{i32 12, i32 50, metadata !4, metadata !100}
!104 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !100} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!105 = metadata !{i32 12, i32 73, metadata !4, metadata !100}
!106 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !100} ; [ DW_TAG_auto_variable ] [range] [line 13]
!107 = metadata !{i32 13, i32 15, metadata !4, metadata !100}
!108 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !109} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!109 = metadata !{i32 39, i32 8, metadata !12, metadata !101}
!110 = metadata !{i32 12, i32 50, metadata !4, metadata !109}
!111 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !109} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!112 = metadata !{i32 12, i32 73, metadata !4, metadata !109}
!113 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !109} ; [ DW_TAG_auto_variable ] [range] [line 13]
!114 = metadata !{i32 13, i32 15, metadata !4, metadata !109}
!115 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !116} ; [ DW_TAG_arg_variable ] [value] [line 12]
!116 = metadata !{i32 36, i32 8, metadata !52, metadata !117}
!117 = metadata !{i32 53, i32 31, metadata !118, null}
!118 = metadata !{i32 786443, metadata !1, metadata !102, i32 53, i32 25, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!119 = metadata !{i32 12, i32 33, metadata !4, metadata !116}
!120 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !116} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!121 = metadata !{i32 12, i32 50, metadata !4, metadata !116}
!122 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !116} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!123 = metadata !{i32 12, i32 73, metadata !4, metadata !116}
!124 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !116} ; [ DW_TAG_auto_variable ] [range] [line 13]
!125 = metadata !{i32 13, i32 15, metadata !4, metadata !116}
!126 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !127} ; [ DW_TAG_arg_variable ] [value] [line 12]
!127 = metadata !{i32 36, i32 8, metadata !52, metadata !128}
!128 = metadata !{i32 57, i32 31, metadata !129, null}
!129 = metadata !{i32 786443, metadata !1, metadata !102, i32 57, i32 25, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!130 = metadata !{i32 12, i32 33, metadata !4, metadata !127}
!131 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !127} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!132 = metadata !{i32 12, i32 50, metadata !4, metadata !127}
!133 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !127} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!134 = metadata !{i32 12, i32 73, metadata !4, metadata !127}
!135 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !127} ; [ DW_TAG_auto_variable ] [range] [line 13]
!136 = metadata !{i32 13, i32 15, metadata !4, metadata !127}
!137 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !138} ; [ DW_TAG_arg_variable ] [value] [line 12]
!138 = metadata !{i32 39, i32 8, metadata !12, metadata !128}
!139 = metadata !{i32 12, i32 33, metadata !4, metadata !138}
!140 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !138} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!141 = metadata !{i32 12, i32 50, metadata !4, metadata !138}
!142 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !138} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!143 = metadata !{i32 12, i32 73, metadata !4, metadata !138}
!144 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !138} ; [ DW_TAG_auto_variable ] [range] [line 13]
!145 = metadata !{i32 13, i32 15, metadata !4, metadata !138}
!146 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !147} ; [ DW_TAG_arg_variable ] [value] [line 12]
!147 = metadata !{i32 39, i32 8, metadata !12, metadata !117}
!148 = metadata !{i32 12, i32 33, metadata !4, metadata !147}
!149 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !147} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!150 = metadata !{i32 12, i32 50, metadata !4, metadata !147}
!151 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !147} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!152 = metadata !{i32 12, i32 73, metadata !4, metadata !147}
!153 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !147} ; [ DW_TAG_auto_variable ] [range] [line 13]
!154 = metadata !{i32 13, i32 15, metadata !4, metadata !147}
!155 = metadata !{i32 46, i32 5, metadata !15, null}
!156 = metadata !{i32 24, i32 9, metadata !45, metadata !91}
!157 = metadata !{i32 26, i32 9, metadata !47, metadata !91}
!158 = metadata !{i32 72, i32 1, metadata !159, null}
!159 = metadata !{i32 786443, metadata !1, metadata !160, i32 70, i32 1, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!160 = metadata !{i32 786443, metadata !1, metadata !97, i32 69, i32 13, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!161 = metadata !{i32 34, i32 9, metadata !50, metadata !117}
!162 = metadata !{i32 14, i32 9, metadata !34, metadata !116}
!163 = metadata !{i32 15, i32 9, metadata !36, metadata !116}
!164 = metadata !{i32 17, i32 14, metadata !38, metadata !116}
!165 = metadata !{i32 18, i32 9, metadata !40, metadata !116}
!166 = metadata !{i32 37, i32 9, metadata !52, metadata !117}
!167 = metadata !{i32 14, i32 9, metadata !34, metadata !147}
!168 = metadata !{i32 15, i32 9, metadata !36, metadata !147}
!169 = metadata !{i32 17, i32 14, metadata !38, metadata !147}
!170 = metadata !{i32 18, i32 9, metadata !40, metadata !147}
!171 = metadata !{i32 40, i32 5, metadata !12, metadata !117}
!172 = metadata !{i32 34, i32 9, metadata !50, metadata !128}
!173 = metadata !{i32 14, i32 9, metadata !34, metadata !127}
!174 = metadata !{i32 15, i32 9, metadata !36, metadata !127}
!175 = metadata !{i32 17, i32 14, metadata !38, metadata !127}
!176 = metadata !{i32 18, i32 9, metadata !40, metadata !127}
!177 = metadata !{i32 37, i32 9, metadata !52, metadata !128}
!178 = metadata !{i32 14, i32 9, metadata !34, metadata !138}
!179 = metadata !{i32 15, i32 9, metadata !36, metadata !138}
!180 = metadata !{i32 17, i32 14, metadata !38, metadata !138}
!181 = metadata !{i32 18, i32 9, metadata !40, metadata !138}
!182 = metadata !{i32 40, i32 5, metadata !12, metadata !128}
!183 = metadata !{i32 61, i32 21, metadata !102, null}
!184 = metadata !{i32 74, i32 5, metadata !15, null}
