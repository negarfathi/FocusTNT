...
main_wrap_around.exit.i:                          ; preds = %main_bb14, %main_bb13, %main_bb12
  ...
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !86), !dbg !89
  call void @llvm.dbg.value(metadata !{i64 %"44"}, i64 0, metadata !90), !dbg !92
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !93), !dbg !94
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !95), !dbg !96
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !97), !dbg !98
...
main_bb15:                                        ; preds = %main_bb16, %main_wrap_around.exit.i2, %main_wrap_around.exit.i
  ...
  %"41" = icmp eq i64 %rc.0, 0, !dbg !100
  br i1 %"41", label %main_bb16, label %main_bb21, !dbg !100

main_bb16:                                        ; preds = %main_bb15
  %"42" = icmp sle i64 0, 0, !dbg !102
  br i1 %"42", label %main_bb15, label %main_bb17, !dbg !102

main_bb17:                                        ; preds = %main_bb16
  %"43" = load i64* @"'flag", align 8, !dbg !91
  %"44" = add nsw i64 %"43", 1, !dbg !91
  %"45" = icmp sgt i64 %"44", 2147483647, !dbg !104
  br i1 %"45", label %main_bb18, label %main_bb19, !dbg !104

main_bb18:                                        ; preds = %main_bb17
  %"46" = sub nsw i64 %"44", 2147483647, !dbg !105
  %"47" = sub nsw i64 %"46", 1, !dbg !105
  %"48" = srem i64 %"47", 4294967296, !dbg !105
  %"49" = add nsw i64 -2147483648, %"48", !dbg !105
  br label %main_wrap_around.exit.i2, !dbg !105

main_bb19:                                        ; preds = %main_bb17
  %"50" = icmp slt i64 %"44", -2147483648, !dbg !106
  br i1 %"50", label %main_bb20, label %main_wrap_around.exit.i2, !dbg !106

main_bb20:                                        ; preds = %main_bb19
  %"51" = sub nsw i64 -2147483648, %"44", !dbg !107
  %"52" = sub nsw i64 %"51", 1, !dbg !107
  %"53" = srem i64 %"52", 4294967296, !dbg !107
  %"54" = sub nsw i64 2147483647, %"53", !dbg !107
  br label %main_wrap_around.exit.i2, !dbg !107

main_wrap_around.exit.i2:                         ; preds = %main_bb20, %main_bb19, %main_bb18
  %.0.i.i1 = phi i64 [ %"49", %main_bb18 ], [ %"54", %main_bb20 ], [ %"44", %main_bb19 ], !dbg !91
  store i64 %.0.i.i1, i64* @"'flag", align 8, !dbg !91
  %"55" = load i64* @"'flag", align 8, !dbg !108
  %"56" = icmp sgt i64 %"55", 1000, !dbg !108
  %.5 = select i1 %"56", i64 1, i64 0, !dbg !108
  br label %main_bb15, !dbg !109
...
!87 = metadata !{i32 49, i32 14, metadata !88, null}
!88 = metadata !{i32 786443, metadata !1, metadata !12, i32 44, i32 5, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!89 = metadata !{i32 24, i32 15, metadata !9, metadata !87}
!90 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !91} ; [ DW_TAG_arg_variable ] [value] [line 12]
!91 = metadata !{i32 25, i32 13, metadata !9, metadata !87}
!92 = metadata !{i32 12, i32 33, metadata !4, metadata !91}
!93 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !91} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!94 = metadata !{i32 12, i32 50, metadata !4, metadata !91}
!95 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !91} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!96 = metadata !{i32 12, i32 73, metadata !4, metadata !91}
!97 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !91} ; [ DW_TAG_auto_variable ] [range] [line 13]
!98 = metadata !{i32 13, i32 15, metadata !4, metadata !91}
!99 = metadata !{i32 43, i32 5, metadata !12, null}
!100 = metadata !{i32 43, i32 5, metadata !101, null}
!101 = metadata !{i32 786443, metadata !1, metadata !12, i32 43, i32 5, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!102 = metadata !{i32 45, i32 13, metadata !103, null}
!103 = metadata !{i32 786443, metadata !1, metadata !88, i32 45, i32 13, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!104 = metadata !{i32 14, i32 9, metadata !31, metadata !91}
!105 = metadata !{i32 15, i32 9, metadata !33, metadata !91}
!106 = metadata !{i32 17, i32 14, metadata !35, metadata !91}
!107 = metadata !{i32 18, i32 9, metadata !37, metadata !91}
!108 = metadata !{i32 26, i32 9, metadata !59, metadata !87}
!109 = metadata !{i32 50, i32 5, metadata !88, null}
!110 = metadata !{i32 51, i32 5, metadata !12, null}
