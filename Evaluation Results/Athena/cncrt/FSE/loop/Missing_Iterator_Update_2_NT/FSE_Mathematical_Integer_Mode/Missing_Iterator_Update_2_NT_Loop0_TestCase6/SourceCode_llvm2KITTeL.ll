...
main_mdb_cursor_get.exit:
  ...
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !34), !dbg !37
...
main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get.exit2, %main_mdb_cursor_get.exit
  ...
  %"9" = icmp eq i32 %rc.0, 0, !dbg !39
  br i1 %"9", label %main_bb4, label %main_bb5, !dbg !39

main_bb4:                                         ; preds = %main_bb3
  %"10" = icmp sle i32 0, 0, !dbg !41
  br i1 %"10", label %main_bb3, label %main_mdb_cursor_get.exit2, !dbg !41

main_mdb_cursor_get.exit2:                        ; preds = %main_bb4
  %"11" = load i32* @"'flag", align 4, !dbg !43
  %"12" = add nsw i32 %"11", 1, !dbg !43
  store i32 %"12", i32* @"'flag", align 4, !dbg !43
  %"13" = load i32* @"'flag", align 4, !dbg !44
  %"14" = icmp sgt i32 %"13", 1000, !dbg !44
  %.3 = select i1 %"14", i32 1, i32 0, !dbg !44
...
!35 = metadata !{i32 31, i32 14, metadata !36, null}
!36 = metadata !{i32 786443, metadata !1, metadata !9, i32 28, i32 5, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!37 = metadata !{i32 12, i32 9, metadata !4, metadata !35}
!38 = metadata !{i32 27, i32 5, metadata !9, null}
!39 = metadata !{i32 27, i32 5, metadata !40, null}
!40 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 5, i32 1, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 29, i32 13, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !36, i32 29, i32 13, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 13, i32 5, metadata !4, metadata !35}
!44 = metadata !{i32 14, i32 9, metadata !20, metadata !35}
!45 = metadata !{i32 32, i32 5, metadata !36, null}
!46 = metadata !{i32 33, i32 5, metadata !9, null}
