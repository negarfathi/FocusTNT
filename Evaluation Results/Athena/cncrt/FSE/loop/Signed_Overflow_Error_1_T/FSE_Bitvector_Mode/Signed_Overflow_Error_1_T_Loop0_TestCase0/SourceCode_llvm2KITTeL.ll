...
main_bb0:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"2"}, i64 0, metadata !13), !dbg !15
  br label %main_bb1, !dbg !16

main_bb1:                                         ; preds = %main_bb3, %main_bb0
  %i.0 = phi i64 [ 1, %main_bb0 ], [ %"2", %main_bb3 ]
  %"0" = icmp sgt i64 %i.0, 4294967295, !dbg !18
  %"1" = icmp eq i64 %i.0, 2147483648, !dbg !21
  %or.cond = or i1 %"0", %"1", !dbg !18
  br i1 %or.cond, label %main_bb2, label %main_bb3, !dbg !18

main_bb2:                                         ; preds = %main_bb1
  ret i32 0, !dbg !24

main_bb3:                                         ; preds = %main_bb1
  %"2" = shl i64 %i.0, 1, !dbg !25
...
!12 = metadata !{i64 1}
!13 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 12, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 12]
...
!16 = metadata !{i32 13, i32 10, metadata !17, null}
...
!18 = metadata !{i32 13, i32 10, metadata !19, null}
!19 = metadata !{i32 786443, metadata !1, metadata !20, i32 13, i32 10, i32 2, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!20 = metadata !{i32 786443, metadata !1, metadata !17, i32 13, i32 10, i32 1, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!21 = metadata !{i32 15, i32 13, metadata !22, null}
!22 = metadata !{i32 786443, metadata !1, metadata !23, i32 15, i32 13, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!23 = metadata !{i32 786443, metadata !1, metadata !17, i32 14, i32 5, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!24 = metadata !{i32 18, i32 5, metadata !4, null}
!25 = metadata !{i32 13, i32 36, metadata !17, null}
