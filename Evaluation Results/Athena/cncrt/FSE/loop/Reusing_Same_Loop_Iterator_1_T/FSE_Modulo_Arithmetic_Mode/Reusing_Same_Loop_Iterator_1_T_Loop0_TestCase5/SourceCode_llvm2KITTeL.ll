...
main_bb10:                                        ; preds = %main_wrap_around.exit
  %"27" = add nsw i64 %i.0, 1, !dbg !58
  call void @llvm.dbg.value(metadata !{i64 %"27"}, i64 0, metadata !59), !dbg !60
  ...
  %"28" = icmp sgt i64 %"27", 2147483647, !dbg !70
  br i1 %"28", label %main_bb11, label %main_bb12, !dbg !70

main_bb11:                                        ; preds = %main_bb10
  %"29" = sub nsw i64 %"27", 2147483647, !dbg !71
...
main_bb12:                                        ; preds = %main_bb10
  %"33" = icmp slt i64 %"27", -2147483648, !dbg !72
  br i1 %"33", label %main_bb13, label %main_wrap_around.exit2, !dbg !72

main_bb13:                                        ; preds = %main_bb12
  %"34" = sub nsw i64 -2147483648, %"27", !dbg !73
