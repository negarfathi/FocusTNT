...
main_bb5:
  ...
  %"13" = icmp slt i64 6, 0, !dbg !45
  %"14" = icmp sle i64 9, 0, !dbg !47
  %or.cond = or i1 %"13", %"14", !dbg !45
  %"15" = icmp sle i64 12, 0, !dbg !49
  %or.cond5 = or i1 %or.cond, %"15", !dbg !45
  %"16" = icmp sgt i64 12, 9, !dbg !51
