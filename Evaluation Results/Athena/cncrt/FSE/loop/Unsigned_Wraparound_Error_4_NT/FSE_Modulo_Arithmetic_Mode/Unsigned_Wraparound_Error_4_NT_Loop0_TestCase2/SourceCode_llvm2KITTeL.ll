...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !37), !dbg !39
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !40), !dbg !42
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %n.0 = phi i64 [ 16, %main_bb5 ], [ %"17", %main_bb7 ], [ %"22", %main_bb9 ], [ %"13", %main_bb8 ]
  %"12" = icmp sgt i64 %n.0, 0, !dbg !53
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !53

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = sub nsw i64 %n.0, 16, !dbg !41
  %"14" = icmp sgt i64 %"13", 4294967295, !dbg !55
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !55
...
main_bb8:                                         ; preds = %main_bb6
  ...
  br i1 %"18", label %main_bb9, label %main_wrap_around.exit, !dbg !57
...
!34 = metadata !{i64 16}
!35 = metadata !{i32 786688, metadata !9, metadata !"n", metadata !5, i32 25, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [n] [line 25]
!36 = metadata !{i32 25, i32 15, metadata !9, null}
!37 = metadata !{i32 786688, metadata !38, metadata !"len", metadata !5, i32 28, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [len] [line 28]
!38 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 5, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!39 = metadata !{i32 28, i32 19, metadata !38, null}
!40 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777229, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [value] [line 13]
!41 = metadata !{i32 33, i32 13, metadata !38, null}
!42 = metadata !{i32 13, i32 33, metadata !4, metadata !41}
!43 = metadata !{i64 0}
!44 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554445, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [lower_bound] [line 13]
!45 = metadata !{i32 13, i32 50, metadata !4, metadata !41}
!46 = metadata !{i64 4294967295}
!47 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331661, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [upper_bound] [line 13]
!48 = metadata !{i32 13, i32 73, metadata !4, metadata !41}
!49 = metadata !{i64 4294967296}
!50 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 14, metadata !8, i32 0, metadata !41} ; [ DW_TAG_auto_variable ] [range] [line 14]
!51 = metadata !{i32 14, i32 15, metadata !4, metadata !41}
!52 = metadata !{i32 26, i32 5, metadata !9, null}
!53 = metadata !{i32 26, i32 5, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !9, i32 26, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 15, i32 9, metadata !26, metadata !41}
!56 = metadata !{i32 16, i32 9, metadata !28, metadata !41}
!57 = metadata !{i32 18, i32 14, metadata !30, metadata !41}
!58 = metadata !{i32 19, i32 9, metadata !32, metadata !41}
!59 = metadata !{i32 35, i32 5, metadata !9, null}
