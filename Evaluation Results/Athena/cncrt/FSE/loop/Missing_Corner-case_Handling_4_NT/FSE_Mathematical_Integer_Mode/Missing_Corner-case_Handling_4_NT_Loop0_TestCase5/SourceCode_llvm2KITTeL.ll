...
main_bb10:
  ...
  %"45" = icmp sle i32 100000, 0, !dbg !98
  %"46" = icmp sgt i32 100000, 65534, !dbg !100
  %or.cond = or i1 %"45", %"46", !dbg !98
  br i1 %or.cond, label %main_bb19, label %main_bb11, !dbg !98

main_bb11:                                        ; preds = %main_bb10
  call void @llvm.dbg.value(metadata !95, i64 0, metadata !102), !dbg !104
  call void @llvm.dbg.value(metadata !47, i64 0, metadata !105), !dbg !107
  %"47" = load i32* @"'memory0_freeIndex", align 4, !dbg !108
  call void @llvm.dbg.value(metadata !{i32 %"47"}, i64 0, metadata !109), !dbg !110
  %"48" = load i32* @"'memory0_freeIndex", align 4, !dbg !111
  %"49" = add nsw i32 %"48", 8, !dbg !111
  store i32 %"49", i32* @"'memory0_freeIndex", align 4, !dbg !111
  call void @llvm.dbg.value(metadata !{i32 %"47"}, i64 0, metadata !112), !dbg !113
  %"50" = sext i32 %"47" to i64, !dbg !114
  %"51" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"50", !dbg !114
  %"52" = getelementptr inbounds %struct.NNode* %"51", i32 0, i32 0, !dbg !114
  store i32 1, i32* %"52", align 4, !dbg !114
  %"53" = sext i32 %"47" to i64, !dbg !115
  %"54" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"53", !dbg !115
  %"55" = getelementptr inbounds %struct.NNode* %"54", i32 0, i32 1, !dbg !115
  store i32 0, i32* %"55", align 4, !dbg !115
  call void @llvm.dbg.value(metadata !{i32 %"47"}, i64 0, metadata !116), !dbg !117
...
main_bb12:                                        ; preds = %main_bb13, %main_bb11
  %i.0.i = phi i32 [ 2, %main_bb11 ], [ %"73", %main_bb13 ], !dbg !103
  %cyclic.0.i = phi i32 [ %"47", %main_bb11 ], [ %"72", %main_bb13 ], !dbg !103
  %"56" = icmp sle i32 %i.0.i, 100000, !dbg !124
  br i1 %"56", label %main_bb13, label %main_initLink.exit, !dbg !124

main_bb13:                                        ; preds = %main_bb12
  %"57" = load i32* @"'memory0_freeIndex", align 4, !dbg !125
  %"58" = load i32* @"'memory0_freeIndex", align 4, !dbg !126
  %"59" = add nsw i32 %"58", 8, !dbg !126
  store i32 %"59", i32* @"'memory0_freeIndex", align 4, !dbg !126
  %"60" = sext i32 %"57" to i64, !dbg !127
  %"61" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"60", !dbg !127
  %"62" = getelementptr inbounds %struct.NNode* %"61", i32 0, i32 0, !dbg !127
  store i32 %i.0.i, i32* %"62", align 4, !dbg !127
  %"63" = sext i32 %"57" to i64, !dbg !128
  %"64" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"63", !dbg !128
  %"65" = getelementptr inbounds %struct.NNode* %"64", i32 0, i32 1, !dbg !128
  store i32 0, i32* %"65", align 4, !dbg !128
  %"66" = sext i32 %cyclic.0.i to i64, !dbg !129
  %"67" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"66", !dbg !129
  %"68" = getelementptr inbounds %struct.NNode* %"67", i32 0, i32 1, !dbg !129
  store i32 %"57", i32* %"68", align 4, !dbg !129
  %"69" = sext i32 %cyclic.0.i to i64, !dbg !130
  %"70" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"69", !dbg !130
  %"71" = getelementptr inbounds %struct.NNode* %"70", i32 0, i32 1, !dbg !130
  %"72" = load i32* %"71", align 4, !dbg !130
  %"73" = add nsw i32 %i.0.i, 1, !dbg !131
  br label %main_bb12, !dbg !131

main_initLink.exit:                               ; preds = %main_bb12
  %"74" = sext i32 %cyclic.0.i to i64, !dbg !132
  ...
  store i32 %"47", i32* %"76", align 4, !dbg !132
  call void @llvm.dbg.value(metadata !{i32 %"47"}, i64 0, metadata !133), !dbg !134
  call void @llvm.dbg.value(metadata !{i32 %"47"}, i64 0, metadata !135), !dbg !136
  call void @llvm.dbg.value(metadata !{i32 %"47"}, i64 0, metadata !137), !dbg !139
  call void @llvm.dbg.value(metadata !{i32 %"47"}, i64 0, metadata !140), !dbg !141
  br label %main_bb14, !dbg !142

main_bb14:                                        ; preds = %main_bb15, %main_initLink.exit
  %begin.0.i = phi i32 [ %"47", %main_initLink.exit ], [ %"85", %main_bb15 ], !dbg !138
  %"77" = sext i32 %begin.0.i to i64, !dbg !143
  %"78" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"77", !dbg !143
  %"79" = getelementptr inbounds %struct.NNode* %"78", i32 0, i32 1, !dbg !143
  %"80" = load i32* %"79", align 4, !dbg !143
  %"81" = icmp ne i32 %"80", %"47", !dbg !143
  br i1 %"81", label %main_bb15, label %main_findEnd.exit, !dbg !143

main_bb15:                                        ; preds = %main_bb14
  %"82" = sext i32 %begin.0.i to i64, !dbg !144
  %"83" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"82", !dbg !144
  %"84" = getelementptr inbounds %struct.NNode* %"83", i32 0, i32 1, !dbg !144
  %"85" = load i32* %"84", align 4, !dbg !144
...
main_findEnd.exit:                                ; preds = %main_bb14, %main_bb18
  ...
  %"86" = icmp ne i32 %node.0, 0, !dbg !145
  br i1 %"86", label %main_bb16, label %main_bb19, !dbg !145

main_bb16:                                        ; preds = %main_findEnd.exit
  %"87" = sext i32 %node.0 to i64, !dbg !147
  %"88" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"87", !dbg !147
  %"89" = getelementptr inbounds %struct.NNode* %"88", i32 0, i32 0, !dbg !147
  %"90" = load i32* %"89", align 4, !dbg !147
  %"91" = sitofp i32 %"90" to float, !dbg !147
  %"92" = fcmp ogt float %"91", %h.0, !dbg !147
  br i1 %"92", label %main_bb17, label %main_bb18, !dbg !147

main_bb17:                                        ; preds = %main_bb16
  %"93" = sext i32 %node.0 to i64, !dbg !150
  %"94" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"93", !dbg !150
  %"95" = getelementptr inbounds %struct.NNode* %"94", i32 0, i32 0, !dbg !150
  %"96" = load i32* %"95", align 4, !dbg !150
  %"97" = sitofp i32 %"96" to float, !dbg !150
  br label %main_bb18, !dbg !150

main_bb18:                                        ; preds = %main_bb17, %main_bb16
  %h.1 = phi float [ %"97", %main_bb17 ], [ %h.0, %main_bb16 ]
  %"98" = sext i32 %node.0 to i64, !dbg !151
  %"99" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"98", !dbg !151
  %"100" = getelementptr inbounds %struct.NNode* %"99", i32 0, i32 1, !dbg !151
  %"101" = load i32* %"100", align 4, !dbg !151
