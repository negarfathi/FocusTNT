...
main_bb17:
  ...
  %"67" = icmp sle i64 100000, 0, !dbg !139
  %"68" = icmp sgt i64 100000, 65534, !dbg !141
  %or.cond = or i1 %"67", %"68", !dbg !139
  br i1 %or.cond, label %main_bb28, label %main_bb18, !dbg !139

main_bb18:                                        ; preds = %main_bb17
  call void @llvm.dbg.value(metadata !136, i64 0, metadata !143), !dbg !145
  call void @llvm.dbg.value(metadata !71, i64 0, metadata !146), !dbg !148
  %"69" = load i32* @"'memory0_freeIndex", align 4, !dbg !149
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !150), !dbg !151
  %"70" = load i32* @"'memory0_freeIndex", align 4, !dbg !152
  %"71" = add nsw i32 %"70", 16, !dbg !152
  store i32 %"71", i32* @"'memory0_freeIndex", align 4, !dbg !152
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !153), !dbg !154
  %"72" = sext i32 %"69" to i64, !dbg !155
  %"73" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"72", !dbg !155
  %"74" = getelementptr inbounds %struct.NNode* %"73", i32 0, i32 0, !dbg !155
  store i64 1, i64* %"74", align 8, !dbg !155
  %"75" = sext i32 %"69" to i64, !dbg !156
  %"76" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"75", !dbg !156
  %"77" = getelementptr inbounds %struct.NNode* %"76", i32 0, i32 1, !dbg !156
  store i32 0, i32* %"77", align 4, !dbg !156
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !157), !dbg !158
...
main_wrap_around.exit.i:                          ; preds = %main_bb22, %main_bb21, %main_bb20, %main_bb18
  %i.0.i = phi i64 [ 2, %main_bb18 ], [ %"100", %main_bb20 ], [ %"105", %main_bb22 ], [ %"95", %main_bb21 ], !dbg !144
  %cyclic.0.i = phi i32 [ %"69", %main_bb18 ], [ %"94", %main_bb20 ], [ %"94", %main_bb21 ], [ %"94", %main_bb22 ], !dbg !144
  %"78" = icmp sle i64 %i.0.i, 100000, !dbg !172
  br i1 %"78", label %main_bb19, label %main_initLink.exit, !dbg !172

main_bb19:                                        ; preds = %main_wrap_around.exit.i
  %"79" = load i32* @"'memory0_freeIndex", align 4, !dbg !173
  %"80" = load i32* @"'memory0_freeIndex", align 4, !dbg !174
  %"81" = add nsw i32 %"80", 16, !dbg !174
  store i32 %"81", i32* @"'memory0_freeIndex", align 4, !dbg !174
  %"82" = sext i32 %"79" to i64, !dbg !175
  %"83" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"82", !dbg !175
  %"84" = getelementptr inbounds %struct.NNode* %"83", i32 0, i32 0, !dbg !175
  store i64 %i.0.i, i64* %"84", align 8, !dbg !175
  %"85" = sext i32 %"79" to i64, !dbg !176
  %"86" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"85", !dbg !176
  %"87" = getelementptr inbounds %struct.NNode* %"86", i32 0, i32 1, !dbg !176
  store i32 0, i32* %"87", align 4, !dbg !176
  %"88" = sext i32 %cyclic.0.i to i64, !dbg !177
  %"89" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"88", !dbg !177
  %"90" = getelementptr inbounds %struct.NNode* %"89", i32 0, i32 1, !dbg !177
  store i32 %"79", i32* %"90", align 4, !dbg !177
  %"91" = sext i32 %cyclic.0.i to i64, !dbg !178
  %"92" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"91", !dbg !178
  %"93" = getelementptr inbounds %struct.NNode* %"92", i32 0, i32 1, !dbg !178
  %"94" = load i32* %"93", align 4, !dbg !178
  %"95" = add nsw i64 %i.0.i, 1, !dbg !165
  %"96" = icmp sgt i64 %"95", 2147483647, !dbg !179
  br i1 %"96", label %main_bb20, label %main_bb21, !dbg !179

main_bb20:                                        ; preds = %main_bb19
  %"97" = sub nsw i64 %"95", 2147483647, !dbg !180
  %"98" = sub nsw i64 %"97", 1, !dbg !180
  %"99" = srem i64 %"98", 4294967296, !dbg !180
  %"100" = add nsw i64 -2147483648, %"99", !dbg !180
  br label %main_wrap_around.exit.i, !dbg !180

main_bb21:                                        ; preds = %main_bb19
  %"101" = icmp slt i64 %"95", -2147483648, !dbg !181
  br i1 %"101", label %main_bb22, label %main_wrap_around.exit.i, !dbg !181

main_bb22:                                        ; preds = %main_bb21
  %"102" = sub nsw i64 -2147483648, %"95", !dbg !182
  %"103" = sub nsw i64 %"102", 1, !dbg !182
  %"104" = srem i64 %"103", 4294967296, !dbg !182
  %"105" = sub nsw i64 2147483647, %"104", !dbg !182
  br label %main_wrap_around.exit.i, !dbg !182

main_initLink.exit:                               ; preds = %main_wrap_around.exit.i
  %"106" = sext i32 %cyclic.0.i to i64, !dbg !183
  ...
  store i32 %"69", i32* %"108", align 4, !dbg !183
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !184), !dbg !185
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !186), !dbg !187
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !188), !dbg !190
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !191), !dbg !192
  br label %main_bb23, !dbg !193

main_bb23:                                        ; preds = %main_bb24, %main_initLink.exit
  %begin.0.i = phi i32 [ %"69", %main_initLink.exit ], [ %"117", %main_bb24 ], !dbg !189
  %"109" = sext i32 %begin.0.i to i64, !dbg !194
  %"110" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"109", !dbg !194
  %"111" = getelementptr inbounds %struct.NNode* %"110", i32 0, i32 1, !dbg !194
  %"112" = load i32* %"111", align 4, !dbg !194
  %"113" = icmp ne i32 %"112", %"69", !dbg !194
  br i1 %"113", label %main_bb24, label %main_findEnd.exit, !dbg !194

main_bb24:                                        ; preds = %main_bb23
  %"114" = sext i32 %begin.0.i to i64, !dbg !195
  %"115" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"114", !dbg !195
  %"116" = getelementptr inbounds %struct.NNode* %"115", i32 0, i32 1, !dbg !195
  %"117" = load i32* %"116", align 4, !dbg !195
...
main_findEnd.exit:                                ; preds = %main_bb23, %main_bb27
  ...
  %"118" = icmp ne i32 %node.0, 0, !dbg !197
  br i1 %"118", label %main_bb25, label %main_bb28, !dbg !197

main_bb25:                                        ; preds = %main_findEnd.exit
  %"119" = sext i32 %node.0 to i64, !dbg !199
  %"120" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"119", !dbg !199
  %"121" = getelementptr inbounds %struct.NNode* %"120", i32 0, i32 0, !dbg !199
  %"122" = load i64* %"121", align 8, !dbg !199
  %"123" = icmp sgt i64 %"122", %h.0, !dbg !199
  br i1 %"123", label %main_bb26, label %main_bb27, !dbg !199

main_bb26:                                        ; preds = %main_bb25
  %"124" = sext i32 %node.0 to i64, !dbg !202
  %"125" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"124", !dbg !202
  %"126" = getelementptr inbounds %struct.NNode* %"125", i32 0, i32 0, !dbg !202
  %"127" = load i64* %"126", align 8, !dbg !202
  br label %main_bb27, !dbg !204

main_bb27:                                        ; preds = %main_bb26, %main_bb25
  %h.1 = phi i64 [ %"127", %main_bb26 ], [ %h.0, %main_bb25 ]
  %"128" = sext i32 %node.0 to i64, !dbg !205
  %"129" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"128", !dbg !205
  %"130" = getelementptr inbounds %struct.NNode* %"129", i32 0, i32 1, !dbg !205
  %"131" = load i32* %"130", align 4, !dbg !205
