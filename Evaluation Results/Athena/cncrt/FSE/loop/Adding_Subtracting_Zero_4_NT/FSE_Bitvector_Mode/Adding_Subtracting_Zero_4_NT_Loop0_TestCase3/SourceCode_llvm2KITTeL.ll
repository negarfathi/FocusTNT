...
main_bb7:
  ...
  br i1 %"10", label %main_bb14, label %main_bb8, !dbg !49

main_bb8:                                         ; preds = %main_bb7
  call void @llvm.dbg.value(metadata !21, i64 0, metadata !51), !dbg !52
  call void @llvm.dbg.value(metadata !{i32 %buf.0}, i64 0, metadata !53), !dbg !56
  call void @llvm.dbg.value(metadata !{i32 %count.0}, i64 0, metadata !57), !dbg !58
  call void @llvm.dbg.value(metadata !21, i64 0, metadata !59), !dbg !60
  %"11" = load i32* @"'flag", align 4, !dbg !61
  call void @llvm.dbg.value(metadata !{i32 %.0.i}, i64 0, metadata !62), !dbg !63
  call void @llvm.dbg.value(metadata !{i32 %"18"}, i64 0, metadata !47), !dbg !48
  call void @llvm.dbg.value(metadata !{i32 %"19"}, i64 0, metadata !51), !dbg !52
  br label %main_bb9, !dbg !64

main_bb9:                                         ; preds = %main_bb13, %main_bb8
  %buf.0 = phi i32 [ 0, %main_bb8 ], [ %"19", %main_bb13 ]
  %count.0 = phi i32 [ 3, %main_bb8 ], [ %"18", %main_bb13 ]
  %"12" = icmp sgt i32 %count.0, 0, !dbg !65
  br i1 %"12", label %main_bb10, label %main_bb14, !dbg !65

main_bb10:                                        ; preds = %main_bb9
  %"13" = icmp eq i32 %"11", 1, !dbg !61
  br i1 %"13", label %main_read.exit, label %main_bb11, !dbg !61

main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %count.0.i = phi i32 [ %"15", %main_bb12 ], [ 0, %main_bb10 ], !dbg !54
  %.01.i = phi i32 [ %"16", %main_bb12 ], [ %buf.0, %main_bb10 ], !dbg !54
  %"14" = icmp slt i32 %.01.i, %count.0, !dbg !67
  br i1 %"14", label %main_bb12, label %main_read.exit, !dbg !67

main_bb12:                                        ; preds = %main_bb11
  %"15" = add nsw i32 %count.0.i, 1, !dbg !68
  %"16" = add nsw i32 %.01.i, 1, !dbg !69
  br label %main_bb11, !dbg !70

main_read.exit:                                   ; preds = %main_bb10, %main_bb11
  %.0.i = phi i32 [ 0, %main_bb10 ], [ %count.0.i, %main_bb11 ], !dbg !54
  %"17" = icmp slt i32 %.0.i, 0, !dbg !71
  br i1 %"17", label %main_bb14, label %main_bb13, !dbg !71

main_bb13:                                        ; preds = %main_read.exit
  %"18" = sub nsw i32 %count.0, %.0.i, !dbg !73
  %"19" = add nsw i32 %buf.0, %.0.i, !dbg !74
  br label %main_bb9, !dbg !75

main_bb14:                                        ; preds = %main_bb9, %main_read.exit, %main_bb7
  ret i32 0, !dbg !76
}
...
!53 = metadata !{i32 786689, metadata !4, metadata !"loc", metadata !5, i32 16777226, metadata !8, i32 0, metadata !54} ; [ DW_TAG_arg_variable ] [loc] [line 10]
...
!56 = metadata !{i32 10, i32 15, metadata !4, metadata !54}
!57 = metadata !{i32 786689, metadata !4, metadata !"len", metadata !5, i32 33554442, metadata !8, i32 0, metadata !54} ; [ DW_TAG_arg_variable ] [len] [line 10]
!58 = metadata !{i32 10, i32 25, metadata !4, metadata !54}
!59 = metadata !{i32 786688, metadata !4, metadata !"count", metadata !5, i32 12, metadata !8, i32 0, metadata !54} ; [ DW_TAG_auto_variable ] [count] [line 12]
!60 = metadata !{i32 12, i32 9, metadata !4, metadata !54}
!61 = metadata !{i32 13, i32 9, metadata !25, metadata !54}
!62 = metadata !{i32 786688, metadata !9, metadata !"ret", metadata !5, i32 47, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ret] [line 47]
!63 = metadata !{i32 47, i32 9, metadata !9, null}
!64 = metadata !{i32 49, i32 5, metadata !9, null}
!65 = metadata !{i32 49, i32 5, metadata !66, null}
!66 = metadata !{i32 786443, metadata !1, metadata !9, i32 49, i32 5, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!67 = metadata !{i32 15, i32 5, metadata !27, metadata !54}
!68 = metadata !{i32 27, i32 13, metadata !33, metadata !54}
!69 = metadata !{i32 30, i32 17, metadata !40, metadata !54}
!70 = metadata !{i32 31, i32 17, metadata !40, metadata !54}
!71 = metadata !{i32 52, i32 13, metadata !72, null}
!72 = metadata !{i32 786443, metadata !1, metadata !55, i32 52, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!73 = metadata !{i32 54, i32 9, metadata !55, null}
!74 = metadata !{i32 55, i32 9, metadata !55, null}
!75 = metadata !{i32 56, i32 5, metadata !55, null}
!76 = metadata !{i32 58, i32 1, metadata !9, null} ; [ DW_TAG_imported_module ]
