...
main_bb21:
  ...
  br i1 %"52", label %main_bb30, label %main_bb22, !dbg !83
...
main_bb22:                                        ; preds = %main_bb21
  ...
  call void @llvm.dbg.value(metadata !{i64 %"58"}, i64 0, metadata !98), !dbg !100
  ...
  call void @llvm.dbg.value(metadata !{i64 %"69"}, i64 0, metadata !110), !dbg !112
...
main_wrap_around.exit:                            ; preds = %main_bb29, %main_bb28, %main_bb27, %main_bb22
  ...
  %count.0 = phi i64 [ 5, %main_bb22 ], [ %.0.i2, %main_bb27 ], [ %.0.i2, %main_bb28 ], [ %.0.i2, %main_bb29 ]
  %"54" = icmp sgt i64 %count.0, 0, !dbg !120
  br i1 %"54", label %main_read.exit, label %main_bb30, !dbg !120

main_read.exit:                                   ; preds = %main_wrap_around.exit
  %"55" = icmp ne i64 %"53", 1, !dbg !95
  %"56" = icmp slt i64 %buf.0, %count.0, !dbg !122
  %or.cond = and i1 %"55", %"56", !dbg !95
  %.0.i = select i1 %or.cond, i64 -1, i64 0, !dbg !95
  %"57" = icmp slt i64 %.0.i, 0, !dbg !123
  br i1 %"57", label %main_bb30, label %main_bb23, !dbg !123

main_bb23:                                        ; preds = %main_read.exit
  %"58" = sub nsw i64 %count.0, %.0.i, !dbg !99
  %"59" = icmp sgt i64 %"58", 2147483647, !dbg !125
  br i1 %"59", label %main_bb24, label %main_bb25, !dbg !125

main_bb24:                                        ; preds = %main_bb23
  %"60" = sub nsw i64 %"58", 2147483647, !dbg !126
  %"61" = sub nsw i64 %"60", 1, !dbg !126
  %"62" = srem i64 %"61", 4294967296, !dbg !126
  %"63" = add nsw i64 -2147483648, %"62", !dbg !126
  br label %main_wrap_around.exit3, !dbg !126

main_bb25:                                        ; preds = %main_bb23
  %"64" = icmp slt i64 %"58", -2147483648, !dbg !127
  br i1 %"64", label %main_bb26, label %main_wrap_around.exit3, !dbg !127

main_bb26:                                        ; preds = %main_bb25
  %"65" = sub nsw i64 -2147483648, %"58", !dbg !128
  %"66" = sub nsw i64 %"65", 1, !dbg !128
  %"67" = srem i64 %"66", 4294967296, !dbg !128
  %"68" = sub nsw i64 2147483647, %"67", !dbg !128
  br label %main_wrap_around.exit3, !dbg !128

main_wrap_around.exit3:                           ; preds = %main_bb24, %main_bb25, %main_bb26
  %.0.i2 = phi i64 [ %"63", %main_bb24 ], [ %"68", %main_bb26 ], [ %"58", %main_bb25 ], !dbg !99
  %"69" = add nsw i64 %buf.0, %.0.i, !dbg !111
  %"70" = icmp sgt i64 %"69", 2147483647, !dbg !129
  br i1 %"70", label %main_bb27, label %main_bb28, !dbg !129

main_bb27:                                        ; preds = %main_wrap_around.exit3
  %"71" = sub nsw i64 %"69", 2147483647, !dbg !130
  %"72" = sub nsw i64 %"71", 1, !dbg !130
  %"73" = srem i64 %"72", 4294967296, !dbg !130
  %"74" = add nsw i64 -2147483648, %"73", !dbg !130
  br label %main_wrap_around.exit, !dbg !130

main_bb28:                                        ; preds = %main_wrap_around.exit3
  %"75" = icmp slt i64 %"69", -2147483648, !dbg !131
  br i1 %"75", label %main_bb29, label %main_wrap_around.exit, !dbg !131

main_bb29:                                        ; preds = %main_bb28
  %"76" = sub nsw i64 -2147483648, %"69", !dbg !132
  %"77" = sub nsw i64 %"76", 1, !dbg !132
  %"78" = srem i64 %"77", 4294967296, !dbg !132
  %"79" = sub nsw i64 2147483647, %"78", !dbg !132
  br label %main_wrap_around.exit, !dbg !132

main_bb30:                                        ; preds = %main_wrap_around.exit, %main_read.exit, %main_bb21
  ret i32 0, !dbg !133
}
...
!123 = metadata !{i32 70, i32 13, metadata !124, null}
!124 = metadata !{i32 786443, metadata !1, metadata !89, i32 70, i32 13, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!125 = metadata !{i32 14, i32 9, metadata !31, metadata !99}
!126 = metadata !{i32 15, i32 9, metadata !33, metadata !99}
!127 = metadata !{i32 17, i32 14, metadata !35, metadata !99}
!128 = metadata !{i32 18, i32 9, metadata !37, metadata !99}
!129 = metadata !{i32 14, i32 9, metadata !31, metadata !111}
!130 = metadata !{i32 15, i32 9, metadata !33, metadata !111}
!131 = metadata !{i32 17, i32 14, metadata !35, metadata !111}
!132 = metadata !{i32 18, i32 9, metadata !37, metadata !111}
!133 = metadata !{i32 78, i32 1, metadata !12, null}
