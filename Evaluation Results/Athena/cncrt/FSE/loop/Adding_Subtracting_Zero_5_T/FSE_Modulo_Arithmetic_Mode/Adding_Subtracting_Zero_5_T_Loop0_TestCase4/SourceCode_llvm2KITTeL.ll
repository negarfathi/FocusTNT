...
define i32 @main() #0 {
main_bb12:
  call void @llvm.dbg.value(metadata !111, i64 0, metadata !112), !dbg !113
  %"49" = icmp sle i64 100000, 0, !dbg !114
  %"50" = icmp sgt i64 100000, 65534, !dbg !116
  %or.cond = or i1 %"49", %"50", !dbg !114
  br i1 %or.cond, label %main_bb20, label %main_bb13, !dbg !114

main_bb13:                                        ; preds = %main_bb12
  call void @llvm.dbg.value(metadata !111, i64 0, metadata !118), !dbg !120
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !121), !dbg !123
  %"51" = load i32* @"'memory0_freeIndex", align 4, !dbg !124
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !125), !dbg !126
  %"52" = load i32* @"'memory0_freeIndex", align 4, !dbg !127
  %"53" = add nsw i32 %"52", 4, !dbg !127
  store i32 %"53", i32* @"'memory0_freeIndex", align 4, !dbg !127
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !128), !dbg !129
  %"54" = sext i32 %"51" to i64, !dbg !130
  %"55" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"54", !dbg !130
  %"56" = getelementptr inbounds %struct.NNode* %"55", i32 0, i32 0, !dbg !130
  store i32 %"51", i32* %"56", align 4, !dbg !130
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !131), !dbg !132
...
main_wrap_around.exit.i:                          ; preds = %main_bb17, %main_bb16, %main_bb15, %main_bb13
  %i.0.i = phi i64 [ 2, %main_bb13 ], [ %"76", %main_bb15 ], [ %"81", %main_bb17 ], [ %"71", %main_bb16 ], !dbg !119
  %cyclic.0.i = phi i32 [ %"51", %main_bb13 ], [ %"70", %main_bb15 ], [ %"70", %main_bb16 ], [ %"70", %main_bb17 ], !dbg !119
  %"57" = icmp sle i64 %i.0.i, 100000, !dbg !146
  br i1 %"57", label %main_bb14, label %main_initLink.exit, !dbg !146

main_bb14:                                        ; preds = %main_wrap_around.exit.i
  %"58" = load i32* @"'memory0_freeIndex", align 4, !dbg !147
  %"59" = load i32* @"'memory0_freeIndex", align 4, !dbg !148
  %"60" = add nsw i32 %"59", 4, !dbg !148
  store i32 %"60", i32* @"'memory0_freeIndex", align 4, !dbg !148
  %"61" = sext i32 %"58" to i64, !dbg !149
  %"62" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"61", !dbg !149
  %"63" = getelementptr inbounds %struct.NNode* %"62", i32 0, i32 0, !dbg !149
  store i32 %"58", i32* %"63", align 4, !dbg !149
  %"64" = sext i32 %cyclic.0.i to i64, !dbg !150
  %"65" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"64", !dbg !150
  %"66" = getelementptr inbounds %struct.NNode* %"65", i32 0, i32 0, !dbg !150
  store i32 %"58", i32* %"66", align 4, !dbg !150
  %"67" = sext i32 %cyclic.0.i to i64, !dbg !151
  %"68" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"67", !dbg !151
  %"69" = getelementptr inbounds %struct.NNode* %"68", i32 0, i32 0, !dbg !151
  %"70" = load i32* %"69", align 4, !dbg !151
  %"71" = add nsw i64 %i.0.i, 1, !dbg !139
  %"72" = icmp sgt i64 %"71", 2147483647, !dbg !152
  br i1 %"72", label %main_bb15, label %main_bb16, !dbg !152

main_bb15:                                        ; preds = %main_bb14
  %"73" = sub nsw i64 %"71", 2147483647, !dbg !153
  %"74" = sub nsw i64 %"73", 1, !dbg !153
  %"75" = srem i64 %"74", 4294967296, !dbg !153
  %"76" = add nsw i64 -2147483648, %"75", !dbg !153
  br label %main_wrap_around.exit.i, !dbg !153

main_bb16:                                        ; preds = %main_bb14
  %"77" = icmp slt i64 %"71", -2147483648, !dbg !154
  br i1 %"77", label %main_bb17, label %main_wrap_around.exit.i, !dbg !154

main_bb17:                                        ; preds = %main_bb16
  %"78" = sub nsw i64 -2147483648, %"71", !dbg !155
  %"79" = sub nsw i64 %"78", 1, !dbg !155
  %"80" = srem i64 %"79", 4294967296, !dbg !155
  %"81" = sub nsw i64 2147483647, %"80", !dbg !155
  br label %main_wrap_around.exit.i, !dbg !155

main_initLink.exit:                               ; preds = %main_wrap_around.exit.i
  %"82" = sext i32 %cyclic.0.i to i64, !dbg !156
  %"83" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"82", !dbg !156
  %"84" = getelementptr inbounds %struct.NNode* %"83", i32 0, i32 0, !dbg !156
  store i32 %cyclic.0.i, i32* %"84", align 4, !dbg !156
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !157), !dbg !158
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !159), !dbg !160
  call void @llvm.dbg.value(metadata !{i32 %"89"}, i64 0, metadata !161), !dbg !163
  call void @llvm.dbg.value(metadata !{i32 %"89"}, i64 0, metadata !159), !dbg !160
  br label %main_bb18, !dbg !164

main_bb18:                                        ; preds = %main_bb19, %main_initLink.exit
  %ip.0 = phi i32 [ %"51", %main_initLink.exit ], [ %"89", %main_bb19 ]
  %"85" = icmp ne i32 %ip.0, 0, !dbg !165
  br i1 %"85", label %main_bb19, label %main_bb20, !dbg !165

main_bb19:                                        ; preds = %main_bb18
  %"86" = sext i32 %ip.0 to i64, !dbg !167
  %"87" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"86", !dbg !167
  %"88" = getelementptr inbounds %struct.NNode* %"87", i32 0, i32 0, !dbg !167
  %"89" = load i32* %"88", align 4, !dbg !167
  %"90" = icmp eq i32 %ip.0, %"89", !dbg !168
  br i1 %"90", label %main_bb20, label %main_bb18, !dbg !168
...
!117 = metadata !{i32 786443, metadata !1, metadata !115, i32 54, i32 9, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!166 = metadata !{i32 786443, metadata !1, metadata !16, i32 60, i32 5, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!167 = metadata !{i32 62, i32 9, metadata !162, null}
!168 = metadata !{i32 63, i32 13, metadata !169, null}
!169 = metadata !{i32 786443, metadata !1, metadata !162, i32 63, i32 13, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!170 = metadata !{i32 70, i32 1, metadata !16, null}
