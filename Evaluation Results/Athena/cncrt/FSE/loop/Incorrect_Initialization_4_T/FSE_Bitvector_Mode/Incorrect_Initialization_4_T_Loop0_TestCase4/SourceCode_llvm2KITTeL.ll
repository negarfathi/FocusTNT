...
main_bb0:
  ...
  %"2" = icmp sle i32 1, 0, !dbg !25
  %or.cond1 = or i1 %or.cond, %"2", !dbg !21
  %"3" = icmp sgt i32 1, 0, !dbg !27
  %or.cond2 = or i1 %or.cond1, %"3", !dbg !21
  %"4" = icmp sgt i32 0, 65534, !dbg !29
...
main_bb1:                                         ; preds = %main_bb0
  ...
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !34), !dbg !35
  call void @llvm.dbg.value(metadata !{i32 %"10"}, i64 0, metadata !32), !dbg !33
  %"6" = srem i32 10, 1, !dbg !36
