...
main_bb5:
  ...
  %"12" = icmp slt i64 7, 0, !dbg !43
  %"13" = icmp sle i64 8, 0, !dbg !45
  %or.cond = or i1 %"12", %"13", !dbg !43
  %"14" = icmp sle i64 0, 0, !dbg !47
  %or.cond5 = or i1 %or.cond, %"14", !dbg !43
  %"15" = icmp sgt i64 0, 8, !dbg !49
  %or.cond6 = or i1 %or.cond5, %"15", !dbg !43
  %"16" = icmp sgt i64 8, 65534, !dbg !51
...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  ...
  call void @llvm.dbg.value(metadata !40, i64 0, metadata !71), !dbg !72
