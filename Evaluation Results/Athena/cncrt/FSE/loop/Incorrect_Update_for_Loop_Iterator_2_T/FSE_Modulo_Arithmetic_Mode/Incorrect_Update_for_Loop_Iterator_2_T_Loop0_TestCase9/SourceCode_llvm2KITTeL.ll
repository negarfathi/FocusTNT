...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  ...
  %"23" = icmp ne i64 %.0.i, 0, !dbg !77
  br i1 %"23", label %main_bb10, label %main_wrap_around.exit6, !dbg !77

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"24" = add nsw i64 %.0.i, -1, !dbg !78
  %"25" = icmp sgt i64 %"24", 255, !dbg !80
  br i1 %"25", label %main_bb11, label %main_bb12, !dbg !80

main_bb11:                                        ; preds = %main_bb10
  %"26" = sub nsw i64 %"24", 255, !dbg !81
  %"27" = sub nsw i64 %"26", 1, !dbg !81
  %"28" = srem i64 %"27", 256, !dbg !81
  br label %main_wrap_around.exit6, !dbg !81

main_bb12:                                        ; preds = %main_bb10
  %"29" = icmp slt i64 %"24", 0, !dbg !82
  br i1 %"29", label %main_bb13, label %main_wrap_around.exit6, !dbg !82

main_bb13:                                        ; preds = %main_bb12
  %"30" = sub nsw i64 0, %"24", !dbg !83
  %"31" = sub nsw i64 %"30", 1, !dbg !83
  %"32" = srem i64 %"31", 256, !dbg !83
  %"33" = sub nsw i64 255, %"32", !dbg !83
