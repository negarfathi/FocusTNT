...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %h.0 = phi i64 [ 4, %main_bb5 ], [ %"21", %main_bb7 ], [ %"26", %main_bb9 ], [ %"16", %main_bb8 ]
  %linesToRead.0 = phi i64 [ 1, %main_bb5 ], [ %h.0.linesToRead.0, %main_bb7 ], [ %h.0.linesToRead.0, %main_bb8 ], [ %h.0.linesToRead.0, %main_bb9 ]
  %"13" = icmp ne i64 %linesToRead.0, 0, !dbg !39
  %"14" = icmp sgt i64 %h.0, 0, !dbg !41
  %. = select i1 %"13", i1 %"14", i1 false, !dbg !39
  br i1 %., label %main_bb6, label %main_bb10, !dbg !43

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"15" = icmp sgt i64 %linesToRead.0, %h.0, !dbg !45
  %h.0.linesToRead.0 = select i1 %"15", i64 %h.0, i64 %linesToRead.0, !dbg !45
  %"16" = sub nsw i64 %h.0, %h.0.linesToRead.0, !dbg !48
...
!41 = metadata !{i32 30, i32 5, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 5, i32 2, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 30, i32 5, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 5, i32 3, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 32, i32 13, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !47, i32 32, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 36, i32 13, metadata !47, null}
