...
main_bb9:
  ...
  %"42" = icmp sle i32 100000, 0, !dbg !88
  %"43" = icmp sgt i32 100000, 65534, !dbg !90
  %or.cond = or i1 %"42", %"43", !dbg !88
  br i1 %or.cond, label %main_bb18, label %main_bb10, !dbg !88

main_bb10:                                        ; preds = %main_bb9
  call void @llvm.dbg.value(metadata !85, i64 0, metadata !92), !dbg !94
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !95), !dbg !97
  %"44" = load i32* @"'memory0_freeIndex", align 4, !dbg !98
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !99), !dbg !100
  %"45" = load i32* @"'memory0_freeIndex", align 4, !dbg !101
  %"46" = add nsw i32 %"45", 8, !dbg !101
  store i32 %"46", i32* @"'memory0_freeIndex", align 4, !dbg !101
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !102), !dbg !103
  %"47" = sext i32 %"44" to i64, !dbg !104
  %"48" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"47", !dbg !104
  %"49" = getelementptr inbounds %struct.NNode* %"48", i32 0, i32 0, !dbg !104
  store i32 1, i32* %"49", align 4, !dbg !104
  %"50" = sext i32 %"44" to i64, !dbg !105
  %"51" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"50", !dbg !105
  %"52" = getelementptr inbounds %struct.NNode* %"51", i32 0, i32 1, !dbg !105
...
main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %i.0.i = phi i32 [ 2, %main_bb10 ], [ %"70", %main_bb12 ], !dbg !93
  %cyclic.0.i = phi i32 [ %"44", %main_bb10 ], [ %"69", %main_bb12 ], !dbg !93
  %"53" = icmp sle i32 %i.0.i, 100000, !dbg !114
  br i1 %"53", label %main_bb12, label %main_initLink.exit, !dbg !114

main_bb12:                                        ; preds = %main_bb11
  %"54" = load i32* @"'memory0_freeIndex", align 4, !dbg !115
  %"55" = load i32* @"'memory0_freeIndex", align 4, !dbg !116
  %"56" = add nsw i32 %"55", 8, !dbg !116
  store i32 %"56", i32* @"'memory0_freeIndex", align 4, !dbg !116
  %"57" = sext i32 %"54" to i64, !dbg !117
  %"58" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"57", !dbg !117
  %"59" = getelementptr inbounds %struct.NNode* %"58", i32 0, i32 0, !dbg !117
  store i32 %i.0.i, i32* %"59", align 4, !dbg !117
  %"60" = sext i32 %"54" to i64, !dbg !118
  %"61" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"60", !dbg !118
  %"62" = getelementptr inbounds %struct.NNode* %"61", i32 0, i32 1, !dbg !118
  store i32 0, i32* %"62", align 4, !dbg !118
  %"63" = sext i32 %cyclic.0.i to i64, !dbg !119
  %"64" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"63", !dbg !119
  %"65" = getelementptr inbounds %struct.NNode* %"64", i32 0, i32 1, !dbg !119
  store i32 %"54", i32* %"65", align 4, !dbg !119
  %"66" = sext i32 %cyclic.0.i to i64, !dbg !120
  %"67" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"66", !dbg !120
  %"68" = getelementptr inbounds %struct.NNode* %"67", i32 0, i32 1, !dbg !120
  %"69" = load i32* %"68", align 4, !dbg !120
  %"70" = add nsw i32 %i.0.i, 1, !dbg !121
  br label %main_bb11, !dbg !121

main_initLink.exit:                               ; preds = %main_bb11
  %"71" = sext i32 %cyclic.0.i to i64, !dbg !122
  %"72" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"71", !dbg !122
  %"73" = getelementptr inbounds %struct.NNode* %"72", i32 0, i32 1, !dbg !122
  store i32 %"44", i32* %"73", align 4, !dbg !122
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !123), !dbg !124
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !125), !dbg !126
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !127), !dbg !129
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !130), !dbg !131
  br label %main_bb13, !dbg !132

main_bb13:                                        ; preds = %main_bb14, %main_initLink.exit
  %begin.0.i = phi i32 [ %"44", %main_initLink.exit ], [ %"82", %main_bb14 ], !dbg !128
  %"74" = sext i32 %begin.0.i to i64, !dbg !133
  %"75" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"74", !dbg !133
  %"76" = getelementptr inbounds %struct.NNode* %"75", i32 0, i32 1, !dbg !133
  %"77" = load i32* %"76", align 4, !dbg !133
  %"78" = icmp ne i32 %"77", %"44", !dbg !133
  br i1 %"78", label %main_bb14, label %main_findEnd.exit, !dbg !133

main_bb14:                                        ; preds = %main_bb13
  %"79" = sext i32 %begin.0.i to i64, !dbg !134
  %"80" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"79", !dbg !134
  %"81" = getelementptr inbounds %struct.NNode* %"80", i32 0, i32 1, !dbg !134
  %"82" = load i32* %"81", align 4, !dbg !134
...
main_findEnd.exit:                                ; preds = %main_bb13, %main_bb17
  ...
  %"83" = icmp ne i32 %node.0, %begin.0.i, !dbg !135
  br i1 %"83", label %main_bb15, label %main_bb18, !dbg !135

main_bb15:                                        ; preds = %main_findEnd.exit
  %"84" = sext i32 %node.0 to i64, !dbg !137
  %"85" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"84", !dbg !137
  %"86" = getelementptr inbounds %struct.NNode* %"85", i32 0, i32 0, !dbg !137
  %"87" = load i32* %"86", align 4, !dbg !137
  %"88" = sitofp i32 %"87" to float, !dbg !137
  %"89" = fcmp ogt float %"88", %h.0, !dbg !137
  br i1 %"89", label %main_bb16, label %main_bb17, !dbg !137

main_bb16:                                        ; preds = %main_bb15
  %"90" = sext i32 %node.0 to i64, !dbg !140
  %"91" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"90", !dbg !140
  %"92" = getelementptr inbounds %struct.NNode* %"91", i32 0, i32 0, !dbg !140
  %"93" = load i32* %"92", align 4, !dbg !140
  %"94" = sitofp i32 %"93" to float, !dbg !140
  br label %main_bb17, !dbg !140

main_bb17:                                        ; preds = %main_bb16, %main_bb15
  %h.1 = phi float [ %"94", %main_bb16 ], [ %h.0, %main_bb15 ]
  %"95" = sext i32 %node.0 to i64, !dbg !141
  %"96" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"95", !dbg !141
  %"97" = getelementptr inbounds %struct.NNode* %"96", i32 0, i32 1, !dbg !141
  %"98" = load i32* %"97", align 4, !dbg !141
