...
define i32 @main() #0 {
main_bb16:
  call void @llvm.dbg.value(metadata !75, i64 0, metadata !126), !dbg !127
  %"64" = icmp sle i64 2, 0, !dbg !128
  %"65" = icmp sgt i64 2, 65534, !dbg !130
  %or.cond = or i1 %"64", %"65", !dbg !128
  br i1 %or.cond, label %main_bb27, label %main_bb17, !dbg !128

main_bb17:                                        ; preds = %main_bb16
  call void @llvm.dbg.value(metadata !75, i64 0, metadata !132), !dbg !134
  call void @llvm.dbg.value(metadata !61, i64 0, metadata !135), !dbg !137
  %"66" = load i32* @"'memory0_freeIndex", align 4, !dbg !138
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !139), !dbg !140
  %"67" = load i32* @"'memory0_freeIndex", align 4, !dbg !141
  %"68" = add nsw i32 %"67", 16, !dbg !141
  store i32 %"68", i32* @"'memory0_freeIndex", align 4, !dbg !141
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !142), !dbg !143
  %"69" = sext i32 %"66" to i64, !dbg !144
  %"70" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"69", !dbg !144
  %"71" = getelementptr inbounds %struct.NNode* %"70", i32 0, i32 0, !dbg !144
  store i64 1, i64* %"71", align 8, !dbg !144
  %"72" = sext i32 %"66" to i64, !dbg !145
  %"73" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"72", !dbg !145
  %"74" = getelementptr inbounds %struct.NNode* %"73", i32 0, i32 1, !dbg !145
  store i32 0, i32* %"74", align 4, !dbg !145
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !146), !dbg !147
  call void @llvm.dbg.value(metadata !75, i64 0, metadata !148), !dbg !149
  call void @llvm.dbg.value(metadata !61, i64 0, metadata !150), !dbg !152
  call void @llvm.dbg.value(metadata !90, i64 0, metadata !153), !dbg !155
  call void @llvm.dbg.value(metadata !93, i64 0, metadata !156), !dbg !157
  call void @llvm.dbg.value(metadata !96, i64 0, metadata !158), !dbg !159
  br label %main_wrap_around.exit.i, !dbg !160

main_wrap_around.exit.i:                          ; preds = %main_bb21, %main_bb20, %main_bb19, %main_bb17
  %i.0.i = phi i64 [ 2, %main_bb17 ], [ %"97", %main_bb19 ], [ %"102", %main_bb21 ], [ %"92", %main_bb20 ], !dbg !133
  %cyclic.0.i = phi i32 [ %"66", %main_bb17 ], [ %"91", %main_bb19 ], [ %"91", %main_bb20 ], [ %"91", %main_bb21 ], !dbg !133
  %"75" = icmp sle i64 %i.0.i, 2, !dbg !161
  br i1 %"75", label %main_bb18, label %main_initLink.exit, !dbg !161

main_bb18:                                        ; preds = %main_wrap_around.exit.i
  %"76" = load i32* @"'memory0_freeIndex", align 4, !dbg !162
  %"77" = load i32* @"'memory0_freeIndex", align 4, !dbg !163
  %"78" = add nsw i32 %"77", 16, !dbg !163
  store i32 %"78", i32* @"'memory0_freeIndex", align 4, !dbg !163
  %"79" = sext i32 %"76" to i64, !dbg !164
  %"80" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"79", !dbg !164
  %"81" = getelementptr inbounds %struct.NNode* %"80", i32 0, i32 0, !dbg !164
  store i64 %i.0.i, i64* %"81", align 8, !dbg !164
  %"82" = sext i32 %"76" to i64, !dbg !165
  %"83" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"82", !dbg !165
  %"84" = getelementptr inbounds %struct.NNode* %"83", i32 0, i32 1, !dbg !165
  store i32 0, i32* %"84", align 4, !dbg !165
  %"85" = sext i32 %cyclic.0.i to i64, !dbg !166
  %"86" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"85", !dbg !166
  %"87" = getelementptr inbounds %struct.NNode* %"86", i32 0, i32 1, !dbg !166
  store i32 %"76", i32* %"87", align 4, !dbg !166
  %"88" = sext i32 %cyclic.0.i to i64, !dbg !167
  %"89" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"88", !dbg !167
  %"90" = getelementptr inbounds %struct.NNode* %"89", i32 0, i32 1, !dbg !167
  %"91" = load i32* %"90", align 4, !dbg !167
  %"92" = add nsw i64 %i.0.i, 1, !dbg !154
  %"93" = icmp sgt i64 %"92", 2147483647, !dbg !168
  br i1 %"93", label %main_bb19, label %main_bb20, !dbg !168

main_bb19:                                        ; preds = %main_bb18
  %"94" = sub nsw i64 %"92", 2147483647, !dbg !169
  %"95" = sub nsw i64 %"94", 1, !dbg !169
  %"96" = srem i64 %"95", 4294967296, !dbg !169
  %"97" = add nsw i64 -2147483648, %"96", !dbg !169
  br label %main_wrap_around.exit.i, !dbg !169

main_bb20:                                        ; preds = %main_bb18
  %"98" = icmp slt i64 %"92", -2147483648, !dbg !170
  br i1 %"98", label %main_bb21, label %main_wrap_around.exit.i, !dbg !170

main_bb21:                                        ; preds = %main_bb20
  %"99" = sub nsw i64 -2147483648, %"92", !dbg !171
  %"100" = sub nsw i64 %"99", 1, !dbg !171
  %"101" = srem i64 %"100", 4294967296, !dbg !171
  %"102" = sub nsw i64 2147483647, %"101", !dbg !171
  br label %main_wrap_around.exit.i, !dbg !171

main_initLink.exit:                               ; preds = %main_wrap_around.exit.i
  %"103" = sext i32 %cyclic.0.i to i64, !dbg !172
  %"104" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"103", !dbg !172
  %"105" = getelementptr inbounds %struct.NNode* %"104", i32 0, i32 1, !dbg !172
  store i32 %"66", i32* %"105", align 4, !dbg !172
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !173), !dbg !174
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !175), !dbg !176
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !177), !dbg !179
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !180), !dbg !181
  br label %main_bb22, !dbg !182

main_bb22:                                        ; preds = %main_bb23, %main_initLink.exit
  %begin.0.i = phi i32 [ %"66", %main_initLink.exit ], [ %"114", %main_bb23 ], !dbg !178
  %"106" = sext i32 %begin.0.i to i64, !dbg !183
  %"107" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"106", !dbg !183
  %"108" = getelementptr inbounds %struct.NNode* %"107", i32 0, i32 1, !dbg !183
  %"109" = load i32* %"108", align 4, !dbg !183
  %"110" = icmp ne i32 %"109", %"66", !dbg !183
  br i1 %"110", label %main_bb23, label %main_findEnd.exit, !dbg !183

main_bb23:                                        ; preds = %main_bb22
  %"111" = sext i32 %begin.0.i to i64, !dbg !184
  %"112" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"111", !dbg !184
  %"113" = getelementptr inbounds %struct.NNode* %"112", i32 0, i32 1, !dbg !184
  %"114" = load i32* %"113", align 4, !dbg !184
  br label %main_bb22, !dbg !185

main_findEnd.exit:                                ; preds = %main_bb22, %main_bb26
  %h.0 = phi i64 [ %h.1, %main_bb26 ], [ 0, %main_bb22 ]
  %node.0 = phi i32 [ %"128", %main_bb26 ], [ %"66", %main_bb22 ]
  %"115" = icmp ne i32 %node.0, %begin.0.i, !dbg !186
  br i1 %"115", label %main_bb24, label %main_bb27, !dbg !186

main_bb24:                                        ; preds = %main_findEnd.exit
  %"116" = sext i32 %node.0 to i64, !dbg !188
  %"117" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"116", !dbg !188
  %"118" = getelementptr inbounds %struct.NNode* %"117", i32 0, i32 0, !dbg !188
  %"119" = load i64* %"118", align 8, !dbg !188
  %"120" = icmp sgt i64 %"119", %h.0, !dbg !188
  br i1 %"120", label %main_bb25, label %main_bb26, !dbg !188

main_bb25:                                        ; preds = %main_bb24
  %"121" = sext i32 %node.0 to i64, !dbg !191
  %"122" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"121", !dbg !191
  %"123" = getelementptr inbounds %struct.NNode* %"122", i32 0, i32 0, !dbg !191
  %"124" = load i64* %"123", align 8, !dbg !191
  br label %main_bb26, !dbg !193

main_bb26:                                        ; preds = %main_bb25, %main_bb24
  %h.1 = phi i64 [ %"124", %main_bb25 ], [ %h.0, %main_bb24 ]
  %"125" = sext i32 %node.0 to i64, !dbg !194
  %"126" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"125", !dbg !194
  %"127" = getelementptr inbounds %struct.NNode* %"126", i32 0, i32 1, !dbg !194
  %"128" = load i32* %"127", align 4, !dbg !194
  br label %main_findEnd.exit, !dbg !195
...
!126 = metadata !{i32 786688, metadata !17, metadata !"num", metadata !5, i32 65, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num] [line 65]
!127 = metadata !{i32 65, i32 15, metadata !17, null}
!128 = metadata !{i32 66, i32 9, metadata !129, null}
!129 = metadata !{i32 786443, metadata !1, metadata !17, i32 66, i32 9, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!130 = metadata !{i32 66, i32 9, metadata !131, null}
!131 = metadata !{i32 786443, metadata !1, metadata !129, i32 66, i32 9, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!132 = metadata !{i32 786689, metadata !13, metadata !"n", metadata !5, i32 16777252, metadata !8, i32 0, metadata !133} ; [ DW_TAG_arg_variable ] [n] [line 36]
!133 = metadata !{i32 70, i32 16, metadata !17, null}
!134 = metadata !{i32 36, i32 24, metadata !13, metadata !133}
!135 = metadata !{i32 786689, metadata !9, metadata !"size", metadata !5, i32 16777246, metadata !12, i32 0, metadata !136} ; [ DW_TAG_arg_variable ] [size] [line 30]
!136 = metadata !{i32 37, i32 16, metadata !13, metadata !133}
!137 = metadata !{i32 30, i32 26, metadata !9, metadata !136}
!138 = metadata !{i32 31, i32 4, metadata !9, metadata !136}
!139 = metadata !{i32 786688, metadata !9, metadata !"allocatedIndex", metadata !5, i32 31, metadata !12, i32 0, metadata !136} ; [ DW_TAG_auto_variable ] [allocatedIndex] [line 31]
!140 = metadata !{i32 31, i32 8, metadata !9, metadata !136}
!141 = metadata !{i32 32, i32 4, metadata !9, metadata !136}
!142 = metadata !{i32 786688, metadata !13, metadata !"head", metadata !5, i32 37, metadata !12, i32 0, metadata !133} ; [ DW_TAG_auto_variable ] [head] [line 37]
!143 = metadata !{i32 37, i32 9, metadata !13, metadata !133}
!144 = metadata !{i32 38, i32 5, metadata !13, metadata !133}
!145 = metadata !{i32 39, i32 5, metadata !13, metadata !133}
!146 = metadata !{i32 786688, metadata !13, metadata !"cyclic", metadata !5, i32 40, metadata !12, i32 0, metadata !133} ; [ DW_TAG_auto_variable ] [cyclic] [line 40]
!147 = metadata !{i32 40, i32 9, metadata !13, metadata !133}
!148 = metadata !{i32 786688, metadata !13, metadata !"i", metadata !5, i32 42, metadata !8, i32 0, metadata !133} ; [ DW_TAG_auto_variable ] [i] [line 42]
!149 = metadata !{i32 42, i32 15, metadata !13, metadata !133}
!150 = metadata !{i32 786689, metadata !9, metadata !"size", metadata !5, i32 16777246, metadata !12, i32 0, metadata !151} ; [ DW_TAG_arg_variable ] [size] [line 30]
!151 = metadata !{i32 44, i32 20, metadata !80, metadata !133}
!152 = metadata !{i32 30, i32 26, metadata !9, metadata !151}
!153 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554452, metadata !8, i32 0, metadata !154} ; [ DW_TAG_arg_variable ] [lower_bound] [line 20]
!154 = metadata !{i32 43, i32 26, metadata !81, metadata !133}
!155 = metadata !{i32 20, i32 50, metadata !4, metadata !154}
!156 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331668, metadata !8, i32 0, metadata !154} ; [ DW_TAG_arg_variable ] [upper_bound] [line 20]
!157 = metadata !{i32 20, i32 73, metadata !4, metadata !154}
!158 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 21, metadata !8, i32 0, metadata !154} ; [ DW_TAG_auto_variable ] [range] [line 21]
!159 = metadata !{i32 21, i32 15, metadata !4, metadata !154}
!160 = metadata !{i32 43, i32 10, metadata !81, metadata !133}
!161 = metadata !{i32 43, i32 10, metadata !101, metadata !133}
!162 = metadata !{i32 31, i32 4, metadata !9, metadata !151}
!163 = metadata !{i32 32, i32 4, metadata !9, metadata !151}
!164 = metadata !{i32 45, i32 9, metadata !80, metadata !133}
!165 = metadata !{i32 46, i32 9, metadata !80, metadata !133}
!166 = metadata !{i32 47, i32 9, metadata !80, metadata !133}
!167 = metadata !{i32 48, i32 9, metadata !80, metadata !133}
!168 = metadata !{i32 22, i32 9, metadata !44, metadata !154}
!169 = metadata !{i32 23, i32 9, metadata !46, metadata !154}
!170 = metadata !{i32 25, i32 14, metadata !48, metadata !154}
!171 = metadata !{i32 26, i32 9, metadata !50, metadata !154}
!172 = metadata !{i32 50, i32 5, metadata !13, metadata !133}
!173 = metadata !{i32 786688, metadata !17, metadata !"list", metadata !5, i32 70, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [list] [line 70]
!174 = metadata !{i32 70, i32 9, metadata !17, null}
!175 = metadata !{i32 786688, metadata !17, metadata !"node", metadata !5, i32 71, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [node] [line 71]
!176 = metadata !{i32 71, i32 9, metadata !17, null}
!177 = metadata !{i32 786689, metadata !16, metadata !"list", metadata !5, i32 16777269, metadata !12, i32 0, metadata !178} ; [ DW_TAG_arg_variable ] [list] [line 53]
!178 = metadata !{i32 72, i32 15, metadata !17, null}
!179 = metadata !{i32 53, i32 18, metadata !16, metadata !178}
!180 = metadata !{i32 786688, metadata !16, metadata !"begin", metadata !5, i32 55, metadata !12, i32 0, metadata !178} ; [ DW_TAG_auto_variable ] [begin] [line 55]
!181 = metadata !{i32 55, i32 9, metadata !16, metadata !178}
!182 = metadata !{i32 56, i32 5, metadata !16, metadata !178}
!183 = metadata !{i32 56, i32 5, metadata !121, metadata !178}
!184 = metadata !{i32 58, i32 9, metadata !123, metadata !178} ; [ DW_TAG_imported_module ]
!185 = metadata !{i32 59, i32 1, metadata !123, metadata !178}
!186 = metadata !{i32 74, i32 5, metadata !187, null}
!187 = metadata !{i32 786443, metadata !1, metadata !17, i32 74, i32 5, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!188 = metadata !{i32 76, i32 13, metadata !189, null}
!189 = metadata !{i32 786443, metadata !1, metadata !190, i32 76, i32 13, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!190 = metadata !{i32 786443, metadata !1, metadata !17, i32 75, i32 5, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!191 = metadata !{i32 78, i32 13, metadata !192, null}
!192 = metadata !{i32 786443, metadata !1, metadata !189, i32 77, i32 1, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!193 = metadata !{i32 79, i32 1, metadata !192, null}
!194 = metadata !{i32 80, i32 9, metadata !190, null}
!195 = metadata !{i32 81, i32 5, metadata !190, null}
!196 = metadata !{i32 83, i32 1, metadata !17, null}
