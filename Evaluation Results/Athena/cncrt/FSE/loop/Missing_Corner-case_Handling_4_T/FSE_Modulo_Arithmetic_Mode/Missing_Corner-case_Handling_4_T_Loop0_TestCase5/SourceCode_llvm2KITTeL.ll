...
define i32 @main() #0 {
main_bb16:
  call void @llvm.dbg.value(metadata !126, i64 0, metadata !127), !dbg !128
  %"64" = icmp sle i64 100000, 0, !dbg !129
  %"65" = icmp sgt i64 100000, 65534, !dbg !131
  %or.cond = or i1 %"64", %"65", !dbg !129
  br i1 %or.cond, label %main_bb27, label %main_bb17, !dbg !129

main_bb17:                                        ; preds = %main_bb16
  call void @llvm.dbg.value(metadata !126, i64 0, metadata !133), !dbg !135
  call void @llvm.dbg.value(metadata !61, i64 0, metadata !136), !dbg !138
  %"66" = load i32* @"'memory0_freeIndex", align 4, !dbg !139
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !140), !dbg !141
  %"67" = load i32* @"'memory0_freeIndex", align 4, !dbg !142
  %"68" = add nsw i32 %"67", 16, !dbg !142
  store i32 %"68", i32* @"'memory0_freeIndex", align 4, !dbg !142
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !143), !dbg !144
  %"69" = sext i32 %"66" to i64, !dbg !145
  %"70" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"69", !dbg !145
  %"71" = getelementptr inbounds %struct.NNode* %"70", i32 0, i32 0, !dbg !145
  store i64 1, i64* %"71", align 8, !dbg !145
  %"72" = sext i32 %"66" to i64, !dbg !146
  %"73" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"72", !dbg !146
  %"74" = getelementptr inbounds %struct.NNode* %"73", i32 0, i32 1, !dbg !146
  store i32 0, i32* %"74", align 4, !dbg !146
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !147), !dbg !148
...
main_wrap_around.exit.i:                          ; preds = %main_bb21, %main_bb20, %main_bb19, %main_bb17
  %i.0.i = phi i64 [ 2, %main_bb17 ], [ %"97", %main_bb19 ], [ %"102", %main_bb21 ], [ %"92", %main_bb20 ], !dbg !134
  %cyclic.0.i = phi i32 [ %"66", %main_bb17 ], [ %"91", %main_bb19 ], [ %"91", %main_bb20 ], [ %"91", %main_bb21 ], !dbg !134
  %"75" = icmp sle i64 %i.0.i, 100000, !dbg !162
  br i1 %"75", label %main_bb18, label %main_initLink.exit, !dbg !162

main_bb18:                                        ; preds = %main_wrap_around.exit.i
  %"76" = load i32* @"'memory0_freeIndex", align 4, !dbg !163
  %"77" = load i32* @"'memory0_freeIndex", align 4, !dbg !164
  %"78" = add nsw i32 %"77", 16, !dbg !164
  store i32 %"78", i32* @"'memory0_freeIndex", align 4, !dbg !164
  %"79" = sext i32 %"76" to i64, !dbg !165
  %"80" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"79", !dbg !165
  %"81" = getelementptr inbounds %struct.NNode* %"80", i32 0, i32 0, !dbg !165
  store i64 %i.0.i, i64* %"81", align 8, !dbg !165
  %"82" = sext i32 %"76" to i64, !dbg !166
  %"83" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"82", !dbg !166
  %"84" = getelementptr inbounds %struct.NNode* %"83", i32 0, i32 1, !dbg !166
  store i32 0, i32* %"84", align 4, !dbg !166
  %"85" = sext i32 %cyclic.0.i to i64, !dbg !167
  %"86" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"85", !dbg !167
  %"87" = getelementptr inbounds %struct.NNode* %"86", i32 0, i32 1, !dbg !167
  store i32 %"76", i32* %"87", align 4, !dbg !167
  %"88" = sext i32 %cyclic.0.i to i64, !dbg !168
  %"89" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"88", !dbg !168
  %"90" = getelementptr inbounds %struct.NNode* %"89", i32 0, i32 1, !dbg !168
  %"91" = load i32* %"90", align 4, !dbg !168
  %"92" = add nsw i64 %i.0.i, 1, !dbg !155
  %"93" = icmp sgt i64 %"92", 2147483647, !dbg !169
  br i1 %"93", label %main_bb19, label %main_bb20, !dbg !169

main_bb19:                                        ; preds = %main_bb18
  %"94" = sub nsw i64 %"92", 2147483647, !dbg !170
  %"95" = sub nsw i64 %"94", 1, !dbg !170
  %"96" = srem i64 %"95", 4294967296, !dbg !170
  %"97" = add nsw i64 -2147483648, %"96", !dbg !170
  br label %main_wrap_around.exit.i, !dbg !170

main_bb20:                                        ; preds = %main_bb18
  %"98" = icmp slt i64 %"92", -2147483648, !dbg !171
  br i1 %"98", label %main_bb21, label %main_wrap_around.exit.i, !dbg !171

main_bb21:                                        ; preds = %main_bb20
  %"99" = sub nsw i64 -2147483648, %"92", !dbg !172
  %"100" = sub nsw i64 %"99", 1, !dbg !172
  %"101" = srem i64 %"100", 4294967296, !dbg !172
  %"102" = sub nsw i64 2147483647, %"101", !dbg !172
  br label %main_wrap_around.exit.i, !dbg !172

main_initLink.exit:                               ; preds = %main_wrap_around.exit.i
  %"103" = sext i32 %cyclic.0.i to i64, !dbg !173
  %"104" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"103", !dbg !173
  %"105" = getelementptr inbounds %struct.NNode* %"104", i32 0, i32 1, !dbg !173
  store i32 %"66", i32* %"105", align 4, !dbg !173
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !174), !dbg !175
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !176), !dbg !177
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !178), !dbg !180
  call void @llvm.dbg.value(metadata !{i32 %"66"}, i64 0, metadata !181), !dbg !182
  br label %main_bb22, !dbg !183

main_bb22:                                        ; preds = %main_bb23, %main_initLink.exit
  %begin.0.i = phi i32 [ %"66", %main_initLink.exit ], [ %"114", %main_bb23 ], !dbg !179
  %"106" = sext i32 %begin.0.i to i64, !dbg !184
  %"107" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"106", !dbg !184
  %"108" = getelementptr inbounds %struct.NNode* %"107", i32 0, i32 1, !dbg !184
  %"109" = load i32* %"108", align 4, !dbg !184
  %"110" = icmp ne i32 %"109", %"66", !dbg !184
  br i1 %"110", label %main_bb23, label %main_findEnd.exit, !dbg !184

main_bb23:                                        ; preds = %main_bb22
  %"111" = sext i32 %begin.0.i to i64, !dbg !185
  %"112" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"111", !dbg !185
  %"113" = getelementptr inbounds %struct.NNode* %"112", i32 0, i32 1, !dbg !185
  %"114" = load i32* %"113", align 4, !dbg !185
...
main_findEnd.exit:                                ; preds = %main_bb22, %main_bb26
  ...
  %"115" = icmp ne i32 %node.0, %begin.0.i, !dbg !187
  br i1 %"115", label %main_bb24, label %main_bb27, !dbg !187

main_bb24:                                        ; preds = %main_findEnd.exit
  %"116" = sext i32 %node.0 to i64, !dbg !189
  %"117" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"116", !dbg !189
  %"118" = getelementptr inbounds %struct.NNode* %"117", i32 0, i32 0, !dbg !189
  %"119" = load i64* %"118", align 8, !dbg !189
  %"120" = icmp sgt i64 %"119", %h.0, !dbg !189
  br i1 %"120", label %main_bb25, label %main_bb26, !dbg !189

main_bb25:                                        ; preds = %main_bb24
  %"121" = sext i32 %node.0 to i64, !dbg !192
  %"122" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"121", !dbg !192
  %"123" = getelementptr inbounds %struct.NNode* %"122", i32 0, i32 0, !dbg !192
  %"124" = load i64* %"123", align 8, !dbg !192
  br label %main_bb26, !dbg !194

main_bb26:                                        ; preds = %main_bb25, %main_bb24
  %h.1 = phi i64 [ %"124", %main_bb25 ], [ %h.0, %main_bb24 ]
  %"125" = sext i32 %node.0 to i64, !dbg !195
  %"126" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"125", !dbg !195
  %"127" = getelementptr inbounds %struct.NNode* %"126", i32 0, i32 1, !dbg !195
  %"128" = load i32* %"127", align 4, !dbg !195
