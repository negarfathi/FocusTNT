...
main_bb10:                                        ; preds = %main_wrap_around.exit
  ...
  call void @llvm.dbg.value(metadata !{i64 %"38"}, i64 0, metadata !78), !dbg !82
...
main_wrap_around.exit2:                           ; preds = %main_bb23, %main_bb22, %main_bb21, %main_bb10
  ...
  %"32" = icmp slt i64 %base.0, 0, !dbg !90
  br i1 %"32", label %main_bb11, label %main_bb24, !dbg !90

main_bb11:                                        ; preds = %main_wrap_around.exit2
  %"33" = getelementptr inbounds [10 x i64]* %old_, i32 0, i64 %i.0, !dbg !92
  %"34" = load i64* %"33", align 8, !dbg !92
  %"35" = getelementptr inbounds [10 x i64]* %new_, i32 0, i64 %i.0, !dbg !92
  %"36" = load i64* %"35", align 8, !dbg !92
...
main_bb12:                                        ; preds = %main_wrap_around.exit6, %main_bb11
  ...
  %"37" = icmp ne i64 %"34", %"36", !dbg !92
  br i1 %"37", label %main_bb13, label %main_bb17, !dbg !92

main_bb13:                                        ; preds = %main_bb12
  %"38" = add nsw i64 %number.0, 1, !dbg !79
  %"39" = icmp sgt i64 %"38", 2147483647, !dbg !95
  br i1 %"39", label %main_bb14, label %main_bb15, !dbg !95

main_bb14:                                        ; preds = %main_bb13
  %"40" = sub nsw i64 %"38", 2147483647, !dbg !96
  %"41" = sub nsw i64 %"40", 1, !dbg !96
  %"42" = srem i64 %"41", 4294967296, !dbg !96
  %"43" = add nsw i64 -2147483648, %"42", !dbg !96
  br label %main_wrap_around.exit6, !dbg !96

main_bb15:                                        ; preds = %main_bb13
  %"44" = icmp slt i64 %"38", -2147483648, !dbg !97
  br i1 %"44", label %main_bb16, label %main_wrap_around.exit6, !dbg !97

main_bb16:                                        ; preds = %main_bb15
  %"45" = sub nsw i64 -2147483648, %"38", !dbg !98
  %"46" = sub nsw i64 %"45", 1, !dbg !98
  %"47" = srem i64 %"46", 4294967296, !dbg !98
  %"48" = sub nsw i64 2147483647, %"47", !dbg !98
  br label %main_wrap_around.exit6, !dbg !98

main_wrap_around.exit6:                           ; preds = %main_bb14, %main_bb15, %main_bb16
  %.0.i5 = phi i64 [ %"43", %main_bb14 ], [ %"48", %main_bb16 ], [ %"38", %main_bb15 ], !dbg !79
  %"49" = icmp eq i64 %.0.i5, 0, !dbg !79
  br i1 %"49", label %main_bb17, label %main_bb12, !dbg !79
...
!90 = metadata !{i32 35, i32 5, metadata !91, null}
!91 = metadata !{i32 786443, metadata !1, metadata !9, i32 35, i32 5, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!92 = metadata !{i32 38, i32 9, metadata !93, null}
!93 = metadata !{i32 786443, metadata !1, metadata !76, i32 38, i32 9, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!94 = metadata !{i32 38, i32 9, metadata !76, null}
!95 = metadata !{i32 13, i32 9, metadata !26, metadata !79}
!96 = metadata !{i32 14, i32 9, metadata !28, metadata !79}
!97 = metadata !{i32 16, i32 14, metadata !30, metadata !79}
!98 = metadata !{i32 17, i32 9, metadata !32, metadata !79}
!99 = metadata !{i32 45, i32 14, metadata !76, null}
...
!112 = metadata !{i32 46, i32 16, metadata !76, null}
...
!125 = metadata !{i32 48, i32 5, metadata !9, null}
