...
main_bb10:
  ...
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !84), !dbg !85
  call void @llvm.dbg.value(metadata !86, i64 0, metadata !87), !dbg !88
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !89), !dbg !90
  ...
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !100), !dbg !101
...
main_wrap_around.exit:                            ; preds = %main_bb14, %main_bb13, %main_bb12, %main_bb10
  ...
  %"25" = icmp slt i64 %i.0, undef, !dbg !109
  br i1 %"25", label %main_bb11, label %main_bb15, !dbg !109

main_bb11:                                        ; preds = %main_wrap_around.exit
  %"26" = add nsw i64 %i.0, 1, !dbg !97
  %"27" = icmp sgt i64 %"26", 65535, !dbg !112
  br i1 %"27", label %main_bb12, label %main_bb13, !dbg !112

main_bb12:                                        ; preds = %main_bb11
  %"28" = sub nsw i64 %"26", 65535, !dbg !113
  %"29" = sub nsw i64 %"28", 1, !dbg !113
  %"30" = srem i64 %"29", 65536, !dbg !113
  br label %main_wrap_around.exit, !dbg !113

main_bb13:                                        ; preds = %main_bb11
  %"31" = icmp slt i64 %"26", 0, !dbg !114
  br i1 %"31", label %main_bb14, label %main_wrap_around.exit, !dbg !114

main_bb14:                                        ; preds = %main_bb13
  %"32" = sub nsw i64 0, %"26", !dbg !115
  %"33" = sub nsw i64 %"32", 1, !dbg !115
  %"34" = srem i64 %"33", 65536, !dbg !115
  %"35" = sub nsw i64 65535, %"34", !dbg !115
  br label %main_wrap_around.exit, !dbg !115
...
!84 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !82} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!85 = metadata !{i32 12, i32 50, metadata !4, metadata !82}
!86 = metadata !{i64 -1}
!87 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !82} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!88 = metadata !{i32 12, i32 73, metadata !4, metadata !82}
!89 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !82} ; [ DW_TAG_auto_variable ] [range] [line 13]
!90 = metadata !{i32 13, i32 15, metadata !4, metadata !82}
!91 = metadata !{i64 undef}
!92 = metadata !{i32 786688, metadata !12, metadata !"max_fds", metadata !5, i32 36, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [max_fds] [line 36]
!93 = metadata !{i32 36, i32 15, metadata !12, null}
!94 = metadata !{i32 786688, metadata !12, metadata !"i", metadata !5, i32 35, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 35]
!95 = metadata !{i32 35, i32 15, metadata !12, null}
...
!97 = metadata !{i32 37, i32 37, metadata !98, null}
!98 = metadata !{i32 786443, metadata !1, metadata !12, i32 37, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!99 = metadata !{i32 12, i32 33, metadata !4, metadata !97}
...
!105 = metadata !{i64 65536}
!106 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !97} ; [ DW_TAG_auto_variable ] [range] [line 13]
!107 = metadata !{i32 13, i32 15, metadata !4, metadata !97}
!108 = metadata !{i32 37, i32 10, metadata !98, null}
!109 = metadata !{i32 37, i32 10, metadata !110, null}
!110 = metadata !{i32 786443, metadata !1, metadata !111, i32 37, i32 10, i32 2, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!111 = metadata !{i32 786443, metadata !1, metadata !98, i32 37, i32 10, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!112 = metadata !{i32 14, i32 9, metadata !29, metadata !97}
!113 = metadata !{i32 15, i32 9, metadata !31, metadata !97}
!114 = metadata !{i32 17, i32 14, metadata !33, metadata !97}
!115 = metadata !{i32 18, i32 9, metadata !35, metadata !97}
!116 = metadata !{i32 42, i32 5, metadata !12, null}
