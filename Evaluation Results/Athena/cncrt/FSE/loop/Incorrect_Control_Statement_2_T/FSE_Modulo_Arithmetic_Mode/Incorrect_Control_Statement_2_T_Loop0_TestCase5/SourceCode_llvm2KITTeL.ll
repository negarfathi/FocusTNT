...
@main.slots_used = private unnamed_addr constant [10 x i64] [i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1], align 16
...
main_bb5:
  ...
  %"13" = bitcast [10 x i64]* %slots_used to i8*, !dbg !44
  %"14" = bitcast [10 x i64]* @main.slots_used to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %"13", i8* %"14", i64 80, i32 16, i1 false), !dbg !44
  call void @llvm.dbg.declare(metadata !{[10 x i64]* %ereg}, metadata !45), !dbg !46
  %"15" = bitcast [10 x i64]* %ereg to i8*, !dbg !47
  call void @llvm.memset.p0i8.i64(i8* %"15", i8 0, i64 80, i32 16, i1 false), !dbg !47
  %"16" = bitcast i8* %"15" to [10 x i64]*, !dbg !47
  %"17" = getelementptr [10 x i64]* %"16", i32 0, i32 3, !dbg !47
  store i64 5, i64* %"17", !dbg !47
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !49), !dbg !51
  call void @llvm.dbg.value(metadata !{i64 %"19"}, i64 0, metadata !52), !dbg !54
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %i.0 = phi i64 [ 0, %main_bb5 ], [ %"24", %main_bb7 ], [ %"29", %main_bb9 ], [ %"19", %main_bb8 ]
  %"18" = icmp slt i64 %i.0, 10, !dbg !65
  br i1 %"18", label %main_bb6, label %main_wrap_around.exit2, !dbg !65

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"19" = add nsw i64 %i.0, 1, !dbg !53
...
main_wrap_around.exit2:                           ; preds = %main_bb18, %main_bb17, %main_bb16, %main_wrap_around.exit
  %i1.0 = phi i64 [ 0, %main_wrap_around.exit ], [ %"46", %main_bb16 ], [ %"51", %main_bb18 ], [ %"41", %main_bb17 ]
  %table.0 = phi i64 [ %"12", %main_wrap_around.exit ], [ %table.1, %main_bb16 ], [ %table.1, %main_bb17 ], [ %table.1, %main_bb18 ]
  %"30" = icmp slt i64 %i1.0, 10, !dbg !72
  br i1 %"30", label %main_bb10, label %main_bb19, !dbg !72

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"31" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i1.0, !dbg !74
  %"32" = load i64* %"31", align 8, !dbg !74
  br label %main_NodeBlock

main_NodeBlock:                                   ; preds = %main_bb10
  %Pivot = icmp slt i64 %"32", 2
  br i1 %Pivot, label %main_LeafBlock, label %main_LeafBlock3

main_LeafBlock:                                   ; preds = %main_NodeBlock
  %SwitchLeaf = icmp eq i64 %"32", 0
  br i1 %SwitchLeaf, label %main_bb11, label %main_NewDefault

main_bb11:                                        ; preds = %main_LeafBlock
  %"33" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !76
  %"34" = load i64* %"33", align 8, !dbg !76
  %"35" = icmp ne i64 %"34", 0, !dbg !76
  br i1 %"35", label %main_bb12, label %main_bb19, !dbg !76
...
main_bb13:                                        ; preds = %main_NewDefault
  %"38" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !81
  %"39" = load i64* %"38", align 8, !dbg !81
  br label %main_bb14, !dbg !82

main_bb14:                                        ; preds = %main_LeafBlock3, %main_bb13, %main_bb12
  %table.1 = phi i64 [ %"39", %main_bb13 ], [ %"37", %main_bb12 ], [ %table.0, %main_LeafBlock3 ]
  %"40" = icmp ne i64 %table.1, 0, !dbg !83
  br i1 %"40", label %main_bb19, label %main_bb15, !dbg !83

main_bb15:                                        ; preds = %main_bb14
  %"41" = add nsw i64 %i1.0, 1, !dbg !85
  %"42" = icmp sgt i64 %"41", 2147483647, !dbg !86
  br i1 %"42", label %main_bb16, label %main_bb17, !dbg !86

main_bb16:                                        ; preds = %main_bb15
  %"43" = sub nsw i64 %"41", 2147483647, !dbg !87
  %"44" = sub nsw i64 %"43", 1, !dbg !87
  %"45" = srem i64 %"44", 4294967296, !dbg !87
  %"46" = add nsw i64 -2147483648, %"45", !dbg !87
  br label %main_wrap_around.exit2, !dbg !87

main_bb17:                                        ; preds = %main_bb15
  %"47" = icmp slt i64 %"41", -2147483648, !dbg !88
  br i1 %"47", label %main_bb18, label %main_wrap_around.exit2, !dbg !88

main_bb18:                                        ; preds = %main_bb17
  %"48" = sub nsw i64 -2147483648, %"41", !dbg !89
  %"49" = sub nsw i64 %"48", 1, !dbg !89
  %"50" = srem i64 %"49", 4294967296, !dbg !89
  %"51" = sub nsw i64 2147483647, %"50", !dbg !89
...
!44 = metadata !{i32 25, i32 5, metadata !9, null}
!45 = metadata !{i32 786688, metadata !9, metadata !"ereg", metadata !5, i32 26, metadata !40, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ereg] [line 26]
!46 = metadata !{i32 26, i32 15, metadata !9, null}
!47 = metadata !{i32 26, i32 5, metadata !9, null}
!48 = metadata !{i64 0}
!49 = metadata !{i32 786688, metadata !50, metadata !"i", metadata !5, i32 28, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 28]
!50 = metadata !{i32 786443, metadata !1, metadata !9, i32 28, i32 5, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 28, i32 20, metadata !50, null}
!52 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !53} ; [ DW_TAG_arg_variable ] [value] [line 12]
!53 = metadata !{i32 28, i32 42, metadata !50, null}
!54 = metadata !{i32 12, i32 33, metadata !4, metadata !53}
!55 = metadata !{i64 -2147483648}
!56 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !53} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!57 = metadata !{i32 12, i32 50, metadata !4, metadata !53}
!58 = metadata !{i64 2147483647}
!59 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !53} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!60 = metadata !{i32 12, i32 73, metadata !4, metadata !53}
!61 = metadata !{i64 4294967296}
!62 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !53} ; [ DW_TAG_auto_variable ] [range] [line 13]
!63 = metadata !{i32 13, i32 15, metadata !4, metadata !53}
!64 = metadata !{i32 28, i32 10, metadata !50, null}
!65 = metadata !{i32 28, i32 10, metadata !66, null}
!66 = metadata !{i32 786443, metadata !1, metadata !67, i32 28, i32 10, i32 2, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!67 = metadata !{i32 786443, metadata !1, metadata !50, i32 28, i32 10, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!68 = metadata !{i32 14, i32 9, metadata !26, metadata !53}
!69 = metadata !{i32 15, i32 9, metadata !28, metadata !53}
!70 = metadata !{i32 17, i32 14, metadata !30, metadata !53}
!71 = metadata !{i32 18, i32 9, metadata !32, metadata !53}
!72 = metadata !{i32 34, i32 5, metadata !73, null}
!73 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 5, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!74 = metadata !{i32 36, i32 9, metadata !75, null}
!75 = metadata !{i32 786443, metadata !1, metadata !9, i32 35, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 41, i32 21, metadata !77, null}
!77 = metadata !{i32 786443, metadata !1, metadata !78, i32 41, i32 21, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!78 = metadata !{i32 786443, metadata !1, metadata !75, i32 37, i32 9, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!79 = metadata !{i32 46, i32 21, metadata !77, null}
!80 = metadata !{i32 47, i32 17, metadata !78, null}
!81 = metadata !{i32 49, i32 17, metadata !78, null}
!82 = metadata !{i32 50, i32 17, metadata !78, null}
!83 = metadata !{i32 52, i32 13, metadata !84, null}
!84 = metadata !{i32 786443, metadata !1, metadata !75, i32 52, i32 13, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!85 = metadata !{i32 56, i32 14, metadata !75, null}
!86 = metadata !{i32 14, i32 9, metadata !26, metadata !85}
!87 = metadata !{i32 15, i32 9, metadata !28, metadata !85}
!88 = metadata !{i32 17, i32 14, metadata !30, metadata !85}
!89 = metadata !{i32 18, i32 9, metadata !32, metadata !85}
!90 = metadata !{i32 59, i32 1, metadata !9, null}
