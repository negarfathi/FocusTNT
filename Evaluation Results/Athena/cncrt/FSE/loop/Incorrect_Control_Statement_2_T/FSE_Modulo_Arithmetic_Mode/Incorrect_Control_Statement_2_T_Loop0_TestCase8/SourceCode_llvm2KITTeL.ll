...
@main.slots_used = private unnamed_addr constant [10 x i64] [i64 1, i64 2, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1], align 16
...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"17"}, i64 0, metadata !52), !dbg !54
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"16" = icmp slt i64 %i.0, 10, !dbg !65
  br i1 %"16", label %main_bb6, label %main_wrap_around.exit2, !dbg !65

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"17" = add nsw i64 %i.0, 1, !dbg !53
  %"18" = icmp sgt i64 %"17", 2147483647, !dbg !68
  br i1 %"18", label %main_bb7, label %main_bb8, !dbg !68

main_bb7:                                         ; preds = %main_bb6
  %"19" = sub nsw i64 %"17", 2147483647, !dbg !69
  %"20" = sub nsw i64 %"19", 1, !dbg !69
  %"21" = srem i64 %"20", 4294967296, !dbg !69
  %"22" = add nsw i64 -2147483648, %"21", !dbg !69
  br label %main_wrap_around.exit, !dbg !69

main_bb8:                                         ; preds = %main_bb6
  %"23" = icmp slt i64 %"17", -2147483648, !dbg !70
  br i1 %"23", label %main_bb9, label %main_wrap_around.exit, !dbg !70

main_bb9:                                         ; preds = %main_bb8
  %"24" = sub nsw i64 -2147483648, %"17", !dbg !71
  %"25" = sub nsw i64 %"24", 1, !dbg !71
  %"26" = srem i64 %"25", 4294967296, !dbg !71
  %"27" = sub nsw i64 2147483647, %"26", !dbg !71
  br label %main_wrap_around.exit, !dbg !71

main_wrap_around.exit2:                           ; preds = %main_bb18, %main_bb17, %main_bb16, %main_wrap_around.exit
  %i1.0 = phi i64 [ 0, %main_wrap_around.exit ], [ %"44", %main_bb16 ], [ %"49", %main_bb18 ], [ %"39", %main_bb17 ]
  %table.0 = phi i64 [ %"12", %main_wrap_around.exit ], [ %table.1, %main_bb16 ], [ %table.1, %main_bb17 ], [ %table.1, %main_bb18 ]
  %"28" = icmp slt i64 %i1.0, 10, !dbg !72
  br i1 %"28", label %main_bb10, label %main_bb19, !dbg !72

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"29" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i1.0, !dbg !74
  %"30" = load i64* %"29", align 8, !dbg !74
...
main_bb11:                                        ; preds = %main_LeafBlock
  %"31" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !76
  %"32" = load i64* %"31", align 8, !dbg !76
  %"33" = icmp ne i64 %"32", 0, !dbg !76
  br i1 %"33", label %main_bb12, label %main_bb19, !dbg !76

main_bb12:                                        ; preds = %main_bb11
  %"34" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !79
...
main_bb13:                                        ; preds = %main_NewDefault
  %"36" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !81
  %"37" = load i64* %"36", align 8, !dbg !81
  br label %main_bb14, !dbg !82

main_bb14:                                        ; preds = %main_LeafBlock3, %main_bb13, %main_bb12
  %table.1 = phi i64 [ %"37", %main_bb13 ], [ %"35", %main_bb12 ], [ %table.0, %main_LeafBlock3 ]
  %"38" = icmp ne i64 %table.1, 0, !dbg !83
  br i1 %"38", label %main_bb19, label %main_bb15, !dbg !83

main_bb15:                                        ; preds = %main_bb14
  %"39" = add nsw i64 %i1.0, 1, !dbg !85
  %"40" = icmp sgt i64 %"39", 2147483647, !dbg !86
  br i1 %"40", label %main_bb16, label %main_bb17, !dbg !86

main_bb16:                                        ; preds = %main_bb15
  %"41" = sub nsw i64 %"39", 2147483647, !dbg !87
  %"42" = sub nsw i64 %"41", 1, !dbg !87
  %"43" = srem i64 %"42", 4294967296, !dbg !87
  %"44" = add nsw i64 -2147483648, %"43", !dbg !87
  br label %main_wrap_around.exit2, !dbg !87

main_bb17:                                        ; preds = %main_bb15
  %"45" = icmp slt i64 %"39", -2147483648, !dbg !88
  br i1 %"45", label %main_bb18, label %main_wrap_around.exit2, !dbg !88

main_bb18:                                        ; preds = %main_bb17
  %"46" = sub nsw i64 -2147483648, %"39", !dbg !89
  %"47" = sub nsw i64 %"46", 1, !dbg !89
  %"48" = srem i64 %"47", 4294967296, !dbg !89
  %"49" = sub nsw i64 2147483647, %"48", !dbg !89
