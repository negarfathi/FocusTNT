...
main_bb0:
  ...
  call void @llvm.memset.p0i8.i64(i8* %"3", i8 0, i64 40, i32 16, i1 false), !dbg !25
  %"4" = bitcast i8* %"3" to [10 x i32]*, !dbg !25
  %"5" = getelementptr [10 x i32]* %"4", i32 0, i32 3, !dbg !25
  store i32 5, i32* %"5", !dbg !25
  call void @llvm.dbg.value(metadata !26, i64 0, metadata !27), !dbg !29
  call void @llvm.dbg.value(metadata !{i32 %"7"}, i64 0, metadata !27), !dbg !29
  br label %main_bb1, !dbg !30

main_bb1:                                         ; preds = %main_bb2, %main_bb0
  %i.0 = phi i32 [ 0, %main_bb0 ], [ %"7", %main_bb2 ]
  %"6" = icmp slt i32 %i.0, 10, !dbg !31
  br i1 %"6", label %main_bb2, label %main_bb3, !dbg !31

main_bb2:                                         ; preds = %main_bb1
  %"7" = add nsw i32 %i.0, 1, !dbg !34
  br label %main_bb1, !dbg !34

main_bb3:                                         ; preds = %main_bb1, %main_bb9
  %i1.0 = phi i32 [ %"23", %main_bb9 ], [ 0, %main_bb1 ]
  %table.0 = phi i32 [ %table.1, %main_bb9 ], [ %"0", %main_bb1 ]
  %"8" = icmp slt i32 %i1.0, 10, !dbg !35
  br i1 %"8", label %main_bb4, label %main_bb10, !dbg !35

main_bb4:                                         ; preds = %main_bb3
  %"9" = sext i32 %i1.0 to i64, !dbg !37
  %"10" = getelementptr inbounds [10 x i32]* %slots_used, i32 0, i64 %"9", !dbg !37
...
main_bb5:                                         ; preds = %main_LeafBlock
  %"12" = sext i32 %i1.0 to i64, !dbg !39
  %"13" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"12", !dbg !39
  %"14" = load i32* %"13", align 4, !dbg !39
  %"15" = icmp ne i32 %"14", 0, !dbg !39
  br i1 %"15", label %main_bb6, label %main_bb10, !dbg !39
...
main_bb7:                                         ; preds = %main_NewDefault
  %"19" = sext i32 %i1.0 to i64, !dbg !44
  %"20" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"19", !dbg !44
  %"21" = load i32* %"20", align 4, !dbg !44
  br label %main_bb8, !dbg !45

main_bb8:                                         ; preds = %main_LeafBlock1, %main_bb7, %main_bb6
  %table.1 = phi i32 [ %"21", %main_bb7 ], [ %"18", %main_bb6 ], [ %table.0, %main_LeafBlock1 ]
  %"22" = icmp ne i32 %table.1, 0, !dbg !46
  br i1 %"22", label %main_bb10, label %main_bb9, !dbg !46

main_bb9:                                         ; preds = %main_bb8
  %"23" = add nsw i32 %i1.0, 1, !dbg !48
