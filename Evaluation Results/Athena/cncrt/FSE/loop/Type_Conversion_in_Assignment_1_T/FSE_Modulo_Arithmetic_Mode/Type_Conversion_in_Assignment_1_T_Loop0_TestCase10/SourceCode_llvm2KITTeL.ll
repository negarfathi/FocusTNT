...
main_bb15:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"42"}, i64 0, metadata !89), !dbg !94
  ...
  call void @llvm.dbg.value(metadata !113, i64 0, metadata !101), !dbg !102
  br label %main_bb16, !dbg !123

main_bb16:                                        ; preds = %main_fgetc.exit, %main_bb15
...
main_bb17:                                        ; preds = %main_bb16
  %"41" = load i64* @"'flag", align 8, !dbg !90
  %"42" = add nsw i64 %"41", 1, !dbg !90
...
main_wrap_around.exit.i:                          ; preds = %main_bb20, %main_bb19, %main_bb18
  %.0.i.i = phi i64 [ %"47", %main_bb18 ], [ %"52", %main_bb20 ], [ %"42", %main_bb19 ], !dbg !90
...
main_fgetc.exit:                                  ; preds = %main_bb16, %main_wrap_around.exit.i
  %.0.i = phi i64 [ 1, %main_wrap_around.exit.i ], [ -1, %main_bb16 ], !dbg !91
  %cond = icmp eq i64 %.0.i, -1, !dbg !130
  br i1 %cond, label %main_bb21, label %main_bb16, !dbg !130
...
!105 = metadata !{i32 33, i32 13, metadata !63, metadata !91}
...
!113 = metadata !{i64 1}
!114 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777229, metadata !8, i32 0, metadata !115} ; [ DW_TAG_arg_variable ] [value] [line 13]
!115 = metadata !{i32 35, i32 9, metadata !9, metadata !91}
!116 = metadata !{i32 13, i32 33, metadata !4, metadata !115}
!117 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554445, metadata !8, i32 0, metadata !115} ; [ DW_TAG_arg_variable ] [lower_bound] [line 13]
!118 = metadata !{i32 13, i32 50, metadata !4, metadata !115}
!119 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331661, metadata !8, i32 0, metadata !115} ; [ DW_TAG_arg_variable ] [upper_bound] [line 13]
!120 = metadata !{i32 13, i32 73, metadata !4, metadata !115}
!121 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 14, metadata !8, i32 0, metadata !115} ; [ DW_TAG_auto_variable ] [range] [line 14]
!122 = metadata !{i32 14, i32 15, metadata !4, metadata !115}
!123 = metadata !{i32 41, i32 5, metadata !93, null}
!124 = metadata !{i32 25, i32 9, metadata !40, metadata !91}
!125 = metadata !{i32 15, i32 9, metadata !31, metadata !90}
!126 = metadata !{i32 16, i32 9, metadata !33, metadata !90}
!127 = metadata !{i32 18, i32 14, metadata !35, metadata !90}
!128 = metadata !{i32 19, i32 9, metadata !37, metadata !90}
!129 = metadata !{i32 36, i32 5, metadata !9, metadata !91}
!130 = metadata !{i32 44, i32 13, metadata !131, null}
!131 = metadata !{i32 786443, metadata !1, metadata !92, i32 44, i32 13, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
