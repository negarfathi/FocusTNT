...
main_fgetc.exit:                                  ; preds = %main_bb16, %main_wrap_around.exit.i
  %.0.i = phi i64 [ 0, %main_wrap_around.exit.i ], [ -1, %main_bb16 ], !dbg !91
  br label %main_LeafBlock

main_LeafBlock:                                   ; preds = %main_fgetc.exit
  %.0.i.off = add i64 %.0.i, 1
  %SwitchLeaf = icmp ule i64 %.0.i.off, 1
  br i1 %SwitchLeaf, label %main_bb21, label %main_NewDefault

main_bb21:                                        ; preds = %main_LeafBlock
  ret i32 0, !dbg !130
...
!130 = metadata !{i32 60, i32 1, metadata !12, null}
