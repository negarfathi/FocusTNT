...
main_bb5:
  ...
  %"12" = icmp sle i64 4294967295, 0, !dbg !45
  %"13" = icmp eq i64 2147483648, 0, !dbg !47
...
main_bb6:                                         ; preds = %main_bb5, %main_wrap_around.exit
  ...
  %"14" = icmp slt i64 4294967295, %cur.0, !dbg !49
  br i1 %"14", label %main_bb11, label %main_bb7, !dbg !49

main_bb7:                                         ; preds = %main_bb6
  %"15" = add nsw i64 %cur.0, 2147483648, !dbg !53
  %"16" = icmp sgt i64 %"15", 4294967295, !dbg !54
  br i1 %"16", label %main_bb8, label %main_bb9, !dbg !54

main_bb8:                                         ; preds = %main_bb7
  %"17" = sub nsw i64 %"15", 4294967295, !dbg !55
  %"18" = sub nsw i64 %"17", 1, !dbg !55
  %"19" = srem i64 %"18", 4294967296, !dbg !55
  br label %main_wrap_around.exit, !dbg !55

main_bb9:                                         ; preds = %main_bb7
  %"20" = icmp slt i64 %"15", 0, !dbg !56
  br i1 %"20", label %main_bb10, label %main_wrap_around.exit, !dbg !56

main_bb10:                                        ; preds = %main_bb9
  %"21" = sub nsw i64 0, %"15", !dbg !57
  %"22" = sub nsw i64 %"21", 1, !dbg !57
  %"23" = srem i64 %"22", 4294967296, !dbg !57
  %"24" = sub nsw i64 4294967295, %"23", !dbg !57
  br label %main_wrap_around.exit, !dbg !57

main_wrap_around.exit:                            ; preds = %main_bb8, %main_bb9, %main_bb10
  %.0.i = phi i64 [ %"19", %main_bb8 ], [ %"24", %main_bb10 ], [ %"15", %main_bb9 ], !dbg !53
  %"25" = icmp sle i64 %.0.i, %cur.0, !dbg !58
  br i1 %"25", label %main_bb11, label %main_bb6, !dbg !58
