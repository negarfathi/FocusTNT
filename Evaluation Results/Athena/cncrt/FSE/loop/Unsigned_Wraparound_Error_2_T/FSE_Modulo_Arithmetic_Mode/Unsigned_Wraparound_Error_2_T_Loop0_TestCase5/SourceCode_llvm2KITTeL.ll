...
main_bb5:
  ...
  %"12" = icmp slt i64 2147483648, 100, !dbg !43
  call void @llvm.dbg.value(metadata !40, i64 0, metadata !38), !dbg !39
  %. = select i1 %"12", i64 100, i64 2147483648, !dbg !43
  ...
  call void @llvm.dbg.value(metadata !{i64 %"25"}, i64 0, metadata !58), !dbg !61
  call void @llvm.dbg.value(metadata !49, i64 0, metadata !62), !dbg !63
  call void @llvm.dbg.value(metadata !52, i64 0, metadata !64), !dbg !65
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !66), !dbg !67
...
main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  ...
  br i1 %"13", label %main_bb6, label %main_.critedge, !dbg !69
...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  ...
  br i1 %"24", label %main_bb10, label %main_.critedge, !dbg !75

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"25" = mul nsw i64 %ui.0, 2, !dbg !59
  %"26" = icmp sgt i64 %"25", 4294967295, !dbg !77
  br i1 %"26", label %main_bb11, label %main_bb12, !dbg !77

main_bb11:                                        ; preds = %main_bb10
  %"27" = sub nsw i64 %"25", 4294967295, !dbg !78
  %"28" = sub nsw i64 %"27", 1, !dbg !78
  %"29" = srem i64 %"28", 4294967296, !dbg !78
  br label %main_wrap_around.exit2, !dbg !78

main_bb12:                                        ; preds = %main_bb10
  %"30" = icmp slt i64 %"25", 0, !dbg !79
  br i1 %"30", label %main_bb13, label %main_wrap_around.exit2, !dbg !79

main_bb13:                                        ; preds = %main_bb12
  %"31" = sub nsw i64 0, %"25", !dbg !80
  %"32" = sub nsw i64 %"31", 1, !dbg !80
  %"33" = srem i64 %"32", 4294967296, !dbg !80
  %"34" = sub nsw i64 4294967295, %"33", !dbg !80
...
!59 = metadata !{i32 33, i32 14, metadata !60, null}
!60 = metadata !{i32 786443, metadata !1, metadata !9, i32 32, i32 1, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 12, i32 33, metadata !4, metadata !59}
!62 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !59} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!63 = metadata !{i32 12, i32 50, metadata !4, metadata !59}
...
!66 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !59} ; [ DW_TAG_auto_variable ] [range] [line 13]
!67 = metadata !{i32 13, i32 15, metadata !4, metadata !59}
!68 = metadata !{i32 31, i32 5, metadata !9, null}
!69 = metadata !{i32 31, i32 5, metadata !70, null}
!70 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 14, i32 9, metadata !26, metadata !46}
!72 = metadata !{i32 15, i32 9, metadata !28, metadata !46}
!73 = metadata !{i32 17, i32 14, metadata !30, metadata !46}
!74 = metadata !{i32 18, i32 9, metadata !32, metadata !46}
!75 = metadata !{i32 31, i32 29, metadata !76, null}
!76 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 29, i32 3, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!81 = metadata !{i32 35, i32 5, metadata !9, null}
