...
main_bb1:
  ...
  call void @llvm.dbg.value(metadata !13, i64 0, metadata !21), !dbg !23
  %"3" = sext i32 65535 to i64, !dbg !22
  ...
  call void @llvm.dbg.value(metadata !{i64 %"5"}, i64 0, metadata !28), !dbg !29
  br label %main_bb2, !dbg !30

main_bb2:                                         ; preds = %main_bb3, %main_bb1
  %i.0 = phi i64 [ 0, %main_bb1 ], [ %"5", %main_bb3 ]
  %"4" = icmp slt i64 %i.0, %"3", !dbg !32
  br i1 %"4", label %main_bb3, label %main_bb4, !dbg !32

main_bb3:                                         ; preds = %main_bb2
  %"5" = add nsw i64 %i.0, 1, !dbg !35
...
!21 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 11, metadata !8, i32 0, metadata !22} ; [ DW_TAG_auto_variable ] [i] [line 11]
!22 = metadata !{i32 21, i32 20, metadata !9, null}
!23 = metadata !{i32 11, i32 9, metadata !4, metadata !22}
!24 = metadata !{i32 786688, metadata !9, metadata !"max_fds", metadata !5, i32 21, metadata !25, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [max_fds] [line 21]
...
!26 = metadata !{i32 21, i32 10, metadata !9, null}
!27 = metadata !{i64 0}
!28 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 20, metadata !25, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 20]
!29 = metadata !{i32 20, i32 10, metadata !9, null}
!30 = metadata !{i32 22, i32 10, metadata !31, null}
!31 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 5, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!32 = metadata !{i32 22, i32 10, metadata !33, null}
!33 = metadata !{i32 786443, metadata !1, metadata !34, i32 22, i32 10, i32 2, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!34 = metadata !{i32 786443, metadata !1, metadata !31, i32 22, i32 10, i32 1, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!35 = metadata !{i32 22, i32 32, metadata !31, null}
!36 = metadata !{i32 27, i32 5, metadata !9, null}
