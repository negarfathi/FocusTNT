...
gettablesize_bb5:
  ...
  %"12" = srem i64 50000, 99999, !dbg !40
...
main_bb10:
  ...
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !93), !dbg !94
  call void @llvm.dbg.value(metadata !90, i64 0, metadata !95), !dbg !96
  ...
  call void @llvm.dbg.value(metadata !87, i64 0, metadata !103), !dbg !104
  call void @llvm.dbg.value(metadata !90, i64 0, metadata !105), !dbg !106
  call void @llvm.dbg.value(metadata !{i64 %"26"}, i64 0, metadata !95), !dbg !96
  br label %main_bb11, !dbg !107

main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %i.0 = phi i64 [ 0, %main_bb10 ], [ %"26", %main_bb12 ]
  %"25" = icmp slt i64 %i.0, 50000, !dbg !108
  br i1 %"25", label %main_bb12, label %main_bb13, !dbg !108

main_bb12:                                        ; preds = %main_bb11
  %"26" = add nsw i64 %i.0, 1, !dbg !98
  br label %main_bb11, !dbg !98
...
!90 = metadata !{i64 0}
!91 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 12, metadata !8, i32 0, metadata !82} ; [ DW_TAG_auto_variable ] [range] [line 12]
!92 = metadata !{i32 12, i32 15, metadata !4, metadata !82}
!93 = metadata !{i32 786688, metadata !12, metadata !"max_fds", metadata !5, i32 35, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [max_fds] [line 35]
!94 = metadata !{i32 35, i32 15, metadata !12, null}
!95 = metadata !{i32 786688, metadata !12, metadata !"i", metadata !5, i32 34, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 34]
!96 = metadata !{i32 34, i32 15, metadata !12, null}
!97 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777227, metadata !8, i32 0, metadata !98} ; [ DW_TAG_arg_variable ] [value] [line 11]
!98 = metadata !{i32 36, i32 37, metadata !99, null}
!99 = metadata !{i32 786443, metadata !1, metadata !12, i32 36, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!107 = metadata !{i32 36, i32 10, metadata !99, null}
!108 = metadata !{i32 36, i32 10, metadata !109, null}
!109 = metadata !{i32 786443, metadata !1, metadata !110, i32 36, i32 10, i32 2, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!110 = metadata !{i32 786443, metadata !1, metadata !99, i32 36, i32 10, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!111 = metadata !{i32 41, i32 5, metadata !12, null}
