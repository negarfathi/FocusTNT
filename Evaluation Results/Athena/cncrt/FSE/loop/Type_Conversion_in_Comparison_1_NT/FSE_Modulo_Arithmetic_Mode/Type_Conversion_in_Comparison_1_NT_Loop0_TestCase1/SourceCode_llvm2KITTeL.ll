...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"12"}, i64 0, metadata !41), !dbg !44
...
main_wrap_around.exit2:                           ; preds = %main_bb12, %main_bb11, %main_bb10, %main_bb5
  ...
  %"12" = add nsw i64 0, 0, !dbg !42
  %"13" = icmp sgt i64 %"12", 2147483647, !dbg !66
  br i1 %"13", label %main_bb6, label %main_bb7, !dbg !66

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"14" = sub nsw i64 %"12", 2147483647, !dbg !67
  %"15" = sub nsw i64 %"14", 1, !dbg !67
  %"16" = srem i64 %"15", 4294967296, !dbg !67
  %"17" = add nsw i64 -2147483648, %"16", !dbg !67
  br label %main_wrap_around.exit, !dbg !67

main_bb7:                                         ; preds = %main_wrap_around.exit2
  %"18" = icmp slt i64 %"12", -2147483648, !dbg !68
  br i1 %"18", label %main_bb8, label %main_wrap_around.exit, !dbg !68

main_bb8:                                         ; preds = %main_bb7
  %"19" = sub nsw i64 -2147483648, %"12", !dbg !69
  %"20" = sub nsw i64 %"19", 1, !dbg !69
  %"21" = srem i64 %"20", 4294967296, !dbg !69
  %"22" = sub nsw i64 2147483647, %"21", !dbg !69
  br label %main_wrap_around.exit, !dbg !69

main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  %.0.i = phi i64 [ %"17", %main_bb6 ], [ %"22", %main_bb8 ], [ %"12", %main_bb7 ], !dbg !42
  %"23" = icmp slt i64 %s.0, %.0.i, !dbg !42
  br i1 %"23", label %main_bb9, label %main_bb13, !dbg !42

main_bb9:                                         ; preds = %main_wrap_around.exit
  %"24" = add nsw i64 %s.0, 1, !dbg !55
  %"25" = icmp sgt i64 %"24", 65535, !dbg !70
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !70

main_bb10:                                        ; preds = %main_bb9
  %"26" = sub nsw i64 %"24", 65535, !dbg !71
  %"27" = sub nsw i64 %"26", 1, !dbg !71
  %"28" = srem i64 %"27", 65536, !dbg !71
  br label %main_wrap_around.exit2, !dbg !71

main_bb11:                                        ; preds = %main_bb9
  %"29" = icmp slt i64 %"24", 0, !dbg !72
  br i1 %"29", label %main_bb12, label %main_wrap_around.exit2, !dbg !72

main_bb12:                                        ; preds = %main_bb11
  %"30" = sub nsw i64 0, %"24", !dbg !73
  %"31" = sub nsw i64 %"30", 1, !dbg !73
  %"32" = srem i64 %"31", 65536, !dbg !73
  %"33" = sub nsw i64 65535, %"32", !dbg !73
...
!37 = metadata !{i32 786688, metadata !9, metadata !"len", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [len] [line 24]
!38 = metadata !{i32 24, i32 26, metadata !9, null}
!39 = metadata !{i32 786688, metadata !9, metadata !"s", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [s] [line 24]
!40 = metadata !{i32 24, i32 15, metadata !9, null}
!41 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !42} ; [ DW_TAG_arg_variable ] [value] [line 12]
!42 = metadata !{i32 27, i32 27, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 5, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!55 = metadata !{i32 27, i32 77, metadata !43, null}
...
!62 = metadata !{i64 65536}
!63 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !55} ; [ DW_TAG_auto_variable ] [range] [line 13]
!64 = metadata !{i32 13, i32 15, metadata !4, metadata !55}
!65 = metadata !{i32 27, i32 10, metadata !43, null}
!66 = metadata !{i32 14, i32 9, metadata !26, metadata !42}
!67 = metadata !{i32 15, i32 9, metadata !28, metadata !42}
!68 = metadata !{i32 17, i32 14, metadata !30, metadata !42}
!69 = metadata !{i32 18, i32 9, metadata !32, metadata !42}
!70 = metadata !{i32 14, i32 9, metadata !26, metadata !55}
!71 = metadata !{i32 15, i32 9, metadata !28, metadata !55}
!72 = metadata !{i32 17, i32 14, metadata !30, metadata !55}
!73 = metadata !{i32 18, i32 9, metadata !32, metadata !55}
!74 = metadata !{i32 31, i32 5, metadata !9, null}
