...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"12"}, i64 0, metadata !42), !dbg !45
...
main_wrap_around.exit2:                           ; preds = %main_bb12, %main_bb11, %main_bb10, %main_bb5
  %s.0 = phi i64 [ 65535, %main_bb5 ], [ %"28", %main_bb10 ], [ %"33", %main_bb12 ], [ %"24", %main_bb11 ]
  %"12" = add nsw i64 65535, 1, !dbg !43
  %"13" = icmp sgt i64 %"12", 2147483647, !dbg !67
  br i1 %"13", label %main_bb6, label %main_bb7, !dbg !67

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"14" = sub nsw i64 %"12", 2147483647, !dbg !68
  %"15" = sub nsw i64 %"14", 1, !dbg !68
  %"16" = srem i64 %"15", 4294967296, !dbg !68
  %"17" = add nsw i64 -2147483648, %"16", !dbg !68
  br label %main_wrap_around.exit, !dbg !68

main_bb7:                                         ; preds = %main_wrap_around.exit2
  %"18" = icmp slt i64 %"12", -2147483648, !dbg !69
  br i1 %"18", label %main_bb8, label %main_wrap_around.exit, !dbg !69

main_bb8:                                         ; preds = %main_bb7
  %"19" = sub nsw i64 -2147483648, %"12", !dbg !70
  %"20" = sub nsw i64 %"19", 1, !dbg !70
  %"21" = srem i64 %"20", 4294967296, !dbg !70
  %"22" = sub nsw i64 2147483647, %"21", !dbg !70
  br label %main_wrap_around.exit, !dbg !70

main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  %.0.i = phi i64 [ %"17", %main_bb6 ], [ %"22", %main_bb8 ], [ %"12", %main_bb7 ], !dbg !43
  %"23" = icmp slt i64 %s.0, %.0.i, !dbg !43
  br i1 %"23", label %main_bb9, label %main_bb13, !dbg !43

main_bb9:                                         ; preds = %main_wrap_around.exit
  %"24" = add nsw i64 %s.0, 1, !dbg !56
  %"25" = icmp sgt i64 %"24", 65535, !dbg !71
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !71

main_bb10:                                        ; preds = %main_bb9
  %"26" = sub nsw i64 %"24", 65535, !dbg !72
  %"27" = sub nsw i64 %"26", 1, !dbg !72
  %"28" = srem i64 %"27", 65536, !dbg !72
  br label %main_wrap_around.exit2, !dbg !72

main_bb11:                                        ; preds = %main_bb9
  %"29" = icmp slt i64 %"24", 0, !dbg !73
  br i1 %"29", label %main_bb12, label %main_wrap_around.exit2, !dbg !73

main_bb12:                                        ; preds = %main_bb11
  %"30" = sub nsw i64 0, %"24", !dbg !74
  %"31" = sub nsw i64 %"30", 1, !dbg !74
  %"32" = srem i64 %"31", 65536, !dbg !74
  %"33" = sub nsw i64 65535, %"32", !dbg !74
...
!63 = metadata !{i64 65536}
!64 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !56} ; [ DW_TAG_auto_variable ] [range] [line 13]
!65 = metadata !{i32 13, i32 15, metadata !4, metadata !56}
!66 = metadata !{i32 27, i32 10, metadata !44, null}
...
!71 = metadata !{i32 14, i32 9, metadata !26, metadata !56}
!72 = metadata !{i32 15, i32 9, metadata !28, metadata !56}
!73 = metadata !{i32 17, i32 14, metadata !30, metadata !56}
!74 = metadata !{i32 18, i32 9, metadata !32, metadata !56}
!75 = metadata !{i32 31, i32 5, metadata !9, null}
