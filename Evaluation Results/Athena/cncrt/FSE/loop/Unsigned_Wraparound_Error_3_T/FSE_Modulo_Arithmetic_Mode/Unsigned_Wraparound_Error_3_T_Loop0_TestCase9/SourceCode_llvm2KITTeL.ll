...
main_bb5:
  ...
  %"12" = add nsw i64 1, 3000000000, !dbg !43
  ...
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !50), !dbg !51
  call void @llvm.dbg.value(metadata !52, i64 0, metadata !53), !dbg !54
  %"14" = icmp sgt i64 %"13", 4294967295, !dbg !55
  br i1 %"14", label %main_bb6, label %main_bb7, !dbg !55

main_bb6:                                         ; preds = %main_bb5
  %"15" = sub nsw i64 %"13", 4294967295, !dbg !56
  %"16" = sub nsw i64 %"15", 1, !dbg !56
  %"17" = srem i64 %"16", 4294967296, !dbg !56
  br label %main_wrap_around.exit, !dbg !56

main_bb7:                                         ; preds = %main_bb5
  %"18" = icmp slt i64 %"13", 0, !dbg !57
  br i1 %"18", label %main_bb8, label %main_wrap_around.exit, !dbg !57

main_bb8:                                         ; preds = %main_bb7
  %"19" = sub nsw i64 0, %"13", !dbg !58
  %"20" = sub nsw i64 %"19", 1, !dbg !58
  %"21" = srem i64 %"20", 4294967296, !dbg !58
  %"22" = sub nsw i64 4294967295, %"21", !dbg !58
...
main_wrap_around.exit2:                           ; preds = %main_wrap_around.exit, %main_bb12, %main_bb14, %main_bb15, %main_bb16
  ...
  %"25" = add nsw i64 4294967295, 3000000000, !dbg !61
  %"26" = add nsw i64 %"25", 1, !dbg !61
  %"27" = icmp sgt i64 %"26", 4294967295, !dbg !62
  br i1 %"27", label %main_bb9, label %main_bb10, !dbg !62
...
main_bb10:                                        ; preds = %main_wrap_around.exit2
  ...
  br i1 %"31", label %main_bb11, label %main_wrap_around.exit4, !dbg !64
...
main_wrap_around.exit4:                           ; preds = %main_bb9, %main_bb10, %main_bb11
  %.0.i3 = phi i64 [ %"30", %main_bb9 ], [ %"35", %main_bb11 ], [ %"26", %main_bb10 ], !dbg !61
  %"36" = icmp slt i64 %newbufsize.0, %.0.i3, !dbg !61
  br i1 %"36", label %main_bb12, label %main_bb17, !dbg !61

main_bb12:                                        ; preds = %main_wrap_around.exit4
  %"37" = icmp sge i64 %newbufsize.0, 2147483648, !dbg !66
  br i1 %"37", label %main_wrap_around.exit2, label %main_bb13, !dbg !66

main_bb13:                                        ; preds = %main_bb12
  %"38" = mul nsw i64 %newbufsize.0, 2, !dbg !69
  %"39" = icmp sgt i64 %"38", 4294967295, !dbg !70
  br i1 %"39", label %main_bb14, label %main_bb15, !dbg !70

main_bb14:                                        ; preds = %main_bb13
  %"40" = sub nsw i64 %"38", 4294967295, !dbg !71
  %"41" = sub nsw i64 %"40", 1, !dbg !71
  %"42" = srem i64 %"41", 4294967296, !dbg !71
  br label %main_wrap_around.exit2, !dbg !71

main_bb15:                                        ; preds = %main_bb13
  %"43" = icmp slt i64 %"38", 0, !dbg !72
  br i1 %"43", label %main_bb16, label %main_wrap_around.exit2, !dbg !72

main_bb16:                                        ; preds = %main_bb15
  %"44" = sub nsw i64 0, %"38", !dbg !73
  %"45" = sub nsw i64 %"44", 1, !dbg !73
  %"46" = srem i64 %"45", 4294967296, !dbg !73
  %"47" = sub nsw i64 4294967295, %"46", !dbg !73
...
!50 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331659, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [upper_bound] [line 11]
!51 = metadata !{i32 11, i32 73, metadata !4, metadata !43}
!52 = metadata !{i64 4294967296}
!53 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 12, metadata !8, i32 0, metadata !43} ; [ DW_TAG_auto_variable ] [range] [line 12]
!54 = metadata !{i32 12, i32 15, metadata !4, metadata !43}
!55 = metadata !{i32 13, i32 9, metadata !26, metadata !43}
!56 = metadata !{i32 14, i32 9, metadata !28, metadata !43}
!57 = metadata !{i32 16, i32 14, metadata !30, metadata !43}
!58 = metadata !{i32 17, i32 9, metadata !32, metadata !43}
!59 = metadata !{i32 30, i32 9, metadata !60, null}
!60 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 9, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 34, i32 25, metadata !9, null}
!62 = metadata !{i32 13, i32 9, metadata !26, metadata !61}
!63 = metadata !{i32 14, i32 9, metadata !28, metadata !61}
!64 = metadata !{i32 16, i32 14, metadata !30, metadata !61}
!65 = metadata !{i32 17, i32 9, metadata !32, metadata !61}
!66 = metadata !{i32 36, i32 13, metadata !67, null}
!67 = metadata !{i32 786443, metadata !1, metadata !68, i32 36, i32 13, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!68 = metadata !{i32 786443, metadata !1, metadata !9, i32 35, i32 5, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 41, i32 26, metadata !67, null}
!70 = metadata !{i32 13, i32 9, metadata !26, metadata !69}
!71 = metadata !{i32 14, i32 9, metadata !28, metadata !69}
!72 = metadata !{i32 16, i32 14, metadata !30, metadata !69}
!73 = metadata !{i32 17, i32 9, metadata !32, metadata !69}
!74 = metadata !{i32 44, i32 1, metadata !9, null}
