...
main_bb5:
  ...
  %"12" = icmp slt i64 200, -1, !dbg !43
  %"13" = icmp sle i64 500, 0, !dbg !45
...
main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  ...
  %"38" = icmp ne i64 200, -1, !dbg !60
  %"39" = icmp sgt i64 %.0.i3, 200, !dbg !62
  %or.cond6 = and i1 %"38", %"39", !dbg !60
  %size.1 = select i1 %or.cond6, i64 200, i64 %.0.i3, !dbg !60
  %"40" = sub nsw i64 %size.1, 500, !dbg !64
