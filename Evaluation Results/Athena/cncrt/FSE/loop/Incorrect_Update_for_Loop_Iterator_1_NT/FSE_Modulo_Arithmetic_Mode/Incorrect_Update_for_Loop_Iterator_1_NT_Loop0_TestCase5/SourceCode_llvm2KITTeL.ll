...
main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  ...
  %"38" = icmp ne i64 4096, -1, !dbg !60
  %"39" = icmp sgt i64 %.0.i3, 4096, !dbg !62
  %or.cond6 = and i1 %"38", %"39", !dbg !60
  %size.1 = select i1 %or.cond6, i64 4096, i64 %.0.i3, !dbg !60
