...
main_bb7:
  ...
  br i1 %or.cond, label %main_bb11, label %main_bb8, !dbg !54

main_bb8:                                         ; preds = %main_bb7, %main_read.exit
  %pos.0 = phi i32 [ %"18", %main_read.exit ], [ 0, %main_bb7 ]
...
main_read.exit:                                   ; preds = %main_bb9, %main_bb10
  ...
  %cond = icmp eq i32 %.0.i, 0, !dbg !66
  %"17" = add nsw i32 %.0.i, 1, !dbg !68
  %..0.i = select i1 %cond, i32 %"17", i32 %.0.i, !dbg !66
  %"18" = add nsw i32 %pos.0, %..0.i, !dbg !70
  br label %main_bb8, !dbg !71
...
!58 = metadata !{i32 71, i32 5, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !9, i32 71, i32 5, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 73, i32 18, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !9, i32 72, i32 5, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 34, i32 9, metadata !25, metadata !60}
!63 = metadata !{i32 36, i32 5, metadata !27, metadata !60}
!64 = metadata !{i32 56, i32 17, metadata !43, metadata !60}
!65 = metadata !{i32 57, i32 17, metadata !43, metadata !60}
!66 = metadata !{i32 74, i32 13, metadata !67, null}
!67 = metadata !{i32 786443, metadata !1, metadata !61, i32 74, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!68 = metadata !{i32 82, i32 13, metadata !69, null}
!69 = metadata !{i32 786443, metadata !1, metadata !61, i32 81, i32 13, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!70 = metadata !{i32 83, i32 9, metadata !61, null}
!71 = metadata !{i32 84, i32 5, metadata !61, null}
!72 = metadata !{i32 86, i32 1, metadata !9, null}
