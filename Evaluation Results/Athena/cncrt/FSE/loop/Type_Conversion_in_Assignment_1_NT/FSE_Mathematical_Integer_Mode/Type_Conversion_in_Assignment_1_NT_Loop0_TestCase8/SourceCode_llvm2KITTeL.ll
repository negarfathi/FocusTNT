...
main_fgetc.exit:                                  ; preds = %main_bb4, %main_bb5
  ...
  %"13" = icmp eq i32 %"12", 0, !dbg !40
  %"14" = zext i8 %"11" to i32
  %"15" = icmp eq i32 %"14", -1, !dbg !42
  %or.cond = or i1 %"13", %"15", !dbg !40
  br i1 %or.cond, label %main_bb6, label %main_bb4, !dbg !40
...
!35 = metadata !{i32 -255}
!36 = metadata !{i32 26, i32 5, metadata !33, null}
!37 = metadata !{i32 14, i32 9, metadata !16, metadata !31}
!38 = metadata !{i32 16, i32 5, metadata !4, metadata !31}
!39 = metadata !{i32 21, i32 5, metadata !4, metadata !31}
!40 = metadata !{i32 29, i32 13, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !32, i32 29, i32 13, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 29, i32 13, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !41, i32 29, i32 13, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 43, i32 1, metadata !9, null}
