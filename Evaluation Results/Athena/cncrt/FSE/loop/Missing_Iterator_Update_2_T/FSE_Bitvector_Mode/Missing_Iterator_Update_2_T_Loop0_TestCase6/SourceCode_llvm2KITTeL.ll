...
main_mdb_cursor_get.exit:
  ...
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !34), !dbg !39
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !40), !dbg !42
  br label %main_bb3, !dbg !43

main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get.exit
  %.sink7 = phi i32 [ %"7", %main_mdb_cursor_get.exit ], [ %"12", %main_bb4 ]
  %"8" = icmp sgt i32 %.sink7, 1000, !dbg !29
  %. = select i1 %"8", i32 1, i32 0, !dbg !29
  %"9" = icmp eq i32 %., 0, !dbg !44
  br i1 %"9", label %main_bb4, label %main_bb5, !dbg !44

main_bb4:                                         ; preds = %main_bb3
  %"10" = load i32* @"'flag", align 4, !dbg !46
  %"11" = add nsw i32 %"10", 1, !dbg !46
  store i32 %"11", i32* @"'flag", align 4, !dbg !46
  %"12" = load i32* @"'flag", align 4, !dbg !47
...
!32 = metadata !{i32 786688, metadata !9, metadata !"dval_mv_size", metadata !5, i32 26, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [dval_mv_size] [line 26]
!33 = metadata !{i32 26, i32 9, metadata !9, null}
!34 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 12, metadata !8, i32 0, metadata !35} ; [ DW_TAG_auto_variable ] [i] [line 12]
!35 = metadata !{i32 31, i32 18, metadata !36, null}
!36 = metadata !{i32 786443, metadata !1, metadata !37, i32 30, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!37 = metadata !{i32 786443, metadata !1, metadata !38, i32 29, i32 13, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!38 = metadata !{i32 786443, metadata !1, metadata !9, i32 28, i32 5, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!39 = metadata !{i32 12, i32 9, metadata !4, metadata !35}
!40 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 12, metadata !8, i32 0, metadata !41} ; [ DW_TAG_auto_variable ] [i] [line 12]
!41 = metadata !{i32 34, i32 14, metadata !38, null}
!42 = metadata !{i32 12, i32 9, metadata !4, metadata !41}
!43 = metadata !{i32 27, i32 5, metadata !9, null}
!44 = metadata !{i32 27, i32 5, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 5, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 13, i32 5, metadata !4, metadata !35}
!47 = metadata !{i32 14, i32 9, metadata !20, metadata !35}
!48 = metadata !{i32 32, i32 13, metadata !36, null}
!49 = metadata !{i32 36, i32 5, metadata !9, null}
