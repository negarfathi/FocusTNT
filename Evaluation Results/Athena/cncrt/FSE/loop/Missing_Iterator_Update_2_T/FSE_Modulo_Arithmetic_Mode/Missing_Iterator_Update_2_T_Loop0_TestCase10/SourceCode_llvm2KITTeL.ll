...
main_wrap_around.exit.i:                          ; preds = %main_bb14, %main_bb13, %main_bb12
  ...
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !87), !dbg !92
  call void @llvm.dbg.value(metadata !{i64 %"44"}, i64 0, metadata !93), !dbg !95
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !96), !dbg !97
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !98), !dbg !99
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !100), !dbg !101
  call void @llvm.dbg.value(metadata !{i64 %.9}, i64 0, metadata !82), !dbg !83
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !102), !dbg !104
  call void @llvm.dbg.value(metadata !{i64 %"44"}, i64 0, metadata !105), !dbg !107
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !108), !dbg !109
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !110), !dbg !111
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !112), !dbg !113
...
main_bb15:                                        ; preds = %main_wrap_around.exit.i2, %main_wrap_around.exit.i6, %main_wrap_around.exit.i
  ...
  %"41" = icmp eq i64 %rc.0, 0, !dbg !115
  br i1 %"41", label %main_bb16, label %main_bb25, !dbg !115

main_bb16:                                        ; preds = %main_bb15
  %"42" = icmp sle i64 -10, 0, !dbg !117
  %"43" = load i64* @"'flag", align 8, !dbg !94
  %"44" = add nsw i64 %"43", 1, !dbg !94
  %"45" = icmp sgt i64 %"44", 2147483647, !dbg !118
  br i1 %"42", label %main_bb17, label %main_bb21, !dbg !117

main_bb17:                                        ; preds = %main_bb16
  br i1 %"45", label %main_bb18, label %main_bb19, !dbg !118

main_bb18:                                        ; preds = %main_bb17
  %"46" = sub nsw i64 %"44", 2147483647, !dbg !119
  %"47" = sub nsw i64 %"46", 1, !dbg !119
  %"48" = srem i64 %"47", 4294967296, !dbg !119
  %"49" = add nsw i64 -2147483648, %"48", !dbg !119
  br label %main_wrap_around.exit.i6, !dbg !119

main_bb19:                                        ; preds = %main_bb17
  %"50" = icmp slt i64 %"44", -2147483648, !dbg !120
  br i1 %"50", label %main_bb20, label %main_wrap_around.exit.i6, !dbg !120

main_bb20:                                        ; preds = %main_bb19
  %"51" = sub nsw i64 -2147483648, %"44", !dbg !121
  %"52" = sub nsw i64 %"51", 1, !dbg !121
  %"53" = srem i64 %"52", 4294967296, !dbg !121
  %"54" = sub nsw i64 2147483647, %"53", !dbg !121
  br label %main_wrap_around.exit.i6, !dbg !121

main_wrap_around.exit.i6:                         ; preds = %main_bb20, %main_bb19, %main_bb18
  %.0.i.i5 = phi i64 [ %"49", %main_bb18 ], [ %"54", %main_bb20 ], [ %"44", %main_bb19 ], !dbg !94
  store i64 %.0.i.i5, i64* @"'flag", align 8, !dbg !94
  %"55" = load i64* @"'flag", align 8, !dbg !122
  %"56" = icmp sgt i64 %"55", 1000, !dbg !122
  %.9 = select i1 %"56", i64 1, i64 0, !dbg !122
  br label %main_bb15, !dbg !123

main_bb21:                                        ; preds = %main_bb16
  br i1 %"45", label %main_bb22, label %main_bb23, !dbg !124

main_bb22:                                        ; preds = %main_bb21
  %"57" = sub nsw i64 %"44", 2147483647, !dbg !125
  %"58" = sub nsw i64 %"57", 1, !dbg !125
  %"59" = srem i64 %"58", 4294967296, !dbg !125
  %"60" = add nsw i64 -2147483648, %"59", !dbg !125
  br label %main_wrap_around.exit.i2, !dbg !125

main_bb23:                                        ; preds = %main_bb21
  %"61" = icmp slt i64 %"44", -2147483648, !dbg !126
  br i1 %"61", label %main_bb24, label %main_wrap_around.exit.i2, !dbg !126

main_bb24:                                        ; preds = %main_bb23
  %"62" = sub nsw i64 -2147483648, %"44", !dbg !127
  %"63" = sub nsw i64 %"62", 1, !dbg !127
  %"64" = srem i64 %"63", 4294967296, !dbg !127
  %"65" = sub nsw i64 2147483647, %"64", !dbg !127
  br label %main_wrap_around.exit.i2, !dbg !127

main_wrap_around.exit.i2:                         ; preds = %main_bb24, %main_bb23, %main_bb22
  %.0.i.i1 = phi i64 [ %"60", %main_bb22 ], [ %"65", %main_bb24 ], [ %"44", %main_bb23 ], !dbg !106
  store i64 %.0.i.i1, i64* @"'flag", align 8, !dbg !106
  %"66" = load i64* @"'flag", align 8, !dbg !128
  %"67" = icmp sgt i64 %"66", 1000, !dbg !128
  %.10 = select i1 %"67", i64 1, i64 0, !dbg !128
...
!88 = metadata !{i32 47, i32 18, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !90, i32 46, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!90 = metadata !{i32 786443, metadata !1, metadata !91, i32 45, i32 13, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!91 = metadata !{i32 786443, metadata !1, metadata !12, i32 44, i32 5, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!92 = metadata !{i32 24, i32 15, metadata !9, metadata !88}
!93 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !94} ; [ DW_TAG_arg_variable ] [value] [line 12]
!94 = metadata !{i32 25, i32 13, metadata !9, metadata !88}
!95 = metadata !{i32 12, i32 33, metadata !4, metadata !94}
!96 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !94} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!97 = metadata !{i32 12, i32 50, metadata !4, metadata !94}
!98 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !94} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!99 = metadata !{i32 12, i32 73, metadata !4, metadata !94}
!100 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !94} ; [ DW_TAG_auto_variable ] [range] [line 13]
!101 = metadata !{i32 13, i32 15, metadata !4, metadata !94}
!102 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 24, metadata !8, i32 0, metadata !103} ; [ DW_TAG_auto_variable ] [i] [line 24]
!103 = metadata !{i32 50, i32 14, metadata !91, null}
!104 = metadata !{i32 24, i32 15, metadata !9, metadata !103}
!105 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !106} ; [ DW_TAG_arg_variable ] [value] [line 12]
!106 = metadata !{i32 25, i32 13, metadata !9, metadata !103}
!107 = metadata !{i32 12, i32 33, metadata !4, metadata !106}
!108 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !106} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!109 = metadata !{i32 12, i32 50, metadata !4, metadata !106}
!110 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !106} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!111 = metadata !{i32 12, i32 73, metadata !4, metadata !106}
!112 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !106} ; [ DW_TAG_auto_variable ] [range] [line 13]
!113 = metadata !{i32 13, i32 15, metadata !4, metadata !106}
!114 = metadata !{i32 43, i32 5, metadata !12, null}
!115 = metadata !{i32 43, i32 5, metadata !116, null}
!116 = metadata !{i32 786443, metadata !1, metadata !12, i32 43, i32 5, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!117 = metadata !{i32 45, i32 13, metadata !90, null}
!118 = metadata !{i32 14, i32 9, metadata !31, metadata !94}
!119 = metadata !{i32 15, i32 9, metadata !33, metadata !94}
!120 = metadata !{i32 17, i32 14, metadata !35, metadata !94}
!121 = metadata !{i32 18, i32 9, metadata !37, metadata !94}
!122 = metadata !{i32 26, i32 9, metadata !59, metadata !88}
!123 = metadata !{i32 48, i32 13, metadata !89, null}
!124 = metadata !{i32 14, i32 9, metadata !31, metadata !106}
!125 = metadata !{i32 15, i32 9, metadata !33, metadata !106}
!126 = metadata !{i32 17, i32 14, metadata !35, metadata !106}
!127 = metadata !{i32 18, i32 9, metadata !37, metadata !106}
!128 = metadata !{i32 26, i32 9, metadata !59, metadata !103}
!129 = metadata !{i32 51, i32 5, metadata !91, null}
!130 = metadata !{i32 52, i32 5, metadata !12, null}
