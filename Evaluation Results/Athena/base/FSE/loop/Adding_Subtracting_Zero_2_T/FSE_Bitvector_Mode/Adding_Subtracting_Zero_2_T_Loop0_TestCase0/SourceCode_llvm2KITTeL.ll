...
main_bb5:
  ...
  br i1 %or.cond, label %main_bb12, label %main_bb6, !dbg !36

main_bb6:                                         ; preds = %main_bb11, %main_bb5
  %b.0 = phi i32 [ %"7", %main_bb5 ], [ %"21", %main_bb11 ]
  %"11" = icmp slt i32 %b.0, %"8", !dbg !40
  br i1 %"11", label %main_bb7, label %main_bb12, !dbg !40
...
main_ff_subtitles_next_line.exit:                 ; preds = %main_bb7, %main_bb9, %main_bb10
  ...
  br i1 %"20", label %main_bb11, label %main_bb12, !dbg !52

main_bb11:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"21" = add nsw i32 %b.0, %"19", !dbg !54
  %"22" = sub nsw i32 %"8", 4, !dbg !55
  %"23" = icmp sge i32 %"21", %"22", !dbg !55
  br i1 %"23", label %main_bb12, label %main_bb6, !dbg !55
...
!15 = metadata !{i32 13, i32 13, metadata !4, null}
...
!30 = metadata !{i32 30, i32 13, metadata !9, null}
...
!33 = metadata !{i32 31, i32 15, metadata !9, null}
...
!42 = metadata !{i32 13, i32 13, metadata !4, metadata !43}
...
!45 = metadata !{i32 14, i32 5, metadata !4, metadata !43}
!46 = metadata !{i32 15, i32 9, metadata !20, metadata !43}
!47 = metadata !{i32 17, i32 9, metadata !22, metadata !43}
!48 = metadata !{i32 19, i32 9, metadata !24, metadata !43}
!49 = metadata !{i32 20, i32 9, metadata !24, metadata !43}
!50 = metadata !{i32 22, i32 14, metadata !28, metadata !43}
!51 = metadata !{i32 23, i32 5, metadata !28, metadata !43}
!52 = metadata !{i32 37, i32 13, metadata !53, null}
!53 = metadata !{i32 786443, metadata !1, metadata !44, i32 37, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 39, i32 9, metadata !44, null}
!55 = metadata !{i32 40, i32 13, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !44, i32 40, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 44, i32 1, metadata !9, null}
