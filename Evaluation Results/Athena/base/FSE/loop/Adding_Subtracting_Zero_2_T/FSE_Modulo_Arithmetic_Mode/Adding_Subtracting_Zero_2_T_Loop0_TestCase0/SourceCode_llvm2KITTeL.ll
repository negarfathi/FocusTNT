...
main_bb13:
  ...
  br i1 %or.cond, label %main_bb30, label %main_bb14, !dbg !84
...
main_bb14:                                        ; preds = %main_wrap_around.exit3, %main_bb13
  ...
  br i1 %"33", label %main_bb15, label %main_bb30, !dbg !88
...
main_ff_subtitles_next_line.exit:                 ; preds = %main_bb15, %main_bb17, %main_bb18, %main_bb20, %main_bb21, %main_bb22
  ...
  %"51" = icmp ne i64 %.0.i, 0, !dbg !104
  br i1 %"51", label %main_bb23, label %main_bb30, !dbg !104

main_bb23:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"52" = add nsw i64 %b.0, %.0.i, !dbg !106
  %"53" = icmp sgt i64 %"52", 2147483647, !dbg !107
  br i1 %"53", label %main_bb24, label %main_bb25, !dbg !107

main_bb24:                                        ; preds = %main_bb23
  %"54" = sub nsw i64 %"52", 2147483647, !dbg !108
  %"55" = sub nsw i64 %"54", 1, !dbg !108
  %"56" = srem i64 %"55", 4294967296, !dbg !108
  %"57" = add nsw i64 -2147483648, %"56", !dbg !108
  br label %main_wrap_around.exit, !dbg !108

main_bb25:                                        ; preds = %main_bb23
  %"58" = icmp slt i64 %"52", -2147483648, !dbg !109
  br i1 %"58", label %main_bb26, label %main_wrap_around.exit, !dbg !109

main_bb26:                                        ; preds = %main_bb25
  %"59" = sub nsw i64 -2147483648, %"52", !dbg !110
  %"60" = sub nsw i64 %"59", 1, !dbg !110
  %"61" = srem i64 %"60", 4294967296, !dbg !110
  %"62" = sub nsw i64 2147483647, %"61", !dbg !110
  br label %main_wrap_around.exit, !dbg !110

main_wrap_around.exit:                            ; preds = %main_bb24, %main_bb25, %main_bb26
  %.0.i1 = phi i64 [ %"57", %main_bb24 ], [ %"62", %main_bb26 ], [ %"52", %main_bb25 ], !dbg !106
  %"63" = sub nsw i64 %"30", 4, !dbg !111
  %"64" = icmp sgt i64 %"63", 2147483647, !dbg !113
  br i1 %"64", label %main_bb27, label %main_bb28, !dbg !113

main_bb27:                                        ; preds = %main_wrap_around.exit
  %"65" = sub nsw i64 %"63", 2147483647, !dbg !114
  %"66" = sub nsw i64 %"65", 1, !dbg !114
  %"67" = srem i64 %"66", 4294967296, !dbg !114
  %"68" = add nsw i64 -2147483648, %"67", !dbg !114
  br label %main_wrap_around.exit3, !dbg !114

main_bb28:                                        ; preds = %main_wrap_around.exit
  %"69" = icmp slt i64 %"63", -2147483648, !dbg !115
  br i1 %"69", label %main_bb29, label %main_wrap_around.exit3, !dbg !115

main_bb29:                                        ; preds = %main_bb28
  %"70" = sub nsw i64 -2147483648, %"63", !dbg !116
  %"71" = sub nsw i64 %"70", 1, !dbg !116
  %"72" = srem i64 %"71", 4294967296, !dbg !116
  %"73" = sub nsw i64 2147483647, %"72", !dbg !116
  br label %main_wrap_around.exit3, !dbg !116

main_wrap_around.exit3:                           ; preds = %main_bb27, %main_bb28, %main_bb29
  %.0.i2 = phi i64 [ %"68", %main_bb27 ], [ %"73", %main_bb29 ], [ %"63", %main_bb28 ], !dbg !111
  %"74" = icmp sge i64 %.0.i1, %.0.i2, !dbg !111
  br i1 %"74", label %main_bb30, label %main_bb14, !dbg !111

main_bb30:                                        ; preds = %main_bb14, %main_ff_subtitles_next_line.exit, %main_wrap_around.exit3, %main_bb13
  ret i32 0, !dbg !117
}
...
!39 = metadata !{i32 25, i32 19, metadata !9, null}
...
!78 = metadata !{i32 46, i32 19, metadata !12, null}
...
!81 = metadata !{i32 47, i32 21, metadata !12, null}
...
!88 = metadata !{i32 52, i32 5, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 5, i32 1, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!90 = metadata !{i32 25, i32 19, metadata !9, metadata !91}
!91 = metadata !{i32 54, i32 25, metadata !92, null}
!92 = metadata !{i32 786443, metadata !1, metadata !12, i32 53, i32 5, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!93 = metadata !{i32 26, i32 9, metadata !9, metadata !91}
!94 = metadata !{i32 27, i32 9, metadata !55, metadata !91}
!95 = metadata !{i32 31, i32 9, metadata !57, metadata !91}
!96 = metadata !{i32 33, i32 9, metadata !59, metadata !91}
!97 = metadata !{i32 34, i32 9, metadata !59, metadata !91}
!98 = metadata !{i32 36, i32 14, metadata !62, metadata !91}
!99 = metadata !{i32 38, i32 12, metadata !64, metadata !91}
!100 = metadata !{i32 15, i32 9, metadata !31, metadata !99}
!101 = metadata !{i32 16, i32 9, metadata !33, metadata !99}
!102 = metadata !{i32 18, i32 14, metadata !35, metadata !99}
!103 = metadata !{i32 19, i32 9, metadata !37, metadata !99}
!104 = metadata !{i32 55, i32 13, metadata !105, null}
!105 = metadata !{i32 786443, metadata !1, metadata !92, i32 55, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!106 = metadata !{i32 59, i32 13, metadata !92, null}
!107 = metadata !{i32 15, i32 9, metadata !31, metadata !106}
!108 = metadata !{i32 16, i32 9, metadata !33, metadata !106}
!109 = metadata !{i32 18, i32 14, metadata !35, metadata !106}
!110 = metadata !{i32 19, i32 9, metadata !37, metadata !106}
!111 = metadata !{i32 60, i32 18, metadata !112, null}
!112 = metadata !{i32 786443, metadata !1, metadata !92, i32 60, i32 13, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!113 = metadata !{i32 15, i32 9, metadata !31, metadata !111}
!114 = metadata !{i32 16, i32 9, metadata !33, metadata !111}
!115 = metadata !{i32 18, i32 14, metadata !35, metadata !111}
!116 = metadata !{i32 19, i32 9, metadata !37, metadata !111}
!117 = metadata !{i32 66, i32 1, metadata !12, null}
