...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !35), !dbg !36
...
main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  %res.0 = phi i64 [ 0, %main_bb5 ], [ %res.1, %main_wrap_around.exit ]
  %pkt.0 = phi i64 [ %"12", %main_bb5 ], [ %pkt.1, %main_wrap_around.exit ]
  %"13" = icmp slt i64 %pkt.0, 10, !dbg !55
  br i1 %"13", label %main_wrap_around.exit, label %main_bb11, !dbg !55

main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  %res.1 = phi i64 [ %res.0, %main_bb6 ], [ %"15", %main_bb8 ], [ %"15", %main_bb9 ], [ %"15", %main_bb10 ]
  %pkt.1 = phi i64 [ %pkt.0, %main_bb6 ], [ %"21", %main_bb8 ], [ %"26", %main_bb10 ], [ %"16", %main_bb9 ]
  %"14" = icmp eq i64 %res.1, 0, !dbg !57
  br i1 %"14", label %main_bb7, label %main_bb6, !dbg !57
...
main_bb7:                                         ; preds = %main_wrap_around.exit
  ...
  br i1 %"17", label %main_bb8, label %main_bb9, !dbg !60
...
main_bb9:                                         ; preds = %main_bb7
  ...
  br i1 %"22", label %main_bb10, label %main_wrap_around.exit, !dbg !62
...
!34 = metadata !{i64 0}
!35 = metadata !{i32 786688, metadata !9, metadata !"res", metadata !5, i32 23, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [res] [line 23]
!36 = metadata !{i32 23, i32 15, metadata !9, null}
!37 = metadata !{i32 24, i32 21, metadata !9, null}
!38 = metadata !{i32 786688, metadata !9, metadata !"pkt", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [pkt] [line 24]
...
!41 = metadata !{i32 30, i32 20, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !43, i32 28, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!56 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 5, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 27, i32 9, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !43, i32 27, i32 9, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 29, i32 19, metadata !42, null}
...
!64 = metadata !{i32 33, i32 5, metadata !9, null}
