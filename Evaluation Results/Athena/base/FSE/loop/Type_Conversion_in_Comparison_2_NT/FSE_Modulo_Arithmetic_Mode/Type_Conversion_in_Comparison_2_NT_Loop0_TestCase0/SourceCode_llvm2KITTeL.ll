...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %ac.0 = phi i64 [ %"12", %main_bb5 ], [ %"19", %main_bb7 ], [ %"24", %main_bb9 ], [ %"15", %main_bb8 ]
  %"14" = icmp ne i64 %ac.0, %"13", !dbg !56
  br i1 %"14", label %main_bb6, label %main_bb10, !dbg !56

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"15" = add nsw i64 %ac.0, 1, !dbg !43
  %"16" = icmp sgt i64 %"15", 255, !dbg !59
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !59

main_bb7:                                         ; preds = %main_bb6
  %"17" = sub nsw i64 %"15", 255, !dbg !60
  %"18" = sub nsw i64 %"17", 1, !dbg !60
  %"19" = srem i64 %"18", 256, !dbg !60
  br label %main_wrap_around.exit, !dbg !60

main_bb8:                                         ; preds = %main_bb6
  %"20" = icmp slt i64 %"15", 0, !dbg !61
  br i1 %"20", label %main_bb9, label %main_wrap_around.exit, !dbg !61

main_bb9:                                         ; preds = %main_bb8
  %"21" = sub nsw i64 0, %"15", !dbg !62
  %"22" = sub nsw i64 %"21", 1, !dbg !62
  %"23" = srem i64 %"22", 256, !dbg !62
  %"24" = sub nsw i64 255, %"23", !dbg !62
...
!34 = metadata !{i32 25, i32 17, metadata !9, null}
...
!37 = metadata !{i32 26, i32 18, metadata !9, null}
!38 = metadata !{i32 786688, metadata !9, metadata !"c2", metadata !5, i32 26, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [c2] [line 26]
!39 = metadata !{i32 26, i32 12, metadata !9, null}
!40 = metadata !{i32 786688, metadata !9, metadata !"ac", metadata !5, i32 27, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ac] [line 27]
!41 = metadata !{i32 27, i32 12, metadata !9, null}
!42 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777229, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [value] [line 13]
!43 = metadata !{i32 28, i32 34, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 28, i32 2, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 13, i32 33, metadata !4, metadata !43}
!46 = metadata !{i64 0}
!47 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554445, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [lower_bound] [line 13]
!48 = metadata !{i32 13, i32 50, metadata !4, metadata !43}
!49 = metadata !{i64 255}
!50 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331661, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [upper_bound] [line 13]
!51 = metadata !{i32 13, i32 73, metadata !4, metadata !43}
!52 = metadata !{i64 256}
!53 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 14, metadata !8, i32 0, metadata !43} ; [ DW_TAG_auto_variable ] [range] [line 14]
!54 = metadata !{i32 14, i32 15, metadata !4, metadata !43}
!55 = metadata !{i32 28, i32 7, metadata !44, null}
!56 = metadata !{i32 28, i32 7, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !58, i32 28, i32 7, i32 2, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 786443, metadata !1, metadata !44, i32 28, i32 7, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 15, i32 9, metadata !26, metadata !43}
!60 = metadata !{i32 16, i32 9, metadata !28, metadata !43}
!61 = metadata !{i32 18, i32 14, metadata !30, metadata !43}
!62 = metadata !{i32 19, i32 9, metadata !32, metadata !43}
!63 = metadata !{i32 32, i32 2, metadata !9, null}
