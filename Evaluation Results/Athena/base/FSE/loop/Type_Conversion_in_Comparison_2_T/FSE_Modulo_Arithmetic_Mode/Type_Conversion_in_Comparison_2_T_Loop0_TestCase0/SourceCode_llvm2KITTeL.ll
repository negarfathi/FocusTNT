...
main_bb5:
  ...
  %"13" = call i64 @__VERIFIER_nondet_char(), !dbg !37
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !38), !dbg !39
  %"14" = trunc i64 %"12" to i8, !dbg !40
  %"15" = zext i8 %"14" to i64, !dbg !40
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !42), !dbg !43
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !44), !dbg !46
  ...
  call void @llvm.dbg.value(metadata !{i64 %"26"}, i64 0, metadata !56), !dbg !58
...
main_wrap_around.exit2:                           ; preds = %main_bb12, %main_bb11, %main_bb10, %main_bb5
  %ac.0 = phi i64 [ %"15", %main_bb5 ], [ %"30", %main_bb10 ], [ %"35", %main_bb12 ], [ %"26", %main_bb11 ]
  %"16" = icmp sgt i64 %"13", 255, !dbg !65
  br i1 %"16", label %main_bb6, label %main_bb7, !dbg !65

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"17" = sub nsw i64 %"13", 255, !dbg !66
  %"18" = sub nsw i64 %"17", 1, !dbg !66
  %"19" = srem i64 %"18", 256, !dbg !66
  br label %main_wrap_around.exit, !dbg !66

main_bb7:                                         ; preds = %main_wrap_around.exit2
  %"20" = icmp slt i64 %"13", 0, !dbg !67
  br i1 %"20", label %main_bb8, label %main_wrap_around.exit, !dbg !67

main_bb8:                                         ; preds = %main_bb7
  %"21" = sub nsw i64 0, %"13", !dbg !68
  %"22" = sub nsw i64 %"21", 1, !dbg !68
  %"23" = srem i64 %"22", 256, !dbg !68
  %"24" = sub nsw i64 255, %"23", !dbg !68
  br label %main_wrap_around.exit, !dbg !68

main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  %.0.i = phi i64 [ %"19", %main_bb6 ], [ %"24", %main_bb8 ], [ %"13", %main_bb7 ], !dbg !45
  %"25" = icmp ne i64 %ac.0, %.0.i, !dbg !45
  br i1 %"25", label %main_bb9, label %main_bb13, !dbg !45

main_bb9:                                         ; preds = %main_wrap_around.exit
  %"26" = add nsw i64 %ac.0, 1, !dbg !57
  %"27" = icmp sgt i64 %"26", 255, !dbg !69
  br i1 %"27", label %main_bb10, label %main_bb11, !dbg !69

main_bb10:                                        ; preds = %main_bb9
  %"28" = sub nsw i64 %"26", 255, !dbg !70
  %"29" = sub nsw i64 %"28", 1, !dbg !70
  %"30" = srem i64 %"29", 256, !dbg !70
  br label %main_wrap_around.exit2, !dbg !70

main_bb11:                                        ; preds = %main_bb9
  %"31" = icmp slt i64 %"26", 0, !dbg !71
  br i1 %"31", label %main_bb12, label %main_wrap_around.exit2, !dbg !71

main_bb12:                                        ; preds = %main_bb11
  %"32" = sub nsw i64 0, %"26", !dbg !72
  %"33" = sub nsw i64 %"32", 1, !dbg !72
  %"34" = srem i64 %"33", 256, !dbg !72
  %"35" = sub nsw i64 255, %"34", !dbg !72
...
!34 = metadata !{i32 24, i32 17, metadata !9, null}
...
!37 = metadata !{i32 25, i32 18, metadata !9, null}
...
!47 = metadata !{i64 0}
!48 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !45} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!49 = metadata !{i32 12, i32 50, metadata !4, metadata !45}
!50 = metadata !{i64 255}
!51 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !45} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!52 = metadata !{i32 12, i32 73, metadata !4, metadata !45}
!53 = metadata !{i64 256}
!54 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !45} ; [ DW_TAG_auto_variable ] [range] [line 13]
!55 = metadata !{i32 13, i32 15, metadata !4, metadata !45}
...
!57 = metadata !{i32 27, i32 76, metadata !41, null}
...
!65 = metadata !{i32 14, i32 9, metadata !26, metadata !45}
!66 = metadata !{i32 15, i32 9, metadata !28, metadata !45}
!67 = metadata !{i32 17, i32 14, metadata !30, metadata !45}
!68 = metadata !{i32 18, i32 9, metadata !32, metadata !45}
!69 = metadata !{i32 14, i32 9, metadata !26, metadata !57}
!70 = metadata !{i32 15, i32 9, metadata !28, metadata !57}
!71 = metadata !{i32 17, i32 14, metadata !30, metadata !57}
!72 = metadata !{i32 18, i32 9, metadata !32, metadata !57}
!73 = metadata !{i32 31, i32 2, metadata !9, null}
