...
main_bb5:
  ...
  %"14" = call i64 @__VERIFIER_nondet_uint(), !dbg !42
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !43), !dbg !44
  %"15" = icmp sle i64 %"13", %"14", !dbg !45
  %"16" = icmp eq i64 %"12", 0, !dbg !47
  %or.cond = or i1 %"15", %"16", !dbg !45
  br i1 %or.cond, label %main_bb11, label %main_bb6, !dbg !45

main_bb6:                                         ; preds = %main_bb5, %main_wrap_around.exit
  %cur.0 = phi i64 [ %.0.i, %main_wrap_around.exit ], [ %"12", %main_bb5 ]
  %"17" = icmp slt i64 %"13", %cur.0, !dbg !49
  br i1 %"17", label %main_bb11, label %main_bb7, !dbg !49

main_bb7:                                         ; preds = %main_bb6
  %"18" = add nsw i64 %cur.0, %"12", !dbg !53
  %"19" = icmp sgt i64 %"18", 4294967295, !dbg !54
  br i1 %"19", label %main_bb8, label %main_bb9, !dbg !54

main_bb8:                                         ; preds = %main_bb7
  %"20" = sub nsw i64 %"18", 4294967295, !dbg !55
  %"21" = sub nsw i64 %"20", 1, !dbg !55
  %"22" = srem i64 %"21", 4294967296, !dbg !55
  br label %main_wrap_around.exit, !dbg !55

main_bb9:                                         ; preds = %main_bb7
  %"23" = icmp slt i64 %"18", 0, !dbg !56
  br i1 %"23", label %main_bb10, label %main_wrap_around.exit, !dbg !56

main_bb10:                                        ; preds = %main_bb9
  %"24" = sub nsw i64 0, %"18", !dbg !57
  %"25" = sub nsw i64 %"24", 1, !dbg !57
  %"26" = srem i64 %"25", 4294967296, !dbg !57
  %"27" = sub nsw i64 4294967295, %"26", !dbg !57
  br label %main_wrap_around.exit, !dbg !57

main_wrap_around.exit:                            ; preds = %main_bb8, %main_bb9, %main_bb10
  %.0.i = phi i64 [ %"22", %main_bb8 ], [ %"27", %main_bb10 ], [ %"18", %main_bb9 ], !dbg !53
  %"28" = icmp sle i64 %.0.i, %cur.0, !dbg !58
  br i1 %"28", label %main_bb11, label %main_bb6, !dbg !58
...
!37 = metadata !{i32 786688, metadata !9, metadata !"cur", metadata !5, i32 25, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [cur] [line 25]
!38 = metadata !{i32 25, i32 15, metadata !9, null}
!39 = metadata !{i32 27, i32 24, metadata !9, null}
!40 = metadata !{i32 786688, metadata !9, metadata !"st_max", metadata !5, i32 27, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [st_max] [line 27]
!41 = metadata !{i32 27, i32 15, metadata !9, null}
!42 = metadata !{i32 28, i32 24, metadata !9, null}
!43 = metadata !{i32 786688, metadata !9, metadata !"it_min", metadata !5, i32 28, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [it_min] [line 28]
!44 = metadata !{i32 28, i32 15, metadata !9, null}
!45 = metadata !{i32 29, i32 9, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 29, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 33, i32 9, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 9, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 39, i32 13, metadata !50, null}
!50 = metadata !{i32 786443, metadata !1, metadata !51, i32 39, i32 13, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 786443, metadata !1, metadata !52, i32 38, i32 5, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 786443, metadata !1, metadata !9, i32 37, i32 5, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!53 = metadata !{i32 44, i32 15, metadata !51, null}
!54 = metadata !{i32 14, i32 9, metadata !26, metadata !53}
!55 = metadata !{i32 15, i32 9, metadata !28, metadata !53}
!56 = metadata !{i32 17, i32 14, metadata !30, metadata !53}
!57 = metadata !{i32 18, i32 9, metadata !32, metadata !53}
!58 = metadata !{i32 45, i32 13, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !51, i32 45, i32 13, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 51, i32 1, metadata !9, null}
