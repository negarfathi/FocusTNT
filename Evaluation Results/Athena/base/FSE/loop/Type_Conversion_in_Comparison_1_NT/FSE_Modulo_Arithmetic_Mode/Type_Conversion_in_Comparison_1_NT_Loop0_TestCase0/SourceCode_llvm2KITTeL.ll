...
main_bb5:
  ...
  %"13" = call i64 @__VERIFIER_nondet_ushort(), !dbg !37
  ...
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !42), !dbg !45
  ...
  call void @llvm.dbg.value(metadata !{i64 %"26"}, i64 0, metadata !55), !dbg !57
...
main_wrap_around.exit2:                           ; preds = %main_bb12, %main_bb11, %main_bb10, %main_bb5
  ...
  %"14" = add nsw i64 %"12", %"13", !dbg !43
  %"15" = icmp sgt i64 %"14", 2147483647, !dbg !68
  br i1 %"15", label %main_bb6, label %main_bb7, !dbg !68

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"16" = sub nsw i64 %"14", 2147483647, !dbg !69
  %"17" = sub nsw i64 %"16", 1, !dbg !69
  %"18" = srem i64 %"17", 4294967296, !dbg !69
  %"19" = add nsw i64 -2147483648, %"18", !dbg !69
  br label %main_wrap_around.exit, !dbg !69

main_bb7:                                         ; preds = %main_wrap_around.exit2
  %"20" = icmp slt i64 %"14", -2147483648, !dbg !70
  br i1 %"20", label %main_bb8, label %main_wrap_around.exit, !dbg !70

main_bb8:                                         ; preds = %main_bb7
  %"21" = sub nsw i64 -2147483648, %"14", !dbg !71
  %"22" = sub nsw i64 %"21", 1, !dbg !71
  %"23" = srem i64 %"22", 4294967296, !dbg !71
  %"24" = sub nsw i64 2147483647, %"23", !dbg !71
  br label %main_wrap_around.exit, !dbg !71

main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  %.0.i = phi i64 [ %"19", %main_bb6 ], [ %"24", %main_bb8 ], [ %"14", %main_bb7 ], !dbg !43
  %"25" = icmp slt i64 %s.0, %.0.i, !dbg !43
  br i1 %"25", label %main_bb9, label %main_bb13, !dbg !43

main_bb9:                                         ; preds = %main_wrap_around.exit
  %"26" = add nsw i64 %s.0, 1, !dbg !56
  %"27" = icmp sgt i64 %"26", 65535, !dbg !72
  br i1 %"27", label %main_bb10, label %main_bb11, !dbg !72

main_bb10:                                        ; preds = %main_bb9
  %"28" = sub nsw i64 %"26", 65535, !dbg !73
  %"29" = sub nsw i64 %"28", 1, !dbg !73
  %"30" = srem i64 %"29", 65536, !dbg !73
  br label %main_wrap_around.exit2, !dbg !73

main_bb11:                                        ; preds = %main_bb9
  %"31" = icmp slt i64 %"26", 0, !dbg !74
  br i1 %"31", label %main_bb12, label %main_wrap_around.exit2, !dbg !74

main_bb12:                                        ; preds = %main_bb11
  %"32" = sub nsw i64 0, %"26", !dbg !75
  %"33" = sub nsw i64 %"32", 1, !dbg !75
  %"34" = srem i64 %"33", 65536, !dbg !75
  %"35" = sub nsw i64 65535, %"34", !dbg !75
...
!34 = metadata !{i32 25, i32 14, metadata !9, null}
...
!37 = metadata !{i32 26, i32 11, metadata !9, null}
!38 = metadata !{i32 786688, metadata !9, metadata !"len", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [len] [line 24]
!39 = metadata !{i32 24, i32 26, metadata !9, null}
!40 = metadata !{i32 786688, metadata !9, metadata !"s", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [s] [line 24]
...
!43 = metadata !{i32 27, i32 27, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 5, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 12, i32 33, metadata !4, metadata !43}
!46 = metadata !{i64 -2147483648}
...
!56 = metadata !{i32 27, i32 77, metadata !44, null}
...
!62 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !56} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!63 = metadata !{i32 12, i32 73, metadata !4, metadata !56}
!64 = metadata !{i64 65536}
!65 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !56} ; [ DW_TAG_auto_variable ] [range] [line 13]
!66 = metadata !{i32 13, i32 15, metadata !4, metadata !56}
!67 = metadata !{i32 27, i32 10, metadata !44, null}
...
!72 = metadata !{i32 14, i32 9, metadata !26, metadata !56}
!73 = metadata !{i32 15, i32 9, metadata !28, metadata !56}
!74 = metadata !{i32 17, i32 14, metadata !30, metadata !56}
!75 = metadata !{i32 18, i32 9, metadata !32, metadata !56}
!76 = metadata !{i32 31, i32 5, metadata !9, null}
