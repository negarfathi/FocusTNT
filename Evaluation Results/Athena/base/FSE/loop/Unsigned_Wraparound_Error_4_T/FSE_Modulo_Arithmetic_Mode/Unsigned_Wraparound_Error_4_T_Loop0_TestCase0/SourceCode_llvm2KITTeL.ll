...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !41), !dbg !43
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"13" = icmp sgt i64 %n.0, 0, !dbg !54
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !54

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = icmp sgt i64 %n.0, 16, !dbg !56
  %.n.0 = select i1 %"14", i64 16, i64 %n.0, !dbg !56
  %"15" = sub nsw i64 %n.0, %.n.0, !dbg !42
  %"16" = icmp sgt i64 %"15", 4294967295, !dbg !58
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !58

main_bb7:                                         ; preds = %main_bb6
  %"17" = sub nsw i64 %"15", 4294967295, !dbg !59
  %"18" = sub nsw i64 %"17", 1, !dbg !59
  %"19" = srem i64 %"18", 4294967296, !dbg !59
  br label %main_wrap_around.exit, !dbg !59

main_bb8:                                         ; preds = %main_bb6
  %"20" = icmp slt i64 %"15", 0, !dbg !60
  br i1 %"20", label %main_bb9, label %main_wrap_around.exit, !dbg !60

main_bb9:                                         ; preds = %main_bb8
  %"21" = sub nsw i64 0, %"15", !dbg !61
  %"22" = sub nsw i64 %"21", 1, !dbg !61
  %"23" = srem i64 %"22", 4294967296, !dbg !61
  %"24" = sub nsw i64 4294967295, %"23", !dbg !61
