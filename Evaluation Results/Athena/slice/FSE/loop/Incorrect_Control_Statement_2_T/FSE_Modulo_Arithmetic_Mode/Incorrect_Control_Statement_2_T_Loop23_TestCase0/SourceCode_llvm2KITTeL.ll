...
main_bb5:
  ...
  call void @llvm.dbg.declare(metadata !{[10 x i64]* %ereg}, metadata !40), !dbg !41
...
main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = call i64 @__VERIFIER_nondet_int(), !dbg !65
  %"15" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i.0, !dbg !65
  store i64 %"14", i64* %"15", align 8, !dbg !65
  %"16" = call i64 @__VERIFIER_nondet_int(), !dbg !66
  %"17" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i.0, !dbg !66
  store i64 %"16", i64* %"17", align 8, !dbg !66
...
!40 = metadata !{i32 786688, metadata !9, metadata !"ereg", metadata !5, i32 20, metadata !36, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ereg] [line 20]
!41 = metadata !{i32 20, i32 13, metadata !9, null}
!42 = metadata !{i64 10}
...
!64 = metadata !{i32 786443, metadata !1, metadata !47, i32 25, i32 5, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 26, i32 23, metadata !51, null}
!66 = metadata !{i32 27, i32 17, metadata !51, null}
!67 = metadata !{i32 9, i32 9, metadata !25, metadata !50}
!68 = metadata !{i32 10, i32 9, metadata !27, metadata !50}
!69 = metadata !{i32 12, i32 14, metadata !29, metadata !50}
!70 = metadata !{i32 13, i32 9, metadata !31, metadata !50}
