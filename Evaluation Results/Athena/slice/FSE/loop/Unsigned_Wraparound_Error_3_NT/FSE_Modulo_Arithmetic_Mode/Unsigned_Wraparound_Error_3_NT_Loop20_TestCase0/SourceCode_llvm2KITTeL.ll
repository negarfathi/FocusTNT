...
main_bb5:
  ...
  %"15" = icmp eq i64 %"13", 0, !dbg !42
  br i1 %"15", label %main_bb17, label %main_bb6, !dbg !42

main_bb6:                                         ; preds = %main_bb5
  %"16" = add nsw i64 %"13", %"14", !dbg !44
  %"17" = add nsw i64 %"16", 1, !dbg !44
  call void @llvm.dbg.value(metadata !{i64 %"17"}, i64 0, metadata !46), !dbg !47
  ...
  %"18" = icmp sgt i64 %"17", 4294967295, !dbg !57
  br i1 %"18", label %main_bb7, label %main_bb8, !dbg !57

main_bb7:                                         ; preds = %main_bb6
  %"19" = sub nsw i64 %"17", 4294967295, !dbg !58
  %"20" = sub nsw i64 %"19", 1, !dbg !58
  %"21" = srem i64 %"20", 4294967296, !dbg !58
  br label %main_wrap_around.exit, !dbg !58

main_bb8:                                         ; preds = %main_bb6
  %"22" = icmp slt i64 %"17", 0, !dbg !59
  br i1 %"22", label %main_bb9, label %main_wrap_around.exit, !dbg !59

main_bb9:                                         ; preds = %main_bb8
  %"23" = sub nsw i64 0, %"17", !dbg !60
  %"24" = sub nsw i64 %"23", 1, !dbg !60
  %"25" = srem i64 %"24", 4294967296, !dbg !60
  %"26" = sub nsw i64 4294967295, %"25", !dbg !60
  br label %main_wrap_around.exit, !dbg !60

main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  %.0.i = phi i64 [ %"21", %main_bb7 ], [ %"26", %main_bb9 ], [ %"17", %main_bb8 ], !dbg !44
  %"27" = icmp eq i64 %.0.i, 4294967295, !dbg !44
  br i1 %"27", label %main_bb17, label %main_wrap_around.exit2, !dbg !44
...
main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_wrap_around.exit
  ...
  br i1 %"30", label %main_bb10, label %main_bb11, !dbg !62
...
main_bb11:                                        ; preds = %main_wrap_around.exit2
  ...
  br i1 %"34", label %main_bb12, label %main_wrap_around.exit4, !dbg !64
...
main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  %.0.i3 = phi i64 [ %"33", %main_bb10 ], [ %"38", %main_bb12 ], [ %"29", %main_bb11 ], !dbg !61
  %"39" = icmp slt i64 %newbufsize.0, %.0.i3, !dbg !61
  br i1 %"39", label %main_bb13, label %main_bb17, !dbg !61

main_bb13:                                        ; preds = %main_wrap_around.exit4
  %"40" = mul nsw i64 %newbufsize.0, 2, !dbg !66
  %"41" = icmp sgt i64 %"40", 4294967295, !dbg !68
  br i1 %"41", label %main_bb14, label %main_bb15, !dbg !68

main_bb14:                                        ; preds = %main_bb13
  %"42" = sub nsw i64 %"40", 4294967295, !dbg !69
  %"43" = sub nsw i64 %"42", 1, !dbg !69
  %"44" = srem i64 %"43", 4294967296, !dbg !69
  br label %main_wrap_around.exit2, !dbg !69

main_bb15:                                        ; preds = %main_bb13
  %"45" = icmp slt i64 %"40", 0, !dbg !70
  br i1 %"45", label %main_bb16, label %main_wrap_around.exit2, !dbg !70

main_bb16:                                        ; preds = %main_bb15
  %"46" = sub nsw i64 0, %"40", !dbg !71
  %"47" = sub nsw i64 %"46", 1, !dbg !71
  %"48" = srem i64 %"47", 4294967296, !dbg !71
  %"49" = sub nsw i64 4294967295, %"48", !dbg !71
