...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !39), !dbg !42
  call void @llvm.dbg.value(metadata !{i64 %"22"}, i64 0, metadata !34), !dbg !35
  br label %main_bb6, !dbg !43

main_bb6:                                         ; preds = %main_bb7, %main_bb8, %main_bb5
  %l.0 = phi i64 [ %"12", %main_bb5 ], [ %"22", %main_bb8 ], [ %"16", %main_bb7 ]
  %"13" = trunc i64 %l.0 to i32, !dbg !44
  %"14" = sub nsw i32 %"13", 1, !dbg !44
  %"15" = trunc i32 %"14" to i8, !dbg !44
  %"16" = zext i8 %"15" to i64, !dbg !44
  %"17" = icmp ne i64 %l.0, 0, !dbg !45
  br i1 %"17", label %main_bb7, label %main_bb9, !dbg !45

main_bb7:                                         ; preds = %main_bb6
  %"18" = icmp ne i64 %"16", 0, !dbg !47
  br i1 %"18", label %main_bb8, label %main_bb6, !dbg !47

main_bb8:                                         ; preds = %main_bb7
  %"19" = trunc i64 %"16" to i32, !dbg !48
  %"20" = sub nsw i32 %"19", 1, !dbg !48
  %"21" = trunc i32 %"20" to i8, !dbg !48
  %"22" = zext i8 %"21" to i64, !dbg !48
