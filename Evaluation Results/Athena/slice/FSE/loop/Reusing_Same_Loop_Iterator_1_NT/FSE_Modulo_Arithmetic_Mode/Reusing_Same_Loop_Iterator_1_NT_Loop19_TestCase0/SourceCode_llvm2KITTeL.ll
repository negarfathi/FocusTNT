...
main_bb5:
  ...
  %"14" = icmp sgt i64 %"12", 65534, !dbg !39
  %"15" = icmp sgt i64 %"13", 65534, !dbg !41
...
main_wrap_around.exit2:                           ; preds = %main_bb5, %main_bb13, %main_bb12, %main_bb11
  %i.0 = phi i64 [ %"32", %main_bb11 ], [ %"37", %main_bb13 ], [ %"18", %main_bb12 ], [ 0, %main_bb5 ]
  %"16" = icmp slt i64 %i.0, %"12", !dbg !43
  br i1 %"16", label %main_wrap_around.exit, label %main_bb14, !dbg !43

main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  %i.1 = phi i64 [ 0, %main_wrap_around.exit2 ], [ %"23", %main_bb7 ], [ %"28", %main_bb9 ], [ %"18", %main_bb8 ]
  %"17" = icmp slt i64 %i.1, %"13", !dbg !45
  %"18" = add nsw i64 %i.1, 1, !dbg !48
  %"19" = icmp sgt i64 %"18", 2147483647, !dbg !50
  br i1 %"17", label %main_bb6, label %main_bb10, !dbg !45

main_bb6:                                         ; preds = %main_wrap_around.exit
  br i1 %"19", label %main_bb7, label %main_bb8, !dbg !50
...
main_bb8:                                         ; preds = %main_bb6
  ...
  br i1 %"24", label %main_bb9, label %main_wrap_around.exit, !dbg !52
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !54), !dbg !56
  ...
  br i1 %"19", label %main_bb11, label %main_bb12, !dbg !66

main_bb11:                                        ; preds = %main_bb10
  %"29" = sub nsw i64 %"18", 2147483647, !dbg !67
...
main_bb12:                                        ; preds = %main_bb10
  %"33" = icmp slt i64 %"18", -2147483648, !dbg !68
  br i1 %"33", label %main_bb13, label %main_wrap_around.exit2, !dbg !68

main_bb13:                                        ; preds = %main_bb12
  %"34" = sub nsw i64 -2147483648, %"18", !dbg !69
...
!33 = metadata !{i32 21, i32 24, metadata !9, null}
!34 = metadata !{i32 786688, metadata !9, metadata !"num_crtc", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num_crtc] [line 21]
!35 = metadata !{i32 21, i32 13, metadata !9, null}
!36 = metadata !{i32 22, i32 26, metadata !9, null}
!37 = metadata !{i32 786688, metadata !9, metadata !"num_output", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num_output] [line 22]
!38 = metadata !{i32 22, i32 13, metadata !9, null}
!39 = metadata !{i32 23, i32 7, metadata !40, null}
!40 = metadata !{i32 786443, metadata !1, metadata !9, i32 23, i32 7, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!43 = metadata !{i32 32, i32 3, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 32, i32 3, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 34, i32 5, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !47, i32 34, i32 5, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 786443, metadata !1, metadata !9, i32 32, i32 24, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 35, i32 8, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !47, i32 35, i32 1, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!55 = metadata !{i32 37, i32 10, metadata !47, null}
!56 = metadata !{i32 7, i32 33, metadata !4, metadata !55}
!57 = metadata !{i64 -2147483648}
!58 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !55} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!59 = metadata !{i32 7, i32 50, metadata !4, metadata !55}
!60 = metadata !{i64 2147483647}
!61 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !55} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!62 = metadata !{i32 7, i32 73, metadata !4, metadata !55}
!63 = metadata !{i64 4294967296}
!64 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !55} ; [ DW_TAG_auto_variable ] [range] [line 8]
!65 = metadata !{i32 8, i32 15, metadata !4, metadata !55} ; [ DW_TAG_imported_declaration ]
!66 = metadata !{i32 9, i32 9, metadata !25, metadata !55}
!67 = metadata !{i32 10, i32 9, metadata !27, metadata !55}
!68 = metadata !{i32 12, i32 14, metadata !29, metadata !55}
!69 = metadata !{i32 13, i32 9, metadata !31, metadata !55}
!70 = metadata !{i32 39, i32 17, metadata !9, null}
