...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !39), !dbg !42
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %i.0 = phi i64 [ 10, %main_bb5 ], [ %"19", %main_bb7 ], [ %"24", %main_bb9 ], [ %"14", %main_bb8 ]
  %"13" = icmp sle i64 %i.0, %"12", !dbg !53
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !53

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = mul nsw i64 %i.0, 10, !dbg !40
  %"15" = icmp sgt i64 %"14", 2147483647, !dbg !55
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !55

main_bb7:                                         ; preds = %main_bb6
  %"16" = sub nsw i64 %"14", 2147483647, !dbg !56
  %"17" = sub nsw i64 %"16", 1, !dbg !56
  %"18" = srem i64 %"17", 4294967296, !dbg !56
  %"19" = add nsw i64 -2147483648, %"18", !dbg !56
  br label %main_wrap_around.exit, !dbg !56

main_bb8:                                         ; preds = %main_bb6
  %"20" = icmp slt i64 %"14", -2147483648, !dbg !57
  br i1 %"20", label %main_bb9, label %main_wrap_around.exit, !dbg !57

main_bb9:                                         ; preds = %main_bb8
  %"21" = sub nsw i64 -2147483648, %"14", !dbg !58
  %"22" = sub nsw i64 %"21", 1, !dbg !58
  %"23" = srem i64 %"22", 4294967296, !dbg !58
  %"24" = sub nsw i64 2147483647, %"23", !dbg !58
...
!33 = metadata !{i32 20, i32 22, metadata !9, null}
!34 = metadata !{i32 786688, metadata !9, metadata !"number", metadata !5, i32 20, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [number] [line 20]
!35 = metadata !{i32 20, i32 13, metadata !9, null}
!36 = metadata !{i64 10}
!37 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 19, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 19]
...
!41 = metadata !{i32 786443, metadata !1, metadata !9, i32 23, i32 1, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 7, i32 33, metadata !4, metadata !40}
!43 = metadata !{i64 -2147483648}
!44 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !40} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!45 = metadata !{i32 7, i32 50, metadata !4, metadata !40}
!46 = metadata !{i64 2147483647}
!47 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !40} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!48 = metadata !{i32 7, i32 73, metadata !4, metadata !40}
!49 = metadata !{i64 4294967296}
!50 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !40} ; [ DW_TAG_auto_variable ] [range] [line 8]
!51 = metadata !{i32 8, i32 15, metadata !4, metadata !40} ; [ DW_TAG_imported_declaration ]
!52 = metadata !{i32 22, i32 3, metadata !9, null}
!53 = metadata !{i32 22, i32 3, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 3, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 9, i32 9, metadata !25, metadata !40}
!56 = metadata !{i32 10, i32 9, metadata !27, metadata !40}
!57 = metadata !{i32 12, i32 14, metadata !29, metadata !40}
!58 = metadata !{i32 13, i32 9, metadata !31, metadata !40}
!59 = metadata !{i32 25, i32 3, metadata !9, null}
