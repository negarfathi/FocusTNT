...
read_slice_1_bb1:                                 ; preds = %read_slice_1_bb0
  %"4" = call i32 @__VERIFIER_nondet_int(), !dbg !22
  call void @llvm.dbg.value(metadata !{i32 %"4"}, i64 0, metadata !23), !dbg !24
  %"5" = icmp sle i32 %"4", 0, !dbg !25
  br i1 %"5", label %read_slice_1_bb5, label %read_slice_1_bb2, !dbg !25

read_slice_1_bb2:                                 ; preds = %read_slice_1_bb1
  %"6" = srem i32 %"4", 1000, !dbg !27
  call void @llvm.dbg.value(metadata !{i32 %"6"}, i64 0, metadata !23), !dbg !24
  %"7" = icmp slt i32 %"6", 995, !dbg !29
  br i1 %"7", label %read_slice_1_bb3, label %read_slice_1_bb4, !dbg !29

read_slice_1_bb3:                                 ; preds = %read_slice_1_bb2
  %"8" = load i32* @"'count", align 4, !dbg !31
  %"9" = add nsw i32 %"8", 1, !dbg !31
  store i32 %"9", i32* @"'count", align 4, !dbg !31
  call void @llvm.dbg.value(metadata !{i32 %"6"}, i64 0, metadata !33), !dbg !34
...
read_slice_1_bb5:                                 ; preds = %read_slice_1_bb1, %read_slice_1_bb4, %read_slice_1_bb3, %read_slice_1_bb0
  %__retres.2 = phi i32 [ 0, %read_slice_1_bb0 ], [ -1, %read_slice_1_bb1 ], [ %"6", %read_slice_1_bb3 ], [ 0, %read_slice_1_bb4 ]
...
define void @main() #0 {
main_bb6:
  call void @llvm.dbg.value(metadata !{i32 %__retres.2.i}, i64 0, metadata !40), !dbg !42
  call void @llvm.dbg.value(metadata !{i32 %"14"}, i64 0, metadata !43) #3, !dbg !45
  call void @llvm.dbg.value(metadata !{i32 %"16"}, i64 0, metadata !43) #3, !dbg !45
  call void @llvm.dbg.value(metadata !{i32 %"16"}, i64 0, metadata !46) #3, !dbg !47
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !46) #3, !dbg !47
  br label %main_bb7, !dbg !48

main_bb7:                                         ; preds = %main_read_slice_1.exit, %main_bb6
  %"10" = load i32* @"'flag", align 4, !dbg !49
  %"11" = icmp eq i32 %"10", 1, !dbg !49
  %"12" = load i32* @"'count", align 4, !dbg !44
  %"13" = icmp sgt i32 %"12", 100, !dbg !50
  %or.cond.i = or i1 %"11", %"13", !dbg !49
  br i1 %or.cond.i, label %main_read_slice_1.exit, label %main_bb8, !dbg !49

main_bb8:                                         ; preds = %main_bb7
  %"14" = call i32 @__VERIFIER_nondet_int() #3, !dbg !51
  %"15" = icmp sle i32 %"14", 0, !dbg !52
  br i1 %"15", label %main_read_slice_1.exit, label %main_bb9, !dbg !52

main_bb9:                                         ; preds = %main_bb8
  %"16" = srem i32 %"14", 1000, !dbg !53
  %"17" = icmp slt i32 %"16", 995, !dbg !54
  br i1 %"17", label %main_bb10, label %main_bb11, !dbg !54

main_bb10:                                        ; preds = %main_bb9
  %"18" = load i32* @"'count", align 4, !dbg !55
  %"19" = add nsw i32 %"18", 1, !dbg !55
  store i32 %"19", i32* @"'count", align 4, !dbg !55
  br label %main_read_slice_1.exit, !dbg !56

main_bb11:                                        ; preds = %main_bb9
  store i32 1, i32* @"'flag", align 4, !dbg !57
  br label %main_read_slice_1.exit, !dbg !44

main_read_slice_1.exit:                           ; preds = %main_bb7, %main_bb8, %main_bb10, %main_bb11
  %__retres.2.i = phi i32 [ 0, %main_bb7 ], [ -1, %main_bb8 ], [ %"16", %main_bb10 ], [ 0, %main_bb11 ], !dbg !44
  %"20" = icmp slt i32 %__retres.2.i, 0, !dbg !58
  br i1 %"20", label %main_bb12, label %main_bb7, !dbg !58
...
!22 = metadata !{i32 19, i32 13, metadata !4, null}
...
!40 = metadata !{i32 786688, metadata !41, metadata !"tmp", metadata !5, i32 38, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp] [line 38]
!41 = metadata !{i32 786443, metadata !1, metadata !9, i32 37, i32 13, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 38, i32 9, metadata !41, null}
!43 = metadata !{i32 786688, metadata !4, metadata !"num", metadata !5, i32 19, metadata !8, i32 0, metadata !44} ; [ DW_TAG_auto_variable ] [num] [line 19]
!44 = metadata !{i32 39, i32 11, metadata !41, null}
!45 = metadata !{i32 19, i32 7, metadata !4, metadata !44}
!46 = metadata !{i32 786688, metadata !4, metadata !"__retres", metadata !5, i32 9, metadata !8, i32 0, metadata !44} ; [ DW_TAG_auto_variable ] [__retres] [line 9]
!47 = metadata !{i32 9, i32 7, metadata !4, metadata !44}
!48 = metadata !{i32 37, i32 3, metadata !9, null}
!49 = metadata !{i32 10, i32 7, metadata !19, metadata !44}
!50 = metadata !{i32 15, i32 9, metadata !21, metadata !44}
!51 = metadata !{i32 19, i32 13, metadata !4, metadata !44}
!52 = metadata !{i32 20, i32 7, metadata !26, metadata !44}
!53 = metadata !{i32 22, i32 5, metadata !28, metadata !44}
!54 = metadata !{i32 23, i32 9, metadata !30, metadata !44}
!55 = metadata !{i32 24, i32 7, metadata !32, metadata !44}
!56 = metadata !{i32 26, i32 5, metadata !32, metadata !44}
!57 = metadata !{i32 28, i32 7, metadata !37, metadata !44}
!58 = metadata !{i32 40, i32 9, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !41, i32 40, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 45, i32 3, metadata !9, null}
