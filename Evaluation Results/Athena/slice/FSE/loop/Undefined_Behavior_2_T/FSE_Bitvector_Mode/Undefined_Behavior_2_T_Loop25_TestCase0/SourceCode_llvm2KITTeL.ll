...
main_bb5:                                         ; preds = %main_ffs_slice_1.exit, %main_bb4
  %w.0 = phi i32 [ %"4", %main_bb4 ], [ %w.1, %main_ffs_slice_1.exit ]
  %"5" = icmp ne i32 %w.0, 0, !dbg !38
  br i1 %"5", label %main_bb6, label %main_bb8, !dbg !38

main_bb6:                                         ; preds = %main_bb5, %main_bb7
  %i.0.i = phi i32 [ %"8", %main_bb7 ], [ 1, %main_bb5 ], !dbg !32
  %.0.i = phi i32 [ %"9", %main_bb7 ], [ %w.0, %main_bb5 ], !dbg !32
  %"6" = urem i32 %.0.i, 2, !dbg !40
  %"7" = icmp eq i32 %"6", 0, !dbg !40
  br i1 %"7", label %main_bb7, label %main_ffs_slice_1.exit, !dbg !40

main_bb7:                                         ; preds = %main_bb6
  %"8" = add i32 %i.0.i, 1, !dbg !41
  %"9" = udiv i32 %.0.i, 2, !dbg !42
...
main_ffs_slice_1.exit:                            ; preds = %main_bb6
  ...
  %"10" = icmp ult i32 %i.0.i, 32, !dbg !46
  %"11" = lshr i32 %w.0, %i.0.i, !dbg !48
  call void @llvm.dbg.value(metadata !{i32 %"11"}, i64 0, metadata !29), !dbg !30
  %w.1 = select i1 %"10", i32 %"11", i32 0, !dbg !46
...
!28 = metadata !{i32 17, i32 20, metadata !9, null}
