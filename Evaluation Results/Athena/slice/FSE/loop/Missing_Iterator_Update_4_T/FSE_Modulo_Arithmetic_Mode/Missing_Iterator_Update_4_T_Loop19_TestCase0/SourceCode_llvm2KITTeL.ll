...
main_bb5:
  ...
  br i1 %or.cond2, label %main_bb10, label %main_wrap_around.exit, !dbg !39

main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb9, %main_bb8, %main_bb7
  %x.0 = phi i64 [ %"24", %main_bb7 ], [ %"29", %main_bb9 ], [ %"19", %main_bb8 ], [ 0, %main_bb5 ]
  %"18" = icmp slt i64 %x.0, %"12", !dbg !47
  br i1 %"18", label %main_bb6, label %main_bb10, !dbg !47

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"19" = add nsw i64 %x.0, 1, !dbg !49
  %"20" = icmp sgt i64 %"19", 2147483647, !dbg !51
  br i1 %"20", label %main_bb7, label %main_bb8, !dbg !51

main_bb7:                                         ; preds = %main_bb6
  %"21" = sub nsw i64 %"19", 2147483647, !dbg !52
  %"22" = sub nsw i64 %"21", 1, !dbg !52
  %"23" = srem i64 %"22", 4294967296, !dbg !52
  %"24" = add nsw i64 -2147483648, %"23", !dbg !52
  br label %main_wrap_around.exit, !dbg !52

main_bb8:                                         ; preds = %main_bb6
  %"25" = icmp slt i64 %"19", -2147483648, !dbg !53
  br i1 %"25", label %main_bb9, label %main_wrap_around.exit, !dbg !53

main_bb9:                                         ; preds = %main_bb8
  %"26" = sub nsw i64 -2147483648, %"19", !dbg !54
  %"27" = sub nsw i64 %"26", 1, !dbg !54
  %"28" = srem i64 %"27", 4294967296, !dbg !54
  %"29" = sub nsw i64 2147483647, %"28", !dbg !54
...
!33 = metadata !{i32 21, i32 27, metadata !9, null}
!34 = metadata !{i32 786688, metadata !9, metadata !"mat_colSize", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [mat_colSize] [line 21]
!35 = metadata !{i32 21, i32 13, metadata !9, null}
!36 = metadata !{i32 22, i32 27, metadata !9, null}
!37 = metadata !{i32 786688, metadata !9, metadata !"mat_rowSize", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [mat_rowSize] [line 22]
...
!48 = metadata !{i32 786443, metadata !1, metadata !9, i32 43, i32 3, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 44, i32 8, metadata !50, null}
!50 = metadata !{i32 786443, metadata !1, metadata !9, i32 44, i32 1, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 9, i32 9, metadata !25, metadata !49}
!52 = metadata !{i32 10, i32 9, metadata !27, metadata !49}
!53 = metadata !{i32 12, i32 14, metadata !29, metadata !49}
!54 = metadata !{i32 13, i32 9, metadata !31, metadata !49}
!55 = metadata !{i32 46, i32 17, metadata !9, null}
