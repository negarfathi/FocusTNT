...
main_bb1:
  ...
  br i1 %"4", label %main_bb6, label %main_bb2, !dbg !32

main_bb2:                                         ; preds = %main_bb1
  %"5" = sext i32 %"3" to i64, !dbg !34
  call void @llvm.dbg.value(metadata !{i64 %"5"}, i64 0, metadata !35), !dbg !37
  %"6" = mul i64 4, %"5", !dbg !38
  %"7" = call i8* @__fc_vla_alloc(i64 %"6"), !dbg !38
  %"8" = ptrtoint i8* %"7" to i32, !dbg !38
  ...
  call void @llvm.dbg.value(metadata !{i32 %"15"}, i64 0, metadata !42), !dbg !44
  br label %main_bb3, !dbg !45

main_bb3:                                         ; preds = %main_bb4, %main_bb2
  %i.0 = phi i32 [ 0, %main_bb2 ], [ %"15", %main_bb4 ]
  %"9" = sub nsw i32 %"3", 1, !dbg !46
  %"10" = icmp slt i32 %i.0, %"9", !dbg !46
  br i1 %"10", label %main_bb4, label %main_bb5, !dbg !46

main_bb4:                                         ; preds = %main_bb3
  %"11" = call i32 @__VERIFIER_nondet_int(), !dbg !48
  %"12" = add nsw i32 %"8", %i.0, !dbg !48
  %"13" = sext i32 %"12" to i64, !dbg !48
  %"14" = getelementptr inbounds [100000 x i32]* @memory0, i32 0, i64 %"13", !dbg !48
  store i32 %"11", i32* %"14", align 4, !dbg !48
  %"15" = add nsw i32 %i.0, 1, !dbg !50
  br label %main_bb3, !dbg !51

main_bb5:                                         ; preds = %main_bb3
  %"16" = sub nsw i32 %"3", 1, !dbg !52
  %"17" = add nsw i32 %"8", %"16", !dbg !52
  %"18" = sext i32 %"17" to i64, !dbg !52
  %"19" = getelementptr inbounds [100000 x i32]* @memory0, i32 0, i64 %"18", !dbg !52
  store i32 0, i32* %"19", align 4, !dbg !52
...
!28 = metadata !{i32 22, i32 15, metadata !29, null}
!29 = metadata !{i32 786443, metadata !1, metadata !9, i32 20, i32 3, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!30 = metadata !{i32 786688, metadata !29, metadata !"len", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [len] [line 22]
!31 = metadata !{i32 22, i32 9, metadata !29, null}
!32 = metadata !{i32 23, i32 9, metadata !33, null}
!33 = metadata !{i32 786443, metadata !1, metadata !29, i32 23, i32 9, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!34 = metadata !{i32 27, i32 5, metadata !29, null}
!35 = metadata !{i32 786688, metadata !29, metadata !"__lengthof_argv1", metadata !5, i32 21, metadata !36, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [__lengthof_argv1] [line 21]
...
!37 = metadata !{i32 21, i32 19, metadata !29, null}
!38 = metadata !{i32 28, i32 17, metadata !29, null}
!39 = metadata !{i32 786688, metadata !29, metadata !"argv1", metadata !5, i32 28, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [argv1] [line 28]
!40 = metadata !{i32 28, i32 9, metadata !29, null}
!41 = metadata !{i32 0}
!42 = metadata !{i32 786688, metadata !43, metadata !"i", metadata !5, i32 30, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 30]
!43 = metadata !{i32 786443, metadata !1, metadata !29, i32 29, i32 5, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!52 = metadata !{i32 36, i32 5, metadata !29, null}
!53 = metadata !{i32 37, i32 3, metadata !29, null}
