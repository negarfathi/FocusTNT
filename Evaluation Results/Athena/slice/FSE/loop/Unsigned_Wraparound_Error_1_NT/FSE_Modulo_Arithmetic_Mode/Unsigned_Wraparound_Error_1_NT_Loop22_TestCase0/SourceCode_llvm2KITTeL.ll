...
main_bb5:
  ...
  %"15" = icmp sle i64 %"13", %"14", !dbg !42
  %"16" = icmp eq i64 %"12", 0, !dbg !44
  %or.cond = or i1 %"15", %"16", !dbg !42
  br i1 %or.cond, label %main_bb6, label %main_wrap_around.exit, !dbg !42
...
main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb10, %main_bb9, %main_bb8
  ...
  %"17" = icmp slt i64 %"13", %cur.0, !dbg !46
  br i1 %"17", label %main_bb6, label %main_bb7, !dbg !46

main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  ret void, !dbg !49

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"18" = add nsw i64 %cur.0, %"12", !dbg !50
  %"19" = icmp sgt i64 %"18", 4294967295, !dbg !51
  br i1 %"19", label %main_bb8, label %main_bb9, !dbg !51

main_bb8:                                         ; preds = %main_bb7
  %"20" = sub nsw i64 %"18", 4294967295, !dbg !52
  %"21" = sub nsw i64 %"20", 1, !dbg !52
  %"22" = srem i64 %"21", 4294967296, !dbg !52
  br label %main_wrap_around.exit, !dbg !52

main_bb9:                                         ; preds = %main_bb7
  %"23" = icmp slt i64 %"18", 0, !dbg !53
  br i1 %"23", label %main_bb10, label %main_wrap_around.exit, !dbg !53

main_bb10:                                        ; preds = %main_bb9
  %"24" = sub nsw i64 0, %"18", !dbg !54
  %"25" = sub nsw i64 %"24", 1, !dbg !54
  %"26" = srem i64 %"25", 4294967296, !dbg !54
  %"27" = sub nsw i64 4294967295, %"26", !dbg !54
...
!36 = metadata !{i32 21, i32 22, metadata !9, null}
!37 = metadata !{i32 786688, metadata !9, metadata !"st_max", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [st_max] [line 21]
!38 = metadata !{i32 21, i32 13, metadata !9, null}
!39 = metadata !{i32 22, i32 22, metadata !9, null}
!40 = metadata !{i32 786688, metadata !9, metadata !"it_min", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [it_min] [line 22]
...
!44 = metadata !{i32 26, i32 7, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !9, i32 26, i32 7, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 31, i32 9, metadata !47, null}
!47 = metadata !{i32 786443, metadata !1, metadata !48, i32 31, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 13, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 37, i32 17, metadata !9, null}
!50 = metadata !{i32 35, i32 11, metadata !48, null}
!51 = metadata !{i32 9, i32 9, metadata !25, metadata !50}
!52 = metadata !{i32 10, i32 9, metadata !27, metadata !50}
!53 = metadata !{i32 12, i32 14, metadata !29, metadata !50}
!54 = metadata !{i32 13, i32 9, metadata !31, metadata !50}
