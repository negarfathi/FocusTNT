...
main_bb21:
  ...
  br i1 %"54", label %main_bb49, label %main_wrap_around.exit3, !dbg !85

main_wrap_around.exit3:                           ; preds = %main_bb48, %main_bb47, %main_bb46, %main_wrap_around.exit, %main_bb21
  %tries.0 = phi i64 [ 0, %main_bb21 ], [ %.0.i1, %main_wrap_around.exit ], [ %tries.0, %main_bb46 ], [ %tries.0, %main_bb47 ], [ %tries.0, %main_bb48 ]
  %buf.0 = phi i64 [ 0, %main_bb21 ], [ %buf.0, %main_wrap_around.exit ], [ %"127", %main_bb46 ], [ %"132", %main_bb48 ], [ %"122", %main_bb47 ]
  %count.0 = phi i64 [ %"53", %main_bb21 ], [ %count.0, %main_wrap_around.exit ], [ %.0.i4, %main_bb46 ], [ %.0.i4, %main_bb47 ], [ %.0.i4, %main_bb48 ]
  %"55" = icmp sgt i64 %count.0, 0, !dbg !87
  br i1 %"55", label %main_bb22, label %main_bb49, !dbg !87
...
main_read_slice_1.exit:                           ; preds = %main_bb22, %main_wrap_around.exit2.i, %main_bb23, %main_bb36
  ...
  %"97" = icmp sle i64 %__retres.0.i, 0, !dbg !117
  br i1 %"97", label %main_bb37, label %main_bb42, !dbg !117

main_bb37:                                        ; preds = %main_read_slice_1.exit
  %"98" = icmp eq i64 %__retres.0.i, 0, !dbg !119
  br i1 %"98", label %main_bb38, label %main_bb49, !dbg !119

main_bb38:                                        ; preds = %main_bb37
  %"99" = add nsw i64 %tries.0, 1, !dbg !122
  %"100" = icmp sgt i64 %"99", 2147483647, !dbg !124
  br i1 %"100", label %main_bb39, label %main_bb40, !dbg !124

main_bb39:                                        ; preds = %main_bb38
  %"101" = sub nsw i64 %"99", 2147483647, !dbg !125
  %"102" = sub nsw i64 %"101", 1, !dbg !125
  %"103" = srem i64 %"102", 4294967296, !dbg !125
  %"104" = add nsw i64 -2147483648, %"103", !dbg !125
  br label %main_wrap_around.exit, !dbg !125

main_bb40:                                        ; preds = %main_bb38
  %"105" = icmp slt i64 %"99", -2147483648, !dbg !126
  br i1 %"105", label %main_bb41, label %main_wrap_around.exit, !dbg !126

main_bb41:                                        ; preds = %main_bb40
  %"106" = sub nsw i64 -2147483648, %"99", !dbg !127
  %"107" = sub nsw i64 %"106", 1, !dbg !127
  %"108" = srem i64 %"107", 4294967296, !dbg !127
  %"109" = sub nsw i64 2147483647, %"108", !dbg !127
  br label %main_wrap_around.exit, !dbg !127

main_wrap_around.exit:                            ; preds = %main_bb39, %main_bb40, %main_bb41
  %.0.i1 = phi i64 [ %"104", %main_bb39 ], [ %"109", %main_bb41 ], [ %"99", %main_bb40 ], !dbg !122
  %"110" = icmp slt i64 %tries.0, 5, !dbg !128
  br i1 %"110", label %main_wrap_around.exit3, label %main_bb49, !dbg !128

main_bb42:                                        ; preds = %main_read_slice_1.exit
  %"111" = sub nsw i64 %count.0, %__retres.0.i, !dbg !130
  %"112" = icmp sgt i64 %"111", 2147483647, !dbg !131
  br i1 %"112", label %main_bb43, label %main_bb44, !dbg !131

main_bb43:                                        ; preds = %main_bb42
  %"113" = sub nsw i64 %"111", 2147483647, !dbg !132
  %"114" = sub nsw i64 %"113", 1, !dbg !132
  %"115" = srem i64 %"114", 4294967296, !dbg !132
  %"116" = add nsw i64 -2147483648, %"115", !dbg !132
  br label %main_wrap_around.exit5, !dbg !132

main_bb44:                                        ; preds = %main_bb42
  %"117" = icmp slt i64 %"111", -2147483648, !dbg !133
  br i1 %"117", label %main_bb45, label %main_wrap_around.exit5, !dbg !133

main_bb45:                                        ; preds = %main_bb44
  %"118" = sub nsw i64 -2147483648, %"111", !dbg !134
  %"119" = sub nsw i64 %"118", 1, !dbg !134
  %"120" = srem i64 %"119", 4294967296, !dbg !134
  %"121" = sub nsw i64 2147483647, %"120", !dbg !134
  br label %main_wrap_around.exit5, !dbg !134

main_wrap_around.exit5:                           ; preds = %main_bb43, %main_bb44, %main_bb45
  %.0.i4 = phi i64 [ %"116", %main_bb43 ], [ %"121", %main_bb45 ], [ %"111", %main_bb44 ], !dbg !130
  %"122" = add nsw i64 %buf.0, %__retres.0.i, !dbg !135
  %"123" = icmp sgt i64 %"122", 2147483647, !dbg !136
  br i1 %"123", label %main_bb46, label %main_bb47, !dbg !136

main_bb46:                                        ; preds = %main_wrap_around.exit5
  %"124" = sub nsw i64 %"122", 2147483647, !dbg !137
  %"125" = sub nsw i64 %"124", 1, !dbg !137
  %"126" = srem i64 %"125", 4294967296, !dbg !137
  %"127" = add nsw i64 -2147483648, %"126", !dbg !137
  br label %main_wrap_around.exit3, !dbg !137

main_bb47:                                        ; preds = %main_wrap_around.exit5
  %"128" = icmp slt i64 %"122", -2147483648, !dbg !138
  br i1 %"128", label %main_bb48, label %main_wrap_around.exit3, !dbg !138

main_bb48:                                        ; preds = %main_bb47
  %"129" = sub nsw i64 -2147483648, %"122", !dbg !139
  %"130" = sub nsw i64 %"129", 1, !dbg !139
  %"131" = srem i64 %"130", 4294967296, !dbg !139
  %"132" = sub nsw i64 2147483647, %"131", !dbg !139
  br label %main_wrap_around.exit3, !dbg !139

main_bb49:                                        ; preds = %main_wrap_around.exit3, %main_bb37, %main_wrap_around.exit, %main_bb21
  ret void, !dbg !140
}
...
!87 = metadata !{i32 65, i32 3, metadata !88, null}
!88 = metadata !{i32 786443, metadata !1, metadata !12, i32 65, i32 3, i32 1, i32 25} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!89 = metadata !{i32 22, i32 7, metadata !46, metadata !90}
!90 = metadata !{i32 66, i32 11, metadata !91, null}
!91 = metadata !{i32 786443, metadata !1, metadata !12, i32 65, i32 21, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!117 = metadata !{i32 67, i32 9, metadata !118, null}
!118 = metadata !{i32 786443, metadata !1, metadata !91, i32 67, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!119 = metadata !{i32 68, i32 11, metadata !120, null}
!120 = metadata !{i32 786443, metadata !1, metadata !121, i32 68, i32 11, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!121 = metadata !{i32 786443, metadata !1, metadata !118, i32 67, i32 19, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!122 = metadata !{i32 71, i32 18, metadata !123, null}
!123 = metadata !{i32 786443, metadata !1, metadata !120, i32 68, i32 21, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!124 = metadata !{i32 10, i32 9, metadata !30, metadata !122}
!125 = metadata !{i32 11, i32 9, metadata !32, metadata !122}
!126 = metadata !{i32 13, i32 14, metadata !34, metadata !122}
!127 = metadata !{i32 14, i32 9, metadata !36, metadata !122}
!128 = metadata !{i32 72, i32 13, metadata !129, null}
!129 = metadata !{i32 786443, metadata !1, metadata !123, i32 72, i32 13, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!130 = metadata !{i32 79, i32 13, metadata !91, null}
!131 = metadata !{i32 10, i32 9, metadata !30, metadata !130}
!132 = metadata !{i32 11, i32 9, metadata !32, metadata !130}
!133 = metadata !{i32 13, i32 14, metadata !34, metadata !130}
!134 = metadata !{i32 14, i32 9, metadata !36, metadata !130}
!135 = metadata !{i32 80, i32 11, metadata !91, null}
...
!140 = metadata !{i32 82, i32 17, metadata !12, null}
