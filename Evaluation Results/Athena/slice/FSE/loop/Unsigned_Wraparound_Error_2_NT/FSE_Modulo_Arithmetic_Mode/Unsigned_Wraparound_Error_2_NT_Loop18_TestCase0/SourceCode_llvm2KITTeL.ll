...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !44), !dbg !47
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"15" = icmp slt i64 %ui.0, %., !dbg !58
  br i1 %"15", label %main_bb6, label %main_bb10, !dbg !58

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"16" = mul nsw i64 %ui.0, 2, !dbg !45
  %"17" = icmp sgt i64 %"16", 4294967295, !dbg !60
  br i1 %"17", label %main_bb7, label %main_bb8, !dbg !60

main_bb7:                                         ; preds = %main_bb6
  %"18" = sub nsw i64 %"16", 4294967295, !dbg !61
  %"19" = sub nsw i64 %"18", 1, !dbg !61
  %"20" = srem i64 %"19", 4294967296, !dbg !61
  br label %main_wrap_around.exit, !dbg !61

main_bb8:                                         ; preds = %main_bb6
  %"21" = icmp slt i64 %"16", 0, !dbg !62
  br i1 %"21", label %main_bb9, label %main_wrap_around.exit, !dbg !62

main_bb9:                                         ; preds = %main_bb8
  %"22" = sub nsw i64 0, %"16", !dbg !63
  %"23" = sub nsw i64 %"22", 1, !dbg !63
  %"24" = srem i64 %"23", 4294967296, !dbg !63
  %"25" = sub nsw i64 4294967295, %"24", !dbg !63
...
!57 = metadata !{i32 25, i32 3, metadata !9, null}
!58 = metadata !{i32 25, i32 3, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 9, i32 9, metadata !25, metadata !45}
!61 = metadata !{i32 10, i32 9, metadata !27, metadata !45}
!62 = metadata !{i32 12, i32 14, metadata !29, metadata !45}
!63 = metadata !{i32 13, i32 9, metadata !31, metadata !45}
!64 = metadata !{i32 28, i32 3, metadata !9, null}
