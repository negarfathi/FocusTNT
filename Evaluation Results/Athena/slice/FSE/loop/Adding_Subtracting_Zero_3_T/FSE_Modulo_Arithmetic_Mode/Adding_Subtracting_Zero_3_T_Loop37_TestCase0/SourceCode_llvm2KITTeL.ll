...
main_bb20:
  ...
  %"51" = call i64 @__VERIFIER_nondet_int(), !dbg !115
  call void @llvm.dbg.value(metadata !{i64 %"51"}, i64 0, metadata !116), !dbg !117
  store i64 0, i64* @"'flag", align 8, !dbg !118
  call void @llvm.dbg.value(metadata !42, i64 0, metadata !119), !dbg !120
  %"52" = icmp sle i64 %"51", 0, !dbg !121
  %"53" = icmp sgt i64 %"51", 65536, !dbg !123
  %or.cond = or i1 %"52", %"53", !dbg !121
  br i1 %or.cond, label %main_bb49, label %main_wrap_around.exit2, !dbg !121

main_wrap_around.exit2:                           ; preds = %main_bb20, %main_bb48, %main_bb47, %main_bb46, %main_wrap_around.exit6
  %__fc_errno_0.0 = phi i64 [ %.0.i5, %main_wrap_around.exit6 ], [ %__fc_errno_0.0, %main_bb46 ], [ %__fc_errno_0.0, %main_bb47 ], [ %__fc_errno_0.0, %main_bb48 ], [ 0, %main_bb20 ]
  %pos.0 = phi i64 [ %pos.0, %main_wrap_around.exit6 ], [ %"133", %main_bb46 ], [ %"138", %main_bb48 ], [ %"128", %main_bb47 ], [ 0, %main_bb20 ]
  %"54" = icmp slt i64 %pos.0, %"51", !dbg !125
  br i1 %"54", label %main_bb21, label %main_bb49, !dbg !125

main_bb21:                                        ; preds = %main_wrap_around.exit2
  %"55" = sub nsw i64 %"51", %pos.0, !dbg !127
  %"56" = icmp sgt i64 %"55", 2147483647, !dbg !129
  br i1 %"56", label %main_bb22, label %main_bb23, !dbg !129
...
main_bb23:                                        ; preds = %main_bb21
  ...
  br i1 %"61", label %main_bb24, label %main_wrap_around.exit, !dbg !131
...
main_wrap_around.exit:                            ; preds = %main_bb22, %main_bb23, %main_bb24
  %.0.i = phi i64 [ %"60", %main_bb22 ], [ %"65", %main_bb24 ], [ %"55", %main_bb23 ], !dbg !127
  br label %main_wrap_around.exit2.i, !dbg !133

main_wrap_around.exit2.i:                         ; preds = %main_bb37, %main_bb36, %main_bb35, %main_wrap_around.exit
  %count.0.i = phi i64 [ 0, %main_wrap_around.exit ], [ %.0.i3.i, %main_bb35 ], [ %.0.i3.i, %main_bb36 ], [ %.0.i3.i, %main_bb37 ], !dbg !134
  %.0.i7 = phi i64 [ %pos.0, %main_wrap_around.exit ], [ %"99", %main_bb35 ], [ %"104", %main_bb37 ], [ %"94", %main_bb36 ], !dbg !134
  %"66" = icmp slt i64 %.0.i7, %.0.i, !dbg !135
  br i1 %"66", label %main_bb25, label %main_read_slice_1.exit, !dbg !135

main_bb25:                                        ; preds = %main_wrap_around.exit2.i
  %"67" = call i64 @__VERIFIER_nondet_int() #3, !dbg !136
  %"68" = icmp eq i64 %"67", 0, !dbg !137
  br i1 %"68", label %main_read_slice_1.exit, label %main_bb26, !dbg !137

main_bb26:                                        ; preds = %main_bb25
  %"69" = icmp slt i64 %"67", 0, !dbg !138
  br i1 %"69", label %main_bb27, label %main_wrap_around.exit.i, !dbg !138

main_bb27:                                        ; preds = %main_bb26
  %"70" = sub nsw i64 0, %"67", !dbg !139
  %"71" = icmp sgt i64 %"70", 2147483647, !dbg !140
  br i1 %"71", label %main_bb28, label %main_bb29, !dbg !140

main_bb28:                                        ; preds = %main_bb27
  %"72" = sub nsw i64 %"70", 2147483647, !dbg !141
  %"73" = sub nsw i64 %"72", 1, !dbg !141
  %"74" = srem i64 %"73", 4294967296, !dbg !141
  %"75" = add nsw i64 -2147483648, %"74", !dbg !141
  br label %main_wrap_around.exit.i, !dbg !141

main_bb29:                                        ; preds = %main_bb27
  %"76" = icmp slt i64 %"70", -2147483648, !dbg !142
  br i1 %"76", label %main_bb30, label %main_wrap_around.exit.i, !dbg !142

main_bb30:                                        ; preds = %main_bb29
  %"77" = sub nsw i64 -2147483648, %"70", !dbg !143
  %"78" = sub nsw i64 %"77", 1, !dbg !143
  %"79" = srem i64 %"78", 4294967296, !dbg !143
  %"80" = sub nsw i64 2147483647, %"79", !dbg !143
  br label %main_wrap_around.exit.i, !dbg !143

main_wrap_around.exit.i:                          ; preds = %main_bb30, %main_bb29, %main_bb28, %main_bb26
  %num.0.i = phi i64 [ %"67", %main_bb26 ], [ %"75", %main_bb28 ], [ %"80", %main_bb30 ], [ %"70", %main_bb29 ], !dbg !134
  %"81" = srem i64 %num.0.i, 1000, !dbg !144
  %"82" = add nsw i64 %count.0.i, 1, !dbg !145
  %"83" = icmp sgt i64 %"82", 2147483647, !dbg !146
  br i1 %"83", label %main_bb31, label %main_bb32, !dbg !146

main_bb31:                                        ; preds = %main_wrap_around.exit.i
  %"84" = sub nsw i64 %"82", 2147483647, !dbg !147
  %"85" = sub nsw i64 %"84", 1, !dbg !147
  %"86" = srem i64 %"85", 4294967296, !dbg !147
  %"87" = add nsw i64 -2147483648, %"86", !dbg !147
  br label %main_wrap_around.exit4.i, !dbg !147

main_bb32:                                        ; preds = %main_wrap_around.exit.i
  %"88" = icmp slt i64 %"82", -2147483648, !dbg !148
  br i1 %"88", label %main_bb33, label %main_wrap_around.exit4.i, !dbg !148

main_bb33:                                        ; preds = %main_bb32
  %"89" = sub nsw i64 -2147483648, %"82", !dbg !149
  %"90" = sub nsw i64 %"89", 1, !dbg !149
  %"91" = srem i64 %"90", 4294967296, !dbg !149
  %"92" = sub nsw i64 2147483647, %"91", !dbg !149
  br label %main_wrap_around.exit4.i, !dbg !149

main_wrap_around.exit4.i:                         ; preds = %main_bb33, %main_bb32, %main_bb31
  %.0.i3.i = phi i64 [ %"87", %main_bb31 ], [ %"92", %main_bb33 ], [ %"82", %main_bb32 ], !dbg !145
  %"93" = icmp slt i64 %"81", 995, !dbg !150
  br i1 %"93", label %main_bb34, label %main_read_slice_1.exit, !dbg !150

main_bb34:                                        ; preds = %main_wrap_around.exit4.i
  %"94" = add nsw i64 %.0.i7, 1, !dbg !151
  %"95" = icmp sgt i64 %"94", 2147483647, !dbg !152
  br i1 %"95", label %main_bb35, label %main_bb36, !dbg !152

main_bb35:                                        ; preds = %main_bb34
  %"96" = sub nsw i64 %"94", 2147483647, !dbg !153
  %"97" = sub nsw i64 %"96", 1, !dbg !153
  %"98" = srem i64 %"97", 4294967296, !dbg !153
  %"99" = add nsw i64 -2147483648, %"98", !dbg !153
  br label %main_wrap_around.exit2.i, !dbg !153

main_bb36:                                        ; preds = %main_bb34
  %"100" = icmp slt i64 %"94", -2147483648, !dbg !154
  br i1 %"100", label %main_bb37, label %main_wrap_around.exit2.i, !dbg !154

main_bb37:                                        ; preds = %main_bb36
  %"101" = sub nsw i64 -2147483648, %"94", !dbg !155
  %"102" = sub nsw i64 %"101", 1, !dbg !155
  %"103" = srem i64 %"102", 4294967296, !dbg !155
  %"104" = sub nsw i64 2147483647, %"103", !dbg !155
  br label %main_wrap_around.exit2.i, !dbg !155

main_read_slice_1.exit:                           ; preds = %main_wrap_around.exit2.i, %main_bb25, %main_wrap_around.exit4.i
  %__retres.0.i = phi i64 [ -1, %main_bb25 ], [ %.0.i3.i, %main_wrap_around.exit4.i ], [ %count.0.i, %main_wrap_around.exit2.i ], !dbg !134
  call void @llvm.dbg.value(metadata !{i64 %__retres.0.i}, i64 0, metadata !156), !dbg !157
...
main_LeafBlock:                                   ; preds = %main_NodeBlock
  ...
  br i1 %SwitchLeaf, label %main_bb38, label %main_NewDefault

main_bb38:                                        ; preds = %main_LeafBlock
  %"105" = add nsw i64 %__fc_errno_0.0, 1, !dbg !158
  call void @llvm.dbg.value(metadata !{i64 %"105"}, i64 0, metadata !161), !dbg !162
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !163), !dbg !164
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !165), !dbg !166
  call void @llvm.dbg.value(metadata !61, i64 0, metadata !167), !dbg !168
  %"106" = icmp sgt i64 %"105", 2147483647, !dbg !169
  br i1 %"106", label %main_bb39, label %main_bb40, !dbg !169

main_bb39:                                        ; preds = %main_bb38
  %"107" = sub nsw i64 %"105", 2147483647, !dbg !170
  %"108" = sub nsw i64 %"107", 1, !dbg !170
  %"109" = srem i64 %"108", 4294967296, !dbg !170
  %"110" = add nsw i64 -2147483648, %"109", !dbg !170
  br label %main_wrap_around.exit6, !dbg !170

main_bb40:                                        ; preds = %main_bb38
  %"111" = icmp slt i64 %"105", -2147483648, !dbg !171
  br i1 %"111", label %main_bb41, label %main_wrap_around.exit6, !dbg !171

main_bb41:                                        ; preds = %main_bb40
  %"112" = sub nsw i64 -2147483648, %"105", !dbg !172
  %"113" = sub nsw i64 %"112", 1, !dbg !172
  %"114" = srem i64 %"113", 4294967296, !dbg !172
  %"115" = sub nsw i64 2147483647, %"114", !dbg !172
  br label %main_wrap_around.exit6, !dbg !172

main_wrap_around.exit6:                           ; preds = %main_bb39, %main_bb40, %main_bb41
  %.0.i5 = phi i64 [ %"110", %main_bb39 ], [ %"115", %main_bb41 ], [ %"105", %main_bb40 ], !dbg !158
  call void @llvm.dbg.value(metadata !{i64 %.0.i5}, i64 0, metadata !119), !dbg !120
  %"116" = icmp eq i64 %.0.i5, 5, !dbg !173
  br i1 %"116", label %main_bb49, label %main_wrap_around.exit2, !dbg !173

main_LeafBlock8:                                  ; preds = %main_NodeBlock
  %SwitchLeaf9 = icmp eq i64 %__retres.0.i, 0
  br i1 %SwitchLeaf9, label %main_bb42, label %main_NewDefault

main_bb42:                                        ; preds = %main_LeafBlock8
  %"117" = add nsw i64 %__retres.0.i, 1, !dbg !175
  call void @llvm.dbg.value(metadata !{i64 %"117"}, i64 0, metadata !178), !dbg !179
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !180), !dbg !181
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !182), !dbg !183
  call void @llvm.dbg.value(metadata !61, i64 0, metadata !184), !dbg !185
  %"118" = icmp sgt i64 %"117", 2147483647, !dbg !186
  br i1 %"118", label %main_bb43, label %main_bb44, !dbg !186

main_bb43:                                        ; preds = %main_bb42
  %"119" = sub nsw i64 %"117", 2147483647, !dbg !187
  %"120" = sub nsw i64 %"119", 1, !dbg !187
  %"121" = srem i64 %"120", 4294967296, !dbg !187
  %"122" = add nsw i64 -2147483648, %"121", !dbg !187
  br label %main_wrap_around.exit4, !dbg !187

main_bb44:                                        ; preds = %main_bb42
  %"123" = icmp slt i64 %"117", -2147483648, !dbg !188
  br i1 %"123", label %main_bb45, label %main_wrap_around.exit4, !dbg !188

main_bb45:                                        ; preds = %main_bb44
  %"124" = sub nsw i64 -2147483648, %"117", !dbg !189
  %"125" = sub nsw i64 %"124", 1, !dbg !189
  %"126" = srem i64 %"125", 4294967296, !dbg !189
  %"127" = sub nsw i64 2147483647, %"126", !dbg !189
  br label %main_wrap_around.exit4, !dbg !189

main_NewDefault:                                  ; preds = %main_LeafBlock8, %main_LeafBlock
  br label %main_wrap_around.exit4

main_wrap_around.exit4:                           ; preds = %main_NewDefault, %main_bb45, %main_bb44, %main_bb43
  %rc.0 = phi i64 [ %__retres.0.i, %main_NewDefault ], [ %"122", %main_bb43 ], [ %"127", %main_bb45 ], [ %"117", %main_bb44 ]
  %"128" = add nsw i64 %pos.0, %rc.0, !dbg !190
  call void @llvm.dbg.value(metadata !{i64 %"128"}, i64 0, metadata !191), !dbg !192
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !193), !dbg !194
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !195), !dbg !196
  call void @llvm.dbg.value(metadata !61, i64 0, metadata !197), !dbg !198
  %"129" = icmp sgt i64 %"128", 2147483647, !dbg !199
  br i1 %"129", label %main_bb46, label %main_bb47, !dbg !199

main_bb46:                                        ; preds = %main_wrap_around.exit4
  %"130" = sub nsw i64 %"128", 2147483647, !dbg !200
  %"131" = sub nsw i64 %"130", 1, !dbg !200
  %"132" = srem i64 %"131", 4294967296, !dbg !200
  %"133" = add nsw i64 -2147483648, %"132", !dbg !200
  br label %main_wrap_around.exit2, !dbg !200

main_bb47:                                        ; preds = %main_wrap_around.exit4
  %"134" = icmp slt i64 %"128", -2147483648, !dbg !201
  br i1 %"134", label %main_bb48, label %main_wrap_around.exit2, !dbg !201

main_bb48:                                        ; preds = %main_bb47
  %"135" = sub nsw i64 -2147483648, %"128", !dbg !202
  %"136" = sub nsw i64 %"135", 1, !dbg !202
  %"137" = srem i64 %"136", 4294967296, !dbg !202
  %"138" = sub nsw i64 2147483647, %"137", !dbg !202
  br label %main_wrap_around.exit2, !dbg !202

main_bb49:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit6, %main_bb20
  ret void, !dbg !203
}
...
!95 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 3, i32 1, i32 24} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!115 = metadata !{i32 52, i32 20, metadata !12, null}
...
!126 = metadata !{i32 786443, metadata !1, metadata !12, i32 62, i32 3, i32 1, i32 25} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!135 = metadata !{i32 22, i32 3, metadata !95, metadata !134}
!136 = metadata !{i32 23, i32 21, metadata !46, metadata !134}
!137 = metadata !{i32 24, i32 9, metadata !53, metadata !134}
!138 = metadata !{i32 30, i32 11, metadata !51, metadata !134}
!139 = metadata !{i32 31, i32 9, metadata !50, metadata !134}
!140 = metadata !{i32 10, i32 9, metadata !30, metadata !139}
!141 = metadata !{i32 11, i32 9, metadata !32, metadata !139}
!142 = metadata !{i32 13, i32 14, metadata !34, metadata !139}
!143 = metadata !{i32 14, i32 9, metadata !36, metadata !139}
!144 = metadata !{i32 33, i32 13, metadata !52, metadata !134}
!145 = metadata !{i32 34, i32 16, metadata !52, metadata !134}
...
!150 = metadata !{i32 35, i32 11, metadata !85, metadata !134}
!151 = metadata !{i32 36, i32 10, metadata !84, metadata !134}
!152 = metadata !{i32 10, i32 9, metadata !30, metadata !151}
!153 = metadata !{i32 11, i32 9, metadata !32, metadata !151}
!154 = metadata !{i32 13, i32 14, metadata !34, metadata !151}
!155 = metadata !{i32 14, i32 9, metadata !36, metadata !151}
!156 = metadata !{i32 786688, metadata !128, metadata !"rc", metadata !5, i32 63, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [rc] [line 63]
!157 = metadata !{i32 63, i32 15, metadata !128, null}
!158 = metadata !{i32 65, i32 23, metadata !159, null}
!159 = metadata !{i32 786443, metadata !1, metadata !160, i32 64, i32 19, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!160 = metadata !{i32 786443, metadata !1, metadata !128, i32 64, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!161 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !158} ; [ DW_TAG_arg_variable ] [value] [line 8]
!162 = metadata !{i32 8, i32 33, metadata !4, metadata !158} ; [ DW_TAG_imported_declaration ]
!163 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !158} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!164 = metadata !{i32 8, i32 50, metadata !4, metadata !158} ; [ DW_TAG_imported_declaration ]
!165 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !158} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!166 = metadata !{i32 8, i32 73, metadata !4, metadata !158} ; [ DW_TAG_imported_declaration ]
!167 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !158} ; [ DW_TAG_auto_variable ] [range] [line 9]
!168 = metadata !{i32 9, i32 15, metadata !4, metadata !158}
!169 = metadata !{i32 10, i32 9, metadata !30, metadata !158}
!170 = metadata !{i32 11, i32 9, metadata !32, metadata !158}
!171 = metadata !{i32 13, i32 14, metadata !34, metadata !158}
!172 = metadata !{i32 14, i32 9, metadata !36, metadata !158}
!173 = metadata !{i32 66, i32 11, metadata !174, null}
!174 = metadata !{i32 786443, metadata !1, metadata !159, i32 66, i32 11, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!175 = metadata !{i32 73, i32 9, metadata !176, null}
!176 = metadata !{i32 786443, metadata !1, metadata !177, i32 73, i32 1, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!177 = metadata !{i32 786443, metadata !1, metadata !128, i32 72, i32 9, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!178 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !175} ; [ DW_TAG_arg_variable ] [value] [line 8]
!179 = metadata !{i32 8, i32 33, metadata !4, metadata !175} ; [ DW_TAG_imported_declaration ]
!180 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !175} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!181 = metadata !{i32 8, i32 50, metadata !4, metadata !175} ; [ DW_TAG_imported_declaration ]
!182 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !175} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!183 = metadata !{i32 8, i32 73, metadata !4, metadata !175} ; [ DW_TAG_imported_declaration ]
!184 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !175} ; [ DW_TAG_auto_variable ] [range] [line 9]
!185 = metadata !{i32 9, i32 15, metadata !4, metadata !175}
!186 = metadata !{i32 10, i32 9, metadata !30, metadata !175}
!187 = metadata !{i32 11, i32 9, metadata !32, metadata !175}
!188 = metadata !{i32 13, i32 14, metadata !34, metadata !175}
!189 = metadata !{i32 14, i32 9, metadata !36, metadata !175}
!190 = metadata !{i32 75, i32 11, metadata !128, null}
!191 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !190} ; [ DW_TAG_arg_variable ] [value] [line 8]
!192 = metadata !{i32 8, i32 33, metadata !4, metadata !190} ; [ DW_TAG_imported_declaration ]
!193 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !190} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!194 = metadata !{i32 8, i32 50, metadata !4, metadata !190} ; [ DW_TAG_imported_declaration ]
!195 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !190} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!196 = metadata !{i32 8, i32 73, metadata !4, metadata !190} ; [ DW_TAG_imported_declaration ]
!197 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !190} ; [ DW_TAG_auto_variable ] [range] [line 9]
!198 = metadata !{i32 9, i32 15, metadata !4, metadata !190}
!199 = metadata !{i32 10, i32 9, metadata !30, metadata !190}
!200 = metadata !{i32 11, i32 9, metadata !32, metadata !190}
!201 = metadata !{i32 13, i32 14, metadata !34, metadata !190}
!202 = metadata !{i32 14, i32 9, metadata !36, metadata !190}
!203 = metadata !{i32 77, i32 17, metadata !12, null}
