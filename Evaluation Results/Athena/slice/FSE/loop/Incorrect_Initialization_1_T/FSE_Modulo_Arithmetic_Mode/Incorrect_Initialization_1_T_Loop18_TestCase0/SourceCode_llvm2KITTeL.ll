...
main_bb22:                                        ; preds = %main_strcspn_slice_1.exit, %main_bb21
  %p.0 = phi i32 [ %"50", %main_bb21 ], [ %., %main_strcspn_slice_1.exit ]
...
main_strcspn_slice_1.exit:                        ; preds = %main_bb23, %main_bb27
  ...
  %"102" = sext i32 %"101" to i64, !dbg !169
  %"103" = getelementptr inbounds [100000 x i64]* @memory1, i32 0, i64 %"102", !dbg !169
  %"104" = load i64* %"103", align 8, !dbg !169
  %"105" = icmp ne i64 %"104", 0, !dbg !169
  %"106" = add nsw i32 %"101", 1, !dbg !171
  call void @llvm.dbg.value(metadata !{i32 %"106"}, i64 0, metadata !139), !dbg !140
  %. = select i1 %"105", i32 %"106", i32 %"101", !dbg !169
  br label %main_bb22, !dbg !173
...
!73 = metadata !{i32 786443, metadata !1, metadata !14, i32 40, i32 3, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!80 = metadata !{i32 786443, metadata !1, metadata !77, i32 42, i32 5, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!133 = metadata !{i32 786443, metadata !1, metadata !115, i32 65, i32 5, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!153 = metadata !{i32 786443, metadata !1, metadata !17, i32 72, i32 3, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!169 = metadata !{i32 75, i32 9, metadata !170, null}
!170 = metadata !{i32 786443, metadata !1, metadata !143, i32 75, i32 9, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!171 = metadata !{i32 76, i32 3, metadata !172, null}
!172 = metadata !{i32 786443, metadata !1, metadata !170, i32 76, i32 1, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!173 = metadata !{i32 78, i32 3, metadata !143, null}
!174 = metadata !{i32 79, i32 3, metadata !17, null}
