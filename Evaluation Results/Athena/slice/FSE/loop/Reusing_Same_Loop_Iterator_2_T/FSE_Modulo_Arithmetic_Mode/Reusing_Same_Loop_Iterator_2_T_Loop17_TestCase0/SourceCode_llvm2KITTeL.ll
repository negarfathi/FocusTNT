...
main_bb6:                                         ; preds = %main_wrap_around.exit
  %"15" = add nsw i64 %i.0, 1, !dbg !40
  %"16" = icmp sgt i64 %"15", 2147483647, !dbg !42
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !42

main_bb7:                                         ; preds = %main_bb6
  %"17" = sub nsw i64 %"15", 2147483647, !dbg !43
  %"18" = sub nsw i64 %"17", 1, !dbg !43
  %"19" = srem i64 %"18", 4294967296, !dbg !43
  %"20" = add nsw i64 -2147483648, %"19", !dbg !43
  br label %main_wrap_around.exit, !dbg !43

main_bb8:                                         ; preds = %main_bb6
  %"21" = icmp slt i64 %"15", -2147483648, !dbg !44
  br i1 %"21", label %main_bb9, label %main_wrap_around.exit, !dbg !44

main_bb9:                                         ; preds = %main_bb8
  %"22" = sub nsw i64 -2147483648, %"15", !dbg !45
  %"23" = sub nsw i64 %"22", 1, !dbg !45
  %"24" = srem i64 %"23", 4294967296, !dbg !45
  %"25" = sub nsw i64 2147483647, %"24", !dbg !45
...
!39 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!40 = metadata !{i32 28, i32 8, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !9, i32 28, i32 1, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 9, i32 9, metadata !25, metadata !40}
!43 = metadata !{i32 10, i32 9, metadata !27, metadata !40}
!44 = metadata !{i32 12, i32 14, metadata !29, metadata !40}
!45 = metadata !{i32 13, i32 9, metadata !31, metadata !40}
!46 = metadata !{i32 30, i32 17, metadata !9, null}
