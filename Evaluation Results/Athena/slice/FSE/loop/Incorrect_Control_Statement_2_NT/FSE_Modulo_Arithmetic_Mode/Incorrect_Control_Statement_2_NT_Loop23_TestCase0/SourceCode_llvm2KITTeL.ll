...
main_bb5:
  ...
  call void @llvm.dbg.declare(metadata !{[10 x i64]* %ereg}, metadata !38), !dbg !39
  ...
  call void @llvm.dbg.value(metadata !{i64 %"17"}, i64 0, metadata !47), !dbg !50
...
main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = call i64 @__VERIFIER_nondet_int(), !dbg !63
  %"14" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i.0, !dbg !63
  store i64 %"13", i64* %"14", align 8, !dbg !63
  %"15" = call i64 @__VERIFIER_nondet_int(), !dbg !64
  %"16" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i.0, !dbg !64
  store i64 %"15", i64* %"16", align 8, !dbg !64
  %"17" = add nsw i64 %i.0, 1, !dbg !48
...
!38 = metadata !{i32 786688, metadata !9, metadata !"ereg", metadata !5, i32 20, metadata !34, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ereg] [line 20]
!39 = metadata !{i32 20, i32 13, metadata !9, null}
!40 = metadata !{i64 10}
!41 = metadata !{i32 786688, metadata !9, metadata !"EVENT_EPOLL_TABLES", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [EVENT_EPOLL_TABLES] [line 22]
!42 = metadata !{i32 22, i32 13, metadata !9, null}
!43 = metadata !{i64 0}
!44 = metadata !{i32 786688, metadata !45, metadata !"i", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 24]
!45 = metadata !{i32 786443, metadata !1, metadata !9, i32 23, i32 3, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 24, i32 15, metadata !45, null}
!47 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !48} ; [ DW_TAG_arg_variable ] [value] [line 7]
!48 = metadata !{i32 28, i32 12, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !45, i32 25, i32 20, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!60 = metadata !{i32 25, i32 5, metadata !45, null}
!61 = metadata !{i32 25, i32 5, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !45, i32 25, i32 5, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 26, i32 23, metadata !49, null}
!64 = metadata !{i32 27, i32 17, metadata !49, null}
!65 = metadata !{i32 9, i32 9, metadata !25, metadata !48}
!66 = metadata !{i32 10, i32 9, metadata !27, metadata !48}
!67 = metadata !{i32 12, i32 14, metadata !29, metadata !48}
!68 = metadata !{i32 13, i32 9, metadata !31, metadata !48}
