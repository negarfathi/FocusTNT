...
main_bb5:
  ...
  br i1 %"13", label %main_bb7, label %main_bb6, !dbg !36

main_bb6:                                         ; preds = %main_bb6, %main_bb5
  %"14" = icmp ne i64 %"12", 0, !dbg !38
  br i1 %"14", label %main_bb6, label %main_bb7, !dbg !38
...
!39 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!40 = metadata !{i32 28, i32 17, metadata !9, null}
