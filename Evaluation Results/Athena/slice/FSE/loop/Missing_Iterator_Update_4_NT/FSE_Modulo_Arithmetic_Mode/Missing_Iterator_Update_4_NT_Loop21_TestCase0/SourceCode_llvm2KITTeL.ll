...
main_bb5:
  ...
  %or.cond1 = or i1 %or.cond, %"16", !dbg !39
  %"17" = icmp sgt i64 %"13", 65534, !dbg !45
  %or.cond2 = or i1 %or.cond1, %"17", !dbg !39
  %or.cond2.not = xor i1 %or.cond2, true, !dbg !39
  %"18" = icmp slt i64 0, %"12", !dbg !47
  %or.cond3 = and i1 %or.cond2.not, %"18", !dbg !39
  br i1 %or.cond3, label %main_wrap_around.exit, label %main_bb11, !dbg !39

main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb9, %main_bb8, %main_bb7, %main_bb10
  %y.0 = phi i64 [ 0, %main_bb10 ], [ %"25", %main_bb7 ], [ %"30", %main_bb9 ], [ %"20", %main_bb8 ], [ 0, %main_bb5 ]
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  %.old = icmp slt i64 0, %"12", !dbg !47
  br i1 %.old, label %main_wrap_around.exit, label %main_bb11, !dbg !47
...
!58 = metadata !{i32 49, i32 17, metadata !9, null}
