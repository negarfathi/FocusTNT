...
main_gettablesize_slice_1.exit:                   ; preds = %main_bb10, %main_bb12, %main_bb13, %main_bb14
  ...
  call void @llvm.dbg.value(metadata !{i64 %"41"}, i64 0, metadata !102), !dbg !105
  call void @llvm.dbg.value(metadata !106, i64 0, metadata !107), !dbg !108
  call void @llvm.dbg.value(metadata !109, i64 0, metadata !110), !dbg !111
  call void @llvm.dbg.value(metadata !99, i64 0, metadata !112), !dbg !113
  call void @llvm.dbg.value(metadata !{i64 %"41"}, i64 0, metadata !100), !dbg !101
  br label %main_bb15, !dbg !114

main_bb15:                                        ; preds = %main_bb16, %main_gettablesize_slice_1.exit
  %i.0 = phi i64 [ 0, %main_gettablesize_slice_1.exit ], [ %"41", %main_bb16 ]
  %"40" = icmp slt i64 %i.0, %__retres.0.i, !dbg !115
  br i1 %"40", label %main_bb16, label %main_bb17, !dbg !115

main_bb16:                                        ; preds = %main_bb15
  %"41" = add nsw i64 %i.0, 1, !dbg !103
  br label %main_bb15, !dbg !117
...
!103 = metadata !{i32 36, i32 8, metadata !104, null}
!104 = metadata !{i32 786443, metadata !1, metadata !12, i32 36, i32 1, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!105 = metadata !{i32 7, i32 33, metadata !4, metadata !103}
!106 = metadata !{i64 -9223372036854775808}
!107 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !103} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!108 = metadata !{i32 7, i32 50, metadata !4, metadata !103}
!109 = metadata !{i64 9223372036854775807}
!110 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !103} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!111 = metadata !{i32 7, i32 73, metadata !4, metadata !103}
!112 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !103} ; [ DW_TAG_auto_variable ] [range] [line 8]
!113 = metadata !{i32 8, i32 15, metadata !4, metadata !103} ; [ DW_TAG_imported_declaration ]
!114 = metadata !{i32 35, i32 3, metadata !12, null}
!115 = metadata !{i32 35, i32 3, metadata !116, null}
!116 = metadata !{i32 786443, metadata !1, metadata !12, i32 35, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!117 = metadata !{i32 37, i32 1, metadata !104, null}
