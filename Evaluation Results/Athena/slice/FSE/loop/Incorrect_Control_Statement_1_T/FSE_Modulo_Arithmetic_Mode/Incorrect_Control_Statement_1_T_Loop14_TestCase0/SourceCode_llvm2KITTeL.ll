...
define void @main() #0 {
main_bb5:
  %array = alloca [101 x i64], align 16
  call void @llvm.dbg.declare(metadata !{[101 x i64]* %array}, metadata !33), !dbg !37
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !39), !dbg !41
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !42), !dbg !45
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"12" = icmp slt i64 %i.0, 100, !dbg !56
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !56

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = call i64 @__VERIFIER_nondet_char(), !dbg !58
  %"14" = getelementptr inbounds [101 x i64]* %array, i32 0, i64 %i.0, !dbg !58
  store i64 %"13", i64* %"14", align 8, !dbg !58
  %"15" = add nsw i64 %i.0, 1, !dbg !43
  %"16" = icmp sgt i64 %"15", 2147483647, !dbg !59
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !59

main_bb7:                                         ; preds = %main_bb6
  %"17" = sub nsw i64 %"15", 2147483647, !dbg !60
  %"18" = sub nsw i64 %"17", 1, !dbg !60
  %"19" = srem i64 %"18", 4294967296, !dbg !60
  %"20" = add nsw i64 -2147483648, %"19", !dbg !60
  br label %main_wrap_around.exit, !dbg !60

main_bb8:                                         ; preds = %main_bb6
  %"21" = icmp slt i64 %"15", -2147483648, !dbg !61
  br i1 %"21", label %main_bb9, label %main_wrap_around.exit, !dbg !61

main_bb9:                                         ; preds = %main_bb8
  %"22" = sub nsw i64 -2147483648, %"15", !dbg !62
  %"23" = sub nsw i64 %"22", 1, !dbg !62
  %"24" = srem i64 %"23", 4294967296, !dbg !62
  %"25" = sub nsw i64 2147483647, %"24", !dbg !62
...
!33 = metadata !{i32 786688, metadata !9, metadata !"array", metadata !5, i32 19, metadata !34, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [array] [line 19]
!34 = metadata !{i32 786433, null, null, metadata !"", i32 0, i64 6464, i64 64, i32 0, i32 0, metadata !8, metadata !35, i32 0, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 6464, align 64, offset 0] [from long long int]
!35 = metadata !{metadata !36}
!36 = metadata !{i32 786465, i64 0, i64 101}      ; [ DW_TAG_subrange_type ] [0, 100]
!37 = metadata !{i32 19, i32 13, metadata !9, null}
!38 = metadata !{i64 0}
!39 = metadata !{i32 786688, metadata !40, metadata !"i", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 21]
!40 = metadata !{i32 786443, metadata !1, metadata !9, i32 20, i32 3, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 21, i32 15, metadata !40, null}
...
!43 = metadata !{i32 24, i32 12, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !40, i32 22, i32 21, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!55 = metadata !{i32 22, i32 5, metadata !40, null}
!56 = metadata !{i32 22, i32 5, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !40, i32 22, i32 5, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 23, i32 18, metadata !44, null}
!59 = metadata !{i32 9, i32 9, metadata !25, metadata !43}
!60 = metadata !{i32 10, i32 9, metadata !27, metadata !43}
!61 = metadata !{i32 12, i32 14, metadata !29, metadata !43}
!62 = metadata !{i32 13, i32 9, metadata !31, metadata !43}
!63 = metadata !{i32 27, i32 3, metadata !9, null}
