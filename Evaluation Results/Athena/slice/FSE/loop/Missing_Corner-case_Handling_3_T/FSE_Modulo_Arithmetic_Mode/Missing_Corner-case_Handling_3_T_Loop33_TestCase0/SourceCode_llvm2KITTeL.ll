...
main_wrap_around.exit2:                           ; preds = %main_bb29, %main_bb28, %main_bb27, %main_wrap_around.exit8
  ...
  %"63" = icmp slt i64 %xmin.0, %"12", !dbg !131
  %. = select i1 %"62", i1 false, i1 %"63", !dbg !127
...
main_wrap_around.exit4:                           ; preds = %main_bb25, %main_bb24, %main_bb23, %main_wrap_around.exit2
  ...
  %"64" = sub nsw i64 %"13", 1, !dbg !135
  %"65" = icmp sgt i64 %"64", 2147483647, !dbg !138
  br i1 %"65", label %main_bb19, label %main_bb20, !dbg !138

main_bb19:                                        ; preds = %main_wrap_around.exit4
  %"66" = sub nsw i64 %"64", 2147483647, !dbg !139
  %"67" = sub nsw i64 %"66", 1, !dbg !139
  %"68" = srem i64 %"67", 4294967296, !dbg !139
  %"69" = add nsw i64 -2147483648, %"68", !dbg !139
  br label %main_wrap_around.exit6, !dbg !139

main_bb20:                                        ; preds = %main_wrap_around.exit4
  %"70" = icmp slt i64 %"64", -2147483648, !dbg !140
  br i1 %"70", label %main_bb21, label %main_wrap_around.exit6, !dbg !140

main_bb21:                                        ; preds = %main_bb20
  %"71" = sub nsw i64 -2147483648, %"64", !dbg !141
  %"72" = sub nsw i64 %"71", 1, !dbg !141
  %"73" = srem i64 %"72", 4294967296, !dbg !141
  %"74" = sub nsw i64 2147483647, %"73", !dbg !141
  br label %main_wrap_around.exit6, !dbg !141

main_wrap_around.exit6:                           ; preds = %main_bb19, %main_bb20, %main_bb21
  %.0.i5 = phi i64 [ %"69", %main_bb19 ], [ %"74", %main_bb21 ], [ %"64", %main_bb20 ], !dbg !135
  %"75" = icmp sle i64 %y.0, %.0.i5, !dbg !135
  br i1 %"75", label %main_bb22, label %main_bb26, !dbg !135

main_bb22:                                        ; preds = %main_wrap_around.exit6
  %"76" = mul nsw i64 %xmin.0, %"13", !dbg !142
  %"77" = getelementptr inbounds i64* %"20", i64 %"76", !dbg !142
  %"78" = getelementptr inbounds i64* %"77", i64 %y.0, !dbg !142
  %"79" = load i64* %"78", align 8, !dbg !142
  %"80" = icmp ne i64 %"79", 0, !dbg !142
  %.found.1 = select i1 %"80", i64 1, i64 %found.1, !dbg !142
  %"81" = add nsw i64 %y.0, 1, !dbg !145
  %"82" = icmp sgt i64 %"81", 2147483647, !dbg !146
  br i1 %"82", label %main_bb23, label %main_bb24, !dbg !146

main_bb23:                                        ; preds = %main_bb22
  %"83" = sub nsw i64 %"81", 2147483647, !dbg !147
  %"84" = sub nsw i64 %"83", 1, !dbg !147
  %"85" = srem i64 %"84", 4294967296, !dbg !147
  %"86" = add nsw i64 -2147483648, %"85", !dbg !147
  br label %main_wrap_around.exit4, !dbg !147

main_bb24:                                        ; preds = %main_bb22
  %"87" = icmp slt i64 %"81", -2147483648, !dbg !148
  br i1 %"87", label %main_bb25, label %main_wrap_around.exit4, !dbg !148

main_bb25:                                        ; preds = %main_bb24
  %"88" = sub nsw i64 -2147483648, %"81", !dbg !149
  %"89" = sub nsw i64 %"88", 1, !dbg !149
  %"90" = srem i64 %"89", 4294967296, !dbg !149
  %"91" = sub nsw i64 2147483647, %"90", !dbg !149
  br label %main_wrap_around.exit4, !dbg !149

main_bb26:                                        ; preds = %main_wrap_around.exit6
  %"92" = add nsw i64 %xmin.0, 1, !dbg !150
  call void @llvm.dbg.value(metadata !{i64 %"92"}, i64 0, metadata !151), !dbg !152
  call void @llvm.dbg.value(metadata !70, i64 0, metadata !153), !dbg !154
  call void @llvm.dbg.value(metadata !73, i64 0, metadata !155), !dbg !156
  call void @llvm.dbg.value(metadata !76, i64 0, metadata !157), !dbg !158
  %"93" = icmp sgt i64 %"92", 2147483647, !dbg !159
  br i1 %"93", label %main_bb27, label %main_bb28, !dbg !159

main_bb27:                                        ; preds = %main_bb26
  %"94" = sub nsw i64 %"92", 2147483647, !dbg !160
  %"95" = sub nsw i64 %"94", 1, !dbg !160
  %"96" = srem i64 %"95", 4294967296, !dbg !160
  %"97" = add nsw i64 -2147483648, %"96", !dbg !160
  br label %main_wrap_around.exit2, !dbg !160

main_bb28:                                        ; preds = %main_bb26
  %"98" = icmp slt i64 %"92", -2147483648, !dbg !161
  br i1 %"98", label %main_bb29, label %main_wrap_around.exit2, !dbg !161

main_bb29:                                        ; preds = %main_bb28
  %"99" = sub nsw i64 -2147483648, %"92", !dbg !162
  %"100" = sub nsw i64 %"99", 1, !dbg !162
  %"101" = srem i64 %"100", 4294967296, !dbg !162
  %"102" = sub nsw i64 2147483647, %"101", !dbg !162
  br label %main_wrap_around.exit2, !dbg !162

main_bb30:                                        ; preds = %main_wrap_around.exit2
  call void @llvm.stackrestore(i8* %"18"), !dbg !163
  br label %main_bb31
