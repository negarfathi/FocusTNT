...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !36), !dbg !40
  call void @llvm.dbg.value(metadata !33, i64 0, metadata !41), !dbg !42
...
main_wrap_around.exit:                            ; preds = %main_wrap_around.exit, %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %mul.0 = phi i64 [ 0, %main_bb5 ], [ %"17", %main_bb7 ], [ %"22", %main_bb9 ], [ %"13", %main_bb8 ], [ 0, %main_wrap_around.exit ]
  %"12" = icmp sle i64 %mul.0, 255, !dbg !50
  br i1 %"12", label %main_bb6, label %main_wrap_around.exit, !dbg !50

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = add nsw i64 %mul.0, 1, !dbg !37
  %"14" = icmp sgt i64 %"13", 4294967295, !dbg !52
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !52

main_bb7:                                         ; preds = %main_bb6
  %"15" = sub nsw i64 %"13", 4294967295, !dbg !53
  %"16" = sub nsw i64 %"15", 1, !dbg !53
  %"17" = srem i64 %"16", 4294967296, !dbg !53
  br label %main_wrap_around.exit, !dbg !53

main_bb8:                                         ; preds = %main_bb6
  %"18" = icmp slt i64 %"13", 0, !dbg !54
  br i1 %"18", label %main_bb9, label %main_wrap_around.exit, !dbg !54

main_bb9:                                         ; preds = %main_bb8
  %"19" = sub nsw i64 0, %"13", !dbg !55
  %"20" = sub nsw i64 %"19", 1, !dbg !55
  %"21" = srem i64 %"20", 4294967296, !dbg !55
  %"22" = sub nsw i64 4294967295, %"21", !dbg !55
...
!33 = metadata !{i64 0}
!34 = metadata !{i32 786688, metadata !9, metadata !"mul", metadata !5, i32 16, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [mul] [line 16]
!35 = metadata !{i32 16, i32 13, metadata !9, null}
!36 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777220, metadata !8, i32 0, metadata !37} ; [ DW_TAG_arg_variable ] [value] [line 4]
!37 = metadata !{i32 20, i32 10, metadata !38, null}
!38 = metadata !{i32 786443, metadata !1, metadata !39, i32 20, i32 1, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!39 = metadata !{i32 786443, metadata !1, metadata !9, i32 17, i32 13, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!40 = metadata !{i32 4, i32 33, metadata !4, metadata !37}
!41 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554436, metadata !8, i32 0, metadata !37} ; [ DW_TAG_arg_variable ] [lower_bound] [line 4]
!42 = metadata !{i32 4, i32 50, metadata !4, metadata !37}
!43 = metadata !{i64 4294967295}
!44 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331652, metadata !8, i32 0, metadata !37} ; [ DW_TAG_arg_variable ] [upper_bound] [line 4]
!45 = metadata !{i32 4, i32 73, metadata !4, metadata !37}
!46 = metadata !{i64 4294967296}
!47 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 5, metadata !8, i32 0, metadata !37} ; [ DW_TAG_auto_variable ] [range] [line 5]
!48 = metadata !{i32 5, i32 15, metadata !4, metadata !37}
!49 = metadata !{i32 17, i32 3, metadata !9, null}
!50 = metadata !{i32 19, i32 5, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !39, i32 19, i32 5, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 6, i32 9, metadata !25, metadata !37}
!53 = metadata !{i32 7, i32 9, metadata !27, metadata !37}
!54 = metadata !{i32 9, i32 14, metadata !29, metadata !37}
!55 = metadata !{i32 10, i32 9, metadata !31, metadata !37}
