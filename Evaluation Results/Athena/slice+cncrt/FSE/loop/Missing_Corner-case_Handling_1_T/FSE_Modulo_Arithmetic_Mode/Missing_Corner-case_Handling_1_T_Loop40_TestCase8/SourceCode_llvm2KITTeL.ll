...
main_read_slice_1.exit:                           ; preds = %main_bb15, %main_wrap_around.exit.i
  %__retres.2.i = phi i64 [ 0, %main_bb15 ], [ 500, %main_wrap_around.exit.i ], !dbg !85
  %"47" = icmp sle i64 %__retres.2.i, 0, !dbg !118
