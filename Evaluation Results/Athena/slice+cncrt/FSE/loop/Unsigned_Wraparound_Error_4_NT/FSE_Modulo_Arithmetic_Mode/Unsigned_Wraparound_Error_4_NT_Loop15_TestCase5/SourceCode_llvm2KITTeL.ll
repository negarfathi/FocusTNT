...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %n.0 = phi i64 [ 4294967280, %main_bb5 ], [ %"17", %main_bb7 ], [ %"22", %main_bb9 ], [ %"13", %main_bb8 ]
...
main_bb6:                                         ; preds = %main_wrap_around.exit
  ...
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !54
...
main_bb8:                                         ; preds = %main_bb6
  ...
  br i1 %"18", label %main_bb9, label %main_wrap_around.exit, !dbg !56
...
!53 = metadata !{i32 786443, metadata !1, metadata !9, i32 20, i32 3, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 9, i32 9, metadata !25, metadata !40}
!55 = metadata !{i32 10, i32 9, metadata !27, metadata !40}
!56 = metadata !{i32 12, i32 14, metadata !29, metadata !40}
!57 = metadata !{i32 13, i32 9, metadata !31, metadata !40}
!58 = metadata !{i32 24, i32 3, metadata !9, null}
