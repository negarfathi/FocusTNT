...
main_bb0:
  ...
  %"0" = icmp slt i32 9, 0, !dbg !21
  %"1" = icmp sle i32 12, 0, !dbg !23
  %or.cond = or i1 %"0", %"1", !dbg !21
  %"2" = icmp sle i32 3, 0, !dbg !25
  %or.cond1 = or i1 %or.cond, %"2", !dbg !21
  %"3" = icmp sgt i32 3, 12, !dbg !27
  %or.cond2 = or i1 %or.cond1, %"3", !dbg !21
  %"4" = icmp sgt i32 12, 65534, !dbg !29
