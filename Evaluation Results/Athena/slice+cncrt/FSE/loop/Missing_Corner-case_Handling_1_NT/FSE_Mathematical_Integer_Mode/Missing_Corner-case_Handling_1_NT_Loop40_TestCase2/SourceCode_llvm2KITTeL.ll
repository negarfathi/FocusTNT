...
read_slice_1_bb4:                                 ; preds = %read_slice_1_bb2
  ...
  call void @llvm.dbg.value(metadata !22, i64 0, metadata !33), !dbg !34
...
define void @main() #0 {
main_bb6:
  %"9" = load i32* @"'flag", align 4, !dbg !39
  %"10" = load i32* @"'count", align 4, !dbg !40
  call void @llvm.dbg.value(metadata !{i32 %.}, i64 0, metadata !42), !dbg !43
  call void @llvm.dbg.value(metadata !22, i64 0, metadata !44), !dbg !45
  br label %main_read_slice_1.exit, !dbg !46

main_read_slice_1.exit:                           ; preds = %main_read_slice_1.exit, %main_bb6
  %"11" = icmp eq i32 %"9", 1, !dbg !39
  %"12" = icmp sgt i32 %"10", 100, !dbg !47
  %or.cond.i = or i1 %"11", %"12", !dbg !39
  %. = select i1 %or.cond.i, i32 0, i32 -1, !dbg !39
  %"13" = icmp slt i32 %., 0, !dbg !48
  br i1 %"13", label %main_bb7, label %main_read_slice_1.exit, !dbg !48
...
!38 = metadata !{i32 32, i32 17, metadata !4, null}
!39 = metadata !{i32 10, i32 7, metadata !19, metadata !40}
...
!46 = metadata !{i32 37, i32 3, metadata !9, null}
!47 = metadata !{i32 15, i32 9, metadata !21, metadata !40}
!48 = metadata !{i32 40, i32 9, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !41, i32 40, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!50 = metadata !{i32 45, i32 3, metadata !9, null}
