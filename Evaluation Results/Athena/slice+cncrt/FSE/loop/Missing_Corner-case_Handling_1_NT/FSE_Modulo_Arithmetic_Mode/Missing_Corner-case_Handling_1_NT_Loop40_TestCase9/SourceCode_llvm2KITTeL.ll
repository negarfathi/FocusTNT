...
define void @main() #0 {
main_bb14:
  %"31" = load i64* @"'count", align 8, !dbg !84
  call void @llvm.dbg.value(metadata !82, i64 0, metadata !86), !dbg !87
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !88), !dbg !89
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !90), !dbg !92
  call void @llvm.dbg.value(metadata !52, i64 0, metadata !93), !dbg !94
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !95), !dbg !96
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !97), !dbg !98
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !88), !dbg !89
  call void @llvm.dbg.value(metadata !82, i64 0, metadata !99), !dbg !100
  br label %main_bb15, !dbg !101

main_bb15:                                        ; preds = %main_read_slice_1.exit, %main_bb14
  %"32" = load i64* @"'flag", align 8, !dbg !102
  %"33" = icmp eq i64 %"32", 1, !dbg !102
  %"34" = icmp sgt i64 %"31", 100, !dbg !103
  %or.cond.i = or i1 %"33", %"34", !dbg !102
  br i1 %or.cond.i, label %main_read_slice_1.exit, label %main_bb16, !dbg !102

main_bb16:                                        ; preds = %main_bb15
  store i64 1, i64* @"'flag", align 8, !dbg !104
  br label %main_read_slice_1.exit, !dbg !84

main_read_slice_1.exit:                           ; preds = %main_bb15, %main_bb16
  %"35" = icmp slt i64 0, 0, !dbg !105
  br i1 %"35", label %main_bb17, label %main_bb15, !dbg !105
...
!84 = metadata !{i32 53, i32 11, metadata !85, null}
...
!86 = metadata !{i32 786688, metadata !85, metadata !"tmp", metadata !5, i32 52, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp] [line 52]
!87 = metadata !{i32 52, i32 15, metadata !85, null}
!88 = metadata !{i32 786688, metadata !9, metadata !"num", metadata !5, i32 31, metadata !8, i32 0, metadata !84} ; [ DW_TAG_auto_variable ] [num] [line 31]
!89 = metadata !{i32 31, i32 13, metadata !9, metadata !84}
...
!91 = metadata !{i32 36, i32 11, metadata !49, metadata !84}
...
!99 = metadata !{i32 786688, metadata !9, metadata !"__retres", metadata !5, i32 21, metadata !8, i32 0, metadata !84} ; [ DW_TAG_auto_variable ] [__retres] [line 21]
!100 = metadata !{i32 21, i32 13, metadata !9, metadata !84}
!101 = metadata !{i32 51, i32 3, metadata !12, null}
!102 = metadata !{i32 22, i32 7, metadata !40, metadata !84}
!103 = metadata !{i32 27, i32 9, metadata !42, metadata !84}
!104 = metadata !{i32 42, i32 7, metadata !81, metadata !84}
!105 = metadata !{i32 54, i32 9, metadata !106, null}
!106 = metadata !{i32 786443, metadata !1, metadata !85, i32 54, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!107 = metadata !{i32 59, i32 3, metadata !12, null}
