...
main_bb5:                                         ; preds = %main_bb3
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !54), !dbg !55
  %"15" = icmp slt i32 0, 0, !dbg !56
  br i1 %"15", label %main_bb9, label %main_bb6, !dbg !56

main_bb6:                                         ; preds = %main_bb5, %main_bb8
  %entry.0 = phi i32 [ %"22", %main_bb8 ], [ 0, %main_bb5 ]
  %"16" = icmp sge i32 %entry.0, 5, !dbg !58
  br i1 %"16", label %main_bb9, label %main_bb7, !dbg !58
...
main_bb7:                                         ; preds = %main_bb6
  ...
  br i1 %"21", label %main_bb8, label %main_bb9, !dbg !61
...
!54 = metadata !{i32 786688, metadata !30, metadata !"entry", metadata !5, i32 35, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [entry] [line 35]
!55 = metadata !{i32 35, i32 9, metadata !30, null}
!56 = metadata !{i32 36, i32 9, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !30, i32 36, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!60 = metadata !{i32 786443, metadata !1, metadata !30, i32 37, i32 15, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 42, i32 11, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !60, i32 42, i32 11, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 43, i32 9, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !62, i32 42, i32 42, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 49, i32 5, metadata !60, null}
!66 = metadata !{i32 52, i32 17, metadata !9, null}
