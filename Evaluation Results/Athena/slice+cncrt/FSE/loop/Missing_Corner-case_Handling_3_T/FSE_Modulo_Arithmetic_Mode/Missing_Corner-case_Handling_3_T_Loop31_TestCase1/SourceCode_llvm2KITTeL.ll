...
main_wrap_around.exit2:                           ; preds = %main_bb29, %main_bb28, %main_bb27, %main_wrap_around.exit8
  ...
  %"60" = icmp slt i64 %xmin.0, 1, !dbg !129
  %. = select i1 %"59", i1 false, i1 %"60", !dbg !125
  br i1 %., label %main_wrap_around.exit4, label %main_bb30, !dbg !131
...
main_wrap_around.exit4:                           ; preds = %main_bb25, %main_bb24, %main_bb23, %main_wrap_around.exit2
  ...
  %"61" = sub nsw i64 1, 1, !dbg !133
  %"62" = icmp sgt i64 %"61", 2147483647, !dbg !136
  br i1 %"62", label %main_bb19, label %main_bb20, !dbg !136

main_bb19:                                        ; preds = %main_wrap_around.exit4
  %"63" = sub nsw i64 %"61", 2147483647, !dbg !137
  %"64" = sub nsw i64 %"63", 1, !dbg !137
  %"65" = srem i64 %"64", 4294967296, !dbg !137
  %"66" = add nsw i64 -2147483648, %"65", !dbg !137
  br label %main_wrap_around.exit6, !dbg !137

main_bb20:                                        ; preds = %main_wrap_around.exit4
  %"67" = icmp slt i64 %"61", -2147483648, !dbg !138
  br i1 %"67", label %main_bb21, label %main_wrap_around.exit6, !dbg !138

main_bb21:                                        ; preds = %main_bb20
  %"68" = sub nsw i64 -2147483648, %"61", !dbg !139
  %"69" = sub nsw i64 %"68", 1, !dbg !139
  %"70" = srem i64 %"69", 4294967296, !dbg !139
  %"71" = sub nsw i64 2147483647, %"70", !dbg !139
  br label %main_wrap_around.exit6, !dbg !139

main_wrap_around.exit6:                           ; preds = %main_bb19, %main_bb20, %main_bb21
  %.0.i5 = phi i64 [ %"66", %main_bb19 ], [ %"71", %main_bb21 ], [ %"61", %main_bb20 ], !dbg !133
  %"72" = icmp sle i64 %y.0, %.0.i5, !dbg !133
  br i1 %"72", label %main_bb22, label %main_bb26, !dbg !133

main_bb22:                                        ; preds = %main_wrap_around.exit6
  %"73" = mul nsw i64 %xmin.0, 1, !dbg !140
  %"74" = getelementptr inbounds i64* %"18", i64 %"73", !dbg !140
  %"75" = getelementptr inbounds i64* %"74", i64 %y.0, !dbg !140
  %"76" = load i64* %"75", align 8, !dbg !140
  %"77" = icmp ne i64 %"76", 0, !dbg !140
  %.found.1 = select i1 %"77", i64 1, i64 %found.1, !dbg !140
  %"78" = add nsw i64 %y.0, 1, !dbg !143
  %"79" = icmp sgt i64 %"78", 2147483647, !dbg !144
  br i1 %"79", label %main_bb23, label %main_bb24, !dbg !144

main_bb23:                                        ; preds = %main_bb22
  %"80" = sub nsw i64 %"78", 2147483647, !dbg !145
  %"81" = sub nsw i64 %"80", 1, !dbg !145
  %"82" = srem i64 %"81", 4294967296, !dbg !145
  %"83" = add nsw i64 -2147483648, %"82", !dbg !145
  br label %main_wrap_around.exit4, !dbg !145

main_bb24:                                        ; preds = %main_bb22
  %"84" = icmp slt i64 %"78", -2147483648, !dbg !146
  br i1 %"84", label %main_bb25, label %main_wrap_around.exit4, !dbg !146

main_bb25:                                        ; preds = %main_bb24
  %"85" = sub nsw i64 -2147483648, %"78", !dbg !147
  %"86" = sub nsw i64 %"85", 1, !dbg !147
  %"87" = srem i64 %"86", 4294967296, !dbg !147
  %"88" = sub nsw i64 2147483647, %"87", !dbg !147
  br label %main_wrap_around.exit4, !dbg !147

main_bb26:                                        ; preds = %main_wrap_around.exit6
  %"89" = add nsw i64 %xmin.0, 1, !dbg !148
  call void @llvm.dbg.value(metadata !{i64 %"89"}, i64 0, metadata !149), !dbg !150
  call void @llvm.dbg.value(metadata !69, i64 0, metadata !151), !dbg !152
  call void @llvm.dbg.value(metadata !72, i64 0, metadata !153), !dbg !154
  call void @llvm.dbg.value(metadata !75, i64 0, metadata !155), !dbg !156
  %"90" = icmp sgt i64 %"89", 2147483647, !dbg !157
  br i1 %"90", label %main_bb27, label %main_bb28, !dbg !157

main_bb27:                                        ; preds = %main_bb26
  %"91" = sub nsw i64 %"89", 2147483647, !dbg !158
  %"92" = sub nsw i64 %"91", 1, !dbg !158
  %"93" = srem i64 %"92", 4294967296, !dbg !158
  %"94" = add nsw i64 -2147483648, %"93", !dbg !158
  br label %main_wrap_around.exit2, !dbg !158

main_bb28:                                        ; preds = %main_bb26
  %"95" = icmp slt i64 %"89", -2147483648, !dbg !159
  br i1 %"95", label %main_bb29, label %main_wrap_around.exit2, !dbg !159

main_bb29:                                        ; preds = %main_bb28
  %"96" = sub nsw i64 -2147483648, %"89", !dbg !160
  %"97" = sub nsw i64 %"96", 1, !dbg !160
  %"98" = srem i64 %"97", 4294967296, !dbg !160
  %"99" = sub nsw i64 2147483647, %"98", !dbg !160
  br label %main_wrap_around.exit2, !dbg !160

main_bb30:                                        ; preds = %main_wrap_around.exit2
  call void @llvm.stackrestore(i8* %"16"), !dbg !161
  br label %main_bb31
...
!126 = metadata !{i32 786443, metadata !1, metadata !127, i32 46, i32 10, i32 4, i32 30} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!129 = metadata !{i32 46, i32 10, metadata !130, null}
!130 = metadata !{i32 786443, metadata !1, metadata !128, i32 46, i32 10, i32 3, i32 27} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!131 = metadata !{i32 46, i32 10, metadata !132, null}
!132 = metadata !{i32 786443, metadata !1, metadata !128, i32 46, i32 10, i32 2, i32 26} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!133 = metadata !{i32 48, i32 37, metadata !134, null}
!134 = metadata !{i32 786443, metadata !1, metadata !135, i32 48, i32 9, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!135 = metadata !{i32 786443, metadata !1, metadata !128, i32 47, i32 5, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!136 = metadata !{i32 15, i32 9, metadata !26, metadata !133}
!137 = metadata !{i32 16, i32 9, metadata !28, metadata !133}
!138 = metadata !{i32 18, i32 14, metadata !30, metadata !133}
!139 = metadata !{i32 19, i32 9, metadata !32, metadata !133}
!140 = metadata !{i32 50, i32 17, metadata !141, null}
!141 = metadata !{i32 786443, metadata !1, metadata !142, i32 50, i32 17, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!142 = metadata !{i32 786443, metadata !1, metadata !134, i32 49, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!143 = metadata !{i32 48, i32 84, metadata !134, null}
!144 = metadata !{i32 15, i32 9, metadata !26, metadata !143}
!145 = metadata !{i32 16, i32 9, metadata !28, metadata !143}
!146 = metadata !{i32 18, i32 14, metadata !30, metadata !143}
!147 = metadata !{i32 19, i32 9, metadata !32, metadata !143}
!148 = metadata !{i32 46, i32 62, metadata !128, null}
!149 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777229, metadata !8, i32 0, metadata !148} ; [ DW_TAG_arg_variable ] [value] [line 13]
!150 = metadata !{i32 13, i32 33, metadata !4, metadata !148}
!151 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554445, metadata !8, i32 0, metadata !148} ; [ DW_TAG_arg_variable ] [lower_bound] [line 13]
!152 = metadata !{i32 13, i32 50, metadata !4, metadata !148}
!153 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331661, metadata !8, i32 0, metadata !148} ; [ DW_TAG_arg_variable ] [upper_bound] [line 13]
!154 = metadata !{i32 13, i32 73, metadata !4, metadata !148}
!155 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 14, metadata !8, i32 0, metadata !148} ; [ DW_TAG_auto_variable ] [range] [line 14]
!156 = metadata !{i32 14, i32 15, metadata !4, metadata !148}
!157 = metadata !{i32 15, i32 9, metadata !26, metadata !148}
!158 = metadata !{i32 16, i32 9, metadata !28, metadata !148}
!159 = metadata !{i32 18, i32 14, metadata !30, metadata !148}
!160 = metadata !{i32 19, i32 9, metadata !32, metadata !148}
!161 = metadata !{i32 57, i32 1, metadata !9, null}
