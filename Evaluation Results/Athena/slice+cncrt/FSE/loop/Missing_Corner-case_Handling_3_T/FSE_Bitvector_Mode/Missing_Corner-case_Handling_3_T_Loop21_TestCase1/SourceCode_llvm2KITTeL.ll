...
main_bb7:                                         ; preds = %main_bb2, %main_bb11
  ...
  %"22" = icmp slt i32 %xmin.0, 1, !dbg !60
  %.3 = select i1 %"21", i1 false, i1 %"22", !dbg !56
  br i1 %.3, label %main_bb8, label %main_bb12, !dbg !62

main_bb8:                                         ; preds = %main_bb7
  %"23" = sext i32 %xmin.0 to i64, !dbg !64
...
main_bb9:                                         ; preds = %main_bb10, %main_bb8
  ...
  %"24" = sub nsw i32 1, 1, !dbg !70
  %"25" = icmp sle i32 %y.0, %"24", !dbg !70
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !70

main_bb10:                                        ; preds = %main_bb9
  %"26" = sext i32 %y.0 to i64, !dbg !64
  %"27" = mul nsw i64 %"23", %"5", !dbg !64
  %"28" = getelementptr inbounds i32* %"8", i64 %"27", !dbg !64
  %"29" = getelementptr inbounds i32* %"28", i64 %"26", !dbg !64
  %"30" = load i32* %"29", align 4, !dbg !64
  %"31" = icmp ne i32 %"30", 0, !dbg !64
  %.found.1 = select i1 %"31", i32 1, i32 %found.1, !dbg !64
  %"32" = add nsw i32 %y.0, 1, !dbg !73
  br label %main_bb9, !dbg !73

main_bb11:                                        ; preds = %main_bb9
  %"33" = add nsw i32 %xmin.0, 1, !dbg !74
  call void @llvm.dbg.value(metadata !{i32 %"33"}, i64 0, metadata !75), !dbg !76
  br label %main_bb7, !dbg !74

main_bb12:                                        ; preds = %main_bb7
  call void @llvm.stackrestore(i8* %"6"), !dbg !77
  br label %main_bb13
...
!57 = metadata !{i32 786443, metadata !1, metadata !58, i32 30, i32 10, i32 4, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!60 = metadata !{i32 30, i32 10, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !59, i32 30, i32 10, i32 3, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 30, i32 10, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !59, i32 30, i32 10, i32 2, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 34, i32 17, metadata !65, null}
!65 = metadata !{i32 786443, metadata !1, metadata !66, i32 34, i32 17, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!67 = metadata !{i32 786443, metadata !1, metadata !68, i32 32, i32 9, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!68 = metadata !{i32 786443, metadata !1, metadata !59, i32 31, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 32, i32 14, metadata !67, null}
!70 = metadata !{i32 32, i32 14, metadata !71, null}
!71 = metadata !{i32 786443, metadata !1, metadata !72, i32 32, i32 14, i32 2, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!72 = metadata !{i32 786443, metadata !1, metadata !67, i32 32, i32 14, i32 1, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!73 = metadata !{i32 32, i32 42, metadata !67, null}
!74 = metadata !{i32 30, i32 48, metadata !59, null}
!75 = metadata !{i32 786688, metadata !59, metadata !"xmin", metadata !5, i32 30, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [xmin] [line 30]
!76 = metadata !{i32 30, i32 14, metadata !59, null}
!77 = metadata !{i32 39, i32 1, metadata !4, null}
