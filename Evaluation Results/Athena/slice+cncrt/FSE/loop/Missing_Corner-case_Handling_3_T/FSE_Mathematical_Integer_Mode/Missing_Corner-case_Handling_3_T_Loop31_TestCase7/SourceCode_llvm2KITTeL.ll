...
main_bb0:
  ...
  %"0" = icmp sle i32 30, 0, !dbg !17
  %"1" = icmp sle i32 30, 0, !dbg !19
  %or.cond = or i1 %"0", %"1", !dbg !17
  %"2" = icmp sgt i32 30, 65534, !dbg !21
  %or.cond1 = or i1 %or.cond, %"2", !dbg !17
  %"3" = icmp sgt i32 30, 65534, !dbg !23
  %or.cond2 = or i1 %or.cond1, %"3", !dbg !17
  br i1 %or.cond2, label %main_bb13, label %main_bb1, !dbg !17

main_bb1:                                         ; preds = %main_bb0
  %"4" = zext i32 30 to i64, !dbg !25
  %"5" = zext i32 30 to i64, !dbg !25
...
main_bb2:                                         ; preds = %main_bb6, %main_bb1
  ...
  %"9" = icmp slt i32 %i.0, 30, !dbg !44
  br i1 %"9", label %main_bb3, label %main_bb7, !dbg !44

main_bb3:                                         ; preds = %main_bb2
  %"10" = sext i32 %i.0 to i64, !dbg !47
  br label %main_bb4, !dbg !48

main_bb4:                                         ; preds = %main_bb5, %main_bb3
  %j.0 = phi i32 [ 0, %main_bb3 ], [ %"19", %main_bb5 ]
  %"11" = icmp slt i32 %j.0, 30, !dbg !49
  br i1 %"11", label %main_bb5, label %main_bb6, !dbg !49

main_bb5:                                         ; preds = %main_bb4
  %"12" = icmp sgt i32 -24, 0, !dbg !52
  %"13" = sub nsw i32 0, -24, !dbg !54
  %. = select i1 %"12", i32 %"13", i32 -24, !dbg !52
  %"14" = srem i32 %., 4, !dbg !47
  %"15" = sext i32 %j.0 to i64, !dbg !47
  %"16" = mul nsw i64 %"10", %"5", !dbg !47
  %"17" = getelementptr inbounds i32* %"8", i64 %"16", !dbg !47
  %"18" = getelementptr inbounds i32* %"17", i64 %"15", !dbg !47
  store i32 %"14", i32* %"18", align 4, !dbg !47
  %"19" = add nsw i32 %j.0, 1, !dbg !55
  br label %main_bb4, !dbg !55

main_bb6:                                         ; preds = %main_bb4
  %"20" = add nsw i32 %i.0, 1, !dbg !56
  call void @llvm.dbg.value(metadata !{i32 %"20"}, i64 0, metadata !32), !dbg !34
  br label %main_bb2, !dbg !56

main_bb7:                                         ; preds = %main_bb2, %main_bb11
  %xmin.0 = phi i32 [ %"33", %main_bb11 ], [ 0, %main_bb2 ]
  %found.0 = phi i32 [ %found.1, %main_bb11 ], [ 0, %main_bb2 ]
  %"21" = icmp ne i32 %found.0, 0, !dbg !57
  %"22" = icmp slt i32 %xmin.0, 30, !dbg !61
  %.3 = select i1 %"21", i1 false, i1 %"22", !dbg !57
  br i1 %.3, label %main_bb8, label %main_bb12, !dbg !63

main_bb8:                                         ; preds = %main_bb7
  %"23" = sext i32 %xmin.0 to i64, !dbg !65
  br label %main_bb9, !dbg !70

main_bb9:                                         ; preds = %main_bb10, %main_bb8
  %y.0 = phi i32 [ 0, %main_bb8 ], [ %"32", %main_bb10 ]
  %found.1 = phi i32 [ %found.0, %main_bb8 ], [ %.found.1, %main_bb10 ]
  %"24" = sub nsw i32 30, 1, !dbg !71
  %"25" = icmp sle i32 %y.0, %"24", !dbg !71
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !71

main_bb10:                                        ; preds = %main_bb9
  %"26" = sext i32 %y.0 to i64, !dbg !65
  %"27" = mul nsw i64 %"23", %"5", !dbg !65
  %"28" = getelementptr inbounds i32* %"8", i64 %"27", !dbg !65
  %"29" = getelementptr inbounds i32* %"28", i64 %"26", !dbg !65
  %"30" = load i32* %"29", align 4, !dbg !65
  %"31" = icmp ne i32 %"30", 0, !dbg !65
  %.found.1 = select i1 %"31", i32 1, i32 %found.1, !dbg !65
  %"32" = add nsw i32 %y.0, 1, !dbg !74
  br label %main_bb9, !dbg !74

main_bb11:                                        ; preds = %main_bb9
  %"33" = add nsw i32 %xmin.0, 1, !dbg !75
  call void @llvm.dbg.value(metadata !{i32 %"33"}, i64 0, metadata !76), !dbg !77
  br label %main_bb7, !dbg !75

main_bb12:                                        ; preds = %main_bb7
  call void @llvm.stackrestore(i8* %"6"), !dbg !78
  br label %main_bb13
...
!41 = metadata !{i32 786443, metadata !1, metadata !36, i32 21, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 22, i32 17, metadata !41, null}
!43 = metadata !{i32 18, i32 10, metadata !33, null}
...
!46 = metadata !{i32 786443, metadata !1, metadata !33, i32 18, i32 10, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 25, i32 13, metadata !41, null}
!48 = metadata !{i32 20, i32 14, metadata !36, null}
...
!51 = metadata !{i32 786443, metadata !1, metadata !36, i32 20, i32 14, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 23, i32 17, metadata !53, null}
!53 = metadata !{i32 786443, metadata !1, metadata !41, i32 23, i32 17, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 24, i32 17, metadata !53, null}
!55 = metadata !{i32 20, i32 38, metadata !36, null}
!56 = metadata !{i32 18, i32 34, metadata !33, null}
!57 = metadata !{i32 30, i32 10, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !59, i32 30, i32 10, i32 4, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 786443, metadata !1, metadata !60, i32 30, i32 10, i32 1, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 786443, metadata !1, metadata !4, i32 30, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 30, i32 10, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !60, i32 30, i32 10, i32 3, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 30, i32 10, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !60, i32 30, i32 10, i32 2, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 34, i32 17, metadata !66, null}
!66 = metadata !{i32 786443, metadata !1, metadata !67, i32 34, i32 17, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!67 = metadata !{i32 786443, metadata !1, metadata !68, i32 33, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!68 = metadata !{i32 786443, metadata !1, metadata !69, i32 32, i32 9, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 786443, metadata !1, metadata !60, i32 31, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!70 = metadata !{i32 32, i32 14, metadata !68, null}
!71 = metadata !{i32 32, i32 14, metadata !72, null}
!72 = metadata !{i32 786443, metadata !1, metadata !73, i32 32, i32 14, i32 2, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!73 = metadata !{i32 786443, metadata !1, metadata !68, i32 32, i32 14, i32 1, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!74 = metadata !{i32 32, i32 42, metadata !68, null}
!75 = metadata !{i32 30, i32 48, metadata !60, null}
!76 = metadata !{i32 786688, metadata !60, metadata !"xmin", metadata !5, i32 30, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [xmin] [line 30]
!77 = metadata !{i32 30, i32 14, metadata !60, null}
!78 = metadata !{i32 39, i32 1, metadata !4, null}
