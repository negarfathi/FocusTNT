...
main_bb6:
  ...
  %"8" = icmp sle i32 5, 0, !dbg !48
  br i1 %"8", label %main_bb11, label %main_bb7, !dbg !48

main_bb7:                                         ; preds = %main_bb9, %main_bb6, %main_bb10
  %tries.0 = phi i32 [ %tries.0, %main_bb10 ], [ 0, %main_bb6 ], [ %"13", %main_bb9 ]
  %buf.0 = phi i32 [ %"16", %main_bb10 ], [ 0, %main_bb6 ], [ %buf.0, %main_bb9 ]
  %count.0 = phi i32 [ %"15", %main_bb10 ], [ 5, %main_bb6 ], [ %count.0, %main_bb9 ]
  %"9" = icmp sgt i32 %count.0, 0, !dbg !50
  br i1 %"9", label %main_read_slice_1.exit, label %main_bb11, !dbg !50

main_read_slice_1.exit:                           ; preds = %main_bb7
  %"10" = icmp slt i32 %buf.0, %count.0, !dbg !52
  %. = select i1 %"10", i32 -1, i32 0, !dbg !52
  %"11" = icmp sle i32 %., 0, !dbg !55
  br i1 %"11", label %main_bb8, label %main_bb10, !dbg !55

main_bb8:                                         ; preds = %main_read_slice_1.exit
  %"12" = icmp eq i32 %., 0, !dbg !57
  br i1 %"12", label %main_bb9, label %main_bb11, !dbg !57

main_bb9:                                         ; preds = %main_bb8
  %"13" = add nsw i32 %tries.0, 1, !dbg !60
  %"14" = icmp slt i32 %tries.0, 5, !dbg !62
  br i1 %"14", label %main_bb7, label %main_bb11, !dbg !62

main_bb10:                                        ; preds = %main_read_slice_1.exit
  %"15" = sub nsw i32 %count.0, %., !dbg !64
  %"16" = add nsw i32 %buf.0, %., !dbg !65
  br label %main_bb7, !dbg !66

main_bb11:                                        ; preds = %main_bb7, %main_bb8, %main_bb9, %main_bb6
  ret void, !dbg !67
}
...
!36 = metadata !{i32 786443, metadata !1, metadata !33, i32 18, i32 20, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!42 = metadata !{i32 786443, metadata !1, metadata !40, i32 21, i32 22, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 28, i32 3, metadata !25, null}
!44 = metadata !{i32 30, i32 17, metadata !4, null}
!45 = metadata !{i32 5}
!46 = metadata !{i32 786688, metadata !9, metadata !"count", metadata !5, i32 36, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [count] [line 36]
!47 = metadata !{i32 36, i32 7, metadata !9, null}
!48 = metadata !{i32 37, i32 7, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !9, i32 37, i32 7, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!50 = metadata !{i32 40, i32 3, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !9, i32 40, i32 3, i32 1, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 10, i32 3, metadata !29, metadata !53}
...
!55 = metadata !{i32 42, i32 9, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !54, i32 42, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 43, i32 11, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !59, i32 43, i32 11, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 786443, metadata !1, metadata !56, i32 42, i32 19, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 46, i32 9, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !58, i32 43, i32 21, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 47, i32 13, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !61, i32 47, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 52, i32 5, metadata !54, null}
!65 = metadata !{i32 53, i32 5, metadata !54, null}
!66 = metadata !{i32 54, i32 3, metadata !54, null}
!67 = metadata !{i32 55, i32 17, metadata !9, null}
