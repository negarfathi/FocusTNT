...
main_bb7:
  ...
  br i1 %"10", label %main_bb13, label %main_bb8, !dbg !52
...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %"17"}, i64 0, metadata !56), !dbg !57
  call void @llvm.dbg.value(metadata !{i32 %"19"}, i64 0, metadata !50), !dbg !51
  call void @llvm.dbg.value(metadata !{i32 %"20"}, i64 0, metadata !54), !dbg !55
...
main_bb9:                                         ; preds = %main_bb11, %main_bb12, %main_bb8
  ...
  br i1 %"12", label %main_read_slice_1.exit, label %main_bb13, !dbg !76

main_read_slice_1.exit:                           ; preds = %main_bb9
  %"13" = icmp ne i32 %"11", 1, !dbg !66
  %"14" = icmp slt i32 %buf.0, %count.0, !dbg !78
  %or.cond = and i1 %"13", %"14", !dbg !66
  %__retres.0.i = select i1 %or.cond, i32 -1, i32 0, !dbg !66
  %"15" = icmp sle i32 %__retres.0.i, 0, !dbg !79
  br i1 %"15", label %main_bb10, label %main_bb12, !dbg !79

main_bb10:                                        ; preds = %main_read_slice_1.exit
  %"16" = icmp eq i32 %__retres.0.i, 0, !dbg !80
  br i1 %"16", label %main_bb11, label %main_bb13, !dbg !80

main_bb11:                                        ; preds = %main_bb10
  %"17" = add nsw i32 %tries.0, 1, !dbg !81
  %"18" = icmp slt i32 %tries.0, 5, !dbg !82
  br i1 %"18", label %main_bb9, label %main_bb13, !dbg !82

main_bb12:                                        ; preds = %main_read_slice_1.exit
  %"19" = sub nsw i32 %count.0, %__retres.0.i, !dbg !84
  %"20" = add nsw i32 %buf.0, %__retres.0.i, !dbg !85
  br label %main_bb9, !dbg !86
...
!79 = metadata !{i32 51, i32 9, metadata !73, null}
!80 = metadata !{i32 52, i32 11, metadata !71, null}
!81 = metadata !{i32 55, i32 9, metadata !70, null}
!82 = metadata !{i32 56, i32 13, metadata !83, null}
!83 = metadata !{i32 786443, metadata !1, metadata !70, i32 56, i32 13, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!84 = metadata !{i32 61, i32 5, metadata !60, null}
!85 = metadata !{i32 62, i32 5, metadata !60, null}
!86 = metadata !{i32 63, i32 3, metadata !60, null}
!87 = metadata !{i32 64, i32 17, metadata !9, null}
