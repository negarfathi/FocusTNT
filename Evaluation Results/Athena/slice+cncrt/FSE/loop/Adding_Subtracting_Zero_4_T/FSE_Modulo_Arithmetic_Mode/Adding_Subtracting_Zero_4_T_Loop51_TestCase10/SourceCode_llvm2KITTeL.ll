...
read_slice_1_wrap_around.exit:                    ; preds = %read_slice_1_bb11, %read_slice_1_bb10, %read_slice_1_bb9, %read_slice_1_bb7
  %num.0 = phi i64 [ -1995, %read_slice_1_bb7 ], [ %"22", %read_slice_1_bb9 ], [ %"27", %read_slice_1_bb11 ], [ %"17", %read_slice_1_bb10 ]
...
main_wrap_around.exit:                            ; preds = %main_bb38, %main_bb37, %main_bb36, %main_wrap_around.exit4, %main_bb21
  ...
  %count.0 = phi i64 [ 995, %main_bb21 ], [ %count.0, %main_wrap_around.exit4 ], [ %.0.i1, %main_bb36 ], [ %.0.i1, %main_bb37 ], [ %.0.i1, %main_bb38 ]
