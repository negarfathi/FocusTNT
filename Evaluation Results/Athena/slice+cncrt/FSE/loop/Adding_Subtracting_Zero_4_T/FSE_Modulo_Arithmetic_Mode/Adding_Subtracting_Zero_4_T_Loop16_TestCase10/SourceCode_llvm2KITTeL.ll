...
read_slice_1_wrap_around.exit:                    ; preds = %read_slice_1_bb11, %read_slice_1_bb10, %read_slice_1_bb9, %read_slice_1_bb7
  %num.0 = phi i64 [ -1995, %read_slice_1_bb7 ], [ %"20", %read_slice_1_bb9 ], [ %"25", %read_slice_1_bb11 ], [ %"15", %read_slice_1_bb10 ]
...
main_bb20:
  ...
  %"50" = icmp sle i64 995, 0, !dbg !116
  br i1 %"50", label %main_bb37, label %main_wrap_around.exit, !dbg !116

main_wrap_around.exit:                            ; preds = %main_bb36, %main_bb35, %main_bb34, %main_wrap_around.exit4, %main_bb20
  %tries.0 = phi i64 [ 0, %main_bb20 ], [ %.0.i3, %main_wrap_around.exit4 ], [ %tries.0, %main_bb34 ], [ %tries.0, %main_bb35 ], [ %tries.0, %main_bb36 ]
  %buf.0 = phi i64 [ 0, %main_bb20 ], [ %buf.0, %main_wrap_around.exit4 ], [ %"94", %main_bb34 ], [ %"99", %main_bb36 ], [ %"89", %main_bb35 ]
  %count.0 = phi i64 [ 995, %main_bb20 ], [ %count.0, %main_wrap_around.exit4 ], [ %.0.i1, %main_bb34 ], [ %.0.i1, %main_bb35 ], [ %.0.i1, %main_bb36 ]
  %"51" = icmp sgt i64 %count.0, 0, !dbg !118
  br i1 %"51", label %main_wrap_around.exit2.i, label %main_bb37, !dbg !118

main_wrap_around.exit2.i:                         ; preds = %main_wrap_around.exit
  %"52" = icmp slt i64 %buf.0, %count.0, !dbg !120
  br i1 %"52", label %main_bb21, label %main_read_slice_1.exit, !dbg !120

main_bb21:                                        ; preds = %main_wrap_around.exit2.i
  %"53" = add nsw i64 0, 1, !dbg !123
...
main_bb22:                                        ; preds = %main_bb21
  ...
  br label %main_read_slice_1.exit, !dbg !125

main_bb23:                                        ; preds = %main_bb21
  %"59" = icmp slt i64 %"53", -2147483648, !dbg !126
  br i1 %"59", label %main_bb24, label %main_read_slice_1.exit, !dbg !126
...
main_bb24:                                        ; preds = %main_bb23
  ...
  br label %main_read_slice_1.exit, !dbg !127

main_read_slice_1.exit:                           ; preds = %main_bb22, %main_bb23, %main_bb24, %main_wrap_around.exit2.i
  %__retres.0.i = phi i64 [ 0, %main_wrap_around.exit2.i ], [ %"58", %main_bb22 ], [ %"63", %main_bb24 ], [ %"53", %main_bb23 ], !dbg !121
  %"64" = icmp sle i64 %__retres.0.i, 0, !dbg !128
  br i1 %"64", label %main_bb25, label %main_bb30, !dbg !128

main_bb25:                                        ; preds = %main_read_slice_1.exit
  %"65" = icmp eq i64 %__retres.0.i, 0, !dbg !130
  br i1 %"65", label %main_bb26, label %main_bb37, !dbg !130

main_bb26:                                        ; preds = %main_bb25
  %"66" = add nsw i64 %tries.0, 1, !dbg !133
  %"67" = icmp sgt i64 %"66", 2147483647, !dbg !135
  br i1 %"67", label %main_bb27, label %main_bb28, !dbg !135

main_bb27:                                        ; preds = %main_bb26
  %"68" = sub nsw i64 %"66", 2147483647, !dbg !136
  %"69" = sub nsw i64 %"68", 1, !dbg !136
  %"70" = srem i64 %"69", 4294967296, !dbg !136
  %"71" = add nsw i64 -2147483648, %"70", !dbg !136
  br label %main_wrap_around.exit4, !dbg !136

main_bb28:                                        ; preds = %main_bb26
  %"72" = icmp slt i64 %"66", -2147483648, !dbg !137
  br i1 %"72", label %main_bb29, label %main_wrap_around.exit4, !dbg !137

main_bb29:                                        ; preds = %main_bb28
  %"73" = sub nsw i64 -2147483648, %"66", !dbg !138
  %"74" = sub nsw i64 %"73", 1, !dbg !138
  %"75" = srem i64 %"74", 4294967296, !dbg !138
  %"76" = sub nsw i64 2147483647, %"75", !dbg !138
  br label %main_wrap_around.exit4, !dbg !138

main_wrap_around.exit4:                           ; preds = %main_bb27, %main_bb28, %main_bb29
  %.0.i3 = phi i64 [ %"71", %main_bb27 ], [ %"76", %main_bb29 ], [ %"66", %main_bb28 ], !dbg !133
  %"77" = icmp slt i64 %tries.0, 5, !dbg !139
  br i1 %"77", label %main_wrap_around.exit, label %main_bb37, !dbg !139

main_bb30:                                        ; preds = %main_read_slice_1.exit
  %"78" = sub nsw i64 %count.0, %__retres.0.i, !dbg !141
  %"79" = icmp sgt i64 %"78", 2147483647, !dbg !142
  br i1 %"79", label %main_bb31, label %main_bb32, !dbg !142
...
main_bb31:                                        ; preds = %main_bb30
  ...
  br label %main_wrap_around.exit2, !dbg !143

main_bb32:                                        ; preds = %main_bb30
  %"84" = icmp slt i64 %"78", -2147483648, !dbg !144
  br i1 %"84", label %main_bb33, label %main_wrap_around.exit2, !dbg !144
...
main_bb33:                                        ; preds = %main_bb32
  ...
  br label %main_wrap_around.exit2, !dbg !145

main_wrap_around.exit2:                           ; preds = %main_bb31, %main_bb32, %main_bb33
  %.0.i1 = phi i64 [ %"83", %main_bb31 ], [ %"88", %main_bb33 ], [ %"78", %main_bb32 ], !dbg !141
  %"89" = add nsw i64 %buf.0, %__retres.0.i, !dbg !146
  %"90" = icmp sgt i64 %"89", 2147483647, !dbg !147
  br i1 %"90", label %main_bb34, label %main_bb35, !dbg !147

main_bb34:                                        ; preds = %main_wrap_around.exit2
  %"91" = sub nsw i64 %"89", 2147483647, !dbg !148
  %"92" = sub nsw i64 %"91", 1, !dbg !148
  %"93" = srem i64 %"92", 4294967296, !dbg !148
  %"94" = add nsw i64 -2147483648, %"93", !dbg !148
  br label %main_wrap_around.exit, !dbg !148

main_bb35:                                        ; preds = %main_wrap_around.exit2
  %"95" = icmp slt i64 %"89", -2147483648, !dbg !149
  br i1 %"95", label %main_bb36, label %main_wrap_around.exit, !dbg !149

main_bb36:                                        ; preds = %main_bb35
  %"96" = sub nsw i64 -2147483648, %"89", !dbg !150
  %"97" = sub nsw i64 %"96", 1, !dbg !150
  %"98" = srem i64 %"97", 4294967296, !dbg !150
  %"99" = sub nsw i64 2147483647, %"98", !dbg !150
  br label %main_wrap_around.exit, !dbg !150

main_bb37:                                        ; preds = %main_wrap_around.exit, %main_bb25, %main_wrap_around.exit4, %main_bb20
  ret void, !dbg !151
}
...
!120 = metadata !{i32 22, i32 3, metadata !96, metadata !121}
!121 = metadata !{i32 59, i32 11, metadata !122, null}
!122 = metadata !{i32 786443, metadata !1, metadata !12, i32 58, i32 21, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!123 = metadata !{i32 34, i32 16, metadata !53, metadata !121}
...
!128 = metadata !{i32 60, i32 9, metadata !129, null}
!129 = metadata !{i32 786443, metadata !1, metadata !122, i32 60, i32 9, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!130 = metadata !{i32 61, i32 11, metadata !131, null}
!131 = metadata !{i32 786443, metadata !1, metadata !132, i32 61, i32 11, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!132 = metadata !{i32 786443, metadata !1, metadata !129, i32 60, i32 19, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!133 = metadata !{i32 64, i32 18, metadata !134, null}
!134 = metadata !{i32 786443, metadata !1, metadata !131, i32 61, i32 21, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!135 = metadata !{i32 10, i32 9, metadata !30, metadata !133}
!136 = metadata !{i32 11, i32 9, metadata !32, metadata !133}
!137 = metadata !{i32 13, i32 14, metadata !34, metadata !133}
!138 = metadata !{i32 14, i32 9, metadata !36, metadata !133}
!139 = metadata !{i32 65, i32 13, metadata !140, null}
!140 = metadata !{i32 786443, metadata !1, metadata !134, i32 65, i32 13, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!141 = metadata !{i32 72, i32 13, metadata !122, null}
...
!146 = metadata !{i32 73, i32 11, metadata !122, null}
...
!151 = metadata !{i32 75, i32 17, metadata !12, null}
