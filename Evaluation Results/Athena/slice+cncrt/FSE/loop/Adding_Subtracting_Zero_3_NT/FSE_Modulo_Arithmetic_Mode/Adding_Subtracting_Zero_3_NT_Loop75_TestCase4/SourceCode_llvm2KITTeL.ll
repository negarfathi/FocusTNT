...
read_slice_1_wrap_around.exit:                    ; preds = %read_slice_1_bb11, %read_slice_1_bb10, %read_slice_1_bb9, %read_slice_1_bb7
  %num.0 = phi i64 [ -200, %read_slice_1_bb7 ], [ %"22", %read_slice_1_bb9 ], [ %"27", %read_slice_1_bb11 ], [ %"17", %read_slice_1_bb10 ]
...
main_bb21:
  ...
  %"52" = icmp sle i64 8, 0, !dbg !89
  %"53" = icmp sgt i64 8, 65536, !dbg !91
  %or.cond = or i1 %"52", %"53", !dbg !89
  br i1 %or.cond, label %main_bb42, label %main_bb22, !dbg !89
...
main_bb22:                                        ; preds = %main_bb21
  ...
  call void @llvm.dbg.value(metadata !{i64 %"92"}, i64 0, metadata !116), !dbg !120
  ...
  call void @llvm.dbg.value(metadata !{i64 %.0.i3}, i64 0, metadata !87), !dbg !88
  call void @llvm.dbg.value(metadata !{i64 %"104"}, i64 0, metadata !127), !dbg !129
  call void @llvm.dbg.value(metadata !97, i64 0, metadata !130), !dbg !131
  call void @llvm.dbg.value(metadata !100, i64 0, metadata !132), !dbg !133
  call void @llvm.dbg.value(metadata !103, i64 0, metadata !134), !dbg !135
  br label %main_wrap_around.exit2, !dbg !136

main_wrap_around.exit2:                           ; preds = %main_bb41, %main_bb40, %main_bb39, %main_wrap_around.exit4, %main_bb22
  %__fc_errno_0.0 = phi i64 [ 0, %main_bb22 ], [ %.0.i3, %main_wrap_around.exit4 ], [ %__fc_errno_0.0, %main_bb39 ], [ %__fc_errno_0.0, %main_bb40 ], [ %__fc_errno_0.0, %main_bb41 ]
  %pos.0 = phi i64 [ 0, %main_bb22 ], [ %pos.0, %main_wrap_around.exit4 ], [ %"109", %main_bb39 ], [ %"114", %main_bb41 ], [ %"104", %main_bb40 ]
  %"55" = icmp slt i64 %pos.0, 8, !dbg !137
  br i1 %"55", label %main_bb23, label %main_bb42, !dbg !137

main_bb23:                                        ; preds = %main_wrap_around.exit2
  %"56" = sub nsw i64 8, %pos.0, !dbg !94
  %"57" = icmp sgt i64 %"56", 2147483647, !dbg !139
  br i1 %"57", label %main_bb24, label %main_bb25, !dbg !139

main_bb24:                                        ; preds = %main_bb23
  %"58" = sub nsw i64 %"56", 2147483647, !dbg !140
  %"59" = sub nsw i64 %"58", 1, !dbg !140
  %"60" = srem i64 %"59", 4294967296, !dbg !140
  %"61" = add nsw i64 -2147483648, %"60", !dbg !140
  br label %main_wrap_around.exit, !dbg !140

main_bb25:                                        ; preds = %main_bb23
  %"62" = icmp slt i64 %"56", -2147483648, !dbg !141
  br i1 %"62", label %main_bb26, label %main_wrap_around.exit, !dbg !141

main_bb26:                                        ; preds = %main_bb25
  %"63" = sub nsw i64 -2147483648, %"56", !dbg !142
  %"64" = sub nsw i64 %"63", 1, !dbg !142
  %"65" = srem i64 %"64", 4294967296, !dbg !142
  %"66" = sub nsw i64 2147483647, %"65", !dbg !142
...
main_wrap_around.exit2.i:                         ; preds = %main_bb33, %main_bb32, %main_bb31, %main_wrap_around.exit
  ...
  %.0.i5 = phi i64 [ %pos.0, %main_wrap_around.exit ], [ %"85", %main_bb31 ], [ %"90", %main_bb33 ], [ %"80", %main_bb32 ], !dbg !107
  %"68" = icmp slt i64 %.0.i5, %.0.i, !dbg !143
  br i1 %"68", label %main_bb27, label %main_read_slice_1.exit, !dbg !143

main_bb27:                                        ; preds = %main_wrap_around.exit2.i
  %"69" = add nsw i64 %count.0.i, 1, !dbg !144
  %"70" = icmp sgt i64 %"69", 2147483647, !dbg !145
  br i1 %"70", label %main_bb28, label %main_bb29, !dbg !145

main_bb28:                                        ; preds = %main_bb27
  %"71" = sub nsw i64 %"69", 2147483647, !dbg !146
  %"72" = sub nsw i64 %"71", 1, !dbg !146
  %"73" = srem i64 %"72", 4294967296, !dbg !146
  %"74" = add nsw i64 -2147483648, %"73", !dbg !146
  br label %main_wrap_around.exit4.i, !dbg !146

main_bb29:                                        ; preds = %main_bb27
  %"75" = icmp slt i64 %"69", -2147483648, !dbg !147
  br i1 %"75", label %main_bb30, label %main_wrap_around.exit4.i, !dbg !147

main_bb30:                                        ; preds = %main_bb29
  %"76" = sub nsw i64 -2147483648, %"69", !dbg !148
  %"77" = sub nsw i64 %"76", 1, !dbg !148
  %"78" = srem i64 %"77", 4294967296, !dbg !148
  %"79" = sub nsw i64 2147483647, %"78", !dbg !148
  br label %main_wrap_around.exit4.i, !dbg !148

main_wrap_around.exit4.i:                         ; preds = %main_bb30, %main_bb29, %main_bb28
  %.0.i3.i = phi i64 [ %"74", %main_bb28 ], [ %"79", %main_bb30 ], [ %"69", %main_bb29 ], !dbg !144
  %"80" = add nsw i64 %.0.i5, 1, !dbg !149
  %"81" = icmp sgt i64 %"80", 2147483647, !dbg !150
  br i1 %"81", label %main_bb31, label %main_bb32, !dbg !150

main_bb31:                                        ; preds = %main_wrap_around.exit4.i
  %"82" = sub nsw i64 %"80", 2147483647, !dbg !151
  %"83" = sub nsw i64 %"82", 1, !dbg !151
  %"84" = srem i64 %"83", 4294967296, !dbg !151
  %"85" = add nsw i64 -2147483648, %"84", !dbg !151
  br label %main_wrap_around.exit2.i, !dbg !151

main_bb32:                                        ; preds = %main_wrap_around.exit4.i
  %"86" = icmp slt i64 %"80", -2147483648, !dbg !152
  br i1 %"86", label %main_bb33, label %main_wrap_around.exit2.i, !dbg !152

main_bb33:                                        ; preds = %main_bb32
  %"87" = sub nsw i64 -2147483648, %"80", !dbg !153
  %"88" = sub nsw i64 %"87", 1, !dbg !153
  %"89" = srem i64 %"88", 4294967296, !dbg !153
  %"90" = sub nsw i64 2147483647, %"89", !dbg !153
...
main_read_slice_1.exit:                           ; preds = %main_wrap_around.exit, %main_wrap_around.exit2.i
  ...
  %"91" = icmp eq i64 %__retres.0.i, -1, !dbg !154
  br i1 %"91", label %main_bb34, label %main_bb38, !dbg !154

main_bb34:                                        ; preds = %main_read_slice_1.exit
  %"92" = add nsw i64 %__fc_errno_0.0, 1, !dbg !117
  %"93" = icmp sgt i64 %"92", 2147483647, !dbg !155
  br i1 %"93", label %main_bb35, label %main_bb36, !dbg !155
...
main_bb35:                                        ; preds = %main_bb34
  ...
  br label %main_wrap_around.exit4, !dbg !156

main_bb36:                                        ; preds = %main_bb34
  %"98" = icmp slt i64 %"92", -2147483648, !dbg !157
  br i1 %"98", label %main_bb37, label %main_wrap_around.exit4, !dbg !157
...
main_bb37:                                        ; preds = %main_bb36
  ...
  br label %main_wrap_around.exit4, !dbg !158

main_wrap_around.exit4:                           ; preds = %main_bb35, %main_bb36, %main_bb37
  %.0.i3 = phi i64 [ %"97", %main_bb35 ], [ %"102", %main_bb37 ], [ %"92", %main_bb36 ], !dbg !117
  %"103" = icmp eq i64 %.0.i3, 5, !dbg !159
  br i1 %"103", label %main_bb42, label %main_wrap_around.exit2, !dbg !159

main_bb38:                                        ; preds = %main_read_slice_1.exit
  %"104" = add nsw i64 %pos.0, %__retres.0.i, !dbg !128
  %"105" = icmp sgt i64 %"104", 2147483647, !dbg !161
  br i1 %"105", label %main_bb39, label %main_bb40, !dbg !161

main_bb39:                                        ; preds = %main_bb38
  %"106" = sub nsw i64 %"104", 2147483647, !dbg !162
  %"107" = sub nsw i64 %"106", 1, !dbg !162
  %"108" = srem i64 %"107", 4294967296, !dbg !162
  %"109" = add nsw i64 -2147483648, %"108", !dbg !162
  br label %main_wrap_around.exit2, !dbg !162

main_bb40:                                        ; preds = %main_bb38
  %"110" = icmp slt i64 %"104", -2147483648, !dbg !163
  br i1 %"110", label %main_bb41, label %main_wrap_around.exit2, !dbg !163

main_bb41:                                        ; preds = %main_bb40
  %"111" = sub nsw i64 -2147483648, %"104", !dbg !164
  %"112" = sub nsw i64 %"111", 1, !dbg !164
  %"113" = srem i64 %"112", 4294967296, !dbg !164
  %"114" = sub nsw i64 2147483647, %"113", !dbg !164
  br label %main_wrap_around.exit2, !dbg !164

main_bb42:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit4, %main_bb21
  ret void, !dbg !165
}
...
!128 = metadata !{i32 80, i32 11, metadata !95, null}
!129 = metadata !{i32 8, i32 33, metadata !4, metadata !128} ; [ DW_TAG_imported_declaration ]
!130 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !128} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!131 = metadata !{i32 8, i32 50, metadata !4, metadata !128} ; [ DW_TAG_imported_declaration ]
!132 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !128} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!133 = metadata !{i32 8, i32 73, metadata !4, metadata !128} ; [ DW_TAG_imported_declaration ]
!134 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !128} ; [ DW_TAG_auto_variable ] [range] [line 9]
!135 = metadata !{i32 9, i32 15, metadata !4, metadata !128}
!136 = metadata !{i32 70, i32 3, metadata !12, null}
!137 = metadata !{i32 70, i32 3, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !12, i32 70, i32 3, i32 1, i32 25} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!139 = metadata !{i32 10, i32 9, metadata !30, metadata !94}
!140 = metadata !{i32 11, i32 9, metadata !32, metadata !94}
!141 = metadata !{i32 13, i32 14, metadata !34, metadata !94}
!142 = metadata !{i32 14, i32 9, metadata !36, metadata !94}
!143 = metadata !{i32 26, i32 3, metadata !48, metadata !107}
!144 = metadata !{i32 38, i32 16, metadata !54, metadata !107}
...
!149 = metadata !{i32 40, i32 10, metadata !70, metadata !107}
!150 = metadata !{i32 10, i32 9, metadata !30, metadata !149}
!151 = metadata !{i32 11, i32 9, metadata !32, metadata !149}
!152 = metadata !{i32 13, i32 14, metadata !34, metadata !149}
!153 = metadata !{i32 14, i32 9, metadata !36, metadata !149}
!154 = metadata !{i32 72, i32 9, metadata !119, null}
!155 = metadata !{i32 10, i32 9, metadata !30, metadata !117}
!156 = metadata !{i32 11, i32 9, metadata !32, metadata !117}
!157 = metadata !{i32 13, i32 14, metadata !34, metadata !117}
!158 = metadata !{i32 14, i32 9, metadata !36, metadata !117}
!159 = metadata !{i32 74, i32 11, metadata !160, null}
!160 = metadata !{i32 786443, metadata !1, metadata !118, i32 74, i32 11, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!161 = metadata !{i32 10, i32 9, metadata !30, metadata !128}
!162 = metadata !{i32 11, i32 9, metadata !32, metadata !128}
!163 = metadata !{i32 13, i32 14, metadata !34, metadata !128}
!164 = metadata !{i32 14, i32 9, metadata !36, metadata !128}
!165 = metadata !{i32 82, i32 17, metadata !12, null}
