...
main_bb21:
  ...
  %"52" = icmp sle i64 10, 0, !dbg !89
  %"53" = icmp sgt i64 10, 65536, !dbg !91
  %or.cond6 = or i1 %"52", %"53", !dbg !89
  br i1 %or.cond6, label %main_bb35, label %main_bb22, !dbg !89
...
main_bb22:                                        ; preds = %main_bb21
  ...
  call void @llvm.dbg.value(metadata !{i64 %"70"}, i64 0, metadata !116), !dbg !120
  ...
  call void @llvm.dbg.value(metadata !{i64 %"82"}, i64 0, metadata !127), !dbg !129
...
main_wrap_around.exit2:                           ; preds = %main_bb34, %main_bb33, %main_bb32, %main_wrap_around.exit4, %main_bb22
  %__fc_errno_0.0 = phi i64 [ 0, %main_bb22 ], [ %.0.i3, %main_wrap_around.exit4 ], [ %__fc_errno_0.0, %main_bb32 ], [ %__fc_errno_0.0, %main_bb33 ], [ %__fc_errno_0.0, %main_bb34 ]
  %pos.0 = phi i64 [ 0, %main_bb22 ], [ %pos.0, %main_wrap_around.exit4 ], [ %"87", %main_bb32 ], [ %"92", %main_bb34 ], [ %"82", %main_bb33 ]
  %"55" = icmp slt i64 %pos.0, 10, !dbg !137
  br i1 %"55", label %main_bb23, label %main_bb35, !dbg !137

main_bb23:                                        ; preds = %main_wrap_around.exit2
  %"56" = sub nsw i64 10, %pos.0, !dbg !94
...
main_wrap_around.exit:                            ; preds = %main_bb24, %main_bb25, %main_bb26
  ...
  %"67" = icmp ne i64 %"54", 1, !dbg !113
  %"68" = icmp slt i64 %pos.0, %.0.i, !dbg !143
  %or.cond = and i1 %"67", %"68", !dbg !113
  %__retres.0.i = select i1 %or.cond, i64 -1, i64 0, !dbg !113
  %"69" = icmp eq i64 %__retres.0.i, -1, !dbg !144
  br i1 %"69", label %main_bb27, label %main_bb31, !dbg !144

main_bb27:                                        ; preds = %main_wrap_around.exit
  %"70" = add nsw i64 %__fc_errno_0.0, 1, !dbg !117
  %"71" = icmp sgt i64 %"70", 2147483647, !dbg !145
  br i1 %"71", label %main_bb28, label %main_bb29, !dbg !145

main_bb28:                                        ; preds = %main_bb27
  %"72" = sub nsw i64 %"70", 2147483647, !dbg !146
  %"73" = sub nsw i64 %"72", 1, !dbg !146
  %"74" = srem i64 %"73", 4294967296, !dbg !146
  %"75" = add nsw i64 -2147483648, %"74", !dbg !146
  br label %main_wrap_around.exit4, !dbg !146

main_bb29:                                        ; preds = %main_bb27
  %"76" = icmp slt i64 %"70", -2147483648, !dbg !147
  br i1 %"76", label %main_bb30, label %main_wrap_around.exit4, !dbg !147

main_bb30:                                        ; preds = %main_bb29
  %"77" = sub nsw i64 -2147483648, %"70", !dbg !148
  %"78" = sub nsw i64 %"77", 1, !dbg !148
  %"79" = srem i64 %"78", 4294967296, !dbg !148
  %"80" = sub nsw i64 2147483647, %"79", !dbg !148
  br label %main_wrap_around.exit4, !dbg !148

main_wrap_around.exit4:                           ; preds = %main_bb28, %main_bb29, %main_bb30
  %.0.i3 = phi i64 [ %"75", %main_bb28 ], [ %"80", %main_bb30 ], [ %"70", %main_bb29 ], !dbg !117
  %"81" = icmp eq i64 %.0.i3, 5, !dbg !149
  br i1 %"81", label %main_bb35, label %main_wrap_around.exit2, !dbg !149

main_bb31:                                        ; preds = %main_wrap_around.exit
  %"82" = add nsw i64 %pos.0, %__retres.0.i, !dbg !128
  %"83" = icmp sgt i64 %"82", 2147483647, !dbg !151
  br i1 %"83", label %main_bb32, label %main_bb33, !dbg !151

main_bb32:                                        ; preds = %main_bb31
  %"84" = sub nsw i64 %"82", 2147483647, !dbg !152
  %"85" = sub nsw i64 %"84", 1, !dbg !152
  %"86" = srem i64 %"85", 4294967296, !dbg !152
  %"87" = add nsw i64 -2147483648, %"86", !dbg !152
  br label %main_wrap_around.exit2, !dbg !152

main_bb33:                                        ; preds = %main_bb31
  %"88" = icmp slt i64 %"82", -2147483648, !dbg !153
  br i1 %"88", label %main_bb34, label %main_wrap_around.exit2, !dbg !153

main_bb34:                                        ; preds = %main_bb33
  %"89" = sub nsw i64 -2147483648, %"82", !dbg !154
  %"90" = sub nsw i64 %"89", 1, !dbg !154
  %"91" = srem i64 %"90", 4294967296, !dbg !154
  %"92" = sub nsw i64 2147483647, %"91", !dbg !154
...
!144 = metadata !{i32 72, i32 9, metadata !119, null}
!145 = metadata !{i32 10, i32 9, metadata !30, metadata !117}
!146 = metadata !{i32 11, i32 9, metadata !32, metadata !117}
!147 = metadata !{i32 13, i32 14, metadata !34, metadata !117}
!148 = metadata !{i32 14, i32 9, metadata !36, metadata !117}
!149 = metadata !{i32 74, i32 11, metadata !150, null}
!150 = metadata !{i32 786443, metadata !1, metadata !118, i32 74, i32 11, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!151 = metadata !{i32 10, i32 9, metadata !30, metadata !128}
!152 = metadata !{i32 11, i32 9, metadata !32, metadata !128}
!153 = metadata !{i32 13, i32 14, metadata !34, metadata !128}
!154 = metadata !{i32 14, i32 9, metadata !36, metadata !128}
!155 = metadata !{i32 82, i32 17, metadata !12, null}
