...
main_bb0:
  ...
  call void @llvm.dbg.value(metadata !{i8 %"2"}, i64 0, metadata !18), !dbg !21
...
main_bb1:                                         ; preds = %main_bb2, %main_bb3, %main_bb0
  %l.0 = phi i8 [ -96, %main_bb0 ], [ %"7", %main_bb3 ], [ %"2", %main_bb2 ]
  %"0" = zext i8 %l.0 to i32, !dbg !23
  %"1" = sub nsw i32 %"0", 1, !dbg !23
  %"2" = trunc i32 %"1" to i8, !dbg !23
  %"3" = icmp ne i8 %l.0, 0, !dbg !24
  br i1 %"3", label %main_bb2, label %main_bb4, !dbg !24

main_bb2:                                         ; preds = %main_bb1
  %"4" = icmp ne i8 %"2", 0, !dbg !26
  br i1 %"4", label %main_bb3, label %main_bb1, !dbg !26

main_bb3:                                         ; preds = %main_bb2
  %"5" = zext i8 %"2" to i32, !dbg !27
  %"6" = sub nsw i32 %"5", 1, !dbg !27
  %"7" = trunc i32 %"6" to i8, !dbg !27
