...
main_mdb_cursor_get_slice_1.exit:
  ...
  call void @llvm.dbg.value(metadata !17, i64 0, metadata !39), !dbg !44
  call void @llvm.dbg.value(metadata !17, i64 0, metadata !45), !dbg !47
...
main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get_slice_1.exit
  ...
  %"9" = icmp eq i32 %., 0, !dbg !49
  br i1 %"9", label %main_bb4, label %main_bb5, !dbg !49

main_bb4:                                         ; preds = %main_bb3
  %"10" = load i32* @"'flag", align 4, !dbg !51
  %"11" = add nsw i32 %"10", 1, !dbg !51
  store i32 %"11", i32* @"'flag", align 4, !dbg !51
  %"12" = load i32* @"'flag", align 4, !dbg !52
...
!40 = metadata !{i32 26, i32 12, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !42, i32 25, i32 28, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 786443, metadata !1, metadata !43, i32 25, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 19, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 9, i32 7, metadata !4, metadata !40}
!45 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 9, metadata !8, i32 0, metadata !46} ; [ DW_TAG_auto_variable ] [i] [line 9]
!46 = metadata !{i32 29, i32 10, metadata !43, null}
!47 = metadata !{i32 9, i32 7, metadata !4, metadata !46}
!48 = metadata !{i32 24, i32 3, metadata !9, null}
!49 = metadata !{i32 24, i32 3, metadata !50, null}
!50 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 3, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 10, i32 3, metadata !4, metadata !40}
!52 = metadata !{i32 11, i32 7, metadata !22, metadata !40}
!53 = metadata !{i32 27, i32 7, metadata !41, null}
!54 = metadata !{i32 31, i32 3, metadata !9, null}
