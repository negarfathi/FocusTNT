...
main_bb15:                                        ; preds = %main_wrap_around.exit, %main_bb14
  ...
  %"31" = icmp slt i64 %b.0, 15, !dbg !125
  br i1 %"31", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb22, !dbg !125

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb15
  %"32" = icmp eq i64 %"30", 1, !dbg !102
  %. = select i1 %"32", i64 0, i64 10, !dbg !102
  %"33" = add nsw i64 %b.0, %., !dbg !106
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !127
  br i1 %"34", label %main_bb16, label %main_bb17, !dbg !127

main_bb16:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"35" = sub nsw i64 %"33", 2147483647, !dbg !128
  %"36" = sub nsw i64 %"35", 1, !dbg !128
  %"37" = srem i64 %"36", 4294967296, !dbg !128
  %"38" = add nsw i64 -2147483648, %"37", !dbg !128
  br label %main_wrap_around.exit2, !dbg !128

main_bb17:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"39" = icmp slt i64 %"33", -2147483648, !dbg !129
  br i1 %"39", label %main_bb18, label %main_wrap_around.exit2, !dbg !129

main_bb18:                                        ; preds = %main_bb17
  %"40" = sub nsw i64 -2147483648, %"33", !dbg !130
  %"41" = sub nsw i64 %"40", 1, !dbg !130
  %"42" = srem i64 %"41", 4294967296, !dbg !130
  %"43" = sub nsw i64 2147483647, %"42", !dbg !130
...
main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb17, %main_bb18
  ...
  %"44" = sub nsw i64 15, 4, !dbg !115
  %"45" = icmp sgt i64 %"44", 2147483647, !dbg !131
  br i1 %"45", label %main_bb19, label %main_bb20, !dbg !131

main_bb19:                                        ; preds = %main_wrap_around.exit2
  %"46" = sub nsw i64 %"44", 2147483647, !dbg !132
  %"47" = sub nsw i64 %"46", 1, !dbg !132
  %"48" = srem i64 %"47", 4294967296, !dbg !132
  %"49" = add nsw i64 -2147483648, %"48", !dbg !132
  br label %main_wrap_around.exit, !dbg !132

main_bb20:                                        ; preds = %main_wrap_around.exit2
  %"50" = icmp slt i64 %"44", -2147483648, !dbg !133
  br i1 %"50", label %main_bb21, label %main_wrap_around.exit, !dbg !133

main_bb21:                                        ; preds = %main_bb20
  %"51" = sub nsw i64 -2147483648, %"44", !dbg !134
  %"52" = sub nsw i64 %"51", 1, !dbg !134
  %"53" = srem i64 %"52", 4294967296, !dbg !134
  %"54" = sub nsw i64 2147483647, %"53", !dbg !134
...
!126 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 3, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!127 = metadata !{i32 10, i32 9, metadata !30, metadata !106}
!128 = metadata !{i32 11, i32 9, metadata !32, metadata !106}
!129 = metadata !{i32 13, i32 14, metadata !34, metadata !106}
!130 = metadata !{i32 14, i32 9, metadata !36, metadata !106}
!131 = metadata !{i32 10, i32 9, metadata !30, metadata !115}
!132 = metadata !{i32 11, i32 9, metadata !32, metadata !115}
!133 = metadata !{i32 13, i32 14, metadata !34, metadata !115}
!134 = metadata !{i32 14, i32 9, metadata !36, metadata !115}
!135 = metadata !{i32 62, i32 17, metadata !12, null}
