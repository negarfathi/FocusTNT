...
main_bb14:                                        ; preds = %main_bb13, %main_wrap_around.exit
  ...
  br i1 %"30", label %main_bb15, label %main_bb23, !dbg !88
...
main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb15, %main_bb16
  %"33" = add nsw i64 %b.0, 0, !dbg !95
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !96
  br i1 %"34", label %main_bb17, label %main_bb18, !dbg !96

main_bb17:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"35" = sub nsw i64 %"33", 2147483647, !dbg !97
...
main_bb18:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"39" = icmp slt i64 %"33", -2147483648, !dbg !98
  br i1 %"39", label %main_bb19, label %main_wrap_around.exit2, !dbg !98

main_bb19:                                        ; preds = %main_bb18
  %"40" = sub nsw i64 -2147483648, %"33", !dbg !99
...
main_wrap_around.exit2:                           ; preds = %main_bb17, %main_bb18, %main_bb19
  ...
  %"44" = sub nsw i64 10, 4, !dbg !100
  %"45" = icmp sgt i64 %"44", 2147483647, !dbg !102
  br i1 %"45", label %main_bb20, label %main_bb21, !dbg !102

main_bb20:                                        ; preds = %main_wrap_around.exit2
  %"46" = sub nsw i64 %"44", 2147483647, !dbg !103
  %"47" = sub nsw i64 %"46", 1, !dbg !103
  %"48" = srem i64 %"47", 4294967296, !dbg !103
  %"49" = add nsw i64 -2147483648, %"48", !dbg !103
  br label %main_wrap_around.exit, !dbg !103

main_bb21:                                        ; preds = %main_wrap_around.exit2
  %"50" = icmp slt i64 %"44", -2147483648, !dbg !104
  br i1 %"50", label %main_bb22, label %main_wrap_around.exit, !dbg !104

main_bb22:                                        ; preds = %main_bb21
  %"51" = sub nsw i64 -2147483648, %"44", !dbg !105
  %"52" = sub nsw i64 %"51", 1, !dbg !105
  %"53" = srem i64 %"52", 4294967296, !dbg !105
  %"54" = sub nsw i64 2147483647, %"53", !dbg !105
  br label %main_wrap_around.exit, !dbg !105

main_wrap_around.exit:                            ; preds = %main_bb20, %main_bb21, %main_bb22
  %.0.i = phi i64 [ %"49", %main_bb20 ], [ %"54", %main_bb22 ], [ %"44", %main_bb21 ], !dbg !100
  %"55" = icmp sge i64 %.0.i1, %.0.i, !dbg !100
  br i1 %"55", label %main_bb23, label %main_bb14, !dbg !100
...
!89 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 3, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!95 = metadata !{i32 55, i32 9, metadata !92, null}
!96 = metadata !{i32 10, i32 9, metadata !30, metadata !95}
!97 = metadata !{i32 11, i32 9, metadata !32, metadata !95}
!98 = metadata !{i32 13, i32 14, metadata !34, metadata !95}
!99 = metadata !{i32 14, i32 9, metadata !36, metadata !95}
!100 = metadata !{i32 56, i32 14, metadata !101, null}
!101 = metadata !{i32 786443, metadata !1, metadata !92, i32 56, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!102 = metadata !{i32 10, i32 9, metadata !30, metadata !100}
!103 = metadata !{i32 11, i32 9, metadata !32, metadata !100}
!104 = metadata !{i32 13, i32 14, metadata !34, metadata !100}
!105 = metadata !{i32 14, i32 9, metadata !36, metadata !100}
!106 = metadata !{i32 62, i32 17, metadata !12, null}
