...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !39), !dbg !41
  call void @llvm.dbg.value(metadata !{i64 %"20"}, i64 0, metadata !34), !dbg !35
  br label %main_bb6, !dbg !42

main_bb6:                                         ; preds = %main_bb7, %main_bb5
  %l.0 = phi i64 [ 2147483647, %main_bb5 ], [ %"20", %main_bb7 ]
  %"12" = trunc i64 %l.0 to i32, !dbg !43
  %"13" = sub nsw i32 %"12", 1, !dbg !43
  %"14" = trunc i32 %"13" to i8, !dbg !43
  %"15" = zext i8 %"14" to i64, !dbg !43
  %"16" = icmp ne i64 %l.0, 0, !dbg !44
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !44

main_bb7:                                         ; preds = %main_bb6
  %"17" = trunc i64 %"15" to i32, !dbg !46
  %"18" = sub nsw i32 %"17", 1, !dbg !46
  %"19" = trunc i32 %"18" to i8, !dbg !46
  %"20" = zext i8 %"19" to i64, !dbg !46
