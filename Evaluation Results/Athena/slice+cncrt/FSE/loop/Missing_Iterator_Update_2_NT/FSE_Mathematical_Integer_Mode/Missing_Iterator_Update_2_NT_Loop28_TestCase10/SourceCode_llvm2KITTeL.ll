...
main_mdb_cursor_get_slice_1.exit:
  ...
  call void @llvm.dbg.value(metadata !17, i64 0, metadata !40), !dbg !43
...
main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get_slice_1.exit2, %main_mdb_cursor_get_slice_1.exit
  ...
  %"9" = icmp eq i32 %rc.0, 0, !dbg !45
  br i1 %"9", label %main_bb4, label %main_bb5, !dbg !45

main_bb4:                                         ; preds = %main_bb3
  %"10" = icmp sle i32 -10, 0, !dbg !47
  br i1 %"10", label %main_bb3, label %main_mdb_cursor_get_slice_1.exit2, !dbg !47

main_mdb_cursor_get_slice_1.exit2:                ; preds = %main_bb4
  %"11" = load i32* @"'flag", align 4, !dbg !49
  %"12" = add nsw i32 %"11", 1, !dbg !49
  store i32 %"12", i32* @"'flag", align 4, !dbg !49
  %"13" = load i32* @"'flag", align 4, !dbg !50
  %"14" = icmp sgt i32 %"13", 1000, !dbg !50
  %.3 = select i1 %"14", i32 1, i32 0, !dbg !50
...
!41 = metadata !{i32 26, i32 10, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 19, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 9, i32 7, metadata !4, metadata !41}
!44 = metadata !{i32 24, i32 3, metadata !9, null}
!45 = metadata !{i32 24, i32 3, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 3, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 25, i32 9, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !42, i32 25, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 10, i32 3, metadata !4, metadata !41}
!50 = metadata !{i32 11, i32 7, metadata !22, metadata !41}
!51 = metadata !{i32 27, i32 3, metadata !42, null}
!52 = metadata !{i32 28, i32 3, metadata !9, null}
