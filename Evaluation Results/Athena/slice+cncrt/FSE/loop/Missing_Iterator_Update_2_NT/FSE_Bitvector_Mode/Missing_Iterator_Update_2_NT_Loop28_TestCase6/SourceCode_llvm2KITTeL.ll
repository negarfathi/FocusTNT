...
main_mdb_cursor_get_slice_1.exit:
  ...
  call void @llvm.dbg.value(metadata !17, i64 0, metadata !39), !dbg !42
  call void @llvm.dbg.value(metadata !{i32 %.3}, i64 0, metadata !35), !dbg !36
  br label %main_bb3, !dbg !43

main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get_slice_1.exit2, %main_mdb_cursor_get_slice_1.exit
  %rc.0 = phi i32 [ %., %main_mdb_cursor_get_slice_1.exit ], [ %.3, %main_mdb_cursor_get_slice_1.exit2 ], [ %rc.0, %main_bb4 ]
  %"9" = icmp eq i32 %rc.0, 0, !dbg !44
  br i1 %"9", label %main_bb4, label %main_bb5, !dbg !44

main_bb4:                                         ; preds = %main_bb3
  %"10" = icmp sle i32 0, 0, !dbg !46
  br i1 %"10", label %main_bb3, label %main_mdb_cursor_get_slice_1.exit2, !dbg !46

main_mdb_cursor_get_slice_1.exit2:                ; preds = %main_bb4
  %"11" = load i32* @"'flag", align 4, !dbg !48
  %"12" = add nsw i32 %"11", 1, !dbg !48
  store i32 %"12", i32* @"'flag", align 4, !dbg !48
  %"13" = load i32* @"'flag", align 4, !dbg !49
  %"14" = icmp sgt i32 %"13", 1000, !dbg !49
  %.3 = select i1 %"14", i32 1, i32 0, !dbg !49
...
!37 = metadata !{i32 786688, metadata !9, metadata !"dval_mv_size", metadata !5, i32 23, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [dval_mv_size] [line 23]
!38 = metadata !{i32 23, i32 7, metadata !9, null}
!39 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 9, metadata !8, i32 0, metadata !40} ; [ DW_TAG_auto_variable ] [i] [line 9]
!40 = metadata !{i32 26, i32 10, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 19, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 9, i32 7, metadata !4, metadata !40}
!43 = metadata !{i32 24, i32 3, metadata !9, null}
!44 = metadata !{i32 24, i32 3, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 3, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 25, i32 9, metadata !47, null}
!47 = metadata !{i32 786443, metadata !1, metadata !41, i32 25, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 10, i32 3, metadata !4, metadata !40}
!49 = metadata !{i32 11, i32 7, metadata !22, metadata !40}
!50 = metadata !{i32 27, i32 3, metadata !41, null}
!51 = metadata !{i32 28, i32 3, metadata !9, null}
