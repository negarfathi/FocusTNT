...
main_bb0:
  ...
  %"3" = bitcast i8* %"2" to [10 x i32]*, !dbg !20
  %"4" = getelementptr [10 x i32]* %"3", i32 0, i32 3, !dbg !20
  store i32 5, i32* %"4", !dbg !20
...
main_bb3:                                         ; preds = %main_LeafBlock1, %main_bb1, %main_bb9
  %i_0.0 = phi i32 [ %"22", %main_bb9 ], [ 0, %main_bb1 ], [ %i_0.0, %main_LeafBlock1 ]
  %"7" = icmp slt i32 %i_0.0, 10, !dbg !34
  br i1 %"7", label %main_bb4, label %main_bb10, !dbg !34

main_bb4:                                         ; preds = %main_bb3
  %"8" = sext i32 %i_0.0 to i64, !dbg !36
  %"9" = getelementptr inbounds [10 x i32]* %slots_used, i32 0, i64 %"8", !dbg !36
  %"10" = load i32* %"9", align 4, !dbg !36
...
main_bb5:                                         ; preds = %main_LeafBlock
  %"11" = sext i32 %i_0.0 to i64, !dbg !38
  %"12" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"11", !dbg !38
  %"13" = load i32* %"12", align 4, !dbg !38
  %"14" = icmp ne i32 %"13", 0, !dbg !38
  br i1 %"14", label %main_bb6, label %main_bb10, !dbg !38

main_bb6:                                         ; preds = %main_bb5
  %"15" = sext i32 %i_0.0 to i64, !dbg !41
  %"16" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"15", !dbg !41
  %"17" = load i32* %"16", align 4, !dbg !41
...
main_bb7:                                         ; preds = %main_NewDefault
  %"18" = sext i32 %i_0.0 to i64, !dbg !43
  %"19" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"18", !dbg !43
  %"20" = load i32* %"19", align 4, !dbg !43
  br label %main_bb8, !dbg !44

main_bb8:                                         ; preds = %main_bb7, %main_bb6
  %table.0 = phi i32 [ %"20", %main_bb7 ], [ %"17", %main_bb6 ]
  %"21" = icmp ne i32 %table.0, 0, !dbg !45
  br i1 %"21", label %main_bb10, label %main_bb9, !dbg !45

main_bb9:                                         ; preds = %main_bb8
  %"22" = add nsw i32 %i_0.0, 1, !dbg !47
