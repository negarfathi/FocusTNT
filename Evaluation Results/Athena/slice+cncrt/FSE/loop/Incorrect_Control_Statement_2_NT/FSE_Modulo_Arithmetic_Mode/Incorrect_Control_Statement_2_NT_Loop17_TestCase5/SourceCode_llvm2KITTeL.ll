...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !46), !dbg !49
...
main_bb8:                                         ; preds = %main_bb6
  ...
  br i1 %"24", label %main_bb9, label %main_wrap_around.exit, !dbg !64
