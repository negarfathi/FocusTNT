...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !33, i64 0, metadata !36), !dbg !37
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !38), !dbg !42
...
main_bb6:                                         ; preds = %main_bb7, %main_wrap_around.exit, %main_bb5
  ...
  %"12" = icmp slt i64 %pkt.0, 10, !dbg !53
  br i1 %"12", label %main_bb7, label %main_bb12, !dbg !53

main_bb7:                                         ; preds = %main_wrap_around.exit, %main_bb6
  %pkt.1 = phi i64 [ %pkt.0, %main_bb6 ], [ %.0.i, %main_wrap_around.exit ]
  %"13" = icmp eq i64 0, 0, !dbg !55
  br i1 %"13", label %main_bb8, label %main_bb6, !dbg !55

main_bb8:                                         ; preds = %main_bb7
  %"14" = add nsw i64 %pkt.1, 1, !dbg !39
  %"15" = icmp sgt i64 %"14", 2147483647, !dbg !57
  br i1 %"15", label %main_bb9, label %main_bb10, !dbg !57

main_bb9:                                         ; preds = %main_bb8
  %"16" = sub nsw i64 %"14", 2147483647, !dbg !58
  %"17" = sub nsw i64 %"16", 1, !dbg !58
  %"18" = srem i64 %"17", 4294967296, !dbg !58
  %"19" = add nsw i64 -2147483648, %"18", !dbg !58
  br label %main_wrap_around.exit, !dbg !58

main_bb10:                                        ; preds = %main_bb8
  %"20" = icmp slt i64 %"14", -2147483648, !dbg !59
  br i1 %"20", label %main_bb11, label %main_wrap_around.exit, !dbg !59

main_bb11:                                        ; preds = %main_bb10
  %"21" = sub nsw i64 -2147483648, %"14", !dbg !60
  %"22" = sub nsw i64 %"21", 1, !dbg !60
  %"23" = srem i64 %"22", 4294967296, !dbg !60
  %"24" = sub nsw i64 2147483647, %"23", !dbg !60
  br label %main_wrap_around.exit, !dbg !60

main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb10, %main_bb11
  %.0.i = phi i64 [ %"19", %main_bb9 ], [ %"24", %main_bb11 ], [ %"14", %main_bb10 ], !dbg !39
  %"25" = icmp eq i64 0, 0, !dbg !61
...
!38 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !39} ; [ DW_TAG_arg_variable ] [value] [line 7]
!39 = metadata !{i32 25, i32 14, metadata !40, null}
!40 = metadata !{i32 786443, metadata !1, metadata !41, i32 23, i32 22, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 20, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 7, i32 33, metadata !4, metadata !39}
!43 = metadata !{i64 -2147483648}
!44 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !39} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!45 = metadata !{i32 7, i32 50, metadata !4, metadata !39}
!46 = metadata !{i64 2147483647}
!47 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !39} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!48 = metadata !{i32 7, i32 73, metadata !4, metadata !39}
!49 = metadata !{i64 4294967296}
!50 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !39} ; [ DW_TAG_auto_variable ] [range] [line 8]
!51 = metadata !{i32 8, i32 15, metadata !4, metadata !39} ; [ DW_TAG_imported_declaration ]
!52 = metadata !{i32 21, i32 3, metadata !9, null}
!53 = metadata !{i32 21, i32 3, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 3, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 23, i32 5, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !41, i32 23, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 9, i32 9, metadata !25, metadata !39}
!58 = metadata !{i32 10, i32 9, metadata !27, metadata !39}
!59 = metadata !{i32 12, i32 14, metadata !29, metadata !39}
!60 = metadata !{i32 13, i32 9, metadata !31, metadata !39}
!61 = metadata !{i32 26, i32 11, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !40, i32 26, i32 11, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 33, i32 3, metadata !9, null}
