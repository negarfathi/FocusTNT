...
main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  %pkt.0 = phi i64 [ 11, %main_bb5 ], [ %pkt.1, %main_wrap_around.exit ]
  %res.0 = phi i64 [ 0, %main_bb5 ], [ %res.1, %main_wrap_around.exit ]
  %"12" = icmp slt i64 %pkt.0, 10, !dbg !55
  br i1 %"12", label %main_wrap_around.exit, label %main_bb11, !dbg !55

main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  %pkt.1 = phi i64 [ %pkt.0, %main_bb6 ], [ %"19", %main_bb8 ], [ %"24", %main_bb10 ], [ %"14", %main_bb9 ]
  %res.1 = phi i64 [ %res.0, %main_bb6 ], [ 7, %main_bb8 ], [ 7, %main_bb9 ], [ 7, %main_bb10 ]
  %"13" = icmp eq i64 %res.1, 0, !dbg !57
  br i1 %"13", label %main_bb7, label %main_bb6, !dbg !57

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"14" = add nsw i64 %pkt.1, 1, !dbg !41
  %"15" = icmp sgt i64 %"14", 2147483647, !dbg !59
  br i1 %"15", label %main_bb8, label %main_bb9, !dbg !59
...
main_bb9:                                         ; preds = %main_bb7
  ...
  br i1 %"20", label %main_bb10, label %main_wrap_around.exit, !dbg !61
...
!33 = metadata !{i64 0}
!34 = metadata !{i32 786688, metadata !9, metadata !"res", metadata !5, i32 19, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [res] [line 19]
!35 = metadata !{i32 19, i32 13, metadata !9, null}
!36 = metadata !{i64 11}
!37 = metadata !{i32 786688, metadata !9, metadata !"pkt", metadata !5, i32 20, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [pkt] [line 20]
...
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 1, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!56 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 3, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 23, i32 5, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !43, i32 23, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!63 = metadata !{i32 28, i32 3, metadata !9, null}
