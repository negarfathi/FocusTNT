...
main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  %nfds.0 = phi i64 [ 2, %main_bb5 ], [ %..0.i, %main_wrap_around.exit ]
  %"12" = icmp sle i64 %nfds.0, 200, !dbg !56
...
main_wrap_around.exit:                            ; preds = %main_bb8, %main_bb9, %main_bb10
  ...
  %"24" = icmp sgt i64 %.0.i, 100, !dbg !62
  %..0.i = select i1 %"24", i64 100, i64 %.0.i, !dbg !62
