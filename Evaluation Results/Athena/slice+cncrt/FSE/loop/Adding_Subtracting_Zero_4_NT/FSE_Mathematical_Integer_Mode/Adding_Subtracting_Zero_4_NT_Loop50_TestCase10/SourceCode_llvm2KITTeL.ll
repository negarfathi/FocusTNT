...
main_bb7:
  ...
  %"10" = icmp sle i32 995, 0, !dbg !52
  br i1 %"10", label %main_bb12, label %main_bb8, !dbg !52

main_bb8:                                         ; preds = %main_bb7, %main_bb11
  %buf.0 = phi i32 [ %"17", %main_bb11 ], [ 0, %main_bb7 ]
  %count.0 = phi i32 [ %"16", %main_bb11 ], [ 995, %main_bb7 ]
  %"11" = icmp sgt i32 %count.0, 0, !dbg !54
  br i1 %"11", label %main_bb9, label %main_bb12, !dbg !54
...
main_read_slice_1.exit:                           ; preds = %main_bb9, %main_bb10
  ...
  %"15" = icmp slt i32 %__retres.0.i, 0, !dbg !62
  br i1 %"15", label %main_bb12, label %main_bb11, !dbg !62

main_bb11:                                        ; preds = %main_read_slice_1.exit
  %"16" = sub nsw i32 %count.0, %__retres.0.i, !dbg !64
  %"17" = add nsw i32 %buf.0, %__retres.0.i, !dbg !65
  br label %main_bb8, !dbg !66

main_bb12:                                        ; preds = %main_bb8, %main_read_slice_1.exit, %main_bb7
  ret void, !dbg !67
}
...
!54 = metadata !{i32 48, i32 3, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !9, i32 48, i32 3, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!62 = metadata !{i32 50, i32 9, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !58, i32 50, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 54, i32 5, metadata !58, null}
!65 = metadata !{i32 55, i32 5, metadata !58, null}
!66 = metadata !{i32 56, i32 3, metadata !58, null}
!67 = metadata !{i32 57, i32 17, metadata !9, null}
