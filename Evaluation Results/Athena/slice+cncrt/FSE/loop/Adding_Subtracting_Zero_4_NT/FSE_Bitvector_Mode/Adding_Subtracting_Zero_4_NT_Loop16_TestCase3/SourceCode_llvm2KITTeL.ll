...
main_bb7:                                         ; preds = %main_bb6, %main_bb10
  %buf.0 = phi i32 [ %"15", %main_bb10 ], [ 0, %main_bb6 ]
  %count.0 = phi i32 [ %"14", %main_bb10 ], [ 3, %main_bb6 ]
  %"9" = icmp sgt i32 %count.0, 0, !dbg !51
  br i1 %"9", label %main_bb8, label %main_bb11, !dbg !51
...
main_read_slice_1.exit:                           ; preds = %main_bb8
  ...
  %"13" = icmp slt i32 %count.0.i, 0, !dbg !61
  br i1 %"13", label %main_bb11, label %main_bb10, !dbg !61

main_bb10:                                        ; preds = %main_read_slice_1.exit
  %"14" = sub nsw i32 %count.0, %count.0.i, !dbg !63
  call void @llvm.dbg.value(metadata !{i32 %"14"}, i64 0, metadata !47), !dbg !48
  %"15" = add nsw i32 %buf.0, %count.0.i, !dbg !64
  call void @llvm.dbg.value(metadata !{i32 %"15"}, i64 0, metadata !65), !dbg !66
  br label %main_bb7, !dbg !67

main_bb11:                                        ; preds = %main_bb7, %main_read_slice_1.exit, %main_bb6
  ret void, !dbg !68
}
...
!53 = metadata !{i32 40, i32 11, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !9, i32 39, i32 21, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!61 = metadata !{i32 41, i32 9, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !54, i32 41, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 45, i32 5, metadata !54, null}
!64 = metadata !{i32 46, i32 5, metadata !54, null}
!65 = metadata !{i32 786688, metadata !9, metadata !"buf", metadata !5, i32 38, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [buf] [line 38]
!66 = metadata !{i32 38, i32 7, metadata !9, null}
!67 = metadata !{i32 47, i32 3, metadata !54, null}
!68 = metadata !{i32 48, i32 17, metadata !9, null}
