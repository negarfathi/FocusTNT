...
main_bb20:
  ...
  br i1 %"50", label %main_bb32, label %main_wrap_around.exit, !dbg !116

main_wrap_around.exit:                            ; preds = %main_bb31, %main_bb30, %main_bb29, %main_bb20
  %buf.0 = phi i64 [ 0, %main_bb20 ], [ %"81", %main_bb29 ], [ %"86", %main_bb31 ], [ %"76", %main_bb30 ]
  %count.0 = phi i64 [ 995, %main_bb20 ], [ %.0.i1, %main_bb29 ], [ %.0.i1, %main_bb30 ], [ %.0.i1, %main_bb31 ]
  %"51" = icmp sgt i64 %count.0, 0, !dbg !118
  br i1 %"51", label %main_wrap_around.exit2.i, label %main_bb32, !dbg !118
...
main_read_slice_1.exit:                           ; preds = %main_bb22, %main_bb23, %main_bb24, %main_wrap_around.exit2.i
  ...
  %"64" = icmp slt i64 %__retres.0.i, 0, !dbg !128
  br i1 %"64", label %main_bb32, label %main_bb25, !dbg !128

main_bb25:                                        ; preds = %main_read_slice_1.exit
  %"65" = sub nsw i64 %count.0, %__retres.0.i, !dbg !130
  %"66" = icmp sgt i64 %"65", 2147483647, !dbg !131
  br i1 %"66", label %main_bb26, label %main_bb27, !dbg !131

main_bb26:                                        ; preds = %main_bb25
  %"67" = sub nsw i64 %"65", 2147483647, !dbg !132
  %"68" = sub nsw i64 %"67", 1, !dbg !132
  %"69" = srem i64 %"68", 4294967296, !dbg !132
  %"70" = add nsw i64 -2147483648, %"69", !dbg !132
  br label %main_wrap_around.exit2, !dbg !132

main_bb27:                                        ; preds = %main_bb25
  %"71" = icmp slt i64 %"65", -2147483648, !dbg !133
  br i1 %"71", label %main_bb28, label %main_wrap_around.exit2, !dbg !133

main_bb28:                                        ; preds = %main_bb27
  %"72" = sub nsw i64 -2147483648, %"65", !dbg !134
  %"73" = sub nsw i64 %"72", 1, !dbg !134
  %"74" = srem i64 %"73", 4294967296, !dbg !134
  %"75" = sub nsw i64 2147483647, %"74", !dbg !134
  br label %main_wrap_around.exit2, !dbg !134

main_wrap_around.exit2:                           ; preds = %main_bb26, %main_bb27, %main_bb28
  %.0.i1 = phi i64 [ %"70", %main_bb26 ], [ %"75", %main_bb28 ], [ %"65", %main_bb27 ], !dbg !130
  %"76" = add nsw i64 %buf.0, %__retres.0.i, !dbg !135
  %"77" = icmp sgt i64 %"76", 2147483647, !dbg !136
  br i1 %"77", label %main_bb29, label %main_bb30, !dbg !136

main_bb29:                                        ; preds = %main_wrap_around.exit2
  %"78" = sub nsw i64 %"76", 2147483647, !dbg !137
  %"79" = sub nsw i64 %"78", 1, !dbg !137
  %"80" = srem i64 %"79", 4294967296, !dbg !137
  %"81" = add nsw i64 -2147483648, %"80", !dbg !137
  br label %main_wrap_around.exit, !dbg !137

main_bb30:                                        ; preds = %main_wrap_around.exit2
  %"82" = icmp slt i64 %"76", -2147483648, !dbg !138
  br i1 %"82", label %main_bb31, label %main_wrap_around.exit, !dbg !138

main_bb31:                                        ; preds = %main_bb30
  %"83" = sub nsw i64 -2147483648, %"76", !dbg !139
  %"84" = sub nsw i64 %"83", 1, !dbg !139
  %"85" = srem i64 %"84", 4294967296, !dbg !139
  %"86" = sub nsw i64 2147483647, %"85", !dbg !139
  br label %main_wrap_around.exit, !dbg !139

main_bb32:                                        ; preds = %main_wrap_around.exit, %main_read_slice_1.exit, %main_bb20
  ret void, !dbg !140
}
...
!121 = metadata !{i32 58, i32 11, metadata !122, null} ; [ DW_TAG_imported_module ]
!122 = metadata !{i32 786443, metadata !1, metadata !12, i32 57, i32 21, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!128 = metadata !{i32 59, i32 9, metadata !129, null}
!129 = metadata !{i32 786443, metadata !1, metadata !122, i32 59, i32 9, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!130 = metadata !{i32 63, i32 13, metadata !122, null}
...
!135 = metadata !{i32 64, i32 11, metadata !122, null}
...
!140 = metadata !{i32 66, i32 17, metadata !12, null}
