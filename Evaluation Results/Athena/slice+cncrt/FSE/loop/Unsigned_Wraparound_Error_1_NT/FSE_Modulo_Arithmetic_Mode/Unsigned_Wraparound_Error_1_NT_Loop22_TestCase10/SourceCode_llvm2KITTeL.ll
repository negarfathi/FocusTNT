...
main_bb5:
  ...
  %"12" = icmp sle i64 4294967295, 0, !dbg !42
  %"13" = icmp eq i64 2147483648, 0, !dbg !44
...
main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb10, %main_bb9, %main_bb8
  %cur.0 = phi i64 [ %"19", %main_bb8 ], [ %"24", %main_bb10 ], [ %"15", %main_bb9 ], [ 2147483648, %main_bb5 ]
  %"14" = icmp slt i64 4294967295, %cur.0, !dbg !46
  br i1 %"14", label %main_bb6, label %main_bb7, !dbg !46

main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  ret void, !dbg !49

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"15" = add nsw i64 %cur.0, 2147483648, !dbg !50
  %"16" = icmp sgt i64 %"15", 4294967295, !dbg !51
  br i1 %"16", label %main_bb8, label %main_bb9, !dbg !51

main_bb8:                                         ; preds = %main_bb7
  %"17" = sub nsw i64 %"15", 4294967295, !dbg !52
  %"18" = sub nsw i64 %"17", 1, !dbg !52
  %"19" = srem i64 %"18", 4294967296, !dbg !52
  br label %main_wrap_around.exit, !dbg !52

main_bb9:                                         ; preds = %main_bb7
  %"20" = icmp slt i64 %"15", 0, !dbg !53
  br i1 %"20", label %main_bb10, label %main_wrap_around.exit, !dbg !53

main_bb10:                                        ; preds = %main_bb9
  %"21" = sub nsw i64 0, %"15", !dbg !54
  %"22" = sub nsw i64 %"21", 1, !dbg !54
  %"23" = srem i64 %"22", 4294967296, !dbg !54
  %"24" = sub nsw i64 4294967295, %"23", !dbg !54
