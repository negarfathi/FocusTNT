...
main_bb5:
  ...
  %"12" = icmp sle i64 10, 20, !dbg !42
  %"13" = icmp eq i64 5, 0, !dbg !44
...
main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb10, %main_bb9, %main_bb8
  %cur.0 = phi i64 [ %"19", %main_bb8 ], [ %"24", %main_bb10 ], [ %"15", %main_bb9 ], [ 5, %main_bb5 ]
  %"14" = icmp slt i64 10, %cur.0, !dbg !46
