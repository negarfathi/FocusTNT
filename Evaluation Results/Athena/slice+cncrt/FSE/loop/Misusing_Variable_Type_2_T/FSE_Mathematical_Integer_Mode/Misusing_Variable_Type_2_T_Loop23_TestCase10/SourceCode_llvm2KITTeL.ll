...
main_bb1:
  ...
  call void @llvm.dbg.value(metadata !29, i64 0, metadata !32), !dbg !33
  %"3" = sext i32 70000 to i64, !dbg !34
  ...
  call void @llvm.dbg.value(metadata !{i64 %"5"}, i64 0, metadata !39), !dbg !40
  br label %main_bb2, !dbg !41

main_bb2:                                         ; preds = %main_bb3, %main_bb1
  %i.0 = phi i64 [ 0, %main_bb1 ], [ %"5", %main_bb3 ]
  %"4" = icmp slt i64 %i.0, %"3", !dbg !42
  br i1 %"4", label %main_bb3, label %main_bb4, !dbg !42

main_bb3:                                         ; preds = %main_bb2
  %"5" = add nsw i64 %i.0, 1, !dbg !45
...
!36 = metadata !{i32 786468, null, null, metadata !"long int", i32 0, i64 64, i64 64, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ] [long int] [line 0, size 64, align 64, offset 0, enc DW_ATE_signed]
!37 = metadata !{i32 19, i32 8, metadata !9, null}
!38 = metadata !{i64 0}
!39 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 16, metadata !36, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 16]
!40 = metadata !{i32 16, i32 8, metadata !9, null}
...
!45 = metadata !{i32 21, i32 23, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 23, i32 2, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
