...
main_bb10:
  ...
  call void @llvm.dbg.value(metadata !36, i64 0, metadata !84), !dbg !85
  call void @llvm.dbg.value(metadata !{i64 %"26"}, i64 0, metadata !86), !dbg !89
  ...
  call void @llvm.dbg.value(metadata !36, i64 0, metadata !96), !dbg !97
  call void @llvm.dbg.value(metadata !{i64 %"26"}, i64 0, metadata !84), !dbg !85
  br label %main_bb11, !dbg !98

main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %i.0 = phi i64 [ 0, %main_bb10 ], [ %"26", %main_bb12 ]
  %"25" = icmp slt i64 %i.0, 0, !dbg !99
  br i1 %"25", label %main_bb12, label %main_bb13, !dbg !99

main_bb12:                                        ; preds = %main_bb11
  %"26" = add nsw i64 %i.0, 1, !dbg !87
  br label %main_bb11, !dbg !101
...
!84 = metadata !{i32 786688, metadata !12, metadata !"i", metadata !5, i32 30, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 30]
!85 = metadata !{i32 30, i32 13, metadata !12, null}
!86 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !87} ; [ DW_TAG_arg_variable ] [value] [line 7]
!87 = metadata !{i32 36, i32 8, metadata !88, null}
!88 = metadata !{i32 786443, metadata !1, metadata !12, i32 36, i32 1, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!89 = metadata !{i32 7, i32 33, metadata !4, metadata !87}
!90 = metadata !{i64 -9223372036854775808}
!91 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !87} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!92 = metadata !{i32 7, i32 50, metadata !4, metadata !87}
!93 = metadata !{i64 9223372036854775807}
!94 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !87} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!95 = metadata !{i32 7, i32 73, metadata !4, metadata !87}
!96 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !87} ; [ DW_TAG_auto_variable ] [range] [line 8]
!97 = metadata !{i32 8, i32 15, metadata !4, metadata !87} ; [ DW_TAG_imported_declaration ]
!98 = metadata !{i32 35, i32 3, metadata !12, null}
!99 = metadata !{i32 35, i32 3, metadata !100, null}
!100 = metadata !{i32 786443, metadata !1, metadata !12, i32 35, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!101 = metadata !{i32 37, i32 1, metadata !88, null}
!102 = metadata !{i32 38, i32 3, metadata !12, null}
