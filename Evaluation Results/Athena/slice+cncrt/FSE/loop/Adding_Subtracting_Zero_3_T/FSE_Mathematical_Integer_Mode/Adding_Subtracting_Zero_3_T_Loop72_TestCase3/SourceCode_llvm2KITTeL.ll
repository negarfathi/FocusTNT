...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %"17"}, i64 0, metadata !55), !dbg !56
  call void @llvm.dbg.value(metadata !{i32 %"19"}, i64 0, metadata !70), !dbg !71
...
main_bb9:                                         ; preds = %main_bb10, %main_bb11, %main_bb8
  %__fc_errno_0.0 = phi i32 [ 0, %main_bb8 ], [ %__fc_errno_0.0, %main_bb11 ], [ %"17", %main_bb10 ]
...
main_read_slice_1.exit:                           ; preds = %main_bb9
  ...
  br i1 %or.cond, label %main_bb10, label %main_bb11, !dbg !76

main_bb10:                                        ; preds = %main_read_slice_1.exit
  %"17" = add nsw i32 %__fc_errno_0.0, 1, !dbg !78
  %"18" = icmp eq i32 %"17", 5, !dbg !80
  br i1 %"18", label %main_bb12, label %main_bb9, !dbg !80

main_bb11:                                        ; preds = %main_read_slice_1.exit
  %"19" = add nsw i32 %__retres.0.i, 1, !dbg !82
  %"20" = add nsw i32 %pos.0, %"19", !dbg !85
...
!82 = metadata !{i32 64, i32 18, metadata !83, null}
!83 = metadata !{i32 786443, metadata !1, metadata !84, i32 64, i32 18, i32 1, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!84 = metadata !{i32 786443, metadata !1, metadata !63, i32 64, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!85 = metadata !{i32 65, i32 5, metadata !63, null}
!86 = metadata !{i32 66, i32 3, metadata !63, null}
!87 = metadata !{i32 67, i32 17, metadata !9, null}
