...
main_bb7:
  ...
  br i1 %or.cond1, label %main_bb11, label %main_bb8, !dbg !57

main_bb8:                                         ; preds = %main_bb7, %main_read_slice_1.exit
  %pos.0 = phi i32 [ %"18", %main_read_slice_1.exit ], [ 0, %main_bb7 ]
  %"12" = icmp slt i32 %pos.0, 10, !dbg !61
  br i1 %"12", label %main_bb9, label %main_bb11, !dbg !61
...
main_read_slice_1.exit:                           ; preds = %main_bb9, %main_bb10
  ...
  %cond = icmp eq i32 %__retres.0.i, 0, !dbg !69
  %"17" = add nsw i32 %__retres.0.i, 1, !dbg !71
  %.__retres.0.i = select i1 %cond, i32 %"17", i32 %__retres.0.i, !dbg !69
  %"18" = add nsw i32 %pos.0, %.__retres.0.i, !dbg !74
  br label %main_bb8, !dbg !75

main_bb11:                                        ; preds = %main_bb8, %main_bb7
  ret void, !dbg !76
}
...
!62 = metadata !{i32 786443, metadata !1, metadata !9, i32 54, i32 3, i32 1, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!71 = metadata !{i32 64, i32 18, metadata !72, null}
!72 = metadata !{i32 786443, metadata !1, metadata !73, i32 64, i32 18, i32 1, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!73 = metadata !{i32 786443, metadata !1, metadata !64, i32 64, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!74 = metadata !{i32 65, i32 5, metadata !64, null}
!75 = metadata !{i32 66, i32 3, metadata !64, null}
!76 = metadata !{i32 67, i32 17, metadata !9, null}
