...
main_bb20:
  ...
  %"50" = icmp sle i64 70000, 0, !dbg !121
  %"51" = icmp sgt i64 70000, 65536, !dbg !123
  %or.cond = or i1 %"50", %"51", !dbg !121
  br i1 %or.cond, label %main_bb43, label %main_wrap_around.exit2, !dbg !121

main_wrap_around.exit2:                           ; preds = %main_bb20, %main_bb42, %main_bb41, %main_bb40, %main_wrap_around.exit6
  %__fc_errno_0.0 = phi i64 [ %.0.i5, %main_wrap_around.exit6 ], [ %__fc_errno_0.0, %main_bb40 ], [ %__fc_errno_0.0, %main_bb41 ], [ %__fc_errno_0.0, %main_bb42 ], [ 0, %main_bb20 ]
  %pos.0 = phi i64 [ %pos.0, %main_wrap_around.exit6 ], [ %"115", %main_bb40 ], [ %"120", %main_bb42 ], [ %"110", %main_bb41 ], [ 0, %main_bb20 ]
  %"52" = icmp slt i64 %pos.0, 70000, !dbg !125
  br i1 %"52", label %main_bb21, label %main_bb43, !dbg !125

main_bb21:                                        ; preds = %main_wrap_around.exit2
  %"53" = sub nsw i64 70000, %pos.0, !dbg !127
...
main_wrap_around.exit2.i:                         ; preds = %main_bb31, %main_bb30, %main_bb29, %main_wrap_around.exit
  ...
  %.0.i7 = phi i64 [ %pos.0, %main_wrap_around.exit ], [ %"81", %main_bb29 ], [ %"86", %main_bb31 ], [ %"76", %main_bb30 ], !dbg !134
  %"64" = icmp slt i64 %.0.i7, %.0.i, !dbg !135
...
main_NodeBlock:                                   ; preds = %main_read_slice_1.exit
  %Pivot = icmp slt i64 %count.0.i, 0
  br i1 %Pivot, label %main_LeafBlock, label %main_LeafBlock8

main_LeafBlock:                                   ; preds = %main_NodeBlock
  %SwitchLeaf = icmp eq i64 %count.0.i, -1
  br i1 %SwitchLeaf, label %main_bb32, label %main_NewDefault

main_bb32:                                        ; preds = %main_LeafBlock
  %"87" = add nsw i64 %__fc_errno_0.0, 1, !dbg !148
  ...
  br i1 %"88", label %main_bb33, label %main_bb34, !dbg !159
...
main_bb33:                                        ; preds = %main_bb32
  ...
  br label %main_wrap_around.exit6, !dbg !160

main_bb34:                                        ; preds = %main_bb32
  %"93" = icmp slt i64 %"87", -2147483648, !dbg !161
  br i1 %"93", label %main_bb35, label %main_wrap_around.exit6, !dbg !161
...
main_bb35:                                        ; preds = %main_bb34
  ...
  br label %main_wrap_around.exit6, !dbg !162

main_wrap_around.exit6:                           ; preds = %main_bb33, %main_bb34, %main_bb35
  %.0.i5 = phi i64 [ %"92", %main_bb33 ], [ %"97", %main_bb35 ], [ %"87", %main_bb34 ], !dbg !148
  call void @llvm.dbg.value(metadata !{i64 %.0.i5}, i64 0, metadata !119), !dbg !120
  %"98" = icmp eq i64 %.0.i5, 5, !dbg !163
  br i1 %"98", label %main_bb43, label %main_wrap_around.exit2, !dbg !163

main_LeafBlock8:                                  ; preds = %main_NodeBlock
  %SwitchLeaf9 = icmp eq i64 %count.0.i, 0
  br i1 %SwitchLeaf9, label %main_bb36, label %main_NewDefault

main_bb36:                                        ; preds = %main_LeafBlock8
  %"99" = add nsw i64 %count.0.i, 1, !dbg !165
  call void @llvm.dbg.value(metadata !{i64 %"99"}, i64 0, metadata !168), !dbg !169
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !170), !dbg !171
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !172), !dbg !173
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !174), !dbg !175
  %"100" = icmp sgt i64 %"99", 2147483647, !dbg !176
  br i1 %"100", label %main_bb37, label %main_bb38, !dbg !176

main_bb37:                                        ; preds = %main_bb36
  %"101" = sub nsw i64 %"99", 2147483647, !dbg !177
  %"102" = sub nsw i64 %"101", 1, !dbg !177
  %"103" = srem i64 %"102", 4294967296, !dbg !177
  %"104" = add nsw i64 -2147483648, %"103", !dbg !177
  br label %main_wrap_around.exit4, !dbg !177

main_bb38:                                        ; preds = %main_bb36
  %"105" = icmp slt i64 %"99", -2147483648, !dbg !178
  br i1 %"105", label %main_bb39, label %main_wrap_around.exit4, !dbg !178

main_bb39:                                        ; preds = %main_bb38
  %"106" = sub nsw i64 -2147483648, %"99", !dbg !179
  %"107" = sub nsw i64 %"106", 1, !dbg !179
  %"108" = srem i64 %"107", 4294967296, !dbg !179
  %"109" = sub nsw i64 2147483647, %"108", !dbg !179
  br label %main_wrap_around.exit4, !dbg !179

main_NewDefault:                                  ; preds = %main_LeafBlock8, %main_LeafBlock
  br label %main_wrap_around.exit4

main_wrap_around.exit4:                           ; preds = %main_NewDefault, %main_bb39, %main_bb38, %main_bb37
  %rc.0 = phi i64 [ %count.0.i, %main_NewDefault ], [ %"104", %main_bb37 ], [ %"109", %main_bb39 ], [ %"99", %main_bb38 ]
  %"110" = add nsw i64 %pos.0, %rc.0, !dbg !180
  call void @llvm.dbg.value(metadata !{i64 %"110"}, i64 0, metadata !181), !dbg !182
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !183), !dbg !184
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !185), !dbg !186
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !187), !dbg !188
  %"111" = icmp sgt i64 %"110", 2147483647, !dbg !189
  br i1 %"111", label %main_bb40, label %main_bb41, !dbg !189

main_bb40:                                        ; preds = %main_wrap_around.exit4
  %"112" = sub nsw i64 %"110", 2147483647, !dbg !190
  %"113" = sub nsw i64 %"112", 1, !dbg !190
  %"114" = srem i64 %"113", 4294967296, !dbg !190
  %"115" = add nsw i64 -2147483648, %"114", !dbg !190
  br label %main_wrap_around.exit2, !dbg !190

main_bb41:                                        ; preds = %main_wrap_around.exit4
  %"116" = icmp slt i64 %"110", -2147483648, !dbg !191
  br i1 %"116", label %main_bb42, label %main_wrap_around.exit2, !dbg !191

main_bb42:                                        ; preds = %main_bb41
  %"117" = sub nsw i64 -2147483648, %"110", !dbg !192
  %"118" = sub nsw i64 %"117", 1, !dbg !192
  %"119" = srem i64 %"118", 4294967296, !dbg !192
  %"120" = sub nsw i64 2147483647, %"119", !dbg !192
  br label %main_wrap_around.exit2, !dbg !192

main_bb43:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit6, %main_bb20
  ret void, !dbg !193
}
...
!96 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 3, i32 1, i32 24} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!148 = metadata !{i32 65, i32 23, metadata !149, null}
!149 = metadata !{i32 786443, metadata !1, metadata !150, i32 64, i32 19, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!150 = metadata !{i32 786443, metadata !1, metadata !128, i32 64, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!151 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !148} ; [ DW_TAG_arg_variable ] [value] [line 8]
!152 = metadata !{i32 8, i32 33, metadata !4, metadata !148} ; [ DW_TAG_imported_declaration ]
!153 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !148} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!154 = metadata !{i32 8, i32 50, metadata !4, metadata !148} ; [ DW_TAG_imported_declaration ]
!155 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !148} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!156 = metadata !{i32 8, i32 73, metadata !4, metadata !148} ; [ DW_TAG_imported_declaration ]
!157 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !148} ; [ DW_TAG_auto_variable ] [range] [line 9]
!158 = metadata !{i32 9, i32 15, metadata !4, metadata !148}
!159 = metadata !{i32 10, i32 9, metadata !30, metadata !148}
!160 = metadata !{i32 11, i32 9, metadata !32, metadata !148}
!161 = metadata !{i32 13, i32 14, metadata !34, metadata !148}
!162 = metadata !{i32 14, i32 9, metadata !36, metadata !148}
!163 = metadata !{i32 66, i32 11, metadata !164, null}
!164 = metadata !{i32 786443, metadata !1, metadata !149, i32 66, i32 11, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!165 = metadata !{i32 73, i32 9, metadata !166, null}
!166 = metadata !{i32 786443, metadata !1, metadata !167, i32 73, i32 1, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!167 = metadata !{i32 786443, metadata !1, metadata !128, i32 72, i32 9, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!168 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !165} ; [ DW_TAG_arg_variable ] [value] [line 8]
!169 = metadata !{i32 8, i32 33, metadata !4, metadata !165} ; [ DW_TAG_imported_declaration ]
!170 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !165} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!171 = metadata !{i32 8, i32 50, metadata !4, metadata !165} ; [ DW_TAG_imported_declaration ]
!172 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !165} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!173 = metadata !{i32 8, i32 73, metadata !4, metadata !165} ; [ DW_TAG_imported_declaration ]
!174 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !165} ; [ DW_TAG_auto_variable ] [range] [line 9]
!175 = metadata !{i32 9, i32 15, metadata !4, metadata !165}
!176 = metadata !{i32 10, i32 9, metadata !30, metadata !165}
!177 = metadata !{i32 11, i32 9, metadata !32, metadata !165}
!178 = metadata !{i32 13, i32 14, metadata !34, metadata !165}
!179 = metadata !{i32 14, i32 9, metadata !36, metadata !165}
!180 = metadata !{i32 75, i32 11, metadata !128, null}
!181 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !180} ; [ DW_TAG_arg_variable ] [value] [line 8]
!182 = metadata !{i32 8, i32 33, metadata !4, metadata !180} ; [ DW_TAG_imported_declaration ]
!183 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !180} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!184 = metadata !{i32 8, i32 50, metadata !4, metadata !180} ; [ DW_TAG_imported_declaration ]
!185 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !180} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!186 = metadata !{i32 8, i32 73, metadata !4, metadata !180} ; [ DW_TAG_imported_declaration ]
!187 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !180} ; [ DW_TAG_auto_variable ] [range] [line 9]
!188 = metadata !{i32 9, i32 15, metadata !4, metadata !180}
!189 = metadata !{i32 10, i32 9, metadata !30, metadata !180}
!190 = metadata !{i32 11, i32 9, metadata !32, metadata !180}
!191 = metadata !{i32 13, i32 14, metadata !34, metadata !180}
!192 = metadata !{i32 14, i32 9, metadata !36, metadata !180}
!193 = metadata !{i32 77, i32 17, metadata !12, null}
