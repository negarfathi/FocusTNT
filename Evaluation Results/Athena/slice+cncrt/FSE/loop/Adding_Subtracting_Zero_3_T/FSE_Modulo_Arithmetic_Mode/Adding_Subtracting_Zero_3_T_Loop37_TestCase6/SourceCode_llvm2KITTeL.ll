...
read_slice_1_wrap_around.exit:                    ; preds = %read_slice_1_bb11, %read_slice_1_bb10, %read_slice_1_bb9, %read_slice_1_bb7
  %num.0 = phi i64 [ 996, %read_slice_1_bb7 ], [ %"20", %read_slice_1_bb9 ], [ %"25", %read_slice_1_bb11 ], [ %"15", %read_slice_1_bb10 ]
...
main_bb20:
  ...
  %"50" = icmp sle i64 5, 0, !dbg !121
  %"51" = icmp sgt i64 5, 65536, !dbg !123
