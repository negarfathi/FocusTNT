...
main_bb6:
  ...
  %"8" = icmp sle i32 70000, 0, !dbg !54
  %"9" = icmp sgt i32 70000, 65536, !dbg !56
  %or.cond = or i1 %"8", %"9", !dbg !54
  br i1 %or.cond, label %main_bb14, label %main_bb7, !dbg !54

main_bb7:                                         ; preds = %main_bb6, %main_bb11, %main_bb13
  %__fc_errno_0.0 = phi i32 [ %__fc_errno_0.0, %main_bb13 ], [ %"15", %main_bb11 ], [ 0, %main_bb6 ]
  %pos.0 = phi i32 [ %"18", %main_bb13 ], [ %pos.0, %main_bb11 ], [ 0, %main_bb6 ]
  %"10" = icmp slt i32 %pos.0, 70000, !dbg !58
  br i1 %"10", label %main_bb8, label %main_bb14, !dbg !58

main_bb8:                                         ; preds = %main_bb7
  %"11" = sub nsw i32 70000, %pos.0, !dbg !60
  br label %main_bb9, !dbg !62

main_bb9:                                         ; preds = %main_bb10, %main_bb8
  %count.0.i = phi i32 [ 0, %main_bb8 ], [ %"13", %main_bb10 ], !dbg !60
  %.0.i = phi i32 [ %pos.0, %main_bb8 ], [ %"14", %main_bb10 ], !dbg !60
  %"12" = icmp slt i32 %.0.i, %"11", !dbg !63
  br i1 %"12", label %main_bb10, label %main_read_slice_1.exit, !dbg !63

main_bb10:                                        ; preds = %main_bb9
  %"13" = add nsw i32 %count.0.i, 1, !dbg !64
  %"14" = add nsw i32 %.0.i, 1, !dbg !65
  br label %main_bb9, !dbg !66

main_read_slice_1.exit:                           ; preds = %main_bb9
  call void @llvm.dbg.value(metadata !{i32 %count.0.i}, i64 0, metadata !67), !dbg !68
  br label %main_NodeBlock

main_NodeBlock:                                   ; preds = %main_read_slice_1.exit
  %Pivot = icmp slt i32 %count.0.i, 0
  br i1 %Pivot, label %main_LeafBlock, label %main_LeafBlock1

main_LeafBlock:                                   ; preds = %main_NodeBlock
  %SwitchLeaf = icmp eq i32 %count.0.i, -1
  br i1 %SwitchLeaf, label %main_bb11, label %main_NewDefault

main_bb11:                                        ; preds = %main_LeafBlock
  %"15" = add nsw i32 %__fc_errno_0.0, 1, !dbg !69
  call void @llvm.dbg.value(metadata !{i32 %"15"}, i64 0, metadata !52), !dbg !53
  %"16" = icmp eq i32 %"15", 5, !dbg !72
  br i1 %"16", label %main_bb14, label %main_bb7, !dbg !72

main_LeafBlock1:                                  ; preds = %main_NodeBlock
  %SwitchLeaf2 = icmp eq i32 %count.0.i, 0
  br i1 %SwitchLeaf2, label %main_bb12, label %main_NewDefault

main_bb12:                                        ; preds = %main_LeafBlock1
  %"17" = add nsw i32 %count.0.i, 1, !dbg !74
  call void @llvm.dbg.value(metadata !{i32 %"17"}, i64 0, metadata !67), !dbg !68
  br label %main_bb13, !dbg !74

main_NewDefault:                                  ; preds = %main_LeafBlock1, %main_LeafBlock
  br label %main_bb13

main_bb13:                                        ; preds = %main_NewDefault, %main_bb12
  %rc.0 = phi i32 [ %"17", %main_bb12 ], [ %count.0.i, %main_NewDefault ]
  %"18" = add nsw i32 %pos.0, %rc.0, !dbg !77
  call void @llvm.dbg.value(metadata !{i32 %"18"}, i64 0, metadata !46), !dbg !47
  br label %main_bb7, !dbg !78

main_bb14:                                        ; preds = %main_bb7, %main_bb11, %main_bb6
  ret void, !dbg !79
}
...
!30 = metadata !{i32 786443, metadata !1, metadata !4, i32 10, i32 3, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!63 = metadata !{i32 10, i32 3, metadata !30, metadata !60}
!64 = metadata !{i32 20, i32 7, metadata !35, metadata !60}
!65 = metadata !{i32 21, i32 22, metadata !43, metadata !60}
!66 = metadata !{i32 28, i32 3, metadata !26, metadata !60}
!67 = metadata !{i32 786688, metadata !61, metadata !"rc", metadata !5, i32 43, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [rc] [line 43]
!68 = metadata !{i32 43, i32 9, metadata !61, null}
!69 = metadata !{i32 45, i32 7, metadata !70, null}
!70 = metadata !{i32 786443, metadata !1, metadata !71, i32 44, i32 19, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 786443, metadata !1, metadata !61, i32 44, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!72 = metadata !{i32 46, i32 11, metadata !73, null}
!73 = metadata !{i32 786443, metadata !1, metadata !70, i32 46, i32 11, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!74 = metadata !{i32 52, i32 18, metadata !75, null}
!75 = metadata !{i32 786443, metadata !1, metadata !76, i32 52, i32 18, i32 1, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 786443, metadata !1, metadata !61, i32 52, i32 9, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!77 = metadata !{i32 53, i32 5, metadata !61, null}
!78 = metadata !{i32 54, i32 3, metadata !61, null}
