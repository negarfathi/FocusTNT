...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"19"}, i64 0, metadata !54), !dbg !57
...
main_wrap_around.exit2:                           ; preds = %main_bb23, %main_bb22, %main_bb21, %main_bb10
  %base.0 = phi i64 [ 2, %main_bb10 ], [ %"66", %main_bb21 ], [ %"71", %main_bb23 ], [ %"61", %main_bb22 ]
  %i.0 = phi i64 [ 0, %main_bb10 ], [ %.0.i3, %main_bb21 ], [ %.0.i3, %main_bb22 ], [ %.0.i3, %main_bb23 ]
  %"32" = icmp slt i64 %base.0, 10, !dbg !90
