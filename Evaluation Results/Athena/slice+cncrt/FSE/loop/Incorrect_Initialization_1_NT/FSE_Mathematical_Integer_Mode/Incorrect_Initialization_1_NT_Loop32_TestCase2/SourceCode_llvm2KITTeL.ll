...
main_bb0:
  ...
  %"0" = bitcast [100 x i8]* %buf to i8*, !dbg !17
  call void @llvm.memset.p0i8.i64(i8* %"0", i8 0, i64 100, i32 16, i1 false), !dbg !17
  %"1" = bitcast i8* %"0" to [100 x i8]*, !dbg !17
  %"2" = getelementptr [100 x i8]* %"1", i32 0, i32 0, !dbg !17
  store i8 104, i8* %"2", !dbg !17
  %"3" = getelementptr [100 x i8]* %"1", i32 0, i32 1, !dbg !17
  store i8 101, i8* %"3", !dbg !17
  %"4" = getelementptr [100 x i8]* %"1", i32 0, i32 2, !dbg !17
  store i8 108, i8* %"4", !dbg !17
  %"5" = getelementptr [100 x i8]* %"1", i32 0, i32 3, !dbg !17
  store i8 108, i8* %"5", !dbg !17
  %"6" = getelementptr [100 x i8]* %"1", i32 0, i32 4, !dbg !17
  store i8 111, i8* %"6", !dbg !17
  %"7" = getelementptr [100 x i8]* %"1", i32 0, i32 5, !dbg !17
  store i8 10, i8* %"7", !dbg !17
  call void @llvm.dbg.value(metadata !18, i64 0, metadata !19), !dbg !22
  call void @llvm.dbg.value(metadata !{i32 %"9"}, i64 0, metadata !19), !dbg !22
  br label %main_bb1, !dbg !23

main_bb1:                                         ; preds = %main_bb2, %main_bb0
  %i.0 = phi i32 [ 0, %main_bb0 ], [ %"9", %main_bb2 ]
  %"8" = icmp slt i32 %i.0, 99, !dbg !24
  br i1 %"8", label %main_bb2, label %main_bb3, !dbg !24

main_bb2:                                         ; preds = %main_bb1
  %"9" = add nsw i32 %i.0, 1, !dbg !26
...
!27 = metadata !{i32 786443, metadata !1, metadata !20, i32 10, i32 20, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
