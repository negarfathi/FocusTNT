...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !46), !dbg !49
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"15" = icmp slt i64 %i.0, 10, !dbg !60
  br i1 %"15", label %main_bb6, label %main_bb10, !dbg !60

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"16" = add nsw i64 %i.0, 1, !dbg !47
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !62
  br i1 %"17", label %main_bb7, label %main_bb8, !dbg !62

main_bb7:                                         ; preds = %main_bb6
  %"18" = sub nsw i64 %"16", 2147483647, !dbg !63
  %"19" = sub nsw i64 %"18", 1, !dbg !63
  %"20" = srem i64 %"19", 4294967296, !dbg !63
  %"21" = add nsw i64 -2147483648, %"20", !dbg !63
  br label %main_wrap_around.exit, !dbg !63

main_bb8:                                         ; preds = %main_bb6
  %"22" = icmp slt i64 %"16", -2147483648, !dbg !64
  br i1 %"22", label %main_bb9, label %main_wrap_around.exit, !dbg !64

main_bb9:                                         ; preds = %main_bb8
  %"23" = sub nsw i64 -2147483648, %"16", !dbg !65
  %"24" = sub nsw i64 %"23", 1, !dbg !65
  %"25" = srem i64 %"24", 4294967296, !dbg !65
  %"26" = sub nsw i64 2147483647, %"25", !dbg !65
