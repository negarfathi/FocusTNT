...
main_bb5:
  ...
  call void @llvm.memset.p0i8.i64(i8* %"15", i8 0, i64 80, i32 16, i1 false), !dbg !43
  %"16" = bitcast i8* %"15" to [10 x i64]*, !dbg !43
  %"17" = getelementptr [10 x i64]* %"16", i32 0, i32 3, !dbg !43
  store i64 5, i64* %"17", !dbg !43
  ...
  call void @llvm.dbg.value(metadata !{i64 %"19"}, i64 0, metadata !51), !dbg !54
...
main_bb6:                                         ; preds = %main_wrap_around.exit
  %"19" = add nsw i64 %i.0, 1, !dbg !52
  %"20" = icmp sgt i64 %"19", 2147483647, !dbg !67
  br i1 %"20", label %main_bb7, label %main_bb8, !dbg !67

main_bb7:                                         ; preds = %main_bb6
  %"21" = sub nsw i64 %"19", 2147483647, !dbg !68
  %"22" = sub nsw i64 %"21", 1, !dbg !68
  %"23" = srem i64 %"22", 4294967296, !dbg !68
  %"24" = add nsw i64 -2147483648, %"23", !dbg !68
  br label %main_wrap_around.exit, !dbg !68

main_bb8:                                         ; preds = %main_bb6
  %"25" = icmp slt i64 %"19", -2147483648, !dbg !69
  br i1 %"25", label %main_bb9, label %main_wrap_around.exit, !dbg !69

main_bb9:                                         ; preds = %main_bb8
  %"26" = sub nsw i64 -2147483648, %"19", !dbg !70
  %"27" = sub nsw i64 %"26", 1, !dbg !70
  %"28" = srem i64 %"27", 4294967296, !dbg !70
  %"29" = sub nsw i64 2147483647, %"28", !dbg !70
  br label %main_wrap_around.exit, !dbg !70

main_wrap_around.exit2:                           ; preds = %main_bb18, %main_bb17, %main_bb16, %main_wrap_around.exit
  %i_0.0 = phi i64 [ 0, %main_wrap_around.exit ], [ %"46", %main_bb16 ], [ %"51", %main_bb18 ], [ %"41", %main_bb17 ]
  %table.0 = phi i64 [ %"12", %main_wrap_around.exit ], [ %table.1, %main_bb16 ], [ %table.1, %main_bb17 ], [ %table.1, %main_bb18 ]
  %"30" = icmp slt i64 %i_0.0, 10, !dbg !71
  br i1 %"30", label %main_bb10, label %main_bb19, !dbg !71

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"31" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i_0.0, !dbg !73
...
main_bb11:                                        ; preds = %main_LeafBlock
  %"33" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !75
  %"34" = load i64* %"33", align 8, !dbg !75
  %"35" = icmp ne i64 %"34", 0, !dbg !75
  br i1 %"35", label %main_bb12, label %main_bb19, !dbg !75
...
main_bb13:                                        ; preds = %main_NewDefault
  %"38" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !80
  %"39" = load i64* %"38", align 8, !dbg !80
...
main_bb14:                                        ; preds = %main_LeafBlock3, %main_bb13, %main_bb12
  ...
  %"40" = icmp ne i64 %table.1, 0, !dbg !82
  br i1 %"40", label %main_bb19, label %main_bb15, !dbg !82

main_bb15:                                        ; preds = %main_bb14
  %"41" = add nsw i64 %i_0.0, 1, !dbg !84
  %"42" = icmp sgt i64 %"41", 2147483647, !dbg !85
  br i1 %"42", label %main_bb16, label %main_bb17, !dbg !85

main_bb16:                                        ; preds = %main_bb15
  %"43" = sub nsw i64 %"41", 2147483647, !dbg !86
  %"44" = sub nsw i64 %"43", 1, !dbg !86
  %"45" = srem i64 %"44", 4294967296, !dbg !86
  %"46" = add nsw i64 -2147483648, %"45", !dbg !86
  br label %main_wrap_around.exit2, !dbg !86

main_bb17:                                        ; preds = %main_bb15
  %"47" = icmp slt i64 %"41", -2147483648, !dbg !87
  br i1 %"47", label %main_bb18, label %main_wrap_around.exit2, !dbg !87

main_bb18:                                        ; preds = %main_bb17
  %"48" = sub nsw i64 -2147483648, %"41", !dbg !88
  %"49" = sub nsw i64 %"48", 1, !dbg !88
  %"50" = srem i64 %"49", 4294967296, !dbg !88
  %"51" = sub nsw i64 2147483647, %"50", !dbg !88
