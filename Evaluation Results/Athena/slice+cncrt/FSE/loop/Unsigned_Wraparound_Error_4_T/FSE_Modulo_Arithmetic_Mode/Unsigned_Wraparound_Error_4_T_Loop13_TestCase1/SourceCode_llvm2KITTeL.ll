...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !40), !dbg !42
  call void @llvm.dbg.value(metadata !33, i64 0, metadata !43), !dbg !44
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %n.0 = phi i64 [ 0, %main_bb5 ], [ %"18", %main_bb7 ], [ %"23", %main_bb9 ], [ %"14", %main_bb8 ]
  %"12" = icmp sgt i64 %n.0, 0, !dbg !52
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !52

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = icmp sgt i64 %n.0, 16, !dbg !54
  %.n.0 = select i1 %"13", i64 16, i64 %n.0, !dbg !54
  %"14" = sub nsw i64 %n.0, %.n.0, !dbg !41
...
!43 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!44 = metadata !{i32 7, i32 50, metadata !4, metadata !41}
!45 = metadata !{i64 4294967295}
!46 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!47 = metadata !{i32 7, i32 73, metadata !4, metadata !41}
!48 = metadata !{i64 4294967296}
!49 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !41} ; [ DW_TAG_auto_variable ] [range] [line 8]
!50 = metadata !{i32 8, i32 15, metadata !4, metadata !41} ; [ DW_TAG_imported_declaration ]
!51 = metadata !{i32 20, i32 3, metadata !9, null}
!52 = metadata !{i32 20, i32 3, metadata !53, null}
!53 = metadata !{i32 786443, metadata !1, metadata !9, i32 20, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 22, i32 9, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !37, i32 22, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 9, i32 9, metadata !25, metadata !41}
!57 = metadata !{i32 10, i32 9, metadata !27, metadata !41}
!58 = metadata !{i32 12, i32 14, metadata !29, metadata !41}
!59 = metadata !{i32 13, i32 9, metadata !31, metadata !41}
!60 = metadata !{i32 27, i32 3, metadata !9, null}
