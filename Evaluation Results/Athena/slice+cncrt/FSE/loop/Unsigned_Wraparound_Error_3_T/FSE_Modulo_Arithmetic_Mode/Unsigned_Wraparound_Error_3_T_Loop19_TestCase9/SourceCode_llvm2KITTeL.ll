...
main_bb5:
  ...
  %"12" = add nsw i64 1, 3000000000, !dbg !42
  %"13" = add nsw i64 %"12", 1, !dbg !42
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !44), !dbg !45
  call void @llvm.dbg.value(metadata !46, i64 0, metadata !47), !dbg !48
  call void @llvm.dbg.value(metadata !33, i64 0, metadata !49), !dbg !50
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !52), !dbg !53
  %"14" = icmp sgt i64 %"13", 4294967295, !dbg !54
  br i1 %"14", label %main_bb6, label %main_bb7, !dbg !54

main_bb6:                                         ; preds = %main_bb5
  %"15" = sub nsw i64 %"13", 4294967295, !dbg !55
  %"16" = sub nsw i64 %"15", 1, !dbg !55
  %"17" = srem i64 %"16", 4294967296, !dbg !55
  br label %main_wrap_around.exit, !dbg !55

main_bb7:                                         ; preds = %main_bb5
  %"18" = icmp slt i64 %"13", 0, !dbg !56
  br i1 %"18", label %main_bb8, label %main_wrap_around.exit, !dbg !56

main_bb8:                                         ; preds = %main_bb7
  %"19" = sub nsw i64 0, %"13", !dbg !57
  %"20" = sub nsw i64 %"19", 1, !dbg !57
  %"21" = srem i64 %"20", 4294967296, !dbg !57
  %"22" = sub nsw i64 4294967295, %"21", !dbg !57
  br label %main_wrap_around.exit, !dbg !57

main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  %.0.i = phi i64 [ %"17", %main_bb6 ], [ %"22", %main_bb8 ], [ %"13", %main_bb7 ], !dbg !42
  %"23" = icmp eq i64 %.0.i, 4294967295, !dbg !42
  %"24" = icmp eq i64 1, 0, !dbg !58
  %or.cond = or i1 %"23", %"24", !dbg !42
  br i1 %or.cond, label %main_bb17, label %main_wrap_around.exit2, !dbg !42
...
main_wrap_around.exit2:                           ; preds = %main_wrap_around.exit, %main_bb12, %main_bb14, %main_bb15, %main_bb16
  ...
  %"25" = add nsw i64 4294967295, 3000000000, !dbg !60
  %"26" = add nsw i64 %"25", 1, !dbg !60
  %"27" = icmp sgt i64 %"26", 4294967295, !dbg !61
  br i1 %"27", label %main_bb9, label %main_bb10, !dbg !61

main_bb9:                                         ; preds = %main_wrap_around.exit2
  %"28" = sub nsw i64 %"26", 4294967295, !dbg !62
  %"29" = sub nsw i64 %"28", 1, !dbg !62
  %"30" = srem i64 %"29", 4294967296, !dbg !62
  br label %main_wrap_around.exit4, !dbg !62

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"31" = icmp slt i64 %"26", 0, !dbg !63
  br i1 %"31", label %main_bb11, label %main_wrap_around.exit4, !dbg !63

main_bb11:                                        ; preds = %main_bb10
  %"32" = sub nsw i64 0, %"26", !dbg !64
  %"33" = sub nsw i64 %"32", 1, !dbg !64
  %"34" = srem i64 %"33", 4294967296, !dbg !64
  %"35" = sub nsw i64 4294967295, %"34", !dbg !64
  br label %main_wrap_around.exit4, !dbg !64

main_wrap_around.exit4:                           ; preds = %main_bb9, %main_bb10, %main_bb11
  %.0.i3 = phi i64 [ %"30", %main_bb9 ], [ %"35", %main_bb11 ], [ %"26", %main_bb10 ], !dbg !60
  %"36" = icmp slt i64 %newbufsize.0, %.0.i3, !dbg !60
  br i1 %"36", label %main_bb12, label %main_bb17, !dbg !60

main_bb12:                                        ; preds = %main_wrap_around.exit4
  %"37" = icmp sge i64 %newbufsize.0, 2147483648, !dbg !65
  br i1 %"37", label %main_wrap_around.exit2, label %main_bb13, !dbg !65

main_bb13:                                        ; preds = %main_bb12
  %"38" = mul nsw i64 %newbufsize.0, 2, !dbg !68
  %"39" = icmp sgt i64 %"38", 4294967295, !dbg !69
  br i1 %"39", label %main_bb14, label %main_bb15, !dbg !69

main_bb14:                                        ; preds = %main_bb13
  %"40" = sub nsw i64 %"38", 4294967295, !dbg !70
  %"41" = sub nsw i64 %"40", 1, !dbg !70
  %"42" = srem i64 %"41", 4294967296, !dbg !70
  br label %main_wrap_around.exit2, !dbg !70

main_bb15:                                        ; preds = %main_bb13
  %"43" = icmp slt i64 %"38", 0, !dbg !71
  br i1 %"43", label %main_bb16, label %main_wrap_around.exit2, !dbg !71

main_bb16:                                        ; preds = %main_bb15
  %"44" = sub nsw i64 0, %"38", !dbg !72
  %"45" = sub nsw i64 %"44", 1, !dbg !72
  %"46" = srem i64 %"45", 4294967296, !dbg !72
  %"47" = sub nsw i64 4294967295, %"46", !dbg !72
...
!44 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !42} ; [ DW_TAG_arg_variable ] [value] [line 7]
!45 = metadata !{i32 7, i32 33, metadata !4, metadata !42}
!46 = metadata !{i64 0}
!47 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !42} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!48 = metadata !{i32 7, i32 50, metadata !4, metadata !42}
!49 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !42} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!50 = metadata !{i32 7, i32 73, metadata !4, metadata !42}
!51 = metadata !{i64 4294967296}
!52 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !42} ; [ DW_TAG_auto_variable ] [range] [line 8]
!53 = metadata !{i32 8, i32 15, metadata !4, metadata !42} ; [ DW_TAG_imported_declaration ]
!54 = metadata !{i32 9, i32 9, metadata !25, metadata !42}
!55 = metadata !{i32 10, i32 9, metadata !27, metadata !42}
!56 = metadata !{i32 12, i32 14, metadata !29, metadata !42}
!57 = metadata !{i32 13, i32 9, metadata !31, metadata !42}
!58 = metadata !{i32 27, i32 7, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 7, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 31, i32 23, metadata !9, null}
!61 = metadata !{i32 9, i32 9, metadata !25, metadata !60}
!62 = metadata !{i32 10, i32 9, metadata !27, metadata !60}
!63 = metadata !{i32 12, i32 14, metadata !29, metadata !60}
!64 = metadata !{i32 13, i32 9, metadata !31, metadata !60}
!65 = metadata !{i32 33, i32 9, metadata !66, null}
!66 = metadata !{i32 786443, metadata !1, metadata !67, i32 33, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!68 = metadata !{i32 36, i32 23, metadata !66, null}
!69 = metadata !{i32 9, i32 9, metadata !25, metadata !68}
!70 = metadata !{i32 10, i32 9, metadata !27, metadata !68}
!71 = metadata !{i32 12, i32 14, metadata !29, metadata !68}
!72 = metadata !{i32 13, i32 9, metadata !31, metadata !68}
!73 = metadata !{i32 38, i32 17, metadata !9, null}
