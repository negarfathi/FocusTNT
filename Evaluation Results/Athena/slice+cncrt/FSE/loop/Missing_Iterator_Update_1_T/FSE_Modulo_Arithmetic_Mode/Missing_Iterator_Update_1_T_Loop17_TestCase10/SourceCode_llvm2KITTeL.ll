...
main_bb6:
  ...
  %"12" = icmp eq i64 -999, 0, !dbg !47
  br i1 %"12", label %main_bb7, label %main_bb9, !dbg !47

main_bb7:                                         ; preds = %main_bb6
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !49), !dbg !53
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !45), !dbg !46
  %"13" = load i64* @"'__fc_errno", align 8, !dbg !54
  %.old = icmp slt i64 -999, 0, !dbg !58
  br i1 %.old, label %main_bb8, label %main_bb9, !dbg !58

main_bb8:                                         ; preds = %main_bb8, %main_bb7
  %"14" = icmp eq i64 %"13", 1, !dbg !54
  %"15" = icmp slt i64 -999, 0, !dbg !58
  %or.cond = and i1 %"14", %"15", !dbg !54
  br i1 %or.cond, label %main_bb8, label %main_bb9, !dbg !54

main_bb9:                                         ; preds = %main_bb8, %main_bb7, %main_bb6
  ret void, !dbg !59
}
...
!47 = metadata !{i32 35, i32 7, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !12, i32 35, i32 7, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 786688, metadata !9, metadata !"num", metadata !5, i32 21, metadata !8, i32 0, metadata !50} ; [ DW_TAG_auto_variable ] [num] [line 21]
!50 = metadata !{i32 38, i32 13, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !52, i32 37, i32 15, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 786443, metadata !1, metadata !48, i32 36, i32 1, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!53 = metadata !{i32 21, i32 13, metadata !9, metadata !50}
!54 = metadata !{i32 40, i32 13, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !56, i32 40, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 786443, metadata !1, metadata !57, i32 39, i32 20, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 786443, metadata !1, metadata !51, i32 39, i32 11, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 39, i32 11, metadata !57, null}
!59 = metadata !{i32 47, i32 3, metadata !12, null}
