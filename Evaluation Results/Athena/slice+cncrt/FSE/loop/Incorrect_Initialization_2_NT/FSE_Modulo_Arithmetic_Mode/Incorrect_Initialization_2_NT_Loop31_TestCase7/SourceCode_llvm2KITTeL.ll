...
res_return_slice_1_wrap_around.exit:              ; preds = %res_return_slice_1_bb7, %res_return_slice_1_bb8, %res_return_slice_1_bb9
  ...
  %. = select i1 %"26", i64 10, i64 -1, !dbg !69
  ret i64 %., !dbg !71
}
...
main_bb10:
  ...
  call void @llvm.dbg.value(metadata !118, i64 0, metadata !76), !dbg !77
...
main_bb11:                                        ; preds = %main_NewDefault, %main_bb13, %main_bb10
  ...
  %matroska.0 = phi i64 [ 5, %main_bb10 ], [ 1, %main_bb13 ], [ %matroska.0, %main_NewDefault ]
...
main_res_return_slice_1.exit:                     ; preds = %main_bb15, %main_bb16, %main_bb17
  ...
  %..i1 = select i1 %"42", i64 10, i64 -1, !dbg !133
...
!90 = metadata !{i32 786443, metadata !1, metadata !86, i32 55, i32 19, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!103 = metadata !{i32 60, i32 19, metadata !104, null}
!104 = metadata !{i32 786443, metadata !1, metadata !90, i32 59, i32 9, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!112 = metadata !{i32 68, i32 17, metadata !90, null}
...
!120 = metadata !{i32 20, i32 7, metadata !44, metadata !79}
!121 = metadata !{i32 22, i32 1, metadata !46, metadata !79}
!122 = metadata !{i32 50, i32 9, metadata !123, null}
!123 = metadata !{i32 786443, metadata !1, metadata !80, i32 50, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!124 = metadata !{i32 83, i32 1, metadata !125, null}
!125 = metadata !{i32 786443, metadata !1, metadata !126, i32 82, i32 1, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!126 = metadata !{i32 786443, metadata !1, metadata !80, i32 81, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!134 = metadata !{i32 80, i32 5, metadata !86, null}
