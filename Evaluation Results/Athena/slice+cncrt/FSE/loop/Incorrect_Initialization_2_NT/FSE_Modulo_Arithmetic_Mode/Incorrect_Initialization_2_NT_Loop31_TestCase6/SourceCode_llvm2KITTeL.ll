...
res_return_slice_1_wrap_around.exit:              ; preds = %res_return_slice_1_bb7, %res_return_slice_1_bb8, %res_return_slice_1_bb9
  ...
  %. = select i1 %"26", i64 5, i64 -1, !dbg !69
  ret i64 %., !dbg !71
}
...
main_bb10:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"29"}, i64 0, metadata !87), !dbg !90
  call void @llvm.dbg.value(metadata !{i64 %"31"}, i64 0, metadata !91), !dbg !93
  call void @llvm.dbg.value(metadata !54, i64 0, metadata !94), !dbg !95
  call void @llvm.dbg.value(metadata !57, i64 0, metadata !96), !dbg !97
  call void @llvm.dbg.value(metadata !60, i64 0, metadata !98), !dbg !99
  call void @llvm.dbg.value(metadata !{i64 %..i1}, i64 0, metadata !76), !dbg !77
  call void @llvm.dbg.value(metadata !54, i64 0, metadata !100), !dbg !104
  ...
  call void @llvm.dbg.value(metadata !54, i64 0, metadata !109), !dbg !112
  call void @llvm.dbg.value(metadata !57, i64 0, metadata !113), !dbg !114
  call void @llvm.dbg.value(metadata !60, i64 0, metadata !115), !dbg !116
  call void @llvm.dbg.value(metadata !117, i64 0, metadata !76), !dbg !77
...
main_bb11:                                        ; preds = %main_NewDefault, %main_bb13, %main_bb10
  ...
  %"27" = icmp eq i64 %matroska.0, 1, !dbg !119
  %..i = select i1 %"27", i64 0, i64 1, !dbg !120
  %"28" = icmp ne i64 %..i, 0, !dbg !121
  br i1 %"28", label %main_bb12, label %main_bb18, !dbg !121

main_bb12:                                        ; preds = %main_bb11, %main_res_return_slice_1.exit
  %res.1 = phi i64 [ %..i1, %main_res_return_slice_1.exit ], [ %res.0, %main_bb11 ]
...
main_bb13:                                        ; preds = %main_LeafBlock
  call void @llvm.dbg.value(metadata !117, i64 0, metadata !73), !dbg !74
...
main_bb14:                                        ; preds = %main_LeafBlock8
  %"29" = load i64* @"'flag", align 8, !dbg !126
  %"30" = load i64* @"'flag", align 8, !dbg !92
  %"31" = add nsw i64 %"30", 1, !dbg !92
  %"32" = icmp sgt i64 %"31", 2147483647, !dbg !127
  br i1 %"32", label %main_bb15, label %main_bb16, !dbg !127

main_bb15:                                        ; preds = %main_bb14
  %"33" = sub nsw i64 %"31", 2147483647, !dbg !128
  %"34" = sub nsw i64 %"33", 1, !dbg !128
  %"35" = srem i64 %"34", 4294967296, !dbg !128
  %"36" = add nsw i64 -2147483648, %"35", !dbg !128
  br label %main_res_return_slice_1.exit, !dbg !128

main_bb16:                                        ; preds = %main_bb14
  %"37" = icmp slt i64 %"31", -2147483648, !dbg !129
  br i1 %"37", label %main_bb17, label %main_res_return_slice_1.exit, !dbg !129

main_bb17:                                        ; preds = %main_bb16
  %"38" = sub nsw i64 -2147483648, %"31", !dbg !130
  %"39" = sub nsw i64 %"38", 1, !dbg !130
  %"40" = srem i64 %"39", 4294967296, !dbg !130
  %"41" = sub nsw i64 2147483647, %"40", !dbg !130
  br label %main_res_return_slice_1.exit, !dbg !130

main_res_return_slice_1.exit:                     ; preds = %main_bb15, %main_bb16, %main_bb17
  %.0.i.i = phi i64 [ %"36", %main_bb15 ], [ %"41", %main_bb17 ], [ %"31", %main_bb16 ], !dbg !92
  store i64 %.0.i.i, i64* @"'flag", align 8, !dbg !92
  %"42" = icmp slt i64 %"29", 100, !dbg !131
  %..i1 = select i1 %"42", i64 5, i64 -1, !dbg !132
  br label %main_bb12, !dbg !133
...
!87 = metadata !{i32 786688, metadata !12, metadata !"tmp_0", metadata !5, i32 30, metadata !8, i32 0, metadata !88} ; [ DW_TAG_auto_variable ] [tmp_0] [line 30]
!88 = metadata !{i32 76, i32 32, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !85, i32 55, i32 19, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!90 = metadata !{i32 30, i32 13, metadata !12, metadata !88}
...
!92 = metadata !{i32 32, i32 11, metadata !12, metadata !88}
!93 = metadata !{i32 7, i32 33, metadata !4, metadata !92}
!94 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!95 = metadata !{i32 7, i32 50, metadata !4, metadata !92}
!96 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!97 = metadata !{i32 7, i32 73, metadata !4, metadata !92}
!98 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !92} ; [ DW_TAG_auto_variable ] [range] [line 8]
!99 = metadata !{i32 8, i32 15, metadata !4, metadata !92} ; [ DW_TAG_imported_declaration ]
!100 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !101} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!101 = metadata !{i32 32, i32 11, metadata !12, metadata !102}
!102 = metadata !{i32 60, i32 19, metadata !103, null}
!103 = metadata !{i32 786443, metadata !1, metadata !89, i32 59, i32 9, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!109 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !110} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!110 = metadata !{i32 32, i32 11, metadata !12, metadata !111}
!111 = metadata !{i32 68, i32 17, metadata !89, null}
!112 = metadata !{i32 7, i32 50, metadata !4, metadata !110}
!113 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !110} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!114 = metadata !{i32 7, i32 73, metadata !4, metadata !110}
!115 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !110} ; [ DW_TAG_auto_variable ] [range] [line 8]
!116 = metadata !{i32 8, i32 15, metadata !4, metadata !110} ; [ DW_TAG_imported_declaration ]
!117 = metadata !{i64 1}
!118 = metadata !{i32 48, i32 3, metadata !15, null}
!119 = metadata !{i32 20, i32 7, metadata !44, metadata !79}
!120 = metadata !{i32 22, i32 1, metadata !46, metadata !79}
!121 = metadata !{i32 50, i32 9, metadata !122, null}
!122 = metadata !{i32 786443, metadata !1, metadata !80, i32 50, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!123 = metadata !{i32 83, i32 1, metadata !124, null}
!124 = metadata !{i32 786443, metadata !1, metadata !125, i32 82, i32 1, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!125 = metadata !{i32 786443, metadata !1, metadata !80, i32 81, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!126 = metadata !{i32 31, i32 3, metadata !12, metadata !88}
!127 = metadata !{i32 9, i32 9, metadata !33, metadata !92}
!128 = metadata !{i32 10, i32 9, metadata !35, metadata !92}
!129 = metadata !{i32 12, i32 14, metadata !37, metadata !92}
!130 = metadata !{i32 13, i32 9, metadata !39, metadata !92}
!131 = metadata !{i32 33, i32 7, metadata !68, metadata !88}
!132 = metadata !{i32 37, i32 5, metadata !70, metadata !88}
!133 = metadata !{i32 80, i32 5, metadata !85, null}
!134 = metadata !{i32 85, i32 3, metadata !15, null}
