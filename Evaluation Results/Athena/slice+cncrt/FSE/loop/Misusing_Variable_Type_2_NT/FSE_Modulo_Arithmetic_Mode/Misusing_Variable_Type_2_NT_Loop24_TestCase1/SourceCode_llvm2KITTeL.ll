...
main_bb10:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"29"}, i64 0, metadata !84), !dbg !85
  br label %main_bb11, !dbg !86

main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %i.0 = phi i64 [ 0, %main_bb10 ], [ %"29", %main_bb12 ]
  %"25" = icmp ult i64 %i.0, 0, !dbg !87
  br i1 %"25", label %main_bb12, label %main_bb13, !dbg !87

main_bb12:                                        ; preds = %main_bb11
  %"26" = trunc i64 %i.0 to i32, !dbg !89
  %"27" = add nsw i32 %"26", 1, !dbg !89
  %"28" = trunc i32 %"27" to i16, !dbg !89
  %"29" = zext i16 %"28" to i64, !dbg !89
...
!86 = metadata !{i32 35, i32 3, metadata !12, null}
!87 = metadata !{i32 35, i32 3, metadata !88, null}
!88 = metadata !{i32 786443, metadata !1, metadata !12, i32 35, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!89 = metadata !{i32 36, i32 3, metadata !90, null}
!90 = metadata !{i32 786443, metadata !1, metadata !12, i32 36, i32 1, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!91 = metadata !{i32 37, i32 1, metadata !90, null}
!92 = metadata !{i32 38, i32 3, metadata !12, null}
