...
main_bb10:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"29"}, i64 0, metadata !95), !dbg !96
  br label %main_bb11, !dbg !97

main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %i.0 = phi i64 [ 0, %main_bb10 ], [ %"29", %main_bb12 ]
  %"25" = icmp ult i64 %i.0, 70000, !dbg !98
  br i1 %"25", label %main_bb12, label %main_bb13, !dbg !98

main_bb12:                                        ; preds = %main_bb11
  %"26" = trunc i64 %i.0 to i32, !dbg !100
  %"27" = add nsw i32 %"26", 1, !dbg !100
  %"28" = trunc i32 %"27" to i16, !dbg !100
  %"29" = zext i16 %"28" to i64, !dbg !100
  br label %main_bb11, !dbg !102
...
!97 = metadata !{i32 35, i32 3, metadata !12, null}
!98 = metadata !{i32 35, i32 3, metadata !99, null}
!99 = metadata !{i32 786443, metadata !1, metadata !12, i32 35, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!100 = metadata !{i32 36, i32 3, metadata !101, null}
!101 = metadata !{i32 786443, metadata !1, metadata !12, i32 36, i32 1, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!102 = metadata !{i32 37, i32 1, metadata !101, null}
!103 = metadata !{i32 38, i32 3, metadata !12, null}
