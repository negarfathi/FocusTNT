...
main_bb1:                                         ; preds = %main_bb2, %main_bb0
  %smallest.0 = phi i32 [ 1, %main_bb0 ], [ %"1", %main_bb2 ]
  %"0" = icmp sle i32 %smallest.0, 1500000000, !dbg !19
  br i1 %"0", label %main_bb2, label %main_bb3, !dbg !19

main_bb2:                                         ; preds = %main_bb1
  %"1" = shl i32 %smallest.0, 1, !dbg !22
...
!20 = metadata !{i32 786443, metadata !1, metadata !21, i32 9, i32 3, i32 3, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!21 = metadata !{i32 786443, metadata !1, metadata !4, i32 9, i32 3, i32 1, i32 0} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!22 = metadata !{i32 9, i32 30, metadata !23, null}
!23 = metadata !{i32 786443, metadata !1, metadata !4, i32 9, i32 30, i32 2, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!24 = metadata !{i32 10, i32 3, metadata !4, null}
