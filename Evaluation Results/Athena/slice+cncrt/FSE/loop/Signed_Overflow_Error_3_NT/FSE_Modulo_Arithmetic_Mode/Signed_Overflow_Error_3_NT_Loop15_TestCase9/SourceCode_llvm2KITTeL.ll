...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !39), !dbg !42
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %i.0 = phi i64 [ 10, %main_bb5 ], [ %"18", %main_bb7 ], [ %"23", %main_bb9 ], [ %"13", %main_bb8 ]
  %"12" = icmp sle i64 %i.0, 1950000000, !dbg !53
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !53

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = mul nsw i64 %i.0, 10, !dbg !40
  %"14" = icmp sgt i64 %"13", 2147483647, !dbg !55
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !55

main_bb7:                                         ; preds = %main_bb6
  %"15" = sub nsw i64 %"13", 2147483647, !dbg !56
  %"16" = sub nsw i64 %"15", 1, !dbg !56
  %"17" = srem i64 %"16", 4294967296, !dbg !56
  %"18" = add nsw i64 -2147483648, %"17", !dbg !56
  br label %main_wrap_around.exit, !dbg !56

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"13", -2147483648, !dbg !57
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !57

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 -2147483648, %"13", !dbg !58
  %"21" = sub nsw i64 %"20", 1, !dbg !58
  %"22" = srem i64 %"21", 4294967296, !dbg !58
  %"23" = sub nsw i64 2147483647, %"22", !dbg !58
