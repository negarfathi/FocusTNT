...
STATE USEFIRST ARG6 :
    MATCH "int needed = 1500000000;" -> ASSUME {needed == (1500000000);} GOTO ARG13;
    TRUE -> STOP;
...
STATE USEFIRST ARG18 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (2);needed == (1500000000);} GOTO ARG38;
    TRUE -> STOP;
...
STATE USEFIRST ARG44 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (4);needed == (1500000000);} GOTO ARG45;
    TRUE -> STOP;
