...
STATE USEFIRST ARG6 :
    MATCH "int needed = 1800000000;" -> ASSUME {needed == (1800000000);} GOTO ARG12;
    TRUE -> STOP;
...
STATE USEFIRST ARG15 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (1);needed == (1800000000);} GOTO ARG16;
    TRUE -> STOP;
...
STATE USEFIRST ARG18 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (2);needed == (1800000000);} GOTO ARG36;
    TRUE -> STOP;

STATE USEFIRST ARG36 :
    MATCH "smallest <<= 1;" -> ASSUME {smallest == (4);} GOTO ARG39;
    TRUE -> STOP;
...
STATE USEFIRST ARG44 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (4);needed == (1800000000);} GOTO ARG45;
    TRUE -> STOP;
...
STATE USEFIRST ARG47 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (8);needed == (1800000000);} GOTO ARG48;
    TRUE -> STOP;
...
STATE USEFIRST ARG50 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (16);needed == (1800000000);} GOTO ARG51;
    TRUE -> STOP;
...
STATE USEFIRST ARG59 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (32);needed == (1800000000);} GOTO ARG61;
    TRUE -> STOP;
...
STATE USEFIRST ARG63 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (64);needed == (1800000000);} GOTO ARG64;
    TRUE -> STOP;
...
STATE USEFIRST ARG66 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (128);needed == (1800000000);} GOTO ARG67;
    TRUE -> STOP;
...
STATE USEFIRST ARG69 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (256);needed == (1800000000);} GOTO ARG70;
    TRUE -> STOP;
...
STATE USEFIRST ARG72 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (512);needed == (1800000000);} GOTO ARG73;
    TRUE -> STOP;
...
STATE USEFIRST ARG75 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (1024);needed == (1800000000);} GOTO ARG77;
    TRUE -> STOP;
...
STATE USEFIRST ARG79 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (2048);needed == (1800000000);} GOTO ARG80;
    TRUE -> STOP;
...
STATE USEFIRST ARG82 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (4096);needed == (1800000000);} GOTO ARG83;
    TRUE -> STOP;
...
STATE USEFIRST ARG85 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (8192);needed == (1800000000);} GOTO ARG86;
    TRUE -> STOP;
...
STATE USEFIRST ARG88 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (16384);needed == (1800000000);} GOTO ARG89;
    TRUE -> STOP;
...
STATE USEFIRST ARG91 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (32768);needed == (1800000000);} GOTO ARG92;
    TRUE -> STOP;
...
STATE USEFIRST ARG94 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (65536);needed == (1800000000);} GOTO ARG95;
    TRUE -> STOP;
...
STATE USEFIRST ARG97 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (131072);needed == (1800000000);} GOTO ARG98;
    TRUE -> STOP;
...
STATE USEFIRST ARG100 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (262144);needed == (1800000000);} GOTO ARG101;
    TRUE -> STOP;
...
STATE USEFIRST ARG103 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (524288);needed == (1800000000);} GOTO ARG104;
    TRUE -> STOP;
...
STATE USEFIRST ARG106 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (1048576);needed == (1800000000);} GOTO ARG107;
    TRUE -> STOP;
...
STATE USEFIRST ARG109 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (2097152);needed == (1800000000);} GOTO ARG110;
    TRUE -> STOP;
...
STATE USEFIRST ARG112 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (4194304);needed == (1800000000);} GOTO ARG113;
    TRUE -> STOP;
...
STATE USEFIRST ARG115 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (8388608);needed == (1800000000);} GOTO ARG116;
    TRUE -> STOP;
...
STATE USEFIRST ARG118 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (16777216);needed == (1800000000);} GOTO ARG119;
    TRUE -> STOP;
...
STATE USEFIRST ARG121 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (33554432);needed == (1800000000);} GOTO ARG122;
    TRUE -> STOP;
...
STATE USEFIRST ARG124 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (67108864);needed == (1800000000);} GOTO ARG125;
    TRUE -> STOP;
...
STATE USEFIRST ARG127 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (134217728);needed == (1800000000);} GOTO ARG128;
    TRUE -> STOP;
...
STATE USEFIRST ARG130 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (268435456);needed == (1800000000);} GOTO ARG131;
    TRUE -> STOP;
...
STATE USEFIRST ARG133 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (536870912);needed == (1800000000);} GOTO ARG134;
    TRUE -> STOP;
...
STATE USEFIRST ARG136 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (1073741824);needed == (1800000000);} GOTO ARG137;
    TRUE -> STOP;
...
STATE USEFIRST ARG139 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (-2147483648);needed == (1800000000);} GOTO ARG140;
    TRUE -> STOP;
...
STATE USEFIRST ARG142 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (0);needed == (1800000000);} GOTO ARG143;
    TRUE -> STOP;
