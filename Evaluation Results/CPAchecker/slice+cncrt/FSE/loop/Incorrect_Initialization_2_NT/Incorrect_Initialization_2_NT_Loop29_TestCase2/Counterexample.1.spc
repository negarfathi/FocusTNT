...
STATE USEFIRST ARG42 :
    MATCH "[!(q == 1)]" -> ASSUME {q == (2);} GOTO ARG47;
    TRUE -> STOP;
...
STATE USEFIRST ARG99 :
    MATCH "[!(res == 0)]" -> ASSUME {res == (1);} GOTO ARG143;
    TRUE -> STOP;

STATE USEFIRST ARG143 :
    MATCH "[!(res == -1)]" -> ASSUME {res == (1);} GOTO ARG148;
    TRUE -> STOP;
...
STATE USEFIRST ARG161 :
    MATCH "tmpVar0 = matroska_deliver_packet_slice_1(matroska);" -> GOTO ARG166;
    TRUE -> STOP;

STATE USEFIRST ARG166 :
    MATCH "" -> ASSUME {q == (2);} GOTO ARG167;
    TRUE -> STOP;

STATE USEFIRST ARG167 :
    MATCH "int __retres;" -> ASSUME {q == (2);} GOTO ARG168;
    TRUE -> STOP;
...
STATE USEFIRST ARG173 :
    MATCH "return __retres;" -> GOTO ARG180;
    TRUE -> STOP;
...
STATE USEFIRST ARG183 :
    MATCH "[!(! tmpVar0)]" -> ASSUME {tmpVar0 == (1);} GOTO ARG189;
    TRUE -> STOP;
