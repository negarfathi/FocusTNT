...
STATE USEFIRST ARG140 :
    MATCH "[!(res == -1)]" -> ASSUME {res == (10);} GOTO ARG143;
    TRUE -> STOP;
...
STATE USEFIRST ARG159 :
    MATCH "" -> ASSUME {q == (5);} GOTO ARG160;
    TRUE -> STOP;

STATE USEFIRST ARG160 :
    MATCH "int __retres;" -> ASSUME {q == (5);} GOTO ARG163;
    TRUE -> STOP;

STATE USEFIRST ARG163 :
    MATCH "[!(q == 1)]" -> ASSUME {q == (5);} GOTO ARG168;
    TRUE -> STOP;
...
STATE USEFIRST ARG172 :
    MATCH "[!(! tmpVar0)]" -> ASSUME {tmpVar0 == (1);} GOTO ARG175;
    TRUE -> STOP;
