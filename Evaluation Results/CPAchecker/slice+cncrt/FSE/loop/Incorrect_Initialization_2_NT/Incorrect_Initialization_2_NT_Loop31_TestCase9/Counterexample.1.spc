...
STATE USEFIRST ARG153 :
    MATCH "tmpVar0 = matroska_deliver_packet_slice_1(matroska);" -> GOTO ARG158;
    TRUE -> STOP;

STATE USEFIRST ARG158 :
    MATCH "" -> ASSUME {q == (8);} GOTO ARG160;
    TRUE -> STOP;

STATE USEFIRST ARG160 :
    MATCH "int __retres;" -> ASSUME {q == (8);} GOTO ARG161;
    TRUE -> STOP;
