...
STATE USEFIRST ARG19 :
    MATCH "int res = 0;" -> ASSUME {res == (0);} GOTO ARG20;
    TRUE -> STOP;
...
STATE USEFIRST ARG34 :
    MATCH "tmpVar0 = matroska_deliver_packet_slice_1(matroska);" -> GOTO ARG37;
    TRUE -> STOP;
...
STATE USEFIRST ARG41 :
    MATCH "[!(q == 1)]" -> ASSUME {q == (11);} GOTO ARG44;
    TRUE -> STOP;
...
STATE USEFIRST ARG96 :
    MATCH "[!(res == 0)]" -> ASSUME {res == (3);} GOTO ARG140;
    TRUE -> STOP;

STATE USEFIRST ARG140 :
    MATCH "[!(res == -1)]" -> ASSUME {res == (3);} GOTO ARG141;
    TRUE -> STOP;
...
STATE USEFIRST ARG154 :
    MATCH "" -> ASSUME {q == (11);} GOTO ARG155;
    TRUE -> STOP;

STATE USEFIRST ARG155 :
    MATCH "int __retres;" -> ASSUME {q == (11);} GOTO ARG156;
    TRUE -> STOP;

STATE USEFIRST ARG156 :
    MATCH "[!(q == 1)]" -> ASSUME {q == (11);} GOTO ARG162;
    TRUE -> STOP;
