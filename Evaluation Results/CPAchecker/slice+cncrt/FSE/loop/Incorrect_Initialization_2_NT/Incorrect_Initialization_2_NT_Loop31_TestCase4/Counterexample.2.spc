...
STATE USEFIRST ARG79 :
    MATCH "[!(res)]" -> ASSUME {res == (0);} GOTO ARG91;
    TRUE -> STOP;

STATE USEFIRST ARG91 :
    MATCH "tmp_2 = res_return_slice_1();" -> GOTO ARG94;
    TRUE -> STOP;
...
STATE USEFIRST ARG96 :
    MATCH "int __retres;" -> GOTO ARG98;
    TRUE -> STOP;

STATE USEFIRST ARG98 :
    MATCH "int tmp_0;" -> GOTO ARG103;
    TRUE -> STOP;

STATE USEFIRST ARG103 :
    MATCH "tmp_0 = flag;" -> ASSUME {tmp_0 == (1);} GOTO ARG106;
    TRUE -> STOP;

STATE USEFIRST ARG106 :
    MATCH "flag ++;" -> ASSUME {__CPAchecker_TMP_0 == (1);} GOTO ARG109;
    TRUE -> STOP;

STATE USEFIRST ARG109 :
    MATCH "flag ++;" -> ASSUME {flag == (2);} GOTO ARG112;
    TRUE -> STOP;
...
STATE USEFIRST ARG119 :
    MATCH "__retres = tmp;" -> ASSUME {__retres == (0);} GOTO ARG122;
    TRUE -> STOP;
...
STATE USEFIRST ARG140 :
    MATCH "res = tmp_2 == 0;" -> ASSUME {res == (1);} GOTO ARG149;
    TRUE -> STOP;

STATE USEFIRST ARG149 :
    MATCH "[res]" -> ASSUME {res == (1);} GOTO ARG155;
    TRUE -> STOP;
...
STATE USEFIRST ARG161 :
    MATCH "[!(res == 0)]" -> ASSUME {res == (1);} GOTO ARG208;
    TRUE -> STOP;

STATE USEFIRST ARG208 :
    MATCH "[!(res == -1)]" -> ASSUME {res == (1);} GOTO ARG213;
    TRUE -> STOP;
...
STATE USEFIRST ARG250 :
    MATCH "[!(! tmpVar0)]" -> ASSUME {tmpVar0 == (1);} GOTO ARG254;
    TRUE -> STOP;
