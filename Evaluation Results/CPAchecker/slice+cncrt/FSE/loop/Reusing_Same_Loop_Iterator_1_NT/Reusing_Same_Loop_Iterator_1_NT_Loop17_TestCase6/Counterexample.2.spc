...
STATE USEFIRST ARG14 :
    MATCH "[!(num_crtc > 65534)]" -> ASSUME {num_crtc == (10);} GOTO ARG15;
    TRUE -> STOP;

STATE USEFIRST ARG15 :
    MATCH "[!(num_output > 65534)]" -> ASSUME {num_output == (5);} GOTO ARG20;
    TRUE -> STOP;
...
STATE USEFIRST ARG42 :
    MATCH "[i < num_output]" -> ASSUME {i == (0);num_output == (5);} GOTO ARG43;
    TRUE -> STOP;
...
STATE USEFIRST ARG81 :
    MATCH "i ++;" -> ASSUME {__CPAchecker_TMP_0 == (3);} GOTO ARG84;
    TRUE -> STOP;
