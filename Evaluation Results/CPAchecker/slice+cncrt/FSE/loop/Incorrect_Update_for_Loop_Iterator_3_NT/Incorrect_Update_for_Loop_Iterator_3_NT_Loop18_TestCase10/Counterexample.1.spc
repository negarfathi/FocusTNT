...
STATE USEFIRST ARG17 :
    MATCH "nfds *= 2;" -> ASSUME {nfds == (14);} GOTO ARG18;
    TRUE -> STOP;
...
STATE USEFIRST ARG20 :
    MATCH "[nfds <= nr]" -> ASSUME {nfds == (14);nr == (1000);} GOTO ARG56;
    TRUE -> STOP;

STATE USEFIRST ARG56 :
    MATCH "nfds *= 2;" -> ASSUME {nfds == (28);} GOTO ARG60;
    TRUE -> STOP;

STATE USEFIRST ARG60 :
    MATCH "[!(nfds > NR_OPEN)]" -> ASSUME {nfds == (28);NR_OPEN == (300);} GOTO ARG63;
    TRUE -> STOP;
...
STATE USEFIRST ARG66 :
    MATCH "nfds *= 2;" -> ASSUME {nfds == (56);} GOTO ARG67;
    TRUE -> STOP;
...
STATE USEFIRST ARG70 :
    MATCH "nfds *= 2;" -> ASSUME {nfds == (112);} GOTO ARG75;
    TRUE -> STOP;

STATE USEFIRST ARG75 :
    MATCH "[!(nfds > NR_OPEN)]" -> ASSUME {nfds == (112);NR_OPEN == (300);} GOTO ARG79;
    TRUE -> STOP;
...
STATE USEFIRST ARG80 :
    MATCH "[nfds <= nr]" -> ASSUME {nfds == (112);nr == (1000);} GOTO ARG81;
    TRUE -> STOP;

STATE USEFIRST ARG81 :
    MATCH "nfds *= 2;" -> ASSUME {nfds == (224);} GOTO ARG82;
    TRUE -> STOP;
...
STATE USEFIRST ARG85 :
    MATCH "nfds *= 2;" -> ASSUME {nfds == (448);} GOTO ARG86;
    TRUE -> STOP;
...
STATE USEFIRST ARG91 :
    MATCH "nfds *= 2;" -> ASSUME {nfds == (600);} GOTO ARG92;
    TRUE -> STOP;
