...
STATE USEFIRST ARG18 :
    MATCH "int h = 10;" -> ASSUME {h == (10);} GOTO ARG20;
    TRUE -> STOP;
...
STATE USEFIRST ARG22 :
    MATCH "[h > 0]" -> ASSUME {h == (10);} GOTO ARG23;
    TRUE -> STOP;

STATE USEFIRST ARG23 :
    MATCH "[!(linesToRead > h)]" -> ASSUME {linesToRead == (0);h == (10);} GOTO ARG24;
    TRUE -> STOP;

STATE USEFIRST ARG24 :
    MATCH "h -= linesToRead;" -> ASSUME {h == (10);} GOTO ARG25;
    TRUE -> STOP;
