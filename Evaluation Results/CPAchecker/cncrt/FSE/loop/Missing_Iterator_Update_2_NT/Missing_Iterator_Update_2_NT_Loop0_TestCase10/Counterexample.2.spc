...
STATE USEFIRST ARG17 :
    MATCH "int i = 100;" -> ASSUME {i == (100);} GOTO ARG20;
    TRUE -> STOP;
...
STATE USEFIRST ARG36 :
    MATCH "[i >= 0]" -> ASSUME {i == (100);} GOTO ARG40;
    TRUE -> STOP;
...
STATE USEFIRST ARG45 :
    MATCH "int dval_mv_size = -10;" -> ASSUME {dval_mv_size == (-10);} GOTO ARG48;
    TRUE -> STOP;
...
STATE USEFIRST ARG52 :
    MATCH "[dval_mv_size <= 0]" -> ASSUME {dval_mv_size == (-10);} GOTO ARG53;
    TRUE -> STOP;
