...
STATE USEFIRST ARG11 :
    MATCH "int hash = 20;" -> ASSUME {hash == (20);} GOTO ARG14;
    TRUE -> STOP;
...
STATE USEFIRST ARG17 :
    MATCH "[!(h < 0 || hash <= 0 || rehash <= 0 || rehash > hash)]" -> ASSUME {h == (15);} GOTO ARG23;
    TRUE -> STOP;

STATE USEFIRST ARG23 :
    MATCH "[!(h < 0 || hash <= 0 || rehash <= 0 || rehash > hash)]" -> ASSUME {hash == (20);} GOTO ARG29;
    TRUE -> STOP;
...
STATE USEFIRST ARG30 :
    MATCH "[!(h < 0 || hash <= 0 || rehash <= 0 || rehash > hash)]" -> ASSUME {rehash == (5);hash == (20);} GOTO ARG36;
    TRUE -> STOP;
...
STATE USEFIRST ARG48 :
    MATCH "[i < hash]" -> ASSUME {hash == (20);} GOTO ARG64;
    TRUE -> STOP;
