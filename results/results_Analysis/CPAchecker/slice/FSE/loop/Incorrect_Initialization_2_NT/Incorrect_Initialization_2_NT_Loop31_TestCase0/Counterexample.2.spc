...
STATE USEFIRST ARG27 :
    MATCH "tmpVar0 = matroska_deliver_packet_slice_1(matroska);" -> GOTO ARG34;
    TRUE -> STOP;
...
STATE USEFIRST ARG35 :
    MATCH "int __retres;" -> GOTO ARG38;
    TRUE -> STOP;

STATE USEFIRST ARG38 :
    MATCH "[!(q == 1)]" -> GOTO ARG45;
    TRUE -> STOP;
...
STATE USEFIRST ARG166 :
    MATCH "tmpVar0 = matroska_deliver_packet_slice_1(matroska);" -> GOTO ARG169;
    TRUE -> STOP;
...
STATE USEFIRST ARG171 :
    MATCH "int __retres;" -> GOTO ARG172;
    TRUE -> STOP;

STATE USEFIRST ARG172 :
    MATCH "[!(q == 1)]" -> GOTO ARG178;
    TRUE -> STOP;
...
STATE USEFIRST ARG182 :
    MATCH "[!(! tmpVar0)]" -> ASSUME {tmpVar0 == (1);} GOTO ARG185;
    TRUE -> STOP;
