...
STATE USEFIRST ARG17 :
    MATCH "int i = 1;" -> ASSUME {i == (1);} GOTO ARG20;
    TRUE -> STOP;
...
STATE USEFIRST ARG21 :
    MATCH "flag++;" -> ASSUME {flag == (1);} GOTO ARG26;
    TRUE -> STOP;

STATE USEFIRST ARG26 :
    MATCH "flag++;" -> GOTO ARG27;
    TRUE -> STOP;
...
STATE USEFIRST ARG36 :
    MATCH "[i >= 0]" -> ASSUME {i == (1);} GOTO ARG38;
    TRUE -> STOP;
...
STATE USEFIRST ARG43 :
    MATCH "int dval_mv_size = -1;" -> ASSUME {dval_mv_size == (-1);} GOTO ARG47;
    TRUE -> STOP;
...
STATE USEFIRST ARG52 :
    MATCH "[dval_mv_size <= 0]" -> ASSUME {dval_mv_size == (-1);} GOTO ARG53;
    TRUE -> STOP;
