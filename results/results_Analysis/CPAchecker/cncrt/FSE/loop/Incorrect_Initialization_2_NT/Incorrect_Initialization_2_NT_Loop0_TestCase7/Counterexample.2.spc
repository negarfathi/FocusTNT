...
STATE USEFIRST ARG17 :
    MATCH "int matroska = 5;" -> ASSUME {matroska == (5);} GOTO ARG22;
    TRUE -> STOP;
...
STATE USEFIRST ARG35 :
    MATCH "" -> ASSUME {q == (5);} GOTO ARG36;
    TRUE -> STOP;

STATE USEFIRST ARG36 :
    MATCH "[!(q == 1)]" -> ASSUME {q == (5);} GOTO ARG43;
    TRUE -> STOP;
...
STATE USEFIRST ARG45 :
    MATCH "[matroska_deliver_packet( matroska)]" -> ASSUME {__CPAchecker_TMP_0 == (1);} GOTO ARG48;
    TRUE -> STOP;
...
STATE USEFIRST ARG63 :
    MATCH "[!(res == 0)]" -> ASSUME {res == (10);} GOTO ARG120;
    TRUE -> STOP;

STATE USEFIRST ARG120 :
    MATCH "[!(res == -1)]" -> ASSUME {res == (10);} GOTO ARG123;
    TRUE -> STOP;
...
STATE USEFIRST ARG126 :
    MATCH "matroska_deliver_packet( matroska)" -> GOTO ARG127;
    TRUE -> STOP;

STATE USEFIRST ARG127 :
    MATCH "matroska_deliver_packet( matroska)" -> GOTO ARG132;
    TRUE -> STOP;

STATE USEFIRST ARG132 :
    MATCH "" -> ASSUME {q == (5);} GOTO ARG133;
    TRUE -> STOP;

STATE USEFIRST ARG133 :
    MATCH "[!(q == 1)]" -> ASSUME {q == (5);} GOTO ARG136;
    TRUE -> STOP;

STATE USEFIRST ARG136 :
    MATCH "return 1;" -> GOTO ARG140;
    TRUE -> STOP;
...
STATE USEFIRST ARG145 :
    MATCH "[matroska_deliver_packet( matroska)]" -> ASSUME {__CPAchecker_TMP_0 == (1);} GOTO ARG147;
    TRUE -> STOP;
