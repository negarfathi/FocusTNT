...
main_bb0:
  ...
  call void @llvm.dbg.value(metadata !{i8 %"2"}, i64 0, metadata !12), !dbg !14
  call void @llvm.dbg.value(metadata !{i8 %"2"}, i64 0, metadata !18), !dbg !20
  call void @llvm.dbg.value(metadata !{i8 %"6"}, i64 0, metadata !12), !dbg !14
  br label %main_bb1, !dbg !21

main_bb1:                                         ; preds = %main_bb2, %main_bb0
  %l.0 = phi i8 [ 16, %main_bb0 ], [ %"6", %main_bb2 ]
  %"0" = zext i8 %l.0 to i32, !dbg !22
  %"1" = sub nsw i32 %"0", 1, !dbg !22
  %"2" = trunc i32 %"1" to i8, !dbg !22
  %"3" = icmp ne i8 %l.0, 0, !dbg !23
  br i1 %"3", label %main_bb2, label %main_bb3, !dbg !23

main_bb2:                                         ; preds = %main_bb1
  %"4" = zext i8 %"2" to i32, !dbg !25
  %"5" = sub nsw i32 %"4", 1, !dbg !25
  %"6" = trunc i32 %"5" to i8, !dbg !25
...
!19 = metadata !{i32 786443, metadata !1, metadata !16, i32 13, i32 5, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!20 = metadata !{i32 14, i32 21, metadata !19, null}
!21 = metadata !{i32 8, i32 3, metadata !4, null} ; [ DW_TAG_imported_declaration ]
!22 = metadata !{i32 11, i32 5, metadata !16, null}
!23 = metadata !{i32 12, i32 9, metadata !24, null}
!24 = metadata !{i32 786443, metadata !1, metadata !16, i32 12, i32 9, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!25 = metadata !{i32 16, i32 7, metadata !19, null}
!26 = metadata !{i32 18, i32 3, metadata !16, null}
!27 = metadata !{i32 19, i32 3, metadata !4, null}
