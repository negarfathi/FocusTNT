...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %div2.0 = phi i64 [ 7, %main_bb5 ], [ %"17", %main_bb7 ], [ %"22", %main_bb9 ], [ %"13", %main_bb8 ]
  %"12" = icmp sge i64 %div2.0, 0, !dbg !50
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !50

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = sub nsw i64 %div2.0, 1, !dbg !37
...
!33 = metadata !{i64 7}
!34 = metadata !{i32 786688, metadata !9, metadata !"div2", metadata !5, i32 16, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [div2] [line 16]
