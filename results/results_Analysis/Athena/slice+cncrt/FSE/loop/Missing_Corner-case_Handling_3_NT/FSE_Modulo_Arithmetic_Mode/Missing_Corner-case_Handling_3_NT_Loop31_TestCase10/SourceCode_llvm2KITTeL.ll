...
main_wrap_around.exit2:                           ; preds = %main_bb29, %main_bb28, %main_bb27, %main_wrap_around.exit8
  ...
  %"60" = xor i1 %"59", true, !dbg !127
  br i1 %"60", label %main_wrap_around.exit4, label %main_bb30, !dbg !127
...
main_wrap_around.exit4:                           ; preds = %main_bb25, %main_bb24, %main_bb23, %main_wrap_around.exit2
  ...
  %"61" = sub nsw i64 10, 1, !dbg !131
  %"62" = icmp sgt i64 %"61", 2147483647, !dbg !134
  br i1 %"62", label %main_bb19, label %main_bb20, !dbg !134

main_bb19:                                        ; preds = %main_wrap_around.exit4
  %"63" = sub nsw i64 %"61", 2147483647, !dbg !135
  %"64" = sub nsw i64 %"63", 1, !dbg !135
  %"65" = srem i64 %"64", 4294967296, !dbg !135
  %"66" = add nsw i64 -2147483648, %"65", !dbg !135
  br label %main_wrap_around.exit6, !dbg !135

main_bb20:                                        ; preds = %main_wrap_around.exit4
  %"67" = icmp slt i64 %"61", -2147483648, !dbg !136
  br i1 %"67", label %main_bb21, label %main_wrap_around.exit6, !dbg !136

main_bb21:                                        ; preds = %main_bb20
  %"68" = sub nsw i64 -2147483648, %"61", !dbg !137
  %"69" = sub nsw i64 %"68", 1, !dbg !137
  %"70" = srem i64 %"69", 4294967296, !dbg !137
  %"71" = sub nsw i64 2147483647, %"70", !dbg !137
  br label %main_wrap_around.exit6, !dbg !137

main_wrap_around.exit6:                           ; preds = %main_bb19, %main_bb20, %main_bb21
  %.0.i5 = phi i64 [ %"66", %main_bb19 ], [ %"71", %main_bb21 ], [ %"61", %main_bb20 ], !dbg !131
  %"72" = icmp sle i64 %y.0, %.0.i5, !dbg !131
  br i1 %"72", label %main_bb22, label %main_bb26, !dbg !131

main_bb22:                                        ; preds = %main_wrap_around.exit6
  %"73" = mul nsw i64 %xmin.0, 10, !dbg !138
  %"74" = getelementptr inbounds i64* %"18", i64 %"73", !dbg !138
  %"75" = getelementptr inbounds i64* %"74", i64 %y.0, !dbg !138
  %"76" = load i64* %"75", align 8, !dbg !138
  %"77" = icmp ne i64 %"76", 0, !dbg !138
  %.found.1 = select i1 %"77", i64 1, i64 %found.1, !dbg !138
  %"78" = add nsw i64 %y.0, 1, !dbg !141
  %"79" = icmp sgt i64 %"78", 2147483647, !dbg !142
  br i1 %"79", label %main_bb23, label %main_bb24, !dbg !142

main_bb23:                                        ; preds = %main_bb22
  %"80" = sub nsw i64 %"78", 2147483647, !dbg !143
  %"81" = sub nsw i64 %"80", 1, !dbg !143
  %"82" = srem i64 %"81", 4294967296, !dbg !143
  %"83" = add nsw i64 -2147483648, %"82", !dbg !143
  br label %main_wrap_around.exit4, !dbg !143

main_bb24:                                        ; preds = %main_bb22
  %"84" = icmp slt i64 %"78", -2147483648, !dbg !144
  br i1 %"84", label %main_bb25, label %main_wrap_around.exit4, !dbg !144

main_bb25:                                        ; preds = %main_bb24
  %"85" = sub nsw i64 -2147483648, %"78", !dbg !145
  %"86" = sub nsw i64 %"85", 1, !dbg !145
  %"87" = srem i64 %"86", 4294967296, !dbg !145
  %"88" = sub nsw i64 2147483647, %"87", !dbg !145
  br label %main_wrap_around.exit4, !dbg !145

main_bb26:                                        ; preds = %main_wrap_around.exit6
  %"89" = add nsw i64 %xmin.0, 1, !dbg !146
  call void @llvm.dbg.value(metadata !{i64 %"89"}, i64 0, metadata !147), !dbg !148
  call void @llvm.dbg.value(metadata !71, i64 0, metadata !149), !dbg !150
  call void @llvm.dbg.value(metadata !74, i64 0, metadata !151), !dbg !152
  call void @llvm.dbg.value(metadata !77, i64 0, metadata !153), !dbg !154
  %"90" = icmp sgt i64 %"89", 2147483647, !dbg !155
  br i1 %"90", label %main_bb27, label %main_bb28, !dbg !155

main_bb27:                                        ; preds = %main_bb26
  %"91" = sub nsw i64 %"89", 2147483647, !dbg !156
  %"92" = sub nsw i64 %"91", 1, !dbg !156
  %"93" = srem i64 %"92", 4294967296, !dbg !156
  %"94" = add nsw i64 -2147483648, %"93", !dbg !156
  br label %main_wrap_around.exit2, !dbg !156

main_bb28:                                        ; preds = %main_bb26
  %"95" = icmp slt i64 %"89", -2147483648, !dbg !157
  br i1 %"95", label %main_bb29, label %main_wrap_around.exit2, !dbg !157

main_bb29:                                        ; preds = %main_bb28
  %"96" = sub nsw i64 -2147483648, %"89", !dbg !158
  %"97" = sub nsw i64 %"96", 1, !dbg !158
  %"98" = srem i64 %"97", 4294967296, !dbg !158
  %"99" = sub nsw i64 2147483647, %"98", !dbg !158
  br label %main_wrap_around.exit2, !dbg !158

main_bb30:                                        ; preds = %main_wrap_around.exit2
  call void @llvm.stackrestore(i8* %"16"), !dbg !159
  br label %main_bb31
