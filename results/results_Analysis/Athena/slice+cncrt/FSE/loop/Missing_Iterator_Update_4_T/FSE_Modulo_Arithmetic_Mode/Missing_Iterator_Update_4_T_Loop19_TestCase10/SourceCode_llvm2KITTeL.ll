...
main_bb5:
  ...
  br i1 %or.cond2, label %main_bb10, label %main_wrap_around.exit, !dbg !38

main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb9, %main_bb8, %main_bb7
  %x.0 = phi i64 [ %"22", %main_bb7 ], [ %"27", %main_bb9 ], [ %"17", %main_bb8 ], [ 0, %main_bb5 ]
  %"16" = icmp slt i64 %x.0, 65534, !dbg !46
  br i1 %"16", label %main_bb6, label %main_bb10, !dbg !46

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"17" = add nsw i64 %x.0, 1, !dbg !48
  %"18" = icmp sgt i64 %"17", 2147483647, !dbg !50
  br i1 %"18", label %main_bb7, label %main_bb8, !dbg !50

main_bb7:                                         ; preds = %main_bb6
  %"19" = sub nsw i64 %"17", 2147483647, !dbg !51
  %"20" = sub nsw i64 %"19", 1, !dbg !51
  %"21" = srem i64 %"20", 4294967296, !dbg !51
  %"22" = add nsw i64 -2147483648, %"21", !dbg !51
  br label %main_wrap_around.exit, !dbg !51

main_bb8:                                         ; preds = %main_bb6
  %"23" = icmp slt i64 %"17", -2147483648, !dbg !52
  br i1 %"23", label %main_bb9, label %main_wrap_around.exit, !dbg !52

main_bb9:                                         ; preds = %main_bb8
  %"24" = sub nsw i64 -2147483648, %"17", !dbg !53
  %"25" = sub nsw i64 %"24", 1, !dbg !53
  %"26" = srem i64 %"25", 4294967296, !dbg !53
  %"27" = sub nsw i64 2147483647, %"26", !dbg !53
...
!36 = metadata !{i32 786688, metadata !9, metadata !"mat_rowSize", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [mat_rowSize] [line 22]
...
!47 = metadata !{i32 786443, metadata !1, metadata !9, i32 43, i32 3, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 44, i32 8, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !9, i32 44, i32 1, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!54 = metadata !{i32 46, i32 17, metadata !9, null}
