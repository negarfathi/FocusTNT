...
main_bb5:
  ...
  %or.cond1 = or i1 %or.cond, %"14", !dbg !39
  %"15" = icmp sgt i64 10, 65534, !dbg !45
  %or.cond2 = or i1 %or.cond1, %"15", !dbg !39
...
main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb9, %main_bb8, %main_bb7
  ...
  br i1 %"16", label %main_bb6, label %main_bb10, !dbg !47

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"17" = add nsw i64 %x.0, 1, !dbg !49
  %"18" = icmp sgt i64 %"17", 2147483647, !dbg !51
  br i1 %"18", label %main_bb7, label %main_bb8, !dbg !51

main_bb7:                                         ; preds = %main_bb6
  %"19" = sub nsw i64 %"17", 2147483647, !dbg !52
  %"20" = sub nsw i64 %"19", 1, !dbg !52
  %"21" = srem i64 %"20", 4294967296, !dbg !52
  %"22" = add nsw i64 -2147483648, %"21", !dbg !52
  br label %main_wrap_around.exit, !dbg !52

main_bb8:                                         ; preds = %main_bb6
  %"23" = icmp slt i64 %"17", -2147483648, !dbg !53
  br i1 %"23", label %main_bb9, label %main_wrap_around.exit, !dbg !53

main_bb9:                                         ; preds = %main_bb8
  %"24" = sub nsw i64 -2147483648, %"17", !dbg !54
  %"25" = sub nsw i64 %"24", 1, !dbg !54
  %"26" = srem i64 %"25", 4294967296, !dbg !54
  %"27" = sub nsw i64 2147483647, %"26", !dbg !54
