...
main_bb5:
  ...
  %or.cond1 = or i1 %or.cond, %"14", !dbg !38
  %"15" = icmp sgt i64 65534, 65534, !dbg !44
  %or.cond2 = or i1 %or.cond1, %"15", !dbg !38
  %or.cond2.not = xor i1 %or.cond2, true, !dbg !38
  %"16" = icmp slt i64 0, 65534, !dbg !46
  %or.cond3 = and i1 %or.cond2.not, %"16", !dbg !38
  br i1 %or.cond3, label %main_wrap_around.exit, label %main_bb11, !dbg !38

main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb9, %main_bb8, %main_bb7, %main_bb10
  %y.0 = phi i64 [ 0, %main_bb10 ], [ %"23", %main_bb7 ], [ %"28", %main_bb9 ], [ %"18", %main_bb8 ], [ 0, %main_bb5 ]
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  %.old = icmp slt i64 0, 65534, !dbg !46
  br i1 %.old, label %main_wrap_around.exit, label %main_bb11, !dbg !46

main_bb11:                                        ; preds = %main_bb5, %main_bb10
  ret void, !dbg !57
}
...
!57 = metadata !{i32 49, i32 17, metadata !9, null}
