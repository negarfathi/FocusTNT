...
main_bb5:                                         ; preds = %main_bb3
  ...
  br i1 %"15", label %main_bb7, label %main_bb6, !dbg !55

main_bb6:                                         ; preds = %main_bb5, %main_bb8
  %entry.0 = phi i32 [ %.entry.0, %main_bb8 ], [ 0, %main_bb5 ]
...
main_bb8:                                         ; preds = %main_bb6
  %"17" = add nsw i32 %"8", %entry.0, !dbg !61
  %"18" = sext i32 %"17" to i64, !dbg !61
  %"19" = getelementptr inbounds [100000 x i32]* @memory0, i32 0, i64 %"18", !dbg !61
  %"20" = load i32* %"19", align 4, !dbg !61
  %"21" = icmp ne i32 %"20", 0, !dbg !61
  %"22" = add nsw i32 %entry.0, 1, !dbg !63
  %.entry.0 = select i1 %"21", i32 %"22", i32 %entry.0, !dbg !61
...
!48 = metadata !{i32 786443, metadata !1, metadata !44, i32 30, i32 7, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!60 = metadata !{i32 45, i32 17, metadata !9, null}
!61 = metadata !{i32 42, i32 11, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !59, i32 42, i32 11, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 42, i32 42, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !62, i32 42, i32 42, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 43, i32 5, metadata !59, null}
