...
main_bb1:
  ...
  %"3" = icmp sle i32 1001, 0, !dbg !32
  %"4" = icmp sgt i32 1001, 1000, !dbg !34
  %or.cond = or i1 %"3", %"4", !dbg !32
  br i1 %or.cond, label %main_bb7, label %main_bb2, !dbg !32

main_bb2:                                         ; preds = %main_bb1
  %"5" = sext i32 1001 to i64, !dbg !36
...
main_bb3:                                         ; preds = %main_bb4, %main_bb2
  ...
  %"9" = icmp slt i32 %i.0, 1001, !dbg !48
...
main_bb5:                                         ; preds = %main_bb3
  ...
  %"15" = icmp slt i32 5, 0, !dbg !57
  br i1 %"15", label %main_bb7, label %main_bb6, !dbg !57

main_bb6:                                         ; preds = %main_bb5, %main_bb8
  %entry.0 = phi i32 [ %.entry.0, %main_bb8 ], [ 5, %main_bb5 ]
  %"16" = icmp sge i32 %entry.0, 1001, !dbg !59
...
main_bb8:                                         ; preds = %main_bb6
  %"17" = add nsw i32 %"8", %entry.0, !dbg !63
  %"18" = sext i32 %"17" to i64, !dbg !63
  %"19" = getelementptr inbounds [100000 x i32]* @memory0, i32 0, i64 %"18", !dbg !63
  %"20" = load i32* %"19", align 4, !dbg !63
  %"21" = icmp ne i32 %"20", 0, !dbg !63
  %"22" = add nsw i32 %entry.0, 1, !dbg !65
  %.entry.0 = select i1 %"21", i32 %"22", i32 %entry.0, !dbg !63
  br label %main_bb6, !dbg !67
}
...
!62 = metadata !{i32 45, i32 17, metadata !9, null}
!63 = metadata !{i32 42, i32 11, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !61, i32 42, i32 11, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 42, i32 42, metadata !66, null}
!66 = metadata !{i32 786443, metadata !1, metadata !64, i32 42, i32 42, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!67 = metadata !{i32 43, i32 5, metadata !61, null}
