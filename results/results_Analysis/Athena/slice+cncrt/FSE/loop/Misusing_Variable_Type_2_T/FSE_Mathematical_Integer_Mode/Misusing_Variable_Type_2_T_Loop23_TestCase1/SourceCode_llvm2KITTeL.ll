...
main_bb1:
  ...
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !31), !dbg !32
  %"3" = sext i32 0 to i64, !dbg !33
  call void @llvm.dbg.value(metadata !{i64 %"3"}, i64 0, metadata !34), !dbg !36
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !38), !dbg !39
  call void @llvm.dbg.value(metadata !{i64 %"5"}, i64 0, metadata !38), !dbg !39
  br label %main_bb2, !dbg !40

main_bb2:                                         ; preds = %main_bb3, %main_bb1
  %i.0 = phi i64 [ 0, %main_bb1 ], [ %"5", %main_bb3 ]
  %"4" = icmp slt i64 %i.0, %"3", !dbg !41
  br i1 %"4", label %main_bb3, label %main_bb4, !dbg !41

main_bb3:                                         ; preds = %main_bb2
  %"5" = add nsw i64 %i.0, 1, !dbg !44
...
!29 = metadata !{i32 786688, metadata !4, metadata !"__retres", metadata !5, i32 7, metadata !8, i32 0, metadata !27} ; [ DW_TAG_auto_variable ] [__retres] [line 7]
!30 = metadata !{i32 7, i32 7, metadata !4, metadata !27}
!31 = metadata !{i32 786688, metadata !9, metadata !"tmp", metadata !5, i32 17, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp] [line 17]
!32 = metadata !{i32 17, i32 7, metadata !9, null}
!33 = metadata !{i32 19, i32 3, metadata !9, null}
!34 = metadata !{i32 786688, metadata !9, metadata !"max_fds", metadata !5, i32 19, metadata !35, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [max_fds] [line 19]
!35 = metadata !{i32 786468, null, null, metadata !"long int", i32 0, i64 64, i64 64, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ] [long int] [line 0, size 64, align 64, offset 0, enc DW_ATE_signed]
!36 = metadata !{i32 19, i32 8, metadata !9, null}
!37 = metadata !{i64 0}
!38 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 16, metadata !35, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 16]
!39 = metadata !{i32 16, i32 8, metadata !9, null}
!40 = metadata !{i32 21, i32 3, metadata !9, null}
!41 = metadata !{i32 21, i32 3, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !43, i32 21, i32 3, i32 3, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 3, i32 1, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 21, i32 23, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 23, i32 2, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 22, i32 3, metadata !9, null}
