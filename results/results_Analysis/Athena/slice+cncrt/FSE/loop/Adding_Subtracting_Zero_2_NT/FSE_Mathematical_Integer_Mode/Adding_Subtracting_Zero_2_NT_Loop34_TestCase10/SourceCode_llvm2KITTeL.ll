...
main_bb6:                                         ; preds = %main_bb5, %main_ff_subtitles_next_line_slice_1.exit
  %b.0 = phi i32 [ %"11", %main_ff_subtitles_next_line_slice_1.exit ], [ 1, %main_bb5 ]
  %"8" = icmp slt i32 %b.0, 100, !dbg !45
  br i1 %"8", label %main_bb7, label %main_bb9, !dbg !45
...
main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb7, %main_bb8
  %"11" = add nsw i32 %b.0, 0, !dbg !52
  %"12" = sub nsw i32 100, 4, !dbg !53
  %"13" = icmp sge i32 %"11", %"12", !dbg !53
  br i1 %"13", label %main_bb9, label %main_bb6, !dbg !53
...
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 38, i32 3, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 11, i32 7, metadata !22, metadata !48}
!48 = metadata !{i32 40, i32 13, metadata !49, null}
...
!52 = metadata !{i32 41, i32 5, metadata !49, null}
!53 = metadata !{i32 42, i32 9, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !49, i32 42, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 48, i32 17, metadata !9, null}
