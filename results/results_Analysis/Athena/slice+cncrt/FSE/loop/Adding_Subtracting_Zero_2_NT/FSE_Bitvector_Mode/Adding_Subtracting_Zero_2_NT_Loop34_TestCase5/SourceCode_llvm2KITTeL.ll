...
define void @main() #0 {
main_bb5:
  call void @llvm.dbg.value(metadata !27, i64 0, metadata !36), !dbg !37
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !39), !dbg !40
  %"6" = icmp slt i32 0, 0, !dbg !41
  %"7" = icmp slt i32 15, 0, !dbg !43
  %or.cond = or i1 %"6", %"7", !dbg !41
  br i1 %or.cond, label %main_bb8, label %main_bb6, !dbg !41
...
main_bb6:                                         ; preds = %main_bb5
  ...
  call void @llvm.dbg.value(metadata !{i32 %"11"}, i64 0, metadata !36), !dbg !37
...
main_bb7:                                         ; preds = %main_ff_subtitles_next_line_slice_1.exit, %main_bb6
  %b.0 = phi i32 [ 0, %main_bb6 ], [ %"11", %main_ff_subtitles_next_line_slice_1.exit ]
  %"9" = icmp slt i32 %b.0, 15, !dbg !56
  br i1 %"9", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb8, !dbg !56

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb7
  %"10" = icmp eq i32 %"8", 1, !dbg !49
  %. = select i1 %"10", i32 0, i32 10, !dbg !49
  %"11" = add nsw i32 %b.0, %., !dbg !58
  %"12" = sub nsw i32 15, 4, !dbg !59
  %"13" = icmp sge i32 %"11", %"12", !dbg !59
  br i1 %"13", label %main_bb8, label %main_bb7, !dbg !59
...
!46 = metadata !{i32 40, i32 13, metadata !47, null}
...
!50 = metadata !{i32 786688, metadata !47, metadata !"tmp_1", metadata !5, i32 39, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp_1] [line 39]
...
!57 = metadata !{i32 786443, metadata !1, metadata !9, i32 38, i32 3, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 41, i32 5, metadata !47, null}
!59 = metadata !{i32 42, i32 9, metadata !60, null}
!60 = metadata !{i32 786443, metadata !1, metadata !47, i32 42, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
