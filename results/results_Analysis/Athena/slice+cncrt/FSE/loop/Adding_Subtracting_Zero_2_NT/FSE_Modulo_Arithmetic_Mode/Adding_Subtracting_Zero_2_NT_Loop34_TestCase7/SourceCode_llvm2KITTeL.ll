...
main_bb13:
  ...
  %"28" = icmp slt i64 5, 0, !dbg !85
  %"29" = icmp slt i64 20, 0, !dbg !87
...
main_bb14:                                        ; preds = %main_bb13, %main_wrap_around.exit
  %b.0 = phi i64 [ %.0.i1, %main_wrap_around.exit ], [ 5, %main_bb13 ]
  %"30" = icmp slt i64 %b.0, 20, !dbg !89
