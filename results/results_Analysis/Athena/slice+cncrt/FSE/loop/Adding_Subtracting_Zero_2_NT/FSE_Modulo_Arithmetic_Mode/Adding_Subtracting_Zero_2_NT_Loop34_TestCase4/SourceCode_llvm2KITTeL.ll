...
main_bb13:
  ...
  %"28" = icmp slt i64 0, 0, !dbg !85
  %"29" = icmp slt i64 5, 0, !dbg !87
  %or.cond = or i1 %"28", %"29", !dbg !85
  br i1 %or.cond, label %main_bb22, label %main_bb14, !dbg !85
...
main_bb14:                                        ; preds = %main_bb13
  ...
  call void @llvm.dbg.value(metadata !{i64 %"33"}, i64 0, metadata !105), !dbg !107
  ...
  call void @llvm.dbg.value(metadata !{i64 %.0.i1}, i64 0, metadata !80), !dbg !81
  call void @llvm.dbg.value(metadata !{i64 %"44"}, i64 0, metadata !114), !dbg !117
  ...
  call void @llvm.dbg.value(metadata !124, i64 0, metadata !125), !dbg !127
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !128), !dbg !129
  call void @llvm.dbg.value(metadata !47, i64 0, metadata !130), !dbg !131
  call void @llvm.dbg.value(metadata !50, i64 0, metadata !132), !dbg !133
  br label %main_bb15, !dbg !134

main_bb15:                                        ; preds = %main_wrap_around.exit, %main_bb14
  %b.0 = phi i64 [ 0, %main_bb14 ], [ %.0.i1, %main_wrap_around.exit ]
  %"31" = icmp slt i64 %b.0, 5, !dbg !135
  br i1 %"31", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb22, !dbg !135

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb15
  %"32" = icmp eq i64 %"30", 1, !dbg !102
  %. = select i1 %"32", i64 0, i64 3, !dbg !102
  %"33" = add nsw i64 %b.0, %., !dbg !106
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !137
  br i1 %"34", label %main_bb16, label %main_bb17, !dbg !137

main_bb16:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"35" = sub nsw i64 %"33", 2147483647, !dbg !138
  %"36" = sub nsw i64 %"35", 1, !dbg !138
  %"37" = srem i64 %"36", 4294967296, !dbg !138
  %"38" = add nsw i64 -2147483648, %"37", !dbg !138
  br label %main_wrap_around.exit2, !dbg !138

main_bb17:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"39" = icmp slt i64 %"33", -2147483648, !dbg !139
  br i1 %"39", label %main_bb18, label %main_wrap_around.exit2, !dbg !139

main_bb18:                                        ; preds = %main_bb17
  %"40" = sub nsw i64 -2147483648, %"33", !dbg !140
  %"41" = sub nsw i64 %"40", 1, !dbg !140
  %"42" = srem i64 %"41", 4294967296, !dbg !140
  %"43" = sub nsw i64 2147483647, %"42", !dbg !140
  br label %main_wrap_around.exit2, !dbg !140

main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb17, %main_bb18
  %.0.i1 = phi i64 [ %"38", %main_bb16 ], [ %"43", %main_bb18 ], [ %"33", %main_bb17 ], !dbg !106
  %"44" = sub nsw i64 5, 4, !dbg !115
  %"45" = icmp sgt i64 %"44", 2147483647, !dbg !141
  br i1 %"45", label %main_bb19, label %main_bb20, !dbg !141

main_bb19:                                        ; preds = %main_wrap_around.exit2
  %"46" = sub nsw i64 %"44", 2147483647, !dbg !142
  %"47" = sub nsw i64 %"46", 1, !dbg !142
  %"48" = srem i64 %"47", 4294967296, !dbg !142
  %"49" = add nsw i64 -2147483648, %"48", !dbg !142
  br label %main_wrap_around.exit, !dbg !142

main_bb20:                                        ; preds = %main_wrap_around.exit2
  %"50" = icmp slt i64 %"44", -2147483648, !dbg !143
  br i1 %"50", label %main_bb21, label %main_wrap_around.exit, !dbg !143

main_bb21:                                        ; preds = %main_bb20
  %"51" = sub nsw i64 -2147483648, %"44", !dbg !144
  %"52" = sub nsw i64 %"51", 1, !dbg !144
  %"53" = srem i64 %"52", 4294967296, !dbg !144
  %"54" = sub nsw i64 2147483647, %"53", !dbg !144
  br label %main_wrap_around.exit, !dbg !144

main_wrap_around.exit:                            ; preds = %main_bb19, %main_bb20, %main_bb21
  %.0.i = phi i64 [ %"49", %main_bb19 ], [ %"54", %main_bb21 ], [ %"44", %main_bb20 ], !dbg !115
  %"55" = icmp sge i64 %.0.i1, %.0.i, !dbg !115
  br i1 %"55", label %main_bb22, label %main_bb15, !dbg !115
...
!90 = metadata !{i32 54, i32 13, metadata !91, null}
...
!103 = metadata !{i32 786688, metadata !91, metadata !"tmp_1", metadata !5, i32 53, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp_1] [line 53]
...
!106 = metadata !{i32 55, i32 9, metadata !91, null}
...
!115 = metadata !{i32 56, i32 14, metadata !116, null}
!116 = metadata !{i32 786443, metadata !1, metadata !91, i32 56, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!124 = metadata !{i64 3}
!125 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !126} ; [ DW_TAG_arg_variable ] [value] [line 8]
!126 = metadata !{i32 33, i32 14, metadata !66, metadata !90}
!127 = metadata !{i32 8, i32 33, metadata !4, metadata !126} ; [ DW_TAG_imported_declaration ]
!128 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !126} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!129 = metadata !{i32 8, i32 50, metadata !4, metadata !126} ; [ DW_TAG_imported_declaration ]
!130 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !126} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!131 = metadata !{i32 8, i32 73, metadata !4, metadata !126} ; [ DW_TAG_imported_declaration ]
!132 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !126} ; [ DW_TAG_auto_variable ] [range] [line 9]
!133 = metadata !{i32 9, i32 15, metadata !4, metadata !126}
!134 = metadata !{i32 52, i32 3, metadata !12, null}
!135 = metadata !{i32 52, i32 3, metadata !136, null}
!136 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 3, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!137 = metadata !{i32 10, i32 9, metadata !30, metadata !106}
!138 = metadata !{i32 11, i32 9, metadata !32, metadata !106}
!139 = metadata !{i32 13, i32 14, metadata !34, metadata !106}
!140 = metadata !{i32 14, i32 9, metadata !36, metadata !106}
!141 = metadata !{i32 10, i32 9, metadata !30, metadata !115}
!142 = metadata !{i32 11, i32 9, metadata !32, metadata !115}
!143 = metadata !{i32 13, i32 14, metadata !34, metadata !115}
!144 = metadata !{i32 14, i32 9, metadata !36, metadata !115}
!145 = metadata !{i32 62, i32 17, metadata !12, null}
