...
main_wrap_around.exit.i:                          ; preds = %main_bb14, %main_bb13, %main_bb12
  ...
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !87), !dbg !90
  call void @llvm.dbg.value(metadata !{i64 %"42"}, i64 0, metadata !91), !dbg !93
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !94), !dbg !95
  call void @llvm.dbg.value(metadata !47, i64 0, metadata !96), !dbg !97
  call void @llvm.dbg.value(metadata !50, i64 0, metadata !98), !dbg !99
  call void @llvm.dbg.value(metadata !81, i64 0, metadata !82), !dbg !83
  br label %main_bb15, !dbg !100

main_bb15:                                        ; preds = %main_bb16, %main_wrap_around.exit.i2, %main_wrap_around.exit.i
  %"39" = icmp eq i64 1, 0, !dbg !101
  br i1 %"39", label %main_bb16, label %main_bb21, !dbg !101

main_bb16:                                        ; preds = %main_bb15
  %"40" = icmp sle i64 20, 0, !dbg !103
  br i1 %"40", label %main_bb15, label %main_bb17, !dbg !103

main_bb17:                                        ; preds = %main_bb16
  %"41" = load i64* @"'flag", align 8, !dbg !92
  %"42" = add nsw i64 %"41", 1, !dbg !92
  %"43" = icmp sgt i64 %"42", 2147483647, !dbg !105
  br i1 %"43", label %main_bb18, label %main_bb19, !dbg !105

main_bb18:                                        ; preds = %main_bb17
  %"44" = sub nsw i64 %"42", 2147483647, !dbg !106
  %"45" = sub nsw i64 %"44", 1, !dbg !106
  %"46" = srem i64 %"45", 4294967296, !dbg !106
  %"47" = add nsw i64 -2147483648, %"46", !dbg !106
  br label %main_wrap_around.exit.i2, !dbg !106

main_bb19:                                        ; preds = %main_bb17
  %"48" = icmp slt i64 %"42", -2147483648, !dbg !107
  br i1 %"48", label %main_bb20, label %main_wrap_around.exit.i2, !dbg !107

main_bb20:                                        ; preds = %main_bb19
  %"49" = sub nsw i64 -2147483648, %"42", !dbg !108
  %"50" = sub nsw i64 %"49", 1, !dbg !108
  %"51" = srem i64 %"50", 4294967296, !dbg !108
  %"52" = sub nsw i64 2147483647, %"51", !dbg !108
  br label %main_wrap_around.exit.i2, !dbg !108

main_wrap_around.exit.i2:                         ; preds = %main_bb20, %main_bb19, %main_bb18
  %.0.i.i1 = phi i64 [ %"47", %main_bb18 ], [ %"52", %main_bb20 ], [ %"42", %main_bb19 ], !dbg !92
...
!88 = metadata !{i32 42, i32 10, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !12, i32 38, i32 19, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!90 = metadata !{i32 21, i32 13, metadata !9, metadata !88}
!91 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [value] [line 8]
!92 = metadata !{i32 22, i32 11, metadata !9, metadata !88}
!93 = metadata !{i32 8, i32 33, metadata !4, metadata !92} ; [ DW_TAG_imported_declaration ]
!94 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!95 = metadata !{i32 8, i32 50, metadata !4, metadata !92} ; [ DW_TAG_imported_declaration ]
!96 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!97 = metadata !{i32 8, i32 73, metadata !4, metadata !92} ; [ DW_TAG_imported_declaration ]
!98 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !92} ; [ DW_TAG_auto_variable ] [range] [line 9]
!99 = metadata !{i32 9, i32 15, metadata !4, metadata !92}
!100 = metadata !{i32 38, i32 3, metadata !12, null}
!101 = metadata !{i32 38, i32 3, metadata !102, null}
!102 = metadata !{i32 786443, metadata !1, metadata !12, i32 38, i32 3, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!103 = metadata !{i32 39, i32 9, metadata !104, null}
!104 = metadata !{i32 786443, metadata !1, metadata !89, i32 39, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!105 = metadata !{i32 10, i32 9, metadata !30, metadata !92}
!106 = metadata !{i32 11, i32 9, metadata !32, metadata !92}
!107 = metadata !{i32 13, i32 14, metadata !34, metadata !92}
!108 = metadata !{i32 14, i32 9, metadata !36, metadata !92}
!109 = metadata !{i32 43, i32 3, metadata !89, null}
