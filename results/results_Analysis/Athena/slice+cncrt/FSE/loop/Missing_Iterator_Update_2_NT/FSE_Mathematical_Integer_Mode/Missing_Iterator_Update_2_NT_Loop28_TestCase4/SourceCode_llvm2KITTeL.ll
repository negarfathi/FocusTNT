...
main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get_slice_1.exit1, %main_mdb_cursor_get_slice_1.exit
  %"7" = icmp eq i32 1, 0, !dbg !45
  br i1 %"7", label %main_bb4, label %main_bb5, !dbg !45

main_bb4:                                         ; preds = %main_bb3
  %"8" = icmp sle i32 20, 0, !dbg !47
  br i1 %"8", label %main_bb3, label %main_mdb_cursor_get_slice_1.exit1, !dbg !47

main_mdb_cursor_get_slice_1.exit1:                ; preds = %main_bb4
  %"9" = load i32* @"'flag", align 4, !dbg !49
...
!50 = metadata !{i32 27, i32 3, metadata !42, null}
