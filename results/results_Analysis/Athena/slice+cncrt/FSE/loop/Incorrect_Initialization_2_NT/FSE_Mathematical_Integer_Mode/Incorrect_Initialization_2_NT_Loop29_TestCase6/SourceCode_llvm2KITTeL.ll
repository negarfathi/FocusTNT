...
main_bb2:
  ...
  call void @llvm.dbg.value(metadata !{i32 %"7"}, i64 0, metadata !51), !dbg !54
...
main_bb3:                                         ; preds = %main_NewDefault, %main_bb5, %main_bb2
  ...
  %"5" = icmp eq i32 %matroska.0, 1, !dbg !57
  %..i = select i1 %"5", i32 0, i32 1, !dbg !58
  %"6" = icmp ne i32 %..i, 0, !dbg !59
  br i1 %"6", label %main_bb4, label %main_bb7, !dbg !59
...
main_bb5:                                         ; preds = %main_LeafBlock
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !37), !dbg !38
  br label %main_bb3, !dbg !61
...
main_bb6:                                         ; preds = %main_LeafBlock4
  %"7" = load i32* @"'flag", align 4, !dbg !64
  %"8" = load i32* @"'flag", align 4, !dbg !65
  %"9" = add nsw i32 %"8", 1, !dbg !65
  store i32 %"9", i32* @"'flag", align 4, !dbg !65
  %"10" = icmp slt i32 %"7", 100, !dbg !66
  %..i1 = select i1 %"10", i32 5, i32 -1, !dbg !67
  br label %main_bb4, !dbg !68
...
!52 = metadata !{i32 58, i32 32, metadata !53, null} ; [ DW_TAG_imported_module ]
!53 = metadata !{i32 786443, metadata !1, metadata !49, i32 39, i32 19, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 16, i32 7, metadata !9, metadata !52}
!55 = metadata !{i32 1}
!56 = metadata !{i32 34, i32 3, metadata !12, null}
!57 = metadata !{i32 8, i32 7, metadata !23, metadata !43} ; [ DW_TAG_imported_declaration ]
!58 = metadata !{i32 8, i32 15, metadata !25, metadata !43} ; [ DW_TAG_imported_declaration ]
!59 = metadata !{i32 36, i32 9, metadata !60, null}
!60 = metadata !{i32 786443, metadata !1, metadata !44, i32 36, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 63, i32 20, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !63, i32 63, i32 20, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 786443, metadata !1, metadata !44, i32 63, i32 9, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 17, i32 3, metadata !9, metadata !52}
!65 = metadata !{i32 18, i32 3, metadata !9, metadata !52}
!66 = metadata !{i32 19, i32 7, metadata !32, metadata !52}
!67 = metadata !{i32 23, i32 5, metadata !34, metadata !52}
!68 = metadata !{i32 62, i32 5, metadata !49, null}
!69 = metadata !{i32 65, i32 3, metadata !12, null}
