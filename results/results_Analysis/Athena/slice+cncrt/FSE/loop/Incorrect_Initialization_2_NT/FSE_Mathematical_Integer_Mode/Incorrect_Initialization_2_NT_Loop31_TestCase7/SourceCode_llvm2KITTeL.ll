...
res_return_slice_1_bb1:
  ...
  %. = select i1 %"4", i32 10, i32 -1, !dbg !33
  ret i32 %., !dbg !35
}
...
main_bb2:
  ...
  call void @llvm.dbg.value(metadata !{i32 %"7"}, i64 0, metadata !52), !dbg !55
  call void @llvm.dbg.value(metadata !{i32 %..i1}, i64 0, metadata !40), !dbg !41
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !40), !dbg !41
  br label %main_bb3, !dbg !57

main_bb3:                                         ; preds = %main_NewDefault, %main_bb5, %main_bb2
  %res.0 = phi i32 [ 0, %main_bb2 ], [ %res.1, %main_NewDefault ], [ %res.1, %main_bb5 ]
  %matroska.0 = phi i32 [ 5, %main_bb2 ], [ 1, %main_bb5 ], [ %matroska.0, %main_NewDefault ]
  %"5" = icmp eq i32 %matroska.0, 1, !dbg !58
  %..i = select i1 %"5", i32 0, i32 1, !dbg !59
  %"6" = icmp ne i32 %..i, 0, !dbg !60
  br i1 %"6", label %main_bb4, label %main_bb7, !dbg !60

main_bb4:                                         ; preds = %main_bb3, %main_bb6
  %res.1 = phi i32 [ %..i1, %main_bb6 ], [ %res.0, %main_bb3 ]
...
main_bb5:                                         ; preds = %main_LeafBlock
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !37), !dbg !38
  br label %main_bb3, !dbg !62
...
main_bb6:                                         ; preds = %main_LeafBlock4
  %"7" = load i32* @"'flag", align 4, !dbg !65
  %"8" = load i32* @"'flag", align 4, !dbg !66
  %"9" = add nsw i32 %"8", 1, !dbg !66
  store i32 %"9", i32* @"'flag", align 4, !dbg !66
  %"10" = icmp slt i32 %"7", 100, !dbg !67
  %..i1 = select i1 %"10", i32 10, i32 -1, !dbg !68
  br label %main_bb4, !dbg !69
...
!53 = metadata !{i32 58, i32 32, metadata !54, null} ; [ DW_TAG_imported_module ]
!54 = metadata !{i32 786443, metadata !1, metadata !50, i32 39, i32 19, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 16, i32 7, metadata !9, metadata !53}
!56 = metadata !{i32 1}
!57 = metadata !{i32 34, i32 3, metadata !12, null}
!58 = metadata !{i32 8, i32 7, metadata !23, metadata !43} ; [ DW_TAG_imported_declaration ]
!59 = metadata !{i32 8, i32 15, metadata !25, metadata !43} ; [ DW_TAG_imported_declaration ]
!60 = metadata !{i32 36, i32 9, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !44, i32 36, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 63, i32 20, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !64, i32 63, i32 20, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 786443, metadata !1, metadata !44, i32 63, i32 9, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 17, i32 3, metadata !9, metadata !53}
!66 = metadata !{i32 18, i32 3, metadata !9, metadata !53}
!67 = metadata !{i32 19, i32 7, metadata !32, metadata !53}
!68 = metadata !{i32 23, i32 5, metadata !34, metadata !53}
!69 = metadata !{i32 62, i32 5, metadata !50, null}
!70 = metadata !{i32 65, i32 3, metadata !12, null}
