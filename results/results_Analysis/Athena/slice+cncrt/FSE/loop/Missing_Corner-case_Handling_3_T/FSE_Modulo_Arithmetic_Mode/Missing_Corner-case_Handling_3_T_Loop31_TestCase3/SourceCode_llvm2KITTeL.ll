...
main_bb5:
  ...
  %"12" = icmp sle i64 3, 0, !dbg !39
  %"13" = icmp sle i64 3, 0, !dbg !41
  %or.cond = or i1 %"12", %"13", !dbg !39
  %"14" = icmp sgt i64 3, 65534, !dbg !43
  %or.cond12 = or i1 %or.cond, %"14", !dbg !39
  %"15" = icmp sgt i64 3, 65534, !dbg !45
...
main_wrap_around.exit:                            ; preds = %main_bb11, %main_bb10, %main_bb9, %main_bb7
  %num.0 = phi i64 [ -8, %main_bb7 ], [ %"27", %main_bb9 ], [ %"32", %main_bb11 ], [ %"22", %main_bb10 ]
  %"33" = srem i64 %num.0, 4, !dbg !80
  %"34" = mul nsw i64 %i.0, 3, !dbg !80
...
main_wrap_around.exit2:                           ; preds = %main_bb29, %main_bb28, %main_bb27, %main_wrap_around.exit8
  ...
  %"60" = icmp slt i64 %xmin.0, 3, !dbg !130
...
main_bb22:                                        ; preds = %main_wrap_around.exit6
  %"73" = mul nsw i64 %xmin.0, 3, !dbg !141
