...
main_bb5:
  ...
  %"12" = trunc i64 40000 to i32, !dbg !41
  %"13" = trunc i64 30000 to i32, !dbg !41
  call void @llvm.dbg.value(metadata !{i64 %"17"}, i64 0, metadata !42), !dbg !43
  ...
  call void @llvm.dbg.value(metadata !{i64 %"22"}, i64 0, metadata !39), !dbg !40
  br label %main_bb6, !dbg !53

main_bb6:                                         ; preds = %main_bb7, %main_bb5
  %s.0 = phi i64 [ 40000, %main_bb5 ], [ %"22", %main_bb7 ]
  %"14" = trunc i64 %s.0 to i32, !dbg !54
  %"15" = sext i32 %"14" to i64, !dbg !54
  %"16" = add nsw i32 %"12", %"13", !dbg !41
  %"17" = sext i32 %"16" to i64, !dbg !41
  %"18" = icmp slt i64 %"15", %"17", !dbg !41
  br i1 %"18", label %main_bb7, label %main_bb8, !dbg !41

main_bb7:                                         ; preds = %main_bb6
  %"19" = trunc i64 %s.0 to i32, !dbg !56
  %"20" = add nsw i32 %"19", 1, !dbg !56
  %"21" = trunc i32 %"20" to i16, !dbg !56
  %"22" = zext i16 %"21" to i64, !dbg !56
