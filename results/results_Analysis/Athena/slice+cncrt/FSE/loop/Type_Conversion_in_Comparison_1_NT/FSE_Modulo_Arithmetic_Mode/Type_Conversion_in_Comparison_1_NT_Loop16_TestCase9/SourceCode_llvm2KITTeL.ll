...
main_bb5:
  ...
  %"12" = trunc i64 60000 to i32, !dbg !40
  %"13" = trunc i64 60000 to i32, !dbg !40
  call void @llvm.dbg.value(metadata !{i64 %"17"}, i64 0, metadata !41), !dbg !42
  ...
  call void @llvm.dbg.value(metadata !{i64 %"22"}, i64 0, metadata !38), !dbg !39
  br label %main_bb6, !dbg !52

main_bb6:                                         ; preds = %main_bb7, %main_bb5
  %s.0 = phi i64 [ 60000, %main_bb5 ], [ %"22", %main_bb7 ]
  %"14" = trunc i64 %s.0 to i32, !dbg !53
  %"15" = sext i32 %"14" to i64, !dbg !53
  %"16" = add nsw i32 %"12", %"13", !dbg !40
  %"17" = sext i32 %"16" to i64, !dbg !40
  %"18" = icmp slt i64 %"15", %"17", !dbg !40
  br i1 %"18", label %main_bb7, label %main_bb8, !dbg !40

main_bb7:                                         ; preds = %main_bb6
  %"19" = trunc i64 %s.0 to i32, !dbg !55
  %"20" = add nsw i32 %"19", 1, !dbg !55
  %"21" = trunc i32 %"20" to i16, !dbg !55
  %"22" = zext i16 %"21" to i64, !dbg !55
  br label %main_bb6, !dbg !57
...
!33 = metadata !{i64 60000}
!34 = metadata !{i32 786688, metadata !9, metadata !"seqnum", metadata !5, i32 20, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [seqnum] [line 20]
!35 = metadata !{i32 20, i32 13, metadata !9, null}
!36 = metadata !{i32 786688, metadata !9, metadata !"len", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [len] [line 21]
!37 = metadata !{i32 21, i32 13, metadata !9, null}
!38 = metadata !{i32 786688, metadata !9, metadata !"s", metadata !5, i32 19, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [s] [line 19]
!39 = metadata !{i32 19, i32 13, metadata !9, null}
!40 = metadata !{i32 25, i32 19, metadata !9, null}
!41 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !40} ; [ DW_TAG_arg_variable ] [value] [line 7]
...
!54 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 3, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 26, i32 3, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !9, i32 26, i32 1, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 27, i32 1, metadata !56, null}
!58 = metadata !{i32 28, i32 3, metadata !9, null}
