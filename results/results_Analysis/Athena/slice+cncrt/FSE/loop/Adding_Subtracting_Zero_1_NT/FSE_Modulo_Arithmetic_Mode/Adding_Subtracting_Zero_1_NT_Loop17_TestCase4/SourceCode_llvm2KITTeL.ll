...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"13" = icmp sgt i64 %h.0, 0, !dbg !38
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !38

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = icmp sgt i64 %linesToRead.0, %h.0, !dbg !40
  %h.0.linesToRead.0 = select i1 %"14", i64 %h.0, i64 %linesToRead.0, !dbg !40
  %"15" = sub nsw i64 %h.0, %h.0.linesToRead.0, !dbg !43
...
!38 = metadata !{i32 24, i32 3, metadata !39, null}
!39 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 3, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!40 = metadata !{i32 25, i32 9, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !42, i32 25, i32 9, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 17, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 28, i32 9, metadata !42, null}
!44 = metadata !{i32 9, i32 9, metadata !25, metadata !43}
!45 = metadata !{i32 10, i32 9, metadata !27, metadata !43}
!46 = metadata !{i32 12, i32 14, metadata !29, metadata !43}
!47 = metadata !{i32 13, i32 9, metadata !31, metadata !43}
!48 = metadata !{i32 30, i32 17, metadata !9, null}
