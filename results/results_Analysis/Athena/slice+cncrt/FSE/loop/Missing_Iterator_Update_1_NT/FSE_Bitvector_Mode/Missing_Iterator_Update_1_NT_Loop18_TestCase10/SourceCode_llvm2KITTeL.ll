...
main_bb1:
  ...
  call void @llvm.dbg.value(metadata !17, i64 0, metadata !26), !dbg !30
  call void @llvm.dbg.value(metadata !17, i64 0, metadata !24), !dbg !25
  %"0" = load i32* @"'__fc_errno", align 4, !dbg !31
  br label %main_bb2, !dbg !22

main_bb2:                                         ; preds = %main_bb2, %main_bb1
  %ret.0 = phi i32 [ -999, %main_bb1 ], [ %.ret.0, %main_bb2 ]
  %"1" = icmp eq i32 %ret.0, 0, !dbg !34
  %.ret.0 = select i1 %"1", i32 -999, i32 %ret.0, !dbg !34
  %"2" = icmp slt i32 %.ret.0, 0, !dbg !35
  %"3" = icmp eq i32 %"0", 1, !dbg !31
  %or.cond = and i1 %"2", %"3", !dbg !35
  br i1 %or.cond, label %main_bb2, label %main_bb3, !dbg !35
...
!26 = metadata !{i32 786688, metadata !4, metadata !"num", metadata !5, i32 9, metadata !8, i32 0, metadata !27} ; [ DW_TAG_auto_variable ] [num] [line 9]
!27 = metadata !{i32 22, i32 23, metadata !28, null}
!28 = metadata !{i32 786443, metadata !1, metadata !29, i32 22, i32 23, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!29 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 7, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!30 = metadata !{i32 9, i32 7, metadata !4, metadata !27}
!31 = metadata !{i32 24, i32 9, metadata !32, null}
!32 = metadata !{i32 786443, metadata !1, metadata !33, i32 24, i32 9, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!33 = metadata !{i32 786443, metadata !1, metadata !9, i32 23, i32 7, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!34 = metadata !{i32 22, i32 7, metadata !29, null}
!35 = metadata !{i32 23, i32 7, metadata !33, null}
!36 = metadata !{i32 25, i32 3, metadata !9, null}
