...
main_bb0:
  ...
  %"2" = bitcast [10 x i32]* %new_ to i8*, !dbg !20
...
main_bb2:                                         ; preds = %main_bb1
  %"5" = add nsw i32 %j.0, 1, !dbg !36
  br label %main_bb1, !dbg !38

main_bb3:                                         ; preds = %main_bb1
  %"6" = getelementptr inbounds [10 x i32]* %old_, i32 0, i64 9, !dbg !39
  store i32 0, i32* %"6", align 4, !dbg !39
  %"7" = getelementptr inbounds [10 x i32]* %new_, i32 0, i64 9, !dbg !40
  store i32 0, i32* %"7", align 4, !dbg !40
  call void @llvm.dbg.value(metadata !{i32 %base.0}, i64 0, metadata !41), !dbg !43
  call void @llvm.dbg.value(metadata !{i32 %"15"}, i64 0, metadata !41), !dbg !43
...
main_bb4:                                         ; preds = %main_bb8, %main_bb3
  ...
  %"8" = sext i32 %i.0 to i64, !dbg !45
  %"9" = getelementptr inbounds [10 x i32]* %old_, i32 0, i64 %"8", !dbg !45
  %"10" = load i32* %"9", align 4, !dbg !45
  %"11" = sext i32 %i.0 to i64, !dbg !45
  %"12" = getelementptr inbounds [10 x i32]* %new_, i32 0, i64 %"11", !dbg !45
...
main_bb5:                                         ; preds = %main_bb6, %main_bb4
  ...
  %"14" = icmp ne i32 %"10", %"13", !dbg !45
  br i1 %"14", label %main_bb6, label %main_bb8, !dbg !45

main_bb6:                                         ; preds = %main_bb5
  %"15" = add nsw i32 %number.0, 1, !dbg !48
  %"16" = icmp eq i32 %"15", 110, !dbg !50
  br i1 %"16", label %main_bb7, label %main_bb5, !dbg !50

main_bb7:                                         ; preds = %main_bb6
  ret void, !dbg !52

main_bb8:                                         ; preds = %main_bb5
  %"17" = add nsw i32 %i.0, 1, !dbg !53
  call void @llvm.dbg.value(metadata !{i32 %"17"}, i64 0, metadata !22), !dbg !23
  %"18" = add nsw i32 %base.0, 8, !dbg !54
  call void @llvm.dbg.value(metadata !{i32 %"18"}, i64 0, metadata !25), !dbg !26
