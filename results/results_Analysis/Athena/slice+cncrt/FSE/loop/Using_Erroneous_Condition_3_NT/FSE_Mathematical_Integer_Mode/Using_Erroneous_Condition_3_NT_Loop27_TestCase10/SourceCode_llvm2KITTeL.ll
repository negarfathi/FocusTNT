...
main_bb3:                                         ; preds = %main_bb1
  ...
  call void @llvm.dbg.value(metadata !{i32 %"17"}, i64 0, metadata !41), !dbg !43
...
main_bb4:                                         ; preds = %main_bb8, %main_bb3
  ...
  %"10" = sext i32 %i.0 to i64, !dbg !45
  %"11" = getelementptr inbounds [10 x i32]* %old_, i32 0, i64 %"10", !dbg !45
  %"12" = load i32* %"11", align 4, !dbg !45
  %"13" = sext i32 %i.0 to i64, !dbg !45
  %"14" = getelementptr inbounds [10 x i32]* %new_, i32 0, i64 %"13", !dbg !45
...
main_bb5:                                         ; preds = %main_bb6, %main_bb4
  ...
  %"16" = icmp ne i32 %"12", %"15", !dbg !45
  br i1 %"16", label %main_bb6, label %main_bb8, !dbg !45

main_bb6:                                         ; preds = %main_bb5
  %"17" = add nsw i32 %number.0, 1, !dbg !48
  %"18" = icmp eq i32 %"17", 20, !dbg !50
  br i1 %"18", label %main_bb7, label %main_bb5, !dbg !50

main_bb7:                                         ; preds = %main_bb6
  ret void, !dbg !52

main_bb8:                                         ; preds = %main_bb5
  %"19" = add nsw i32 %i.0, 1, !dbg !53
  call void @llvm.dbg.value(metadata !{i32 %"19"}, i64 0, metadata !22), !dbg !23
  %"20" = add nsw i32 %base.0, 8, !dbg !54
