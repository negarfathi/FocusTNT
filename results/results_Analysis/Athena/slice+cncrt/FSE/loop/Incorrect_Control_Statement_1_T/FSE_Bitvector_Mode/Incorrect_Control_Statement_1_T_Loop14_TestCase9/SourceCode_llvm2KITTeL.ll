...
main_bb0:
  ...
  call void @llvm.memset.p0i8.i64(i8* %"0", i8 0, i64 101, i32 16, i1 false), !dbg !17
  %"1" = bitcast i8* %"0" to [101 x i8]*, !dbg !17
  %"2" = getelementptr [101 x i8]* %"1", i32 0, i32 0, !dbg !17
  store i8 58, i8* %"2", !dbg !17
  %"3" = getelementptr [101 x i8]* %"1", i32 0, i32 1, !dbg !17
  store i8 32, i8* %"3", !dbg !17
  %"4" = getelementptr [101 x i8]* %"1", i32 0, i32 2, !dbg !17
  store i8 9, i8* %"4", !dbg !17
