...
main_bb5:
  ...
  call void @llvm.memset.p0i8.i64(i8* %"14", i8 0, i64 80, i32 16, i1 false), !dbg !41
  %"15" = bitcast i8* %"14" to [10 x i64]*, !dbg !41
  %"16" = getelementptr [10 x i64]* %"15", i32 0, i32 3, !dbg !41
  store i64 5, i64* %"16", !dbg !41
  ...
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !49), !dbg !52
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"17" = icmp slt i64 %i.0, 10, !dbg !63
  br i1 %"17", label %main_bb6, label %main_wrap_around.exit2, !dbg !63

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"18" = add nsw i64 %i.0, 1, !dbg !50
  %"19" = icmp sgt i64 %"18", 2147483647, !dbg !65
  br i1 %"19", label %main_bb7, label %main_bb8, !dbg !65

main_bb7:                                         ; preds = %main_bb6
  %"20" = sub nsw i64 %"18", 2147483647, !dbg !66
  %"21" = sub nsw i64 %"20", 1, !dbg !66
  %"22" = srem i64 %"21", 4294967296, !dbg !66
  %"23" = add nsw i64 -2147483648, %"22", !dbg !66
  br label %main_wrap_around.exit, !dbg !66

main_bb8:                                         ; preds = %main_bb6
  %"24" = icmp slt i64 %"18", -2147483648, !dbg !67
  br i1 %"24", label %main_bb9, label %main_wrap_around.exit, !dbg !67

main_bb9:                                         ; preds = %main_bb8
  %"25" = sub nsw i64 -2147483648, %"18", !dbg !68
  %"26" = sub nsw i64 %"25", 1, !dbg !68
  %"27" = srem i64 %"26", 4294967296, !dbg !68
  %"28" = sub nsw i64 2147483647, %"27", !dbg !68
...
main_wrap_around.exit2:                           ; preds = %main_LeafBlock3, %main_bb18, %main_bb17, %main_bb16, %main_wrap_around.exit
  %i_0.0 = phi i64 [ 0, %main_wrap_around.exit ], [ %i_0.0, %main_LeafBlock3 ], [ %"45", %main_bb16 ], [ %"50", %main_bb18 ], [ %"40", %main_bb17 ]
  %"29" = icmp slt i64 %i_0.0, 10, !dbg !69
  br i1 %"29", label %main_bb10, label %main_bb19, !dbg !69

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"30" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i_0.0, !dbg !71
  %"31" = load i64* %"30", align 8, !dbg !71
...
main_bb11:                                        ; preds = %main_LeafBlock
  %"32" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !73
  %"33" = load i64* %"32", align 8, !dbg !73
  %"34" = icmp ne i64 %"33", 0, !dbg !73
  br i1 %"34", label %main_bb12, label %main_bb19, !dbg !73

main_bb12:                                        ; preds = %main_bb11
  %"35" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !76
  %"36" = load i64* %"35", align 8, !dbg !76
...
main_bb13:                                        ; preds = %main_NewDefault
  %"37" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !78
  %"38" = load i64* %"37", align 8, !dbg !78
  br label %main_bb14, !dbg !79

main_bb14:                                        ; preds = %main_bb13, %main_bb12
  %table.0 = phi i64 [ %"38", %main_bb13 ], [ %"36", %main_bb12 ]
  %"39" = icmp ne i64 %table.0, 0, !dbg !80
  br i1 %"39", label %main_bb19, label %main_bb15, !dbg !80

main_bb15:                                        ; preds = %main_bb14
  %"40" = add nsw i64 %i_0.0, 1, !dbg !82
  %"41" = icmp sgt i64 %"40", 2147483647, !dbg !83
  br i1 %"41", label %main_bb16, label %main_bb17, !dbg !83

main_bb16:                                        ; preds = %main_bb15
  %"42" = sub nsw i64 %"40", 2147483647, !dbg !84
  %"43" = sub nsw i64 %"42", 1, !dbg !84
  %"44" = srem i64 %"43", 4294967296, !dbg !84
  %"45" = add nsw i64 -2147483648, %"44", !dbg !84
  br label %main_wrap_around.exit2, !dbg !84

main_bb17:                                        ; preds = %main_bb15
  %"46" = icmp slt i64 %"40", -2147483648, !dbg !85
  br i1 %"46", label %main_bb18, label %main_wrap_around.exit2, !dbg !85

main_bb18:                                        ; preds = %main_bb17
  %"47" = sub nsw i64 -2147483648, %"40", !dbg !86
  %"48" = sub nsw i64 %"47", 1, !dbg !86
  %"49" = srem i64 %"48", 4294967296, !dbg !86
  %"50" = sub nsw i64 2147483647, %"49", !dbg !86
