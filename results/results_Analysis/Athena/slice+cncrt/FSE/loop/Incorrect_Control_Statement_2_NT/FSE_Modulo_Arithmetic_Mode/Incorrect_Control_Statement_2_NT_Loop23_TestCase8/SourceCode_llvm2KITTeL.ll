...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !49), !dbg !52
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %i.0 = phi i64 [ 0, %main_bb5 ], [ %"21", %main_bb7 ], [ %"26", %main_bb9 ], [ %"16", %main_bb8 ]
  %"15" = icmp slt i64 %i.0, 10, !dbg !63
  br i1 %"15", label %main_bb6, label %main_wrap_around.exit2, !dbg !63

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"16" = add nsw i64 %i.0, 1, !dbg !50
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !65
  br i1 %"17", label %main_bb7, label %main_bb8, !dbg !65

main_bb7:                                         ; preds = %main_bb6
  %"18" = sub nsw i64 %"16", 2147483647, !dbg !66
  %"19" = sub nsw i64 %"18", 1, !dbg !66
  %"20" = srem i64 %"19", 4294967296, !dbg !66
  %"21" = add nsw i64 -2147483648, %"20", !dbg !66
  br label %main_wrap_around.exit, !dbg !66

main_bb8:                                         ; preds = %main_bb6
  %"22" = icmp slt i64 %"16", -2147483648, !dbg !67
  br i1 %"22", label %main_bb9, label %main_wrap_around.exit, !dbg !67

main_bb9:                                         ; preds = %main_bb8
  %"23" = sub nsw i64 -2147483648, %"16", !dbg !68
  %"24" = sub nsw i64 %"23", 1, !dbg !68
  %"25" = srem i64 %"24", 4294967296, !dbg !68
  %"26" = sub nsw i64 2147483647, %"25", !dbg !68
...
main_wrap_around.exit2:                           ; preds = %main_LeafBlock3, %main_bb18, %main_bb17, %main_bb16, %main_wrap_around.exit
  %i_0.0 = phi i64 [ 0, %main_wrap_around.exit ], [ %i_0.0, %main_LeafBlock3 ], [ %"43", %main_bb16 ], [ %"48", %main_bb18 ], [ %"38", %main_bb17 ]
  %"27" = icmp slt i64 %i_0.0, 10, !dbg !69
  br i1 %"27", label %main_bb10, label %main_bb19, !dbg !69

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"28" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i_0.0, !dbg !71
  %"29" = load i64* %"28", align 8, !dbg !71
  br label %main_NodeBlock

main_NodeBlock:                                   ; preds = %main_bb10
  %Pivot = icmp slt i64 %"29", 2
  br i1 %Pivot, label %main_LeafBlock, label %main_LeafBlock3

main_LeafBlock:                                   ; preds = %main_NodeBlock
  %SwitchLeaf = icmp eq i64 %"29", 0
  br i1 %SwitchLeaf, label %main_bb11, label %main_NewDefault

main_bb11:                                        ; preds = %main_LeafBlock
  %"30" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !73
  %"31" = load i64* %"30", align 8, !dbg !73
  %"32" = icmp ne i64 %"31", 0, !dbg !73
  br i1 %"32", label %main_bb12, label %main_bb19, !dbg !73

main_bb12:                                        ; preds = %main_bb11
  %"33" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !76
  %"34" = load i64* %"33", align 8, !dbg !76
  br label %main_bb14, !dbg !77

main_LeafBlock3:                                  ; preds = %main_NodeBlock
  %SwitchLeaf4 = icmp eq i64 %"29", 2
...
main_bb14:                                        ; preds = %main_bb13, %main_bb12
  %table.0 = phi i64 [ %"36", %main_bb13 ], [ %"34", %main_bb12 ]
  %"37" = icmp ne i64 %table.0, 0, !dbg !80
  br i1 %"37", label %main_bb19, label %main_bb15, !dbg !80

main_bb15:                                        ; preds = %main_bb14
  %"38" = add nsw i64 %i_0.0, 1, !dbg !82
  %"39" = icmp sgt i64 %"38", 2147483647, !dbg !83
  br i1 %"39", label %main_bb16, label %main_bb17, !dbg !83

main_bb16:                                        ; preds = %main_bb15
  %"40" = sub nsw i64 %"38", 2147483647, !dbg !84
  %"41" = sub nsw i64 %"40", 1, !dbg !84
  %"42" = srem i64 %"41", 4294967296, !dbg !84
  %"43" = add nsw i64 -2147483648, %"42", !dbg !84
  br label %main_wrap_around.exit2, !dbg !84

main_bb17:                                        ; preds = %main_bb15
  %"44" = icmp slt i64 %"38", -2147483648, !dbg !85
  br i1 %"44", label %main_bb18, label %main_wrap_around.exit2, !dbg !85

main_bb18:                                        ; preds = %main_bb17
  %"45" = sub nsw i64 -2147483648, %"38", !dbg !86
  %"46" = sub nsw i64 %"45", 1, !dbg !86
  %"47" = srem i64 %"46", 4294967296, !dbg !86
  %"48" = sub nsw i64 2147483647, %"47", !dbg !86
