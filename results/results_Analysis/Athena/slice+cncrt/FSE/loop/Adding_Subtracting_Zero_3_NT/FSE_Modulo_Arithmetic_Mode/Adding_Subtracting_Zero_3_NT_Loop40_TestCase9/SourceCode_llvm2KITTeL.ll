...
main_bb20:
  ...
  br i1 %or.cond, label %main_bb37, label %main_wrap_around.exit2, !dbg !121

main_wrap_around.exit2:                           ; preds = %main_bb20, %main_bb36, %main_bb35, %main_bb34, %main_wrap_around.exit4
  %__fc_errno_0.0 = phi i64 [ %.0.i3, %main_wrap_around.exit4 ], [ %__fc_errno_0.0, %main_bb34 ], [ %__fc_errno_0.0, %main_bb35 ], [ %__fc_errno_0.0, %main_bb36 ], [ 0, %main_bb20 ]
  %pos.0 = phi i64 [ %pos.0, %main_wrap_around.exit4 ], [ %"94", %main_bb34 ], [ %"99", %main_bb36 ], [ %"89", %main_bb35 ], [ 0, %main_bb20 ]
  %"52" = icmp slt i64 %pos.0, 30, !dbg !125
  br i1 %"52", label %main_bb21, label %main_bb37, !dbg !125
...
main_read_slice_1.exit:                           ; preds = %main_bb26, %main_bb27, %main_bb28, %main_wrap_around.exit2.i
  ...
  %"76" = icmp eq i64 %__retres.0.i, -1, !dbg !140
  br i1 %"76", label %main_bb29, label %main_bb33, !dbg !140

main_bb29:                                        ; preds = %main_read_slice_1.exit
  %"77" = add nsw i64 %__fc_errno_0.0, 1, !dbg !142
  %"78" = icmp sgt i64 %"77", 2147483647, !dbg !144
  br i1 %"78", label %main_bb30, label %main_bb31, !dbg !144

main_bb30:                                        ; preds = %main_bb29
  %"79" = sub nsw i64 %"77", 2147483647, !dbg !145
  %"80" = sub nsw i64 %"79", 1, !dbg !145
  %"81" = srem i64 %"80", 4294967296, !dbg !145
  %"82" = add nsw i64 -2147483648, %"81", !dbg !145
  br label %main_wrap_around.exit4, !dbg !145

main_bb31:                                        ; preds = %main_bb29
  %"83" = icmp slt i64 %"77", -2147483648, !dbg !146
  br i1 %"83", label %main_bb32, label %main_wrap_around.exit4, !dbg !146

main_bb32:                                        ; preds = %main_bb31
  %"84" = sub nsw i64 -2147483648, %"77", !dbg !147
  %"85" = sub nsw i64 %"84", 1, !dbg !147
  %"86" = srem i64 %"85", 4294967296, !dbg !147
  %"87" = sub nsw i64 2147483647, %"86", !dbg !147
  br label %main_wrap_around.exit4, !dbg !147

main_wrap_around.exit4:                           ; preds = %main_bb30, %main_bb31, %main_bb32
  %.0.i3 = phi i64 [ %"82", %main_bb30 ], [ %"87", %main_bb32 ], [ %"77", %main_bb31 ], !dbg !142
  %"88" = icmp eq i64 %.0.i3, 5, !dbg !148
  br i1 %"88", label %main_bb37, label %main_wrap_around.exit2, !dbg !148

main_bb33:                                        ; preds = %main_read_slice_1.exit
  %"89" = add nsw i64 %pos.0, %__retres.0.i, !dbg !150
  %"90" = icmp sgt i64 %"89", 2147483647, !dbg !151
  br i1 %"90", label %main_bb34, label %main_bb35, !dbg !151

main_bb34:                                        ; preds = %main_bb33
  %"91" = sub nsw i64 %"89", 2147483647, !dbg !152
  %"92" = sub nsw i64 %"91", 1, !dbg !152
  %"93" = srem i64 %"92", 4294967296, !dbg !152
  %"94" = add nsw i64 -2147483648, %"93", !dbg !152
  br label %main_wrap_around.exit2, !dbg !152

main_bb35:                                        ; preds = %main_bb33
  %"95" = icmp slt i64 %"89", -2147483648, !dbg !153
  br i1 %"95", label %main_bb36, label %main_wrap_around.exit2, !dbg !153

main_bb36:                                        ; preds = %main_bb35
  %"96" = sub nsw i64 -2147483648, %"89", !dbg !154
  %"97" = sub nsw i64 %"96", 1, !dbg !154
  %"98" = srem i64 %"97", 4294967296, !dbg !154
  %"99" = sub nsw i64 2147483647, %"98", !dbg !154
  br label %main_wrap_around.exit2, !dbg !154

main_bb37:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit4, %main_bb20
  ret void, !dbg !155
}
...
!140 = metadata !{i32 64, i32 9, metadata !141, null}
!141 = metadata !{i32 786443, metadata !1, metadata !128, i32 64, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!142 = metadata !{i32 65, i32 23, metadata !143, null}
!143 = metadata !{i32 786443, metadata !1, metadata !141, i32 64, i32 19, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!144 = metadata !{i32 10, i32 9, metadata !30, metadata !142}
!145 = metadata !{i32 11, i32 9, metadata !32, metadata !142}
!146 = metadata !{i32 13, i32 14, metadata !34, metadata !142}
!147 = metadata !{i32 14, i32 9, metadata !36, metadata !142}
!148 = metadata !{i32 66, i32 11, metadata !149, null}
!149 = metadata !{i32 786443, metadata !1, metadata !143, i32 66, i32 11, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!150 = metadata !{i32 72, i32 11, metadata !128, null}
!151 = metadata !{i32 10, i32 9, metadata !30, metadata !150}
!152 = metadata !{i32 11, i32 9, metadata !32, metadata !150}
!153 = metadata !{i32 13, i32 14, metadata !34, metadata !150}
!154 = metadata !{i32 14, i32 9, metadata !36, metadata !150}
!155 = metadata !{i32 74, i32 17, metadata !12, null}
