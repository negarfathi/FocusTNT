...
main_bb5:
  ...
  %"12" = icmp slt i64 10, 0, !dbg !43
  %"13" = icmp sle i64 0, 0, !dbg !45
  %or.cond = or i1 %"12", %"13", !dbg !43
  %"14" = icmp sle i64 1, 0, !dbg !47
  %or.cond5 = or i1 %or.cond, %"14", !dbg !43
  %"15" = icmp sgt i64 1, 0, !dbg !49
  %or.cond6 = or i1 %or.cond5, %"15", !dbg !43
  %"16" = icmp sgt i64 0, 65534, !dbg !51
  %or.cond7 = or i1 %or.cond6, %"16", !dbg !43
  br i1 %or.cond7, label %main_bb18, label %main_bb6, !dbg !43

main_bb6:                                         ; preds = %main_bb5
  %"17" = srem i64 10, 0, !dbg !53
...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  ...
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !71), !dbg !72
  call void @llvm.dbg.value(metadata !{i64 %"42"}, i64 0, metadata !73), !dbg !76
  ...
  %"28" = srem i64 10, 1, !dbg !83
  call void @llvm.dbg.value(metadata !{i64 %"31"}, i64 0, metadata !86), !dbg !87
...
main_wrap_around.exit2:                           ; preds = %main_bb17, %main_bb16, %main_bb15, %main_wrap_around.exit
  ...
  %i.0 = phi i64 [ %.0.i, %main_wrap_around.exit ], [ %"47", %main_bb15 ], [ %"52", %main_bb17 ], [ %"42", %main_bb16 ]
  %"29" = icmp slt i64 %i.0, 0, !dbg !95
  br i1 %"29", label %main_bb10, label %main_bb18, !dbg !95

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"30" = icmp ne i64 %r.0, 0, !dbg !97
  br i1 %"30", label %main_wrap_around.exit4, label %main_bb11, !dbg !97

main_bb11:                                        ; preds = %main_bb10
  %"31" = add nsw i64 %"28", 1, !dbg !83
  %"32" = icmp sgt i64 %"31", 2147483647, !dbg !98
  br i1 %"32", label %main_bb12, label %main_bb13, !dbg !98

main_bb12:                                        ; preds = %main_bb11
  %"33" = sub nsw i64 %"31", 2147483647, !dbg !99
  %"34" = sub nsw i64 %"33", 1, !dbg !99
  %"35" = srem i64 %"34", 4294967296, !dbg !99
  %"36" = add nsw i64 -2147483648, %"35", !dbg !99
  br label %main_wrap_around.exit4, !dbg !99

main_bb13:                                        ; preds = %main_bb11
  %"37" = icmp slt i64 %"31", -2147483648, !dbg !100
  br i1 %"37", label %main_bb14, label %main_wrap_around.exit4, !dbg !100

main_bb14:                                        ; preds = %main_bb13
  %"38" = sub nsw i64 -2147483648, %"31", !dbg !101
  %"39" = sub nsw i64 %"38", 1, !dbg !101
  %"40" = srem i64 %"39", 4294967296, !dbg !101
  %"41" = sub nsw i64 2147483647, %"40", !dbg !101
  br label %main_wrap_around.exit4, !dbg !101

main_wrap_around.exit4:                           ; preds = %main_bb14, %main_bb13, %main_bb12, %main_bb10
  %r.1 = phi i64 [ %r.0, %main_bb10 ], [ %"36", %main_bb12 ], [ %"41", %main_bb14 ], [ %"31", %main_bb13 ]
  %"42" = add nsw i64 %i.0, %r.1, !dbg !74
  %"43" = icmp sgt i64 %"42", 2147483647, !dbg !102
  br i1 %"43", label %main_bb15, label %main_bb16, !dbg !102

main_bb15:                                        ; preds = %main_wrap_around.exit4
  %"44" = sub nsw i64 %"42", 2147483647, !dbg !103
  %"45" = sub nsw i64 %"44", 1, !dbg !103
  %"46" = srem i64 %"45", 4294967296, !dbg !103
  %"47" = add nsw i64 -2147483648, %"46", !dbg !103
  br label %main_wrap_around.exit2, !dbg !103

main_bb16:                                        ; preds = %main_wrap_around.exit4
  %"48" = icmp slt i64 %"42", -2147483648, !dbg !104
  br i1 %"48", label %main_bb17, label %main_wrap_around.exit2, !dbg !104

main_bb17:                                        ; preds = %main_bb16
  %"49" = sub nsw i64 -2147483648, %"42", !dbg !105
  %"50" = sub nsw i64 %"49", 1, !dbg !105
  %"51" = srem i64 %"50", 4294967296, !dbg !105
  %"52" = sub nsw i64 2147483647, %"51", !dbg !105
...
!71 = metadata !{i32 786688, metadata !9, metadata !"r", metadata !5, i32 32, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [r] [line 32]
!72 = metadata !{i32 32, i32 15, metadata !9, null}
!73 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !74} ; [ DW_TAG_arg_variable ] [value] [line 12]
!74 = metadata !{i32 38, i32 13, metadata !75, null}
!75 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 12, i32 33, metadata !4, metadata !74}
!77 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !74} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!78 = metadata !{i32 12, i32 50, metadata !4, metadata !74}
!79 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !74} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!80 = metadata !{i32 12, i32 73, metadata !4, metadata !74}
!81 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !74} ; [ DW_TAG_auto_variable ] [range] [line 13]
!82 = metadata !{i32 13, i32 15, metadata !4, metadata !74}
!83 = metadata !{i32 36, i32 7, metadata !84, null}
!84 = metadata !{i32 786443, metadata !1, metadata !85, i32 36, i32 1, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!85 = metadata !{i32 786443, metadata !1, metadata !75, i32 35, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!86 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !83} ; [ DW_TAG_arg_variable ] [value] [line 12]
!87 = metadata !{i32 12, i32 33, metadata !4, metadata !83}
!88 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !83} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!89 = metadata !{i32 12, i32 50, metadata !4, metadata !83}
!90 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !83} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!91 = metadata !{i32 12, i32 73, metadata !4, metadata !83}
!92 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !83} ; [ DW_TAG_auto_variable ] [range] [line 13]
!93 = metadata !{i32 13, i32 15, metadata !4, metadata !83}
!94 = metadata !{i32 33, i32 5, metadata !9, null}
!95 = metadata !{i32 33, i32 5, metadata !96, null}
!96 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 5, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!97 = metadata !{i32 35, i32 13, metadata !85, null}
!98 = metadata !{i32 14, i32 9, metadata !26, metadata !83}
!99 = metadata !{i32 15, i32 9, metadata !28, metadata !83}
!100 = metadata !{i32 17, i32 14, metadata !30, metadata !83}
!101 = metadata !{i32 18, i32 9, metadata !32, metadata !83}
!102 = metadata !{i32 14, i32 9, metadata !26, metadata !74}
!103 = metadata !{i32 15, i32 9, metadata !28, metadata !74}
!104 = metadata !{i32 17, i32 14, metadata !30, metadata !74}
!105 = metadata !{i32 18, i32 9, metadata !32, metadata !74}
!106 = metadata !{i32 41, i32 1, metadata !9, null}
