...
main_bb5:
  ...
  %"12" = icmp sle i64 4294967295, 0, !dbg !44
  %"13" = icmp eq i64 2147483648, 0, !dbg !46
  %or.cond = or i1 %"12", %"13", !dbg !44
  br i1 %or.cond, label %main_bb11, label %main_bb6, !dbg !44

main_bb6:                                         ; preds = %main_bb5, %main_wrap_around.exit
  %cur.0 = phi i64 [ %.0.i, %main_wrap_around.exit ], [ 2147483648, %main_bb5 ]
  %"14" = icmp slt i64 4294967295, %cur.0, !dbg !48
  br i1 %"14", label %main_bb11, label %main_bb7, !dbg !48

main_bb7:                                         ; preds = %main_bb6
  %"15" = add nsw i64 %cur.0, 2147483648, !dbg !51
  %"16" = icmp sgt i64 %"15", 4294967295, !dbg !52
  br i1 %"16", label %main_bb8, label %main_bb9, !dbg !52

main_bb8:                                         ; preds = %main_bb7
  %"17" = sub nsw i64 %"15", 4294967295, !dbg !53
  %"18" = sub nsw i64 %"17", 1, !dbg !53
  %"19" = srem i64 %"18", 4294967296, !dbg !53
  br label %main_wrap_around.exit, !dbg !53

main_bb9:                                         ; preds = %main_bb7
  %"20" = icmp slt i64 %"15", 0, !dbg !54
  br i1 %"20", label %main_bb10, label %main_wrap_around.exit, !dbg !54

main_bb10:                                        ; preds = %main_bb9
  %"21" = sub nsw i64 0, %"15", !dbg !55
  %"22" = sub nsw i64 %"21", 1, !dbg !55
  %"23" = srem i64 %"22", 4294967296, !dbg !55
  %"24" = sub nsw i64 4294967295, %"23", !dbg !55
  br label %main_wrap_around.exit, !dbg !55

main_wrap_around.exit:                            ; preds = %main_bb8, %main_bb9, %main_bb10
  %.0.i = phi i64 [ %"19", %main_bb8 ], [ %"24", %main_bb10 ], [ %"15", %main_bb9 ], !dbg !51
  %"25" = icmp sle i64 %.0.i, %cur.0, !dbg !56
  br i1 %"25", label %main_bb11, label %main_bb6, !dbg !56
