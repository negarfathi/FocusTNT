...
main_bb0:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"2"}, i64 0, metadata !12), !dbg !14
  br label %main_bb1, !dbg !15

main_bb1:                                         ; preds = %main_bb3, %main_bb0
  %i.0 = phi i64 [ 1, %main_bb0 ], [ %"2", %main_bb3 ]
  %"0" = icmp sgt i64 %i.0, 4294967295, !dbg !16
  %"1" = icmp eq i64 %i.0, 2147483648, !dbg !18
  %or.cond = or i1 %"0", %"1", !dbg !16
  br i1 %or.cond, label %main_bb2, label %main_bb3, !dbg !16

main_bb2:                                         ; preds = %main_bb1
  ret void, !dbg !21

main_bb3:                                         ; preds = %main_bb1
  %"2" = shl i64 %i.0, 1, !dbg !22
...
!14 = metadata !{i32 4, i32 8, metadata !4, null}
!15 = metadata !{i32 6, i32 3, metadata !4, null}
!16 = metadata !{i32 6, i32 3, metadata !17, null}
!17 = metadata !{i32 786443, metadata !1, metadata !4, i32 6, i32 3, i32 1, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!18 = metadata !{i32 7, i32 9, metadata !19, null}
!19 = metadata !{i32 786443, metadata !1, metadata !20, i32 7, i32 9, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!20 = metadata !{i32 786443, metadata !1, metadata !4, i32 6, i32 33, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!21 = metadata !{i32 13, i32 3, metadata !4, null}
!22 = metadata !{i32 11, i32 5, metadata !20, null}
!23 = metadata !{i32 12, i32 3, metadata !20, null}
