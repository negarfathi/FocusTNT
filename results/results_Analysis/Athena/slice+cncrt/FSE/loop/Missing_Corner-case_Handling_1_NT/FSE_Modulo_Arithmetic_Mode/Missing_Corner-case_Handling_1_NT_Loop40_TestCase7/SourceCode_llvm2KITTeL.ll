...
main_bb14:
  ...
  call void @llvm.dbg.value(metadata !{i64 %__retres.2.i}, i64 0, metadata !87), !dbg !88
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !89), !dbg !90
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !91), !dbg !93
  call void @llvm.dbg.value(metadata !52, i64 0, metadata !94), !dbg !95
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !96), !dbg !97
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !98), !dbg !99
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !89), !dbg !90
  call void @llvm.dbg.value(metadata !{i64 %"36"}, i64 0, metadata !100), !dbg !102
  call void @llvm.dbg.value(metadata !52, i64 0, metadata !103), !dbg !104
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !105), !dbg !106
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !107), !dbg !108
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !109), !dbg !110
  br label %main_bb15, !dbg !111

main_bb15:                                        ; preds = %main_read_slice_1.exit, %main_bb14
  %"32" = icmp eq i64 %"31", 1, !dbg !84
  %"33" = load i64* @"'count", align 8, !dbg !85
  %"34" = icmp sgt i64 %"33", 100, !dbg !112
  %or.cond.i = or i1 %"32", %"34", !dbg !84
  br i1 %or.cond.i, label %main_read_slice_1.exit, label %main_bb16, !dbg !84

main_bb16:                                        ; preds = %main_bb15
  %"35" = load i64* @"'count", align 8, !dbg !101
  %"36" = add nsw i64 %"35", 1, !dbg !101
  %"37" = icmp sgt i64 %"36", 2147483647, !dbg !113
  br i1 %"37", label %main_bb17, label %main_bb18, !dbg !113

main_bb17:                                        ; preds = %main_bb16
  %"38" = sub nsw i64 %"36", 2147483647, !dbg !114
  %"39" = sub nsw i64 %"38", 1, !dbg !114
  %"40" = srem i64 %"39", 4294967296, !dbg !114
  %"41" = add nsw i64 -2147483648, %"40", !dbg !114
  br label %main_wrap_around.exit.i, !dbg !114

main_bb18:                                        ; preds = %main_bb16
  %"42" = icmp slt i64 %"36", -2147483648, !dbg !115
  br i1 %"42", label %main_bb19, label %main_wrap_around.exit.i, !dbg !115

main_bb19:                                        ; preds = %main_bb18
  %"43" = sub nsw i64 -2147483648, %"36", !dbg !116
  %"44" = sub nsw i64 %"43", 1, !dbg !116
  %"45" = srem i64 %"44", 4294967296, !dbg !116
  %"46" = sub nsw i64 2147483647, %"45", !dbg !116
  br label %main_wrap_around.exit.i, !dbg !116

main_wrap_around.exit.i:                          ; preds = %main_bb19, %main_bb18, %main_bb17
  %.0.i.i = phi i64 [ %"41", %main_bb17 ], [ %"46", %main_bb19 ], [ %"36", %main_bb18 ], !dbg !101
  store i64 %.0.i.i, i64* @"'count", align 8, !dbg !101
  br label %main_read_slice_1.exit, !dbg !117

main_read_slice_1.exit:                           ; preds = %main_bb15, %main_wrap_around.exit.i
  %__retres.2.i = phi i64 [ 0, %main_bb15 ], [ 100, %main_wrap_around.exit.i ], !dbg !85
  %"47" = icmp slt i64 %__retres.2.i, 0, !dbg !118
  br i1 %"47", label %main_bb20, label %main_bb15, !dbg !118

main_bb20:                                        ; preds = %main_read_slice_1.exit
  ret void, !dbg !120
}
...
!91 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777225, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [value] [line 9]
!92 = metadata !{i32 36, i32 11, metadata !49, metadata !85}
!93 = metadata !{i32 9, i32 33, metadata !4, metadata !92}
!94 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554441, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [lower_bound] [line 9]
!95 = metadata !{i32 9, i32 50, metadata !4, metadata !92}
!96 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331657, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [upper_bound] [line 9]
!97 = metadata !{i32 9, i32 73, metadata !4, metadata !92}
!98 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 10, metadata !8, i32 0, metadata !92} ; [ DW_TAG_auto_variable ] [range] [line 10]
!99 = metadata !{i32 10, i32 15, metadata !4, metadata !92}
!100 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777225, metadata !8, i32 0, metadata !101} ; [ DW_TAG_arg_variable ] [value] [line 9]
!101 = metadata !{i32 38, i32 16, metadata !64, metadata !85}
!102 = metadata !{i32 9, i32 33, metadata !4, metadata !101}
!103 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554441, metadata !8, i32 0, metadata !101} ; [ DW_TAG_arg_variable ] [lower_bound] [line 9]
!104 = metadata !{i32 9, i32 50, metadata !4, metadata !101}
!105 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331657, metadata !8, i32 0, metadata !101} ; [ DW_TAG_arg_variable ] [upper_bound] [line 9]
!106 = metadata !{i32 9, i32 73, metadata !4, metadata !101}
!107 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 10, metadata !8, i32 0, metadata !101} ; [ DW_TAG_auto_variable ] [range] [line 10]
!108 = metadata !{i32 10, i32 15, metadata !4, metadata !101}
!109 = metadata !{i32 786688, metadata !9, metadata !"__retres", metadata !5, i32 21, metadata !8, i32 0, metadata !85} ; [ DW_TAG_auto_variable ] [__retres] [line 21]
!110 = metadata !{i32 21, i32 13, metadata !9, metadata !85}
!111 = metadata !{i32 51, i32 3, metadata !12, null}
!112 = metadata !{i32 27, i32 9, metadata !42, metadata !85}
!113 = metadata !{i32 11, i32 9, metadata !31, metadata !101}
!114 = metadata !{i32 12, i32 9, metadata !33, metadata !101}
!115 = metadata !{i32 14, i32 14, metadata !35, metadata !101}
!116 = metadata !{i32 15, i32 9, metadata !37, metadata !101}
!117 = metadata !{i32 40, i32 5, metadata !64, metadata !85}
!118 = metadata !{i32 54, i32 9, metadata !119, null}
!119 = metadata !{i32 786443, metadata !1, metadata !86, i32 54, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!120 = metadata !{i32 59, i32 3, metadata !12, null}
