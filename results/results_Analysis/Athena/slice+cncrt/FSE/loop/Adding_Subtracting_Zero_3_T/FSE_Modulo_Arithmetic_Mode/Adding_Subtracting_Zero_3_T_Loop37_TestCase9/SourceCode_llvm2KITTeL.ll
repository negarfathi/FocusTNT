...
read_slice_1_wrap_around.exit:                    ; preds = %read_slice_1_bb11, %read_slice_1_bb10, %read_slice_1_bb9, %read_slice_1_bb7
  %num.0 = phi i64 [ -999, %read_slice_1_bb7 ], [ %"20", %read_slice_1_bb9 ], [ %"25", %read_slice_1_bb11 ], [ %"15", %read_slice_1_bb10 ]
...
main_bb20:
  ...
  %"50" = icmp sle i64 30, 0, !dbg !121
  %"51" = icmp sgt i64 30, 65536, !dbg !123
  %or.cond = or i1 %"50", %"51", !dbg !121
  br i1 %or.cond, label %main_bb40, label %main_wrap_around.exit2, !dbg !121

main_wrap_around.exit2:                           ; preds = %main_bb20, %main_bb39, %main_bb38, %main_bb37, %main_wrap_around.exit6
  %__fc_errno_0.0 = phi i64 [ %.0.i5, %main_wrap_around.exit6 ], [ %__fc_errno_0.0, %main_bb37 ], [ %__fc_errno_0.0, %main_bb38 ], [ %__fc_errno_0.0, %main_bb39 ], [ 0, %main_bb20 ]
  %pos.0 = phi i64 [ %pos.0, %main_wrap_around.exit6 ], [ %"104", %main_bb37 ], [ %"109", %main_bb39 ], [ %"99", %main_bb38 ], [ 0, %main_bb20 ]
  %"52" = icmp slt i64 %pos.0, 30, !dbg !125
  br i1 %"52", label %main_bb21, label %main_bb40, !dbg !125

main_bb21:                                        ; preds = %main_wrap_around.exit2
  %"53" = sub nsw i64 30, %pos.0, !dbg !127
...
main_bb23:                                        ; preds = %main_bb21
  ...
  br i1 %"59", label %main_bb24, label %main_wrap_around.exit2.i, !dbg !131
...
main_wrap_around.exit2.i:                         ; preds = %main_bb24, %main_bb23, %main_bb22
  %.0.i = phi i64 [ %"58", %main_bb22 ], [ %"63", %main_bb24 ], [ %"53", %main_bb23 ], !dbg !127
  %"64" = icmp slt i64 %pos.0, %.0.i, !dbg !133
  br i1 %"64", label %main_bb25, label %main_read_slice_1.exit, !dbg !133

main_bb25:                                        ; preds = %main_wrap_around.exit2.i
  %"65" = add nsw i64 0, 1, !dbg !135
  %"66" = icmp sgt i64 %"65", 2147483647, !dbg !136
  br i1 %"66", label %main_bb26, label %main_bb27, !dbg !136

main_bb26:                                        ; preds = %main_bb25
  %"67" = sub nsw i64 %"65", 2147483647, !dbg !137
  %"68" = sub nsw i64 %"67", 1, !dbg !137
  %"69" = srem i64 %"68", 4294967296, !dbg !137
  %"70" = add nsw i64 -2147483648, %"69", !dbg !137
  br label %main_read_slice_1.exit, !dbg !137

main_bb27:                                        ; preds = %main_bb25
  %"71" = icmp slt i64 %"65", -2147483648, !dbg !138
  br i1 %"71", label %main_bb28, label %main_read_slice_1.exit, !dbg !138

main_bb28:                                        ; preds = %main_bb27
  %"72" = sub nsw i64 -2147483648, %"65", !dbg !139
  %"73" = sub nsw i64 %"72", 1, !dbg !139
  %"74" = srem i64 %"73", 4294967296, !dbg !139
  %"75" = sub nsw i64 2147483647, %"74", !dbg !139
  br label %main_read_slice_1.exit, !dbg !139

main_read_slice_1.exit:                           ; preds = %main_bb26, %main_bb27, %main_bb28, %main_wrap_around.exit2.i
  %__retres.0.i = phi i64 [ 0, %main_wrap_around.exit2.i ], [ %"70", %main_bb26 ], [ %"75", %main_bb28 ], [ %"65", %main_bb27 ], !dbg !134
...
main_LeafBlock:                                   ; preds = %main_NodeBlock
  ...
  br i1 %SwitchLeaf, label %main_bb29, label %main_NewDefault

main_bb29:                                        ; preds = %main_LeafBlock
  %"76" = add nsw i64 %__fc_errno_0.0, 1, !dbg !140
  %"77" = icmp sgt i64 %"76", 2147483647, !dbg !143
  br i1 %"77", label %main_bb30, label %main_bb31, !dbg !143

main_bb30:                                        ; preds = %main_bb29
  %"78" = sub nsw i64 %"76", 2147483647, !dbg !144
  %"79" = sub nsw i64 %"78", 1, !dbg !144
  %"80" = srem i64 %"79", 4294967296, !dbg !144
  %"81" = add nsw i64 -2147483648, %"80", !dbg !144
  br label %main_wrap_around.exit6, !dbg !144

main_bb31:                                        ; preds = %main_bb29
  %"82" = icmp slt i64 %"76", -2147483648, !dbg !145
  br i1 %"82", label %main_bb32, label %main_wrap_around.exit6, !dbg !145

main_bb32:                                        ; preds = %main_bb31
  %"83" = sub nsw i64 -2147483648, %"76", !dbg !146
  %"84" = sub nsw i64 %"83", 1, !dbg !146
  %"85" = srem i64 %"84", 4294967296, !dbg !146
  %"86" = sub nsw i64 2147483647, %"85", !dbg !146
  br label %main_wrap_around.exit6, !dbg !146

main_wrap_around.exit6:                           ; preds = %main_bb30, %main_bb31, %main_bb32
  %.0.i5 = phi i64 [ %"81", %main_bb30 ], [ %"86", %main_bb32 ], [ %"76", %main_bb31 ], !dbg !140
  %"87" = icmp eq i64 %.0.i5, 5, !dbg !147
  br i1 %"87", label %main_bb40, label %main_wrap_around.exit2, !dbg !147

main_LeafBlock8:                                  ; preds = %main_NodeBlock
  %SwitchLeaf9 = icmp eq i64 %__retres.0.i, 0
  br i1 %SwitchLeaf9, label %main_bb33, label %main_NewDefault

main_bb33:                                        ; preds = %main_LeafBlock8
  %"88" = add nsw i64 %__retres.0.i, 1, !dbg !149
  %"89" = icmp sgt i64 %"88", 2147483647, !dbg !152
  br i1 %"89", label %main_bb34, label %main_bb35, !dbg !152
...
main_bb34:                                        ; preds = %main_bb33
  ...
  br label %main_wrap_around.exit4, !dbg !153

main_bb35:                                        ; preds = %main_bb33
  %"94" = icmp slt i64 %"88", -2147483648, !dbg !154
  br i1 %"94", label %main_bb36, label %main_wrap_around.exit4, !dbg !154
...
main_bb36:                                        ; preds = %main_bb35
  ...
  br label %main_wrap_around.exit4, !dbg !155

main_NewDefault:                                  ; preds = %main_LeafBlock8, %main_LeafBlock
  br label %main_wrap_around.exit4

main_wrap_around.exit4:                           ; preds = %main_NewDefault, %main_bb36, %main_bb35, %main_bb34
  %rc.0 = phi i64 [ %__retres.0.i, %main_NewDefault ], [ %"93", %main_bb34 ], [ %"98", %main_bb36 ], [ %"88", %main_bb35 ]
  %"99" = add nsw i64 %pos.0, %rc.0, !dbg !156
  %"100" = icmp sgt i64 %"99", 2147483647, !dbg !157
  br i1 %"100", label %main_bb37, label %main_bb38, !dbg !157

main_bb37:                                        ; preds = %main_wrap_around.exit4
  %"101" = sub nsw i64 %"99", 2147483647, !dbg !158
  %"102" = sub nsw i64 %"101", 1, !dbg !158
  %"103" = srem i64 %"102", 4294967296, !dbg !158
  %"104" = add nsw i64 -2147483648, %"103", !dbg !158
  br label %main_wrap_around.exit2, !dbg !158

main_bb38:                                        ; preds = %main_wrap_around.exit4
  %"105" = icmp slt i64 %"99", -2147483648, !dbg !159
  br i1 %"105", label %main_bb39, label %main_wrap_around.exit2, !dbg !159

main_bb39:                                        ; preds = %main_bb38
  %"106" = sub nsw i64 -2147483648, %"99", !dbg !160
  %"107" = sub nsw i64 %"106", 1, !dbg !160
  %"108" = srem i64 %"107", 4294967296, !dbg !160
  %"109" = sub nsw i64 2147483647, %"108", !dbg !160
  br label %main_wrap_around.exit2, !dbg !160

main_bb40:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit6, %main_bb20
  ret void, !dbg !161
}
...
!133 = metadata !{i32 22, i32 3, metadata !96, metadata !134}
!134 = metadata !{i32 63, i32 20, metadata !128, null}
!135 = metadata !{i32 34, i32 16, metadata !53, metadata !134}
...
!140 = metadata !{i32 65, i32 23, metadata !141, null}
!141 = metadata !{i32 786443, metadata !1, metadata !142, i32 64, i32 19, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!142 = metadata !{i32 786443, metadata !1, metadata !128, i32 64, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!143 = metadata !{i32 10, i32 9, metadata !30, metadata !140}
!144 = metadata !{i32 11, i32 9, metadata !32, metadata !140}
!145 = metadata !{i32 13, i32 14, metadata !34, metadata !140}
!146 = metadata !{i32 14, i32 9, metadata !36, metadata !140}
!147 = metadata !{i32 66, i32 11, metadata !148, null}
!148 = metadata !{i32 786443, metadata !1, metadata !141, i32 66, i32 11, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!149 = metadata !{i32 73, i32 9, metadata !150, null}
!150 = metadata !{i32 786443, metadata !1, metadata !151, i32 73, i32 1, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!151 = metadata !{i32 786443, metadata !1, metadata !128, i32 72, i32 9, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!152 = metadata !{i32 10, i32 9, metadata !30, metadata !149}
!153 = metadata !{i32 11, i32 9, metadata !32, metadata !149}
!154 = metadata !{i32 13, i32 14, metadata !34, metadata !149}
!155 = metadata !{i32 14, i32 9, metadata !36, metadata !149}
!156 = metadata !{i32 75, i32 11, metadata !128, null}
!157 = metadata !{i32 10, i32 9, metadata !30, metadata !156}
!158 = metadata !{i32 11, i32 9, metadata !32, metadata !156}
!159 = metadata !{i32 13, i32 14, metadata !34, metadata !156}
!160 = metadata !{i32 14, i32 9, metadata !36, metadata !156}
!161 = metadata !{i32 77, i32 17, metadata !12, null}
