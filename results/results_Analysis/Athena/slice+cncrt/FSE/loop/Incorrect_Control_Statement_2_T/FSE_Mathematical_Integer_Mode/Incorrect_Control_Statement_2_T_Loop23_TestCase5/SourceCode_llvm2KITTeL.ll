...
main_bb0:
  ...
  %"4" = bitcast i8* %"3" to [10 x i32]*, !dbg !22
  %"5" = getelementptr [10 x i32]* %"4", i32 0, i32 3, !dbg !22
  store i32 5, i32* %"5", !dbg !22
...
main_bb3:                                         ; preds = %main_bb1, %main_bb9
  %i_0.0 = phi i32 [ %"23", %main_bb9 ], [ 0, %main_bb1 ]
  %table.0 = phi i32 [ %table.1, %main_bb9 ], [ %"0", %main_bb1 ]
  %"8" = icmp slt i32 %i_0.0, 10, !dbg !36
  br i1 %"8", label %main_bb4, label %main_bb10, !dbg !36

main_bb4:                                         ; preds = %main_bb3
  %"9" = sext i32 %i_0.0 to i64, !dbg !38
  %"10" = getelementptr inbounds [10 x i32]* %slots_used, i32 0, i64 %"9", !dbg !38
...
main_bb5:                                         ; preds = %main_LeafBlock
  %"12" = sext i32 %i_0.0 to i64, !dbg !40
  %"13" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"12", !dbg !40
  %"14" = load i32* %"13", align 4, !dbg !40
...
main_bb7:                                         ; preds = %main_NewDefault
  %"19" = sext i32 %i_0.0 to i64, !dbg !45
  %"20" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"19", !dbg !45
  %"21" = load i32* %"20", align 4, !dbg !45
...
main_bb8:                                         ; preds = %main_LeafBlock1, %main_bb7, %main_bb6
  ...
  %"22" = icmp ne i32 %table.1, 0, !dbg !47
  br i1 %"22", label %main_bb10, label %main_bb9, !dbg !47

main_bb9:                                         ; preds = %main_bb8
  %"23" = add nsw i32 %i_0.0, 1, !dbg !49
