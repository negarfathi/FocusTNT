...
main_bb1:
  ...
  %"3" = icmp sle i32 0, 0, !dbg !32
  %"4" = icmp sgt i32 0, 1000, !dbg !34
  %or.cond = or i1 %"3", %"4", !dbg !32
  br i1 %or.cond, label %main_bb9, label %main_bb2, !dbg !32

main_bb2:                                         ; preds = %main_bb1
  %"5" = sext i32 0 to i64, !dbg !36
  ...
  call void @llvm.dbg.value(metadata !28, i64 0, metadata !43), !dbg !45
...
main_bb3:                                         ; preds = %main_bb4, %main_bb2
  ...
  %"9" = icmp slt i32 %i.0, 0, !dbg !47
  br i1 %"9", label %main_bb4, label %main_bb5, !dbg !47

main_bb4:                                         ; preds = %main_bb3
  %"10" = call i32 @__VERIFIER_nondet_int(), !dbg !49
  %"11" = add nsw i32 %"8", %i.0, !dbg !49
  %"12" = sext i32 %"11" to i64, !dbg !49
  %"13" = getelementptr inbounds [100000 x i32]* @memory0, i32 0, i64 %"12", !dbg !49
  store i32 %"10", i32* %"13", align 4, !dbg !49
  %"14" = add nsw i32 %i.0, 1, !dbg !51
  br label %main_bb3, !dbg !52

main_bb5:                                         ; preds = %main_bb3
  call void @llvm.dbg.value(metadata !28, i64 0, metadata !53), !dbg !54
  %"15" = icmp slt i32 0, 0, !dbg !55
  br i1 %"15", label %main_bb9, label %main_bb6, !dbg !55

main_bb6:                                         ; preds = %main_bb5, %main_bb8
  %entry.0 = phi i32 [ %"22", %main_bb8 ], [ 0, %main_bb5 ]
  %"16" = icmp sge i32 %entry.0, 0, !dbg !57
  br i1 %"16", label %main_bb9, label %main_bb7, !dbg !57

main_bb7:                                         ; preds = %main_bb6
  %"17" = add nsw i32 %"8", %entry.0, !dbg !60
  %"18" = sext i32 %"17" to i64, !dbg !60
  %"19" = getelementptr inbounds [100000 x i32]* @memory0, i32 0, i64 %"18", !dbg !60
  %"20" = load i32* %"19", align 4, !dbg !60
  %"21" = icmp ne i32 %"20", 0, !dbg !60
  br i1 %"21", label %main_bb8, label %main_bb9, !dbg !60

main_bb8:                                         ; preds = %main_bb7
  %"22" = add nsw i32 %entry.0, 1, !dbg !62
...
!43 = metadata !{i32 786688, metadata !44, metadata !"i", metadata !5, i32 29, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 29]
!44 = metadata !{i32 786443, metadata !1, metadata !30, i32 28, i32 5, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 29, i32 11, metadata !44, null}
!46 = metadata !{i32 30, i32 7, metadata !44, null}
!47 = metadata !{i32 30, i32 7, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !44, i32 30, i32 7, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 31, i32 37, metadata !50, null}
!50 = metadata !{i32 786443, metadata !1, metadata !44, i32 30, i32 31, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 32, i32 9, metadata !50, null}
!52 = metadata !{i32 33, i32 7, metadata !50, null}
!53 = metadata !{i32 786688, metadata !30, metadata !"entry", metadata !5, i32 35, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [entry] [line 35]
!54 = metadata !{i32 35, i32 9, metadata !30, null}
!55 = metadata !{i32 36, i32 9, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !30, i32 36, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 38, i32 11, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !59, i32 38, i32 11, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 786443, metadata !1, metadata !30, i32 37, i32 15, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 42, i32 11, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !59, i32 42, i32 11, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 43, i32 9, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !61, i32 42, i32 42, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 49, i32 5, metadata !59, null}
!65 = metadata !{i32 52, i32 17, metadata !9, null}
