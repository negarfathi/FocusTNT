...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %"19"}, i64 0, metadata !54), !dbg !55
...
main_bb9:                                         ; preds = %main_bb13, %main_bb8
  ...
  br i1 %"12", label %main_bb10, label %main_bb14, !dbg !68

main_bb10:                                        ; preds = %main_bb9
  %"13" = icmp eq i32 %"11", 1, !dbg !64
  br i1 %"13", label %main_read_slice_1.exit, label %main_bb11, !dbg !64

main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %count.0.i = phi i32 [ %"15", %main_bb12 ], [ 0, %main_bb10 ], !dbg !57
  %.0.i = phi i32 [ %"16", %main_bb12 ], [ %buf.0, %main_bb10 ], !dbg !57
  %"14" = icmp slt i32 %.0.i, %count.0, !dbg !70
  br i1 %"14", label %main_bb12, label %main_read_slice_1.exit, !dbg !70

main_bb12:                                        ; preds = %main_bb11
  %"15" = add nsw i32 %count.0.i, 1, !dbg !71
  %"16" = add nsw i32 %.0.i, 1, !dbg !72
  br label %main_bb11, !dbg !73

main_read_slice_1.exit:                           ; preds = %main_bb10, %main_bb11
  %__retres.0.i = phi i32 [ 0, %main_bb10 ], [ %count.0.i, %main_bb11 ], !dbg !57
  %"17" = icmp slt i32 %__retres.0.i, 0, !dbg !74
  br i1 %"17", label %main_bb14, label %main_bb13, !dbg !74

main_bb13:                                        ; preds = %main_read_slice_1.exit
  %"18" = sub nsw i32 %count.0, %__retres.0.i, !dbg !76
  %"19" = add nsw i32 %buf.0, %__retres.0.i, !dbg !77
  br label %main_bb9, !dbg !78

main_bb14:                                        ; preds = %main_bb9, %main_read_slice_1.exit, %main_bb7
  ret void, !dbg !79
}
...
!71 = metadata !{i32 24, i32 7, metadata !33, metadata !57}
!72 = metadata !{i32 25, i32 22, metadata !41, metadata !57}
!73 = metadata !{i32 33, i32 3, metadata !30, metadata !57}
!74 = metadata !{i32 50, i32 9, metadata !75, null}
!75 = metadata !{i32 786443, metadata !1, metadata !58, i32 50, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 54, i32 5, metadata !58, null}
!77 = metadata !{i32 55, i32 5, metadata !58, null}
!78 = metadata !{i32 56, i32 3, metadata !58, null}
!79 = metadata !{i32 57, i32 17, metadata !9, null}
