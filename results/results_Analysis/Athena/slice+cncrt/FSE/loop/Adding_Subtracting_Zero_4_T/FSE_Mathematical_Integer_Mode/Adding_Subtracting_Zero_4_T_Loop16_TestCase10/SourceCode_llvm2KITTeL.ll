...
read_slice_1_bb2:                                 ; preds = %read_slice_1_bb1
  %"1" = icmp eq i32 -1995, 0, !dbg !31
  br i1 %"1", label %read_slice_1_bb5, label %read_slice_1_bb3, !dbg !31

read_slice_1_bb3:                                 ; preds = %read_slice_1_bb2
  %"2" = icmp slt i32 -1995, 0, !dbg !33
  %"3" = sub nsw i32 0, -1995, !dbg !36
  %. = select i1 %"2", i32 %"3", i32 -1995, !dbg !33
...
main_bb6:
  ...
  %"8" = icmp sle i32 995, 0, !dbg !49
  br i1 %"8", label %main_bb11, label %main_bb7, !dbg !49
...
main_bb7:                                         ; preds = %main_bb9, %main_bb6, %main_bb10
  ...
  %count.0 = phi i32 [ %"15", %main_bb10 ], [ 995, %main_bb6 ], [ %count.0, %main_bb9 ]
  %"9" = icmp sgt i32 %count.0, 0, !dbg !51
  br i1 %"9", label %main_read_slice_1.exit, label %main_bb11, !dbg !51

main_read_slice_1.exit:                           ; preds = %main_bb7
  %"10" = icmp slt i32 %buf.0, %count.0, !dbg !53
  %. = select i1 %"10", i32 1, i32 0, !dbg !53
  %"11" = icmp sle i32 %., 0, !dbg !56
  br i1 %"11", label %main_bb8, label %main_bb10, !dbg !56

main_bb8:                                         ; preds = %main_read_slice_1.exit
  %"12" = icmp eq i32 %., 0, !dbg !58
  br i1 %"12", label %main_bb9, label %main_bb11, !dbg !58

main_bb9:                                         ; preds = %main_bb8
  %"13" = add nsw i32 %tries.0, 1, !dbg !61
  %"14" = icmp slt i32 %tries.0, 5, !dbg !63
  br i1 %"14", label %main_bb7, label %main_bb11, !dbg !63

main_bb10:                                        ; preds = %main_read_slice_1.exit
  %"15" = sub nsw i32 %count.0, %., !dbg !65
  %"16" = add nsw i32 %buf.0, %., !dbg !66
  br label %main_bb7, !dbg !67
...
!54 = metadata !{i32 41, i32 11, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !9, i32 40, i32 21, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 42, i32 9, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !55, i32 42, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 43, i32 11, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !60, i32 43, i32 11, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 786443, metadata !1, metadata !57, i32 42, i32 19, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 46, i32 9, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !59, i32 43, i32 21, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 47, i32 13, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !62, i32 47, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 52, i32 5, metadata !55, null}
!66 = metadata !{i32 53, i32 5, metadata !55, null}
!67 = metadata !{i32 54, i32 3, metadata !55, null}
!68 = metadata !{i32 55, i32 17, metadata !9, null}
