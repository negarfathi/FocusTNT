...
main_bb7:
  ...
  %"10" = icmp sle i32 3, 0, !dbg !52
  br i1 %"10", label %main_bb16, label %main_bb8, !dbg !52
...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %buf.0}, i64 0, metadata !58), !dbg !61
  call void @llvm.dbg.value(metadata !{i32 %count.0}, i64 0, metadata !62), !dbg !63
  call void @llvm.dbg.value(metadata !21, i64 0, metadata !64), !dbg !65
  %"11" = load i32* @"'flag", align 4, !dbg !66
  call void @llvm.dbg.value(metadata !{i32 %__retres.0.i}, i64 0, metadata !67), !dbg !68
  call void @llvm.dbg.value(metadata !{i32 %tries.0}, i64 0, metadata !69), !dbg !74
  call void @llvm.dbg.value(metadata !{i32 %"19"}, i64 0, metadata !56), !dbg !57
  call void @llvm.dbg.value(metadata !{i32 %"21"}, i64 0, metadata !50), !dbg !51
  call void @llvm.dbg.value(metadata !{i32 %"22"}, i64 0, metadata !54), !dbg !55
...
main_bb9:                                         ; preds = %main_bb14, %main_bb15, %main_bb8
  ...
  %"12" = icmp sgt i32 %count.0, 0, !dbg !76
  br i1 %"12", label %main_bb10, label %main_bb16, !dbg !76

main_bb10:                                        ; preds = %main_bb9
  %"13" = icmp eq i32 %"11", 1, !dbg !66
  br i1 %"13", label %main_read_slice_1.exit, label %main_bb11, !dbg !66

main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %count.0.i = phi i32 [ %"15", %main_bb12 ], [ 0, %main_bb10 ], !dbg !59
  %.0.i = phi i32 [ %"16", %main_bb12 ], [ %buf.0, %main_bb10 ], !dbg !59
  %"14" = icmp slt i32 %.0.i, %count.0, !dbg !78
  br i1 %"14", label %main_bb12, label %main_read_slice_1.exit, !dbg !78

main_bb12:                                        ; preds = %main_bb11
  %"15" = add nsw i32 %count.0.i, 1, !dbg !79
  %"16" = add nsw i32 %.0.i, 1, !dbg !80
  br label %main_bb11, !dbg !81

main_read_slice_1.exit:                           ; preds = %main_bb10, %main_bb11
  %__retres.0.i = phi i32 [ 0, %main_bb10 ], [ %count.0.i, %main_bb11 ], !dbg !59
  %"17" = icmp sle i32 %__retres.0.i, 0, !dbg !82
  br i1 %"17", label %main_bb13, label %main_bb15, !dbg !82

main_bb13:                                        ; preds = %main_read_slice_1.exit
  %"18" = icmp eq i32 %__retres.0.i, 0, !dbg !83
  br i1 %"18", label %main_bb14, label %main_bb16, !dbg !83

main_bb14:                                        ; preds = %main_bb13
  %"19" = add nsw i32 %tries.0, 1, !dbg !84
  %"20" = icmp slt i32 %tries.0, 5, !dbg !85
  br i1 %"20", label %main_bb9, label %main_bb16, !dbg !85

main_bb15:                                        ; preds = %main_read_slice_1.exit
  %"21" = sub nsw i32 %count.0, %__retres.0.i, !dbg !87
  %"22" = add nsw i32 %buf.0, %__retres.0.i, !dbg !88
  br label %main_bb9, !dbg !89
...
!56 = metadata !{i32 786688, metadata !9, metadata !"tries", metadata !5, i32 48, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tries] [line 48]
!57 = metadata !{i32 48, i32 7, metadata !9, null}
!58 = metadata !{i32 786689, metadata !4, metadata !"loc", metadata !5, i32 16777222, metadata !8, i32 0, metadata !59} ; [ DW_TAG_arg_variable ] [loc] [line 6]
!59 = metadata !{i32 50, i32 11, metadata !60, null}
!60 = metadata !{i32 786443, metadata !1, metadata !9, i32 49, i32 21, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 6, i32 22, metadata !4, metadata !59}
!62 = metadata !{i32 786689, metadata !4, metadata !"len", metadata !5, i32 33554438, metadata !8, i32 0, metadata !59} ; [ DW_TAG_arg_variable ] [len] [line 6]
!63 = metadata !{i32 6, i32 31, metadata !4, metadata !59}
!64 = metadata !{i32 786688, metadata !4, metadata !"count", metadata !5, i32 9, metadata !8, i32 0, metadata !59} ; [ DW_TAG_auto_variable ] [count] [line 9]
!65 = metadata !{i32 9, i32 7, metadata !4, metadata !59}
!66 = metadata !{i32 10, i32 7, metadata !25, metadata !59}
!67 = metadata !{i32 786688, metadata !9, metadata !"ret", metadata !5, i32 41, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ret] [line 41]
!68 = metadata !{i32 41, i32 7, metadata !9, null}
!69 = metadata !{i32 786688, metadata !70, metadata !"tmp_0", metadata !5, i32 53, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp_0] [line 53]
!70 = metadata !{i32 786443, metadata !1, metadata !71, i32 52, i32 21, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 786443, metadata !1, metadata !72, i32 52, i32 11, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!72 = metadata !{i32 786443, metadata !1, metadata !73, i32 51, i32 19, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!73 = metadata !{i32 786443, metadata !1, metadata !60, i32 51, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!74 = metadata !{i32 53, i32 13, metadata !70, null}
!75 = metadata !{i32 49, i32 3, metadata !9, null}
!76 = metadata !{i32 49, i32 3, metadata !77, null}
!77 = metadata !{i32 786443, metadata !1, metadata !9, i32 49, i32 3, i32 1, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!78 = metadata !{i32 14, i32 3, metadata !27, metadata !59}
!79 = metadata !{i32 24, i32 7, metadata !33, metadata !59}
!80 = metadata !{i32 25, i32 22, metadata !41, metadata !59}
!81 = metadata !{i32 33, i32 3, metadata !30, metadata !59}
!82 = metadata !{i32 51, i32 9, metadata !73, null}
!83 = metadata !{i32 52, i32 11, metadata !71, null}
!84 = metadata !{i32 55, i32 9, metadata !70, null}
!85 = metadata !{i32 56, i32 13, metadata !86, null}
!86 = metadata !{i32 786443, metadata !1, metadata !70, i32 56, i32 13, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!87 = metadata !{i32 61, i32 5, metadata !60, null}
!88 = metadata !{i32 62, i32 5, metadata !60, null}
!89 = metadata !{i32 63, i32 3, metadata !60, null}
!90 = metadata !{i32 64, i32 17, metadata !9, null}
