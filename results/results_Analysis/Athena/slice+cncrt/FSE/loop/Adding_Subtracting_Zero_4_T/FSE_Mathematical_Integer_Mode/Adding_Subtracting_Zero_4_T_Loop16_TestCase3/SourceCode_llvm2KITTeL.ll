...
read_slice_1_bb2:                                 ; preds = %read_slice_1_bb1
  %"1" = icmp eq i32 500, 0, !dbg !31
  br i1 %"1", label %read_slice_1_bb5, label %read_slice_1_bb3, !dbg !31

read_slice_1_bb3:                                 ; preds = %read_slice_1_bb2
  %"2" = icmp slt i32 500, 0, !dbg !33
  %"3" = sub nsw i32 0, 500, !dbg !36
  %. = select i1 %"2", i32 %"3", i32 500, !dbg !33
...
main_bb6:
  ...
  %"8" = icmp sle i32 3, 0, !dbg !49
  br i1 %"8", label %main_bb13, label %main_bb7, !dbg !49

main_bb7:                                         ; preds = %main_bb11, %main_bb6, %main_bb12
  %tries.0 = phi i32 [ %tries.0, %main_bb12 ], [ 0, %main_bb6 ], [ %"15", %main_bb11 ]
  %buf.0 = phi i32 [ %"18", %main_bb12 ], [ 0, %main_bb6 ], [ %buf.0, %main_bb11 ]
  %count.0 = phi i32 [ %"17", %main_bb12 ], [ 3, %main_bb6 ], [ %count.0, %main_bb11 ]
  %"9" = icmp sgt i32 %count.0, 0, !dbg !51
  br i1 %"9", label %main_bb8, label %main_bb13, !dbg !51

main_bb8:                                         ; preds = %main_bb7, %main_bb9
  %count.0.i = phi i32 [ %"11", %main_bb9 ], [ 0, %main_bb7 ], !dbg !53
  %.0.i = phi i32 [ %"12", %main_bb9 ], [ %buf.0, %main_bb7 ], !dbg !53
  %"10" = icmp slt i32 %.0.i, %count.0, !dbg !55
  br i1 %"10", label %main_bb9, label %main_read_slice_1.exit, !dbg !55

main_bb9:                                         ; preds = %main_bb8
  %"11" = add nsw i32 %count.0.i, 1, !dbg !56
  %"12" = add nsw i32 %.0.i, 1, !dbg !57
  br label %main_bb8, !dbg !58

main_read_slice_1.exit:                           ; preds = %main_bb8
  call void @llvm.dbg.value(metadata !{i32 %count.0.i}, i64 0, metadata !59), !dbg !60
  %"13" = icmp sle i32 %count.0.i, 0, !dbg !61
  br i1 %"13", label %main_bb10, label %main_bb12, !dbg !61

main_bb10:                                        ; preds = %main_read_slice_1.exit
  %"14" = icmp eq i32 %count.0.i, 0, !dbg !63
  br i1 %"14", label %main_bb11, label %main_bb13, !dbg !63

main_bb11:                                        ; preds = %main_bb10
  call void @llvm.dbg.value(metadata !{i32 %tries.0}, i64 0, metadata !66), !dbg !68
  %"15" = add nsw i32 %tries.0, 1, !dbg !69
  call void @llvm.dbg.value(metadata !{i32 %"15"}, i64 0, metadata !70), !dbg !71
  %"16" = icmp slt i32 %tries.0, 5, !dbg !72
  br i1 %"16", label %main_bb7, label %main_bb13, !dbg !72

main_bb12:                                        ; preds = %main_read_slice_1.exit
  %"17" = sub nsw i32 %count.0, %count.0.i, !dbg !74
  call void @llvm.dbg.value(metadata !{i32 %"17"}, i64 0, metadata !47), !dbg !48
  %"18" = add nsw i32 %buf.0, %count.0.i, !dbg !75
  call void @llvm.dbg.value(metadata !{i32 %"18"}, i64 0, metadata !76), !dbg !77
  br label %main_bb7, !dbg !78

main_bb13:                                        ; preds = %main_bb7, %main_bb10, %main_bb11, %main_bb6
  ret void, !dbg !79
}
...
!30 = metadata !{i32 786443, metadata !1, metadata !4, i32 10, i32 3, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!55 = metadata !{i32 10, i32 3, metadata !30, metadata !53}
!56 = metadata !{i32 20, i32 7, metadata !35, metadata !53}
!57 = metadata !{i32 21, i32 22, metadata !43, metadata !53}
!58 = metadata !{i32 28, i32 3, metadata !26, metadata !53}
!59 = metadata !{i32 786688, metadata !9, metadata !"ret", metadata !5, i32 35, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ret] [line 35]
!60 = metadata !{i32 35, i32 7, metadata !9, null}
!61 = metadata !{i32 42, i32 9, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !54, i32 42, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 43, i32 11, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !65, i32 43, i32 11, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 786443, metadata !1, metadata !62, i32 42, i32 19, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!66 = metadata !{i32 786688, metadata !67, metadata !"tmp_0", metadata !5, i32 44, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp_0] [line 44]
!67 = metadata !{i32 786443, metadata !1, metadata !64, i32 43, i32 21, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!68 = metadata !{i32 44, i32 13, metadata !67, null}
!69 = metadata !{i32 46, i32 9, metadata !67, null}
!70 = metadata !{i32 786688, metadata !9, metadata !"tries", metadata !5, i32 39, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tries] [line 39]
!71 = metadata !{i32 39, i32 7, metadata !9, null}
!72 = metadata !{i32 47, i32 13, metadata !73, null}
!73 = metadata !{i32 786443, metadata !1, metadata !67, i32 47, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!74 = metadata !{i32 52, i32 5, metadata !54, null}
!75 = metadata !{i32 53, i32 5, metadata !54, null}
!76 = metadata !{i32 786688, metadata !9, metadata !"buf", metadata !5, i32 38, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [buf] [line 38]
!77 = metadata !{i32 38, i32 7, metadata !9, null}
!78 = metadata !{i32 54, i32 3, metadata !54, null}
!79 = metadata !{i32 55, i32 17, metadata !9, null}
