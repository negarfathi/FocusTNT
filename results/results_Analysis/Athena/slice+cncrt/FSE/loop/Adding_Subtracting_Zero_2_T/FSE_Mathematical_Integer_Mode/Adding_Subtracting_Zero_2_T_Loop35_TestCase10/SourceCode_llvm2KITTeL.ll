...
main_bb5:
  ...
  %"6" = icmp slt i32 1, 0, !dbg !41
  %"7" = icmp slt i32 100, 0, !dbg !43
  %or.cond = or i1 %"6", %"7", !dbg !41
  br i1 %or.cond, label %main_bb10, label %main_bb6, !dbg !41

main_bb6:                                         ; preds = %main_bb5, %main_bb9
  %b.0 = phi i32 [ %"12", %main_bb9 ], [ 1, %main_bb5 ]
  %"8" = icmp slt i32 %b.0, 100, !dbg !45
  br i1 %"8", label %main_bb7, label %main_bb10, !dbg !45

main_bb7:                                         ; preds = %main_bb6
  %"9" = load i32* @"'flag", align 4, !dbg !47
  %"10" = icmp eq i32 %"9", 1, !dbg !47
  br i1 %"10", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb8, !dbg !47

main_bb8:                                         ; preds = %main_bb7
  store i32 1, i32* @"'flag", align 4, !dbg !50
  br label %main_ff_subtitles_next_line_slice_1.exit, !dbg !51

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb7, %main_bb8
  %"11" = icmp ne i32 0, 0, !dbg !52
  br i1 %"11", label %main_bb9, label %main_bb10, !dbg !52

main_bb9:                                         ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"12" = add nsw i32 %b.0, 0, !dbg !54
  %"13" = sub nsw i32 100, 4, !dbg !55
  %"14" = icmp sge i32 %"12", %"13", !dbg !55
  br i1 %"14", label %main_bb10, label %main_bb6, !dbg !55
...
!35 = metadata !{i32 1}
!36 = metadata !{i32 786688, metadata !9, metadata !"b", metadata !5, i32 27, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [b] [line 27]
!37 = metadata !{i32 27, i32 7, metadata !9, null}
!38 = metadata !{i32 100}
...
!45 = metadata !{i32 38, i32 3, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 38, i32 3, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 11, i32 7, metadata !22, metadata !48}
!48 = metadata !{i32 39, i32 15, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !9, i32 38, i32 19, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!50 = metadata !{i32 16, i32 5, metadata !26, metadata !48}
!51 = metadata !{i32 18, i32 3, metadata !26, metadata !48}
!52 = metadata !{i32 40, i32 9, metadata !53, null}
!53 = metadata !{i32 786443, metadata !1, metadata !49, i32 40, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 44, i32 5, metadata !49, null}
!55 = metadata !{i32 45, i32 9, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !49, i32 45, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 51, i32 17, metadata !9, null}
