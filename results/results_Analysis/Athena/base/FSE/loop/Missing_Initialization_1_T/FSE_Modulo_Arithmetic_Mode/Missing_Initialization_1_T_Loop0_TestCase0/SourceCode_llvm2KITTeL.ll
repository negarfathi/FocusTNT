...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !38), !dbg !39
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !40), !dbg !44
...
main_bb6:                                         ; preds = %main_bb7, %main_wrap_around.exit, %main_bb5
  ...
  %"13" = icmp slt i64 %pkt.0, 10, !dbg !55
  br i1 %"13", label %main_bb7, label %main_bb12, !dbg !55

main_bb7:                                         ; preds = %main_wrap_around.exit, %main_bb6
  %res.0 = phi i64 [ 0, %main_bb6 ], [ %"15", %main_wrap_around.exit ]
  %pkt.1 = phi i64 [ %pkt.0, %main_bb6 ], [ %.0.i, %main_wrap_around.exit ]
  %"14" = icmp eq i64 %res.0, 0, !dbg !57
  br i1 %"14", label %main_bb8, label %main_bb6, !dbg !57

main_bb8:                                         ; preds = %main_bb7
  %"15" = call i64 @__VERIFIER_nondet_int(), !dbg !59
  %"16" = add nsw i64 %pkt.1, 1, !dbg !41
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !60
  br i1 %"17", label %main_bb9, label %main_bb10, !dbg !60

main_bb9:                                         ; preds = %main_bb8
  %"18" = sub nsw i64 %"16", 2147483647, !dbg !61
  %"19" = sub nsw i64 %"18", 1, !dbg !61
  %"20" = srem i64 %"19", 4294967296, !dbg !61
  %"21" = add nsw i64 -2147483648, %"20", !dbg !61
  br label %main_wrap_around.exit, !dbg !61

main_bb10:                                        ; preds = %main_bb8
  %"22" = icmp slt i64 %"16", -2147483648, !dbg !62
  br i1 %"22", label %main_bb11, label %main_wrap_around.exit, !dbg !62

main_bb11:                                        ; preds = %main_bb10
  %"23" = sub nsw i64 -2147483648, %"16", !dbg !63
  %"24" = sub nsw i64 %"23", 1, !dbg !63
  %"25" = srem i64 %"24", 4294967296, !dbg !63
  %"26" = sub nsw i64 2147483647, %"25", !dbg !63
  br label %main_wrap_around.exit, !dbg !63

main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb10, %main_bb11
  %.0.i = phi i64 [ %"21", %main_bb9 ], [ %"26", %main_bb11 ], [ %"16", %main_bb10 ], !dbg !41
  %"27" = icmp eq i64 %"15", 0, !dbg !64
  br i1 %"27", label %main_bb6, label %main_bb7, !dbg !64
...
!35 = metadata !{i32 786688, metadata !9, metadata !"pkt", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [pkt] [line 24]
!36 = metadata !{i32 24, i32 15, metadata !9, null}
!37 = metadata !{i64 0}
!38 = metadata !{i32 786688, metadata !9, metadata !"res", metadata !5, i32 23, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [res] [line 23]
...
!41 = metadata !{i32 31, i32 20, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !43, i32 29, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 26, i32 5, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!54 = metadata !{i32 25, i32 5, metadata !9, null}
!55 = metadata !{i32 25, i32 5, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 5, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 28, i32 9, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !43, i32 28, i32 9, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 30, i32 19, metadata !42, null}
!60 = metadata !{i32 13, i32 9, metadata !26, metadata !41}
!61 = metadata !{i32 14, i32 9, metadata !28, metadata !41}
!62 = metadata !{i32 16, i32 14, metadata !30, metadata !41}
!63 = metadata !{i32 17, i32 9, metadata !32, metadata !41}
!64 = metadata !{i32 32, i32 17, metadata !65, null}
!65 = metadata !{i32 786443, metadata !1, metadata !42, i32 32, i32 17, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!66 = metadata !{i32 38, i32 5, metadata !9, null}
