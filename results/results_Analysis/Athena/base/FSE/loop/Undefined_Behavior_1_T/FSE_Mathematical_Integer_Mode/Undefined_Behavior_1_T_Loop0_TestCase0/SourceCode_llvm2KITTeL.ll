...
main_bb1:                                         ; preds = %main_bb1, %main_bb0
  ...
  %"2" = add nsw i32 %bytes.0, 1, !dbg !21
  %"3" = lshr i32 %num.0, 7, !dbg !23
  %"4" = icmp ne i32 %"3", 0, !dbg !23
  br i1 %"4", label %main_bb1, label %main_bb2, !dbg !23
...
!12 = metadata !{i32 11, i32 24, metadata !4, null}
