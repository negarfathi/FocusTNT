...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"24"}, i64 0, metadata !50), !dbg !54
...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  ...
  %"25" = icmp ne i64 %.0.i, 0, !dbg !77
  br i1 %"25", label %main_bb10, label %main_wrap_around.exit6, !dbg !77

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"26" = icmp sgt i64 %"24", 255, !dbg !78
  br i1 %"26", label %main_bb11, label %main_bb12, !dbg !78

main_bb11:                                        ; preds = %main_bb10
  %"27" = sub nsw i64 %"24", 255, !dbg !79
  %"28" = sub nsw i64 %"27", 1, !dbg !79
  %"29" = srem i64 %"28", 256, !dbg !79
  br label %main_wrap_around.exit6, !dbg !79

main_bb12:                                        ; preds = %main_bb10
  %"30" = icmp slt i64 %"24", 0, !dbg !80
  br i1 %"30", label %main_bb13, label %main_wrap_around.exit6, !dbg !80

main_bb13:                                        ; preds = %main_bb12
  %"31" = sub nsw i64 0, %"24", !dbg !81
  %"32" = sub nsw i64 %"31", 1, !dbg !81
  %"33" = srem i64 %"32", 256, !dbg !81
  %"34" = sub nsw i64 255, %"33", !dbg !81
  br label %main_wrap_around.exit6, !dbg !81

main_wrap_around.exit6:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_wrap_around.exit
  %l.1 = phi i64 [ %"24", %main_wrap_around.exit ], [ %"29", %main_bb11 ], [ %"34", %main_bb13 ], [ %"24", %main_bb12 ]
  %"35" = icmp sgt i64 %l.1, 255, !dbg !82
  br i1 %"35", label %main_bb14, label %main_bb15, !dbg !82

main_bb14:                                        ; preds = %main_wrap_around.exit6
  %"36" = sub nsw i64 %l.1, 255, !dbg !83
  %"37" = sub nsw i64 %"36", 1, !dbg !83
  %"38" = srem i64 %"37", 256, !dbg !83
  br label %main_wrap_around.exit4, !dbg !83

main_bb15:                                        ; preds = %main_wrap_around.exit6
  %"39" = icmp slt i64 %l.1, 0, !dbg !84
  br i1 %"39", label %main_bb16, label %main_wrap_around.exit4, !dbg !84

main_bb16:                                        ; preds = %main_bb15
  %"40" = sub nsw i64 0, %l.1, !dbg !85
  %"41" = sub nsw i64 %"40", 1, !dbg !85
  %"42" = srem i64 %"41", 256, !dbg !85
  %"43" = sub nsw i64 255, %"42", !dbg !85
  br label %main_wrap_around.exit4, !dbg !85

main_wrap_around.exit2:                           ; preds = %main_wrap_around.exit4
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !86), !dbg !88
