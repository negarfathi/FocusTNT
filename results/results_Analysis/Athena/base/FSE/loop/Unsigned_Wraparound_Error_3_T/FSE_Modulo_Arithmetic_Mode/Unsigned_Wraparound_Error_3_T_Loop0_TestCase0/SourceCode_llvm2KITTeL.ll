...
main_bb5:
  ...
  %"15" = add nsw i64 %"13", %"14", !dbg !43
  %"16" = add nsw i64 %"15", 1, !dbg !43
  ...
  %"17" = icmp sgt i64 %"16", 4294967295, !dbg !56
  br i1 %"17", label %main_bb6, label %main_bb7, !dbg !56

main_bb6:                                         ; preds = %main_bb5
  %"18" = sub nsw i64 %"16", 4294967295, !dbg !57
  %"19" = sub nsw i64 %"18", 1, !dbg !57
  %"20" = srem i64 %"19", 4294967296, !dbg !57
  br label %main_wrap_around.exit, !dbg !57

main_bb7:                                         ; preds = %main_bb5
  %"21" = icmp slt i64 %"16", 0, !dbg !58
  br i1 %"21", label %main_bb8, label %main_wrap_around.exit, !dbg !58

main_bb8:                                         ; preds = %main_bb7
  %"22" = sub nsw i64 0, %"16", !dbg !59
  %"23" = sub nsw i64 %"22", 1, !dbg !59
  %"24" = srem i64 %"23", 4294967296, !dbg !59
  %"25" = sub nsw i64 4294967295, %"24", !dbg !59
  br label %main_wrap_around.exit, !dbg !59

main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  %.0.i = phi i64 [ %"20", %main_bb6 ], [ %"25", %main_bb8 ], [ %"16", %main_bb7 ], !dbg !43
  %"26" = icmp eq i64 %.0.i, 4294967295, !dbg !43
  %"27" = icmp eq i64 %"13", 0, !dbg !60
  %or.cond = or i1 %"26", %"27", !dbg !43
...
main_wrap_around.exit2:                           ; preds = %main_wrap_around.exit, %main_bb12, %main_bb14, %main_bb15, %main_bb16
  %newbufsize.0 = phi i64 [ 4294967295, %main_bb12 ], [ %"45", %main_bb14 ], [ %"50", %main_bb16 ], [ %"41", %main_bb15 ], [ %"13", %main_wrap_around.exit ]
  %"28" = add nsw i64 %"12", %"14", !dbg !62
  %"29" = add nsw i64 %"28", 1, !dbg !62
  %"30" = icmp sgt i64 %"29", 4294967295, !dbg !63
  br i1 %"30", label %main_bb9, label %main_bb10, !dbg !63
...
main_bb10:                                        ; preds = %main_wrap_around.exit2
  ...
  br i1 %"34", label %main_bb11, label %main_wrap_around.exit4, !dbg !65
...
main_wrap_around.exit4:                           ; preds = %main_bb9, %main_bb10, %main_bb11
  %.0.i3 = phi i64 [ %"33", %main_bb9 ], [ %"38", %main_bb11 ], [ %"29", %main_bb10 ], !dbg !62
  %"39" = icmp slt i64 %newbufsize.0, %.0.i3, !dbg !62
  br i1 %"39", label %main_bb12, label %main_bb17, !dbg !62

main_bb12:                                        ; preds = %main_wrap_around.exit4
  %"40" = icmp sge i64 %newbufsize.0, 2147483648, !dbg !67
  br i1 %"40", label %main_wrap_around.exit2, label %main_bb13, !dbg !67

main_bb13:                                        ; preds = %main_bb12
  %"41" = mul nsw i64 %newbufsize.0, 2, !dbg !70
  %"42" = icmp sgt i64 %"41", 4294967295, !dbg !71
  br i1 %"42", label %main_bb14, label %main_bb15, !dbg !71

main_bb14:                                        ; preds = %main_bb13
  %"43" = sub nsw i64 %"41", 4294967295, !dbg !72
...
main_bb15:                                        ; preds = %main_bb13
  %"46" = icmp slt i64 %"41", 0, !dbg !73
  br i1 %"46", label %main_bb16, label %main_wrap_around.exit2, !dbg !73

main_bb16:                                        ; preds = %main_bb15
  %"47" = sub nsw i64 0, %"41", !dbg !74
  %"48" = sub nsw i64 %"47", 1, !dbg !74
  %"49" = srem i64 %"48", 4294967296, !dbg !74
  %"50" = sub nsw i64 4294967295, %"49", !dbg !74
...
!34 = metadata !{i32 23, i32 25, metadata !9, null}
...
!37 = metadata !{i32 24, i32 28, metadata !9, null}
...
!40 = metadata !{i32 25, i32 21, metadata !9, null}
