...
main_bb6:                                         ; preds = %main_bb5
  ...
  call void @llvm.dbg.value(metadata !{i64 %"17"}, i64 0, metadata !42), !dbg !45
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  ...
  %"15" = icmp sgt i64 %h.0, 0, !dbg !56
  br i1 %"15", label %main_bb7, label %main_bb11, !dbg !56

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"16" = icmp sgt i64 %linesToRead.0, %h.0, !dbg !58
  %h.0.linesToRead.0 = select i1 %"16", i64 %h.0, i64 %linesToRead.0, !dbg !58
  %"17" = sub nsw i64 %h.0, %h.0.linesToRead.0, !dbg !43
  %"18" = icmp sgt i64 %"17", 2147483647, !dbg !60
  br i1 %"18", label %main_bb8, label %main_bb9, !dbg !60

main_bb8:                                         ; preds = %main_bb7
  %"19" = sub nsw i64 %"17", 2147483647, !dbg !61
  %"20" = sub nsw i64 %"19", 1, !dbg !61
  %"21" = srem i64 %"20", 4294967296, !dbg !61
  %"22" = add nsw i64 -2147483648, %"21", !dbg !61
  br label %main_wrap_around.exit, !dbg !61

main_bb9:                                         ; preds = %main_bb7
  %"23" = icmp slt i64 %"17", -2147483648, !dbg !62
  br i1 %"23", label %main_bb10, label %main_wrap_around.exit, !dbg !62

main_bb10:                                        ; preds = %main_bb9
  %"24" = sub nsw i64 -2147483648, %"17", !dbg !63
  %"25" = sub nsw i64 %"24", 1, !dbg !63
  %"26" = srem i64 %"25", 4294967296, !dbg !63
  %"27" = sub nsw i64 2147483647, %"26", !dbg !63
...
!58 = metadata !{i32 32, i32 13, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !44, i32 32, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 13, i32 9, metadata !26, metadata !43}
!61 = metadata !{i32 14, i32 9, metadata !28, metadata !43}
!62 = metadata !{i32 16, i32 14, metadata !30, metadata !43}
!63 = metadata !{i32 17, i32 9, metadata !32, metadata !43}
!64 = metadata !{i32 40, i32 1, metadata !9, null}
