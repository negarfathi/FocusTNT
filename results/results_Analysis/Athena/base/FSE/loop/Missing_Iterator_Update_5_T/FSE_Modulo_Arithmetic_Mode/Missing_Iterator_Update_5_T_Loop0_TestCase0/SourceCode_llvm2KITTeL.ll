...
main_bb5:
  ...
  br i1 %or.cond, label %main_bb18, label %main_bb6, !dbg !37
...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  br i1 %"31", label %main_bb17, label %main_wrap_around.exit2, !dbg !75

main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb11
  %entry.0 = phi i64 [ %"18", %main_bb11 ], [ %"41", %main_bb14 ], [ %"46", %main_bb16 ], [ %"36", %main_bb15 ]
  %"32" = icmp sge i64 %entry.0, %"12", !dbg !77
  br i1 %"32", label %main_bb17, label %main_bb12, !dbg !77

main_bb12:                                        ; preds = %main_wrap_around.exit2
  %"33" = getelementptr inbounds i64* %"16", i64 %entry.0, !dbg !81
  %"34" = load i64* %"33", align 8, !dbg !81
  %"35" = icmp ne i64 %"34", 0, !dbg !81
  br i1 %"35", label %main_bb13, label %main_bb17, !dbg !81

main_bb13:                                        ; preds = %main_bb12
  %"36" = add nsw i64 %entry.0, 1, !dbg !83
  %"37" = icmp sgt i64 %"36", 2147483647, !dbg !85
  br i1 %"37", label %main_bb14, label %main_bb15, !dbg !85

main_bb14:                                        ; preds = %main_bb13
  %"38" = sub nsw i64 %"36", 2147483647, !dbg !86
  %"39" = sub nsw i64 %"38", 1, !dbg !86
  %"40" = srem i64 %"39", 4294967296, !dbg !86
  %"41" = add nsw i64 -2147483648, %"40", !dbg !86
  br label %main_wrap_around.exit2, !dbg !86

main_bb15:                                        ; preds = %main_bb13
  %"42" = icmp slt i64 %"36", -2147483648, !dbg !87
  br i1 %"42", label %main_bb16, label %main_wrap_around.exit2, !dbg !87

main_bb16:                                        ; preds = %main_bb15
  %"43" = sub nsw i64 -2147483648, %"36", !dbg !88
  %"44" = sub nsw i64 %"43", 1, !dbg !88
  %"45" = srem i64 %"44", 4294967296, !dbg !88
  %"46" = sub nsw i64 2147483647, %"45", !dbg !88
  br label %main_wrap_around.exit2, !dbg !88

main_bb17:                                        ; preds = %main_bb12, %main_wrap_around.exit2, %main_bb11
  call void @llvm.stackrestore(i8* %"15"), !dbg !89
  br label %main_bb18

main_bb18:                                        ; preds = %main_bb5, %main_bb17
  ret i32 0, !dbg !89
}
...
!41 = metadata !{i32 29, i32 5, metadata !9, null}
!42 = metadata !{i32 786688, metadata !9, metadata !"mcelog_entry", metadata !5, i32 29, metadata !43, i32 8192, i32 0} ; [ DW_TAG_auto_variable ] [mcelog_entry] [line 29]
...
!46 = metadata !{i32 29, i32 15, metadata !9, null}
!47 = metadata !{i64 0}
...
!67 = metadata !{i32 32, i32 27, metadata !68, null}
!68 = metadata !{i32 786443, metadata !1, metadata !49, i32 31, i32 1, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 14, i32 9, metadata !26, metadata !52}
!70 = metadata !{i32 15, i32 9, metadata !28, metadata !52}
!71 = metadata !{i32 17, i32 14, metadata !30, metadata !52}
!72 = metadata !{i32 18, i32 9, metadata !32, metadata !52}
!73 = metadata !{i32 786688, metadata !9, metadata !"entry", metadata !5, i32 34, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [entry] [line 34]
!74 = metadata !{i32 34, i32 15, metadata !9, null}
!75 = metadata !{i32 35, i32 9, metadata !76, null}
!76 = metadata !{i32 786443, metadata !1, metadata !9, i32 35, i32 9, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!77 = metadata !{i32 41, i32 13, metadata !78, null}
!78 = metadata !{i32 786443, metadata !1, metadata !79, i32 41, i32 13, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!79 = metadata !{i32 786443, metadata !1, metadata !80, i32 40, i32 5, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!80 = metadata !{i32 786443, metadata !1, metadata !9, i32 39, i32 5, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!81 = metadata !{i32 45, i32 13, metadata !82, null}
!82 = metadata !{i32 786443, metadata !1, metadata !79, i32 45, i32 13, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!83 = metadata !{i32 47, i32 22, metadata !84, null}
!84 = metadata !{i32 786443, metadata !1, metadata !82, i32 46, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!85 = metadata !{i32 14, i32 9, metadata !26, metadata !83}
!86 = metadata !{i32 15, i32 9, metadata !28, metadata !83}
!87 = metadata !{i32 17, i32 14, metadata !30, metadata !83}
!88 = metadata !{i32 18, i32 9, metadata !32, metadata !83}
!89 = metadata !{i32 53, i32 1, metadata !9, null}
