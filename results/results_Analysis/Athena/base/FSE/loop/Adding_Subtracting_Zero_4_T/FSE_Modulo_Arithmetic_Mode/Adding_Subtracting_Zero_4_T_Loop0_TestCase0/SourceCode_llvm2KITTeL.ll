...
main_bb21:
  ...
  br i1 %"54", label %main_bb50, label %main_wrap_around.exit, !dbg !84

main_wrap_around.exit:                            ; preds = %main_bb49, %main_bb48, %main_bb47, %main_bb42, %main_bb41, %main_bb40, %main_bb21
  %tries.0 = phi i64 [ 0, %main_bb21 ], [ %"105", %main_bb40 ], [ %"110", %main_bb42 ], [ %"99", %main_bb41 ], [ %tries.0, %main_bb47 ], [ %tries.0, %main_bb48 ], [ %tries.0, %main_bb49 ]
  %buf.0 = phi i64 [ 0, %main_bb21 ], [ %buf.0, %main_bb40 ], [ %buf.0, %main_bb41 ], [ %buf.0, %main_bb42 ], [ %"127", %main_bb47 ], [ %"132", %main_bb49 ], [ %"122", %main_bb48 ]
  %count.0 = phi i64 [ %"53", %main_bb21 ], [ %count.0, %main_bb40 ], [ %count.0, %main_bb41 ], [ %count.0, %main_bb42 ], [ %.0.i4, %main_bb47 ], [ %.0.i4, %main_bb48 ], [ %.0.i4, %main_bb49 ]
  %"55" = icmp sgt i64 %count.0, 0, !dbg !86
  br i1 %"55", label %main_bb22, label %main_bb50, !dbg !86
...
main_read.exit:                                   ; preds = %main_bb22, %main_wrap_around.exit2.i, %main_bb23, %main_bb36
  ...
  %"97" = icmp sle i64 %.0.i, 0, !dbg !114
  br i1 %"97", label %main_bb37, label %main_bb43, !dbg !114

main_bb37:                                        ; preds = %main_read.exit
  %"98" = icmp eq i64 %.0.i, 0, !dbg !116
  br i1 %"98", label %main_bb38, label %main_wrap_around.exit7, !dbg !116

main_bb38:                                        ; preds = %main_bb37
  %"99" = add nsw i64 %tries.0, 1, !dbg !119
  %"100" = icmp slt i64 %tries.0, 5, !dbg !119
  br i1 %"100", label %main_bb39, label %main_wrap_around.exit7, !dbg !119

main_bb39:                                        ; preds = %main_bb38
  %"101" = icmp sgt i64 %"99", 2147483647, !dbg !121
  br i1 %"101", label %main_bb40, label %main_bb41, !dbg !121

main_bb40:                                        ; preds = %main_bb39
  %"102" = sub nsw i64 %"99", 2147483647, !dbg !124
  %"103" = sub nsw i64 %"102", 1, !dbg !124
  %"104" = srem i64 %"103", 4294967296, !dbg !124
  %"105" = add nsw i64 -2147483648, %"104", !dbg !124
  br label %main_wrap_around.exit, !dbg !124

main_bb41:                                        ; preds = %main_bb39
  %"106" = icmp slt i64 %"99", -2147483648, !dbg !125
  br i1 %"106", label %main_bb42, label %main_wrap_around.exit, !dbg !125

main_bb42:                                        ; preds = %main_bb41
  %"107" = sub nsw i64 -2147483648, %"99", !dbg !126
  %"108" = sub nsw i64 %"107", 1, !dbg !126
  %"109" = srem i64 %"108", 4294967296, !dbg !126
  %"110" = sub nsw i64 2147483647, %"109", !dbg !126
  br label %main_wrap_around.exit, !dbg !126

main_wrap_around.exit7:                           ; preds = %main_bb38, %main_bb37
  call void @llvm.dbg.value(metadata !127, i64 0, metadata !128), !dbg !130
  call void @llvm.dbg.value(metadata !131, i64 0, metadata !132), !dbg !133
  call void @llvm.dbg.value(metadata !134, i64 0, metadata !135), !dbg !136
  br label %main_bb50, !dbg !137

main_bb43:                                        ; preds = %main_read.exit
  %"111" = sub nsw i64 %count.0, %.0.i, !dbg !138
  %"112" = icmp sgt i64 %"111", 2147483647, !dbg !139
  br i1 %"112", label %main_bb44, label %main_bb45, !dbg !139

main_bb44:                                        ; preds = %main_bb43
  %"113" = sub nsw i64 %"111", 2147483647, !dbg !140
  %"114" = sub nsw i64 %"113", 1, !dbg !140
  %"115" = srem i64 %"114", 4294967296, !dbg !140
  %"116" = add nsw i64 -2147483648, %"115", !dbg !140
  br label %main_wrap_around.exit5, !dbg !140

main_bb45:                                        ; preds = %main_bb43
  %"117" = icmp slt i64 %"111", -2147483648, !dbg !141
  br i1 %"117", label %main_bb46, label %main_wrap_around.exit5, !dbg !141

main_bb46:                                        ; preds = %main_bb45
  %"118" = sub nsw i64 -2147483648, %"111", !dbg !142
  %"119" = sub nsw i64 %"118", 1, !dbg !142
  %"120" = srem i64 %"119", 4294967296, !dbg !142
  %"121" = sub nsw i64 2147483647, %"120", !dbg !142
  br label %main_wrap_around.exit5, !dbg !142

main_wrap_around.exit5:                           ; preds = %main_bb44, %main_bb45, %main_bb46
  %.0.i4 = phi i64 [ %"116", %main_bb44 ], [ %"121", %main_bb46 ], [ %"111", %main_bb45 ], !dbg !138
  %"122" = add nsw i64 %buf.0, %.0.i, !dbg !143
  %"123" = icmp sgt i64 %"122", 2147483647, !dbg !144
  br i1 %"123", label %main_bb47, label %main_bb48, !dbg !144

main_bb47:                                        ; preds = %main_wrap_around.exit5
  %"124" = sub nsw i64 %"122", 2147483647, !dbg !145
  %"125" = sub nsw i64 %"124", 1, !dbg !145
  %"126" = srem i64 %"125", 4294967296, !dbg !145
  %"127" = add nsw i64 -2147483648, %"126", !dbg !145
  br label %main_wrap_around.exit, !dbg !145

main_bb48:                                        ; preds = %main_wrap_around.exit5
  %"128" = icmp slt i64 %"122", -2147483648, !dbg !146
  br i1 %"128", label %main_bb49, label %main_wrap_around.exit, !dbg !146

main_bb49:                                        ; preds = %main_bb48
  %"129" = sub nsw i64 -2147483648, %"122", !dbg !147
  %"130" = sub nsw i64 %"129", 1, !dbg !147
  %"131" = srem i64 %"130", 4294967296, !dbg !147
  %"132" = sub nsw i64 2147483647, %"131", !dbg !147
  br label %main_wrap_around.exit, !dbg !147

main_bb50:                                        ; preds = %main_wrap_around.exit, %main_bb21, %main_wrap_around.exit7
  ret i32 0, !dbg !148
}
...
!86 = metadata !{i32 68, i32 5, metadata !87, null}
!87 = metadata !{i32 786443, metadata !1, metadata !12, i32 68, i32 5, i32 1, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!88 = metadata !{i32 25, i32 9, metadata !47, metadata !89}
!89 = metadata !{i32 70, i32 15, metadata !90, null}
!90 = metadata !{i32 786443, metadata !1, metadata !12, i32 69, i32 5, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!114 = metadata !{i32 71, i32 13, metadata !115, null}
!115 = metadata !{i32 786443, metadata !1, metadata !90, i32 71, i32 13, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!116 = metadata !{i32 73, i32 17, metadata !117, null}
!117 = metadata !{i32 786443, metadata !1, metadata !118, i32 73, i32 17, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!118 = metadata !{i32 786443, metadata !1, metadata !115, i32 72, i32 9, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!119 = metadata !{i32 73, i32 17, metadata !120, null}
!120 = metadata !{i32 786443, metadata !1, metadata !117, i32 73, i32 17, i32 1, i32 24} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!121 = metadata !{i32 14, i32 9, metadata !31, metadata !122}
!122 = metadata !{i32 75, i32 9, metadata !123, null}
!123 = metadata !{i32 786443, metadata !1, metadata !117, i32 74, i32 1, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!129 = metadata !{i32 78, i32 9, metadata !118, null}
!130 = metadata !{i32 12, i32 50, metadata !4, metadata !129}
!131 = metadata !{i64 2147483647}
!132 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !129} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!133 = metadata !{i32 12, i32 73, metadata !4, metadata !129}
!134 = metadata !{i64 4294967296}
...
!137 = metadata !{i32 79, i32 13, metadata !118, null}
!138 = metadata !{i32 81, i32 17, metadata !90, null}
...
!143 = metadata !{i32 82, i32 15, metadata !90, null}
...
!148 = metadata !{i32 85, i32 1, metadata !12, null}
