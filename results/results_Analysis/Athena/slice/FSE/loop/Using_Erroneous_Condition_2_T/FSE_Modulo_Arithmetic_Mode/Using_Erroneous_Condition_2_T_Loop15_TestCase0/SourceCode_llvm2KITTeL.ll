...
main_bb5:
  ...
  br i1 %"13", label %main_bb10, label %main_wrap_around.exit, !dbg !36
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  br i1 %"14", label %main_bb6, label %main_bb10, !dbg !38

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"15" = add nsw i64 %i.0, 1, !dbg !41
  %"16" = icmp sgt i64 %"15", 2147483647, !dbg !43
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !43

main_bb7:                                         ; preds = %main_bb6
  %"17" = sub nsw i64 %"15", 2147483647, !dbg !44
  %"18" = sub nsw i64 %"17", 1, !dbg !44
  %"19" = srem i64 %"18", 4294967296, !dbg !44
  %"20" = add nsw i64 -2147483648, %"19", !dbg !44
  br label %main_wrap_around.exit, !dbg !44

main_bb8:                                         ; preds = %main_bb6
  %"21" = icmp slt i64 %"15", -2147483648, !dbg !45
  br i1 %"21", label %main_bb9, label %main_wrap_around.exit, !dbg !45

main_bb9:                                         ; preds = %main_bb8
  %"22" = sub nsw i64 -2147483648, %"15", !dbg !46
  %"23" = sub nsw i64 %"22", 1, !dbg !46
  %"24" = srem i64 %"23", 4294967296, !dbg !46
  %"25" = sub nsw i64 2147483647, %"24", !dbg !46
...
!33 = metadata !{i32 20, i32 25, metadata !9, null}
!34 = metadata !{i32 786688, metadata !9, metadata !"reg_count", metadata !5, i32 20, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [reg_count] [line 20]
...
!39 = metadata !{i32 786443, metadata !1, metadata !40, i32 27, i32 5, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!40 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 3, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 28, i32 8, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !40, i32 28, i32 1, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 9, i32 9, metadata !25, metadata !41}
!44 = metadata !{i32 10, i32 9, metadata !27, metadata !41}
!45 = metadata !{i32 12, i32 14, metadata !29, metadata !41}
!46 = metadata !{i32 13, i32 9, metadata !31, metadata !41}
!47 = metadata !{i32 31, i32 17, metadata !9, null}
