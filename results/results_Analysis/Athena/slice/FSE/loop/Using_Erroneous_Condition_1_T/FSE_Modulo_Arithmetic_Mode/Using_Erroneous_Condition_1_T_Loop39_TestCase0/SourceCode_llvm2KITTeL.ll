...
main_bb9:                                         ; preds = %main_bb8
  %"43" = sub nsw i64 %"39", 1, !dbg !82
  call void @llvm.dbg.value(metadata !{i64 %"43"}, i64 0, metadata !84), !dbg !85
  ...
  %"44" = icmp sgt i64 %"43", 2147483647, !dbg !95
  br i1 %"44", label %main_bb10, label %main_bb11, !dbg !95

main_bb10:                                        ; preds = %main_bb9
  %"45" = sub nsw i64 %"43", 2147483647, !dbg !96
  %"46" = sub nsw i64 %"45", 1, !dbg !96
  %"47" = srem i64 %"46", 4294967296, !dbg !96
  %"48" = add nsw i64 -2147483648, %"47", !dbg !96
  br label %main_wrap_around.exit8, !dbg !96

main_bb11:                                        ; preds = %main_bb9
  %"49" = icmp slt i64 %"43", -2147483648, !dbg !97
  br i1 %"49", label %main_bb12, label %main_wrap_around.exit8, !dbg !97

main_bb12:                                        ; preds = %main_bb11
  %"50" = sub nsw i64 -2147483648, %"43", !dbg !98
  %"51" = sub nsw i64 %"50", 1, !dbg !98
  %"52" = srem i64 %"51", 4294967296, !dbg !98
  %"53" = sub nsw i64 2147483647, %"52", !dbg !98
  br label %main_wrap_around.exit8, !dbg !98

main_bb13:                                        ; preds = %main_bb8
  %"54" = add nsw i64 %"39", 1, !dbg !99
  call void @llvm.dbg.value(metadata !{i64 %"54"}, i64 0, metadata !102), !dbg !103
  ...
  %"55" = icmp sgt i64 %"54", 2147483647, !dbg !110
  br i1 %"55", label %main_bb14, label %main_bb15, !dbg !110

main_bb14:                                        ; preds = %main_bb13
  %"56" = sub nsw i64 %"54", 2147483647, !dbg !111
  %"57" = sub nsw i64 %"56", 1, !dbg !111
  %"58" = srem i64 %"57", 4294967296, !dbg !111
  %"59" = add nsw i64 -2147483648, %"58", !dbg !111
  br label %main_wrap_around.exit8, !dbg !111

main_bb15:                                        ; preds = %main_bb13
  %"60" = icmp slt i64 %"54", -2147483648, !dbg !112
  br i1 %"60", label %main_bb16, label %main_wrap_around.exit8, !dbg !112

main_bb16:                                        ; preds = %main_bb15
  %"61" = sub nsw i64 -2147483648, %"54", !dbg !113
  %"62" = sub nsw i64 %"61", 1, !dbg !113
  %"63" = srem i64 %"62", 4294967296, !dbg !113
  %"64" = sub nsw i64 2147483647, %"63", !dbg !113
...
main_wrap_around.exit8:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb10, %main_bb11, %main_bb12
  ...
  %"65" = sext i32 %"15" to i64, !dbg !114
  %"66" = getelementptr inbounds [100000 x %struct.Node]* @memory0, i32 0, i64 %"65", !dbg !114
  %"67" = getelementptr inbounds %struct.Node* %"66", i32 0, i32 0, !dbg !114
  %"68" = load i64* %"67", align 8, !dbg !114
  %"69" = srem i64 %pos.0, %"68", !dbg !114
  call void @llvm.dbg.value(metadata !{i64 %"69"}, i64 0, metadata !115), !dbg !116
  ...
  %"70" = icmp sgt i64 %"69", 2147483647, !dbg !123
  br i1 %"70", label %main_bb17, label %main_bb18, !dbg !123

main_bb17:                                        ; preds = %main_wrap_around.exit8
  %"71" = sub nsw i64 %"69", 2147483647, !dbg !124
  %"72" = sub nsw i64 %"71", 1, !dbg !124
  %"73" = srem i64 %"72", 4294967296, !dbg !124
  %"74" = add nsw i64 -2147483648, %"73", !dbg !124
  br label %main_wrap_around.exit4, !dbg !124

main_bb18:                                        ; preds = %main_wrap_around.exit8
  %"75" = icmp slt i64 %"69", -2147483648, !dbg !125
  br i1 %"75", label %main_bb19, label %main_wrap_around.exit4, !dbg !125

main_bb19:                                        ; preds = %main_bb18
  %"76" = sub nsw i64 -2147483648, %"69", !dbg !126
  %"77" = sub nsw i64 %"76", 1, !dbg !126
  %"78" = srem i64 %"77", 4294967296, !dbg !126
  %"79" = sub nsw i64 2147483647, %"78", !dbg !126
  br label %main_wrap_around.exit4, !dbg !126

main_wrap_around.exit4:                           ; preds = %main_bb17, %main_bb18, %main_bb19
  %.0.i3 = phi i64 [ %"74", %main_bb17 ], [ %"79", %main_bb19 ], [ %"69", %main_bb18 ], !dbg !114
  ...
  call void @llvm.dbg.value(metadata !{i64 %"88"}, i64 0, metadata !129), !dbg !132
  ...
  %"80" = sext i32 %"15" to i64, !dbg !139
  %"81" = getelementptr inbounds [100000 x %struct.Node]* @memory0, i32 0, i64 %"80", !dbg !139
  %"82" = getelementptr inbounds %struct.Node* %"81", i32 0, i32 0, !dbg !139
  %"83" = load i64* %"82", align 8, !dbg !139
  call void @llvm.dbg.value(metadata !141, i64 0, metadata !72), !dbg !73
  %"84" = sext i32 %"15" to i64, !dbg !142
  %"85" = getelementptr inbounds [100000 x %struct.Node]* @memory0, i32 0, i64 %"84", !dbg !142
  %"86" = getelementptr inbounds %struct.Node* %"85", i32 0, i32 0, !dbg !142
  %"87" = load i64* %"86", align 8, !dbg !142
  call void @llvm.dbg.value(metadata !{i64 %"101"}, i64 0, metadata !145), !dbg !146
...
main_bb20:                                        ; preds = %main_wrap_around.exit, %main_wrap_around.exit4
  ...
  %"88" = add nsw i64 %pos.1, %direction.0, !dbg !130
  %"89" = icmp sgt i64 %"88", 2147483647, !dbg !154
  br i1 %"89", label %main_bb21, label %main_bb22, !dbg !154

main_bb21:                                        ; preds = %main_bb20
  %"90" = sub nsw i64 %"88", 2147483647, !dbg !155
  %"91" = sub nsw i64 %"90", 1, !dbg !155
  %"92" = srem i64 %"91", 4294967296, !dbg !155
  %"93" = add nsw i64 -2147483648, %"92", !dbg !155
  br label %main_wrap_around.exit2, !dbg !155

main_bb22:                                        ; preds = %main_bb20
  %"94" = icmp slt i64 %"88", -2147483648, !dbg !156
  br i1 %"94", label %main_bb23, label %main_wrap_around.exit2, !dbg !156

main_bb23:                                        ; preds = %main_bb22
  %"95" = sub nsw i64 -2147483648, %"88", !dbg !157
  %"96" = sub nsw i64 %"95", 1, !dbg !157
  %"97" = srem i64 %"96", 4294967296, !dbg !157
  %"98" = sub nsw i64 2147483647, %"97", !dbg !157
  br label %main_wrap_around.exit2, !dbg !157

main_wrap_around.exit2:                           ; preds = %main_bb21, %main_bb22, %main_bb23
  %.0.i1 = phi i64 [ %"93", %main_bb21 ], [ %"98", %main_bb23 ], [ %"88", %main_bb22 ], !dbg !130
  %"99" = icmp eq i64 %.0.i1, %"83", !dbg !139
  br i1 %"99", label %main_wrap_around.exit, label %main_bb24, !dbg !139

main_bb24:                                        ; preds = %main_wrap_around.exit2
  %"100" = icmp slt i64 %.0.i1, 0, !dbg !158
  br i1 %"100", label %main_bb25, label %main_wrap_around.exit, !dbg !158

main_bb25:                                        ; preds = %main_bb24
  %"101" = sub nsw i64 %"87", 1, !dbg !142
  %"102" = icmp sgt i64 %"101", 2147483647, !dbg !159
  br i1 %"102", label %main_bb26, label %main_bb27, !dbg !159

main_bb26:                                        ; preds = %main_bb25
  %"103" = sub nsw i64 %"101", 2147483647, !dbg !160
  %"104" = sub nsw i64 %"103", 1, !dbg !160
  %"105" = srem i64 %"104", 4294967296, !dbg !160
  %"106" = add nsw i64 -2147483648, %"105", !dbg !160
  br label %main_wrap_around.exit, !dbg !160

main_bb27:                                        ; preds = %main_bb25
  %"107" = icmp slt i64 %"101", -2147483648, !dbg !161
  br i1 %"107", label %main_bb28, label %main_wrap_around.exit, !dbg !161

main_bb28:                                        ; preds = %main_bb27
  %"108" = sub nsw i64 -2147483648, %"101", !dbg !162
  %"109" = sub nsw i64 %"108", 1, !dbg !162
  %"110" = srem i64 %"109", 4294967296, !dbg !162
  %"111" = sub nsw i64 2147483647, %"110", !dbg !162
...
main_wrap_around.exit:                            ; preds = %main_bb24, %main_bb26, %main_bb27, %main_bb28, %main_wrap_around.exit2
  ...
  %"112" = icmp ne i64 %pos.3, %.0.i3, !dbg !163
  br i1 %"112", label %main_bb20, label %main_bb29, !dbg !163
