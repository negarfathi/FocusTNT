...
main_bb6:                                         ; preds = %main_bb5
  ...
  call void @llvm.dbg.value(metadata !{i64 %"17"}, i64 0, metadata !41), !dbg !44
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  %h.0 = phi i64 [ %"14", %main_bb6 ], [ %"22", %main_bb8 ], [ %"27", %main_bb10 ], [ %"17", %main_bb9 ]
  %linesToRead.0 = phi i64 [ %"12", %main_bb6 ], [ %h.0.linesToRead.0, %main_bb8 ], [ %h.0.linesToRead.0, %main_bb9 ], [ %h.0.linesToRead.0, %main_bb10 ]
  %"15" = icmp sgt i64 %h.0, 0, !dbg !55
  br i1 %"15", label %main_bb7, label %main_bb11, !dbg !55

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"16" = icmp sgt i64 %linesToRead.0, %h.0, !dbg !57
  %h.0.linesToRead.0 = select i1 %"16", i64 %h.0, i64 %linesToRead.0, !dbg !57
  %"17" = sub nsw i64 %h.0, %h.0.linesToRead.0, !dbg !42
  %"18" = icmp sgt i64 %"17", 2147483647, !dbg !59
  br i1 %"18", label %main_bb8, label %main_bb9, !dbg !59

main_bb8:                                         ; preds = %main_bb7
  %"19" = sub nsw i64 %"17", 2147483647, !dbg !60
  %"20" = sub nsw i64 %"19", 1, !dbg !60
  %"21" = srem i64 %"20", 4294967296, !dbg !60
  %"22" = add nsw i64 -2147483648, %"21", !dbg !60
  br label %main_wrap_around.exit, !dbg !60

main_bb9:                                         ; preds = %main_bb7
  %"23" = icmp slt i64 %"17", -2147483648, !dbg !61
  br i1 %"23", label %main_bb10, label %main_wrap_around.exit, !dbg !61

main_bb10:                                        ; preds = %main_bb9
  %"24" = sub nsw i64 -2147483648, %"17", !dbg !62
  %"25" = sub nsw i64 %"24", 1, !dbg !62
  %"26" = srem i64 %"25", 4294967296, !dbg !62
  %"27" = sub nsw i64 2147483647, %"26", !dbg !62
...
!33 = metadata !{i32 19, i32 27, metadata !9, null}
!34 = metadata !{i32 786688, metadata !9, metadata !"linesToRead", metadata !5, i32 19, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [linesToRead] [line 19]
!35 = metadata !{i32 19, i32 13, metadata !9, null}
!36 = metadata !{i32 20, i32 7, metadata !37, null}
!37 = metadata !{i32 786443, metadata !1, metadata !9, i32 20, i32 7, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!38 = metadata !{i32 23, i32 17, metadata !9, null}
!39 = metadata !{i32 786688, metadata !9, metadata !"h", metadata !5, i32 23, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [h] [line 23]
!40 = metadata !{i32 23, i32 13, metadata !9, null}
...
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 17, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!54 = metadata !{i32 24, i32 3, metadata !9, null}
!55 = metadata !{i32 24, i32 3, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 3, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 25, i32 9, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !43, i32 25, i32 9, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 9, i32 9, metadata !25, metadata !42}
!60 = metadata !{i32 10, i32 9, metadata !27, metadata !42}
!61 = metadata !{i32 12, i32 14, metadata !29, metadata !42}
!62 = metadata !{i32 13, i32 9, metadata !31, metadata !42}
!63 = metadata !{i32 30, i32 17, metadata !9, null}
