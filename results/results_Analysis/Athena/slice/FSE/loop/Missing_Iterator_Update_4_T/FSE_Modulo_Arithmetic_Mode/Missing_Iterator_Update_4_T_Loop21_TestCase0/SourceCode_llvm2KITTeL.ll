...
main_bb5:
  ...
  %"14" = icmp slt i64 %"12", 0, !dbg !39
  %"15" = icmp slt i64 %"13", 0, !dbg !41
  %or.cond = or i1 %"14", %"15", !dbg !39
  %"16" = icmp sgt i64 %"12", 65534, !dbg !43
  %or.cond3 = or i1 %or.cond, %"16", !dbg !39
  %"17" = icmp sgt i64 %"13", 65534, !dbg !45
  %or.cond4 = or i1 %or.cond3, %"17", !dbg !39
  br i1 %or.cond4, label %main_bb14, label %main_wrap_around.exit2, !dbg !39

main_wrap_around.exit2:                           ; preds = %main_bb5, %main_bb13, %main_bb12, %main_bb11
  %x.0 = phi i64 [ %"36", %main_bb11 ], [ %"41", %main_bb13 ], [ %"31", %main_bb12 ], [ 0, %main_bb5 ]
  %"18" = icmp slt i64 %x.0, %"12", !dbg !47
  br i1 %"18", label %main_wrap_around.exit, label %main_bb14, !dbg !47

main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  %y.0 = phi i64 [ 0, %main_wrap_around.exit2 ], [ %"25", %main_bb7 ], [ %"30", %main_bb9 ], [ %"20", %main_bb8 ]
  %"19" = icmp slt i64 %y.0, %"13", !dbg !49
  br i1 %"19", label %main_bb6, label %main_bb10, !dbg !49

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"20" = add nsw i64 %y.0, 1, !dbg !52
  %"21" = icmp sgt i64 %"20", 2147483647, !dbg !54
  br i1 %"21", label %main_bb7, label %main_bb8, !dbg !54

main_bb7:                                         ; preds = %main_bb6
  %"22" = sub nsw i64 %"20", 2147483647, !dbg !55
  %"23" = sub nsw i64 %"22", 1, !dbg !55
  %"24" = srem i64 %"23", 4294967296, !dbg !55
  %"25" = add nsw i64 -2147483648, %"24", !dbg !55
  br label %main_wrap_around.exit, !dbg !55

main_bb8:                                         ; preds = %main_bb6
  %"26" = icmp slt i64 %"20", -2147483648, !dbg !56
  br i1 %"26", label %main_bb9, label %main_wrap_around.exit, !dbg !56

main_bb9:                                         ; preds = %main_bb8
  %"27" = sub nsw i64 -2147483648, %"20", !dbg !57
  %"28" = sub nsw i64 %"27", 1, !dbg !57
  %"29" = srem i64 %"28", 4294967296, !dbg !57
  %"30" = sub nsw i64 2147483647, %"29", !dbg !57
  br label %main_wrap_around.exit, !dbg !57

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"31" = add nsw i64 %x.0, 1, !dbg !58
  call void @llvm.dbg.value(metadata !{i64 %"31"}, i64 0, metadata !59), !dbg !60
  ...
  %"32" = icmp sgt i64 %"31", 2147483647, !dbg !70
  br i1 %"32", label %main_bb11, label %main_bb12, !dbg !70

main_bb11:                                        ; preds = %main_bb10
  %"33" = sub nsw i64 %"31", 2147483647, !dbg !71
  %"34" = sub nsw i64 %"33", 1, !dbg !71
  %"35" = srem i64 %"34", 4294967296, !dbg !71
  %"36" = add nsw i64 -2147483648, %"35", !dbg !71
  br label %main_wrap_around.exit2, !dbg !71

main_bb12:                                        ; preds = %main_bb10
  %"37" = icmp slt i64 %"31", -2147483648, !dbg !72
  br i1 %"37", label %main_bb13, label %main_wrap_around.exit2, !dbg !72

main_bb13:                                        ; preds = %main_bb12
  %"38" = sub nsw i64 -2147483648, %"31", !dbg !73
  %"39" = sub nsw i64 %"38", 1, !dbg !73
  %"40" = srem i64 %"39", 4294967296, !dbg !73
  %"41" = sub nsw i64 2147483647, %"40", !dbg !73
...
!33 = metadata !{i32 22, i32 27, metadata !9, null}
...
!36 = metadata !{i32 23, i32 27, metadata !9, null}
!37 = metadata !{i32 786688, metadata !9, metadata !"mat_rowSize", metadata !5, i32 23, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [mat_rowSize] [line 23]
...
!43 = metadata !{i32 33, i32 11, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !42, i32 33, i32 11, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 38, i32 13, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !44, i32 38, i32 13, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 43, i32 3, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !9, i32 43, i32 3, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 45, i32 5, metadata !50, null}
!50 = metadata !{i32 786443, metadata !1, metadata !51, i32 45, i32 5, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 786443, metadata !1, metadata !9, i32 43, i32 27, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 46, i32 8, metadata !53, null}
!53 = metadata !{i32 786443, metadata !1, metadata !51, i32 46, i32 1, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 9, i32 9, metadata !25, metadata !52}
!55 = metadata !{i32 10, i32 9, metadata !27, metadata !52}
!56 = metadata !{i32 12, i32 14, metadata !29, metadata !52}
!57 = metadata !{i32 13, i32 9, metadata !31, metadata !52}
!58 = metadata !{i32 48, i32 10, metadata !51, null}
!59 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !58} ; [ DW_TAG_arg_variable ] [value] [line 7]
!60 = metadata !{i32 7, i32 33, metadata !4, metadata !58}
!61 = metadata !{i64 -2147483648}
!62 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !58} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!63 = metadata !{i32 7, i32 50, metadata !4, metadata !58}
!64 = metadata !{i64 2147483647}
!65 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !58} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!66 = metadata !{i32 7, i32 73, metadata !4, metadata !58}
!67 = metadata !{i64 4294967296}
!68 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !58} ; [ DW_TAG_auto_variable ] [range] [line 8]
!69 = metadata !{i32 8, i32 15, metadata !4, metadata !58} ; [ DW_TAG_imported_declaration ]
!70 = metadata !{i32 9, i32 9, metadata !25, metadata !58}
!71 = metadata !{i32 10, i32 9, metadata !27, metadata !58}
!72 = metadata !{i32 12, i32 14, metadata !29, metadata !58}
!73 = metadata !{i32 13, i32 9, metadata !31, metadata !58}
!74 = metadata !{i32 50, i32 17, metadata !9, null}
