...
main_bb1:                                         ; preds = %main_bb2, %main_bb0
  ...
  %"0" = icmp slt i32 %i.0, 10, !dbg !24
  br i1 %"0", label %main_bb2, label %main_bb3, !dbg !24

main_bb2:                                         ; preds = %main_bb1
  %"1" = call i32 @__VERIFIER_nondet_int(), !dbg !26
  %"2" = sext i32 %i.0 to i64, !dbg !26
  %"3" = getelementptr inbounds [10 x i32]* %slots_used, i32 0, i64 %"2", !dbg !26
  store i32 %"1", i32* %"3", align 4, !dbg !26
  %"4" = call i32 @__VERIFIER_nondet_int(), !dbg !28
  %"5" = sext i32 %i.0 to i64, !dbg !28
  %"6" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"5", !dbg !28
  store i32 %"4", i32* %"6", align 4, !dbg !28
  %"7" = add nsw i32 %i.0, 1, !dbg !29
...
!19 = metadata !{i32 0}
!20 = metadata !{i32 786688, metadata !21, metadata !"i", metadata !5, i32 10, metadata !13, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 10]
...
!26 = metadata !{i32 12, i32 23, metadata !27, null}
!27 = metadata !{i32 786443, metadata !1, metadata !21, i32 11, i32 20, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
