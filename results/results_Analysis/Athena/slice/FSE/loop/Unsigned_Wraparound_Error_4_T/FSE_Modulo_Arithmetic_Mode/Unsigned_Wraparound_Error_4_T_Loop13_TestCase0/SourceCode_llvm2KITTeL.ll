...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %n.0}, i64 0, metadata !36), !dbg !38
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !36), !dbg !38
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !40), !dbg !42
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %n.0 = phi i64 [ %"12", %main_bb5 ], [ %"19", %main_bb7 ], [ %"24", %main_bb9 ], [ %"15", %main_bb8 ]
  %"13" = icmp sgt i64 %n.0, 0, !dbg !53
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !53

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = icmp sgt i64 %n.0, 16, !dbg !55
  %.n.0 = select i1 %"14", i64 16, i64 %n.0, !dbg !55
  %"15" = sub nsw i64 %n.0, %.n.0, !dbg !41
  %"16" = icmp sgt i64 %"15", 4294967295, !dbg !57
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !57

main_bb7:                                         ; preds = %main_bb6
  %"17" = sub nsw i64 %"15", 4294967295, !dbg !58
  %"18" = sub nsw i64 %"17", 1, !dbg !58
  %"19" = srem i64 %"18", 4294967296, !dbg !58
  br label %main_wrap_around.exit, !dbg !58

main_bb8:                                         ; preds = %main_bb6
  %"20" = icmp slt i64 %"15", 0, !dbg !59
  br i1 %"20", label %main_bb9, label %main_wrap_around.exit, !dbg !59

main_bb9:                                         ; preds = %main_bb8
  %"21" = sub nsw i64 0, %"15", !dbg !60
  %"22" = sub nsw i64 %"21", 1, !dbg !60
  %"23" = srem i64 %"22", 4294967296, !dbg !60
  %"24" = sub nsw i64 4294967295, %"23", !dbg !60
...
!33 = metadata !{i32 19, i32 17, metadata !9, null}
!34 = metadata !{i32 786688, metadata !9, metadata !"n", metadata !5, i32 19, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [n] [line 19]
!35 = metadata !{i32 19, i32 13, metadata !9, null}
!36 = metadata !{i32 786688, metadata !37, metadata !"len", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [len] [line 21]
!37 = metadata !{i32 786443, metadata !1, metadata !9, i32 20, i32 31, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!41 = metadata !{i32 25, i32 9, metadata !37, null}
!42 = metadata !{i32 7, i32 33, metadata !4, metadata !41}
!43 = metadata !{i64 0}
!44 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!45 = metadata !{i32 7, i32 50, metadata !4, metadata !41}
!46 = metadata !{i64 4294967295}
!47 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!48 = metadata !{i32 7, i32 73, metadata !4, metadata !41}
!49 = metadata !{i64 4294967296}
!50 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !41} ; [ DW_TAG_auto_variable ] [range] [line 8]
!51 = metadata !{i32 8, i32 15, metadata !4, metadata !41} ; [ DW_TAG_imported_declaration ]
!52 = metadata !{i32 20, i32 3, metadata !9, null}
!53 = metadata !{i32 20, i32 3, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !9, i32 20, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 22, i32 9, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !37, i32 22, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 9, i32 9, metadata !25, metadata !41}
!58 = metadata !{i32 10, i32 9, metadata !27, metadata !41}
!59 = metadata !{i32 12, i32 14, metadata !29, metadata !41}
!60 = metadata !{i32 13, i32 9, metadata !31, metadata !41}
!61 = metadata !{i32 27, i32 3, metadata !9, null}
