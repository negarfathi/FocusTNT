...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !42), !dbg !45
  ...
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !34), !dbg !35
...
main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  ...
  %"15" = icmp sle i64 %nfds.0, %"13", !dbg !56
  br i1 %"15", label %main_bb7, label %main_bb11, !dbg !56

main_bb7:                                         ; preds = %main_bb6
  %"16" = mul nsw i64 %nfds.0, 2, !dbg !43
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !58
  br i1 %"17", label %main_bb8, label %main_bb9, !dbg !58

main_bb8:                                         ; preds = %main_bb7
  %"18" = sub nsw i64 %"16", 2147483647, !dbg !59
  %"19" = sub nsw i64 %"18", 1, !dbg !59
  %"20" = srem i64 %"19", 4294967296, !dbg !59
  %"21" = add nsw i64 -2147483648, %"20", !dbg !59
  br label %main_wrap_around.exit, !dbg !59

main_bb9:                                         ; preds = %main_bb7
  %"22" = icmp slt i64 %"16", -2147483648, !dbg !60
  br i1 %"22", label %main_bb10, label %main_wrap_around.exit, !dbg !60

main_bb10:                                        ; preds = %main_bb9
  %"23" = sub nsw i64 -2147483648, %"16", !dbg !61
  %"24" = sub nsw i64 %"23", 1, !dbg !61
  %"25" = srem i64 %"24", 4294967296, !dbg !61
  %"26" = sub nsw i64 2147483647, %"25", !dbg !61
  br label %main_wrap_around.exit, !dbg !61

main_wrap_around.exit:                            ; preds = %main_bb8, %main_bb9, %main_bb10
  %.0.i = phi i64 [ %"21", %main_bb8 ], [ %"26", %main_bb10 ], [ %"16", %main_bb9 ], !dbg !43
  %"27" = icmp sgt i64 %.0.i, %"14", !dbg !62
  %..0.i = select i1 %"27", i64 %"14", i64 %.0.i, !dbg !62
  br label %main_bb6, !dbg !64
...
!33 = metadata !{i32 19, i32 20, metadata !9, null}
!34 = metadata !{i32 786688, metadata !9, metadata !"nfds", metadata !5, i32 19, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [nfds] [line 19]
!35 = metadata !{i32 19, i32 13, metadata !9, null}
!36 = metadata !{i32 20, i32 18, metadata !9, null}
!37 = metadata !{i32 786688, metadata !9, metadata !"nr", metadata !5, i32 20, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [nr] [line 20]
!38 = metadata !{i32 20, i32 13, metadata !9, null}
!39 = metadata !{i32 21, i32 23, metadata !9, null}
!40 = metadata !{i32 786688, metadata !9, metadata !"NR_OPEN", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [NR_OPEN] [line 21]
!41 = metadata !{i32 21, i32 13, metadata !9, null}
!42 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [value] [line 7]
!43 = metadata !{i32 23, i32 12, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 22, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 7, i32 33, metadata !4, metadata !43}
!46 = metadata !{i64 -2147483648}
!47 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!48 = metadata !{i32 7, i32 50, metadata !4, metadata !43}
!49 = metadata !{i64 2147483647}
!50 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!51 = metadata !{i32 7, i32 73, metadata !4, metadata !43}
!52 = metadata !{i64 4294967296}
!53 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !43} ; [ DW_TAG_auto_variable ] [range] [line 8]
!54 = metadata !{i32 8, i32 15, metadata !4, metadata !43} ; [ DW_TAG_imported_declaration ]
!55 = metadata !{i32 22, i32 3, metadata !9, null}
!56 = metadata !{i32 22, i32 3, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 9, i32 9, metadata !25, metadata !43}
!59 = metadata !{i32 10, i32 9, metadata !27, metadata !43}
!60 = metadata !{i32 12, i32 14, metadata !29, metadata !43}
!61 = metadata !{i32 13, i32 9, metadata !31, metadata !43}
!62 = metadata !{i32 24, i32 9, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !44, i32 24, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 27, i32 3, metadata !44, null}
!65 = metadata !{i32 28, i32 3, metadata !9, null}
