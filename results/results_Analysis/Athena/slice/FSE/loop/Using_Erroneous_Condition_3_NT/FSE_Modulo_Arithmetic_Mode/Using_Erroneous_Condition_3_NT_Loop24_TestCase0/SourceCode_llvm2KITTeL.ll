...
main_bb10:                                        ; preds = %main_wrap_around.exit
  ...
  call void @llvm.dbg.value(metadata !{i64 %"37"}, i64 0, metadata !79), !dbg !82
...
main_wrap_around.exit6:                           ; preds = %main_bb13, %main_bb14, %main_bb15
  ...
  %"48" = icmp eq i64 %.0.i5, %"13", !dbg !97
  br i1 %"48", label %main_bb16, label %main_bb11, !dbg !97
...
main_wrap_around.exit4:                           ; preds = %main_bb18, %main_bb19, %main_bb20
  ...
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !116), !dbg !117
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !118), !dbg !119
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !120), !dbg !121
