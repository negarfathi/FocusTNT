...
main_bb0:
  ...
  %"0" = call i32 @__VERIFIER_nondet_int(), !dbg !22
  call void @llvm.dbg.value(metadata !{i32 %"0"}, i64 0, metadata !23), !dbg !24
  %"1" = call i32 @__VERIFIER_nondet_int(), !dbg !25
  call void @llvm.dbg.value(metadata !{i32 %"1"}, i64 0, metadata !26), !dbg !27
  call void @llvm.dbg.value(metadata !19, i64 0, metadata !28), !dbg !30
...
main_bb2:                                         ; preds = %main_bb1
  ...
  %"4" = sext i32 %j.0 to i64, !dbg !34
  %"5" = getelementptr inbounds [10 x i32]* %old_, i32 0, i64 %"4", !dbg !34
  store i32 %"3", i32* %"5", align 4, !dbg !34
  %"6" = call i32 @__VERIFIER_nondet_int(), !dbg !36
  %"7" = sext i32 %j.0 to i64, !dbg !36
  %"8" = getelementptr inbounds [10 x i32]* %new_, i32 0, i64 %"7", !dbg !36
  store i32 %"6", i32* %"8", align 4, !dbg !36
  %"9" = add nsw i32 %j.0, 1, !dbg !37
...
main_bb6:                                         ; preds = %main_bb5
  ...
  %"20" = icmp eq i32 %"19", %"1", !dbg !50
  br i1 %"20", label %main_bb7, label %main_bb5, !dbg !50

main_bb7:                                         ; preds = %main_bb6
  ret void, !dbg !52

main_bb8:                                         ; preds = %main_bb5
  %"21" = add nsw i32 %i.0, 1, !dbg !53
  call void @llvm.dbg.value(metadata !{i32 %"21"}, i64 0, metadata !20), !dbg !21
  %"22" = add nsw i32 %base.0, 8, !dbg !54
  call void @llvm.dbg.value(metadata !{i32 %"22"}, i64 0, metadata !23), !dbg !24
...
!19 = metadata !{i32 0}
!20 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 9, metadata !13, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 9]
!21 = metadata !{i32 9, i32 7, metadata !4, null}
!22 = metadata !{i32 10, i32 14, metadata !4, null}
!23 = metadata !{i32 786688, metadata !4, metadata !"base", metadata !5, i32 10, metadata !13, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [base] [line 10]
!24 = metadata !{i32 10, i32 7, metadata !4, null}
!25 = metadata !{i32 11, i32 15, metadata !4, null}
...
!36 = metadata !{i32 16, i32 17, metadata !35, null}
!37 = metadata !{i32 17, i32 7, metadata !35, null}
...
!42 = metadata !{i32 786443, metadata !1, metadata !4, i32 22, i32 13, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!46 = metadata !{i32 786443, metadata !1, metadata !42, i32 24, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 24, i32 5, metadata !42, null}
!48 = metadata !{i32 25, i32 7, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !42, i32 24, i32 32, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!52 = metadata !{i32 36, i32 3, metadata !4, null}
!53 = metadata !{i32 32, i32 5, metadata !42, null}
!54 = metadata !{i32 33, i32 5, metadata !42, null}
!55 = metadata !{i32 34, i32 3, metadata !42, null}
