...
main_bb5:
  ...
  %"12" = call i64 @__VERIFIER_nondet_int(), !dbg !43
  call void @llvm.dbg.value(metadata !{i64 %"12"}, i64 0, metadata !44), !dbg !45
  %"13" = call i64 @__VERIFIER_nondet_int(), !dbg !46
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !47), !dbg !48
  call void @llvm.dbg.value(metadata !40, i64 0, metadata !49), !dbg !51
...
main_bb6:                                         ; preds = %main_wrap_around.exit
  %"15" = call i64 @__VERIFIER_nondet_int(), !dbg !68
  %"16" = getelementptr inbounds [10 x i64]* %old_, i32 0, i64 %j.0, !dbg !68
  store i64 %"15", i64* %"16", align 8, !dbg !68
  %"17" = call i64 @__VERIFIER_nondet_int(), !dbg !69
  %"18" = getelementptr inbounds [10 x i64]* %new_, i32 0, i64 %j.0, !dbg !69
  store i64 %"17", i64* %"18", align 8, !dbg !69
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  ...
  call void @llvm.dbg.value(metadata !{i64 %"38"}, i64 0, metadata !79), !dbg !82
...
main_wrap_around.exit2:                           ; preds = %main_bb23, %main_bb22, %main_bb21, %main_bb10
  ...
  %"32" = icmp slt i64 %base.0, %"13", !dbg !90
...
main_wrap_around.exit6:                           ; preds = %main_bb14, %main_bb15, %main_bb16
  ...
  %"49" = icmp eq i64 %.0.i5, %"13", !dbg !99
  br i1 %"49", label %main_bb17, label %main_bb12, !dbg !99
...
!40 = metadata !{i64 0}
!41 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 21]
!42 = metadata !{i32 21, i32 13, metadata !9, null}
!43 = metadata !{i32 22, i32 20, metadata !9, null}
!44 = metadata !{i32 786688, metadata !9, metadata !"base", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [base] [line 22]
!45 = metadata !{i32 22, i32 13, metadata !9, null}
!46 = metadata !{i32 23, i32 21, metadata !9, null}
...
!68 = metadata !{i32 27, i32 17, metadata !54, null}
!69 = metadata !{i32 28, i32 17, metadata !54, null}
!70 = metadata !{i32 9, i32 9, metadata !25, metadata !53}
!71 = metadata !{i32 10, i32 9, metadata !27, metadata !53}
!72 = metadata !{i32 12, i32 14, metadata !29, metadata !53}
!73 = metadata !{i32 13, i32 9, metadata !31, metadata !53}
