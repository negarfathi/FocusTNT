...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !34), !dbg !35
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !39), !dbg !41
...
main_bb6:                                         ; preds = %main_bb7, %main_bb5
  %l.0 = phi i64 [ %"12", %main_bb5 ], [ %"21", %main_bb7 ]
  %"13" = trunc i64 %l.0 to i32, !dbg !43
  %"14" = sub nsw i32 %"13", 1, !dbg !43
  %"15" = trunc i32 %"14" to i8, !dbg !43
  %"16" = zext i8 %"15" to i64, !dbg !43
  %"17" = icmp ne i64 %l.0, 0, !dbg !44
  br i1 %"17", label %main_bb7, label %main_bb8, !dbg !44

main_bb7:                                         ; preds = %main_bb6
  %"18" = trunc i64 %"16" to i32, !dbg !46
  %"19" = sub nsw i32 %"18", 1, !dbg !46
  %"20" = trunc i32 %"19" to i8, !dbg !46
  %"21" = zext i8 %"20" to i64, !dbg !46
...
!40 = metadata !{i32 786443, metadata !1, metadata !37, i32 27, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 28, i32 17, metadata !40, null}
!42 = metadata !{i32 20, i32 3, metadata !9, null}
!43 = metadata !{i32 23, i32 5, metadata !37, null}
!44 = metadata !{i32 24, i32 9, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !37, i32 24, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 30, i32 7, metadata !40, null}
!47 = metadata !{i32 32, i32 3, metadata !37, null}
!48 = metadata !{i32 33, i32 3, metadata !9, null}
