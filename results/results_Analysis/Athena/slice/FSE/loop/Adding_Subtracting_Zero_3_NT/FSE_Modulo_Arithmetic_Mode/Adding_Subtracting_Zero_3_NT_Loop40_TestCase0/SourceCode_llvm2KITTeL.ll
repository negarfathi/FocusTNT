...
main_bb20:
  ...
  br i1 %or.cond, label %main_bb46, label %main_wrap_around.exit2, !dbg !121

main_wrap_around.exit2:                           ; preds = %main_bb20, %main_bb45, %main_bb44, %main_bb43, %main_wrap_around.exit4
  %__fc_errno_0.0 = phi i64 [ %.0.i3, %main_wrap_around.exit4 ], [ %__fc_errno_0.0, %main_bb43 ], [ %__fc_errno_0.0, %main_bb44 ], [ %__fc_errno_0.0, %main_bb45 ], [ 0, %main_bb20 ]
  %pos.0 = phi i64 [ %pos.0, %main_wrap_around.exit4 ], [ %"123", %main_bb43 ], [ %"128", %main_bb45 ], [ %"118", %main_bb44 ], [ 0, %main_bb20 ]
  %"54" = icmp slt i64 %pos.0, %"51", !dbg !125
  br i1 %"54", label %main_bb21, label %main_bb46, !dbg !125
...
main_wrap_around.exit2.i:                         ; preds = %main_bb37, %main_bb36, %main_bb35, %main_wrap_around.exit
  ...
  %.0.i5 = phi i64 [ %pos.0, %main_wrap_around.exit ], [ %"99", %main_bb35 ], [ %"104", %main_bb37 ], [ %"94", %main_bb36 ], !dbg !134
  %"66" = icmp slt i64 %.0.i5, %.0.i, !dbg !135
...
main_read_slice_1.exit:                           ; preds = %main_wrap_around.exit2.i, %main_bb25, %main_wrap_around.exit4.i
  ...
  %"105" = icmp eq i64 %__retres.0.i, -1, !dbg !158
  br i1 %"105", label %main_bb38, label %main_bb42, !dbg !158

main_bb38:                                        ; preds = %main_read_slice_1.exit
  %"106" = add nsw i64 %__fc_errno_0.0, 1, !dbg !160
  call void @llvm.dbg.value(metadata !{i64 %"106"}, i64 0, metadata !162), !dbg !163
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !164), !dbg !165
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !166), !dbg !167
  call void @llvm.dbg.value(metadata !61, i64 0, metadata !168), !dbg !169
  %"107" = icmp sgt i64 %"106", 2147483647, !dbg !170
  br i1 %"107", label %main_bb39, label %main_bb40, !dbg !170

main_bb39:                                        ; preds = %main_bb38
  %"108" = sub nsw i64 %"106", 2147483647, !dbg !171
  %"109" = sub nsw i64 %"108", 1, !dbg !171
  %"110" = srem i64 %"109", 4294967296, !dbg !171
  %"111" = add nsw i64 -2147483648, %"110", !dbg !171
  br label %main_wrap_around.exit4, !dbg !171

main_bb40:                                        ; preds = %main_bb38
  %"112" = icmp slt i64 %"106", -2147483648, !dbg !172
  br i1 %"112", label %main_bb41, label %main_wrap_around.exit4, !dbg !172

main_bb41:                                        ; preds = %main_bb40
  %"113" = sub nsw i64 -2147483648, %"106", !dbg !173
  %"114" = sub nsw i64 %"113", 1, !dbg !173
  %"115" = srem i64 %"114", 4294967296, !dbg !173
  %"116" = sub nsw i64 2147483647, %"115", !dbg !173
  br label %main_wrap_around.exit4, !dbg !173

main_wrap_around.exit4:                           ; preds = %main_bb39, %main_bb40, %main_bb41
  %.0.i3 = phi i64 [ %"111", %main_bb39 ], [ %"116", %main_bb41 ], [ %"106", %main_bb40 ], !dbg !160
  call void @llvm.dbg.value(metadata !{i64 %.0.i3}, i64 0, metadata !119), !dbg !120
  %"117" = icmp eq i64 %.0.i3, 5, !dbg !174
  br i1 %"117", label %main_bb46, label %main_wrap_around.exit2, !dbg !174

main_bb42:                                        ; preds = %main_read_slice_1.exit
  %"118" = add nsw i64 %pos.0, %__retres.0.i, !dbg !176
  call void @llvm.dbg.value(metadata !{i64 %"118"}, i64 0, metadata !177), !dbg !178
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !179), !dbg !180
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !181), !dbg !182
  call void @llvm.dbg.value(metadata !61, i64 0, metadata !183), !dbg !184
  %"119" = icmp sgt i64 %"118", 2147483647, !dbg !185
  br i1 %"119", label %main_bb43, label %main_bb44, !dbg !185

main_bb43:                                        ; preds = %main_bb42
  %"120" = sub nsw i64 %"118", 2147483647, !dbg !186
  %"121" = sub nsw i64 %"120", 1, !dbg !186
  %"122" = srem i64 %"121", 4294967296, !dbg !186
  %"123" = add nsw i64 -2147483648, %"122", !dbg !186
  br label %main_wrap_around.exit2, !dbg !186

main_bb44:                                        ; preds = %main_bb42
  %"124" = icmp slt i64 %"118", -2147483648, !dbg !187
  br i1 %"124", label %main_bb45, label %main_wrap_around.exit2, !dbg !187

main_bb45:                                        ; preds = %main_bb44
  %"125" = sub nsw i64 -2147483648, %"118", !dbg !188
  %"126" = sub nsw i64 %"125", 1, !dbg !188
  %"127" = srem i64 %"126", 4294967296, !dbg !188
  %"128" = sub nsw i64 2147483647, %"127", !dbg !188
  br label %main_wrap_around.exit2, !dbg !188

main_bb46:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit4, %main_bb20
  ret void, !dbg !189
}
...
!158 = metadata !{i32 64, i32 9, metadata !159, null}
!159 = metadata !{i32 786443, metadata !1, metadata !128, i32 64, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!160 = metadata !{i32 65, i32 23, metadata !161, null}
!161 = metadata !{i32 786443, metadata !1, metadata !159, i32 64, i32 19, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!162 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !160} ; [ DW_TAG_arg_variable ] [value] [line 8]
!163 = metadata !{i32 8, i32 33, metadata !4, metadata !160} ; [ DW_TAG_imported_declaration ]
!164 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !160} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!165 = metadata !{i32 8, i32 50, metadata !4, metadata !160} ; [ DW_TAG_imported_declaration ]
!166 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !160} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!167 = metadata !{i32 8, i32 73, metadata !4, metadata !160} ; [ DW_TAG_imported_declaration ]
!168 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !160} ; [ DW_TAG_auto_variable ] [range] [line 9]
!169 = metadata !{i32 9, i32 15, metadata !4, metadata !160}
!170 = metadata !{i32 10, i32 9, metadata !30, metadata !160}
!171 = metadata !{i32 11, i32 9, metadata !32, metadata !160}
!172 = metadata !{i32 13, i32 14, metadata !34, metadata !160}
!173 = metadata !{i32 14, i32 9, metadata !36, metadata !160}
!174 = metadata !{i32 66, i32 11, metadata !175, null}
!175 = metadata !{i32 786443, metadata !1, metadata !161, i32 66, i32 11, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!176 = metadata !{i32 72, i32 11, metadata !128, null}
!177 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !176} ; [ DW_TAG_arg_variable ] [value] [line 8]
!178 = metadata !{i32 8, i32 33, metadata !4, metadata !176} ; [ DW_TAG_imported_declaration ]
!179 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !176} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!180 = metadata !{i32 8, i32 50, metadata !4, metadata !176} ; [ DW_TAG_imported_declaration ]
!181 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !176} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!182 = metadata !{i32 8, i32 73, metadata !4, metadata !176} ; [ DW_TAG_imported_declaration ]
!183 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !176} ; [ DW_TAG_auto_variable ] [range] [line 9]
!184 = metadata !{i32 9, i32 15, metadata !4, metadata !176}
!185 = metadata !{i32 10, i32 9, metadata !30, metadata !176}
!186 = metadata !{i32 11, i32 9, metadata !32, metadata !176}
!187 = metadata !{i32 13, i32 14, metadata !34, metadata !176}
!188 = metadata !{i32 14, i32 9, metadata !36, metadata !176}
!189 = metadata !{i32 74, i32 17, metadata !12, null}
