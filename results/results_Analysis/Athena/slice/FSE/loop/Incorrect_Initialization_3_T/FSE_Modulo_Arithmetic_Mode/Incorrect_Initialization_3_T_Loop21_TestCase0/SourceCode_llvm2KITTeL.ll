...
define void @main() #0 {
main_bb5:
  %in = alloca [100 x i64], align 16
  call void @llvm.dbg.declare(metadata !{[100 x i64]* %in}, metadata !33), !dbg !37
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %i.0 = phi i64 [ 0, %main_bb5 ], [ %"19", %main_bb7 ], [ %"24", %main_bb9 ], [ %"14", %main_bb8 ]
  %"12" = icmp slt i64 %i.0, 99, !dbg !56
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !56

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = getelementptr inbounds [100 x i64]* %in, i32 0, i64 %i.0, !dbg !58
  store i64 10, i64* %"13", align 8, !dbg !58
  %"14" = add nsw i64 %i.0, 1, !dbg !43
...
main_bb8:                                         ; preds = %main_bb6
  ...
  br i1 %"20", label %main_bb9, label %main_wrap_around.exit, !dbg !61
...
!33 = metadata !{i32 786688, metadata !9, metadata !"in", metadata !5, i32 16, metadata !34, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [in] [line 16]
...
!37 = metadata !{i32 16, i32 13, metadata !9, null}
!38 = metadata !{i64 0}
!39 = metadata !{i32 786688, metadata !40, metadata !"i", metadata !5, i32 18, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 18]
!40 = metadata !{i32 786443, metadata !1, metadata !9, i32 17, i32 3, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 18, i32 15, metadata !40, null}
...
!43 = metadata !{i32 21, i32 12, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !40, i32 19, i32 20, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 4, i32 33, metadata !4, metadata !43}
!46 = metadata !{i64 -2147483648}
!47 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554436, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [lower_bound] [line 4]
!48 = metadata !{i32 4, i32 50, metadata !4, metadata !43}
!49 = metadata !{i64 2147483647}
!50 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331652, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [upper_bound] [line 4]
!51 = metadata !{i32 4, i32 73, metadata !4, metadata !43}
!52 = metadata !{i64 4294967296}
!53 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 5, metadata !8, i32 0, metadata !43} ; [ DW_TAG_auto_variable ] [range] [line 5]
!54 = metadata !{i32 5, i32 15, metadata !4, metadata !43}
!55 = metadata !{i32 19, i32 5, metadata !40, null}
!56 = metadata !{i32 19, i32 5, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !40, i32 19, i32 5, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 20, i32 7, metadata !44, null}
!59 = metadata !{i32 6, i32 9, metadata !25, metadata !43}
!60 = metadata !{i32 7, i32 9, metadata !27, metadata !43}
!61 = metadata !{i32 9, i32 14, metadata !29, metadata !43}
!62 = metadata !{i32 10, i32 9, metadata !31, metadata !43}
!63 = metadata !{i32 24, i32 3, metadata !9, null}
