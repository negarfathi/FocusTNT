...
main_bb20:
  ...
  br i1 %"52", label %main_bb41, label %main_wrap_around.exit3, !dbg !116

main_wrap_around.exit3:                           ; preds = %main_bb40, %main_bb39, %main_bb38, %main_bb20
  %buf.0 = phi i64 [ 0, %main_bb20 ], [ %"110", %main_bb38 ], [ %"115", %main_bb40 ], [ %"105", %main_bb39 ]
  %count.0 = phi i64 [ %"51", %main_bb20 ], [ %.0.i1, %main_bb38 ], [ %.0.i1, %main_bb39 ], [ %.0.i1, %main_bb40 ]
  %"53" = icmp sgt i64 %count.0, 0, !dbg !118
  br i1 %"53", label %main_wrap_around.exit2.i, label %main_bb41, !dbg !118
...
main_read_slice_1.exit:                           ; preds = %main_wrap_around.exit2.i, %main_bb21, %main_wrap_around.exit4.i
  ...
  %"93" = icmp slt i64 %__retres.0.i, 0, !dbg !145
  br i1 %"93", label %main_bb41, label %main_bb34, !dbg !145

main_bb34:                                        ; preds = %main_read_slice_1.exit
  %"94" = sub nsw i64 %count.0, %__retres.0.i, !dbg !147
  call void @llvm.dbg.value(metadata !{i64 %"94"}, i64 0, metadata !148), !dbg !149
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !150), !dbg !151
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !152), !dbg !153
  call void @llvm.dbg.value(metadata !61, i64 0, metadata !154), !dbg !155
  %"95" = icmp sgt i64 %"94", 2147483647, !dbg !156
  br i1 %"95", label %main_bb35, label %main_bb36, !dbg !156

main_bb35:                                        ; preds = %main_bb34
  %"96" = sub nsw i64 %"94", 2147483647, !dbg !157
  %"97" = sub nsw i64 %"96", 1, !dbg !157
  %"98" = srem i64 %"97", 4294967296, !dbg !157
  %"99" = add nsw i64 -2147483648, %"98", !dbg !157
  br label %main_wrap_around.exit, !dbg !157

main_bb36:                                        ; preds = %main_bb34
  %"100" = icmp slt i64 %"94", -2147483648, !dbg !158
  br i1 %"100", label %main_bb37, label %main_wrap_around.exit, !dbg !158

main_bb37:                                        ; preds = %main_bb36
  %"101" = sub nsw i64 -2147483648, %"94", !dbg !159
  %"102" = sub nsw i64 %"101", 1, !dbg !159
  %"103" = srem i64 %"102", 4294967296, !dbg !159
  %"104" = sub nsw i64 2147483647, %"103", !dbg !159
  br label %main_wrap_around.exit, !dbg !159

main_wrap_around.exit:                            ; preds = %main_bb35, %main_bb36, %main_bb37
  %.0.i1 = phi i64 [ %"99", %main_bb35 ], [ %"104", %main_bb37 ], [ %"94", %main_bb36 ], !dbg !147
  call void @llvm.dbg.value(metadata !{i64 %.0.i1}, i64 0, metadata !114), !dbg !115
  %"105" = add nsw i64 %buf.0, %__retres.0.i, !dbg !160
  ...
  br i1 %"106", label %main_bb38, label %main_bb39, !dbg !169

main_bb38:                                        ; preds = %main_wrap_around.exit
...
main_bb39:                                        ; preds = %main_wrap_around.exit
  %"111" = icmp slt i64 %"105", -2147483648, !dbg !171
  br i1 %"111", label %main_bb40, label %main_wrap_around.exit3, !dbg !171
...
main_bb41:                                        ; preds = %main_wrap_around.exit3, %main_read_slice_1.exit, %main_bb20
  ret void, !dbg !173
}
...
!145 = metadata !{i32 59, i32 9, metadata !146, null}
!146 = metadata !{i32 786443, metadata !1, metadata !121, i32 59, i32 9, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!147 = metadata !{i32 63, i32 13, metadata !121, null}
!148 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !147} ; [ DW_TAG_arg_variable ] [value] [line 8]
!149 = metadata !{i32 8, i32 33, metadata !4, metadata !147} ; [ DW_TAG_imported_declaration ]
!150 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !147} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!151 = metadata !{i32 8, i32 50, metadata !4, metadata !147} ; [ DW_TAG_imported_declaration ]
!152 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !147} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!153 = metadata !{i32 8, i32 73, metadata !4, metadata !147} ; [ DW_TAG_imported_declaration ]
!154 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !147} ; [ DW_TAG_auto_variable ] [range] [line 9]
!155 = metadata !{i32 9, i32 15, metadata !4, metadata !147}
!156 = metadata !{i32 10, i32 9, metadata !30, metadata !147}
!157 = metadata !{i32 11, i32 9, metadata !32, metadata !147}
!158 = metadata !{i32 13, i32 14, metadata !34, metadata !147}
!159 = metadata !{i32 14, i32 9, metadata !36, metadata !147}
!160 = metadata !{i32 64, i32 11, metadata !121, null}
...
!173 = metadata !{i32 66, i32 17, metadata !12, null}
