...
main_bb7:
  ...
  br i1 %"12", label %main_bb16, label %main_bb8, !dbg !53
...
main_bb8:                                         ; preds = %main_bb7, %main_bb15
  ...
  br i1 %"13", label %main_bb9, label %main_bb16, !dbg !55
...
main_read_slice_1.exit:                           ; preds = %main_bb9, %main_bb10, %main_bb11, %main_bb14
  ...
  %"25" = icmp slt i32 %__retres.0.i, 0, !dbg !74
  br i1 %"25", label %main_bb16, label %main_bb15, !dbg !74

main_bb15:                                        ; preds = %main_read_slice_1.exit
  %"26" = sub nsw i32 %count.0, %__retres.0.i, !dbg !76
  %"27" = add nsw i32 %buf.0, %__retres.0.i, !dbg !77
  br label %main_bb8, !dbg !78

main_bb16:                                        ; preds = %main_bb8, %main_read_slice_1.exit, %main_bb7
  ret void, !dbg !79
}
...
!36 = metadata !{i32 786443, metadata !1, metadata !33, i32 22, i32 20, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!42 = metadata !{i32 786443, metadata !1, metadata !40, i32 25, i32 22, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!55 = metadata !{i32 48, i32 3, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !9, i32 48, i32 3, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 10, i32 7, metadata !25, metadata !58}
!58 = metadata !{i32 49, i32 11, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !9, i32 48, i32 21, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!75 = metadata !{i32 786443, metadata !1, metadata !59, i32 50, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 54, i32 5, metadata !59, null}
!77 = metadata !{i32 55, i32 5, metadata !59, null}
!78 = metadata !{i32 56, i32 3, metadata !59, null}
