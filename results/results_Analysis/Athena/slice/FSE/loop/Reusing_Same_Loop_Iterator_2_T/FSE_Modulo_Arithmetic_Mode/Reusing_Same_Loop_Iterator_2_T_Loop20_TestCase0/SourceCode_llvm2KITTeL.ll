...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"15" = icmp slt i64 %j.0, 3, !dbg !40
  br i1 %"15", label %main_bb6, label %main_bb10, !dbg !40

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"16" = add nsw i64 %j.0, 1, !dbg !44
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !46
  br i1 %"17", label %main_bb7, label %main_bb8, !dbg !46

main_bb7:                                         ; preds = %main_bb6
  %"18" = sub nsw i64 %"16", 2147483647, !dbg !47
  %"19" = sub nsw i64 %"18", 1, !dbg !47
  %"20" = srem i64 %"19", 4294967296, !dbg !47
  %"21" = add nsw i64 -2147483648, %"20", !dbg !47
  br label %main_wrap_around.exit, !dbg !47

main_bb8:                                         ; preds = %main_bb6
  %"22" = icmp slt i64 %"16", -2147483648, !dbg !48
  br i1 %"22", label %main_bb9, label %main_wrap_around.exit, !dbg !48

main_bb9:                                         ; preds = %main_bb8
  %"23" = sub nsw i64 -2147483648, %"16", !dbg !49
  %"24" = sub nsw i64 %"23", 1, !dbg !49
  %"25" = srem i64 %"24", 4294967296, !dbg !49
  %"26" = sub nsw i64 2147483647, %"25", !dbg !49
  br label %main_wrap_around.exit, !dbg !49

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"27" = add nsw i64 %i.0, 1, !dbg !50
  call void @llvm.dbg.value(metadata !{i64 %"27"}, i64 0, metadata !51), !dbg !52
  ...
  %"28" = icmp sgt i64 %"27", 2147483647, !dbg !62
  br i1 %"28", label %main_bb11, label %main_bb12, !dbg !62

main_bb11:                                        ; preds = %main_bb10
  %"29" = sub nsw i64 %"27", 2147483647, !dbg !63
  %"30" = sub nsw i64 %"29", 1, !dbg !63
  %"31" = srem i64 %"30", 4294967296, !dbg !63
  %"32" = add nsw i64 -2147483648, %"31", !dbg !63
  br label %main_wrap_around.exit2, !dbg !63

main_bb12:                                        ; preds = %main_bb10
  %"33" = icmp slt i64 %"27", -2147483648, !dbg !64
  br i1 %"33", label %main_bb13, label %main_wrap_around.exit2, !dbg !64

main_bb13:                                        ; preds = %main_bb12
  %"34" = sub nsw i64 -2147483648, %"27", !dbg !65
  %"35" = sub nsw i64 %"34", 1, !dbg !65
  %"36" = srem i64 %"35", 4294967296, !dbg !65
  %"37" = sub nsw i64 2147483647, %"36", !dbg !65
...
!39 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 3, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!40 = metadata !{i32 29, i32 7, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !42, i32 29, i32 7, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 786443, metadata !1, metadata !43, i32 26, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 19, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 30, i32 8, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !42, i32 30, i32 1, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 9, i32 9, metadata !25, metadata !44}
!47 = metadata !{i32 10, i32 9, metadata !27, metadata !44}
!48 = metadata !{i32 12, i32 14, metadata !29, metadata !44}
!49 = metadata !{i32 13, i32 9, metadata !31, metadata !44}
!50 = metadata !{i32 33, i32 10, metadata !43, null}
!51 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !50} ; [ DW_TAG_arg_variable ] [value] [line 7]
...
!62 = metadata !{i32 9, i32 9, metadata !25, metadata !50}
!63 = metadata !{i32 10, i32 9, metadata !27, metadata !50}
!64 = metadata !{i32 12, i32 14, metadata !29, metadata !50}
!65 = metadata !{i32 13, i32 9, metadata !31, metadata !50}
!66 = metadata !{i32 35, i32 17, metadata !9, null}
