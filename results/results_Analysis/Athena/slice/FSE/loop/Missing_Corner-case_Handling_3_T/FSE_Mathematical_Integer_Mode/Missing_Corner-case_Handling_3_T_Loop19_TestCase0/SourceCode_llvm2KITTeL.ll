...
main_bb7:                                         ; preds = %main_bb2, %main_bb11
  ...
  %"25" = icmp slt i32 %xmin.0, %"0", !dbg !62
  %.3 = select i1 %"24", i1 false, i1 %"25", !dbg !58
  br i1 %.3, label %main_bb8, label %main_bb12, !dbg !64

main_bb8:                                         ; preds = %main_bb7
  %"26" = sext i32 %xmin.0 to i64, !dbg !66
...
main_bb9:                                         ; preds = %main_bb10, %main_bb8
  ...
  %"27" = sub nsw i32 %"1", 1, !dbg !72
  %"28" = icmp sle i32 %y.0, %"27", !dbg !72
  br i1 %"28", label %main_bb10, label %main_bb11, !dbg !72

main_bb10:                                        ; preds = %main_bb9
  %"29" = sext i32 %y.0 to i64, !dbg !66
  %"30" = mul nsw i64 %"26", %"7", !dbg !66
  %"31" = getelementptr inbounds i32* %"10", i64 %"30", !dbg !66
  %"32" = getelementptr inbounds i32* %"31", i64 %"29", !dbg !66
  %"33" = load i32* %"32", align 4, !dbg !66
  %"34" = icmp ne i32 %"33", 0, !dbg !66
  %.found.1 = select i1 %"34", i32 1, i32 %found.1, !dbg !66
  %"35" = add nsw i32 %y.0, 1, !dbg !75
  br label %main_bb9, !dbg !75

main_bb11:                                        ; preds = %main_bb9
  %"36" = add nsw i32 %xmin.0, 1, !dbg !76
  call void @llvm.dbg.value(metadata !{i32 %"36"}, i64 0, metadata !77), !dbg !78
  br label %main_bb7, !dbg !76

main_bb12:                                        ; preds = %main_bb7
  call void @llvm.stackrestore(i8* %"8"), !dbg !79
  br label %main_bb13
