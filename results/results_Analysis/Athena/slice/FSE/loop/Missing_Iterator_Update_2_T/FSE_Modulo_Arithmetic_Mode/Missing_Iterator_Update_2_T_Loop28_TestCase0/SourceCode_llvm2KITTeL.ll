...
main_mdb_cursor_get_slice_1.exit:                 ; preds = %main_wrap_around.exit.i, %main_bb15
  ...
  call void @llvm.dbg.value(metadata !{i64 %"47"}, i64 0, metadata !91) #3, !dbg !96
  call void @llvm.dbg.value(metadata !{i64 %"49"}, i64 0, metadata !97) #3, !dbg !99
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !100) #3, !dbg !101
  call void @llvm.dbg.value(metadata !47, i64 0, metadata !102) #3, !dbg !103
  call void @llvm.dbg.value(metadata !50, i64 0, metadata !104) #3, !dbg !105
  call void @llvm.dbg.value(metadata !{i64 %"47"}, i64 0, metadata !106) #3, !dbg !108
  call void @llvm.dbg.value(metadata !{i64 %"49"}, i64 0, metadata !109) #3, !dbg !111
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !112) #3, !dbg !113
  call void @llvm.dbg.value(metadata !47, i64 0, metadata !114) #3, !dbg !115
  call void @llvm.dbg.value(metadata !50, i64 0, metadata !116) #3, !dbg !117
  br label %main_mdb_cursor_get_slice_1.exit5, !dbg !118

main_mdb_cursor_get_slice_1.exit5:                ; preds = %main_bb26, %main_wrap_around.exit.i7, %main_bb21, %main_wrap_around.exit.i2, %main_mdb_cursor_get_slice_1.exit
  %rc.0 = phi i64 [ %__retres.1.i, %main_mdb_cursor_get_slice_1.exit ], [ %..i3, %main_bb21 ], [ 1, %main_wrap_around.exit.i2 ], [ %..i8, %main_bb26 ], [ 1, %main_wrap_around.exit.i7 ]
  %"45" = icmp eq i64 %rc.0, 0, !dbg !119
  br i1 %"45", label %main_bb16, label %main_bb27, !dbg !119

main_bb16:                                        ; preds = %main_mdb_cursor_get_slice_1.exit5
  %"46" = icmp sle i64 %"44", 0, !dbg !121
  %"47" = call i64 @__VERIFIER_nondet_int() #3, !dbg !122
  %"48" = load i64* @"'flag", align 8, !dbg !98
  %"49" = add nsw i64 %"48", 1, !dbg !98
  %"50" = icmp sgt i64 %"49", 2147483647, !dbg !123
  br i1 %"46", label %main_bb17, label %main_bb22, !dbg !121

main_bb17:                                        ; preds = %main_bb16
  br i1 %"50", label %main_bb18, label %main_bb19, !dbg !123

main_bb18:                                        ; preds = %main_bb17
  %"51" = sub nsw i64 %"49", 2147483647, !dbg !124
  %"52" = sub nsw i64 %"51", 1, !dbg !124
  %"53" = srem i64 %"52", 4294967296, !dbg !124
  %"54" = add nsw i64 -2147483648, %"53", !dbg !124
  br label %main_wrap_around.exit.i2, !dbg !124

main_bb19:                                        ; preds = %main_bb17
  %"55" = icmp slt i64 %"49", -2147483648, !dbg !125
  br i1 %"55", label %main_bb20, label %main_wrap_around.exit.i2, !dbg !125

main_bb20:                                        ; preds = %main_bb19
  %"56" = sub nsw i64 -2147483648, %"49", !dbg !126
  %"57" = sub nsw i64 %"56", 1, !dbg !126
  %"58" = srem i64 %"57", 4294967296, !dbg !126
  %"59" = sub nsw i64 2147483647, %"58", !dbg !126
  br label %main_wrap_around.exit.i2, !dbg !126

main_wrap_around.exit.i2:                         ; preds = %main_bb20, %main_bb19, %main_bb18
  %.0.i.i1 = phi i64 [ %"54", %main_bb18 ], [ %"59", %main_bb20 ], [ %"49", %main_bb19 ], !dbg !98
  store i64 %.0.i.i1, i64* @"'flag", align 8, !dbg !98
  %"60" = load i64* @"'flag", align 8, !dbg !127
  %"61" = icmp sgt i64 %"60", 1000, !dbg !127
  br i1 %"61", label %main_mdb_cursor_get_slice_1.exit5, label %main_bb21, !dbg !127

main_bb21:                                        ; preds = %main_wrap_around.exit.i2
  %"62" = icmp sge i64 %"47", 0, !dbg !128
  %..i3 = select i1 %"62", i64 0, i64 1, !dbg !129
  br label %main_mdb_cursor_get_slice_1.exit5, !dbg !130

main_bb22:                                        ; preds = %main_bb16
  br i1 %"50", label %main_bb23, label %main_bb24, !dbg !131

main_bb23:                                        ; preds = %main_bb22
  %"63" = sub nsw i64 %"49", 2147483647, !dbg !132
  %"64" = sub nsw i64 %"63", 1, !dbg !132
  %"65" = srem i64 %"64", 4294967296, !dbg !132
  %"66" = add nsw i64 -2147483648, %"65", !dbg !132
  br label %main_wrap_around.exit.i7, !dbg !132

main_bb24:                                        ; preds = %main_bb22
  %"67" = icmp slt i64 %"49", -2147483648, !dbg !133
  br i1 %"67", label %main_bb25, label %main_wrap_around.exit.i7, !dbg !133

main_bb25:                                        ; preds = %main_bb24
  %"68" = sub nsw i64 -2147483648, %"49", !dbg !134
  %"69" = sub nsw i64 %"68", 1, !dbg !134
  %"70" = srem i64 %"69", 4294967296, !dbg !134
  %"71" = sub nsw i64 2147483647, %"70", !dbg !134
  br label %main_wrap_around.exit.i7, !dbg !134

main_wrap_around.exit.i7:                         ; preds = %main_bb25, %main_bb24, %main_bb23
  %.0.i.i6 = phi i64 [ %"66", %main_bb23 ], [ %"71", %main_bb25 ], [ %"49", %main_bb24 ], !dbg !110
  store i64 %.0.i.i6, i64* @"'flag", align 8, !dbg !110
  %"72" = load i64* @"'flag", align 8, !dbg !135
  %"73" = icmp sgt i64 %"72", 1000, !dbg !135
  br i1 %"73", label %main_mdb_cursor_get_slice_1.exit5, label %main_bb26, !dbg !135

main_bb26:                                        ; preds = %main_wrap_around.exit.i7
  %"74" = icmp sge i64 %"47", 0, !dbg !136
  %..i8 = select i1 %"74", i64 0, i64 1, !dbg !137
  br label %main_mdb_cursor_get_slice_1.exit5, !dbg !138

main_bb27:                                        ; preds = %main_mdb_cursor_get_slice_1.exit5
  ret void, !dbg !139
}
...
!92 = metadata !{i32 40, i32 12, metadata !93, null}
!93 = metadata !{i32 786443, metadata !1, metadata !94, i32 39, i32 28, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!94 = metadata !{i32 786443, metadata !1, metadata !95, i32 39, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!95 = metadata !{i32 786443, metadata !1, metadata !12, i32 38, i32 19, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!96 = metadata !{i32 21, i32 13, metadata !9, metadata !92}
!97 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !98} ; [ DW_TAG_arg_variable ] [value] [line 8]
!98 = metadata !{i32 22, i32 11, metadata !9, metadata !92}
!99 = metadata !{i32 8, i32 33, metadata !4, metadata !98} ; [ DW_TAG_imported_declaration ]
!100 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !98} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!101 = metadata !{i32 8, i32 50, metadata !4, metadata !98} ; [ DW_TAG_imported_declaration ]
!102 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !98} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!103 = metadata !{i32 8, i32 73, metadata !4, metadata !98} ; [ DW_TAG_imported_declaration ]
!104 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !98} ; [ DW_TAG_auto_variable ] [range] [line 9]
!105 = metadata !{i32 9, i32 15, metadata !4, metadata !98}
!106 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 21, metadata !8, i32 0, metadata !107} ; [ DW_TAG_auto_variable ] [i] [line 21]
!107 = metadata !{i32 43, i32 10, metadata !95, null}
!108 = metadata !{i32 21, i32 13, metadata !9, metadata !107}
!109 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !110} ; [ DW_TAG_arg_variable ] [value] [line 8]
!110 = metadata !{i32 22, i32 11, metadata !9, metadata !107}
!111 = metadata !{i32 8, i32 33, metadata !4, metadata !110} ; [ DW_TAG_imported_declaration ]
!112 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !110} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!113 = metadata !{i32 8, i32 50, metadata !4, metadata !110} ; [ DW_TAG_imported_declaration ]
!114 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !110} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!115 = metadata !{i32 8, i32 73, metadata !4, metadata !110} ; [ DW_TAG_imported_declaration ]
!116 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !110} ; [ DW_TAG_auto_variable ] [range] [line 9]
!117 = metadata !{i32 9, i32 15, metadata !4, metadata !110}
!118 = metadata !{i32 38, i32 3, metadata !12, null}
!119 = metadata !{i32 38, i32 3, metadata !120, null}
!120 = metadata !{i32 786443, metadata !1, metadata !12, i32 38, i32 3, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!121 = metadata !{i32 39, i32 9, metadata !94, null}
!122 = metadata !{i32 21, i32 17, metadata !9, metadata !92}
!123 = metadata !{i32 10, i32 9, metadata !30, metadata !98}
!124 = metadata !{i32 11, i32 9, metadata !32, metadata !98}
!125 = metadata !{i32 13, i32 14, metadata !34, metadata !98}
!126 = metadata !{i32 14, i32 9, metadata !36, metadata !98}
!127 = metadata !{i32 23, i32 7, metadata !58, metadata !92}
!128 = metadata !{i32 27, i32 7, metadata !60, metadata !92}
!129 = metadata !{i32 29, i32 1, metadata !62, metadata !92}
!130 = metadata !{i32 27, i32 12, metadata !60, metadata !92}
!131 = metadata !{i32 10, i32 9, metadata !30, metadata !110}
!132 = metadata !{i32 11, i32 9, metadata !32, metadata !110}
!133 = metadata !{i32 13, i32 14, metadata !34, metadata !110}
!134 = metadata !{i32 14, i32 9, metadata !36, metadata !110}
!135 = metadata !{i32 23, i32 7, metadata !58, metadata !107}
!136 = metadata !{i32 27, i32 7, metadata !60, metadata !107}
!137 = metadata !{i32 29, i32 1, metadata !62, metadata !107}
!138 = metadata !{i32 27, i32 12, metadata !60, metadata !107}
!139 = metadata !{i32 45, i32 3, metadata !12, null}
