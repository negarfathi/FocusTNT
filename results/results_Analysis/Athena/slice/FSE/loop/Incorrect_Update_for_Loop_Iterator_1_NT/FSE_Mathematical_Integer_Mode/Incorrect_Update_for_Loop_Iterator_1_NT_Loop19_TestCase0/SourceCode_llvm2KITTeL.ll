...
main_bb1:                                         ; preds = %main_bb0, %main_bb4
  ...
  %buffer_bytes_left.0 = phi i32 [ %"11", %main_bb4 ], [ %"2", %main_bb0 ]
  %"6" = sdiv i32 %size.0, 2, !dbg !27
  %"7" = icmp slt i32 %buffer_bytes_left.0, %"6", !dbg !27
  br i1 %"7", label %main_bb2, label %main_bb5, !dbg !27

main_bb2:                                         ; preds = %main_bb1
  %"8" = mul nsw i32 %size.0, 2, !dbg !29
  %"9" = icmp ne i32 %"0", -1, !dbg !31
  br i1 %"9", label %main_bb3, label %main_bb4, !dbg !31

main_bb3:                                         ; preds = %main_bb2
  %"10" = icmp sgt i32 %"8", %"0", !dbg !33
  %. = select i1 %"10", i32 %"0", i32 %"8", !dbg !33
  br label %main_bb4, !dbg !35

main_bb4:                                         ; preds = %main_bb3, %main_bb2
  %size.2 = phi i32 [ %., %main_bb3 ], [ %"8", %main_bb2 ]
  %"11" = sub nsw i32 %size.2, %"1", !dbg !38
