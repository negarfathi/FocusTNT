...
main_wrap_around.exit2:                           ; preds = %main_bb5, %main_bb17, %main_bb16, %main_bb15
  ...
  %buffer_bytes_left.0 = phi i64 [ %"48", %main_bb15 ], [ %"53", %main_bb17 ], [ %"43", %main_bb16 ], [ %"14", %main_bb5 ]
...
main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  ...
  br i1 %"29", label %main_bb9, label %main_bb18, !dbg !48
...
main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  ...
  br i1 %"41", label %main_bb13, label %main_bb14, !dbg !59

main_bb13:                                        ; preds = %main_wrap_around.exit4
  %"42" = icmp sgt i64 %.0.i3, %"12", !dbg !61
  %..0.i3 = select i1 %"42", i64 %"12", i64 %.0.i3, !dbg !61
...
main_bb14:                                        ; preds = %main_bb13, %main_wrap_around.exit4
  ...
  %"43" = sub nsw i64 %size.2, %"13", !dbg !65
  %"44" = icmp sgt i64 %"43", 2147483647, !dbg !66
  br i1 %"44", label %main_bb15, label %main_bb16, !dbg !66

main_bb15:                                        ; preds = %main_bb14
  %"45" = sub nsw i64 %"43", 2147483647, !dbg !67
  %"46" = sub nsw i64 %"45", 1, !dbg !67
  %"47" = srem i64 %"46", 4294967296, !dbg !67
  %"48" = add nsw i64 -2147483648, %"47", !dbg !67
  br label %main_wrap_around.exit2, !dbg !67

main_bb16:                                        ; preds = %main_bb14
  %"49" = icmp slt i64 %"43", -2147483648, !dbg !68
  br i1 %"49", label %main_bb17, label %main_wrap_around.exit2, !dbg !68

main_bb17:                                        ; preds = %main_bb16
  %"50" = sub nsw i64 -2147483648, %"43", !dbg !69
  %"51" = sub nsw i64 %"50", 1, !dbg !69
  %"52" = srem i64 %"51", 4294967296, !dbg !69
  %"53" = sub nsw i64 2147483647, %"52", !dbg !69
