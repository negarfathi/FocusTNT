...
main_bb13:
  ...
  br i1 %or.cond, label %main_bb29, label %main_bb14, !dbg !86
...
main_bb14:                                        ; preds = %main_bb13, %main_wrap_around.exit2
  ...
  br i1 %"33", label %main_bb15, label %main_bb29, !dbg !90
...
main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb15, %main_bb17, %main_bb18, %main_bb20, %main_bb21, %main_bb22
  ...
  %"51" = add nsw i64 %b.0, %__retres.2.i, !dbg !106
  %"52" = icmp sgt i64 %"51", 2147483647, !dbg !107
  br i1 %"52", label %main_bb23, label %main_bb24, !dbg !107

main_bb23:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"53" = sub nsw i64 %"51", 2147483647, !dbg !108
  %"54" = sub nsw i64 %"53", 1, !dbg !108
  %"55" = srem i64 %"54", 4294967296, !dbg !108
  %"56" = add nsw i64 -2147483648, %"55", !dbg !108
  br label %main_wrap_around.exit, !dbg !108

main_bb24:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"57" = icmp slt i64 %"51", -2147483648, !dbg !109
  br i1 %"57", label %main_bb25, label %main_wrap_around.exit, !dbg !109

main_bb25:                                        ; preds = %main_bb24
  %"58" = sub nsw i64 -2147483648, %"51", !dbg !110
  %"59" = sub nsw i64 %"58", 1, !dbg !110
  %"60" = srem i64 %"59", 4294967296, !dbg !110
  %"61" = sub nsw i64 2147483647, %"60", !dbg !110
  br label %main_wrap_around.exit, !dbg !110

main_wrap_around.exit:                            ; preds = %main_bb23, %main_bb24, %main_bb25
  %.0.i = phi i64 [ %"56", %main_bb23 ], [ %"61", %main_bb25 ], [ %"51", %main_bb24 ], !dbg !106
  %"62" = sub nsw i64 %"30", 4, !dbg !111
  %"63" = icmp sgt i64 %"62", 2147483647, !dbg !113
  br i1 %"63", label %main_bb26, label %main_bb27, !dbg !113

main_bb26:                                        ; preds = %main_wrap_around.exit
  %"64" = sub nsw i64 %"62", 2147483647, !dbg !114
  %"65" = sub nsw i64 %"64", 1, !dbg !114
  %"66" = srem i64 %"65", 4294967296, !dbg !114
  %"67" = add nsw i64 -2147483648, %"66", !dbg !114
  br label %main_wrap_around.exit2, !dbg !114

main_bb27:                                        ; preds = %main_wrap_around.exit
  %"68" = icmp slt i64 %"62", -2147483648, !dbg !115
  br i1 %"68", label %main_bb28, label %main_wrap_around.exit2, !dbg !115

main_bb28:                                        ; preds = %main_bb27
  %"69" = sub nsw i64 -2147483648, %"62", !dbg !116
  %"70" = sub nsw i64 %"69", 1, !dbg !116
  %"71" = srem i64 %"70", 4294967296, !dbg !116
  %"72" = sub nsw i64 2147483647, %"71", !dbg !116
  br label %main_wrap_around.exit2, !dbg !116

main_wrap_around.exit2:                           ; preds = %main_bb26, %main_bb27, %main_bb28
  %.0.i1 = phi i64 [ %"67", %main_bb26 ], [ %"72", %main_bb28 ], [ %"62", %main_bb27 ], !dbg !111
  %"73" = icmp sge i64 %.0.i, %.0.i1, !dbg !111
  br i1 %"73", label %main_bb29, label %main_bb14, !dbg !111

main_bb29:                                        ; preds = %main_bb14, %main_wrap_around.exit2, %main_bb13
  ret void, !dbg !117
}
...
!91 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 3, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!92 = metadata !{i32 21, i32 17, metadata !9, metadata !93}
!93 = metadata !{i32 54, i32 13, metadata !94, null}
...
!106 = metadata !{i32 55, i32 9, metadata !94, null}
...
!111 = metadata !{i32 56, i32 14, metadata !112, null}
!112 = metadata !{i32 786443, metadata !1, metadata !94, i32 56, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!113 = metadata !{i32 10, i32 9, metadata !30, metadata !111}
!114 = metadata !{i32 11, i32 9, metadata !32, metadata !111}
!115 = metadata !{i32 13, i32 14, metadata !34, metadata !111}
!116 = metadata !{i32 14, i32 9, metadata !36, metadata !111}
!117 = metadata !{i32 62, i32 17, metadata !12, null}
