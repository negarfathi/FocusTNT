...
read_slice_1_bb6:                                 ; preds = %read_slice_1_bb5
  %"16" = call i64 @__VERIFIER_nondet_int(), !dbg !43
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !44), !dbg !45
  %"17" = icmp sle i64 %"16", 0, !dbg !46
  br i1 %"17", label %read_slice_1_bb13, label %read_slice_1_bb7, !dbg !46

read_slice_1_bb7:                                 ; preds = %read_slice_1_bb6
  %"18" = srem i64 %"16", 1000, !dbg !48
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !50), !dbg !51
  ...
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !44), !dbg !45
  %"19" = icmp slt i64 %"18", 995, !dbg !61
  br i1 %"19", label %read_slice_1_bb8, label %read_slice_1_bb12, !dbg !61

read_slice_1_bb8:                                 ; preds = %read_slice_1_bb7
  %"20" = load i64* @"'count", align 8, !dbg !63
  %"21" = add nsw i64 %"20", 1, !dbg !63
  call void @llvm.dbg.value(metadata !{i64 %"21"}, i64 0, metadata !65), !dbg !66
  ...
  %"22" = icmp sgt i64 %"21", 2147483647, !dbg !73
  br i1 %"22", label %read_slice_1_bb9, label %read_slice_1_bb10, !dbg !73

read_slice_1_bb9:                                 ; preds = %read_slice_1_bb8
  %"23" = sub nsw i64 %"21", 2147483647, !dbg !74
  %"24" = sub nsw i64 %"23", 1, !dbg !74
  %"25" = srem i64 %"24", 4294967296, !dbg !74
  %"26" = add nsw i64 -2147483648, %"25", !dbg !74
  br label %read_slice_1_wrap_around.exit, !dbg !74

read_slice_1_bb10:                                ; preds = %read_slice_1_bb8
  %"27" = icmp slt i64 %"21", -2147483648, !dbg !75
  br i1 %"27", label %read_slice_1_bb11, label %read_slice_1_wrap_around.exit, !dbg !75

read_slice_1_bb11:                                ; preds = %read_slice_1_bb10
  %"28" = sub nsw i64 -2147483648, %"21", !dbg !76
  %"29" = sub nsw i64 %"28", 1, !dbg !76
  %"30" = srem i64 %"29", 4294967296, !dbg !76
  %"31" = sub nsw i64 2147483647, %"30", !dbg !76
...
read_slice_1_wrap_around.exit:                    ; preds = %read_slice_1_bb9, %read_slice_1_bb10, %read_slice_1_bb11
  %.0.i = phi i64 [ %"26", %read_slice_1_bb9 ], [ %"31", %read_slice_1_bb11 ], [ %"21", %read_slice_1_bb10 ], !dbg !63
  store i64 %.0.i, i64* @"'count", align 8, !dbg !63
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !77), !dbg !78
...
read_slice_1_bb13:                                ; preds = %read_slice_1_bb6, %read_slice_1_bb12, %read_slice_1_wrap_around.exit, %read_slice_1_bb5
  %__retres.2 = phi i64 [ 0, %read_slice_1_bb5 ], [ -1, %read_slice_1_bb6 ], [ %"18", %read_slice_1_wrap_around.exit ], [ 0, %read_slice_1_bb12 ]
...
define void @main() #0 {
main_bb14:
  call void @llvm.dbg.value(metadata !{i64 %__retres.2.i}, i64 0, metadata !84), !dbg !86
  call void @llvm.dbg.value(metadata !{i64 %"36"}, i64 0, metadata !87) #3, !dbg !89
  call void @llvm.dbg.value(metadata !{i64 %"38"}, i64 0, metadata !90) #3, !dbg !92
  call void @llvm.dbg.value(metadata !52, i64 0, metadata !93) #3, !dbg !94
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !95) #3, !dbg !96
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !97) #3, !dbg !98
  call void @llvm.dbg.value(metadata !{i64 %"38"}, i64 0, metadata !87) #3, !dbg !89
  call void @llvm.dbg.value(metadata !{i64 %"41"}, i64 0, metadata !99) #3, !dbg !101
  call void @llvm.dbg.value(metadata !52, i64 0, metadata !102) #3, !dbg !103
  call void @llvm.dbg.value(metadata !55, i64 0, metadata !104) #3, !dbg !105
  call void @llvm.dbg.value(metadata !58, i64 0, metadata !106) #3, !dbg !107
  call void @llvm.dbg.value(metadata !{i64 %"38"}, i64 0, metadata !108) #3, !dbg !109
  call void @llvm.dbg.value(metadata !82, i64 0, metadata !108) #3, !dbg !109
  br label %main_bb15, !dbg !110

main_bb15:                                        ; preds = %main_read_slice_1.exit, %main_bb14
  %"32" = load i64* @"'flag", align 8, !dbg !111
  %"33" = icmp eq i64 %"32", 1, !dbg !111
  %"34" = load i64* @"'count", align 8, !dbg !88
  %"35" = icmp sgt i64 %"34", 100, !dbg !112
  %or.cond.i = or i1 %"33", %"35", !dbg !111
  br i1 %or.cond.i, label %main_read_slice_1.exit, label %main_bb16, !dbg !111

main_bb16:                                        ; preds = %main_bb15
  %"36" = call i64 @__VERIFIER_nondet_int() #3, !dbg !113
  %"37" = icmp sle i64 %"36", 0, !dbg !114
  br i1 %"37", label %main_read_slice_1.exit, label %main_bb17, !dbg !114

main_bb17:                                        ; preds = %main_bb16
  %"38" = srem i64 %"36", 1000, !dbg !91
  %"39" = icmp slt i64 %"38", 995, !dbg !115
  br i1 %"39", label %main_bb18, label %main_bb22, !dbg !115

main_bb18:                                        ; preds = %main_bb17
  %"40" = load i64* @"'count", align 8, !dbg !100
  %"41" = add nsw i64 %"40", 1, !dbg !100
  %"42" = icmp sgt i64 %"41", 2147483647, !dbg !116
  br i1 %"42", label %main_bb19, label %main_bb20, !dbg !116

main_bb19:                                        ; preds = %main_bb18
  %"43" = sub nsw i64 %"41", 2147483647, !dbg !117
  %"44" = sub nsw i64 %"43", 1, !dbg !117
  %"45" = srem i64 %"44", 4294967296, !dbg !117
  %"46" = add nsw i64 -2147483648, %"45", !dbg !117
  br label %main_wrap_around.exit.i, !dbg !117

main_bb20:                                        ; preds = %main_bb18
  %"47" = icmp slt i64 %"41", -2147483648, !dbg !118
  br i1 %"47", label %main_bb21, label %main_wrap_around.exit.i, !dbg !118

main_bb21:                                        ; preds = %main_bb20
  %"48" = sub nsw i64 -2147483648, %"41", !dbg !119
  %"49" = sub nsw i64 %"48", 1, !dbg !119
  %"50" = srem i64 %"49", 4294967296, !dbg !119
  %"51" = sub nsw i64 2147483647, %"50", !dbg !119
  br label %main_wrap_around.exit.i, !dbg !119

main_wrap_around.exit.i:                          ; preds = %main_bb21, %main_bb20, %main_bb19
  %.0.i.i = phi i64 [ %"46", %main_bb19 ], [ %"51", %main_bb21 ], [ %"41", %main_bb20 ], !dbg !100
  store i64 %.0.i.i, i64* @"'count", align 8, !dbg !100
  br label %main_read_slice_1.exit, !dbg !120

main_bb22:                                        ; preds = %main_bb17
  store i64 1, i64* @"'flag", align 8, !dbg !121
  br label %main_read_slice_1.exit, !dbg !88

main_read_slice_1.exit:                           ; preds = %main_bb15, %main_bb16, %main_wrap_around.exit.i, %main_bb22
  %__retres.2.i = phi i64 [ 0, %main_bb15 ], [ -1, %main_bb16 ], [ %"38", %main_wrap_around.exit.i ], [ 0, %main_bb22 ], !dbg !88
  %"52" = icmp slt i64 %__retres.2.i, 0, !dbg !122
  br i1 %"52", label %main_bb23, label %main_bb15, !dbg !122
...
!43 = metadata !{i32 31, i32 19, metadata !9, null}
...
!84 = metadata !{i32 786688, metadata !85, metadata !"tmp", metadata !5, i32 52, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp] [line 52]
!85 = metadata !{i32 786443, metadata !1, metadata !12, i32 51, i32 13, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!86 = metadata !{i32 52, i32 15, metadata !85, null}
!87 = metadata !{i32 786688, metadata !9, metadata !"num", metadata !5, i32 31, metadata !8, i32 0, metadata !88} ; [ DW_TAG_auto_variable ] [num] [line 31]
!88 = metadata !{i32 53, i32 11, metadata !85, null}
!89 = metadata !{i32 31, i32 13, metadata !9, metadata !88}
!90 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777225, metadata !8, i32 0, metadata !91} ; [ DW_TAG_arg_variable ] [value] [line 9]
!91 = metadata !{i32 36, i32 11, metadata !49, metadata !88}
!92 = metadata !{i32 9, i32 33, metadata !4, metadata !91}
!93 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554441, metadata !8, i32 0, metadata !91} ; [ DW_TAG_arg_variable ] [lower_bound] [line 9]
!94 = metadata !{i32 9, i32 50, metadata !4, metadata !91}
!95 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331657, metadata !8, i32 0, metadata !91} ; [ DW_TAG_arg_variable ] [upper_bound] [line 9]
!96 = metadata !{i32 9, i32 73, metadata !4, metadata !91}
!97 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 10, metadata !8, i32 0, metadata !91} ; [ DW_TAG_auto_variable ] [range] [line 10]
!98 = metadata !{i32 10, i32 15, metadata !4, metadata !91}
!99 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777225, metadata !8, i32 0, metadata !100} ; [ DW_TAG_arg_variable ] [value] [line 9]
!100 = metadata !{i32 38, i32 16, metadata !64, metadata !88}
!101 = metadata !{i32 9, i32 33, metadata !4, metadata !100}
!102 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554441, metadata !8, i32 0, metadata !100} ; [ DW_TAG_arg_variable ] [lower_bound] [line 9]
...
!108 = metadata !{i32 786688, metadata !9, metadata !"__retres", metadata !5, i32 21, metadata !8, i32 0, metadata !88} ; [ DW_TAG_auto_variable ] [__retres] [line 21]
!109 = metadata !{i32 21, i32 13, metadata !9, metadata !88}
!110 = metadata !{i32 51, i32 3, metadata !12, null}
!111 = metadata !{i32 22, i32 7, metadata !40, metadata !88}
!112 = metadata !{i32 27, i32 9, metadata !42, metadata !88}
!113 = metadata !{i32 31, i32 19, metadata !9, metadata !88}
!114 = metadata !{i32 32, i32 7, metadata !47, metadata !88}
!115 = metadata !{i32 37, i32 9, metadata !62, metadata !88}
!116 = metadata !{i32 11, i32 9, metadata !31, metadata !100}
!117 = metadata !{i32 12, i32 9, metadata !33, metadata !100}
!118 = metadata !{i32 14, i32 14, metadata !35, metadata !100}
!119 = metadata !{i32 15, i32 9, metadata !37, metadata !100}
!120 = metadata !{i32 40, i32 5, metadata !64, metadata !88}
!121 = metadata !{i32 42, i32 7, metadata !81, metadata !88}
!122 = metadata !{i32 54, i32 9, metadata !123, null}
!123 = metadata !{i32 786443, metadata !1, metadata !85, i32 54, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!124 = metadata !{i32 59, i32 3, metadata !12, null}
