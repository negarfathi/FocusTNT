...
define i32 @main() #0 {
main_bb5:
  %mcelog_entry = alloca [1001 x i64], align 16
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !35), !dbg !36
  %"12" = icmp sle i64 1001, 0, !dbg !37
  %"13" = icmp sgt i64 1001, 1000, !dbg !39
  %or.cond = or i1 %"12", %"13", !dbg !37
  br i1 %or.cond, label %main_bb17, label %main_bb6, !dbg !37

main_bb6:                                         ; preds = %main_bb5
  call void @llvm.dbg.declare(metadata !{[1001 x i64]* %mcelog_entry}, metadata !41), !dbg !45
  %"14" = bitcast [1001 x i64]* %mcelog_entry to i8*, !dbg !46
  call void @llvm.memset.p0i8.i64(i8* %"14", i8 0, i64 8008, i32 16, i1 false), !dbg !46
  call void @llvm.dbg.value(metadata !47, i64 0, metadata !48), !dbg !50
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !51), !dbg !53
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  ...
  %"15" = icmp slt i64 %i.0, 1001, !dbg !64
  br i1 %"15", label %main_bb7, label %main_bb11, !dbg !64

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"16" = add nsw i64 %i.0, 1, !dbg !52
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !67
  br i1 %"17", label %main_bb8, label %main_bb9, !dbg !67

main_bb8:                                         ; preds = %main_bb7
  %"18" = sub nsw i64 %"16", 2147483647, !dbg !68
  %"19" = sub nsw i64 %"18", 1, !dbg !68
  %"20" = srem i64 %"19", 4294967296, !dbg !68
  %"21" = add nsw i64 -2147483648, %"20", !dbg !68
  br label %main_wrap_around.exit, !dbg !68

main_bb9:                                         ; preds = %main_bb7
  %"22" = icmp slt i64 %"16", -2147483648, !dbg !69
  br i1 %"22", label %main_bb10, label %main_wrap_around.exit, !dbg !69

main_bb10:                                        ; preds = %main_bb9
  %"23" = sub nsw i64 -2147483648, %"16", !dbg !70
  %"24" = sub nsw i64 %"23", 1, !dbg !70
  %"25" = srem i64 %"24", 4294967296, !dbg !70
  %"26" = sub nsw i64 2147483647, %"25", !dbg !70
...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  %"27" = icmp slt i64 5, 0, !dbg !74
  br i1 %"27", label %main_bb17, label %main_wrap_around.exit2, !dbg !74

main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb11
  %entry.0 = phi i64 [ 5, %main_bb11 ], [ %"37", %main_bb14 ], [ %"42", %main_bb16 ], [ %"32", %main_bb15 ]
  %"28" = icmp sge i64 %entry.0, 1001, !dbg !76
  br i1 %"28", label %main_bb17, label %main_bb12, !dbg !76

main_bb12:                                        ; preds = %main_wrap_around.exit2
  %"29" = getelementptr inbounds [1001 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !80
  %"30" = load i64* %"29", align 8, !dbg !80
  %"31" = icmp ne i64 %"30", 0, !dbg !80
  br i1 %"31", label %main_bb13, label %main_bb17, !dbg !80

main_bb13:                                        ; preds = %main_bb12
  %"32" = add nsw i64 %entry.0, 1, !dbg !82
  %"33" = icmp sgt i64 %"32", 2147483647, !dbg !84
  br i1 %"33", label %main_bb14, label %main_bb15, !dbg !84

main_bb14:                                        ; preds = %main_bb13
  %"34" = sub nsw i64 %"32", 2147483647, !dbg !85
  %"35" = sub nsw i64 %"34", 1, !dbg !85
  %"36" = srem i64 %"35", 4294967296, !dbg !85
  %"37" = add nsw i64 -2147483648, %"36", !dbg !85
  br label %main_wrap_around.exit2, !dbg !85

main_bb15:                                        ; preds = %main_bb13
  %"38" = icmp slt i64 %"32", -2147483648, !dbg !86
  br i1 %"38", label %main_bb16, label %main_wrap_around.exit2, !dbg !86

main_bb16:                                        ; preds = %main_bb15
  %"39" = sub nsw i64 -2147483648, %"32", !dbg !87
  %"40" = sub nsw i64 %"39", 1, !dbg !87
  %"41" = srem i64 %"40", 4294967296, !dbg !87
  %"42" = sub nsw i64 2147483647, %"41", !dbg !87
...
!42 = metadata !{i32 786433, null, null, metadata !"", i32 0, i64 64064, i64 64, i32 0, i32 0, metadata !8, metadata !43, i32 0, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 64064, align 64, offset 0] [from long long int]
!43 = metadata !{metadata !44}
!44 = metadata !{i32 786465, i64 0, i64 1001}     ; [ DW_TAG_subrange_type ] [0, 1000]
...
!71 = metadata !{i64 5}
!72 = metadata !{i32 786688, metadata !9, metadata !"entry", metadata !5, i32 34, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [entry] [line 34]
!73 = metadata !{i32 34, i32 15, metadata !9, null}
!74 = metadata !{i32 35, i32 9, metadata !75, null}
!75 = metadata !{i32 786443, metadata !1, metadata !9, i32 35, i32 9, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 41, i32 13, metadata !77, null}
!77 = metadata !{i32 786443, metadata !1, metadata !78, i32 41, i32 13, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!78 = metadata !{i32 786443, metadata !1, metadata !79, i32 40, i32 5, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!79 = metadata !{i32 786443, metadata !1, metadata !9, i32 39, i32 5, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!80 = metadata !{i32 45, i32 13, metadata !81, null}
!81 = metadata !{i32 786443, metadata !1, metadata !78, i32 45, i32 13, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!82 = metadata !{i32 47, i32 22, metadata !83, null}
!83 = metadata !{i32 786443, metadata !1, metadata !81, i32 46, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!84 = metadata !{i32 14, i32 9, metadata !26, metadata !82}
!85 = metadata !{i32 15, i32 9, metadata !28, metadata !82}
!86 = metadata !{i32 17, i32 14, metadata !30, metadata !82}
!87 = metadata !{i32 18, i32 9, metadata !32, metadata !82}
!88 = metadata !{i32 53, i32 1, metadata !9, null}
