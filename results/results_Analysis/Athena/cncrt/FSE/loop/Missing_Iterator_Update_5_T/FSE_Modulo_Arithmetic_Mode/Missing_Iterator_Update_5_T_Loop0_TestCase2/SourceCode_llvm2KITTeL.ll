...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  br i1 %"28", label %main_bb17, label %main_wrap_around.exit2, !dbg !74

main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb11
  %entry.0 = phi i64 [ 1, %main_bb11 ], [ %"38", %main_bb14 ], [ %"43", %main_bb16 ], [ %"33", %main_bb15 ]
  %"29" = icmp sge i64 %entry.0, 3, !dbg !76
  br i1 %"29", label %main_bb17, label %main_bb12, !dbg !76

main_bb12:                                        ; preds = %main_wrap_around.exit2
  %"30" = getelementptr inbounds [3 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !80
  %"31" = load i64* %"30", align 8, !dbg !80
  %"32" = icmp ne i64 %"31", 0, !dbg !80
  br i1 %"32", label %main_bb13, label %main_bb17, !dbg !80

main_bb13:                                        ; preds = %main_bb12
  %"33" = add nsw i64 %entry.0, 1, !dbg !82
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !84
  br i1 %"34", label %main_bb14, label %main_bb15, !dbg !84

main_bb14:                                        ; preds = %main_bb13
  %"35" = sub nsw i64 %"33", 2147483647, !dbg !85
  %"36" = sub nsw i64 %"35", 1, !dbg !85
  %"37" = srem i64 %"36", 4294967296, !dbg !85
  %"38" = add nsw i64 -2147483648, %"37", !dbg !85
  br label %main_wrap_around.exit2, !dbg !85

main_bb15:                                        ; preds = %main_bb13
  %"39" = icmp slt i64 %"33", -2147483648, !dbg !86
  br i1 %"39", label %main_bb16, label %main_wrap_around.exit2, !dbg !86

main_bb16:                                        ; preds = %main_bb15
  %"40" = sub nsw i64 -2147483648, %"33", !dbg !87
  %"41" = sub nsw i64 %"40", 1, !dbg !87
  %"42" = srem i64 %"41", 4294967296, !dbg !87
  %"43" = sub nsw i64 2147483647, %"42", !dbg !87
