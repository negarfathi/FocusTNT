...
main_bb6:                                         ; preds = %main_bb5
  ...
  %"16" = getelementptr [5 x i64]* %"15", i32 0, i32 0, !dbg !46
  store i64 1, i64* %"16", !dbg !46
  %"17" = getelementptr [5 x i64]* %"15", i32 0, i32 1, !dbg !46
  store i64 1, i64* %"17", !dbg !46
  %"18" = getelementptr [5 x i64]* %"15", i32 0, i32 2, !dbg !46
  store i64 1, i64* %"18", !dbg !46
  %"19" = getelementptr [5 x i64]* %"15", i32 0, i32 3, !dbg !46
  store i64 1, i64* %"19", !dbg !46
  %"20" = getelementptr [5 x i64]* %"15", i32 0, i32 4, !dbg !46
  store i64 1, i64* %"20", !dbg !46
  call void @llvm.dbg.value(metadata !47, i64 0, metadata !48), !dbg !50
  call void @llvm.dbg.value(metadata !{i64 %"22"}, i64 0, metadata !51), !dbg !53
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  %i.0 = phi i64 [ 0, %main_bb6 ], [ %"27", %main_bb8 ], [ %"32", %main_bb10 ], [ %"22", %main_bb9 ]
  %"21" = icmp slt i64 %i.0, 5, !dbg !64
  br i1 %"21", label %main_bb7, label %main_bb11, !dbg !64

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"22" = add nsw i64 %i.0, 1, !dbg !52
  %"23" = icmp sgt i64 %"22", 2147483647, !dbg !67
  br i1 %"23", label %main_bb8, label %main_bb9, !dbg !67

main_bb8:                                         ; preds = %main_bb7
  %"24" = sub nsw i64 %"22", 2147483647, !dbg !68
  %"25" = sub nsw i64 %"24", 1, !dbg !68
  %"26" = srem i64 %"25", 4294967296, !dbg !68
  %"27" = add nsw i64 -2147483648, %"26", !dbg !68
  br label %main_wrap_around.exit, !dbg !68

main_bb9:                                         ; preds = %main_bb7
  %"28" = icmp slt i64 %"22", -2147483648, !dbg !69
  br i1 %"28", label %main_bb10, label %main_wrap_around.exit, !dbg !69

main_bb10:                                        ; preds = %main_bb9
  %"29" = sub nsw i64 -2147483648, %"22", !dbg !70
  %"30" = sub nsw i64 %"29", 1, !dbg !70
  %"31" = srem i64 %"30", 4294967296, !dbg !70
  %"32" = sub nsw i64 2147483647, %"31", !dbg !70
...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  %"33" = icmp slt i64 -1, 0, !dbg !74
  br i1 %"33", label %main_bb17, label %main_wrap_around.exit2, !dbg !74

main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb11
  %entry.0 = phi i64 [ -1, %main_bb11 ], [ %"43", %main_bb14 ], [ %"48", %main_bb16 ], [ %"38", %main_bb15 ]
  %"34" = icmp sge i64 %entry.0, 5, !dbg !76
  br i1 %"34", label %main_bb17, label %main_bb12, !dbg !76

main_bb12:                                        ; preds = %main_wrap_around.exit2
  %"35" = getelementptr inbounds [5 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !80
  %"36" = load i64* %"35", align 8, !dbg !80
  %"37" = icmp ne i64 %"36", 0, !dbg !80
  br i1 %"37", label %main_bb13, label %main_bb17, !dbg !80

main_bb13:                                        ; preds = %main_bb12
  %"38" = add nsw i64 %entry.0, 1, !dbg !82
  %"39" = icmp sgt i64 %"38", 2147483647, !dbg !84
  br i1 %"39", label %main_bb14, label %main_bb15, !dbg !84

main_bb14:                                        ; preds = %main_bb13
  %"40" = sub nsw i64 %"38", 2147483647, !dbg !85
  %"41" = sub nsw i64 %"40", 1, !dbg !85
  %"42" = srem i64 %"41", 4294967296, !dbg !85
  %"43" = add nsw i64 -2147483648, %"42", !dbg !85
  br label %main_wrap_around.exit2, !dbg !85

main_bb15:                                        ; preds = %main_bb13
  %"44" = icmp slt i64 %"38", -2147483648, !dbg !86
  br i1 %"44", label %main_bb16, label %main_wrap_around.exit2, !dbg !86

main_bb16:                                        ; preds = %main_bb15
  %"45" = sub nsw i64 -2147483648, %"38", !dbg !87
  %"46" = sub nsw i64 %"45", 1, !dbg !87
  %"47" = srem i64 %"46", 4294967296, !dbg !87
  %"48" = sub nsw i64 2147483647, %"47", !dbg !87
