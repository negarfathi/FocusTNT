...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  br i1 %"33", label %main_bb17, label %main_wrap_around.exit2, !dbg !73

main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb11
  %entry.0 = phi i64 [ 0, %main_bb11 ], [ %"43", %main_bb14 ], [ %"48", %main_bb16 ], [ %"38", %main_bb15 ]
  %"34" = icmp sge i64 %entry.0, 5, !dbg !75
  br i1 %"34", label %main_bb17, label %main_bb12, !dbg !75

main_bb12:                                        ; preds = %main_wrap_around.exit2
  %"35" = getelementptr inbounds [5 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !79
  %"36" = load i64* %"35", align 8, !dbg !79
  %"37" = icmp ne i64 %"36", 0, !dbg !79
  br i1 %"37", label %main_bb13, label %main_bb17, !dbg !79

main_bb13:                                        ; preds = %main_bb12
  %"38" = add nsw i64 %entry.0, 1, !dbg !81
  %"39" = icmp sgt i64 %"38", 2147483647, !dbg !83
  br i1 %"39", label %main_bb14, label %main_bb15, !dbg !83
...
main_bb15:                                        ; preds = %main_bb13
  ...
  br i1 %"44", label %main_bb16, label %main_wrap_around.exit2, !dbg !85
