...
main_bb5:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %"12", i8* %"13", i64 80, i32 16, i1 false), !dbg !48
  call void @llvm.dbg.declare(metadata !{[10 x i64]* %new_}, metadata !49), !dbg !50
  %"14" = bitcast [10 x i64]* %new_ to i8*, !dbg !51
  %"15" = bitcast [10 x i64]* @main.new_ to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %"14", i8* %"15", i64 80, i32 16, i1 false), !dbg !51
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !52), !dbg !54
  call void @llvm.dbg.value(metadata !{i64 %"17"}, i64 0, metadata !55), !dbg !57
...
main_bb6:                                         ; preds = %main_wrap_around.exit
  %"17" = add nsw i64 %j.0, 1, !dbg !56
  %"18" = icmp sgt i64 %"17", 2147483647, !dbg !71
  br i1 %"18", label %main_bb7, label %main_bb8, !dbg !71

main_bb7:                                         ; preds = %main_bb6
  %"19" = sub nsw i64 %"17", 2147483647, !dbg !72
  %"20" = sub nsw i64 %"19", 1, !dbg !72
  %"21" = srem i64 %"20", 4294967296, !dbg !72
  %"22" = add nsw i64 -2147483648, %"21", !dbg !72
  br label %main_wrap_around.exit, !dbg !72

main_bb8:                                         ; preds = %main_bb6
  %"23" = icmp slt i64 %"17", -2147483648, !dbg !73
  br i1 %"23", label %main_bb9, label %main_wrap_around.exit, !dbg !73

main_bb9:                                         ; preds = %main_bb8
  %"24" = sub nsw i64 -2147483648, %"17", !dbg !74
  %"25" = sub nsw i64 %"24", 1, !dbg !74
  %"26" = srem i64 %"25", 4294967296, !dbg !74
  %"27" = sub nsw i64 2147483647, %"26", !dbg !74
  br label %main_wrap_around.exit, !dbg !74

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"28" = getelementptr inbounds [10 x i64]* %old_, i32 0, i64 9, !dbg !75
  store i64 0, i64* %"28", align 8, !dbg !75
  %"29" = getelementptr inbounds [10 x i64]* %new_, i32 0, i64 9, !dbg !76
  store i64 0, i64* %"29", align 8, !dbg !76
  call void @llvm.dbg.value(metadata !{i64 %base.0}, i64 0, metadata !77), !dbg !79
  call void @llvm.dbg.value(metadata !{i64 %"35"}, i64 0, metadata !80), !dbg !84
...
main_wrap_around.exit2:                           ; preds = %main_bb23, %main_bb22, %main_bb21, %main_bb10
  %base.0 = phi i64 [ 100, %main_bb10 ], [ %"63", %main_bb21 ], [ %"68", %main_bb23 ], [ %"58", %main_bb22 ]
  %i.0 = phi i64 [ 0, %main_bb10 ], [ %.0.i3, %main_bb21 ], [ %.0.i3, %main_bb22 ], [ %.0.i3, %main_bb23 ]
  %"30" = getelementptr inbounds [10 x i64]* %old_, i32 0, i64 %i.0, !dbg !92
  %"31" = load i64* %"30", align 8, !dbg !92
  %"32" = getelementptr inbounds [10 x i64]* %new_, i32 0, i64 %i.0, !dbg !92
...
main_bb11:                                        ; preds = %main_wrap_around.exit6, %main_wrap_around.exit2
  ...
  %"34" = icmp ne i64 %"31", %"33", !dbg !92
  br i1 %"34", label %main_bb12, label %main_bb17, !dbg !92

main_bb12:                                        ; preds = %main_bb11
  %"35" = add nsw i64 %number.0, 1, !dbg !81
  %"36" = icmp sgt i64 %"35", 2147483647, !dbg !95
  br i1 %"36", label %main_bb13, label %main_bb14, !dbg !95

main_bb13:                                        ; preds = %main_bb12
  %"37" = sub nsw i64 %"35", 2147483647, !dbg !96
  %"38" = sub nsw i64 %"37", 1, !dbg !96
  %"39" = srem i64 %"38", 4294967296, !dbg !96
  %"40" = add nsw i64 -2147483648, %"39", !dbg !96
  br label %main_wrap_around.exit6, !dbg !96

main_bb14:                                        ; preds = %main_bb12
  %"41" = icmp slt i64 %"35", -2147483648, !dbg !97
  br i1 %"41", label %main_bb15, label %main_wrap_around.exit6, !dbg !97

main_bb15:                                        ; preds = %main_bb14
  %"42" = sub nsw i64 -2147483648, %"35", !dbg !98
  %"43" = sub nsw i64 %"42", 1, !dbg !98
  %"44" = srem i64 %"43", 4294967296, !dbg !98
  %"45" = sub nsw i64 2147483647, %"44", !dbg !98
  br label %main_wrap_around.exit6, !dbg !98

main_wrap_around.exit6:                           ; preds = %main_bb13, %main_bb14, %main_bb15
  %.0.i5 = phi i64 [ %"40", %main_bb13 ], [ %"45", %main_bb15 ], [ %"35", %main_bb14 ], !dbg !81
  %"46" = icmp eq i64 %.0.i5, 110, !dbg !81
  br i1 %"46", label %main_bb16, label %main_bb11, !dbg !81
