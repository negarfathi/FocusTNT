...
main_bb14:
  ...
  call void @llvm.dbg.value(metadata !89, i64 0, metadata !90), !dbg !92
  call void @llvm.dbg.value(metadata !53, i64 0, metadata !93), !dbg !94
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !95), !dbg !96
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !97), !dbg !98
  call void @llvm.dbg.value(metadata !89, i64 0, metadata !87), !dbg !88
  call void @llvm.dbg.value(metadata !{i64 %"36"}, i64 0, metadata !99), !dbg !101
  call void @llvm.dbg.value(metadata !53, i64 0, metadata !102), !dbg !103
  ...
  br label %main_bb15, !dbg !108

main_bb15:                                        ; preds = %main_read.exit, %main_bb14
  %"32" = icmp eq i64 %"31", 1, !dbg !83
  %"33" = load i64* @"'count", align 8, !dbg !84
  %"34" = icmp sgt i64 %"33", 100, !dbg !109
  %or.cond.i = or i1 %"32", %"34", !dbg !83
  br i1 %or.cond.i, label %main_read.exit, label %main_bb16, !dbg !83

main_bb16:                                        ; preds = %main_bb15
  %"35" = load i64* @"'count", align 8, !dbg !100
  %"36" = add nsw i64 %"35", 1, !dbg !100
  %"37" = icmp sgt i64 %"36", 2147483647, !dbg !110
  br i1 %"37", label %main_bb17, label %main_bb18, !dbg !110

main_bb17:                                        ; preds = %main_bb16
  %"38" = sub nsw i64 %"36", 2147483647, !dbg !111
  %"39" = sub nsw i64 %"38", 1, !dbg !111
  %"40" = srem i64 %"39", 4294967296, !dbg !111
  %"41" = add nsw i64 -2147483648, %"40", !dbg !111
  br label %main_wrap_around.exit.i, !dbg !111

main_bb18:                                        ; preds = %main_bb16
  %"42" = icmp slt i64 %"36", -2147483648, !dbg !112
  br i1 %"42", label %main_bb19, label %main_wrap_around.exit.i, !dbg !112

main_bb19:                                        ; preds = %main_bb18
  %"43" = sub nsw i64 -2147483648, %"36", !dbg !113
  %"44" = sub nsw i64 %"43", 1, !dbg !113
  %"45" = srem i64 %"44", 4294967296, !dbg !113
  %"46" = sub nsw i64 2147483647, %"45", !dbg !113
  br label %main_wrap_around.exit.i, !dbg !113

main_wrap_around.exit.i:                          ; preds = %main_bb19, %main_bb18, %main_bb17
  %.0.i.i = phi i64 [ %"41", %main_bb17 ], [ %"46", %main_bb19 ], [ %"36", %main_bb18 ], !dbg !100
  store i64 %.0.i.i, i64* @"'count", align 8, !dbg !100
  br label %main_read.exit, !dbg !114

main_read.exit:                                   ; preds = %main_bb15, %main_wrap_around.exit.i
  %"47" = icmp sle i64 0, 0, !dbg !84
...
!89 = metadata !{i64 0}
!90 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777230, metadata !8, i32 0, metadata !91} ; [ DW_TAG_arg_variable ] [value] [line 14]
!91 = metadata !{i32 37, i32 15, metadata !50, metadata !84}
!92 = metadata !{i32 14, i32 33, metadata !4, metadata !91}
!93 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554446, metadata !8, i32 0, metadata !91} ; [ DW_TAG_arg_variable ] [lower_bound] [line 14]
!94 = metadata !{i32 14, i32 50, metadata !4, metadata !91}
!95 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331662, metadata !8, i32 0, metadata !91} ; [ DW_TAG_arg_variable ] [upper_bound] [line 14]
!96 = metadata !{i32 14, i32 73, metadata !4, metadata !91}
!97 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 15, metadata !8, i32 0, metadata !91} ; [ DW_TAG_auto_variable ] [range] [line 15]
!98 = metadata !{i32 15, i32 15, metadata !4, metadata !91}
!99 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777230, metadata !8, i32 0, metadata !100} ; [ DW_TAG_arg_variable ] [value] [line 14]
!100 = metadata !{i32 40, i32 22, metadata !65, metadata !84}
!101 = metadata !{i32 14, i32 33, metadata !4, metadata !100}
!102 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554446, metadata !8, i32 0, metadata !100} ; [ DW_TAG_arg_variable ] [lower_bound] [line 14]
!103 = metadata !{i32 14, i32 50, metadata !4, metadata !100}
!104 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331662, metadata !8, i32 0, metadata !100} ; [ DW_TAG_arg_variable ] [upper_bound] [line 14]
!105 = metadata !{i32 14, i32 73, metadata !4, metadata !100}
!106 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 15, metadata !8, i32 0, metadata !100} ; [ DW_TAG_auto_variable ] [range] [line 15]
!107 = metadata !{i32 15, i32 15, metadata !4, metadata !100}
!108 = metadata !{i32 53, i32 5, metadata !12, null}
!109 = metadata !{i32 26, i32 9, metadata !43, metadata !84}
!110 = metadata !{i32 16, i32 9, metadata !32, metadata !100}
!111 = metadata !{i32 17, i32 9, metadata !34, metadata !100}
!112 = metadata !{i32 19, i32 14, metadata !36, metadata !100}
!113 = metadata !{i32 20, i32 9, metadata !38, metadata !100}
!114 = metadata !{i32 41, i32 13, metadata !65, metadata !84}
!115 = metadata !{i32 60, i32 5, metadata !12, null}
