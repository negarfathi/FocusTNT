...
main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get.exit
  %"7" = icmp eq i32 1, 0, !dbg !45
  br i1 %"7", label %main_bb4, label %main_bb5, !dbg !45

main_bb4:                                         ; preds = %main_bb3
  %"8" = load i32* @"'flag", align 4, !dbg !47
  %"9" = add nsw i32 %"8", 1, !dbg !47
  store i32 %"9", i32* @"'flag", align 4, !dbg !47
...
!48 = metadata !{i32 32, i32 13, metadata !37, null}
