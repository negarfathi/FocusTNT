...
main_wrap_around.exit2:                           ; preds = %main_bb12, %main_bb11, %main_bb10, %main_bb5
  %s.0 = phi i64 [ 40000, %main_bb5 ], [ %"28", %main_bb10 ], [ %"33", %main_bb12 ], [ %"24", %main_bb11 ]
  %"12" = add nsw i64 40000, 30000, !dbg !43
  %"13" = icmp sgt i64 %"12", 2147483647, !dbg !68
  br i1 %"13", label %main_bb6, label %main_bb7, !dbg !68

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"14" = sub nsw i64 %"12", 2147483647, !dbg !69
  %"15" = sub nsw i64 %"14", 1, !dbg !69
  %"16" = srem i64 %"15", 4294967296, !dbg !69
  %"17" = add nsw i64 -2147483648, %"16", !dbg !69
  br label %main_wrap_around.exit, !dbg !69

main_bb7:                                         ; preds = %main_wrap_around.exit2
  %"18" = icmp slt i64 %"12", -2147483648, !dbg !70
  br i1 %"18", label %main_bb8, label %main_wrap_around.exit, !dbg !70

main_bb8:                                         ; preds = %main_bb7
  %"19" = sub nsw i64 -2147483648, %"12", !dbg !71
  %"20" = sub nsw i64 %"19", 1, !dbg !71
  %"21" = srem i64 %"20", 4294967296, !dbg !71
  %"22" = sub nsw i64 2147483647, %"21", !dbg !71
...
main_bb9:                                         ; preds = %main_wrap_around.exit
  ...
  %"25" = icmp sgt i64 %"24", 65535, !dbg !72
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !72

main_bb10:                                        ; preds = %main_bb9
  %"26" = sub nsw i64 %"24", 65535, !dbg !73
  %"27" = sub nsw i64 %"26", 1, !dbg !73
  %"28" = srem i64 %"27", 65536, !dbg !73
...
main_bb12:                                        ; preds = %main_bb11
  ...
  %"32" = srem i64 %"31", 65536, !dbg !75
  %"33" = sub nsw i64 65535, %"32", !dbg !75
