...
define i32 @main() #0 {
main_bb3:
  call void @llvm.dbg.value(metadata !{i8 %"11"}, i64 0, metadata !27), !dbg !29
  call void @llvm.dbg.value(metadata !18, i64 0, metadata !30), !dbg !34
  call void @llvm.dbg.value(metadata !35, i64 0, metadata !30), !dbg !34
  call void @llvm.dbg.value(metadata !36, i64 0, metadata !30), !dbg !34
  br label %main_bb4, !dbg !37

main_bb4:                                         ; preds = %main_bb7, %main_bb3
  %"7" = load i32* @"'flag", align 4, !dbg !38
  %"8" = icmp sgt i32 %"7", 1000, !dbg !38
  br i1 %"8", label %main_fgetc.exit, label %main_bb5, !dbg !38

main_bb5:                                         ; preds = %main_bb4
  %"9" = load i32* @"'flag", align 4, !dbg !39
  %"10" = add nsw i32 %"9", 1, !dbg !39
  store i32 %"10", i32* @"'flag", align 4, !dbg !39
  br label %main_fgetc.exit, !dbg !40

main_fgetc.exit:                                  ; preds = %main_bb4, %main_bb5
  %.0.i = phi i32 [ 0, %main_bb5 ], [ -1, %main_bb4 ], !dbg !31
  %"11" = trunc i32 %.0.i to i8, !dbg !31
  %"12" = zext i8 %"11" to i32, !dbg !41
  %"13" = icmp eq i32 %"12", 0, !dbg !41
  %"14" = zext i8 %"11" to i32
  %"15" = icmp eq i32 %"14", -1, !dbg !43
  %or.cond = or i1 %"13", %"15", !dbg !41
  br i1 %or.cond, label %main_bb6, label %main_bb7, !dbg !41
...
!35 = metadata !{i32 -256}
!36 = metadata !{i32 0}
!37 = metadata !{i32 26, i32 5, metadata !33, null}
!38 = metadata !{i32 14, i32 9, metadata !16, metadata !31}
!39 = metadata !{i32 16, i32 5, metadata !4, metadata !31}
!40 = metadata !{i32 21, i32 5, metadata !4, metadata !31}
!41 = metadata !{i32 29, i32 13, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !32, i32 29, i32 13, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 29, i32 13, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !42, i32 29, i32 13, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 43, i32 1, metadata !9, null}
!46 = metadata !{i32 41, i32 5, metadata !32, null}
