...
main_bb15:
  ...
  call void @llvm.dbg.value(metadata !98, i64 0, metadata !115), !dbg !117
  ...
  call void @llvm.dbg.value(metadata !92, i64 0, metadata !124), !dbg !126
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !127), !dbg !128
  call void @llvm.dbg.value(metadata !47, i64 0, metadata !129), !dbg !130
  call void @llvm.dbg.value(metadata !50, i64 0, metadata !131), !dbg !132
...
main_bb16:                                        ; preds = %main_NewDefault, %main_bb15
  %"39" = load i64* @"'flag", align 8, !dbg !134
  %"40" = icmp sgt i64 %"39", 1000, !dbg !134
  br i1 %"40", label %main_fgetc.exit, label %main_bb17, !dbg !134

main_bb17:                                        ; preds = %main_bb16
  %"41" = load i64* @"'flag", align 8, !dbg !104
  %"42" = add nsw i64 %"41", 1, !dbg !104
  %"43" = icmp sgt i64 %"42", 2147483647, !dbg !135
  br i1 %"43", label %main_bb18, label %main_bb19, !dbg !135

main_bb18:                                        ; preds = %main_bb17
  %"44" = sub nsw i64 %"42", 2147483647, !dbg !136
  %"45" = sub nsw i64 %"44", 1, !dbg !136
  %"46" = srem i64 %"45", 4294967296, !dbg !136
  %"47" = add nsw i64 -2147483648, %"46", !dbg !136
  br label %main_wrap_around.exit.i, !dbg !136

main_bb19:                                        ; preds = %main_bb17
  %"48" = icmp slt i64 %"42", -2147483648, !dbg !137
  br i1 %"48", label %main_bb20, label %main_wrap_around.exit.i, !dbg !137

main_bb20:                                        ; preds = %main_bb19
  %"49" = sub nsw i64 -2147483648, %"42", !dbg !138
  %"50" = sub nsw i64 %"49", 1, !dbg !138
  %"51" = srem i64 %"50", 4294967296, !dbg !138
  %"52" = sub nsw i64 2147483647, %"51", !dbg !138
...
main_wrap_around.exit.i:                          ; preds = %main_bb20, %main_bb19, %main_bb18
  ...
  br label %main_fgetc.exit, !dbg !139

main_fgetc.exit:                                  ; preds = %main_bb16, %main_wrap_around.exit.i
  %.0.i = phi i64 [ 0, %main_wrap_around.exit.i ], [ -1, %main_bb16 ], !dbg !105
  %"53" = icmp slt i64 %.0.i, 0, !dbg !140
  br i1 %"53", label %main_bb21, label %main_wrap_around.exit, !dbg !140

main_bb21:                                        ; preds = %main_fgetc.exit
  %"54" = sub nsw i64 0, %.0.i, !dbg !141
  %"55" = sub nsw i64 %"54", 1, !dbg !141
  %"56" = srem i64 %"55", 256, !dbg !141
  %"57" = sub nsw i64 255, %"56", !dbg !141
...
!139 = metadata !{i32 37, i32 5, metadata !9, metadata !105}
!140 = metadata !{i32 19, i32 14, metadata !35, metadata !88}
!141 = metadata !{i32 20, i32 9, metadata !37, metadata !88}
!142 = metadata !{i32 61, i32 1, metadata !12, null}
