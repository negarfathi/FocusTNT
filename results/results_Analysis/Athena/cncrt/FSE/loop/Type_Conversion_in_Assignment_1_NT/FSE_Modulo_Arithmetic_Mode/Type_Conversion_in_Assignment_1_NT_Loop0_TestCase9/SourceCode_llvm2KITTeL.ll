...
fgetc_wrap_around.exit3:                          ; preds = %fgetc_bb13, %fgetc_bb12, %fgetc_bb11, %fgetc_wrap_around.exit
  %c.0 = phi i64 [ 511, %fgetc_wrap_around.exit ], [ %"32", %fgetc_bb11 ], [ %"37", %fgetc_bb13 ], [ %"27", %fgetc_bb12 ]
...
main_bb15:
  ...
  call void @llvm.dbg.value(metadata !95, i64 0, metadata !115), !dbg !117
  ...
  call void @llvm.dbg.value(metadata !95, i64 0, metadata !113), !dbg !114
  br label %main_bb16, !dbg !124

main_bb16:                                        ; preds = %main_NewDefault, %main_bb15
  %"39" = load i64* @"'flag", align 8, !dbg !125
  %"40" = icmp sgt i64 %"39", 1000, !dbg !125
  br i1 %"40", label %main_fgetc.exit, label %main_bb17, !dbg !125

main_bb17:                                        ; preds = %main_bb16
  %"41" = load i64* @"'flag", align 8, !dbg !104
  %"42" = add nsw i64 %"41", 1, !dbg !104
  %"43" = icmp sgt i64 %"42", 2147483647, !dbg !126
  br i1 %"43", label %main_bb18, label %main_bb19, !dbg !126

main_bb18:                                        ; preds = %main_bb17
  %"44" = sub nsw i64 %"42", 2147483647, !dbg !127
  %"45" = sub nsw i64 %"44", 1, !dbg !127
  %"46" = srem i64 %"45", 4294967296, !dbg !127
  %"47" = add nsw i64 -2147483648, %"46", !dbg !127
  br label %main_wrap_around.exit.i, !dbg !127

main_bb19:                                        ; preds = %main_bb17
  %"48" = icmp slt i64 %"42", -2147483648, !dbg !128
  br i1 %"48", label %main_bb20, label %main_wrap_around.exit.i, !dbg !128

main_bb20:                                        ; preds = %main_bb19
  %"49" = sub nsw i64 -2147483648, %"42", !dbg !129
  %"50" = sub nsw i64 %"49", 1, !dbg !129
  %"51" = srem i64 %"50", 4294967296, !dbg !129
  %"52" = sub nsw i64 2147483647, %"51", !dbg !129
  br label %main_wrap_around.exit.i, !dbg !129
...
main_wrap_around.exit.i:                          ; preds = %main_bb20, %main_bb19, %main_bb18
  ...
  br label %main_fgetc.exit, !dbg !130

main_fgetc.exit:                                  ; preds = %main_bb16, %main_wrap_around.exit.i
  %.0.i = phi i64 [ 255, %main_wrap_around.exit.i ], [ -1, %main_bb16 ], !dbg !105
  %"53" = icmp slt i64 %.0.i, 0, !dbg !131
  br i1 %"53", label %main_bb21, label %main_wrap_around.exit, !dbg !131

main_bb21:                                        ; preds = %main_fgetc.exit
  %"54" = sub nsw i64 0, %.0.i, !dbg !132
  %"55" = sub nsw i64 %"54", 1, !dbg !132
  %"56" = srem i64 %"55", 256, !dbg !132
  %"57" = sub nsw i64 255, %"56", !dbg !132
...
!116 = metadata !{i32 36, i32 9, metadata !9, metadata !105}
...
!124 = metadata !{i32 42, i32 5, metadata !90, null}
!125 = metadata !{i32 26, i32 9, metadata !40, metadata !105}
!126 = metadata !{i32 16, i32 9, metadata !31, metadata !104}
!127 = metadata !{i32 17, i32 9, metadata !33, metadata !104}
!128 = metadata !{i32 19, i32 14, metadata !35, metadata !104}
!129 = metadata !{i32 20, i32 9, metadata !37, metadata !104}
!130 = metadata !{i32 37, i32 5, metadata !9, metadata !105}
!131 = metadata !{i32 19, i32 14, metadata !35, metadata !88}
!132 = metadata !{i32 20, i32 9, metadata !37, metadata !88}
!133 = metadata !{i32 61, i32 1, metadata !12, null}
