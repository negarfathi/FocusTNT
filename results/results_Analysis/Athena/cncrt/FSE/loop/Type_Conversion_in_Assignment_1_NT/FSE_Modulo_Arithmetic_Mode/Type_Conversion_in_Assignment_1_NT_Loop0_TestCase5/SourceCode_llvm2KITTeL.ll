...
fgetc_wrap_around.exit3:                          ; preds = %fgetc_bb13, %fgetc_bb12, %fgetc_bb11, %fgetc_wrap_around.exit
  %c.0 = phi i64 [ -512, %fgetc_wrap_around.exit ], [ %"32", %fgetc_bb11 ], [ %"37", %fgetc_bb13 ], [ %"27", %fgetc_bb12 ]
...
main_bb15:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"42"}, i64 0, metadata !103), !dbg !106
  ...
  call void @llvm.dbg.value(metadata !115, i64 0, metadata !116), !dbg !118
  ...
  call void @llvm.dbg.value(metadata !92, i64 0, metadata !125), !dbg !127
  ...
  call void @llvm.dbg.value(metadata !92, i64 0, metadata !113), !dbg !114
  br label %main_bb16, !dbg !134

main_bb16:                                        ; preds = %main_NewDefault, %main_bb15
  %"39" = load i64* @"'flag", align 8, !dbg !135
  %"40" = icmp sgt i64 %"39", 1000, !dbg !135
  br i1 %"40", label %main_fgetc.exit, label %main_bb17, !dbg !135

main_bb17:                                        ; preds = %main_bb16
  %"41" = load i64* @"'flag", align 8, !dbg !104
  %"42" = add nsw i64 %"41", 1, !dbg !104
  %"43" = icmp sgt i64 %"42", 2147483647, !dbg !136
  br i1 %"43", label %main_bb18, label %main_bb19, !dbg !136

main_bb18:                                        ; preds = %main_bb17
  %"44" = sub nsw i64 %"42", 2147483647, !dbg !137
  %"45" = sub nsw i64 %"44", 1, !dbg !137
  %"46" = srem i64 %"45", 4294967296, !dbg !137
  %"47" = add nsw i64 -2147483648, %"46", !dbg !137
  br label %main_wrap_around.exit.i, !dbg !137

main_bb19:                                        ; preds = %main_bb17
  %"48" = icmp slt i64 %"42", -2147483648, !dbg !138
  br i1 %"48", label %main_bb20, label %main_wrap_around.exit.i, !dbg !138

main_bb20:                                        ; preds = %main_bb19
  %"49" = sub nsw i64 -2147483648, %"42", !dbg !139
  %"50" = sub nsw i64 %"49", 1, !dbg !139
  %"51" = srem i64 %"50", 4294967296, !dbg !139
  %"52" = sub nsw i64 2147483647, %"51", !dbg !139
  br label %main_wrap_around.exit.i, !dbg !139

main_wrap_around.exit.i:                          ; preds = %main_bb20, %main_bb19, %main_bb18
  %.0.i.i = phi i64 [ %"47", %main_bb18 ], [ %"52", %main_bb20 ], [ %"42", %main_bb19 ], !dbg !104
  store i64 %.0.i.i, i64* @"'flag", align 8, !dbg !104
  br label %main_fgetc.exit, !dbg !140

main_fgetc.exit:                                  ; preds = %main_bb16, %main_wrap_around.exit.i
  %.0.i = phi i64 [ 0, %main_wrap_around.exit.i ], [ -1, %main_bb16 ], !dbg !105
  %"53" = icmp slt i64 %.0.i, 0, !dbg !141
  br i1 %"53", label %main_bb21, label %main_wrap_around.exit, !dbg !141

main_bb21:                                        ; preds = %main_fgetc.exit
  %"54" = sub nsw i64 0, %.0.i, !dbg !142
  %"55" = sub nsw i64 %"54", 1, !dbg !142
  %"56" = srem i64 %"55", 256, !dbg !142
  %"57" = sub nsw i64 255, %"56", !dbg !142
...
!115 = metadata !{i64 512}
!116 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777230, metadata !8, i32 0, metadata !117} ; [ DW_TAG_arg_variable ] [value] [line 14]
!117 = metadata !{i32 34, i32 13, metadata !63, metadata !105}
!118 = metadata !{i32 14, i32 33, metadata !4, metadata !117}
!119 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554446, metadata !8, i32 0, metadata !117} ; [ DW_TAG_arg_variable ] [lower_bound] [line 14]
!120 = metadata !{i32 14, i32 50, metadata !4, metadata !117}
!121 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331662, metadata !8, i32 0, metadata !117} ; [ DW_TAG_arg_variable ] [upper_bound] [line 14]
!122 = metadata !{i32 14, i32 73, metadata !4, metadata !117}
!123 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 15, metadata !8, i32 0, metadata !117} ; [ DW_TAG_auto_variable ] [range] [line 15]
!124 = metadata !{i32 15, i32 15, metadata !4, metadata !117}
!125 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777230, metadata !8, i32 0, metadata !126} ; [ DW_TAG_arg_variable ] [value] [line 14]
!126 = metadata !{i32 36, i32 9, metadata !9, metadata !105}
!127 = metadata !{i32 14, i32 33, metadata !4, metadata !126}
!128 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554446, metadata !8, i32 0, metadata !126} ; [ DW_TAG_arg_variable ] [lower_bound] [line 14]
!129 = metadata !{i32 14, i32 50, metadata !4, metadata !126}
!130 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331662, metadata !8, i32 0, metadata !126} ; [ DW_TAG_arg_variable ] [upper_bound] [line 14]
!131 = metadata !{i32 14, i32 73, metadata !4, metadata !126}
!132 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 15, metadata !8, i32 0, metadata !126} ; [ DW_TAG_auto_variable ] [range] [line 15]
!133 = metadata !{i32 15, i32 15, metadata !4, metadata !126}
!134 = metadata !{i32 42, i32 5, metadata !90, null}
!135 = metadata !{i32 26, i32 9, metadata !40, metadata !105}
!136 = metadata !{i32 16, i32 9, metadata !31, metadata !104}
!137 = metadata !{i32 17, i32 9, metadata !33, metadata !104}
!138 = metadata !{i32 19, i32 14, metadata !35, metadata !104}
!139 = metadata !{i32 20, i32 9, metadata !37, metadata !104}
!140 = metadata !{i32 37, i32 5, metadata !9, metadata !105}
!141 = metadata !{i32 19, i32 14, metadata !35, metadata !88}
!142 = metadata !{i32 20, i32 9, metadata !37, metadata !88}
!143 = metadata !{i32 61, i32 1, metadata !12, null}
