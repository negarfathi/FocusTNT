...
define i32 @main() #0 {
main_bb5:
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !72), !dbg !73
  %"27" = icmp sle i32 2, 0, !dbg !74
  %"28" = icmp sgt i32 2, 65534, !dbg !76
  %or.cond = or i1 %"27", %"28", !dbg !74
  br i1 %or.cond, label %main_bb11, label %main_bb6, !dbg !74

main_bb6:                                         ; preds = %main_bb5
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !78), !dbg !80
  call void @llvm.dbg.value(metadata !35, i64 0, metadata !81), !dbg !83
  %"29" = load i32* @"'memory0_freeIndex", align 4, !dbg !84
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !85), !dbg !86
  %"30" = load i32* @"'memory0_freeIndex", align 4, !dbg !87
  %"31" = add nsw i32 %"30", 4, !dbg !87
  store i32 %"31", i32* @"'memory0_freeIndex", align 4, !dbg !87
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !88), !dbg !89
  %"32" = sext i32 %"29" to i64, !dbg !90
  %"33" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"32", !dbg !90
  %"34" = getelementptr inbounds %struct.NNode* %"33", i32 0, i32 0, !dbg !90
  store i32 %"29", i32* %"34", align 4, !dbg !90
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !91), !dbg !92
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !93), !dbg !94
  call void @llvm.dbg.value(metadata !35, i64 0, metadata !95), !dbg !97
  br label %main_bb7, !dbg !98

main_bb7:                                         ; preds = %main_bb8, %main_bb6
  %i.0.i = phi i32 [ 2, %main_bb6 ], [ %"49", %main_bb8 ], !dbg !79
  %cyclic.0.i = phi i32 [ %"29", %main_bb6 ], [ %"48", %main_bb8 ], !dbg !79
  %"35" = icmp sle i32 %i.0.i, 2, !dbg !99
  br i1 %"35", label %main_bb8, label %main_initLink.exit, !dbg !99

main_bb8:                                         ; preds = %main_bb7
  %"36" = load i32* @"'memory0_freeIndex", align 4, !dbg !100
  %"37" = load i32* @"'memory0_freeIndex", align 4, !dbg !101
  %"38" = add nsw i32 %"37", 4, !dbg !101
  store i32 %"38", i32* @"'memory0_freeIndex", align 4, !dbg !101
  %"39" = sext i32 %"36" to i64, !dbg !102
  %"40" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"39", !dbg !102
  %"41" = getelementptr inbounds %struct.NNode* %"40", i32 0, i32 0, !dbg !102
  store i32 %"36", i32* %"41", align 4, !dbg !102
  %"42" = sext i32 %cyclic.0.i to i64, !dbg !103
  %"43" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"42", !dbg !103
  %"44" = getelementptr inbounds %struct.NNode* %"43", i32 0, i32 0, !dbg !103
  store i32 %"36", i32* %"44", align 4, !dbg !103
  %"45" = sext i32 %cyclic.0.i to i64, !dbg !104
  %"46" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"45", !dbg !104
  %"47" = getelementptr inbounds %struct.NNode* %"46", i32 0, i32 0, !dbg !104
  %"48" = load i32* %"47", align 4, !dbg !104
  %"49" = add nsw i32 %i.0.i, 1, !dbg !105
  br label %main_bb7, !dbg !105

main_initLink.exit:                               ; preds = %main_bb7
  %"50" = sext i32 %cyclic.0.i to i64, !dbg !106
  %"51" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"50", !dbg !106
  %"52" = getelementptr inbounds %struct.NNode* %"51", i32 0, i32 0, !dbg !106
  store i32 %cyclic.0.i, i32* %"52", align 4, !dbg !106
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !107), !dbg !108
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !109), !dbg !110
  call void @llvm.dbg.value(metadata !{i32 %"57"}, i64 0, metadata !111), !dbg !113
  call void @llvm.dbg.value(metadata !{i32 %"57"}, i64 0, metadata !109), !dbg !110
  br label %main_bb9, !dbg !114

main_bb9:                                         ; preds = %main_bb10, %main_initLink.exit
  %ip.0 = phi i32 [ %"29", %main_initLink.exit ], [ %"57", %main_bb10 ]
  %"53" = icmp ne i32 %ip.0, 0, !dbg !115
  br i1 %"53", label %main_bb10, label %main_bb11, !dbg !115

main_bb10:                                        ; preds = %main_bb9
  %"54" = sext i32 %ip.0 to i64, !dbg !117
  %"55" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"54", !dbg !117
  %"56" = getelementptr inbounds %struct.NNode* %"55", i32 0, i32 0, !dbg !117
  %"57" = load i32* %"56", align 4, !dbg !117
  %"58" = icmp eq i32 %ip.0, %"57", !dbg !118
  br i1 %"58", label %main_bb11, label %main_bb9, !dbg !118

main_bb11:                                        ; preds = %main_bb9, %main_bb10, %main_bb5
  ret i32 0, !dbg !120
}
...
!62 = metadata !{i32 786443, metadata !1, metadata !63, i32 29, i32 10, i32 2, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 786443, metadata !1, metadata !54, i32 29, i32 10, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!72 = metadata !{i32 786688, metadata !10, metadata !"num", metadata !5, i32 41, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num] [line 41]
!73 = metadata !{i32 41, i32 9, metadata !10, null}
!74 = metadata !{i32 42, i32 9, metadata !75, null}
!75 = metadata !{i32 786443, metadata !1, metadata !10, i32 42, i32 9, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 42, i32 9, metadata !77, null}
!77 = metadata !{i32 786443, metadata !1, metadata !75, i32 42, i32 9, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!78 = metadata !{i32 786689, metadata !9, metadata !"n", metadata !5, i32 16777239, metadata !8, i32 0, metadata !79} ; [ DW_TAG_arg_variable ] [n] [line 23]
!79 = metadata !{i32 44, i32 16, metadata !10, null}
!80 = metadata !{i32 23, i32 18, metadata !9, metadata !79}
!81 = metadata !{i32 786689, metadata !4, metadata !"size", metadata !5, i32 16777233, metadata !8, i32 0, metadata !82} ; [ DW_TAG_arg_variable ] [size] [line 17]
!82 = metadata !{i32 24, i32 16, metadata !9, metadata !79}
!83 = metadata !{i32 17, i32 26, metadata !4, metadata !82}
!84 = metadata !{i32 18, i32 4, metadata !4, metadata !82}
!85 = metadata !{i32 786688, metadata !4, metadata !"allocatedIndex", metadata !5, i32 18, metadata !8, i32 0, metadata !82} ; [ DW_TAG_auto_variable ] [allocatedIndex] [line 18]
!86 = metadata !{i32 18, i32 8, metadata !4, metadata !82}
!87 = metadata !{i32 19, i32 4, metadata !4, metadata !82}
!88 = metadata !{i32 786688, metadata !9, metadata !"head", metadata !5, i32 24, metadata !8, i32 0, metadata !79} ; [ DW_TAG_auto_variable ] [head] [line 24]
!89 = metadata !{i32 24, i32 9, metadata !9, metadata !79}
!90 = metadata !{i32 25, i32 5, metadata !9, metadata !79}
!91 = metadata !{i32 786688, metadata !9, metadata !"cyclic", metadata !5, i32 26, metadata !8, i32 0, metadata !79} ; [ DW_TAG_auto_variable ] [cyclic] [line 26]
!92 = metadata !{i32 26, i32 9, metadata !9, metadata !79}
!93 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 28, metadata !8, i32 0, metadata !79} ; [ DW_TAG_auto_variable ] [i] [line 28]
!94 = metadata !{i32 28, i32 9, metadata !9, metadata !79}
!95 = metadata !{i32 786689, metadata !4, metadata !"size", metadata !5, i32 16777233, metadata !8, i32 0, metadata !96} ; [ DW_TAG_arg_variable ] [size] [line 17]
!96 = metadata !{i32 30, i32 20, metadata !53, metadata !79}
!97 = metadata !{i32 17, i32 26, metadata !4, metadata !96}
!98 = metadata !{i32 29, i32 10, metadata !54, metadata !79}
!99 = metadata !{i32 29, i32 10, metadata !62, metadata !79}
!100 = metadata !{i32 18, i32 4, metadata !4, metadata !96}
!101 = metadata !{i32 19, i32 4, metadata !4, metadata !96}
!102 = metadata !{i32 31, i32 9, metadata !53, metadata !79}
!103 = metadata !{i32 32, i32 9, metadata !53, metadata !79}
!104 = metadata !{i32 33, i32 9, metadata !53, metadata !79}
!105 = metadata !{i32 29, i32 21, metadata !54, metadata !79}
!106 = metadata !{i32 35, i32 5, metadata !9, metadata !79}
!107 = metadata !{i32 786688, metadata !10, metadata !"list", metadata !5, i32 44, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [list] [line 44]
!108 = metadata !{i32 44, i32 9, metadata !10, null}
!109 = metadata !{i32 786688, metadata !10, metadata !"ip", metadata !5, i32 45, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ip] [line 45]
!110 = metadata !{i32 45, i32 9, metadata !10, null}
!111 = metadata !{i32 786688, metadata !112, metadata !"nxt", metadata !5, i32 48, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [nxt] [line 48]
!112 = metadata !{i32 786443, metadata !1, metadata !10, i32 47, i32 5, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!113 = metadata !{i32 48, i32 13, metadata !112, null}
!114 = metadata !{i32 46, i32 5, metadata !10, null}
!115 = metadata !{i32 46, i32 5, metadata !116, null}
!116 = metadata !{i32 786443, metadata !1, metadata !10, i32 46, i32 5, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!117 = metadata !{i32 48, i32 9, metadata !112, null}
!118 = metadata !{i32 49, i32 13, metadata !119, null}
!119 = metadata !{i32 786443, metadata !1, metadata !112, i32 49, i32 13, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!120 = metadata !{i32 54, i32 1, metadata !10, null}
