...
main_bb5:
  ...
  %"27" = icmp sle i32 100000, 0, !dbg !75
  %"28" = icmp sgt i32 100000, 65534, !dbg !77
  %or.cond = or i1 %"27", %"28", !dbg !75
  br i1 %or.cond, label %main_bb11, label %main_bb6, !dbg !75

main_bb6:                                         ; preds = %main_bb5
  call void @llvm.dbg.value(metadata !72, i64 0, metadata !79), !dbg !81
  call void @llvm.dbg.value(metadata !35, i64 0, metadata !82), !dbg !84
  %"29" = load i32* @"'memory0_freeIndex", align 4, !dbg !85
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !86), !dbg !87
  %"30" = load i32* @"'memory0_freeIndex", align 4, !dbg !88
  %"31" = add nsw i32 %"30", 4, !dbg !88
  store i32 %"31", i32* @"'memory0_freeIndex", align 4, !dbg !88
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !89), !dbg !90
  %"32" = sext i32 %"29" to i64, !dbg !91
  %"33" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"32", !dbg !91
  %"34" = getelementptr inbounds %struct.NNode* %"33", i32 0, i32 0, !dbg !91
  store i32 %"29", i32* %"34", align 4, !dbg !91
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !92), !dbg !93
...
main_bb7:                                         ; preds = %main_bb8, %main_bb6
  %i.0.i = phi i32 [ 2, %main_bb6 ], [ %"49", %main_bb8 ], !dbg !80
  %cyclic.0.i = phi i32 [ %"29", %main_bb6 ], [ %"48", %main_bb8 ], !dbg !80
  %"35" = icmp sle i32 %i.0.i, 100000, !dbg !100
  br i1 %"35", label %main_bb8, label %main_initLink.exit, !dbg !100

main_bb8:                                         ; preds = %main_bb7
  %"36" = load i32* @"'memory0_freeIndex", align 4, !dbg !101
  %"37" = load i32* @"'memory0_freeIndex", align 4, !dbg !102
  %"38" = add nsw i32 %"37", 4, !dbg !102
  store i32 %"38", i32* @"'memory0_freeIndex", align 4, !dbg !102
  %"39" = sext i32 %"36" to i64, !dbg !103
  %"40" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"39", !dbg !103
  %"41" = getelementptr inbounds %struct.NNode* %"40", i32 0, i32 0, !dbg !103
  store i32 %"36", i32* %"41", align 4, !dbg !103
  %"42" = sext i32 %cyclic.0.i to i64, !dbg !104
  %"43" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"42", !dbg !104
  %"44" = getelementptr inbounds %struct.NNode* %"43", i32 0, i32 0, !dbg !104
  store i32 %"36", i32* %"44", align 4, !dbg !104
  %"45" = sext i32 %cyclic.0.i to i64, !dbg !105
  %"46" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"45", !dbg !105
  %"47" = getelementptr inbounds %struct.NNode* %"46", i32 0, i32 0, !dbg !105
  %"48" = load i32* %"47", align 4, !dbg !105
  %"49" = add nsw i32 %i.0.i, 1, !dbg !106
  br label %main_bb7, !dbg !106

main_initLink.exit:                               ; preds = %main_bb7
  %"50" = sext i32 %cyclic.0.i to i64, !dbg !107
  %"51" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"50", !dbg !107
  %"52" = getelementptr inbounds %struct.NNode* %"51", i32 0, i32 0, !dbg !107
  store i32 %cyclic.0.i, i32* %"52", align 4, !dbg !107
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !108), !dbg !109
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !110), !dbg !111
  call void @llvm.dbg.value(metadata !{i32 %"57"}, i64 0, metadata !112), !dbg !114
  call void @llvm.dbg.value(metadata !{i32 %"57"}, i64 0, metadata !110), !dbg !111
  br label %main_bb9, !dbg !115

main_bb9:                                         ; preds = %main_bb10, %main_initLink.exit
  %ip.0 = phi i32 [ %"29", %main_initLink.exit ], [ %"57", %main_bb10 ]
  %"53" = icmp ne i32 %ip.0, 0, !dbg !116
  br i1 %"53", label %main_bb10, label %main_bb11, !dbg !116

main_bb10:                                        ; preds = %main_bb9
  %"54" = sext i32 %ip.0 to i64, !dbg !118
  %"55" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"54", !dbg !118
  %"56" = getelementptr inbounds %struct.NNode* %"55", i32 0, i32 0, !dbg !118
  %"57" = load i32* %"56", align 4, !dbg !118
  %"58" = icmp eq i32 %ip.0, %"57", !dbg !119
  br i1 %"58", label %main_bb11, label %main_bb9, !dbg !119
...
!78 = metadata !{i32 786443, metadata !1, metadata !76, i32 42, i32 9, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!117 = metadata !{i32 786443, metadata !1, metadata !10, i32 46, i32 5, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!118 = metadata !{i32 48, i32 9, metadata !113, null}
!119 = metadata !{i32 49, i32 13, metadata !120, null}
!120 = metadata !{i32 786443, metadata !1, metadata !113, i32 49, i32 13, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!121 = metadata !{i32 54, i32 1, metadata !10, null}
