...
define i32 @main() #0 {
main_bb12:
  call void @llvm.dbg.value(metadata !72, i64 0, metadata !111), !dbg !112
  %"49" = icmp sle i64 2, 0, !dbg !113
  %"50" = icmp sgt i64 2, 65534, !dbg !115
  %or.cond = or i1 %"49", %"50", !dbg !113
  br i1 %or.cond, label %main_bb20, label %main_bb13, !dbg !113

main_bb13:                                        ; preds = %main_bb12
  call void @llvm.dbg.value(metadata !72, i64 0, metadata !117), !dbg !119
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !120), !dbg !122
  %"51" = load i32* @"'memory0_freeIndex", align 4, !dbg !123
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !124), !dbg !125
  %"52" = load i32* @"'memory0_freeIndex", align 4, !dbg !126
  %"53" = add nsw i32 %"52", 4, !dbg !126
  store i32 %"53", i32* @"'memory0_freeIndex", align 4, !dbg !126
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !127), !dbg !128
  %"54" = sext i32 %"51" to i64, !dbg !129
  %"55" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"54", !dbg !129
  %"56" = getelementptr inbounds %struct.NNode* %"55", i32 0, i32 0, !dbg !129
  store i32 %"51", i32* %"56", align 4, !dbg !129
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !130), !dbg !131
  call void @llvm.dbg.value(metadata !72, i64 0, metadata !132), !dbg !133
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !134), !dbg !136
  call void @llvm.dbg.value(metadata !87, i64 0, metadata !137), !dbg !139
  call void @llvm.dbg.value(metadata !90, i64 0, metadata !140), !dbg !141
  call void @llvm.dbg.value(metadata !93, i64 0, metadata !142), !dbg !143
  br label %main_wrap_around.exit.i, !dbg !144

main_wrap_around.exit.i:                          ; preds = %main_bb17, %main_bb16, %main_bb15, %main_bb13
  %i.0.i = phi i64 [ 2, %main_bb13 ], [ %"76", %main_bb15 ], [ %"81", %main_bb17 ], [ %"71", %main_bb16 ], !dbg !118
  %cyclic.0.i = phi i32 [ %"51", %main_bb13 ], [ %"70", %main_bb15 ], [ %"70", %main_bb16 ], [ %"70", %main_bb17 ], !dbg !118
  %"57" = icmp sle i64 %i.0.i, 2, !dbg !145
  br i1 %"57", label %main_bb14, label %main_initLink.exit, !dbg !145

main_bb14:                                        ; preds = %main_wrap_around.exit.i
  %"58" = load i32* @"'memory0_freeIndex", align 4, !dbg !146
  %"59" = load i32* @"'memory0_freeIndex", align 4, !dbg !147
  %"60" = add nsw i32 %"59", 4, !dbg !147
  store i32 %"60", i32* @"'memory0_freeIndex", align 4, !dbg !147
  %"61" = sext i32 %"58" to i64, !dbg !148
  %"62" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"61", !dbg !148
  %"63" = getelementptr inbounds %struct.NNode* %"62", i32 0, i32 0, !dbg !148
  store i32 %"58", i32* %"63", align 4, !dbg !148
  %"64" = sext i32 %cyclic.0.i to i64, !dbg !149
  %"65" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"64", !dbg !149
  %"66" = getelementptr inbounds %struct.NNode* %"65", i32 0, i32 0, !dbg !149
  store i32 %"58", i32* %"66", align 4, !dbg !149
  %"67" = sext i32 %cyclic.0.i to i64, !dbg !150
  %"68" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"67", !dbg !150
  %"69" = getelementptr inbounds %struct.NNode* %"68", i32 0, i32 0, !dbg !150
  %"70" = load i32* %"69", align 4, !dbg !150
  %"71" = add nsw i64 %i.0.i, 1, !dbg !138
  %"72" = icmp sgt i64 %"71", 2147483647, !dbg !151
  br i1 %"72", label %main_bb15, label %main_bb16, !dbg !151

main_bb15:                                        ; preds = %main_bb14
  %"73" = sub nsw i64 %"71", 2147483647, !dbg !152
  %"74" = sub nsw i64 %"73", 1, !dbg !152
  %"75" = srem i64 %"74", 4294967296, !dbg !152
  %"76" = add nsw i64 -2147483648, %"75", !dbg !152
  br label %main_wrap_around.exit.i, !dbg !152

main_bb16:                                        ; preds = %main_bb14
  %"77" = icmp slt i64 %"71", -2147483648, !dbg !153
  br i1 %"77", label %main_bb17, label %main_wrap_around.exit.i, !dbg !153

main_bb17:                                        ; preds = %main_bb16
  %"78" = sub nsw i64 -2147483648, %"71", !dbg !154
  %"79" = sub nsw i64 %"78", 1, !dbg !154
  %"80" = srem i64 %"79", 4294967296, !dbg !154
  %"81" = sub nsw i64 2147483647, %"80", !dbg !154
  br label %main_wrap_around.exit.i, !dbg !154

main_initLink.exit:                               ; preds = %main_wrap_around.exit.i
  %"82" = sext i32 %cyclic.0.i to i64, !dbg !155
  %"83" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"82", !dbg !155
  %"84" = getelementptr inbounds %struct.NNode* %"83", i32 0, i32 0, !dbg !155
  store i32 %cyclic.0.i, i32* %"84", align 4, !dbg !155
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !156), !dbg !157
  call void @llvm.dbg.value(metadata !{i32 %"51"}, i64 0, metadata !158), !dbg !159
  call void @llvm.dbg.value(metadata !{i32 %"89"}, i64 0, metadata !160), !dbg !162
  call void @llvm.dbg.value(metadata !{i32 %"89"}, i64 0, metadata !158), !dbg !159
  br label %main_bb18, !dbg !163

main_bb18:                                        ; preds = %main_bb19, %main_initLink.exit
  %ip.0 = phi i32 [ %"51", %main_initLink.exit ], [ %"89", %main_bb19 ]
  %"85" = icmp ne i32 %ip.0, 0, !dbg !164
  br i1 %"85", label %main_bb19, label %main_bb20, !dbg !164

main_bb19:                                        ; preds = %main_bb18
  %"86" = sext i32 %ip.0 to i64, !dbg !166
  %"87" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"86", !dbg !166
  %"88" = getelementptr inbounds %struct.NNode* %"87", i32 0, i32 0, !dbg !166
  %"89" = load i32* %"88", align 4, !dbg !166
  %"90" = icmp eq i32 %ip.0, %"89", !dbg !167
  br i1 %"90", label %main_bb20, label %main_bb18, !dbg !167

main_bb20:                                        ; preds = %main_bb18, %main_bb19, %main_bb12
  ret i32 0, !dbg !169
}
...
!98 = metadata !{i32 786443, metadata !1, metadata !99, i32 41, i32 10, i32 2, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!99 = metadata !{i32 786443, metadata !1, metadata !78, i32 41, i32 10, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!111 = metadata !{i32 786688, metadata !16, metadata !"num", metadata !5, i32 53, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num] [line 53]
!112 = metadata !{i32 53, i32 15, metadata !16, null}
!113 = metadata !{i32 54, i32 9, metadata !114, null}
!114 = metadata !{i32 786443, metadata !1, metadata !16, i32 54, i32 9, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!115 = metadata !{i32 54, i32 9, metadata !116, null}
!116 = metadata !{i32 786443, metadata !1, metadata !114, i32 54, i32 9, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!117 = metadata !{i32 786689, metadata !13, metadata !"n", metadata !5, i32 16777251, metadata !8, i32 0, metadata !118} ; [ DW_TAG_arg_variable ] [n] [line 35]
!118 = metadata !{i32 58, i32 16, metadata !16, null} ; [ DW_TAG_imported_module ]
!119 = metadata !{i32 35, i32 24, metadata !13, metadata !118}
!120 = metadata !{i32 786689, metadata !9, metadata !"size", metadata !5, i32 16777245, metadata !12, i32 0, metadata !121} ; [ DW_TAG_arg_variable ] [size] [line 29]
!121 = metadata !{i32 36, i32 16, metadata !13, metadata !118}
!122 = metadata !{i32 29, i32 26, metadata !9, metadata !121}
!123 = metadata !{i32 30, i32 4, metadata !9, metadata !121}
!124 = metadata !{i32 786688, metadata !9, metadata !"allocatedIndex", metadata !5, i32 30, metadata !12, i32 0, metadata !121} ; [ DW_TAG_auto_variable ] [allocatedIndex] [line 30]
!125 = metadata !{i32 30, i32 8, metadata !9, metadata !121}
!126 = metadata !{i32 31, i32 4, metadata !9, metadata !121}
!127 = metadata !{i32 786688, metadata !13, metadata !"head", metadata !5, i32 36, metadata !12, i32 0, metadata !118} ; [ DW_TAG_auto_variable ] [head] [line 36]
!128 = metadata !{i32 36, i32 9, metadata !13, metadata !118}
!129 = metadata !{i32 37, i32 5, metadata !13, metadata !118}
!130 = metadata !{i32 786688, metadata !13, metadata !"cyclic", metadata !5, i32 38, metadata !12, i32 0, metadata !118} ; [ DW_TAG_auto_variable ] [cyclic] [line 38]
!131 = metadata !{i32 38, i32 9, metadata !13, metadata !118}
!132 = metadata !{i32 786688, metadata !13, metadata !"i", metadata !5, i32 40, metadata !8, i32 0, metadata !118} ; [ DW_TAG_auto_variable ] [i] [line 40]
!133 = metadata !{i32 40, i32 15, metadata !13, metadata !118}
!134 = metadata !{i32 786689, metadata !9, metadata !"size", metadata !5, i32 16777245, metadata !12, i32 0, metadata !135} ; [ DW_TAG_arg_variable ] [size] [line 29]
!135 = metadata !{i32 42, i32 20, metadata !77, metadata !118}
!136 = metadata !{i32 29, i32 26, metadata !9, metadata !135}
!137 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554451, metadata !8, i32 0, metadata !138} ; [ DW_TAG_arg_variable ] [lower_bound] [line 19]
!138 = metadata !{i32 41, i32 26, metadata !78, metadata !118}
!139 = metadata !{i32 19, i32 50, metadata !4, metadata !138}
!140 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331667, metadata !8, i32 0, metadata !138} ; [ DW_TAG_arg_variable ] [upper_bound] [line 19]
!141 = metadata !{i32 19, i32 73, metadata !4, metadata !138}
!142 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 20, metadata !8, i32 0, metadata !138} ; [ DW_TAG_auto_variable ] [range] [line 20]
!143 = metadata !{i32 20, i32 15, metadata !4, metadata !138}
!144 = metadata !{i32 41, i32 10, metadata !78, metadata !118}
!145 = metadata !{i32 41, i32 10, metadata !98, metadata !118}
!146 = metadata !{i32 30, i32 4, metadata !9, metadata !135}
!147 = metadata !{i32 31, i32 4, metadata !9, metadata !135}
!148 = metadata !{i32 43, i32 9, metadata !77, metadata !118}
!149 = metadata !{i32 44, i32 9, metadata !77, metadata !118}
!150 = metadata !{i32 45, i32 9, metadata !77, metadata !118}
!151 = metadata !{i32 21, i32 9, metadata !42, metadata !138}
!152 = metadata !{i32 22, i32 9, metadata !44, metadata !138}
!153 = metadata !{i32 24, i32 14, metadata !46, metadata !138}
!154 = metadata !{i32 25, i32 9, metadata !48, metadata !138}
!155 = metadata !{i32 47, i32 5, metadata !13, metadata !118}
!156 = metadata !{i32 786688, metadata !16, metadata !"list", metadata !5, i32 58, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [list] [line 58]
!157 = metadata !{i32 58, i32 9, metadata !16, null} ; [ DW_TAG_imported_module ]
!158 = metadata !{i32 786688, metadata !16, metadata !"ip", metadata !5, i32 59, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ip] [line 59]
!159 = metadata !{i32 59, i32 9, metadata !16, null}
!160 = metadata !{i32 786688, metadata !161, metadata !"nxt", metadata !5, i32 62, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [nxt] [line 62]
!161 = metadata !{i32 786443, metadata !1, metadata !16, i32 61, i32 5, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!162 = metadata !{i32 62, i32 13, metadata !161, null}
!163 = metadata !{i32 60, i32 5, metadata !16, null}
!164 = metadata !{i32 60, i32 5, metadata !165, null}
!165 = metadata !{i32 786443, metadata !1, metadata !16, i32 60, i32 5, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!166 = metadata !{i32 62, i32 9, metadata !161, null}
!167 = metadata !{i32 63, i32 13, metadata !168, null}
!168 = metadata !{i32 786443, metadata !1, metadata !161, i32 63, i32 13, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!169 = metadata !{i32 70, i32 1, metadata !16, null}
