...
main_bb7:
  ...
  br i1 %"10", label %main_bb13, label %main_bb8, !dbg !49
...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %"17"}, i64 0, metadata !53), !dbg !54
  call void @llvm.dbg.value(metadata !{i32 %"19"}, i64 0, metadata !47), !dbg !48
  call void @llvm.dbg.value(metadata !{i32 %"20"}, i64 0, metadata !51), !dbg !52
  br label %main_bb9, !dbg !66

main_bb9:                                         ; preds = %main_bb11, %main_bb12, %main_bb8
  %tries.0 = phi i32 [ 0, %main_bb8 ], [ %tries.0, %main_bb12 ], [ %"17", %main_bb11 ]
  %buf.0 = phi i32 [ 0, %main_bb8 ], [ %"20", %main_bb12 ], [ %buf.0, %main_bb11 ]
  %count.0 = phi i32 [ 5, %main_bb8 ], [ %"19", %main_bb12 ], [ %count.0, %main_bb11 ]
  %"12" = icmp sgt i32 %count.0, 0, !dbg !67
  br i1 %"12", label %main_read.exit, label %main_bb13, !dbg !67

main_read.exit:                                   ; preds = %main_bb9
  %"13" = icmp ne i32 %"11", 1, !dbg !63
  %"14" = icmp slt i32 %buf.0, %count.0, !dbg !69
  %or.cond = and i1 %"13", %"14", !dbg !63
  %.0.i = select i1 %or.cond, i32 -1, i32 0, !dbg !63
  %"15" = icmp sle i32 %.0.i, 0, !dbg !70
  br i1 %"15", label %main_bb10, label %main_bb12, !dbg !70

main_bb10:                                        ; preds = %main_read.exit
  %"16" = icmp eq i32 %.0.i, 0, !dbg !72
  br i1 %"16", label %main_bb11, label %main_bb13, !dbg !72

main_bb11:                                        ; preds = %main_bb10
  %"17" = add nsw i32 %tries.0, 1, !dbg !75
  %"18" = icmp slt i32 %tries.0, 5, !dbg !75
  br i1 %"18", label %main_bb9, label %main_bb13, !dbg !75

main_bb12:                                        ; preds = %main_read.exit
  %"19" = sub nsw i32 %count.0, %.0.i, !dbg !77
  %"20" = add nsw i32 %buf.0, %.0.i, !dbg !78
  br label %main_bb9, !dbg !79

main_bb13:                                        ; preds = %main_bb9, %main_bb10, %main_bb11, %main_bb7
  ret i32 0, !dbg !80
}
...
!70 = metadata !{i32 53, i32 13, metadata !71, null}
!71 = metadata !{i32 786443, metadata !1, metadata !57, i32 53, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!72 = metadata !{i32 55, i32 17, metadata !73, null}
!73 = metadata !{i32 786443, metadata !1, metadata !74, i32 55, i32 17, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!74 = metadata !{i32 786443, metadata !1, metadata !71, i32 54, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!75 = metadata !{i32 55, i32 17, metadata !76, null}
!76 = metadata !{i32 786443, metadata !1, metadata !73, i32 55, i32 17, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!77 = metadata !{i32 59, i32 9, metadata !57, null}
!78 = metadata !{i32 60, i32 9, metadata !57, null}
!79 = metadata !{i32 61, i32 5, metadata !57, null}
!80 = metadata !{i32 63, i32 1, metadata !9, null}
