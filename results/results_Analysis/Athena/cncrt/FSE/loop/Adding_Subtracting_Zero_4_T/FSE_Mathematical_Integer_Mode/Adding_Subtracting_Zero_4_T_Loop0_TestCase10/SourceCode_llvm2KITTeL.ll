...
read_bb2:                                         ; preds = %read_bb1
  %"3" = icmp eq i32 -1995, 0, !dbg !28
  br i1 %"3", label %read_bb6, label %read_bb3, !dbg !28

read_bb3:                                         ; preds = %read_bb2
  %"4" = icmp slt i32 -1995, 0, !dbg !31
  %"5" = sub nsw i32 0, -1995, !dbg !34
  %. = select i1 %"4", i32 %"5", i32 -1995, !dbg !31
...
main_bb8:                                         ; preds = %main_bb12, %main_bb7, %main_bb13
  ...
  %count.0 = phi i32 [ %"19", %main_bb13 ], [ 995, %main_bb7 ], [ %count.0, %main_bb12 ]
  %"11" = icmp sgt i32 %count.0, 0, !dbg !51
  br i1 %"11", label %main_bb9, label %main_bb14, !dbg !51
...
main_read.exit:                                   ; preds = %main_bb9, %main_bb10
  ...
  %"15" = icmp sle i32 %.0.i, 0, !dbg !59
  br i1 %"15", label %main_bb11, label %main_bb13, !dbg !59

main_bb11:                                        ; preds = %main_read.exit
  %"16" = icmp eq i32 %.0.i, 0, !dbg !61
  br i1 %"16", label %main_bb12, label %main_bb14, !dbg !61

main_bb12:                                        ; preds = %main_bb11
  %"17" = add nsw i32 %tries.0, 1, !dbg !64
  %"18" = icmp slt i32 %tries.0, 5, !dbg !64
  br i1 %"18", label %main_bb8, label %main_bb14, !dbg !64

main_bb13:                                        ; preds = %main_read.exit
  %"19" = sub nsw i32 %count.0, %.0.i, !dbg !66
  %"20" = add nsw i32 %buf.0, %.0.i, !dbg !67
...
!51 = metadata !{i32 50, i32 5, metadata !52, null}
!52 = metadata !{i32 786443, metadata !1, metadata !9, i32 50, i32 5, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!53 = metadata !{i32 13, i32 9, metadata !25, metadata !54}
!54 = metadata !{i32 52, i32 15, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !9, i32 51, i32 5, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!60 = metadata !{i32 786443, metadata !1, metadata !55, i32 53, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 55, i32 17, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !63, i32 55, i32 17, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 786443, metadata !1, metadata !60, i32 54, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 55, i32 17, metadata !65, null}
!65 = metadata !{i32 786443, metadata !1, metadata !62, i32 55, i32 17, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!66 = metadata !{i32 59, i32 9, metadata !55, null}
!67 = metadata !{i32 60, i32 9, metadata !55, null}
!68 = metadata !{i32 61, i32 5, metadata !55, null}
!69 = metadata !{i32 63, i32 1, metadata !9, null}
