...
main_bb5:                                         ; preds = %main_ffs.exit, %main_bb4
  %w.0 = phi i32 [ -2147483648, %main_bb4 ], [ %w.1, %main_ffs.exit ]
...
main_bb6:                                         ; preds = %main_bb5, %main_bb7
  ...
  br i1 %"6", label %main_bb7, label %main_ffs.exit, !dbg !41

main_bb7:                                         ; preds = %main_bb6
  %"7" = add i32 %i.0.i, 1, !dbg !42
...
main_ffs.exit:                                    ; preds = %main_bb6
  ...
  %"9" = icmp ult i32 %i.0.i, 32, !dbg !47
  %"10" = lshr i32 %w.0, %i.0.i, !dbg !49
  call void @llvm.dbg.value(metadata !{i32 %"10"}, i64 0, metadata !30), !dbg !31
  %w.1 = select i1 %"9", i32 %"10", i32 0, !dbg !47
