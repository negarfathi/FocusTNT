...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  br i1 %"27", label %main_bb12, label %main_wrap_around.exit2, !dbg !74

main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb17, %main_bb16, %main_bb15, %main_bb11
  %entry.0 = phi i64 [ 5, %main_bb11 ], [ %"37", %main_bb15 ], [ %"42", %main_bb17 ], [ %"32", %main_bb16 ], [ %entry.0, %main_bb13 ]
  %"28" = icmp sge i64 %entry.0, 1001, !dbg !76
  br i1 %"28", label %main_bb12, label %main_bb13, !dbg !76

main_bb12:                                        ; preds = %main_wrap_around.exit2, %main_bb11, %main_bb5
  ret i32 0, !dbg !80

main_bb13:                                        ; preds = %main_wrap_around.exit2
  %"29" = getelementptr inbounds [1001 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !81
  %"30" = load i64* %"29", align 8, !dbg !81
  %"31" = icmp ne i64 %"30", 0, !dbg !81
  br i1 %"31", label %main_bb14, label %main_wrap_around.exit2, !dbg !81

main_bb14:                                        ; preds = %main_bb13
  %"32" = add nsw i64 %entry.0, 1, !dbg !83
  %"33" = icmp sgt i64 %"32", 2147483647, !dbg !85
  br i1 %"33", label %main_bb15, label %main_bb16, !dbg !85

main_bb15:                                        ; preds = %main_bb14
  %"34" = sub nsw i64 %"32", 2147483647, !dbg !86
  %"35" = sub nsw i64 %"34", 1, !dbg !86
  %"36" = srem i64 %"35", 4294967296, !dbg !86
  %"37" = add nsw i64 -2147483648, %"36", !dbg !86
  br label %main_wrap_around.exit2, !dbg !86

main_bb16:                                        ; preds = %main_bb14
  %"38" = icmp slt i64 %"32", -2147483648, !dbg !87
  br i1 %"38", label %main_bb17, label %main_wrap_around.exit2, !dbg !87

main_bb17:                                        ; preds = %main_bb16
  %"39" = sub nsw i64 -2147483648, %"32", !dbg !88
  %"40" = sub nsw i64 %"39", 1, !dbg !88
  %"41" = srem i64 %"40", 4294967296, !dbg !88
  %"42" = sub nsw i64 2147483647, %"41", !dbg !88
