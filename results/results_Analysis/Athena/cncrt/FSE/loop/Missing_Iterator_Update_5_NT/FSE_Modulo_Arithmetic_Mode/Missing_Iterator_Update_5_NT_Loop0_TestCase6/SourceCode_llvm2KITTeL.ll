...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  br i1 %"32", label %main_bb12, label %main_wrap_around.exit2, !dbg !73

main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb17, %main_bb16, %main_bb15, %main_bb11
  %entry.0 = phi i64 [ 0, %main_bb11 ], [ %"42", %main_bb15 ], [ %"47", %main_bb17 ], [ %"37", %main_bb16 ], [ %entry.0, %main_bb13 ]
  %"33" = icmp sge i64 %entry.0, 5, !dbg !75
  br i1 %"33", label %main_bb12, label %main_bb13, !dbg !75
...
main_bb13:                                        ; preds = %main_wrap_around.exit2
  ...
  br i1 %"36", label %main_bb14, label %main_wrap_around.exit2, !dbg !80

main_bb14:                                        ; preds = %main_bb13
  %"37" = add nsw i64 %entry.0, 1, !dbg !82
  %"38" = icmp sgt i64 %"37", 2147483647, !dbg !84
  br i1 %"38", label %main_bb15, label %main_bb16, !dbg !84
...
main_bb16:                                        ; preds = %main_bb14
  ...
  br i1 %"43", label %main_bb17, label %main_wrap_around.exit2, !dbg !86
