...
main_bb4:                                         ; preds = %main_bb5, %main_bb3
  ...
  %"11" = icmp slt i32 %j.0, 3, !dbg !49
  br i1 %"11", label %main_bb5, label %main_bb6, !dbg !49

main_bb5:                                         ; preds = %main_bb4
  %"12" = icmp sgt i32 -8, 0, !dbg !52
  %"13" = sub nsw i32 0, -8, !dbg !54
  %. = select i1 %"12", i32 %"13", i32 -8, !dbg !52
...
main_bb7:                                         ; preds = %main_bb2, %main_bb11
  ...
  %"22" = icmp slt i32 %xmin.0, 3, !dbg !61
