...
main_bb5:
  ...
  %"12" = icmp sgt i64 65534, 65534, !dbg !40
  %"13" = icmp sgt i64 65533, 65534, !dbg !42
...
main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  ...
  %"14" = icmp slt i64 %i.0, 65534, !dbg !44
  br i1 %"14", label %main_wrap_around.exit, label %main_bb14, !dbg !44
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"15" = icmp slt i64 %i.1, 65533, !dbg !48
  %"16" = add nsw i64 %i.1, 1, !dbg !53
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !54
  br i1 %"15", label %main_bb6, label %main_bb10, !dbg !48

main_bb6:                                         ; preds = %main_wrap_around.exit
  br i1 %"17", label %main_bb7, label %main_bb8, !dbg !54

main_bb7:                                         ; preds = %main_bb6
  %"18" = sub nsw i64 %"16", 2147483647, !dbg !55
  %"19" = sub nsw i64 %"18", 1, !dbg !55
  %"20" = srem i64 %"19", 4294967296, !dbg !55
  %"21" = add nsw i64 -2147483648, %"20", !dbg !55
  br label %main_wrap_around.exit, !dbg !55

main_bb8:                                         ; preds = %main_bb6
  %"22" = icmp slt i64 %"16", -2147483648, !dbg !56
  br i1 %"22", label %main_bb9, label %main_wrap_around.exit, !dbg !56

main_bb9:                                         ; preds = %main_bb8
  %"23" = sub nsw i64 -2147483648, %"16", !dbg !57
  %"24" = sub nsw i64 %"23", 1, !dbg !57
  %"25" = srem i64 %"24", 4294967296, !dbg !57
  %"26" = sub nsw i64 2147483647, %"25", !dbg !57
  br label %main_wrap_around.exit, !dbg !57

main_bb10:                                        ; preds = %main_wrap_around.exit
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !58), !dbg !60
  ...
  br i1 %"17", label %main_bb11, label %main_bb12, !dbg !70

main_bb11:                                        ; preds = %main_bb10
  %"27" = sub nsw i64 %"16", 2147483647, !dbg !71
  %"28" = sub nsw i64 %"27", 1, !dbg !71
  %"29" = srem i64 %"28", 4294967296, !dbg !71
  %"30" = add nsw i64 -2147483648, %"29", !dbg !71
  br label %main_wrap_around.exit2, !dbg !71

main_bb12:                                        ; preds = %main_bb10
  %"31" = icmp slt i64 %"16", -2147483648, !dbg !72
  br i1 %"31", label %main_bb13, label %main_wrap_around.exit2, !dbg !72

main_bb13:                                        ; preds = %main_bb12
  %"32" = sub nsw i64 -2147483648, %"16", !dbg !73
  %"33" = sub nsw i64 %"32", 1, !dbg !73
  %"34" = srem i64 %"33", 4294967296, !dbg !73
  %"35" = sub nsw i64 2147483647, %"34", !dbg !73
...
!58 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777227, metadata !8, i32 0, metadata !59} ; [ DW_TAG_arg_variable ] [value] [line 11]
!59 = metadata !{i32 30, i32 38, metadata !47, null}
!60 = metadata !{i32 11, i32 33, metadata !4, metadata !59}
!61 = metadata !{i64 -2147483648}
!62 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554443, metadata !8, i32 0, metadata !59} ; [ DW_TAG_arg_variable ] [lower_bound] [line 11]
!63 = metadata !{i32 11, i32 50, metadata !4, metadata !59}
!64 = metadata !{i64 2147483647}
!65 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331659, metadata !8, i32 0, metadata !59} ; [ DW_TAG_arg_variable ] [upper_bound] [line 11]
!66 = metadata !{i32 11, i32 73, metadata !4, metadata !59}
!67 = metadata !{i64 4294967296}
!68 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 12, metadata !8, i32 0, metadata !59} ; [ DW_TAG_auto_variable ] [range] [line 12]
!69 = metadata !{i32 12, i32 15, metadata !4, metadata !59}
!70 = metadata !{i32 13, i32 9, metadata !26, metadata !59}
!71 = metadata !{i32 14, i32 9, metadata !28, metadata !59}
!72 = metadata !{i32 16, i32 14, metadata !30, metadata !59}
!73 = metadata !{i32 17, i32 9, metadata !32, metadata !59}
