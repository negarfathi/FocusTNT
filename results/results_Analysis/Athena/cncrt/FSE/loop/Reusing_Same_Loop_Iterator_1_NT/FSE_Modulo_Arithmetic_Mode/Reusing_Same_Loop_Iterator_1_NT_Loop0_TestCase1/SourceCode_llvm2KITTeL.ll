...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"15" = icmp slt i64 %i.1, 0, !dbg !47
  %"16" = add nsw i64 %i.1, 1, !dbg !52
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !57), !dbg !59
  ...
  br i1 %"17", label %main_bb11, label %main_bb12, !dbg !69

main_bb11:                                        ; preds = %main_bb10
  %"27" = sub nsw i64 %"16", 2147483647, !dbg !70
  %"28" = sub nsw i64 %"27", 1, !dbg !70
  %"29" = srem i64 %"28", 4294967296, !dbg !70
  %"30" = add nsw i64 -2147483648, %"29", !dbg !70
  br label %main_wrap_around.exit2, !dbg !70

main_bb12:                                        ; preds = %main_bb10
  %"31" = icmp slt i64 %"16", -2147483648, !dbg !71
  br i1 %"31", label %main_bb13, label %main_wrap_around.exit2, !dbg !71

main_bb13:                                        ; preds = %main_bb12
  %"32" = sub nsw i64 -2147483648, %"16", !dbg !72
  %"33" = sub nsw i64 %"32", 1, !dbg !72
  %"34" = srem i64 %"33", 4294967296, !dbg !72
  %"35" = sub nsw i64 2147483647, %"34", !dbg !72
...
!57 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777227, metadata !8, i32 0, metadata !58} ; [ DW_TAG_arg_variable ] [value] [line 11]
!58 = metadata !{i32 30, i32 38, metadata !46, null}
!59 = metadata !{i32 11, i32 33, metadata !4, metadata !58}
!60 = metadata !{i64 -2147483648}
!61 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554443, metadata !8, i32 0, metadata !58} ; [ DW_TAG_arg_variable ] [lower_bound] [line 11]
!62 = metadata !{i32 11, i32 50, metadata !4, metadata !58}
!63 = metadata !{i64 2147483647}
!64 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331659, metadata !8, i32 0, metadata !58} ; [ DW_TAG_arg_variable ] [upper_bound] [line 11]
!65 = metadata !{i32 11, i32 73, metadata !4, metadata !58}
!66 = metadata !{i64 4294967296}
!67 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 12, metadata !8, i32 0, metadata !58} ; [ DW_TAG_auto_variable ] [range] [line 12]
!68 = metadata !{i32 12, i32 15, metadata !4, metadata !58}
!69 = metadata !{i32 13, i32 9, metadata !26, metadata !58}
!70 = metadata !{i32 14, i32 9, metadata !28, metadata !58}
!71 = metadata !{i32 16, i32 14, metadata !30, metadata !58}
!72 = metadata !{i32 17, i32 9, metadata !32, metadata !58}
