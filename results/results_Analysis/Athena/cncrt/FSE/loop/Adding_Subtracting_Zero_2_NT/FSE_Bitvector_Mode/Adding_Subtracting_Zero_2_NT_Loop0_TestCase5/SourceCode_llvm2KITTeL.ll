...
main_bb7:                                         ; preds = %main_ff_subtitles_next_line.exit, %main_bb6
  %b.0 = phi i32 [ 0, %main_bb6 ], [ %"11", %main_ff_subtitles_next_line.exit ]
  %"9" = icmp slt i32 %b.0, 15, !dbg !46
...
main_ff_subtitles_next_line.exit:                 ; preds = %main_bb7
  ...
  %. = select i1 %"10", i32 0, i32 10, !dbg !48
  %"11" = add nsw i32 %b.0, %., !dbg !41
  %"12" = sub nsw i32 15, 4, !dbg !49
