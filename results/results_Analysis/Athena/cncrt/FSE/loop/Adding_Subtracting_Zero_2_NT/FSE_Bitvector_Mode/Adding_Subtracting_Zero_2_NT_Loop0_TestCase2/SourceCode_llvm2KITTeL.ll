...
main_bb5:
  ...
  br i1 %or.cond, label %main_bb8, label %main_bb6, !dbg !35

main_bb6:                                         ; preds = %main_bb5
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !39), !dbg !42
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !39), !dbg !42
  %"8" = load i32* @"'flag", align 4, !dbg !43
  call void @llvm.dbg.value(metadata !{i32 %"11"}, i64 0, metadata !31), !dbg !32
  br label %main_bb7, !dbg !44

main_bb7:                                         ; preds = %main_ff_subtitles_next_line.exit, %main_bb6
  %b.0 = phi i32 [ 10, %main_bb6 ], [ %"11", %main_ff_subtitles_next_line.exit ]
  %"9" = icmp slt i32 %b.0, 5, !dbg !45
  br i1 %"9", label %main_ff_subtitles_next_line.exit, label %main_bb8, !dbg !45

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb7
  %"10" = icmp eq i32 %"8", 1, !dbg !43
  %. = select i1 %"10", i32 0, i32 5, !dbg !47
  %"11" = add nsw i32 %b.0, %., !dbg !40
  %"12" = sub nsw i32 5, 4, !dbg !48
  %"13" = icmp sge i32 %"11", %"12", !dbg !48
  br i1 %"13", label %main_bb8, label %main_bb7, !dbg !48

main_bb8:                                         ; preds = %main_bb7, %main_ff_subtitles_next_line.exit, %main_bb5
  ret i32 0, !dbg !50
}
...
!33 = metadata !{i32 786688, metadata !9, metadata !"end", metadata !5, i32 30, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [end] [line 30]
!34 = metadata !{i32 30, i32 9, metadata !9, null}
!35 = metadata !{i32 31, i32 9, metadata !36, null}
!36 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!37 = metadata !{i32 31, i32 9, metadata !38, null}
!38 = metadata !{i32 786443, metadata !1, metadata !36, i32 31, i32 9, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!39 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 12, metadata !8, i32 0, metadata !40} ; [ DW_TAG_auto_variable ] [i] [line 12]
!40 = metadata !{i32 35, i32 14, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 5, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 12, i32 9, metadata !4, metadata !40}
!43 = metadata !{i32 14, i32 9, metadata !20, metadata !40}
!44 = metadata !{i32 33, i32 5, metadata !9, null}
!45 = metadata !{i32 33, i32 5, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 5, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 25, i32 1, metadata !4, metadata !40}
!48 = metadata !{i32 36, i32 13, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !41, i32 36, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!50 = metadata !{i32 40, i32 1, metadata !9, null}
