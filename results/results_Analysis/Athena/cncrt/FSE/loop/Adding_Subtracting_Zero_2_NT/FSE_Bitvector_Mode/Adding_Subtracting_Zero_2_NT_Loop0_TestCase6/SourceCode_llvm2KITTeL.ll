...
main_bb6:                                         ; preds = %main_ff_subtitles_next_line.exit, %main_bb5
  %b.0 = phi i32 [ 0, %main_bb5 ], [ %"11", %main_ff_subtitles_next_line.exit ]
  %"8" = icmp slt i32 %b.0, 10, !dbg !39
  br i1 %"8", label %main_bb7, label %main_bb9, !dbg !39
...
main_ff_subtitles_next_line.exit:                 ; preds = %main_bb7, %main_bb8
  %"11" = add nsw i32 %b.0, 0, !dbg !42
  %"12" = sub nsw i32 10, 4, !dbg !46
  %"13" = icmp sge i32 %"11", %"12", !dbg !46
  br i1 %"13", label %main_bb9, label %main_bb6, !dbg !46

main_bb9:                                         ; preds = %main_bb6, %main_ff_subtitles_next_line.exit, %main_bb5
  ret i32 0, !dbg !48
}
...
!30 = metadata !{i32 786688, metadata !9, metadata !"b", metadata !5, i32 29, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [b] [line 29]
!31 = metadata !{i32 29, i32 9, metadata !9, null}
!32 = metadata !{i32 10}
...
!39 = metadata !{i32 33, i32 5, metadata !40, null}
!40 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 5, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 14, i32 9, metadata !20, metadata !42}
!42 = metadata !{i32 35, i32 14, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 5, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 18, i32 9, metadata !24, metadata !42}
!45 = metadata !{i32 19, i32 9, metadata !24, metadata !42}
!46 = metadata !{i32 36, i32 13, metadata !47, null}
!47 = metadata !{i32 786443, metadata !1, metadata !43, i32 36, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
