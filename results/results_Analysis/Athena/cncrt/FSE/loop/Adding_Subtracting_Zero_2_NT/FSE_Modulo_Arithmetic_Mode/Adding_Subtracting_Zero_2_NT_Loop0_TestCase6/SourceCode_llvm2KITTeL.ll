...
define i32 @main() #0 {
main_bb13:
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !78), !dbg !79
  call void @llvm.dbg.value(metadata !80, i64 0, metadata !81), !dbg !82
  %"28" = icmp slt i64 0, 0, !dbg !83
  %"29" = icmp slt i64 10, 0, !dbg !85
  %or.cond = or i1 %"28", %"29", !dbg !83
  br i1 %or.cond, label %main_bb23, label %main_bb14, !dbg !83

main_bb14:                                        ; preds = %main_wrap_around.exit, %main_bb13
  %b.0 = phi i64 [ 0, %main_bb13 ], [ %.0.i1, %main_wrap_around.exit ]
  %"30" = icmp slt i64 %b.0, 10, !dbg !87
  br i1 %"30", label %main_bb15, label %main_bb23, !dbg !87

main_bb15:                                        ; preds = %main_bb14
  %"31" = load i64* @"'flag", align 8, !dbg !89
  %"32" = icmp eq i64 %"31", 1, !dbg !89
  br i1 %"32", label %main_ff_subtitles_next_line.exit, label %main_bb16, !dbg !89

main_bb16:                                        ; preds = %main_bb15
  store i64 1, i64* @"'flag", align 8, !dbg !92
  br label %main_ff_subtitles_next_line.exit, !dbg !93

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb15, %main_bb16
  %"33" = add nsw i64 %b.0, 0, !dbg !90
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !94
  br i1 %"34", label %main_bb17, label %main_bb18, !dbg !94

main_bb17:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"35" = sub nsw i64 %"33", 2147483647, !dbg !96
  %"36" = sub nsw i64 %"35", 1, !dbg !96
  %"37" = srem i64 %"36", 4294967296, !dbg !96
  %"38" = add nsw i64 -2147483648, %"37", !dbg !96
  br label %main_wrap_around.exit2, !dbg !96

main_bb18:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"39" = icmp slt i64 %"33", -2147483648, !dbg !97
  br i1 %"39", label %main_bb19, label %main_wrap_around.exit2, !dbg !97

main_bb19:                                        ; preds = %main_bb18
  %"40" = sub nsw i64 -2147483648, %"33", !dbg !98
  %"41" = sub nsw i64 %"40", 1, !dbg !98
  %"42" = srem i64 %"41", 4294967296, !dbg !98
  %"43" = sub nsw i64 2147483647, %"42", !dbg !98
  br label %main_wrap_around.exit2, !dbg !98

main_wrap_around.exit2:                           ; preds = %main_bb17, %main_bb18, %main_bb19
  %.0.i1 = phi i64 [ %"38", %main_bb17 ], [ %"43", %main_bb19 ], [ %"33", %main_bb18 ], !dbg !95
  %"44" = sub nsw i64 10, 4, !dbg !99
  %"45" = icmp sgt i64 %"44", 2147483647, !dbg !101
  br i1 %"45", label %main_bb20, label %main_bb21, !dbg !101

main_bb20:                                        ; preds = %main_wrap_around.exit2
  %"46" = sub nsw i64 %"44", 2147483647, !dbg !102
  %"47" = sub nsw i64 %"46", 1, !dbg !102
  %"48" = srem i64 %"47", 4294967296, !dbg !102
  %"49" = add nsw i64 -2147483648, %"48", !dbg !102
  br label %main_wrap_around.exit, !dbg !102

main_bb21:                                        ; preds = %main_wrap_around.exit2
  %"50" = icmp slt i64 %"44", -2147483648, !dbg !103
  br i1 %"50", label %main_bb22, label %main_wrap_around.exit, !dbg !103

main_bb22:                                        ; preds = %main_bb21
  %"51" = sub nsw i64 -2147483648, %"44", !dbg !104
  %"52" = sub nsw i64 %"51", 1, !dbg !104
  %"53" = srem i64 %"52", 4294967296, !dbg !104
  %"54" = sub nsw i64 2147483647, %"53", !dbg !104
  br label %main_wrap_around.exit, !dbg !104

main_wrap_around.exit:                            ; preds = %main_bb20, %main_bb21, %main_bb22
  %.0.i = phi i64 [ %"49", %main_bb20 ], [ %"54", %main_bb22 ], [ %"44", %main_bb21 ], !dbg !99
  %"55" = icmp sge i64 %.0.i1, %.0.i, !dbg !99
  br i1 %"55", label %main_bb23, label %main_bb14, !dbg !99

main_bb23:                                        ; preds = %main_bb14, %main_wrap_around.exit, %main_bb13
  ret i32 0, !dbg !105
}
...
!78 = metadata !{i32 786688, metadata !12, metadata !"b", metadata !5, i32 45, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [b] [line 45]
!79 = metadata !{i32 45, i32 15, metadata !12, null}
!80 = metadata !{i64 10}
...
!87 = metadata !{i32 51, i32 5, metadata !88, null}
!88 = metadata !{i32 786443, metadata !1, metadata !12, i32 51, i32 5, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!89 = metadata !{i32 26, i32 9, metadata !55, metadata !90}
!90 = metadata !{i32 53, i32 30, metadata !91, null}
!91 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 5, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!92 = metadata !{i32 32, i32 9, metadata !59, metadata !90}
!93 = metadata !{i32 33, i32 9, metadata !59, metadata !90}
!94 = metadata !{i32 14, i32 9, metadata !31, metadata !95}
!95 = metadata !{i32 53, i32 13, metadata !91, null}
!96 = metadata !{i32 15, i32 9, metadata !33, metadata !95}
!97 = metadata !{i32 17, i32 14, metadata !35, metadata !95}
!98 = metadata !{i32 18, i32 9, metadata !37, metadata !95}
!99 = metadata !{i32 54, i32 18, metadata !100, null}
!100 = metadata !{i32 786443, metadata !1, metadata !91, i32 54, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!101 = metadata !{i32 14, i32 9, metadata !31, metadata !99}
!102 = metadata !{i32 15, i32 9, metadata !33, metadata !99}
!103 = metadata !{i32 17, i32 14, metadata !35, metadata !99}
!104 = metadata !{i32 18, i32 9, metadata !37, metadata !99}
!105 = metadata !{i32 60, i32 1, metadata !12, null}
