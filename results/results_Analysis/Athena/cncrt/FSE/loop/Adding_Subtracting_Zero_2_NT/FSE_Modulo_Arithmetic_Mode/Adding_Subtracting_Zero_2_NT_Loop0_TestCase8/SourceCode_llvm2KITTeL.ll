...
main_ff_subtitles_next_line.exit:                 ; preds = %main_bb15, %main_bb16
  %"33" = add nsw i64 %b.0, 0, !dbg !91
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !95
  br i1 %"34", label %main_bb17, label %main_bb18, !dbg !95
...
main_wrap_around.exit2:                           ; preds = %main_bb17, %main_bb18, %main_bb19
  %.0.i1 = phi i64 [ %"38", %main_bb17 ], [ %"43", %main_bb19 ], [ %"33", %main_bb18 ], !dbg !96
  %"44" = sub nsw i64 30, 4, !dbg !100
...
!90 = metadata !{i32 26, i32 9, metadata !55, metadata !91}
...
!93 = metadata !{i32 32, i32 9, metadata !59, metadata !91}
!94 = metadata !{i32 33, i32 9, metadata !59, metadata !91}
!95 = metadata !{i32 14, i32 9, metadata !31, metadata !96}
!96 = metadata !{i32 53, i32 13, metadata !92, null}
!97 = metadata !{i32 15, i32 9, metadata !33, metadata !96}
!98 = metadata !{i32 17, i32 14, metadata !35, metadata !96}
!99 = metadata !{i32 18, i32 9, metadata !37, metadata !96}
!100 = metadata !{i32 54, i32 18, metadata !101, null}
!101 = metadata !{i32 786443, metadata !1, metadata !92, i32 54, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!102 = metadata !{i32 14, i32 9, metadata !31, metadata !100}
!103 = metadata !{i32 15, i32 9, metadata !33, metadata !100}
!104 = metadata !{i32 17, i32 14, metadata !35, metadata !100}
!105 = metadata !{i32 18, i32 9, metadata !37, metadata !100}
!106 = metadata !{i32 60, i32 1, metadata !12, null}
