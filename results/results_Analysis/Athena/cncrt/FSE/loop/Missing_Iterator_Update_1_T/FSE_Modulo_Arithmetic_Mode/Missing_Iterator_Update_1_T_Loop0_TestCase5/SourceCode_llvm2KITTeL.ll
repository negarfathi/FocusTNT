...
main_bb10:
  ...
  %"15" = icmp eq i64 5, 0, !dbg !57
  br i1 %"15", label %main_bb11, label %main_bb13, !dbg !57

main_bb11:                                        ; preds = %main_bb10
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !59), !dbg !63
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !55), !dbg !56
  %"16" = load i64* @"'errno", align 8, !dbg !64
  br label %main_bb12, !dbg !66

main_bb12:                                        ; preds = %main_bb11, %main_bb12
  %"17" = icmp slt i64 5, 0, !dbg !67
  %"18" = icmp eq i64 %"16", 1, !dbg !64
  %. = select i1 %"17", i1 %"18", i1 false, !dbg !67
  br i1 %., label %main_bb12, label %main_bb13, !dbg !69

main_bb13:                                        ; preds = %main_bb12, %main_bb10
  ret i32 0, !dbg !71
}
...
!55 = metadata !{i32 786688, metadata !12, metadata !"ret", metadata !5, i32 44, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ret] [line 44]
!56 = metadata !{i32 44, i32 15, metadata !12, null}
!57 = metadata !{i32 46, i32 9, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !12, i32 46, i32 9, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 786688, metadata !9, metadata !"num", metadata !5, i32 27, metadata !8, i32 0, metadata !60} ; [ DW_TAG_auto_variable ] [num] [line 27]
!60 = metadata !{i32 49, i32 19, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !62, i32 48, i32 11, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 786443, metadata !1, metadata !58, i32 47, i32 5, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 27, i32 15, metadata !9, metadata !60}
!64 = metadata !{i32 50, i32 9, metadata !65, null}
!65 = metadata !{i32 786443, metadata !1, metadata !61, i32 50, i32 9, i32 2, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!66 = metadata !{i32 48, i32 9, metadata !62, null}
!67 = metadata !{i32 50, i32 9, metadata !68, null}
!68 = metadata !{i32 786443, metadata !1, metadata !61, i32 50, i32 9, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 50, i32 9, metadata !70, null}
!70 = metadata !{i32 786443, metadata !1, metadata !61, i32 50, i32 9, i32 3, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 52, i32 5, metadata !12, null}
