...
main_bb0:
  ...
  %"0" = icmp ule i32 -1, 0, !dbg !24
  %"1" = icmp eq i32 -2147483648, 0, !dbg !26
...
main_bb1:                                         ; preds = %main_bb0, %main_bb2
  ...
  %"2" = icmp ult i32 -1, %cur.0, !dbg !28
  br i1 %"2", label %main_bb3, label %main_bb2, !dbg !28

main_bb2:                                         ; preds = %main_bb1
  %"3" = add i32 %cur.0, -2147483648, !dbg !32
  %"4" = icmp ule i32 %"3", %cur.0, !dbg !33
  br i1 %"4", label %main_bb3, label %main_bb1, !dbg !33
