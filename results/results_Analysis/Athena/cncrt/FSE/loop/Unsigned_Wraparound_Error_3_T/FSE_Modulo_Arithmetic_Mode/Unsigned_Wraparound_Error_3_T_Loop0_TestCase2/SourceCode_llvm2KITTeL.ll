...
main_wrap_around.exit2:                           ; preds = %main_wrap_around.exit, %main_bb12, %main_bb14, %main_bb15, %main_bb16
  %newbufsize.0 = phi i64 [ 4294967295, %main_bb12 ], [ %"42", %main_bb14 ], [ %"47", %main_bb16 ], [ %"38", %main_bb15 ], [ 2, %main_wrap_around.exit ]
  %"25" = add nsw i64 0, 5, !dbg !61
