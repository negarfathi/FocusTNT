...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !40, i64 0, metadata !35), !dbg !36
...
main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  ...
  br i1 %"12", label %main_wrap_around.exit, label %main_bb11, !dbg !56
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  ...
  %"13" = icmp eq i64 %res.1, 0, !dbg !58
  br i1 %"13", label %main_bb7, label %main_bb6, !dbg !58

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"14" = add nsw i64 %pkt.1, 1, !dbg !42
  %"15" = icmp sgt i64 %"14", 2147483647, !dbg !60
  br i1 %"15", label %main_bb8, label %main_bb9, !dbg !60
...
main_bb9:                                         ; preds = %main_bb7
  ...
  br i1 %"20", label %main_bb10, label %main_wrap_around.exit, !dbg !62
...
!42 = metadata !{i32 30, i32 20, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !44, i32 28, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!57 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 5, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 27, i32 9, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !44, i32 27, i32 9, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
