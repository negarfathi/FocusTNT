...
main_bb0:
  ...
  call void @llvm.dbg.value(metadata !{i32 %"5"}, i64 0, metadata !27), !dbg !29
  br label %main_bb1, !dbg !30

main_bb1:                                         ; preds = %main_bb2, %main_bb0
  %i.0 = phi i32 [ 0, %main_bb0 ], [ %"5", %main_bb2 ]
  %"4" = icmp slt i32 %i.0, 10, !dbg !31
  br i1 %"4", label %main_bb2, label %main_bb3, !dbg !31

main_bb2:                                         ; preds = %main_bb1
  %"5" = add nsw i32 %i.0, 1, !dbg !34
  br label %main_bb1, !dbg !34

main_bb3:                                         ; preds = %main_bb1, %main_bb9
  %i1.0 = phi i32 [ %"21", %main_bb9 ], [ 0, %main_bb1 ]
  %table.0 = phi i32 [ %table.1, %main_bb9 ], [ %"0", %main_bb1 ]
  %"6" = icmp slt i32 %i1.0, 10, !dbg !35
  br i1 %"6", label %main_bb4, label %main_bb10, !dbg !35

main_bb4:                                         ; preds = %main_bb3
  %"7" = sext i32 %i1.0 to i64, !dbg !37
  %"8" = getelementptr inbounds [10 x i32]* %slots_used, i32 0, i64 %"7", !dbg !37
  %"9" = load i32* %"8", align 4, !dbg !37
...
main_bb5:                                         ; preds = %main_LeafBlock
  %"10" = sext i32 %i1.0 to i64, !dbg !39
  %"11" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"10", !dbg !39
  %"12" = load i32* %"11", align 4, !dbg !39
  %"13" = icmp ne i32 %"12", 0, !dbg !39
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !39

main_bb6:                                         ; preds = %main_bb5
  %"14" = sext i32 %i1.0 to i64, !dbg !42
  %"15" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"14", !dbg !42
  %"16" = load i32* %"15", align 4, !dbg !42
...
main_bb7:                                         ; preds = %main_NewDefault
  %"17" = sext i32 %i1.0 to i64, !dbg !44
  %"18" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"17", !dbg !44
  %"19" = load i32* %"18", align 4, !dbg !44
  br label %main_bb8, !dbg !45

main_bb8:                                         ; preds = %main_LeafBlock1, %main_bb7, %main_bb6
  %table.1 = phi i32 [ %"19", %main_bb7 ], [ %"16", %main_bb6 ], [ %table.0, %main_LeafBlock1 ]
  %"20" = icmp ne i32 %table.1, 0, !dbg !46
  br i1 %"20", label %main_bb10, label %main_bb9, !dbg !46

main_bb9:                                         ; preds = %main_bb8
  %"21" = add nsw i32 %i1.0, 1, !dbg !48
