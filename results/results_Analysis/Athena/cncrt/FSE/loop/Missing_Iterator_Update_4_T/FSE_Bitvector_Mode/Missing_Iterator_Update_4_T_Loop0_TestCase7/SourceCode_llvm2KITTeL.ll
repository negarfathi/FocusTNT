...
main_bb0:
  ...
  %"0" = icmp slt i32 2, 0, !dbg !26
  %"1" = icmp slt i32 5, 0, !dbg !28
  %or.cond = or i1 %"0", %"1", !dbg !26
  %"2" = icmp sgt i32 2, 65534, !dbg !30
  %or.cond1 = or i1 %or.cond, %"2", !dbg !26
  %"3" = icmp sgt i32 5, 65534, !dbg !32
...
!20 = metadata !{i32 3}
!21 = metadata !{i32 786688, metadata !4, metadata !"z", metadata !5, i32 14, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [z] [line 14]
