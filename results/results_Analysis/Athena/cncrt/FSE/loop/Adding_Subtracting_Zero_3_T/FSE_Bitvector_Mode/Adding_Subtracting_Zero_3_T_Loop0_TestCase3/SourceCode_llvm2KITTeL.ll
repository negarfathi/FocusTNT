...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %"17"}, i64 0, metadata !52), !dbg !53
...
main_bb9:                                         ; preds = %main_bb10, %main_bb11, %main_bb8
  %errno.0 = phi i32 [ 0, %main_bb8 ], [ %errno.0, %main_bb11 ], [ %"17", %main_bb10 ]
...
main_read.exit:                                   ; preds = %main_bb9
  ...
  br i1 %or.cond1, label %main_bb10, label %main_bb11, !dbg !73

main_bb10:                                        ; preds = %main_read.exit
  %"17" = add nsw i32 %errno.0, 1, !dbg !75
  %"18" = icmp eq i32 %"17", 5, !dbg !77
  br i1 %"18", label %main_bb12, label %main_bb9, !dbg !77

main_bb11:                                        ; preds = %main_read.exit
  %"19" = add nsw i32 %.0.i, 1, !dbg !79
  %"20" = add nsw i32 %pos.0, %"19", !dbg !81
...
!73 = metadata !{i32 74, i32 13, metadata !74, null}
!74 = metadata !{i32 786443, metadata !1, metadata !60, i32 74, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!75 = metadata !{i32 76, i32 13, metadata !76, null}
!76 = metadata !{i32 786443, metadata !1, metadata !74, i32 75, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!77 = metadata !{i32 77, i32 17, metadata !78, null}
!78 = metadata !{i32 786443, metadata !1, metadata !76, i32 77, i32 17, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!79 = metadata !{i32 82, i32 13, metadata !80, null}
!80 = metadata !{i32 786443, metadata !1, metadata !60, i32 81, i32 13, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!81 = metadata !{i32 83, i32 9, metadata !60, null}
!82 = metadata !{i32 84, i32 5, metadata !60, null}
!83 = metadata !{i32 86, i32 1, metadata !9, null}
