...
main_bb21:
  ...
  br i1 %or.cond, label %main_bb38, label %main_bb22, !dbg !88
...
main_bb22:                                        ; preds = %main_bb21
  ...
  call void @llvm.dbg.value(metadata !{i64 %"69"}, i64 0, metadata !115), !dbg !119
  ...
  call void @llvm.dbg.value(metadata !{i64 %"81"}, i64 0, metadata !126), !dbg !130
  ...
  call void @llvm.dbg.value(metadata !{i64 %"92"}, i64 0, metadata !137), !dbg !139
...
main_wrap_around.exit2:                           ; preds = %main_bb37, %main_bb36, %main_bb35, %main_wrap_around.exit6, %main_bb22
  %errno.0 = phi i64 [ 0, %main_bb22 ], [ %.0.i5, %main_wrap_around.exit6 ], [ %errno.0, %main_bb35 ], [ %errno.0, %main_bb36 ], [ %errno.0, %main_bb37 ]
  %pos.0 = phi i64 [ 0, %main_bb22 ], [ %pos.0, %main_wrap_around.exit6 ], [ %"97", %main_bb35 ], [ %"102", %main_bb37 ], [ %"92", %main_bb36 ]
  %"55" = icmp slt i64 %pos.0, 10, !dbg !147
  br i1 %"55", label %main_bb23, label %main_bb38, !dbg !147
...
main_wrap_around.exit:                            ; preds = %main_bb24, %main_bb25, %main_bb26
  ...
  %"68" = icmp slt i64 %pos.0, %.0.i, !dbg !153
  %or.cond8 = and i1 %"67", %"68", !dbg !112
  %.0.i7 = select i1 %or.cond8, i64 -1, i64 0, !dbg !112
  br i1 %or.cond8, label %main_bb27, label %main_bb31, !dbg !154

main_bb27:                                        ; preds = %main_wrap_around.exit
  %"69" = add nsw i64 %errno.0, 1, !dbg !116
...
main_bb28:                                        ; preds = %main_bb27
  ...
  br label %main_wrap_around.exit6, !dbg !156

main_bb29:                                        ; preds = %main_bb27
  %"75" = icmp slt i64 %"69", -2147483648, !dbg !157
  br i1 %"75", label %main_bb30, label %main_wrap_around.exit6, !dbg !157
...
main_bb30:                                        ; preds = %main_bb29
  ...
  br label %main_wrap_around.exit6, !dbg !158

main_wrap_around.exit6:                           ; preds = %main_bb28, %main_bb29, %main_bb30
  %.0.i5 = phi i64 [ %"74", %main_bb28 ], [ %"79", %main_bb30 ], [ %"69", %main_bb29 ], !dbg !116
  %"80" = icmp eq i64 %.0.i5, 5, !dbg !159
  br i1 %"80", label %main_bb38, label %main_wrap_around.exit2, !dbg !159

main_bb31:                                        ; preds = %main_wrap_around.exit
  %"81" = add nsw i64 %.0.i7, 1, !dbg !127
  %"82" = icmp sgt i64 %"81", 2147483647, !dbg !161
  br i1 %"82", label %main_bb32, label %main_bb33, !dbg !161

main_bb32:                                        ; preds = %main_bb31
  %"83" = sub nsw i64 %"81", 2147483647, !dbg !162
  %"84" = sub nsw i64 %"83", 1, !dbg !162
  %"85" = srem i64 %"84", 4294967296, !dbg !162
  %"86" = add nsw i64 -2147483648, %"85", !dbg !162
  br label %main_wrap_around.exit4, !dbg !162

main_bb33:                                        ; preds = %main_bb31
  %"87" = icmp slt i64 %"81", -2147483648, !dbg !163
  br i1 %"87", label %main_bb34, label %main_wrap_around.exit4, !dbg !163

main_bb34:                                        ; preds = %main_bb33
  %"88" = sub nsw i64 -2147483648, %"81", !dbg !164
  %"89" = sub nsw i64 %"88", 1, !dbg !164
  %"90" = srem i64 %"89", 4294967296, !dbg !164
  %"91" = sub nsw i64 2147483647, %"90", !dbg !164
  br label %main_wrap_around.exit4, !dbg !164

main_wrap_around.exit4:                           ; preds = %main_bb34, %main_bb33, %main_bb32
  %rc.0 = phi i64 [ %"86", %main_bb32 ], [ %"91", %main_bb34 ], [ %"81", %main_bb33 ]
  %"92" = add nsw i64 %pos.0, %rc.0, !dbg !138
  %"93" = icmp sgt i64 %"92", 2147483647, !dbg !165
  br i1 %"93", label %main_bb35, label %main_bb36, !dbg !165

main_bb35:                                        ; preds = %main_wrap_around.exit4
  %"94" = sub nsw i64 %"92", 2147483647, !dbg !166
  %"95" = sub nsw i64 %"94", 1, !dbg !166
  %"96" = srem i64 %"95", 4294967296, !dbg !166
  %"97" = add nsw i64 -2147483648, %"96", !dbg !166
  br label %main_wrap_around.exit2, !dbg !166

main_bb36:                                        ; preds = %main_wrap_around.exit4
  %"98" = icmp slt i64 %"92", -2147483648, !dbg !167
  br i1 %"98", label %main_bb37, label %main_wrap_around.exit2, !dbg !167

main_bb37:                                        ; preds = %main_bb36
  %"99" = sub nsw i64 -2147483648, %"92", !dbg !168
  %"100" = sub nsw i64 %"99", 1, !dbg !168
  %"101" = srem i64 %"100", 4294967296, !dbg !168
  %"102" = sub nsw i64 2147483647, %"101", !dbg !168
  br label %main_wrap_around.exit2, !dbg !168
...
!154 = metadata !{i32 92, i32 13, metadata !118, null}
!155 = metadata !{i32 35, i32 9, metadata !31, metadata !116}
!156 = metadata !{i32 36, i32 9, metadata !33, metadata !116}
!157 = metadata !{i32 38, i32 14, metadata !35, metadata !116}
!158 = metadata !{i32 39, i32 9, metadata !37, metadata !116}
!159 = metadata !{i32 95, i32 17, metadata !160, null}
!160 = metadata !{i32 786443, metadata !1, metadata !117, i32 95, i32 17, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!161 = metadata !{i32 35, i32 9, metadata !31, metadata !127}
!162 = metadata !{i32 36, i32 9, metadata !33, metadata !127}
!163 = metadata !{i32 38, i32 14, metadata !35, metadata !127}
!164 = metadata !{i32 39, i32 9, metadata !37, metadata !127}
!165 = metadata !{i32 35, i32 9, metadata !31, metadata !138}
!166 = metadata !{i32 36, i32 9, metadata !33, metadata !138}
!167 = metadata !{i32 38, i32 14, metadata !35, metadata !138}
!168 = metadata !{i32 39, i32 9, metadata !37, metadata !138}
!169 = metadata !{i32 108, i32 1, metadata !12, null}
