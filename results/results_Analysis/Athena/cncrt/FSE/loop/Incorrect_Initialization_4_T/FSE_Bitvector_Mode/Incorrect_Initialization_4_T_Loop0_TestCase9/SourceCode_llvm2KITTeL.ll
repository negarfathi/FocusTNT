...
main_bb0:
  ...
  %"0" = icmp slt i32 18, 0, !dbg !21
  %"1" = icmp sle i32 21, 0, !dbg !23
  %or.cond = or i1 %"0", %"1", !dbg !21
  %"2" = icmp sle i32 6, 0, !dbg !25
  %or.cond1 = or i1 %or.cond, %"2", !dbg !21
  %"3" = icmp sgt i32 6, 21, !dbg !27
  %or.cond2 = or i1 %or.cond1, %"3", !dbg !21
  %"4" = icmp sgt i32 21, 65534, !dbg !29
...
main_bb2:                                         ; preds = %main_bb3, %main_bb1
  ...
  %"7" = icmp slt i32 %i.0, 21, !dbg !42
  br i1 %"7", label %main_bb3, label %main_bb4, !dbg !42

main_bb3:                                         ; preds = %main_bb2
  %"8" = icmp ne i32 %r.0, 0, !dbg !44
  %"9" = add nsw i32 %"6", 1, !dbg !37
  %r.0. = select i1 %"8", i32 %r.0, i32 %"9", !dbg !44
  %"10" = add nsw i32 %i.0, %r.0., !dbg !45
