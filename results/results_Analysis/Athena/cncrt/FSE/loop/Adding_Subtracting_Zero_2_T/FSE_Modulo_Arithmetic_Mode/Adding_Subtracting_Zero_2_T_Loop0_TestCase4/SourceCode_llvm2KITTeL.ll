...
main_bb14:                                        ; preds = %main_bb13
  ...
  call void @llvm.dbg.value(metadata !123, i64 0, metadata !124), !dbg !126
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !127), !dbg !128
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !129), !dbg !130
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !131), !dbg !132
  br label %main_bb15, !dbg !133

main_bb15:                                        ; preds = %main_wrap_around.exit, %main_bb14
  %b.0 = phi i64 [ 0, %main_bb14 ], [ %.0.i2, %main_wrap_around.exit ]
  %"31" = icmp slt i64 %b.0, 5, !dbg !134
  br i1 %"31", label %main_ff_subtitles_next_line.exit, label %main_bb23, !dbg !134

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb15
  %"32" = icmp eq i64 %"30", 1, !dbg !101
  %. = select i1 %"32", i64 0, i64 3, !dbg !101
  %"33" = icmp ne i64 %., 0, !dbg !136
  br i1 %"33", label %main_bb16, label %main_bb23, !dbg !136

main_bb16:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"34" = add nsw i64 %b.0, %., !dbg !105
  %"35" = icmp sgt i64 %"34", 2147483647, !dbg !138
  br i1 %"35", label %main_bb17, label %main_bb18, !dbg !138

main_bb17:                                        ; preds = %main_bb16
  %"36" = sub nsw i64 %"34", 2147483647, !dbg !139
  %"37" = sub nsw i64 %"36", 1, !dbg !139
  %"38" = srem i64 %"37", 4294967296, !dbg !139
  %"39" = add nsw i64 -2147483648, %"38", !dbg !139
  br label %main_wrap_around.exit3, !dbg !139

main_bb18:                                        ; preds = %main_bb16
  %"40" = icmp slt i64 %"34", -2147483648, !dbg !140
  br i1 %"40", label %main_bb19, label %main_wrap_around.exit3, !dbg !140

main_bb19:                                        ; preds = %main_bb18
  %"41" = sub nsw i64 -2147483648, %"34", !dbg !141
  %"42" = sub nsw i64 %"41", 1, !dbg !141
  %"43" = srem i64 %"42", 4294967296, !dbg !141
  %"44" = sub nsw i64 2147483647, %"43", !dbg !141
  br label %main_wrap_around.exit3, !dbg !141

main_wrap_around.exit3:                           ; preds = %main_bb17, %main_bb18, %main_bb19
  %.0.i2 = phi i64 [ %"39", %main_bb17 ], [ %"44", %main_bb19 ], [ %"34", %main_bb18 ], !dbg !105
  %"45" = sub nsw i64 5, 4, !dbg !114
  %"46" = icmp sgt i64 %"45", 2147483647, !dbg !142
  br i1 %"46", label %main_bb20, label %main_bb21, !dbg !142

main_bb20:                                        ; preds = %main_wrap_around.exit3
  %"47" = sub nsw i64 %"45", 2147483647, !dbg !143
  %"48" = sub nsw i64 %"47", 1, !dbg !143
  %"49" = srem i64 %"48", 4294967296, !dbg !143
  %"50" = add nsw i64 -2147483648, %"49", !dbg !143
  br label %main_wrap_around.exit, !dbg !143

main_bb21:                                        ; preds = %main_wrap_around.exit3
  %"51" = icmp slt i64 %"45", -2147483648, !dbg !144
  br i1 %"51", label %main_bb22, label %main_wrap_around.exit, !dbg !144

main_bb22:                                        ; preds = %main_bb21
  %"52" = sub nsw i64 -2147483648, %"45", !dbg !145
  %"53" = sub nsw i64 %"52", 1, !dbg !145
  %"54" = srem i64 %"53", 4294967296, !dbg !145
  %"55" = sub nsw i64 2147483647, %"54", !dbg !145
...
!123 = metadata !{i64 3}
!124 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777229, metadata !8, i32 0, metadata !125} ; [ DW_TAG_arg_variable ] [value] [line 13]
!125 = metadata !{i32 38, i32 12, metadata !64, metadata !89}
!126 = metadata !{i32 13, i32 33, metadata !4, metadata !125}
!127 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554445, metadata !8, i32 0, metadata !125} ; [ DW_TAG_arg_variable ] [lower_bound] [line 13]
!128 = metadata !{i32 13, i32 50, metadata !4, metadata !125}
!129 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331661, metadata !8, i32 0, metadata !125} ; [ DW_TAG_arg_variable ] [upper_bound] [line 13]
!130 = metadata !{i32 13, i32 73, metadata !4, metadata !125}
!131 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 14, metadata !8, i32 0, metadata !125} ; [ DW_TAG_auto_variable ] [range] [line 14]
!132 = metadata !{i32 14, i32 15, metadata !4, metadata !125}
!133 = metadata !{i32 52, i32 5, metadata !12, null}
!134 = metadata !{i32 52, i32 5, metadata !135, null}
!135 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 5, i32 1, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!136 = metadata !{i32 55, i32 13, metadata !137, null}
!137 = metadata !{i32 786443, metadata !1, metadata !90, i32 55, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!138 = metadata !{i32 15, i32 9, metadata !31, metadata !105}
!139 = metadata !{i32 16, i32 9, metadata !33, metadata !105}
!140 = metadata !{i32 18, i32 14, metadata !35, metadata !105}
!141 = metadata !{i32 19, i32 9, metadata !37, metadata !105}
!142 = metadata !{i32 15, i32 9, metadata !31, metadata !114}
!143 = metadata !{i32 16, i32 9, metadata !33, metadata !114}
!144 = metadata !{i32 18, i32 14, metadata !35, metadata !114}
!145 = metadata !{i32 19, i32 9, metadata !37, metadata !114}
!146 = metadata !{i32 66, i32 1, metadata !12, null}
