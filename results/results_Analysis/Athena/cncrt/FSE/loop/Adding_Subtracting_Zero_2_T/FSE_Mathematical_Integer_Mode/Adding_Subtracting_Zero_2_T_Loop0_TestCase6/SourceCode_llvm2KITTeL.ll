...
define i32 @main() #0 {
main_bb5:
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !30), !dbg !31
  call void @llvm.dbg.value(metadata !32, i64 0, metadata !33), !dbg !34
  %"6" = icmp slt i32 0, 0, !dbg !35
  %"7" = icmp slt i32 10, 0, !dbg !37
  %or.cond = or i1 %"6", %"7", !dbg !35
  br i1 %or.cond, label %main_bb10, label %main_bb6, !dbg !35

main_bb6:                                         ; preds = %main_bb9, %main_bb5
  %b.0 = phi i32 [ 0, %main_bb5 ], [ %"12", %main_bb9 ]
  %"8" = icmp slt i32 %b.0, 10, !dbg !39
  br i1 %"8", label %main_bb7, label %main_bb10, !dbg !39

main_bb7:                                         ; preds = %main_bb6
  %"9" = load i32* @"'flag", align 4, !dbg !41
  %"10" = icmp eq i32 %"9", 1, !dbg !41
  br i1 %"10", label %main_ff_subtitles_next_line.exit, label %main_bb8, !dbg !41

main_bb8:                                         ; preds = %main_bb7
  store i32 1, i32* @"'flag", align 4, !dbg !44
  br label %main_ff_subtitles_next_line.exit, !dbg !45

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb7, %main_bb8
  %"11" = icmp ne i32 0, 0, !dbg !46
  br i1 %"11", label %main_bb9, label %main_bb10, !dbg !46

main_bb9:                                         ; preds = %main_ff_subtitles_next_line.exit
  %"12" = add nsw i32 %b.0, 0, !dbg !48
  %"13" = sub nsw i32 10, 4, !dbg !49
  %"14" = icmp sge i32 %"12", %"13", !dbg !49
  br i1 %"14", label %main_bb10, label %main_bb6, !dbg !49

main_bb10:                                        ; preds = %main_bb6, %main_ff_subtitles_next_line.exit, %main_bb9, %main_bb5
  ret i32 0, !dbg !51
}
...
!30 = metadata !{i32 786688, metadata !9, metadata !"b", metadata !5, i32 30, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [b] [line 30]
!31 = metadata !{i32 30, i32 9, metadata !9, null}
!32 = metadata !{i32 10}
!33 = metadata !{i32 786688, metadata !9, metadata !"end", metadata !5, i32 31, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [end] [line 31]
!34 = metadata !{i32 31, i32 9, metadata !9, null}
!35 = metadata !{i32 32, i32 9, metadata !36, null}
!36 = metadata !{i32 786443, metadata !1, metadata !9, i32 32, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!37 = metadata !{i32 32, i32 9, metadata !38, null}
!38 = metadata !{i32 786443, metadata !1, metadata !36, i32 32, i32 9, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!39 = metadata !{i32 34, i32 5, metadata !40, null}
!40 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 15, i32 9, metadata !20, metadata !42}
!42 = metadata !{i32 36, i32 19, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 35, i32 5, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 19, i32 9, metadata !24, metadata !42}
!45 = metadata !{i32 20, i32 9, metadata !24, metadata !42}
!46 = metadata !{i32 37, i32 13, metadata !47, null}
!47 = metadata !{i32 786443, metadata !1, metadata !43, i32 37, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 39, i32 9, metadata !43, null}
!49 = metadata !{i32 40, i32 13, metadata !50, null}
!50 = metadata !{i32 786443, metadata !1, metadata !43, i32 40, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 44, i32 1, metadata !9, null}
