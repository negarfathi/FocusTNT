...
define i32 @main() #0 {
main_bb9:
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !85), !dbg !86
  %"42" = icmp sle i32 2, 0, !dbg !87
  %"43" = icmp sgt i32 2, 65534, !dbg !89
  %or.cond = or i1 %"42", %"43", !dbg !87
  br i1 %or.cond, label %main_bb18, label %main_bb10, !dbg !87

main_bb10:                                        ; preds = %main_bb9
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !91), !dbg !93
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !94), !dbg !96
  ...
  %"46" = add nsw i32 %"45", 8, !dbg !100
  store i32 %"46", i32* @"'memory0_freeIndex", align 4, !dbg !100
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !101), !dbg !102
  %"47" = sext i32 %"44" to i64, !dbg !103
  %"48" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"47", !dbg !103
  %"49" = getelementptr inbounds %struct.NNode* %"48", i32 0, i32 0, !dbg !103
  store i32 1, i32* %"49", align 4, !dbg !103
  %"50" = sext i32 %"44" to i64, !dbg !104
  %"51" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"50", !dbg !104
  %"52" = getelementptr inbounds %struct.NNode* %"51", i32 0, i32 1, !dbg !104
  store i32 0, i32* %"52", align 4, !dbg !104
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !105), !dbg !106
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !107), !dbg !108
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !109), !dbg !111
  br label %main_bb11, !dbg !112

main_bb11:                                        ; preds = %main_bb12, %main_bb10
  %i.0.i = phi i32 [ 2, %main_bb10 ], [ %"70", %main_bb12 ], !dbg !92
  %cyclic.0.i = phi i32 [ %"44", %main_bb10 ], [ %"69", %main_bb12 ], !dbg !92
  %"53" = icmp sle i32 %i.0.i, 2, !dbg !113
  br i1 %"53", label %main_bb12, label %main_initLink.exit, !dbg !113

main_bb12:                                        ; preds = %main_bb11
  %"54" = load i32* @"'memory0_freeIndex", align 4, !dbg !114
  %"55" = load i32* @"'memory0_freeIndex", align 4, !dbg !115
  %"56" = add nsw i32 %"55", 8, !dbg !115
  store i32 %"56", i32* @"'memory0_freeIndex", align 4, !dbg !115
  %"57" = sext i32 %"54" to i64, !dbg !116
  %"58" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"57", !dbg !116
  %"59" = getelementptr inbounds %struct.NNode* %"58", i32 0, i32 0, !dbg !116
  store i32 %i.0.i, i32* %"59", align 4, !dbg !116
  %"60" = sext i32 %"54" to i64, !dbg !117
  %"61" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"60", !dbg !117
  %"62" = getelementptr inbounds %struct.NNode* %"61", i32 0, i32 1, !dbg !117
  store i32 0, i32* %"62", align 4, !dbg !117
  %"63" = sext i32 %cyclic.0.i to i64, !dbg !118
  %"64" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"63", !dbg !118
  %"65" = getelementptr inbounds %struct.NNode* %"64", i32 0, i32 1, !dbg !118
  store i32 %"54", i32* %"65", align 4, !dbg !118
  %"66" = sext i32 %cyclic.0.i to i64, !dbg !119
  %"67" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"66", !dbg !119
  %"68" = getelementptr inbounds %struct.NNode* %"67", i32 0, i32 1, !dbg !119
  %"69" = load i32* %"68", align 4, !dbg !119
  %"70" = add nsw i32 %i.0.i, 1, !dbg !120
  br label %main_bb11, !dbg !120

main_initLink.exit:                               ; preds = %main_bb11
  %"71" = sext i32 %cyclic.0.i to i64, !dbg !121
  %"72" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"71", !dbg !121
  %"73" = getelementptr inbounds %struct.NNode* %"72", i32 0, i32 1, !dbg !121
  store i32 %"44", i32* %"73", align 4, !dbg !121
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !122), !dbg !123
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !124), !dbg !125
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !126), !dbg !128
  call void @llvm.dbg.value(metadata !{i32 %"44"}, i64 0, metadata !129), !dbg !130
  br label %main_bb13, !dbg !131

main_bb13:                                        ; preds = %main_bb14, %main_initLink.exit
  %begin.0.i = phi i32 [ %"44", %main_initLink.exit ], [ %"82", %main_bb14 ], !dbg !127
  %"74" = sext i32 %begin.0.i to i64, !dbg !132
  %"75" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"74", !dbg !132
  %"76" = getelementptr inbounds %struct.NNode* %"75", i32 0, i32 1, !dbg !132
  %"77" = load i32* %"76", align 4, !dbg !132
  %"78" = icmp ne i32 %"77", %"44", !dbg !132
  br i1 %"78", label %main_bb14, label %main_findEnd.exit, !dbg !132

main_bb14:                                        ; preds = %main_bb13
  %"79" = sext i32 %begin.0.i to i64, !dbg !133
  %"80" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"79", !dbg !133
  %"81" = getelementptr inbounds %struct.NNode* %"80", i32 0, i32 1, !dbg !133
  %"82" = load i32* %"81", align 4, !dbg !133
  br label %main_bb13, !dbg !133

main_findEnd.exit:                                ; preds = %main_bb13, %main_bb17
  %h.0 = phi float [ %h.1, %main_bb17 ], [ 0.000000e+00, %main_bb13 ]
  %node.0 = phi i32 [ %"98", %main_bb17 ], [ %"44", %main_bb13 ]
  %"83" = icmp ne i32 %node.0, %begin.0.i, !dbg !134
  br i1 %"83", label %main_bb15, label %main_bb18, !dbg !134

main_bb15:                                        ; preds = %main_findEnd.exit
  %"84" = sext i32 %node.0 to i64, !dbg !136
  %"85" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"84", !dbg !136
  %"86" = getelementptr inbounds %struct.NNode* %"85", i32 0, i32 0, !dbg !136
  %"87" = load i32* %"86", align 4, !dbg !136
  %"88" = sitofp i32 %"87" to float, !dbg !136
  %"89" = fcmp ogt float %"88", %h.0, !dbg !136
  br i1 %"89", label %main_bb16, label %main_bb17, !dbg !136

main_bb16:                                        ; preds = %main_bb15
  %"90" = sext i32 %node.0 to i64, !dbg !139
  %"91" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"90", !dbg !139
  %"92" = getelementptr inbounds %struct.NNode* %"91", i32 0, i32 0, !dbg !139
  %"93" = load i32* %"92", align 4, !dbg !139
  %"94" = sitofp i32 %"93" to float, !dbg !139
  br label %main_bb17, !dbg !139

main_bb17:                                        ; preds = %main_bb16, %main_bb15
  %h.1 = phi float [ %"94", %main_bb16 ], [ %h.0, %main_bb15 ]
  %"95" = sext i32 %node.0 to i64, !dbg !140
  %"96" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"95", !dbg !140
  %"97" = getelementptr inbounds %struct.NNode* %"96", i32 0, i32 1, !dbg !140
  %"98" = load i32* %"97", align 4, !dbg !140
  br label %main_findEnd.exit, !dbg !141
...
!85 = metadata !{i32 786688, metadata !11, metadata !"num", metadata !5, i32 51, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num] [line 51]
!86 = metadata !{i32 51, i32 9, metadata !11, null}
!87 = metadata !{i32 52, i32 9, metadata !88, null}
!88 = metadata !{i32 786443, metadata !1, metadata !11, i32 52, i32 9, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!89 = metadata !{i32 52, i32 9, metadata !90, null}
!90 = metadata !{i32 786443, metadata !1, metadata !88, i32 52, i32 9, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!91 = metadata !{i32 786689, metadata !9, metadata !"n", metadata !5, i32 16777240, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [n] [line 24]
!92 = metadata !{i32 54, i32 16, metadata !11, null}
!93 = metadata !{i32 24, i32 18, metadata !9, metadata !92}
!94 = metadata !{i32 786689, metadata !4, metadata !"size", metadata !5, i32 16777234, metadata !8, i32 0, metadata !95} ; [ DW_TAG_arg_variable ] [size] [line 18]
!95 = metadata !{i32 25, i32 16, metadata !9, metadata !92}
!96 = metadata !{i32 18, i32 26, metadata !4, metadata !95}
!97 = metadata !{i32 19, i32 4, metadata !4, metadata !95}
!98 = metadata !{i32 786688, metadata !4, metadata !"allocatedIndex", metadata !5, i32 19, metadata !8, i32 0, metadata !95} ; [ DW_TAG_auto_variable ] [allocatedIndex] [line 19]
!99 = metadata !{i32 19, i32 8, metadata !4, metadata !95}
!100 = metadata !{i32 20, i32 4, metadata !4, metadata !95}
!101 = metadata !{i32 786688, metadata !9, metadata !"head", metadata !5, i32 25, metadata !8, i32 0, metadata !92} ; [ DW_TAG_auto_variable ] [head] [line 25]
!102 = metadata !{i32 25, i32 9, metadata !9, metadata !92}
!103 = metadata !{i32 26, i32 5, metadata !9, metadata !92}
!104 = metadata !{i32 27, i32 5, metadata !9, metadata !92}
!105 = metadata !{i32 786688, metadata !9, metadata !"cyclic", metadata !5, i32 28, metadata !8, i32 0, metadata !92} ; [ DW_TAG_auto_variable ] [cyclic] [line 28]
!106 = metadata !{i32 28, i32 9, metadata !9, metadata !92}
!107 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 30, metadata !8, i32 0, metadata !92} ; [ DW_TAG_auto_variable ] [i] [line 30]
!108 = metadata !{i32 30, i32 9, metadata !9, metadata !92}
!109 = metadata !{i32 786689, metadata !4, metadata !"size", metadata !5, i32 16777234, metadata !8, i32 0, metadata !110} ; [ DW_TAG_arg_variable ] [size] [line 18]
!110 = metadata !{i32 32, i32 20, metadata !56, metadata !92}
!111 = metadata !{i32 18, i32 26, metadata !4, metadata !110}
!112 = metadata !{i32 31, i32 10, metadata !57, metadata !92}
!113 = metadata !{i32 31, i32 10, metadata !65, metadata !92}
!114 = metadata !{i32 19, i32 4, metadata !4, metadata !110}
!115 = metadata !{i32 20, i32 4, metadata !4, metadata !110}
!116 = metadata !{i32 33, i32 9, metadata !56, metadata !92}
!117 = metadata !{i32 34, i32 9, metadata !56, metadata !92}
!118 = metadata !{i32 35, i32 9, metadata !56, metadata !92}
!119 = metadata !{i32 36, i32 9, metadata !56, metadata !92}
!120 = metadata !{i32 31, i32 21, metadata !57, metadata !92}
!121 = metadata !{i32 38, i32 5, metadata !9, metadata !92}
!122 = metadata !{i32 786688, metadata !11, metadata !"list", metadata !5, i32 54, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [list] [line 54]
!123 = metadata !{i32 54, i32 9, metadata !11, null}
!124 = metadata !{i32 786688, metadata !11, metadata !"node", metadata !5, i32 55, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [node] [line 55]
!125 = metadata !{i32 55, i32 9, metadata !11, null}
!126 = metadata !{i32 786689, metadata !10, metadata !"list", metadata !5, i32 16777257, metadata !8, i32 0, metadata !127} ; [ DW_TAG_arg_variable ] [list] [line 41]
!127 = metadata !{i32 56, i32 15, metadata !11, null}
!128 = metadata !{i32 41, i32 18, metadata !10, metadata !127}
!129 = metadata !{i32 786688, metadata !10, metadata !"begin", metadata !5, i32 43, metadata !8, i32 0, metadata !127} ; [ DW_TAG_auto_variable ] [begin] [line 43]
!130 = metadata !{i32 43, i32 9, metadata !10, metadata !127}
!131 = metadata !{i32 44, i32 5, metadata !10, metadata !127}
!132 = metadata !{i32 44, i32 5, metadata !82, metadata !127}
!133 = metadata !{i32 45, i32 9, metadata !10, metadata !127}
!134 = metadata !{i32 58, i32 5, metadata !135, null} ; [ DW_TAG_imported_module ]
!135 = metadata !{i32 786443, metadata !1, metadata !11, i32 58, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!136 = metadata !{i32 60, i32 13, metadata !137, null}
!137 = metadata !{i32 786443, metadata !1, metadata !138, i32 60, i32 13, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!138 = metadata !{i32 786443, metadata !1, metadata !11, i32 59, i32 5, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!139 = metadata !{i32 61, i32 13, metadata !137, null}
!140 = metadata !{i32 62, i32 9, metadata !138, null}
!141 = metadata !{i32 63, i32 5, metadata !138, null}
!142 = metadata !{i32 65, i32 1, metadata !11, null}
