...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %ac.0 = phi i64 [ 200, %main_bb5 ], [ %"17", %main_bb7 ], [ %"22", %main_bb9 ], [ %"13", %main_bb8 ]
  %"12" = icmp ne i64 %ac.0, -100, !dbg !56
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !56

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = add nsw i64 %ac.0, 1, !dbg !43
  %"14" = icmp sgt i64 %"13", 255, !dbg !59
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !59

main_bb7:                                         ; preds = %main_bb6
  %"15" = sub nsw i64 %"13", 255, !dbg !60
  %"16" = sub nsw i64 %"15", 1, !dbg !60
  %"17" = srem i64 %"16", 256, !dbg !60
  br label %main_wrap_around.exit, !dbg !60

main_bb8:                                         ; preds = %main_bb6
  %"18" = icmp slt i64 %"13", 0, !dbg !61
  br i1 %"18", label %main_bb9, label %main_wrap_around.exit, !dbg !61

main_bb9:                                         ; preds = %main_bb8
  %"19" = sub nsw i64 0, %"13", !dbg !62
  %"20" = sub nsw i64 %"19", 1, !dbg !62
  %"21" = srem i64 %"20", 256, !dbg !62
  %"22" = sub nsw i64 255, %"21", !dbg !62
