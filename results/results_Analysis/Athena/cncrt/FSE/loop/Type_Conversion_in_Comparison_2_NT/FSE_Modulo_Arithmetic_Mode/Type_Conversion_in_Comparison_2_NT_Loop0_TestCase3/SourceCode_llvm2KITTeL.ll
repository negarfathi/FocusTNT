...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !48), !dbg !49
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %ac.0 = phi i64 [ 255, %main_bb5 ], [ %"17", %main_bb7 ], [ %"22", %main_bb9 ], [ %"13", %main_bb8 ]
  %"12" = icmp ne i64 %ac.0, 0, !dbg !54
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !54

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = add nsw i64 %ac.0, 1, !dbg !43
  %"14" = icmp sgt i64 %"13", 255, !dbg !57
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !57

main_bb7:                                         ; preds = %main_bb6
  %"15" = sub nsw i64 %"13", 255, !dbg !58
  %"16" = sub nsw i64 %"15", 1, !dbg !58
  %"17" = srem i64 %"16", 256, !dbg !58
  br label %main_wrap_around.exit, !dbg !58

main_bb8:                                         ; preds = %main_bb6
  %"18" = icmp slt i64 %"13", 0, !dbg !59
  br i1 %"18", label %main_bb9, label %main_wrap_around.exit, !dbg !59

main_bb9:                                         ; preds = %main_bb8
  %"19" = sub nsw i64 0, %"13", !dbg !60
  %"20" = sub nsw i64 %"19", 1, !dbg !60
  %"21" = srem i64 %"20", 256, !dbg !60
  %"22" = sub nsw i64 255, %"21", !dbg !60
...
!46 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554445, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [lower_bound] [line 13]
!47 = metadata !{i32 13, i32 50, metadata !4, metadata !43}
!48 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331661, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [upper_bound] [line 13]
!49 = metadata !{i32 13, i32 73, metadata !4, metadata !43}
!50 = metadata !{i64 256}
!51 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 14, metadata !8, i32 0, metadata !43} ; [ DW_TAG_auto_variable ] [range] [line 14]
!52 = metadata !{i32 14, i32 15, metadata !4, metadata !43}
!53 = metadata !{i32 28, i32 7, metadata !44, null}
!54 = metadata !{i32 28, i32 7, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !56, i32 28, i32 7, i32 2, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 786443, metadata !1, metadata !44, i32 28, i32 7, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 15, i32 9, metadata !26, metadata !43}
!58 = metadata !{i32 16, i32 9, metadata !28, metadata !43}
!59 = metadata !{i32 18, i32 14, metadata !30, metadata !43}
!60 = metadata !{i32 19, i32 9, metadata !32, metadata !43}
!61 = metadata !{i32 32, i32 2, metadata !9, null}
