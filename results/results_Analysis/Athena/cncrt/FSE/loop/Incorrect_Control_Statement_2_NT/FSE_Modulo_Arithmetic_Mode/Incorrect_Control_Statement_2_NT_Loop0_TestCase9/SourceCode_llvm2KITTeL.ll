...
main_bb6:                                         ; preds = %main_wrap_around.exit
  ...
  br i1 %"17", label %main_bb7, label %main_bb8, !dbg !66
...
main_bb8:                                         ; preds = %main_bb6
  ...
  br i1 %"22", label %main_bb9, label %main_wrap_around.exit, !dbg !68
...
main_wrap_around.exit2:                           ; preds = %main_LeafBlock3, %main_bb18, %main_bb17, %main_bb16, %main_wrap_around.exit
  %i1.0 = phi i64 [ 0, %main_wrap_around.exit ], [ %i1.0, %main_LeafBlock3 ], [ %"43", %main_bb16 ], [ %"48", %main_bb18 ], [ %"38", %main_bb17 ]
  %"27" = icmp slt i64 %i1.0, 10, !dbg !70
  br i1 %"27", label %main_bb10, label %main_bb19, !dbg !70

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"28" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i1.0, !dbg !72
  %"29" = load i64* %"28", align 8, !dbg !72
...
main_bb11:                                        ; preds = %main_LeafBlock
  %"30" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !74
  %"31" = load i64* %"30", align 8, !dbg !74
  %"32" = icmp ne i64 %"31", 0, !dbg !74
  br i1 %"32", label %main_bb12, label %main_bb19, !dbg !74

main_bb12:                                        ; preds = %main_bb11
  %"33" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !77
  %"34" = load i64* %"33", align 8, !dbg !77
...
main_bb14:                                        ; preds = %main_bb13, %main_bb12
  ...
  %"37" = icmp ne i64 %table.0, 0, !dbg !81
  br i1 %"37", label %main_bb19, label %main_bb15, !dbg !81

main_bb15:                                        ; preds = %main_bb14
  %"38" = add nsw i64 %i1.0, 1, !dbg !83
  %"39" = icmp sgt i64 %"38", 2147483647, !dbg !84
  br i1 %"39", label %main_bb16, label %main_bb17, !dbg !84
...
main_bb17:                                        ; preds = %main_bb15
  ...
  br i1 %"44", label %main_bb18, label %main_wrap_around.exit2, !dbg !86
