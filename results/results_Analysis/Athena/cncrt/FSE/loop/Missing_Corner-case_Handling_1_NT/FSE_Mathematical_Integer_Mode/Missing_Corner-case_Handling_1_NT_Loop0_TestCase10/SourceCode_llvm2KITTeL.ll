...
read_bb1:                                         ; preds = %read_bb0
  ...
  %"4" = icmp sle i32 1000, 0, !dbg !23
  br i1 %"4", label %read_bb5, label %read_bb2, !dbg !23

read_bb2:                                         ; preds = %read_bb1
  %"5" = srem i32 1000, 1000, !dbg !25
  call void @llvm.dbg.value(metadata !{i32 %"5"}, i64 0, metadata !21), !dbg !22
  %"6" = icmp slt i32 %"5", 995, !dbg !27
  br i1 %"6", label %read_bb3, label %read_bb4, !dbg !27

read_bb3:                                         ; preds = %read_bb2
  %"7" = load i32* @"'count", align 4, !dbg !29
...
read_bb5:                                         ; preds = %read_bb1, %read_bb0, %read_bb4, %read_bb3
  %.0 = phi i32 [ %"5", %read_bb3 ], [ 0, %read_bb4 ], [ 0, %read_bb0 ], [ -1, %read_bb1 ]
  ret i32 %.0, !dbg !35
}
...
main_bb6:
  ...
  call void @llvm.dbg.value(metadata !20, i64 0, metadata !40), !dbg !41
  call void @llvm.dbg.value(metadata !42, i64 0, metadata !40), !dbg !41
  br label %main_bb7, !dbg !43

main_bb7:                                         ; preds = %main_read.exit, %main_bb6
  %"10" = icmp eq i32 %"9", 1, !dbg !36
  %"11" = load i32* @"'count", align 4, !dbg !37
  %"12" = icmp sgt i32 %"11", 100, !dbg !44
  %or.cond.i = or i1 %"10", %"12", !dbg !36
  br i1 %or.cond.i, label %main_read.exit, label %main_bb8, !dbg !36

main_bb8:                                         ; preds = %main_bb7
  %"13" = load i32* @"'count", align 4, !dbg !45
  %"14" = add nsw i32 %"13", 1, !dbg !45
  store i32 %"14", i32* @"'count", align 4, !dbg !45
  br label %main_read.exit, !dbg !46

main_read.exit:                                   ; preds = %main_bb7, %main_bb8
  %"15" = icmp slt i32 0, 0, !dbg !37
  br i1 %"15", label %main_bb9, label %main_bb7, !dbg !37

main_bb9:                                         ; preds = %main_read.exit
  ret i32 0, !dbg !47
}
...
!36 = metadata !{i32 14, i32 9, metadata !17, metadata !37}
...
!40 = metadata !{i32 786688, metadata !4, metadata !"num", metadata !5, i32 16, metadata !8, i32 0, metadata !37} ; [ DW_TAG_auto_variable ] [num] [line 16]
!41 = metadata !{i32 16, i32 9, metadata !4, metadata !37}
!42 = metadata !{i32 0}
!43 = metadata !{i32 39, i32 5, metadata !9, null}
!44 = metadata !{i32 14, i32 9, metadata !19, metadata !37}
!45 = metadata !{i32 26, i32 13, metadata !30, metadata !37}
!46 = metadata !{i32 27, i32 13, metadata !30, metadata !37}
!47 = metadata !{i32 44, i32 5, metadata !9, null}
