...
res_return_bb1:
  ...
  %. = select i1 %"3", i32 5, i32 -1, !dbg !26
  ret i32 %., !dbg !27
}
...
main_bb2:
  ...
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !32), !dbg !33
...
main_bb3:                                         ; preds = %main_NewDefault, %main_bb5, %main_bb2
  ...
  %"4" = icmp eq i32 %matroska.0, 1, !dbg !44
  %..i = select i1 %"4", i32 0, i32 1, !dbg !45
  %"5" = icmp ne i32 %..i, 0, !dbg !35
  br i1 %"5", label %main_bb4, label %main_bb8, !dbg !35

main_bb4:                                         ; preds = %main_bb7, %main_bb6, %main_bb3
  %res.1 = phi i32 [ %res.0, %main_bb3 ], [ %., %main_bb7 ], [ %"10", %main_bb6 ]
...
main_bb5:                                         ; preds = %main_LeafBlock
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !29), !dbg !30
...
main_bb6:                                         ; preds = %main_LeafBlock4
  %"6" = load i32* @"'flag", align 4, !dbg !48
  %"7" = add nsw i32 %"6", 1, !dbg !48
  store i32 %"7", i32* @"'flag", align 4, !dbg !48
  %"8" = icmp slt i32 %"6", 100, !dbg !48
  %..i3 = select i1 %"8", i32 5, i32 -1, !dbg !52
  %"9" = icmp slt i32 %..i3, 0, !dbg !49
  %"10" = zext i1 %"9" to i32, !dbg !49
  br i1 %"9", label %main_bb4, label %main_bb7, !dbg !49

main_bb7:                                         ; preds = %main_bb6
  %"11" = load i32* @"'flag", align 4, !dbg !53
  %"12" = add nsw i32 %"11", 1, !dbg !53
  store i32 %"12", i32* @"'flag", align 4, !dbg !53
  %"13" = icmp slt i32 %"11", 100, !dbg !53
  %..i2 = select i1 %"13", i32 5, i32 -1, !dbg !56
  %"14" = icmp eq i32 %..i2, 0, !dbg !54
  %"15" = zext i1 %"14" to i32, !dbg !54
  %. = select i1 %"14", i32 1, i32 %"15", !dbg !54
...
!26 = metadata !{i32 21, i32 9, metadata !25, null}
...
!38 = metadata !{i32 1}
!39 = metadata !{i32 786688, metadata !40, metadata !"id", metadata !5, i32 32, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [id] [line 32]
!40 = metadata !{i32 786443, metadata !1, metadata !41, i32 31, i32 9, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 786443, metadata !1, metadata !12, i32 29, i32 5, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 32, i32 17, metadata !40, null}
...
!47 = metadata !{i32 786443, metadata !1, metadata !41, i32 47, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 20, i32 9, metadata !25, metadata !49}
!49 = metadata !{i32 35, i32 31, metadata !50, null}
!50 = metadata !{i32 786443, metadata !1, metadata !51, i32 35, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 786443, metadata !1, metadata !40, i32 33, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 21, i32 9, metadata !25, metadata !49}
!53 = metadata !{i32 20, i32 9, metadata !25, metadata !54}
!54 = metadata !{i32 37, i32 31, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !51, i32 37, i32 25, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 21, i32 9, metadata !25, metadata !54}
!57 = metadata !{i32 39, i32 21, metadata !51, null}
!58 = metadata !{i32 50, i32 5, metadata !12, null}
