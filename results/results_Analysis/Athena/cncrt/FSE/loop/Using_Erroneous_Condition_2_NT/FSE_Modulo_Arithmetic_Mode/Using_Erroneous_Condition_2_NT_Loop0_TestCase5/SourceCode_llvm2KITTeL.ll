...
main_bb5:
  ...
  %"12" = icmp sgt i64 999999, 65534, !dbg !37
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"13" = icmp ne i64 999999, 0, !dbg !39
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !39

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = add nsw i64 %i.0, 1, !dbg !43
  %"15" = icmp sgt i64 %"14", 2147483647, !dbg !44
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !44

main_bb7:                                         ; preds = %main_bb6
  %"16" = sub nsw i64 %"14", 2147483647, !dbg !45
  %"17" = sub nsw i64 %"16", 1, !dbg !45
  %"18" = srem i64 %"17", 4294967296, !dbg !45
  %"19" = add nsw i64 -2147483648, %"18", !dbg !45
  br label %main_wrap_around.exit, !dbg !45

main_bb8:                                         ; preds = %main_bb6
  %"20" = icmp slt i64 %"14", -2147483648, !dbg !46
  br i1 %"20", label %main_bb9, label %main_wrap_around.exit, !dbg !46

main_bb9:                                         ; preds = %main_bb8
  %"21" = sub nsw i64 -2147483648, %"14", !dbg !47
  %"22" = sub nsw i64 %"21", 1, !dbg !47
  %"23" = srem i64 %"22", 4294967296, !dbg !47
  %"24" = sub nsw i64 2147483647, %"23", !dbg !47
...
!34 = metadata !{i64 999999}
!35 = metadata !{i32 786688, metadata !9, metadata !"reg_count", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [reg_count] [line 24]
...
!40 = metadata !{i32 786443, metadata !1, metadata !41, i32 29, i32 10, i32 2, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 786443, metadata !1, metadata !42, i32 29, i32 10, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!43 = metadata !{i32 29, i32 45, metadata !42, null}
!44 = metadata !{i32 14, i32 9, metadata !26, metadata !43}
!45 = metadata !{i32 15, i32 9, metadata !28, metadata !43}
!46 = metadata !{i32 17, i32 14, metadata !30, metadata !43}
!47 = metadata !{i32 18, i32 9, metadata !32, metadata !43}
!48 = metadata !{i32 34, i32 1, metadata !9, null}
