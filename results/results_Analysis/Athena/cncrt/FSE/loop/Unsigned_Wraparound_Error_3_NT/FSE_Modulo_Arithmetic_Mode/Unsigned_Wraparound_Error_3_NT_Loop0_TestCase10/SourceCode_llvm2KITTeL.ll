...
main_bb5:
  ...
  %"12" = icmp eq i64 95, 0, !dbg !43
  br i1 %"12", label %main_bb17, label %main_bb6, !dbg !43

main_bb6:                                         ; preds = %main_bb5
  %"13" = add nsw i64 95, 4294967288, !dbg !45
...
main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_wrap_around.exit
  %newbufsize.0 = phi i64 [ 95, %main_wrap_around.exit ], [ %"41", %main_bb14 ], [ %"46", %main_bb16 ], [ %"37", %main_bb15 ]
  %"25" = add nsw i64 4294967200, 4294967288, !dbg !62
  %"26" = add nsw i64 %"25", 1, !dbg !62
  %"27" = icmp sgt i64 %"26", 4294967295, !dbg !63
  br i1 %"27", label %main_bb10, label %main_bb11, !dbg !63
...
main_bb11:                                        ; preds = %main_wrap_around.exit2
  ...
  br i1 %"31", label %main_bb12, label %main_wrap_around.exit4, !dbg !65
...
main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  %.0.i3 = phi i64 [ %"30", %main_bb10 ], [ %"35", %main_bb12 ], [ %"26", %main_bb11 ], !dbg !62
  %"36" = icmp slt i64 %newbufsize.0, %.0.i3, !dbg !62
  br i1 %"36", label %main_bb13, label %main_bb17, !dbg !62

main_bb13:                                        ; preds = %main_wrap_around.exit4
  %"37" = mul nsw i64 %newbufsize.0, 2, !dbg !67
  %"38" = icmp sgt i64 %"37", 4294967295, !dbg !69
  br i1 %"38", label %main_bb14, label %main_bb15, !dbg !69

main_bb14:                                        ; preds = %main_bb13
  %"39" = sub nsw i64 %"37", 4294967295, !dbg !70
  %"40" = sub nsw i64 %"39", 1, !dbg !70
  %"41" = srem i64 %"40", 4294967296, !dbg !70
  br label %main_wrap_around.exit2, !dbg !70

main_bb15:                                        ; preds = %main_bb13
  %"42" = icmp slt i64 %"37", 0, !dbg !71
  br i1 %"42", label %main_bb16, label %main_wrap_around.exit2, !dbg !71

main_bb16:                                        ; preds = %main_bb15
  %"43" = sub nsw i64 0, %"37", !dbg !72
  %"44" = sub nsw i64 %"43", 1, !dbg !72
  %"45" = srem i64 %"44", 4294967296, !dbg !72
  %"46" = sub nsw i64 4294967295, %"45", !dbg !72
