...
int main()
{
    char buf[100] = {'h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','h','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','e','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','o','o','o','o','o','o','o','o','o','o','o','o','o','o','o','X','X','X','X','X','X','X','X','X','Y'};
    for( int i = 0 ; i < 99 ; i++ )
        ;
    buf[99] = '\0';
    char *p = buf;
