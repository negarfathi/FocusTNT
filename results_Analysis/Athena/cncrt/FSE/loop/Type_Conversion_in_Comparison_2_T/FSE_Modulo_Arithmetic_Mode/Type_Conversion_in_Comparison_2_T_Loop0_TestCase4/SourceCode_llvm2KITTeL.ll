...
main_wrap_around.exit2:                           ; preds = %main_bb12, %main_bb11, %main_bb10, %main_bb5
  ...
  %"14" = icmp sgt i64 127, 255, !dbg !65
  br i1 %"14", label %main_bb6, label %main_bb7, !dbg !65

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"15" = sub nsw i64 127, 255, !dbg !66
  %"16" = sub nsw i64 %"15", 1, !dbg !66
  %"17" = srem i64 %"16", 256, !dbg !66
  br label %main_wrap_around.exit, !dbg !66

main_bb7:                                         ; preds = %main_wrap_around.exit2
  %"18" = icmp slt i64 127, 0, !dbg !67
  br i1 %"18", label %main_bb8, label %main_wrap_around.exit, !dbg !67

main_bb8:                                         ; preds = %main_bb7
  %"19" = sub nsw i64 0, 127, !dbg !68
  %"20" = sub nsw i64 %"19", 1, !dbg !68
  %"21" = srem i64 %"20", 256, !dbg !68
  %"22" = sub nsw i64 255, %"21", !dbg !68
  br label %main_wrap_around.exit, !dbg !68

main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  %.0.i = phi i64 [ %"17", %main_bb6 ], [ %"22", %main_bb8 ], [ 127, %main_bb7 ], !dbg !45
  %"23" = icmp ne i64 %ac.0, %.0.i, !dbg !45
  br i1 %"23", label %main_bb9, label %main_bb13, !dbg !45

main_bb9:                                         ; preds = %main_wrap_around.exit
  %"24" = add nsw i64 %ac.0, 1, !dbg !57
  %"25" = icmp sgt i64 %"24", 255, !dbg !69
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !69

main_bb10:                                        ; preds = %main_bb9
  %"26" = sub nsw i64 %"24", 255, !dbg !70
  %"27" = sub nsw i64 %"26", 1, !dbg !70
  %"28" = srem i64 %"27", 256, !dbg !70
  br label %main_wrap_around.exit2, !dbg !70

main_bb11:                                        ; preds = %main_bb9
  %"29" = icmp slt i64 %"24", 0, !dbg !71
  br i1 %"29", label %main_bb12, label %main_wrap_around.exit2, !dbg !71

main_bb12:                                        ; preds = %main_bb11
  %"30" = sub nsw i64 0, %"24", !dbg !72
  %"31" = sub nsw i64 %"30", 1, !dbg !72
  %"32" = srem i64 %"31", 256, !dbg !72
  %"33" = sub nsw i64 255, %"32", !dbg !72
