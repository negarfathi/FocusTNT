...
main_bb0:
  ...
  call void @llvm.dbg.value(metadata !14, i64 0, metadata !18), !dbg !19
...
main_bb1:                                         ; preds = %main_bb2, %main_bb0
  ...
  %"0" = mul nsw i32 %bytes.0, 8, !dbg !21
  store i32 %"0", i32* @"'gtv_0", align 4, !dbg !21
  %"1" = lshr i32 1, %"0", !dbg !21
  %"2" = icmp ne i32 %"1", 0, !dbg !21
  %"3" = icmp slt i32 %bytes.0, 4, !dbg !23
  %. = select i1 %"2", i1 %"3", i1 false, !dbg !21
  br i1 %., label %main_bb2, label %main_bb3, !dbg !25

main_bb2:                                         ; preds = %main_bb1
  %"4" = add nsw i32 %bytes.0, 1, !dbg !27
...
!18 = metadata !{i32 786688, metadata !4, metadata !"bytes", metadata !5, i32 14, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [bytes] [line 14]
...
!22 = metadata !{i32 786443, metadata !1, metadata !4, i32 15, i32 5, i32 1, i32 0} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!23 = metadata !{i32 15, i32 5, metadata !24, null}
!24 = metadata !{i32 786443, metadata !1, metadata !4, i32 15, i32 5, i32 2, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!25 = metadata !{i32 15, i32 5, metadata !26, null}
!26 = metadata !{i32 786443, metadata !1, metadata !4, i32 15, i32 5, i32 3, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!27 = metadata !{i32 16, i32 9, metadata !4, null}
