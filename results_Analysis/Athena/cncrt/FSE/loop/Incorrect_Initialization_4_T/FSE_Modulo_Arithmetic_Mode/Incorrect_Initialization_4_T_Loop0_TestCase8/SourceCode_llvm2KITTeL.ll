...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  ...
  call void @llvm.dbg.value(metadata !{i64 %"42"}, i64 0, metadata !74), !dbg !77
  ...
  %"28" = srem i64 15, 5, !dbg !84
  call void @llvm.dbg.value(metadata !{i64 %"31"}, i64 0, metadata !87), !dbg !88
...
main_wrap_around.exit2:                           ; preds = %main_bb17, %main_bb16, %main_bb15, %main_wrap_around.exit
  ...
  %"29" = icmp slt i64 %i.0, 20, !dbg !96
  br i1 %"29", label %main_bb10, label %main_bb18, !dbg !96

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"30" = icmp ne i64 %r.0, 0, !dbg !98
  br i1 %"30", label %main_wrap_around.exit4, label %main_bb11, !dbg !98

main_bb11:                                        ; preds = %main_bb10
  %"31" = add nsw i64 %"28", 1, !dbg !84
  %"32" = icmp sgt i64 %"31", 2147483647, !dbg !99
  br i1 %"32", label %main_bb12, label %main_bb13, !dbg !99
...
main_bb13:                                        ; preds = %main_bb11
  ...
  br i1 %"37", label %main_bb14, label %main_wrap_around.exit4, !dbg !101
...
main_wrap_around.exit4:                           ; preds = %main_bb14, %main_bb13, %main_bb12, %main_bb10
  ...
  %"42" = add nsw i64 %i.0, %r.1, !dbg !75
  %"43" = icmp sgt i64 %"42", 2147483647, !dbg !103
  br i1 %"43", label %main_bb15, label %main_bb16, !dbg !103

main_bb15:                                        ; preds = %main_wrap_around.exit4
  %"44" = sub nsw i64 %"42", 2147483647, !dbg !104
  %"45" = sub nsw i64 %"44", 1, !dbg !104
  %"46" = srem i64 %"45", 4294967296, !dbg !104
  %"47" = add nsw i64 -2147483648, %"46", !dbg !104
  br label %main_wrap_around.exit2, !dbg !104

main_bb16:                                        ; preds = %main_wrap_around.exit4
  %"48" = icmp slt i64 %"42", -2147483648, !dbg !105
  br i1 %"48", label %main_bb17, label %main_wrap_around.exit2, !dbg !105

main_bb17:                                        ; preds = %main_bb16
  %"49" = sub nsw i64 -2147483648, %"42", !dbg !106
  %"50" = sub nsw i64 %"49", 1, !dbg !106
  %"51" = srem i64 %"50", 4294967296, !dbg !106
  %"52" = sub nsw i64 2147483647, %"51", !dbg !106
