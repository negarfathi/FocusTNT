...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !44), !dbg !47
  ...
  call void @llvm.dbg.value(metadata !{i64 %.0.i}, i64 0, metadata !40), !dbg !41
  call void @llvm.dbg.value(metadata !{i64 %"24"}, i64 0, metadata !57), !dbg !59
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !60), !dbg !61
...
main_wrap_around.exit2:                           ; preds = %main_bb12, %main_bb11, %main_bb10, %main_bb5
  %s.0 = phi i64 [ 60000, %main_bb5 ], [ %"28", %main_bb10 ], [ %"33", %main_bb12 ], [ %"24", %main_bb11 ]
  %i.0 = phi i64 [ 0, %main_bb5 ], [ %.0.i, %main_bb10 ], [ %.0.i, %main_bb11 ], [ %.0.i, %main_bb12 ]
  %"12" = icmp slt i64 %i.0, 60000, !dbg !69
  br i1 %"12", label %main_bb6, label %main_bb13, !dbg !69

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"13" = add nsw i64 %i.0, 1, !dbg !45
  %"14" = icmp sgt i64 %"13", 2147483647, !dbg !72
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !72

main_bb7:                                         ; preds = %main_bb6
  %"15" = sub nsw i64 %"13", 2147483647, !dbg !73
  %"16" = sub nsw i64 %"15", 1, !dbg !73
  %"17" = srem i64 %"16", 4294967296, !dbg !73
  %"18" = add nsw i64 -2147483648, %"17", !dbg !73
  br label %main_wrap_around.exit, !dbg !73

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"13", -2147483648, !dbg !74
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !74

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 -2147483648, %"13", !dbg !75
  %"21" = sub nsw i64 %"20", 1, !dbg !75
  %"22" = srem i64 %"21", 4294967296, !dbg !75
  %"23" = sub nsw i64 2147483647, %"22", !dbg !75
  br label %main_wrap_around.exit, !dbg !75

main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  %.0.i = phi i64 [ %"18", %main_bb7 ], [ %"23", %main_bb9 ], [ %"13", %main_bb8 ], !dbg !45
  %"24" = add nsw i64 %s.0, 1, !dbg !58
  %"25" = icmp sgt i64 %"24", 65535, !dbg !76
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !76

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"26" = sub nsw i64 %"24", 65535, !dbg !77
  %"27" = sub nsw i64 %"26", 1, !dbg !77
  %"28" = srem i64 %"27", 65536, !dbg !77
  br label %main_wrap_around.exit2, !dbg !77

main_bb11:                                        ; preds = %main_wrap_around.exit
  %"29" = icmp slt i64 %"24", 0, !dbg !78
  br i1 %"29", label %main_bb12, label %main_wrap_around.exit2, !dbg !78

main_bb12:                                        ; preds = %main_bb11
  %"30" = sub nsw i64 0, %"24", !dbg !79
  %"31" = sub nsw i64 %"30", 1, !dbg !79
  %"32" = srem i64 %"31", 65536, !dbg !79
  %"33" = sub nsw i64 65535, %"32", !dbg !79
...
!37 = metadata !{i32 786688, metadata !9, metadata !"len", metadata !5, i32 25, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [len] [line 25]
!38 = metadata !{i32 25, i32 15, metadata !9, null}
!39 = metadata !{i64 0}
!40 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 28, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 28]
!41 = metadata !{i32 28, i32 15, metadata !9, null}
!42 = metadata !{i32 786688, metadata !9, metadata !"s", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [s] [line 24]
!43 = metadata !{i32 24, i32 15, metadata !9, null}
...
!45 = metadata !{i32 29, i32 44, metadata !46, null}
...
!58 = metadata !{i32 29, i32 88, metadata !46, null}
...
!65 = metadata !{i64 65536}
!66 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !58} ; [ DW_TAG_auto_variable ] [range] [line 13]
!67 = metadata !{i32 13, i32 15, metadata !4, metadata !58}
!68 = metadata !{i32 29, i32 10, metadata !46, null}
!69 = metadata !{i32 29, i32 10, metadata !70, null}
!70 = metadata !{i32 786443, metadata !1, metadata !71, i32 29, i32 10, i32 2, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 786443, metadata !1, metadata !46, i32 29, i32 10, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!72 = metadata !{i32 14, i32 9, metadata !26, metadata !45}
!73 = metadata !{i32 15, i32 9, metadata !28, metadata !45}
!74 = metadata !{i32 17, i32 14, metadata !30, metadata !45}
!75 = metadata !{i32 18, i32 9, metadata !32, metadata !45}
...
!80 = metadata !{i32 33, i32 5, metadata !9, null}
