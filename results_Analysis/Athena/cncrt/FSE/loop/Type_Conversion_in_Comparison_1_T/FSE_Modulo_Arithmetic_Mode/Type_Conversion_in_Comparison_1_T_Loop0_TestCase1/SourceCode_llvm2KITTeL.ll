...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !43), !dbg !46
  ...
  call void @llvm.dbg.value(metadata !{i64 %.0.i}, i64 0, metadata !39), !dbg !40
  call void @llvm.dbg.value(metadata !{i64 %"24"}, i64 0, metadata !56), !dbg !58
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !59), !dbg !60
...
main_wrap_around.exit2:                           ; preds = %main_bb12, %main_bb11, %main_bb10, %main_bb5
  %s.0 = phi i64 [ 0, %main_bb5 ], [ %"28", %main_bb10 ], [ %"33", %main_bb12 ], [ %"24", %main_bb11 ]
  %i.0 = phi i64 [ 0, %main_bb5 ], [ %.0.i, %main_bb10 ], [ %.0.i, %main_bb11 ], [ %.0.i, %main_bb12 ]
  %"12" = icmp slt i64 %i.0, 0, !dbg !68
  br i1 %"12", label %main_bb6, label %main_bb13, !dbg !68

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"13" = add nsw i64 %i.0, 1, !dbg !44
  %"14" = icmp sgt i64 %"13", 2147483647, !dbg !71
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !71

main_bb7:                                         ; preds = %main_bb6
  %"15" = sub nsw i64 %"13", 2147483647, !dbg !72
  %"16" = sub nsw i64 %"15", 1, !dbg !72
  %"17" = srem i64 %"16", 4294967296, !dbg !72
  %"18" = add nsw i64 -2147483648, %"17", !dbg !72
  br label %main_wrap_around.exit, !dbg !72

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"13", -2147483648, !dbg !73
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !73

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 -2147483648, %"13", !dbg !74
  %"21" = sub nsw i64 %"20", 1, !dbg !74
  %"22" = srem i64 %"21", 4294967296, !dbg !74
  %"23" = sub nsw i64 2147483647, %"22", !dbg !74
...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  ...
  %"24" = add nsw i64 %s.0, 1, !dbg !57
  %"25" = icmp sgt i64 %"24", 65535, !dbg !75
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !75

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"26" = sub nsw i64 %"24", 65535, !dbg !76
  %"27" = sub nsw i64 %"26", 1, !dbg !76
  %"28" = srem i64 %"27", 65536, !dbg !76
  br label %main_wrap_around.exit2, !dbg !76

main_bb11:                                        ; preds = %main_wrap_around.exit
  %"29" = icmp slt i64 %"24", 0, !dbg !77
  br i1 %"29", label %main_bb12, label %main_wrap_around.exit2, !dbg !77

main_bb12:                                        ; preds = %main_bb11
  %"30" = sub nsw i64 0, %"24", !dbg !78
  %"31" = sub nsw i64 %"30", 1, !dbg !78
  %"32" = srem i64 %"31", 65536, !dbg !78
  %"33" = sub nsw i64 65535, %"32", !dbg !78
...
!39 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 28, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 28]
!40 = metadata !{i32 28, i32 15, metadata !9, null}
!41 = metadata !{i32 786688, metadata !9, metadata !"s", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [s] [line 24]
...
!44 = metadata !{i32 29, i32 44, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !9, i32 29, i32 5, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 12, i32 33, metadata !4, metadata !44}
!47 = metadata !{i64 -2147483648}
!48 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !44} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!49 = metadata !{i32 12, i32 50, metadata !4, metadata !44}
...
!57 = metadata !{i32 29, i32 88, metadata !45, null}
...
!64 = metadata !{i64 65536}
!65 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !57} ; [ DW_TAG_auto_variable ] [range] [line 13]
!66 = metadata !{i32 13, i32 15, metadata !4, metadata !57}
!67 = metadata !{i32 29, i32 10, metadata !45, null}
!68 = metadata !{i32 29, i32 10, metadata !69, null}
!69 = metadata !{i32 786443, metadata !1, metadata !70, i32 29, i32 10, i32 2, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!70 = metadata !{i32 786443, metadata !1, metadata !45, i32 29, i32 10, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 14, i32 9, metadata !26, metadata !44}
!72 = metadata !{i32 15, i32 9, metadata !28, metadata !44}
!73 = metadata !{i32 17, i32 14, metadata !30, metadata !44}
!74 = metadata !{i32 18, i32 9, metadata !32, metadata !44}
...
!79 = metadata !{i32 33, i32 5, metadata !9, null}
