...
main_wrap_around.exit2:                           ; preds = %main_bb12, %main_bb11, %main_bb10, %main_bb5
  ...
  %"12" = icmp slt i64 %i.0, 30000, !dbg !70
  br i1 %"12", label %main_bb6, label %main_bb13, !dbg !70

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"13" = add nsw i64 %i.0, 1, !dbg !46
  %"14" = icmp sgt i64 %"13", 2147483647, !dbg !73
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !73

main_bb7:                                         ; preds = %main_bb6
  %"15" = sub nsw i64 %"13", 2147483647, !dbg !74
  %"16" = sub nsw i64 %"15", 1, !dbg !74
  %"17" = srem i64 %"16", 4294967296, !dbg !74
  %"18" = add nsw i64 -2147483648, %"17", !dbg !74
  br label %main_wrap_around.exit, !dbg !74

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"13", -2147483648, !dbg !75
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !75

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 -2147483648, %"13", !dbg !76
  %"21" = sub nsw i64 %"20", 1, !dbg !76
  %"22" = srem i64 %"21", 4294967296, !dbg !76
  %"23" = sub nsw i64 2147483647, %"22", !dbg !76
...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  ...
  %"25" = icmp sgt i64 %"24", 65535, !dbg !77
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !77

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"26" = sub nsw i64 %"24", 65535, !dbg !78
  %"27" = sub nsw i64 %"26", 1, !dbg !78
  %"28" = srem i64 %"27", 65536, !dbg !78
  br label %main_wrap_around.exit2, !dbg !78

main_bb11:                                        ; preds = %main_wrap_around.exit
  %"29" = icmp slt i64 %"24", 0, !dbg !79
  br i1 %"29", label %main_bb12, label %main_wrap_around.exit2, !dbg !79

main_bb12:                                        ; preds = %main_bb11
  %"30" = sub nsw i64 0, %"24", !dbg !80
  %"31" = sub nsw i64 %"30", 1, !dbg !80
  %"32" = srem i64 %"31", 65536, !dbg !80
  %"33" = sub nsw i64 65535, %"32", !dbg !80
