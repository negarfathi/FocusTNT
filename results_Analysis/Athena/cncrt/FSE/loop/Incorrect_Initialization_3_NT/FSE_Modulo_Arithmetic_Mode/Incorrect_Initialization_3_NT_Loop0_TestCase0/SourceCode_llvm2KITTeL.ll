...
main_bb17:                                        ; preds = %main_strchr.exit, %main_bb16
  %p.0 = phi i32 [ %"24", %main_bb16 ], [ %..0.i, %main_strchr.exit ]
...
main_strchr.exit:                                 ; preds = %main_bb18, %main_bb19
  ...
  call void @llvm.dbg.value(metadata !{i32 %..0.i}, i64 0, metadata !103), !dbg !104
  br label %main_bb17, !dbg !125
...
!125 = metadata !{i32 55, i32 5, metadata !108, null}
!126 = metadata !{i32 56, i32 5, metadata !16, null}
