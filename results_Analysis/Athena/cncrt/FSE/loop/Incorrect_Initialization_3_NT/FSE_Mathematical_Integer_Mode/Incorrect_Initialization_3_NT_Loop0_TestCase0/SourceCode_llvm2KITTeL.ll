...
main_bb10:                                        ; preds = %main_strchr.exit, %main_bb9
  %p.0 = phi i32 [ %"14", %main_bb9 ], [ %..0.i, %main_strchr.exit ]
...
main_strchr.exit:                                 ; preds = %main_bb11, %main_bb12
  ...
  call void @llvm.dbg.value(metadata !{i32 %..0.i}, i64 0, metadata !66), !dbg !67
...
!87 = metadata !{i32 39, i32 5, metadata !71, null}
!88 = metadata !{i32 40, i32 5, metadata !12, null}
