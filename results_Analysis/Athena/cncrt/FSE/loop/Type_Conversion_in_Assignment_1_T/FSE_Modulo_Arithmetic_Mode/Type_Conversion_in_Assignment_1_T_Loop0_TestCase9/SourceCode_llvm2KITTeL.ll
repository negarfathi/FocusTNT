...
main_bb15:
  ...
  call void @llvm.dbg.value(metadata !103, i64 0, metadata !101), !dbg !102
  br label %main_bb16, !dbg !113

main_bb16:                                        ; preds = %main_fgetc.exit, %main_bb15
  %"39" = load i64* @"'flag", align 8, !dbg !114
  %"40" = icmp sgt i64 %"39", 1000, !dbg !114
  br i1 %"40", label %main_fgetc.exit, label %main_bb17, !dbg !114

main_bb17:                                        ; preds = %main_bb16
  %"41" = load i64* @"'flag", align 8, !dbg !90
  %"42" = add nsw i64 %"41", 1, !dbg !90
  %"43" = icmp sgt i64 %"42", 2147483647, !dbg !115
  br i1 %"43", label %main_bb18, label %main_bb19, !dbg !115

main_bb18:                                        ; preds = %main_bb17
  %"44" = sub nsw i64 %"42", 2147483647, !dbg !116
  %"45" = sub nsw i64 %"44", 1, !dbg !116
  %"46" = srem i64 %"45", 4294967296, !dbg !116
  %"47" = add nsw i64 -2147483648, %"46", !dbg !116
  br label %main_wrap_around.exit.i, !dbg !116

main_bb19:                                        ; preds = %main_bb17
  %"48" = icmp slt i64 %"42", -2147483648, !dbg !117
  br i1 %"48", label %main_bb20, label %main_wrap_around.exit.i, !dbg !117

main_bb20:                                        ; preds = %main_bb19
  %"49" = sub nsw i64 -2147483648, %"42", !dbg !118
  %"50" = sub nsw i64 %"49", 1, !dbg !118
  %"51" = srem i64 %"50", 4294967296, !dbg !118
  %"52" = sub nsw i64 2147483647, %"51", !dbg !118
  br label %main_wrap_around.exit.i, !dbg !118
...
main_wrap_around.exit.i:                          ; preds = %main_bb20, %main_bb19, %main_bb18
  ...
  br label %main_fgetc.exit, !dbg !119

main_fgetc.exit:                                  ; preds = %main_bb16, %main_wrap_around.exit.i
  %.0.i = phi i64 [ 255, %main_wrap_around.exit.i ], [ -1, %main_bb16 ], !dbg !91
  %cond = icmp eq i64 %.0.i, -1, !dbg !120
  br i1 %cond, label %main_bb21, label %main_bb16, !dbg !120
...
!105 = metadata !{i32 35, i32 9, metadata !9, metadata !91}
...
!113 = metadata !{i32 41, i32 5, metadata !93, null}
!114 = metadata !{i32 25, i32 9, metadata !40, metadata !91}
!115 = metadata !{i32 15, i32 9, metadata !31, metadata !90}
!116 = metadata !{i32 16, i32 9, metadata !33, metadata !90}
!117 = metadata !{i32 18, i32 14, metadata !35, metadata !90}
!118 = metadata !{i32 19, i32 9, metadata !37, metadata !90}
!119 = metadata !{i32 36, i32 5, metadata !9, metadata !91}
!120 = metadata !{i32 44, i32 13, metadata !121, null}
!121 = metadata !{i32 786443, metadata !1, metadata !92, i32 44, i32 13, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!122 = metadata !{i32 60, i32 1, metadata !12, null}
