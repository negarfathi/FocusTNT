...
fgetc_wrap_around.exit3:                          ; preds = %fgetc_bb13, %fgetc_bb12, %fgetc_bb11, %fgetc_wrap_around.exit
  %c.0 = phi i64 [ 255, %fgetc_wrap_around.exit ], [ %"32", %fgetc_bb11 ], [ %"37", %fgetc_bb13 ], [ %"27", %fgetc_bb12 ]
...
main_bb15:
  ...
  call void @llvm.dbg.value(metadata !57, i64 0, metadata !103), !dbg !105
  ...
  call void @llvm.dbg.value(metadata !57, i64 0, metadata !101), !dbg !102
  br label %main_bb16, !dbg !112

main_bb16:                                        ; preds = %main_fgetc.exit, %main_bb15
  %"39" = load i64* @"'flag", align 8, !dbg !113
  %"40" = icmp sgt i64 %"39", 1000, !dbg !113
  br i1 %"40", label %main_fgetc.exit, label %main_bb17, !dbg !113

main_bb17:                                        ; preds = %main_bb16
  %"41" = load i64* @"'flag", align 8, !dbg !90
  %"42" = add nsw i64 %"41", 1, !dbg !90
  %"43" = icmp sgt i64 %"42", 2147483647, !dbg !114
  br i1 %"43", label %main_bb18, label %main_bb19, !dbg !114

main_bb18:                                        ; preds = %main_bb17
  %"44" = sub nsw i64 %"42", 2147483647, !dbg !115
  %"45" = sub nsw i64 %"44", 1, !dbg !115
  %"46" = srem i64 %"45", 4294967296, !dbg !115
  %"47" = add nsw i64 -2147483648, %"46", !dbg !115
  br label %main_wrap_around.exit.i, !dbg !115

main_bb19:                                        ; preds = %main_bb17
  %"48" = icmp slt i64 %"42", -2147483648, !dbg !116
  br i1 %"48", label %main_bb20, label %main_wrap_around.exit.i, !dbg !116

main_bb20:                                        ; preds = %main_bb19
  %"49" = sub nsw i64 -2147483648, %"42", !dbg !117
  %"50" = sub nsw i64 %"49", 1, !dbg !117
  %"51" = srem i64 %"50", 4294967296, !dbg !117
  %"52" = sub nsw i64 2147483647, %"51", !dbg !117
...
!104 = metadata !{i32 35, i32 9, metadata !9, metadata !91}
...
!112 = metadata !{i32 41, i32 5, metadata !93, null}
!113 = metadata !{i32 25, i32 9, metadata !40, metadata !91}
!114 = metadata !{i32 15, i32 9, metadata !31, metadata !90}
!115 = metadata !{i32 16, i32 9, metadata !33, metadata !90}
!116 = metadata !{i32 18, i32 14, metadata !35, metadata !90}
!117 = metadata !{i32 19, i32 9, metadata !37, metadata !90}
!118 = metadata !{i32 36, i32 5, metadata !9, metadata !91}
!119 = metadata !{i32 44, i32 13, metadata !120, null}
!120 = metadata !{i32 786443, metadata !1, metadata !92, i32 44, i32 13, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!121 = metadata !{i32 60, i32 1, metadata !12, null}
