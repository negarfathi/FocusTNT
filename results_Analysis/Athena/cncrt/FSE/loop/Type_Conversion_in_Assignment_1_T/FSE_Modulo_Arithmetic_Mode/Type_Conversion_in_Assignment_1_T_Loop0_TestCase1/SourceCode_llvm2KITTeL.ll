...
fgetc_wrap_around.exit3:                          ; preds = %fgetc_bb13, %fgetc_bb12, %fgetc_bb11, %fgetc_wrap_around.exit
  %c.0 = phi i64 [ 0, %fgetc_wrap_around.exit ], [ %"32", %fgetc_bb11 ], [ %"37", %fgetc_bb13 ], [ %"27", %fgetc_bb12 ]
...
!119 = metadata !{i32 60, i32 1, metadata !12, null}
