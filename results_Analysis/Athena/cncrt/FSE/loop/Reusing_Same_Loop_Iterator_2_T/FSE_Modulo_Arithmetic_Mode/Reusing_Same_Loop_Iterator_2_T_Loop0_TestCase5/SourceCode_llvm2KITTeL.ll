...
main_bb5:
  ...
  %"12" = icmp sgt i64 100000, 65534, !dbg !37
  br i1 %"12", label %main_bb14, label %main_wrap_around.exit2, !dbg !37
...
main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  ...
  %"13" = icmp slt i64 %i.0, 100000, !dbg !39
  br i1 %"13", label %main_wrap_around.exit, label %main_bb14, !dbg !39
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"14" = icmp slt i64 %j.0, 3, !dbg !43
  br i1 %"14", label %main_bb6, label %main_bb10, !dbg !43

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"15" = add nsw i64 %j.0, 1, !dbg !48
  %"16" = icmp sgt i64 %"15", 2147483647, !dbg !49
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !49
...
main_bb8:                                         ; preds = %main_bb6
  ...
  br i1 %"21", label %main_bb9, label %main_wrap_around.exit, !dbg !51
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  %"26" = add nsw i64 %i.0, 1, !dbg !53
  call void @llvm.dbg.value(metadata !{i64 %"26"}, i64 0, metadata !54), !dbg !55
  ...
  %"27" = icmp sgt i64 %"26", 2147483647, !dbg !65
  br i1 %"27", label %main_bb11, label %main_bb12, !dbg !65

main_bb11:                                        ; preds = %main_bb10
  %"28" = sub nsw i64 %"26", 2147483647, !dbg !66
  %"29" = sub nsw i64 %"28", 1, !dbg !66
  %"30" = srem i64 %"29", 4294967296, !dbg !66
  %"31" = add nsw i64 -2147483648, %"30", !dbg !66
  br label %main_wrap_around.exit2, !dbg !66

main_bb12:                                        ; preds = %main_bb10
  %"32" = icmp slt i64 %"26", -2147483648, !dbg !67
  br i1 %"32", label %main_bb13, label %main_wrap_around.exit2, !dbg !67

main_bb13:                                        ; preds = %main_bb12
  %"33" = sub nsw i64 -2147483648, %"26", !dbg !68
  %"34" = sub nsw i64 %"33", 1, !dbg !68
  %"35" = srem i64 %"34", 4294967296, !dbg !68
  %"36" = sub nsw i64 2147483647, %"35", !dbg !68
...
!35 = metadata !{i32 786688, metadata !9, metadata !"num", metadata !5, i32 25, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num] [line 25]
...
!39 = metadata !{i32 30, i32 10, metadata !40, null}
!40 = metadata !{i32 786443, metadata !1, metadata !41, i32 30, i32 10, i32 2, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 786443, metadata !1, metadata !42, i32 30, i32 10, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 33, i32 14, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !45, i32 33, i32 14, i32 2, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 786443, metadata !1, metadata !46, i32 33, i32 14, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 786443, metadata !1, metadata !47, i32 33, i32 9, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 786443, metadata !1, metadata !42, i32 31, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 33, i32 35, metadata !46, null}
!49 = metadata !{i32 14, i32 9, metadata !26, metadata !48}
!50 = metadata !{i32 15, i32 9, metadata !28, metadata !48}
!51 = metadata !{i32 17, i32 14, metadata !30, metadata !48}
!52 = metadata !{i32 18, i32 9, metadata !32, metadata !48}
!53 = metadata !{i32 30, i32 33, metadata !42, null}
...
!69 = metadata !{i32 39, i32 1, metadata !9, null}
