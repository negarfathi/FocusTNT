...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  br i1 %"32", label %main_bb12, label %main_wrap_around.exit2, !dbg !74

main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb17, %main_bb16, %main_bb15, %main_bb11
  %entry.0 = phi i64 [ 3, %main_bb11 ], [ %"42", %main_bb15 ], [ %"47", %main_bb17 ], [ %"37", %main_bb16 ], [ %entry.0, %main_bb13 ]
  %"33" = icmp sge i64 %entry.0, 5, !dbg !76
  br i1 %"33", label %main_bb12, label %main_bb13, !dbg !76

main_bb12:                                        ; preds = %main_wrap_around.exit2, %main_bb11, %main_bb5
  ret i32 0, !dbg !80

main_bb13:                                        ; preds = %main_wrap_around.exit2
  %"34" = getelementptr inbounds [5 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !81
  %"35" = load i64* %"34", align 8, !dbg !81
  %"36" = icmp ne i64 %"35", 0, !dbg !81
  br i1 %"36", label %main_bb14, label %main_wrap_around.exit2, !dbg !81

main_bb14:                                        ; preds = %main_bb13
  %"37" = add nsw i64 %entry.0, 1, !dbg !83
  %"38" = icmp sgt i64 %"37", 2147483647, !dbg !85
  br i1 %"38", label %main_bb15, label %main_bb16, !dbg !85

main_bb15:                                        ; preds = %main_bb14
  %"39" = sub nsw i64 %"37", 2147483647, !dbg !86
  %"40" = sub nsw i64 %"39", 1, !dbg !86
  %"41" = srem i64 %"40", 4294967296, !dbg !86
  %"42" = add nsw i64 -2147483648, %"41", !dbg !86
  br label %main_wrap_around.exit2, !dbg !86

main_bb16:                                        ; preds = %main_bb14
  %"43" = icmp slt i64 %"37", -2147483648, !dbg !87
  br i1 %"43", label %main_bb17, label %main_wrap_around.exit2, !dbg !87

main_bb17:                                        ; preds = %main_bb16
  %"44" = sub nsw i64 -2147483648, %"37", !dbg !88
  %"45" = sub nsw i64 %"44", 1, !dbg !88
  %"46" = srem i64 %"45", 4294967296, !dbg !88
  %"47" = sub nsw i64 2147483647, %"46", !dbg !88
