...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  %"33" = icmp slt i64 0, 0, !dbg !73
  br i1 %"33", label %main_bb12, label %main_wrap_around.exit2, !dbg !73

main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb17, %main_bb16, %main_bb15, %main_bb11
  %entry.0 = phi i64 [ 0, %main_bb11 ], [ %"43", %main_bb15 ], [ %"48", %main_bb17 ], [ %"38", %main_bb16 ], [ %entry.0, %main_bb13 ]
  %"34" = icmp sge i64 %entry.0, 5, !dbg !75
  br i1 %"34", label %main_bb12, label %main_bb13, !dbg !75
...
main_bb13:                                        ; preds = %main_wrap_around.exit2
  ...
  br i1 %"37", label %main_bb14, label %main_wrap_around.exit2, !dbg !80

main_bb14:                                        ; preds = %main_bb13
  %"38" = add nsw i64 %entry.0, 1, !dbg !82
  %"39" = icmp sgt i64 %"38", 2147483647, !dbg !84
  br i1 %"39", label %main_bb15, label %main_bb16, !dbg !84
...
main_bb16:                                        ; preds = %main_bb14
  ...
  br i1 %"44", label %main_bb17, label %main_wrap_around.exit2, !dbg !86
...
!71 = metadata !{i32 786688, metadata !9, metadata !"entry", metadata !5, i32 35, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [entry] [line 35]
!72 = metadata !{i32 35, i32 15, metadata !9, null}
!73 = metadata !{i32 36, i32 9, metadata !74, null}
!74 = metadata !{i32 786443, metadata !1, metadata !9, i32 36, i32 9, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!75 = metadata !{i32 42, i32 13, metadata !76, null}
!76 = metadata !{i32 786443, metadata !1, metadata !77, i32 42, i32 13, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!77 = metadata !{i32 786443, metadata !1, metadata !78, i32 41, i32 5, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!78 = metadata !{i32 786443, metadata !1, metadata !9, i32 40, i32 5, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!79 = metadata !{i32 53, i32 1, metadata !9, null}
!80 = metadata !{i32 46, i32 13, metadata !81, null}
!81 = metadata !{i32 786443, metadata !1, metadata !77, i32 46, i32 13, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!82 = metadata !{i32 48, i32 22, metadata !83, null}
!83 = metadata !{i32 786443, metadata !1, metadata !81, i32 47, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!84 = metadata !{i32 15, i32 9, metadata !26, metadata !82}
!85 = metadata !{i32 16, i32 9, metadata !28, metadata !82}
!86 = metadata !{i32 18, i32 14, metadata !30, metadata !82}
!87 = metadata !{i32 19, i32 9, metadata !32, metadata !82}
