...
define i32 @main() #0 {
main_bb5:
  %mcelog_entry = alloca [0 x i64], align 8
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !35), !dbg !36
  %"12" = icmp sle i64 0, 0, !dbg !37
  %"13" = icmp sgt i64 0, 1000, !dbg !39
  %or.cond = or i1 %"12", %"13", !dbg !37
  br i1 %or.cond, label %main_bb12, label %main_bb6, !dbg !37

main_bb6:                                         ; preds = %main_bb5
  call void @llvm.dbg.declare(metadata !{[0 x i64]* %mcelog_entry}, metadata !41), !dbg !45
  %"14" = bitcast [0 x i64]* %mcelog_entry to i8*, !dbg !46
  call void @llvm.memset.p0i8.i64(i8* %"14", i8 0, i64 0, i32 8, i1 false), !dbg !46
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !47), !dbg !49
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !50), !dbg !52
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  %i.0 = phi i64 [ 0, %main_bb6 ], [ %"21", %main_bb8 ], [ %"26", %main_bb10 ], [ %"16", %main_bb9 ]
  %"15" = icmp slt i64 %i.0, 0, !dbg !63
  br i1 %"15", label %main_bb7, label %main_bb11, !dbg !63

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"16" = add nsw i64 %i.0, 1, !dbg !51
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !66
  br i1 %"17", label %main_bb8, label %main_bb9, !dbg !66
...
main_bb9:                                         ; preds = %main_bb7
  ...
  br i1 %"22", label %main_bb10, label %main_wrap_around.exit, !dbg !68
...
main_bb11:                                        ; preds = %main_wrap_around.exit
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !70), !dbg !71
  %"27" = icmp slt i64 0, 0, !dbg !72
  br i1 %"27", label %main_bb12, label %main_wrap_around.exit2, !dbg !72

main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb17, %main_bb16, %main_bb15, %main_bb11
  %entry.0 = phi i64 [ 0, %main_bb11 ], [ %"37", %main_bb15 ], [ %"42", %main_bb17 ], [ %"32", %main_bb16 ], [ %entry.0, %main_bb13 ]
  %"28" = icmp sge i64 %entry.0, 0, !dbg !74
  br i1 %"28", label %main_bb12, label %main_bb13, !dbg !74

main_bb12:                                        ; preds = %main_wrap_around.exit2, %main_bb11, %main_bb5
  ret i32 0, !dbg !78

main_bb13:                                        ; preds = %main_wrap_around.exit2
  %"29" = getelementptr inbounds [0 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !79
  %"30" = load i64* %"29", align 8, !dbg !79
  %"31" = icmp ne i64 %"30", 0, !dbg !79
  br i1 %"31", label %main_bb14, label %main_wrap_around.exit2, !dbg !79

main_bb14:                                        ; preds = %main_bb13
  %"32" = add nsw i64 %entry.0, 1, !dbg !81
  %"33" = icmp sgt i64 %"32", 2147483647, !dbg !83
  br i1 %"33", label %main_bb15, label %main_bb16, !dbg !83

main_bb15:                                        ; preds = %main_bb14
  %"34" = sub nsw i64 %"32", 2147483647, !dbg !84
  %"35" = sub nsw i64 %"34", 1, !dbg !84
  %"36" = srem i64 %"35", 4294967296, !dbg !84
  %"37" = add nsw i64 -2147483648, %"36", !dbg !84
  br label %main_wrap_around.exit2, !dbg !84

main_bb16:                                        ; preds = %main_bb14
  %"38" = icmp slt i64 %"32", -2147483648, !dbg !85
  br i1 %"38", label %main_bb17, label %main_wrap_around.exit2, !dbg !85

main_bb17:                                        ; preds = %main_bb16
  %"39" = sub nsw i64 -2147483648, %"32", !dbg !86
  %"40" = sub nsw i64 %"39", 1, !dbg !86
  %"41" = srem i64 %"40", 4294967296, !dbg !86
  %"42" = sub nsw i64 2147483647, %"41", !dbg !86
...
!42 = metadata !{i32 786433, null, null, metadata !"", i32 0, i64 0, i64 64, i32 0, i32 0, metadata !8, metadata !43, i32 0, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 0, align 64, offset 0] [from long long int]
!43 = metadata !{metadata !44}
!44 = metadata !{i32 786465, i64 0, i64 0}        ; [ DW_TAG_subrange_type ] [0, -1]
!45 = metadata !{i32 30, i32 15, metadata !9, null}
!46 = metadata !{i32 30, i32 5, metadata !9, null}
!47 = metadata !{i32 786688, metadata !48, metadata !"i", metadata !5, i32 31, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 31]
!48 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 31, i32 20, metadata !48, null}
!50 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777229, metadata !8, i32 0, metadata !51} ; [ DW_TAG_arg_variable ] [value] [line 13]
!51 = metadata !{i32 31, i32 49, metadata !48, null}
!52 = metadata !{i32 13, i32 33, metadata !4, metadata !51}
!53 = metadata !{i64 -2147483648}
!54 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554445, metadata !8, i32 0, metadata !51} ; [ DW_TAG_arg_variable ] [lower_bound] [line 13]
!55 = metadata !{i32 13, i32 50, metadata !4, metadata !51}
!56 = metadata !{i64 2147483647}
!57 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331661, metadata !8, i32 0, metadata !51} ; [ DW_TAG_arg_variable ] [upper_bound] [line 13]
!58 = metadata !{i32 13, i32 73, metadata !4, metadata !51}
!59 = metadata !{i64 4294967296}
!60 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 14, metadata !8, i32 0, metadata !51} ; [ DW_TAG_auto_variable ] [range] [line 14]
!61 = metadata !{i32 14, i32 15, metadata !4, metadata !51}
!62 = metadata !{i32 31, i32 10, metadata !48, null}
!63 = metadata !{i32 31, i32 10, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !65, i32 31, i32 10, i32 2, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 786443, metadata !1, metadata !48, i32 31, i32 10, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!66 = metadata !{i32 15, i32 9, metadata !26, metadata !51}
!67 = metadata !{i32 16, i32 9, metadata !28, metadata !51}
!68 = metadata !{i32 18, i32 14, metadata !30, metadata !51}
!69 = metadata !{i32 19, i32 9, metadata !32, metadata !51}
!70 = metadata !{i32 786688, metadata !9, metadata !"entry", metadata !5, i32 35, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [entry] [line 35]
!71 = metadata !{i32 35, i32 15, metadata !9, null}
!72 = metadata !{i32 36, i32 9, metadata !73, null}
!73 = metadata !{i32 786443, metadata !1, metadata !9, i32 36, i32 9, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!74 = metadata !{i32 42, i32 13, metadata !75, null}
!75 = metadata !{i32 786443, metadata !1, metadata !76, i32 42, i32 13, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 786443, metadata !1, metadata !77, i32 41, i32 5, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!77 = metadata !{i32 786443, metadata !1, metadata !9, i32 40, i32 5, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!78 = metadata !{i32 53, i32 1, metadata !9, null}
!79 = metadata !{i32 46, i32 13, metadata !80, null}
!80 = metadata !{i32 786443, metadata !1, metadata !76, i32 46, i32 13, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!81 = metadata !{i32 48, i32 22, metadata !82, null}
!82 = metadata !{i32 786443, metadata !1, metadata !80, i32 47, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!83 = metadata !{i32 15, i32 9, metadata !26, metadata !81}
!84 = metadata !{i32 16, i32 9, metadata !28, metadata !81}
!85 = metadata !{i32 18, i32 14, metadata !30, metadata !81}
!86 = metadata !{i32 19, i32 9, metadata !32, metadata !81}
