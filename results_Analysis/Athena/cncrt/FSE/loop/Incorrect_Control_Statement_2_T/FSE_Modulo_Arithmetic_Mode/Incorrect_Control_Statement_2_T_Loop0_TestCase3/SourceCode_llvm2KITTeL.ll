...
@main.slots_used = private unnamed_addr constant [10 x i64] [i64 3, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1], align 16
@main.ereg = private unnamed_addr constant [10 x i64] [i64 7, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1], align 16
...
main_bb5:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %"15", i8* %"16", i64 80, i32 16, i1 false), !dbg !47
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !49), !dbg !51
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !52), !dbg !54
...
main_bb6:                                         ; preds = %main_wrap_around.exit
  %"18" = add nsw i64 %i.0, 1, !dbg !53
  %"19" = icmp sgt i64 %"18", 2147483647, !dbg !68
  br i1 %"19", label %main_bb7, label %main_bb8, !dbg !68

main_bb7:                                         ; preds = %main_bb6
  %"20" = sub nsw i64 %"18", 2147483647, !dbg !69
  %"21" = sub nsw i64 %"20", 1, !dbg !69
  %"22" = srem i64 %"21", 4294967296, !dbg !69
  %"23" = add nsw i64 -2147483648, %"22", !dbg !69
  br label %main_wrap_around.exit, !dbg !69

main_bb8:                                         ; preds = %main_bb6
  %"24" = icmp slt i64 %"18", -2147483648, !dbg !70
  br i1 %"24", label %main_bb9, label %main_wrap_around.exit, !dbg !70

main_bb9:                                         ; preds = %main_bb8
  %"25" = sub nsw i64 -2147483648, %"18", !dbg !71
  %"26" = sub nsw i64 %"25", 1, !dbg !71
  %"27" = srem i64 %"26", 4294967296, !dbg !71
  %"28" = sub nsw i64 2147483647, %"27", !dbg !71
...
main_wrap_around.exit2:                           ; preds = %main_bb18, %main_bb17, %main_bb16, %main_wrap_around.exit
  ...
  %"29" = icmp slt i64 %i1.0, 10, !dbg !72
  br i1 %"29", label %main_bb10, label %main_bb19, !dbg !72

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"30" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i1.0, !dbg !74
...
main_bb11:                                        ; preds = %main_LeafBlock
  %"32" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !76
  %"33" = load i64* %"32", align 8, !dbg !76
  %"34" = icmp ne i64 %"33", 0, !dbg !76
  br i1 %"34", label %main_bb12, label %main_bb19, !dbg !76

main_bb12:                                        ; preds = %main_bb11
  %"35" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !79
  %"36" = load i64* %"35", align 8, !dbg !79
...
main_bb13:                                        ; preds = %main_NewDefault
  %"37" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !81
  %"38" = load i64* %"37", align 8, !dbg !81
...
main_bb14:                                        ; preds = %main_LeafBlock3, %main_bb13, %main_bb12
  ...
  %"39" = icmp ne i64 %table.1, 0, !dbg !83
  br i1 %"39", label %main_bb19, label %main_bb15, !dbg !83

main_bb15:                                        ; preds = %main_bb14
  %"40" = add nsw i64 %i1.0, 1, !dbg !85
  %"41" = icmp sgt i64 %"40", 2147483647, !dbg !86
  br i1 %"41", label %main_bb16, label %main_bb17, !dbg !86

main_bb16:                                        ; preds = %main_bb15
  %"42" = sub nsw i64 %"40", 2147483647, !dbg !87
  %"43" = sub nsw i64 %"42", 1, !dbg !87
  %"44" = srem i64 %"43", 4294967296, !dbg !87
  %"45" = add nsw i64 -2147483648, %"44", !dbg !87
  br label %main_wrap_around.exit2, !dbg !87

main_bb17:                                        ; preds = %main_bb15
  %"46" = icmp slt i64 %"40", -2147483648, !dbg !88
  br i1 %"46", label %main_bb18, label %main_wrap_around.exit2, !dbg !88

main_bb18:                                        ; preds = %main_bb17
  %"47" = sub nsw i64 -2147483648, %"40", !dbg !89
  %"48" = sub nsw i64 %"47", 1, !dbg !89
  %"49" = srem i64 %"48", 4294967296, !dbg !89
  %"50" = sub nsw i64 2147483647, %"49", !dbg !89
