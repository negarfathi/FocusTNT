...
main_bb5:
  ...
  %"12" = icmp slt i64 4294967295, 0, !dbg !43
  call void @llvm.dbg.value(metadata !40, i64 0, metadata !38), !dbg !39
  %. = select i1 %"12", i64 0, i64 4294967295, !dbg !43
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !45), !dbg !48
  call void @llvm.dbg.value(metadata !40, i64 0, metadata !49), !dbg !50
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !51), !dbg !52
  call void @llvm.dbg.value(metadata !53, i64 0, metadata !54), !dbg !55
  call void @llvm.dbg.value(metadata !{i64 %"25"}, i64 0, metadata !56), !dbg !59
  call void @llvm.dbg.value(metadata !40, i64 0, metadata !60), !dbg !61
  call void @llvm.dbg.value(metadata !37, i64 0, metadata !62), !dbg !63
...
main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  ...
  %"13" = icmp slt i64 %ui.0, %., !dbg !67
  br i1 %"13", label %main_bb6, label %main_.critedge, !dbg !67

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"14" = mul nsw i64 %ui.0, 2, !dbg !46
...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  %.0.i = phi i64 [ %"18", %main_bb7 ], [ %"23", %main_bb9 ], [ %"14", %main_bb8 ], !dbg !46
  %"24" = icmp sgt i64 %.0.i, %ui.0, !dbg !46
  br i1 %"24", label %main_bb10, label %main_.critedge, !dbg !73

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"25" = mul nsw i64 %ui.0, 2, !dbg !57
...
!46 = metadata !{i32 31, i32 29, metadata !47, null}
!47 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 29, i32 2, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 12, i32 33, metadata !4, metadata !46}
!49 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !46} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!50 = metadata !{i32 12, i32 50, metadata !4, metadata !46}
!51 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !46} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!52 = metadata !{i32 12, i32 73, metadata !4, metadata !46}
!53 = metadata !{i64 4294967296}
!54 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !46} ; [ DW_TAG_auto_variable ] [range] [line 13]
!55 = metadata !{i32 13, i32 15, metadata !4, metadata !46}
...
!57 = metadata !{i32 33, i32 14, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !9, i32 32, i32 1, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 12, i32 33, metadata !4, metadata !57}
!60 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !57} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!61 = metadata !{i32 12, i32 50, metadata !4, metadata !57}
!62 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !57} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!63 = metadata !{i32 12, i32 73, metadata !4, metadata !57}
!64 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !57} ; [ DW_TAG_auto_variable ] [range] [line 13]
!65 = metadata !{i32 13, i32 15, metadata !4, metadata !57}
!66 = metadata !{i32 31, i32 5, metadata !9, null}
!67 = metadata !{i32 31, i32 5, metadata !68, null}
!68 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 14, i32 9, metadata !26, metadata !46}
!70 = metadata !{i32 15, i32 9, metadata !28, metadata !46}
!71 = metadata !{i32 17, i32 14, metadata !30, metadata !46}
!72 = metadata !{i32 18, i32 9, metadata !32, metadata !46}
!73 = metadata !{i32 31, i32 29, metadata !74, null}
!74 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 29, i32 3, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!75 = metadata !{i32 14, i32 9, metadata !26, metadata !57}
!76 = metadata !{i32 15, i32 9, metadata !28, metadata !57}
!77 = metadata !{i32 17, i32 14, metadata !30, metadata !57}
!78 = metadata !{i32 18, i32 9, metadata !32, metadata !57}
!79 = metadata !{i32 35, i32 5, metadata !9, null}
