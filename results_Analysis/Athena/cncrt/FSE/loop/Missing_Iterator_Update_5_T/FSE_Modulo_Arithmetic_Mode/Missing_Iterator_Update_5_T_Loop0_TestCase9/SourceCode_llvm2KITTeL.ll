...
main_bb11:                                        ; preds = %main_wrap_around.exit
  ...
  %"32" = icmp slt i64 3, 0, !dbg !74
  br i1 %"32", label %main_bb17, label %main_wrap_around.exit2, !dbg !74

main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb11
  %entry.0 = phi i64 [ 3, %main_bb11 ], [ %"42", %main_bb14 ], [ %"47", %main_bb16 ], [ %"37", %main_bb15 ]
  %"33" = icmp sge i64 %entry.0, 5, !dbg !76
  br i1 %"33", label %main_bb17, label %main_bb12, !dbg !76

main_bb12:                                        ; preds = %main_wrap_around.exit2
  %"34" = getelementptr inbounds [5 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !80
  %"35" = load i64* %"34", align 8, !dbg !80
  %"36" = icmp ne i64 %"35", 0, !dbg !80
  br i1 %"36", label %main_bb13, label %main_bb17, !dbg !80

main_bb13:                                        ; preds = %main_bb12
  %"37" = add nsw i64 %entry.0, 1, !dbg !82
  %"38" = icmp sgt i64 %"37", 2147483647, !dbg !84
  br i1 %"38", label %main_bb14, label %main_bb15, !dbg !84

main_bb14:                                        ; preds = %main_bb13
  %"39" = sub nsw i64 %"37", 2147483647, !dbg !85
  %"40" = sub nsw i64 %"39", 1, !dbg !85
  %"41" = srem i64 %"40", 4294967296, !dbg !85
  %"42" = add nsw i64 -2147483648, %"41", !dbg !85
  br label %main_wrap_around.exit2, !dbg !85

main_bb15:                                        ; preds = %main_bb13
  %"43" = icmp slt i64 %"37", -2147483648, !dbg !86
  br i1 %"43", label %main_bb16, label %main_wrap_around.exit2, !dbg !86

main_bb16:                                        ; preds = %main_bb15
  %"44" = sub nsw i64 -2147483648, %"37", !dbg !87
  %"45" = sub nsw i64 %"44", 1, !dbg !87
  %"46" = srem i64 %"45", 4294967296, !dbg !87
  %"47" = sub nsw i64 2147483647, %"46", !dbg !87
