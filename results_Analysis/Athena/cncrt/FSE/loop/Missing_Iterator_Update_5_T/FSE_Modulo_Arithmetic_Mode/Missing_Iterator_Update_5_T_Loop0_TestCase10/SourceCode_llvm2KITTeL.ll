...
define i32 @main() #0 {
main_bb5:
  %mcelog_entry = alloca [100 x i64], align 16
  call void @llvm.dbg.value(metadata !34, i64 0, metadata !35), !dbg !36
  %"12" = icmp sle i64 100, 0, !dbg !37
  %"13" = icmp sgt i64 100, 1000, !dbg !39
  %or.cond = or i1 %"12", %"13", !dbg !37
  br i1 %or.cond, label %main_bb17, label %main_bb6, !dbg !37

main_bb6:                                         ; preds = %main_bb5
  call void @llvm.dbg.declare(metadata !{[100 x i64]* %mcelog_entry}, metadata !41), !dbg !45
  %"14" = bitcast [100 x i64]* %mcelog_entry to i8*, !dbg !46
  call void @llvm.memset.p0i8.i64(i8* %"14", i8 0, i64 800, i32 16, i1 false), !dbg !46
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  ...
  %"15" = icmp slt i64 %i.0, 100, !dbg !64
...
main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb11
  ...
  %"28" = icmp sge i64 %entry.0, 100, !dbg !76
  br i1 %"28", label %main_bb17, label %main_bb12, !dbg !76

main_bb12:                                        ; preds = %main_wrap_around.exit2
  %"29" = getelementptr inbounds [100 x i64]* %mcelog_entry, i32 0, i64 %entry.0, !dbg !80
...
!42 = metadata !{i32 786433, null, null, metadata !"", i32 0, i64 6400, i64 64, i32 0, i32 0, metadata !8, metadata !43, i32 0, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 6400, align 64, offset 0] [from long long int]
!43 = metadata !{metadata !44}
!44 = metadata !{i32 786465, i64 0, i64 100}      ; [ DW_TAG_subrange_type ] [0, 99]
