...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !35), !dbg !36
...
main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  ...
  %pkt.0 = phi i64 [ 0, %main_bb5 ], [ %pkt.1, %main_wrap_around.exit ]
...
!37 = metadata !{i32 786688, metadata !9, metadata !"pkt", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [pkt] [line 24]
...
!63 = metadata !{i32 33, i32 5, metadata !9, null}
