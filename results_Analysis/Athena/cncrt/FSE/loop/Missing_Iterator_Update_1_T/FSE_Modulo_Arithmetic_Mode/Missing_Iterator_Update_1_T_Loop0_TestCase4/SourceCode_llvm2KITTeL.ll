...
main_bb8:
  ...
  %"13" = icmp eq i64 -1, 0, !dbg !55
  br i1 %"13", label %main_bb9, label %main_.critedge, !dbg !55

main_bb9:                                         ; preds = %main_bb9, %main_bb8
  store i64 2, i64* @"'errno", align 8, !dbg !57
  %"14" = icmp slt i64 -1, 0, !dbg !61
  %"15" = load i64* @"'errno", align 8
  %"16" = icmp eq i64 %"15", 1, !dbg !63
  %or.cond = and i1 %"14", %"16", !dbg !61
  br i1 %or.cond, label %main_bb9, label %main_.critedge, !dbg !61

main_.critedge:                                   ; preds = %main_bb9, %main_bb8
  ret i32 0, !dbg !65
}
...
!52 = metadata !{i32 35, i32 13, metadata !45, metadata !50}
!53 = metadata !{i32 786688, metadata !12, metadata !"ret", metadata !5, i32 44, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ret] [line 44]
!54 = metadata !{i32 44, i32 15, metadata !12, null}
!55 = metadata !{i32 46, i32 9, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !12, i32 46, i32 9, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 35, i32 13, metadata !45, metadata !58}
!58 = metadata !{i32 49, i32 19, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !60, i32 48, i32 11, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 786443, metadata !1, metadata !56, i32 47, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 50, i32 9, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !59, i32 50, i32 9, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 50, i32 9, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !59, i32 50, i32 9, i32 2, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 52, i32 5, metadata !12, null}
