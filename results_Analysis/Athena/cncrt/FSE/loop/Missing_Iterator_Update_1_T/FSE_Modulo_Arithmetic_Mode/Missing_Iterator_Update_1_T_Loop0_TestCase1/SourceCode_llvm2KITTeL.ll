...
main_bb8:
  ...
  %"13" = icmp eq i64 1, 0, !dbg !54
  br i1 %"13", label %main_bb9, label %main_bb11, !dbg !54

main_bb9:                                         ; preds = %main_bb8
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !56), !dbg !60
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !52), !dbg !53
  %"14" = load i64* @"'errno", align 8, !dbg !61
  br label %main_bb10, !dbg !63

main_bb10:                                        ; preds = %main_bb9, %main_bb10
  %"15" = icmp slt i64 1, 0, !dbg !64
  %"16" = icmp eq i64 %"14", 1, !dbg !61
  %. = select i1 %"15", i1 %"16", i1 false, !dbg !64
  br i1 %., label %main_bb10, label %main_bb11, !dbg !66

main_bb11:                                        ; preds = %main_bb10, %main_bb8
  ret i32 0, !dbg !68
}
...
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 28, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 35, i32 13, metadata !45, null}
...
!47 = metadata !{i32 36, i32 9, metadata !46, null}
!48 = metadata !{i32 39, i32 1, metadata !9, null}
!49 = metadata !{i32 786688, metadata !9, metadata !"num", metadata !5, i32 27, metadata !8, i32 0, metadata !50} ; [ DW_TAG_auto_variable ] [num] [line 27]
!50 = metadata !{i32 44, i32 21, metadata !12, null}
!51 = metadata !{i32 27, i32 15, metadata !9, metadata !50}
!52 = metadata !{i32 786688, metadata !12, metadata !"ret", metadata !5, i32 44, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ret] [line 44]
!53 = metadata !{i32 44, i32 15, metadata !12, null}
!54 = metadata !{i32 46, i32 9, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !12, i32 46, i32 9, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 786688, metadata !9, metadata !"num", metadata !5, i32 27, metadata !8, i32 0, metadata !57} ; [ DW_TAG_auto_variable ] [num] [line 27]
!57 = metadata !{i32 49, i32 19, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !59, i32 48, i32 11, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 786443, metadata !1, metadata !55, i32 47, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 27, i32 15, metadata !9, metadata !57}
!61 = metadata !{i32 50, i32 9, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !58, i32 50, i32 9, i32 2, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 48, i32 9, metadata !59, null}
!64 = metadata !{i32 50, i32 9, metadata !65, null}
!65 = metadata !{i32 786443, metadata !1, metadata !58, i32 50, i32 9, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!66 = metadata !{i32 50, i32 9, metadata !67, null}
!67 = metadata !{i32 786443, metadata !1, metadata !58, i32 50, i32 9, i32 3, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!68 = metadata !{i32 52, i32 5, metadata !12, null}
