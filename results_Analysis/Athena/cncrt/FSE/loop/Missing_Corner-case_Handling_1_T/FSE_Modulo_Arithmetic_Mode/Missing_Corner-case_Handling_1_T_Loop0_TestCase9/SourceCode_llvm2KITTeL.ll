...
define i32 @main() #0 {
main_bb14:
  %"31" = load i64* @"'count", align 8, !dbg !83
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !86), !dbg !87
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !88), !dbg !90
  ...
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !95), !dbg !96
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !86), !dbg !87
  br label %main_bb15, !dbg !97

main_bb15:                                        ; preds = %main_read.exit, %main_bb14
  %"32" = load i64* @"'flag", align 8, !dbg !98
  %"33" = icmp eq i64 %"32", 1, !dbg !98
  %"34" = icmp sgt i64 %"31", 100, !dbg !99
  %or.cond.i = or i1 %"33", %"34", !dbg !98
  br i1 %or.cond.i, label %main_read.exit, label %main_bb16, !dbg !98

main_bb16:                                        ; preds = %main_bb15
  store i64 1, i64* @"'flag", align 8, !dbg !100
  br label %main_read.exit, !dbg !101

main_read.exit:                                   ; preds = %main_bb15, %main_bb16
  %"35" = icmp sle i64 0, 0, !dbg !83
  br i1 %"35", label %main_bb17, label %main_bb15, !dbg !83
...
!83 = metadata !{i32 55, i32 13, metadata !84, null}
!84 = metadata !{i32 786443, metadata !1, metadata !85, i32 55, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!85 = metadata !{i32 786443, metadata !1, metadata !12, i32 54, i32 5, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!86 = metadata !{i32 786688, metadata !9, metadata !"num", metadata !5, i32 30, metadata !8, i32 0, metadata !83} ; [ DW_TAG_auto_variable ] [num] [line 30]
!87 = metadata !{i32 30, i32 15, metadata !9, metadata !83}
...
!89 = metadata !{i32 37, i32 15, metadata !50, metadata !83}
...
!97 = metadata !{i32 53, i32 5, metadata !12, null}
!98 = metadata !{i32 26, i32 9, metadata !41, metadata !83}
!99 = metadata !{i32 26, i32 9, metadata !43, metadata !83}
!100 = metadata !{i32 45, i32 13, metadata !80, metadata !83}
!101 = metadata !{i32 46, i32 13, metadata !80, metadata !83}
!102 = metadata !{i32 60, i32 5, metadata !12, null}
