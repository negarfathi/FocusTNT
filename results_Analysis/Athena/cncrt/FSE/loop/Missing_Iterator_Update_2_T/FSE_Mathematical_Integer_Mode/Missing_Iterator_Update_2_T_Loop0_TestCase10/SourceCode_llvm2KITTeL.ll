...
main_mdb_cursor_get.exit:
  ...
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !35), !dbg !40
  call void @llvm.dbg.value(metadata !15, i64 0, metadata !41), !dbg !43
...
main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get.exit
  ...
  %"9" = icmp eq i32 %., 0, !dbg !45
  br i1 %"9", label %main_bb4, label %main_bb5, !dbg !45

main_bb4:                                         ; preds = %main_bb3
  %"10" = load i32* @"'flag", align 4, !dbg !47
  %"11" = add nsw i32 %"10", 1, !dbg !47
  store i32 %"11", i32* @"'flag", align 4, !dbg !47
  %"12" = load i32* @"'flag", align 4, !dbg !48
...
!36 = metadata !{i32 31, i32 18, metadata !37, null}
!37 = metadata !{i32 786443, metadata !1, metadata !38, i32 30, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!38 = metadata !{i32 786443, metadata !1, metadata !39, i32 29, i32 13, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!39 = metadata !{i32 786443, metadata !1, metadata !9, i32 28, i32 5, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!40 = metadata !{i32 12, i32 9, metadata !4, metadata !36}
!41 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 12, metadata !8, i32 0, metadata !42} ; [ DW_TAG_auto_variable ] [i] [line 12]
!42 = metadata !{i32 34, i32 14, metadata !39, null}
!43 = metadata !{i32 12, i32 9, metadata !4, metadata !42}
!44 = metadata !{i32 27, i32 5, metadata !9, null}
!45 = metadata !{i32 27, i32 5, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 5, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 13, i32 5, metadata !4, metadata !36}
!48 = metadata !{i32 14, i32 9, metadata !20, metadata !36}
!49 = metadata !{i32 32, i32 13, metadata !37, null}
!50 = metadata !{i32 36, i32 5, metadata !9, null}
