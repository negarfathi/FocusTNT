...
main_bb5:
  ...
  %"12" = icmp sgt i64 0, 65534, !dbg !39
...
main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  %i.0 = phi i64 [ 0, %main_bb5 ], [ %"32", %main_bb11 ], [ %"37", %main_bb13 ], [ %"27", %main_bb12 ]
  %"14" = icmp slt i64 %i.0, 0, !dbg !43
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"15" = icmp slt i64 %j.0, 0, !dbg !47
  br i1 %"15", label %main_bb6, label %main_bb10, !dbg !47

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"16" = add nsw i64 %j.0, 1, !dbg !52
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !53
  br i1 %"17", label %main_bb7, label %main_bb8, !dbg !53

main_bb7:                                         ; preds = %main_bb6
  %"18" = sub nsw i64 %"16", 2147483647, !dbg !54
  %"19" = sub nsw i64 %"18", 1, !dbg !54
  %"20" = srem i64 %"19", 4294967296, !dbg !54
  %"21" = add nsw i64 -2147483648, %"20", !dbg !54
  br label %main_wrap_around.exit, !dbg !54

main_bb8:                                         ; preds = %main_bb6
  %"22" = icmp slt i64 %"16", -2147483648, !dbg !55
  br i1 %"22", label %main_bb9, label %main_wrap_around.exit, !dbg !55

main_bb9:                                         ; preds = %main_bb8
  %"23" = sub nsw i64 -2147483648, %"16", !dbg !56
  %"24" = sub nsw i64 %"23", 1, !dbg !56
  %"25" = srem i64 %"24", 4294967296, !dbg !56
  %"26" = sub nsw i64 2147483647, %"25", !dbg !56
  br label %main_wrap_around.exit, !dbg !56

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"27" = add nsw i64 %i.0, 1, !dbg !57
  call void @llvm.dbg.value(metadata !{i64 %"27"}, i64 0, metadata !58), !dbg !59
  ...
  %"28" = icmp sgt i64 %"27", 2147483647, !dbg !69
  br i1 %"28", label %main_bb11, label %main_bb12, !dbg !69

main_bb11:                                        ; preds = %main_bb10
  %"29" = sub nsw i64 %"27", 2147483647, !dbg !70
  %"30" = sub nsw i64 %"29", 1, !dbg !70
  %"31" = srem i64 %"30", 4294967296, !dbg !70
  %"32" = add nsw i64 -2147483648, %"31", !dbg !70
  br label %main_wrap_around.exit2, !dbg !70

main_bb12:                                        ; preds = %main_bb10
  %"33" = icmp slt i64 %"27", -2147483648, !dbg !71
  br i1 %"33", label %main_bb13, label %main_wrap_around.exit2, !dbg !71

main_bb13:                                        ; preds = %main_bb12
  %"34" = sub nsw i64 -2147483648, %"27", !dbg !72
  %"35" = sub nsw i64 %"34", 1, !dbg !72
  %"36" = srem i64 %"35", 4294967296, !dbg !72
  %"37" = sub nsw i64 2147483647, %"36", !dbg !72
...
!37 = metadata !{i32 786688, metadata !9, metadata !"num_output", metadata !5, i32 25, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num_output] [line 25]
...
!41 = metadata !{i32 26, i32 9, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !40, i32 26, i32 9, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 30, i32 10, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !45, i32 30, i32 10, i32 2, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 786443, metadata !1, metadata !46, i32 30, i32 10, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 32, i32 14, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !49, i32 32, i32 14, i32 2, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 786443, metadata !1, metadata !50, i32 32, i32 14, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!50 = metadata !{i32 786443, metadata !1, metadata !51, i32 32, i32 9, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 786443, metadata !1, metadata !46, i32 31, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 32, i32 44, metadata !50, null}
!53 = metadata !{i32 13, i32 9, metadata !26, metadata !52}
!54 = metadata !{i32 14, i32 9, metadata !28, metadata !52}
!55 = metadata !{i32 16, i32 14, metadata !30, metadata !52}
!56 = metadata !{i32 17, i32 9, metadata !32, metadata !52}
!57 = metadata !{i32 30, i32 38, metadata !46, null}
!58 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777227, metadata !8, i32 0, metadata !57} ; [ DW_TAG_arg_variable ] [value] [line 11]
!59 = metadata !{i32 11, i32 33, metadata !4, metadata !57}
!60 = metadata !{i64 -2147483648}
!61 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554443, metadata !8, i32 0, metadata !57} ; [ DW_TAG_arg_variable ] [lower_bound] [line 11]
!62 = metadata !{i32 11, i32 50, metadata !4, metadata !57}
!63 = metadata !{i64 2147483647}
!64 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331659, metadata !8, i32 0, metadata !57} ; [ DW_TAG_arg_variable ] [upper_bound] [line 11]
!65 = metadata !{i32 11, i32 73, metadata !4, metadata !57}
!66 = metadata !{i64 4294967296}
!67 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 12, metadata !8, i32 0, metadata !57} ; [ DW_TAG_auto_variable ] [range] [line 12]
!68 = metadata !{i32 12, i32 15, metadata !4, metadata !57}
!69 = metadata !{i32 13, i32 9, metadata !26, metadata !57}
!70 = metadata !{i32 14, i32 9, metadata !28, metadata !57}
!71 = metadata !{i32 16, i32 14, metadata !30, metadata !57}
!72 = metadata !{i32 17, i32 9, metadata !32, metadata !57}
!73 = metadata !{i32 38, i32 1, metadata !9, null}
