...
main_bb7:                                         ; preds = %main_bb2, %main_bb11
  ...
  %"22" = xor i1 %"21", true, !dbg !58
  br i1 %"22", label %main_bb8, label %main_bb12, !dbg !58

main_bb8:                                         ; preds = %main_bb7
  %"23" = sext i32 %xmin.0 to i64, !dbg !62
...
main_bb9:                                         ; preds = %main_bb10, %main_bb8
  ...
  %"24" = sub nsw i32 10, 1, !dbg !68
  %"25" = icmp sle i32 %y.0, %"24", !dbg !68
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !68

main_bb10:                                        ; preds = %main_bb9
  %"26" = sext i32 %y.0 to i64, !dbg !62
  %"27" = mul nsw i64 %"23", %"5", !dbg !62
  %"28" = getelementptr inbounds i32* %"8", i64 %"27", !dbg !62
  %"29" = getelementptr inbounds i32* %"28", i64 %"26", !dbg !62
  %"30" = load i32* %"29", align 4, !dbg !62
  %"31" = icmp ne i32 %"30", 0, !dbg !62
  %.found.1 = select i1 %"31", i32 1, i32 %found.1, !dbg !62
  %"32" = add nsw i32 %y.0, 1, !dbg !71
  br label %main_bb9, !dbg !71

main_bb11:                                        ; preds = %main_bb9
  %"33" = add nsw i32 %xmin.0, 1, !dbg !72
  call void @llvm.dbg.value(metadata !{i32 %"33"}, i64 0, metadata !73), !dbg !74
  br label %main_bb7, !dbg !72

main_bb12:                                        ; preds = %main_bb7
  call void @llvm.stackrestore(i8* %"6"), !dbg !75
  br label %main_bb13
