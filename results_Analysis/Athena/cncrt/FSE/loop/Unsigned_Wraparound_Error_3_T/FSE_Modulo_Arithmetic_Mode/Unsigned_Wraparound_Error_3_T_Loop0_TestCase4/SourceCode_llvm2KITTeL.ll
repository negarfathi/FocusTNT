...
main_wrap_around.exit2:                           ; preds = %main_wrap_around.exit, %main_bb12, %main_bb14, %main_bb15, %main_bb16
  %newbufsize.0 = phi i64 [ 4294967295, %main_bb12 ], [ %"42", %main_bb14 ], [ %"47", %main_bb16 ], [ %"38", %main_bb15 ], [ 1024, %main_wrap_around.exit ]
  %"25" = add nsw i64 1000, 0, !dbg !61
...
!47 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554443, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [lower_bound] [line 11]
!48 = metadata !{i32 11, i32 50, metadata !4, metadata !43}
