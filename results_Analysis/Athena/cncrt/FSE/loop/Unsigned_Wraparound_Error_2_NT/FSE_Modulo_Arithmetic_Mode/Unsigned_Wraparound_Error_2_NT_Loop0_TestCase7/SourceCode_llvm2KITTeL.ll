...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"13" = icmp slt i64 %ui.0, %., !dbg !58
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !58

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = mul nsw i64 %ui.0, 2, !dbg !45
  %"15" = icmp sgt i64 %"14", 4294967295, !dbg !60
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !60

main_bb7:                                         ; preds = %main_bb6
  %"16" = sub nsw i64 %"14", 4294967295, !dbg !61
  %"17" = sub nsw i64 %"16", 1, !dbg !61
  %"18" = srem i64 %"17", 4294967296, !dbg !61
  br label %main_wrap_around.exit, !dbg !61

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"14", 0, !dbg !62
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !62

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 0, %"14", !dbg !63
  %"21" = sub nsw i64 %"20", 1, !dbg !63
  %"22" = srem i64 %"21", 4294967296, !dbg !63
  %"23" = sub nsw i64 4294967295, %"22", !dbg !63
...
!45 = metadata !{i32 33, i32 14, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 32, i32 1, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!57 = metadata !{i32 31, i32 5, metadata !9, null}
!58 = metadata !{i32 31, i32 5, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 14, i32 9, metadata !26, metadata !45}
!61 = metadata !{i32 15, i32 9, metadata !28, metadata !45}
!62 = metadata !{i32 17, i32 14, metadata !30, metadata !45}
!63 = metadata !{i32 18, i32 9, metadata !32, metadata !45}
!64 = metadata !{i32 35, i32 5, metadata !9, null}
