...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"13" = icmp slt i64 %ui.0, %., !dbg !59
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !59

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = mul nsw i64 %ui.0, 2, !dbg !46
  %"15" = icmp sgt i64 %"14", 4294967295, !dbg !61
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !61

main_bb7:                                         ; preds = %main_bb6
  %"16" = sub nsw i64 %"14", 4294967295, !dbg !62
  %"17" = sub nsw i64 %"16", 1, !dbg !62
  %"18" = srem i64 %"17", 4294967296, !dbg !62
  br label %main_wrap_around.exit, !dbg !62

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"14", 0, !dbg !63
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !63

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 0, %"14", !dbg !64
  %"21" = sub nsw i64 %"20", 1, !dbg !64
  %"22" = srem i64 %"21", 4294967296, !dbg !64
  %"23" = sub nsw i64 4294967295, %"22", !dbg !64
