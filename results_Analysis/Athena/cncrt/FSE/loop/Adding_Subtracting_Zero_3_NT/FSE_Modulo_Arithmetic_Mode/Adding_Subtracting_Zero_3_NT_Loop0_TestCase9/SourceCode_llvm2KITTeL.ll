...
main_bb21:
  ...
  %"52" = icmp sle i64 30, 0, !dbg !88
  %"53" = icmp sgt i64 30, 65536, !dbg !90
  %or.cond = or i1 %"52", %"53", !dbg !88
  br i1 %or.cond, label %main_bb38, label %main_wrap_around.exit2, !dbg !88

main_wrap_around.exit2:                           ; preds = %main_bb37, %main_bb36, %main_bb35, %main_wrap_around.exit4, %main_bb21
  %errno.0 = phi i64 [ 0, %main_bb21 ], [ %.0.i3, %main_wrap_around.exit4 ], [ %errno.0, %main_bb35 ], [ %errno.0, %main_bb36 ], [ %errno.0, %main_bb37 ]
  %pos.0 = phi i64 [ 0, %main_bb21 ], [ %pos.0, %main_wrap_around.exit4 ], [ %"98", %main_bb35 ], [ %"103", %main_bb37 ], [ %"93", %main_bb36 ]
  %"54" = icmp slt i64 %pos.0, 30, !dbg !92
  br i1 %"54", label %main_bb22, label %main_bb38, !dbg !92

main_bb22:                                        ; preds = %main_wrap_around.exit2
  %"55" = sub nsw i64 30, %pos.0, !dbg !94
...
main_wrap_around.exit:                            ; preds = %main_bb23, %main_bb24, %main_bb25
  ...
  %or.cond6 = and i1 %"67", %"68", !dbg !100
  br i1 %or.cond6, label %main_bb26, label %main_read.exit, !dbg !100
...
main_read.exit:                                   ; preds = %main_wrap_around.exit, %main_wrap_around.exit4.i
  %.0.i5 = phi i64 [ %.0.i3.i, %main_wrap_around.exit4.i ], [ 0, %main_wrap_around.exit ], !dbg !101
  %"80" = icmp eq i64 %.0.i5, -1, !dbg !110
  br i1 %"80", label %main_bb30, label %main_bb34, !dbg !110

main_bb30:                                        ; preds = %main_read.exit
  %"81" = add nsw i64 %errno.0, 1, !dbg !112
  %"82" = icmp sgt i64 %"81", 2147483647, !dbg !114
  br i1 %"82", label %main_bb31, label %main_bb32, !dbg !114

main_bb31:                                        ; preds = %main_bb30
  %"83" = sub nsw i64 %"81", 2147483647, !dbg !115
  %"84" = sub nsw i64 %"83", 1, !dbg !115
  %"85" = srem i64 %"84", 4294967296, !dbg !115
  %"86" = add nsw i64 -2147483648, %"85", !dbg !115
  br label %main_wrap_around.exit4, !dbg !115

main_bb32:                                        ; preds = %main_bb30
  %"87" = icmp slt i64 %"81", -2147483648, !dbg !116
  br i1 %"87", label %main_bb33, label %main_wrap_around.exit4, !dbg !116

main_bb33:                                        ; preds = %main_bb32
  %"88" = sub nsw i64 -2147483648, %"81", !dbg !117
  %"89" = sub nsw i64 %"88", 1, !dbg !117
  %"90" = srem i64 %"89", 4294967296, !dbg !117
  %"91" = sub nsw i64 2147483647, %"90", !dbg !117
  br label %main_wrap_around.exit4, !dbg !117

main_wrap_around.exit4:                           ; preds = %main_bb31, %main_bb32, %main_bb33
  %.0.i3 = phi i64 [ %"86", %main_bb31 ], [ %"91", %main_bb33 ], [ %"81", %main_bb32 ], !dbg !112
  %"92" = icmp eq i64 %.0.i3, 5, !dbg !118
  br i1 %"92", label %main_bb38, label %main_wrap_around.exit2, !dbg !118

main_bb34:                                        ; preds = %main_read.exit
  %"93" = add nsw i64 %pos.0, %.0.i5, !dbg !120
  %"94" = icmp sgt i64 %"93", 2147483647, !dbg !121
  br i1 %"94", label %main_bb35, label %main_bb36, !dbg !121

main_bb35:                                        ; preds = %main_bb34
  %"95" = sub nsw i64 %"93", 2147483647, !dbg !122
  %"96" = sub nsw i64 %"95", 1, !dbg !122
  %"97" = srem i64 %"96", 4294967296, !dbg !122
  %"98" = add nsw i64 -2147483648, %"97", !dbg !122
  br label %main_wrap_around.exit2, !dbg !122

main_bb36:                                        ; preds = %main_bb34
  %"99" = icmp slt i64 %"93", -2147483648, !dbg !123
  br i1 %"99", label %main_bb37, label %main_wrap_around.exit2, !dbg !123

main_bb37:                                        ; preds = %main_bb36
  %"100" = sub nsw i64 -2147483648, %"93", !dbg !124
  %"101" = sub nsw i64 %"100", 1, !dbg !124
  %"102" = srem i64 %"101", 4294967296, !dbg !124
  %"103" = sub nsw i64 2147483647, %"102", !dbg !124
  br label %main_wrap_around.exit2, !dbg !124

main_bb38:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit4, %main_bb21
  ret i32 0, !dbg !125
}
...
!92 = metadata !{i32 92, i32 5, metadata !93, null}
!93 = metadata !{i32 786443, metadata !1, metadata !12, i32 92, i32 5, i32 1, i32 24} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!94 = metadata !{i32 94, i32 35, metadata !95, null}
!95 = metadata !{i32 786443, metadata !1, metadata !12, i32 93, i32 5, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!96 = metadata !{i32 38, i32 9, metadata !31, metadata !94}
!97 = metadata !{i32 39, i32 9, metadata !33, metadata !94}
!98 = metadata !{i32 41, i32 14, metadata !35, metadata !94}
!99 = metadata !{i32 42, i32 9, metadata !37, metadata !94}
!100 = metadata !{i32 49, i32 9, metadata !47, metadata !101}
!101 = metadata !{i32 94, i32 24, metadata !95, null}
!102 = metadata !{i32 53, i32 5, metadata !49, metadata !101}
!103 = metadata !{i32 67, i32 22, metadata !55, metadata !101}
!104 = metadata !{i32 38, i32 9, metadata !31, metadata !103}
!105 = metadata !{i32 39, i32 9, metadata !33, metadata !103}
!106 = metadata !{i32 41, i32 14, metadata !35, metadata !103}
!107 = metadata !{i32 42, i32 9, metadata !37, metadata !103}
!108 = metadata !{i32 75, i32 17, metadata !77, metadata !101}
!109 = metadata !{i32 76, i32 17, metadata !77, metadata !101}
!110 = metadata !{i32 95, i32 13, metadata !111, null}
!111 = metadata !{i32 786443, metadata !1, metadata !95, i32 95, i32 13, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!112 = metadata !{i32 97, i32 22, metadata !113, null}
!113 = metadata !{i32 786443, metadata !1, metadata !111, i32 96, i32 9, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!114 = metadata !{i32 38, i32 9, metadata !31, metadata !112}
!115 = metadata !{i32 39, i32 9, metadata !33, metadata !112}
!116 = metadata !{i32 41, i32 14, metadata !35, metadata !112}
!117 = metadata !{i32 42, i32 9, metadata !37, metadata !112}
!118 = metadata !{i32 98, i32 17, metadata !119, null}
!119 = metadata !{i32 786443, metadata !1, metadata !113, i32 98, i32 17, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!120 = metadata !{i32 104, i32 15, metadata !95, null}
!121 = metadata !{i32 38, i32 9, metadata !31, metadata !120}
!122 = metadata !{i32 39, i32 9, metadata !33, metadata !120}
!123 = metadata !{i32 41, i32 14, metadata !35, metadata !120}
!124 = metadata !{i32 42, i32 9, metadata !37, metadata !120}
!125 = metadata !{i32 107, i32 1, metadata !12, null}
