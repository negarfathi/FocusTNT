...
main_bb21:
  ...
  %"52" = icmp sle i64 70000, 0, !dbg !88
  %"53" = icmp sgt i64 70000, 65536, !dbg !90
  %or.cond = or i1 %"52", %"53", !dbg !88
  br i1 %or.cond, label %main_bb42, label %main_bb22, !dbg !88
...
main_bb22:                                        ; preds = %main_bb21
  ...
  call void @llvm.dbg.value(metadata !{i64 %"92"}, i64 0, metadata !115), !dbg !119
  ...
  call void @llvm.dbg.value(metadata !{i64 %"104"}, i64 0, metadata !126), !dbg !128
...
main_wrap_around.exit2:                           ; preds = %main_bb41, %main_bb40, %main_bb39, %main_wrap_around.exit4, %main_bb22
  %errno.0 = phi i64 [ 0, %main_bb22 ], [ %.0.i3, %main_wrap_around.exit4 ], [ %errno.0, %main_bb39 ], [ %errno.0, %main_bb40 ], [ %errno.0, %main_bb41 ]
  %pos.0 = phi i64 [ 0, %main_bb22 ], [ %pos.0, %main_wrap_around.exit4 ], [ %"109", %main_bb39 ], [ %"114", %main_bb41 ], [ %"104", %main_bb40 ]
  %"55" = icmp slt i64 %pos.0, 70000, !dbg !136
  br i1 %"55", label %main_bb23, label %main_bb42, !dbg !136

main_bb23:                                        ; preds = %main_wrap_around.exit2
  %"56" = sub nsw i64 70000, %pos.0, !dbg !93
...
main_wrap_around.exit2.i:                         ; preds = %main_bb33, %main_bb32, %main_bb31, %main_wrap_around.exit
  ...
  %"68" = icmp slt i64 %.06.i, %.0.i, !dbg !142
  br i1 %"68", label %main_bb27, label %main_read.exit, !dbg !142

main_bb27:                                        ; preds = %main_wrap_around.exit2.i
  %"69" = add nsw i64 %count.0.i, 1, !dbg !143
  %"70" = icmp sgt i64 %"69", 2147483647, !dbg !144
  br i1 %"70", label %main_bb28, label %main_bb29, !dbg !144

main_bb28:                                        ; preds = %main_bb27
  %"71" = sub nsw i64 %"69", 2147483647, !dbg !145
  %"72" = sub nsw i64 %"71", 1, !dbg !145
  %"73" = srem i64 %"72", 4294967296, !dbg !145
  %"74" = add nsw i64 -2147483648, %"73", !dbg !145
  br label %main_wrap_around.exit4.i, !dbg !145

main_bb29:                                        ; preds = %main_bb27
  %"75" = icmp slt i64 %"69", -2147483648, !dbg !146
  br i1 %"75", label %main_bb30, label %main_wrap_around.exit4.i, !dbg !146

main_bb30:                                        ; preds = %main_bb29
  %"76" = sub nsw i64 -2147483648, %"69", !dbg !147
  %"77" = sub nsw i64 %"76", 1, !dbg !147
  %"78" = srem i64 %"77", 4294967296, !dbg !147
  %"79" = sub nsw i64 2147483647, %"78", !dbg !147
  br label %main_wrap_around.exit4.i, !dbg !147

main_wrap_around.exit4.i:                         ; preds = %main_bb30, %main_bb29, %main_bb28
  %.0.i3.i = phi i64 [ %"74", %main_bb28 ], [ %"79", %main_bb30 ], [ %"69", %main_bb29 ], !dbg !143
  %"80" = add nsw i64 %.06.i, 1, !dbg !148
  %"81" = icmp sgt i64 %"80", 2147483647, !dbg !149
  br i1 %"81", label %main_bb31, label %main_bb32, !dbg !149

main_bb31:                                        ; preds = %main_wrap_around.exit4.i
  %"82" = sub nsw i64 %"80", 2147483647, !dbg !150
  %"83" = sub nsw i64 %"82", 1, !dbg !150
  %"84" = srem i64 %"83", 4294967296, !dbg !150
  %"85" = add nsw i64 -2147483648, %"84", !dbg !150
  br label %main_wrap_around.exit2.i, !dbg !150

main_bb32:                                        ; preds = %main_wrap_around.exit4.i
  %"86" = icmp slt i64 %"80", -2147483648, !dbg !151
  br i1 %"86", label %main_bb33, label %main_wrap_around.exit2.i, !dbg !151

main_bb33:                                        ; preds = %main_bb32
  %"87" = sub nsw i64 -2147483648, %"80", !dbg !152
  %"88" = sub nsw i64 %"87", 1, !dbg !152
  %"89" = srem i64 %"88", 4294967296, !dbg !152
  %"90" = sub nsw i64 2147483647, %"89", !dbg !152
  br label %main_wrap_around.exit2.i, !dbg !152

main_read.exit:                                   ; preds = %main_wrap_around.exit, %main_wrap_around.exit2.i
  %.0.i5 = phi i64 [ 0, %main_wrap_around.exit ], [ %count.0.i, %main_wrap_around.exit2.i ], !dbg !106
  %"91" = icmp eq i64 %.0.i5, -1, !dbg !153
  br i1 %"91", label %main_bb34, label %main_bb38, !dbg !153

main_bb34:                                        ; preds = %main_read.exit
  %"92" = add nsw i64 %errno.0, 1, !dbg !116
  %"93" = icmp sgt i64 %"92", 2147483647, !dbg !154
  br i1 %"93", label %main_bb35, label %main_bb36, !dbg !154

main_bb35:                                        ; preds = %main_bb34
  %"94" = sub nsw i64 %"92", 2147483647, !dbg !155
  %"95" = sub nsw i64 %"94", 1, !dbg !155
  %"96" = srem i64 %"95", 4294967296, !dbg !155
  %"97" = add nsw i64 -2147483648, %"96", !dbg !155
  br label %main_wrap_around.exit4, !dbg !155

main_bb36:                                        ; preds = %main_bb34
  %"98" = icmp slt i64 %"92", -2147483648, !dbg !156
  br i1 %"98", label %main_bb37, label %main_wrap_around.exit4, !dbg !156

main_bb37:                                        ; preds = %main_bb36
  %"99" = sub nsw i64 -2147483648, %"92", !dbg !157
  %"100" = sub nsw i64 %"99", 1, !dbg !157
  %"101" = srem i64 %"100", 4294967296, !dbg !157
  %"102" = sub nsw i64 2147483647, %"101", !dbg !157
  br label %main_wrap_around.exit4, !dbg !157

main_wrap_around.exit4:                           ; preds = %main_bb35, %main_bb36, %main_bb37
  %.0.i3 = phi i64 [ %"97", %main_bb35 ], [ %"102", %main_bb37 ], [ %"92", %main_bb36 ], !dbg !116
  %"103" = icmp eq i64 %.0.i3, 5, !dbg !158
  br i1 %"103", label %main_bb42, label %main_wrap_around.exit2, !dbg !158

main_bb38:                                        ; preds = %main_read.exit
  %"104" = add nsw i64 %pos.0, %.0.i5, !dbg !127
  %"105" = icmp sgt i64 %"104", 2147483647, !dbg !160
  br i1 %"105", label %main_bb39, label %main_bb40, !dbg !160

main_bb39:                                        ; preds = %main_bb38
  %"106" = sub nsw i64 %"104", 2147483647, !dbg !161
  %"107" = sub nsw i64 %"106", 1, !dbg !161
  %"108" = srem i64 %"107", 4294967296, !dbg !161
  %"109" = add nsw i64 -2147483648, %"108", !dbg !161
  br label %main_wrap_around.exit2, !dbg !161

main_bb40:                                        ; preds = %main_bb38
  %"110" = icmp slt i64 %"104", -2147483648, !dbg !162
  br i1 %"110", label %main_bb41, label %main_wrap_around.exit2, !dbg !162

main_bb41:                                        ; preds = %main_bb40
  %"111" = sub nsw i64 -2147483648, %"104", !dbg !163
  %"112" = sub nsw i64 %"111", 1, !dbg !163
  %"113" = srem i64 %"112", 4294967296, !dbg !163
  %"114" = sub nsw i64 2147483647, %"113", !dbg !163
  br label %main_wrap_around.exit2, !dbg !163
...
!143 = metadata !{i32 67, i32 22, metadata !55, metadata !106}
!144 = metadata !{i32 38, i32 9, metadata !31, metadata !143}
!145 = metadata !{i32 39, i32 9, metadata !33, metadata !143}
!146 = metadata !{i32 41, i32 14, metadata !35, metadata !143}
!147 = metadata !{i32 42, i32 9, metadata !37, metadata !143}
!148 = metadata !{i32 70, i32 24, metadata !71, metadata !106}
!149 = metadata !{i32 38, i32 9, metadata !31, metadata !148}
!150 = metadata !{i32 39, i32 9, metadata !33, metadata !148}
!151 = metadata !{i32 41, i32 14, metadata !35, metadata !148}
!152 = metadata !{i32 42, i32 9, metadata !37, metadata !148}
!153 = metadata !{i32 95, i32 13, metadata !118, null}
!154 = metadata !{i32 38, i32 9, metadata !31, metadata !116}
!155 = metadata !{i32 39, i32 9, metadata !33, metadata !116}
!156 = metadata !{i32 41, i32 14, metadata !35, metadata !116}
!157 = metadata !{i32 42, i32 9, metadata !37, metadata !116}
!158 = metadata !{i32 98, i32 17, metadata !159, null}
!159 = metadata !{i32 786443, metadata !1, metadata !117, i32 98, i32 17, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!160 = metadata !{i32 38, i32 9, metadata !31, metadata !127}
!161 = metadata !{i32 39, i32 9, metadata !33, metadata !127}
!162 = metadata !{i32 41, i32 14, metadata !35, metadata !127}
!163 = metadata !{i32 42, i32 9, metadata !37, metadata !127}
!164 = metadata !{i32 107, i32 1, metadata !12, null}
