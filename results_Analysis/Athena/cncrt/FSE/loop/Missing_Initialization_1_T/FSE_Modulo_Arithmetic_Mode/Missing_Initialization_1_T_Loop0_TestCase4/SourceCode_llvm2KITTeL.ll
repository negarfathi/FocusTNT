...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !41), !dbg !45
...
main_bb7:                                         ; preds = %main_wrap_around.exit, %main_bb6
  ...
  %"13" = icmp eq i64 %res.0, 0, !dbg !58
  br i1 %"13", label %main_bb8, label %main_bb6, !dbg !58

main_bb8:                                         ; preds = %main_bb7
  %"14" = add nsw i64 %pkt.1, 1, !dbg !42
  %"15" = icmp sgt i64 %"14", 2147483647, !dbg !60
  br i1 %"15", label %main_bb9, label %main_bb10, !dbg !60
...
main_bb10:                                        ; preds = %main_bb8
  ...
  br i1 %"20", label %main_bb11, label %main_wrap_around.exit, !dbg !62
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb10, %main_bb11
  %.0.i = phi i64 [ %"19", %main_bb9 ], [ %"24", %main_bb11 ], [ %"14", %main_bb10 ], !dbg !42
  %"25" = icmp eq i64 3, 0, !dbg !64
  br i1 %"25", label %main_bb6, label %main_bb7, !dbg !64
...
!40 = metadata !{i64 3}
!41 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777227, metadata !8, i32 0, metadata !42} ; [ DW_TAG_arg_variable ] [value] [line 11]
!42 = metadata !{i32 31, i32 20, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !44, i32 29, i32 9, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 26, i32 5, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 11, i32 33, metadata !4, metadata !42}
!46 = metadata !{i64 -2147483648}
!47 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554443, metadata !8, i32 0, metadata !42} ; [ DW_TAG_arg_variable ] [lower_bound] [line 11]
!48 = metadata !{i32 11, i32 50, metadata !4, metadata !42}
!49 = metadata !{i64 2147483647}
!50 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331659, metadata !8, i32 0, metadata !42} ; [ DW_TAG_arg_variable ] [upper_bound] [line 11]
!51 = metadata !{i32 11, i32 73, metadata !4, metadata !42}
!52 = metadata !{i64 4294967296}
!53 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 12, metadata !8, i32 0, metadata !42} ; [ DW_TAG_auto_variable ] [range] [line 12]
!54 = metadata !{i32 12, i32 15, metadata !4, metadata !42}
!55 = metadata !{i32 25, i32 5, metadata !9, null}
!56 = metadata !{i32 25, i32 5, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 5, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 28, i32 9, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !44, i32 28, i32 9, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 13, i32 9, metadata !26, metadata !42}
!61 = metadata !{i32 14, i32 9, metadata !28, metadata !42}
!62 = metadata !{i32 16, i32 14, metadata !30, metadata !42}
!63 = metadata !{i32 17, i32 9, metadata !32, metadata !42}
!64 = metadata !{i32 32, i32 17, metadata !65, null}
!65 = metadata !{i32 786443, metadata !1, metadata !43, i32 32, i32 17, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
