...
main_wrap_around.exit7:                           ; preds = %main_bb39, %main_bb38, %main_bb37, %main_bb32, %main_bb31, %main_bb30, %main_bb21
  ...
  %count.0 = phi i64 [ 2, %main_bb21 ], [ %count.0, %main_bb30 ], [ %count.0, %main_bb31 ], [ %count.0, %main_bb32 ], [ %.0.i2, %main_bb37 ], [ %.0.i2, %main_bb38 ], [ %.0.i2, %main_bb39 ]
