...
read_wrap_around.exit:                            ; preds = %read_bb11, %read_bb10, %read_bb9, %read_bb7
  %num.0 = phi i64 [ -999, %read_bb7 ], [ %"22", %read_bb9 ], [ %"27", %read_bb11 ], [ %"17", %read_bb10 ]
...
main_bb21:
  ...
  %"52" = icmp sle i64 30, 0, !dbg !83
  br i1 %"52", label %main_bb40, label %main_wrap_around.exit7, !dbg !83

main_wrap_around.exit7:                           ; preds = %main_bb39, %main_bb38, %main_bb37, %main_bb32, %main_bb31, %main_bb30, %main_bb21
  %tries.0 = phi i64 [ 0, %main_bb21 ], [ %"76", %main_bb30 ], [ %"81", %main_bb32 ], [ %"70", %main_bb31 ], [ %tries.0, %main_bb37 ], [ %tries.0, %main_bb38 ], [ %tries.0, %main_bb39 ]
  %buf.0 = phi i64 [ 0, %main_bb21 ], [ %buf.0, %main_bb30 ], [ %buf.0, %main_bb31 ], [ %buf.0, %main_bb32 ], [ %"98", %main_bb37 ], [ %"103", %main_bb39 ], [ %"93", %main_bb38 ]
  %count.0 = phi i64 [ 30, %main_bb21 ], [ %count.0, %main_bb30 ], [ %count.0, %main_bb31 ], [ %count.0, %main_bb32 ], [ %.0.i2, %main_bb37 ], [ %.0.i2, %main_bb38 ], [ %.0.i2, %main_bb39 ]
  %"53" = icmp sgt i64 %count.0, 0, !dbg !85
  br i1 %"53", label %main_bb22, label %main_bb40, !dbg !85

main_bb22:                                        ; preds = %main_wrap_around.exit7
...
main_read.exit:                                   ; preds = %main_bb22, %main_wrap_around.exit4.i
  ...
  %"68" = icmp sle i64 %.0.i, 0, !dbg !98
  br i1 %"68", label %main_bb27, label %main_bb33, !dbg !98

main_bb27:                                        ; preds = %main_read.exit
  %"69" = icmp eq i64 %.0.i, 0, !dbg !100
  br i1 %"69", label %main_bb28, label %main_wrap_around.exit5, !dbg !100

main_bb28:                                        ; preds = %main_bb27
  %"70" = add nsw i64 %tries.0, 1, !dbg !103
  %"71" = icmp slt i64 %tries.0, 5, !dbg !103
  br i1 %"71", label %main_bb29, label %main_wrap_around.exit5, !dbg !103

main_bb29:                                        ; preds = %main_bb28
  %"72" = icmp sgt i64 %"70", 2147483647, !dbg !105
  br i1 %"72", label %main_bb30, label %main_bb31, !dbg !105

main_bb30:                                        ; preds = %main_bb29
  %"73" = sub nsw i64 %"70", 2147483647, !dbg !108
  %"74" = sub nsw i64 %"73", 1, !dbg !108
  %"75" = srem i64 %"74", 4294967296, !dbg !108
  %"76" = add nsw i64 -2147483648, %"75", !dbg !108
  br label %main_wrap_around.exit7, !dbg !108

main_bb31:                                        ; preds = %main_bb29
  %"77" = icmp slt i64 %"70", -2147483648, !dbg !109
  br i1 %"77", label %main_bb32, label %main_wrap_around.exit7, !dbg !109

main_bb32:                                        ; preds = %main_bb31
  %"78" = sub nsw i64 -2147483648, %"70", !dbg !110
  %"79" = sub nsw i64 %"78", 1, !dbg !110
  %"80" = srem i64 %"79", 4294967296, !dbg !110
  %"81" = sub nsw i64 2147483647, %"80", !dbg !110
  br label %main_wrap_around.exit7, !dbg !110

main_wrap_around.exit5:                           ; preds = %main_bb28, %main_bb27
  ...
  call void @llvm.dbg.value(metadata !118, i64 0, metadata !119), !dbg !120
  br label %main_bb40, !dbg !121

main_bb33:                                        ; preds = %main_read.exit
  %"82" = sub nsw i64 %count.0, %.0.i, !dbg !122
  %"83" = icmp sgt i64 %"82", 2147483647, !dbg !123
  br i1 %"83", label %main_bb34, label %main_bb35, !dbg !123

main_bb34:                                        ; preds = %main_bb33
  %"84" = sub nsw i64 %"82", 2147483647, !dbg !124
  %"85" = sub nsw i64 %"84", 1, !dbg !124
  %"86" = srem i64 %"85", 4294967296, !dbg !124
  %"87" = add nsw i64 -2147483648, %"86", !dbg !124
  br label %main_wrap_around.exit3, !dbg !124

main_bb35:                                        ; preds = %main_bb33
  %"88" = icmp slt i64 %"82", -2147483648, !dbg !125
  br i1 %"88", label %main_bb36, label %main_wrap_around.exit3, !dbg !125

main_bb36:                                        ; preds = %main_bb35
  %"89" = sub nsw i64 -2147483648, %"82", !dbg !126
  %"90" = sub nsw i64 %"89", 1, !dbg !126
  %"91" = srem i64 %"90", 4294967296, !dbg !126
  %"92" = sub nsw i64 2147483647, %"91", !dbg !126
  br label %main_wrap_around.exit3, !dbg !126

main_wrap_around.exit3:                           ; preds = %main_bb34, %main_bb35, %main_bb36
  %.0.i2 = phi i64 [ %"87", %main_bb34 ], [ %"92", %main_bb36 ], [ %"82", %main_bb35 ], !dbg !122
  %"93" = add nsw i64 %buf.0, %.0.i, !dbg !127
  %"94" = icmp sgt i64 %"93", 2147483647, !dbg !128
  br i1 %"94", label %main_bb37, label %main_bb38, !dbg !128

main_bb37:                                        ; preds = %main_wrap_around.exit3
  %"95" = sub nsw i64 %"93", 2147483647, !dbg !129
  %"96" = sub nsw i64 %"95", 1, !dbg !129
  %"97" = srem i64 %"96", 4294967296, !dbg !129
  %"98" = add nsw i64 -2147483648, %"97", !dbg !129
  br label %main_wrap_around.exit7, !dbg !129

main_bb38:                                        ; preds = %main_wrap_around.exit3
  %"99" = icmp slt i64 %"93", -2147483648, !dbg !130
  br i1 %"99", label %main_bb39, label %main_wrap_around.exit7, !dbg !130

main_bb39:                                        ; preds = %main_bb38
  %"100" = sub nsw i64 -2147483648, %"93", !dbg !131
  %"101" = sub nsw i64 %"100", 1, !dbg !131
  %"102" = srem i64 %"101", 4294967296, !dbg !131
  %"103" = sub nsw i64 2147483647, %"102", !dbg !131
  br label %main_wrap_around.exit7, !dbg !131

main_bb40:                                        ; preds = %main_wrap_around.exit7, %main_bb21, %main_wrap_around.exit5
  ret i32 0, !dbg !132
}
...
!85 = metadata !{i32 68, i32 5, metadata !86, null}
!86 = metadata !{i32 786443, metadata !1, metadata !12, i32 68, i32 5, i32 1, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!87 = metadata !{i32 25, i32 9, metadata !47, metadata !88}
!88 = metadata !{i32 70, i32 15, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !12, i32 69, i32 5, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!98 = metadata !{i32 71, i32 13, metadata !99, null}
!99 = metadata !{i32 786443, metadata !1, metadata !89, i32 71, i32 13, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!100 = metadata !{i32 73, i32 17, metadata !101, null}
!101 = metadata !{i32 786443, metadata !1, metadata !102, i32 73, i32 17, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!102 = metadata !{i32 786443, metadata !1, metadata !99, i32 72, i32 9, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!103 = metadata !{i32 73, i32 17, metadata !104, null}
!104 = metadata !{i32 786443, metadata !1, metadata !101, i32 73, i32 17, i32 1, i32 24} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!105 = metadata !{i32 14, i32 9, metadata !31, metadata !106}
!106 = metadata !{i32 75, i32 9, metadata !107, null}
!107 = metadata !{i32 786443, metadata !1, metadata !101, i32 74, i32 1, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!108 = metadata !{i32 15, i32 9, metadata !33, metadata !106}
!109 = metadata !{i32 17, i32 14, metadata !35, metadata !106}
!110 = metadata !{i32 18, i32 9, metadata !37, metadata !106}
!111 = metadata !{i64 -2147483648}
!112 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !113} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!113 = metadata !{i32 78, i32 9, metadata !102, null}
!114 = metadata !{i32 12, i32 50, metadata !4, metadata !113}
!115 = metadata !{i64 2147483647}
!116 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !113} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!117 = metadata !{i32 12, i32 73, metadata !4, metadata !113}
!118 = metadata !{i64 4294967296}
!119 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !113} ; [ DW_TAG_auto_variable ] [range] [line 13]
!120 = metadata !{i32 13, i32 15, metadata !4, metadata !113}
!121 = metadata !{i32 79, i32 13, metadata !102, null}
!122 = metadata !{i32 81, i32 17, metadata !89, null}
!123 = metadata !{i32 14, i32 9, metadata !31, metadata !122}
!124 = metadata !{i32 15, i32 9, metadata !33, metadata !122}
!125 = metadata !{i32 17, i32 14, metadata !35, metadata !122}
!126 = metadata !{i32 18, i32 9, metadata !37, metadata !122}
!127 = metadata !{i32 82, i32 15, metadata !89, null}
!128 = metadata !{i32 14, i32 9, metadata !31, metadata !127}
!129 = metadata !{i32 15, i32 9, metadata !33, metadata !127}
!130 = metadata !{i32 17, i32 14, metadata !35, metadata !127}
!131 = metadata !{i32 18, i32 9, metadata !37, metadata !127}
!132 = metadata !{i32 85, i32 1, metadata !12, null}
