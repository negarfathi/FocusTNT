...
main_bb21:
  ...
  br i1 %"52", label %main_bb36, label %main_bb22, !dbg !83
...
main_bb22:                                        ; preds = %main_bb21
  ...
  call void @llvm.dbg.value(metadata !{i64 %"59"}, i64 0, metadata !87), !dbg !88
  call void @llvm.dbg.value(metadata !{i64 %"59"}, i64 0, metadata !100), !dbg !106
  ...
  call void @llvm.dbg.value(metadata !{i64 %"71"}, i64 0, metadata !116), !dbg !118
  ...
  call void @llvm.dbg.value(metadata !{i64 %"82"}, i64 0, metadata !125), !dbg !127
...
main_wrap_around.exit7:                           ; preds = %main_bb35, %main_bb34, %main_bb33, %main_bb28, %main_bb27, %main_bb26, %main_bb22
  %tries.0 = phi i64 [ 0, %main_bb22 ], [ %"65", %main_bb26 ], [ %"70", %main_bb28 ], [ %"59", %main_bb27 ], [ %tries.0, %main_bb33 ], [ %tries.0, %main_bb34 ], [ %tries.0, %main_bb35 ]
  %buf.0 = phi i64 [ 0, %main_bb22 ], [ %buf.0, %main_bb26 ], [ %buf.0, %main_bb27 ], [ %buf.0, %main_bb28 ], [ %"87", %main_bb33 ], [ %"92", %main_bb35 ], [ %"82", %main_bb34 ]
  %count.0 = phi i64 [ 5, %main_bb22 ], [ %count.0, %main_bb26 ], [ %count.0, %main_bb27 ], [ %count.0, %main_bb28 ], [ %.0.i2, %main_bb33 ], [ %.0.i2, %main_bb34 ], [ %.0.i2, %main_bb35 ]
  %"54" = icmp sgt i64 %count.0, 0, !dbg !135
  br i1 %"54", label %main_read.exit, label %main_bb36, !dbg !135

main_read.exit:                                   ; preds = %main_wrap_around.exit7
  %"55" = icmp ne i64 %"53", 1, !dbg !97
  %"56" = icmp slt i64 %buf.0, %count.0, !dbg !137
  %or.cond = and i1 %"55", %"56", !dbg !97
  %.0.i = select i1 %or.cond, i64 -1, i64 0, !dbg !97
  %"57" = icmp sle i64 %.0.i, 0, !dbg !138
  br i1 %"57", label %main_bb23, label %main_bb29, !dbg !138

main_bb23:                                        ; preds = %main_read.exit
  %"58" = icmp eq i64 %.0.i, 0, !dbg !139
  br i1 %"58", label %main_bb24, label %main_wrap_around.exit5, !dbg !139

main_bb24:                                        ; preds = %main_bb23
  %"59" = add nsw i64 %tries.0, 1, !dbg !140
  %"60" = icmp slt i64 %tries.0, 5, !dbg !140
  br i1 %"60", label %main_bb25, label %main_wrap_around.exit5, !dbg !140

main_bb25:                                        ; preds = %main_bb24
  %"61" = icmp sgt i64 %"59", 2147483647, !dbg !142
  br i1 %"61", label %main_bb26, label %main_bb27, !dbg !142

main_bb26:                                        ; preds = %main_bb25
  %"62" = sub nsw i64 %"59", 2147483647, !dbg !143
  %"63" = sub nsw i64 %"62", 1, !dbg !143
  %"64" = srem i64 %"63", 4294967296, !dbg !143
  %"65" = add nsw i64 -2147483648, %"64", !dbg !143
  br label %main_wrap_around.exit7, !dbg !143

main_bb27:                                        ; preds = %main_bb25
  %"66" = icmp slt i64 %"59", -2147483648, !dbg !144
  br i1 %"66", label %main_bb28, label %main_wrap_around.exit7, !dbg !144

main_bb28:                                        ; preds = %main_bb27
  %"67" = sub nsw i64 -2147483648, %"59", !dbg !145
  %"68" = sub nsw i64 %"67", 1, !dbg !145
  %"69" = srem i64 %"68", 4294967296, !dbg !145
  %"70" = sub nsw i64 2147483647, %"69", !dbg !145
  br label %main_wrap_around.exit7, !dbg !145

main_wrap_around.exit5:                           ; preds = %main_bb24, %main_bb23
  call void @llvm.dbg.value(metadata !107, i64 0, metadata !146), !dbg !148
  call void @llvm.dbg.value(metadata !110, i64 0, metadata !149), !dbg !150
  call void @llvm.dbg.value(metadata !113, i64 0, metadata !151), !dbg !152
  br label %main_bb36, !dbg !153

main_bb29:                                        ; preds = %main_read.exit
  %"71" = sub nsw i64 %count.0, %.0.i, !dbg !117
  %"72" = icmp sgt i64 %"71", 2147483647, !dbg !154
  br i1 %"72", label %main_bb30, label %main_bb31, !dbg !154

main_bb30:                                        ; preds = %main_bb29
  %"73" = sub nsw i64 %"71", 2147483647, !dbg !155
  %"74" = sub nsw i64 %"73", 1, !dbg !155
  %"75" = srem i64 %"74", 4294967296, !dbg !155
  %"76" = add nsw i64 -2147483648, %"75", !dbg !155
  br label %main_wrap_around.exit3, !dbg !155

main_bb31:                                        ; preds = %main_bb29
  %"77" = icmp slt i64 %"71", -2147483648, !dbg !156
  br i1 %"77", label %main_bb32, label %main_wrap_around.exit3, !dbg !156

main_bb32:                                        ; preds = %main_bb31
  %"78" = sub nsw i64 -2147483648, %"71", !dbg !157
  %"79" = sub nsw i64 %"78", 1, !dbg !157
  %"80" = srem i64 %"79", 4294967296, !dbg !157
  %"81" = sub nsw i64 2147483647, %"80", !dbg !157
  br label %main_wrap_around.exit3, !dbg !157

main_wrap_around.exit3:                           ; preds = %main_bb30, %main_bb31, %main_bb32
  %.0.i2 = phi i64 [ %"76", %main_bb30 ], [ %"81", %main_bb32 ], [ %"71", %main_bb31 ], !dbg !117
  %"82" = add nsw i64 %buf.0, %.0.i, !dbg !126
  %"83" = icmp sgt i64 %"82", 2147483647, !dbg !158
  br i1 %"83", label %main_bb33, label %main_bb34, !dbg !158

main_bb33:                                        ; preds = %main_wrap_around.exit3
  %"84" = sub nsw i64 %"82", 2147483647, !dbg !159
  %"85" = sub nsw i64 %"84", 1, !dbg !159
  %"86" = srem i64 %"85", 4294967296, !dbg !159
  %"87" = add nsw i64 -2147483648, %"86", !dbg !159
  br label %main_wrap_around.exit7, !dbg !159

main_bb34:                                        ; preds = %main_wrap_around.exit3
  %"88" = icmp slt i64 %"82", -2147483648, !dbg !160
  br i1 %"88", label %main_bb35, label %main_wrap_around.exit7, !dbg !160

main_bb35:                                        ; preds = %main_bb34
  %"89" = sub nsw i64 -2147483648, %"82", !dbg !161
  %"90" = sub nsw i64 %"89", 1, !dbg !161
  %"91" = srem i64 %"90", 4294967296, !dbg !161
  %"92" = sub nsw i64 2147483647, %"91", !dbg !161
  br label %main_wrap_around.exit7, !dbg !161

main_bb36:                                        ; preds = %main_wrap_around.exit7, %main_bb21, %main_wrap_around.exit5
  ret i32 0, !dbg !162
}
...
!138 = metadata !{i32 71, i32 13, metadata !105, null}
!139 = metadata !{i32 73, i32 17, metadata !103, null}
!140 = metadata !{i32 73, i32 17, metadata !141, null}
!141 = metadata !{i32 786443, metadata !1, metadata !103, i32 73, i32 17, i32 1, i32 24} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!142 = metadata !{i32 14, i32 9, metadata !31, metadata !101}
!143 = metadata !{i32 15, i32 9, metadata !33, metadata !101}
!144 = metadata !{i32 17, i32 14, metadata !35, metadata !101}
!145 = metadata !{i32 18, i32 9, metadata !37, metadata !101}
!146 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !147} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!147 = metadata !{i32 78, i32 9, metadata !104, null}
!148 = metadata !{i32 12, i32 50, metadata !4, metadata !147}
!149 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !147} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!150 = metadata !{i32 12, i32 73, metadata !4, metadata !147}
!151 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !147} ; [ DW_TAG_auto_variable ] [range] [line 13]
!152 = metadata !{i32 13, i32 15, metadata !4, metadata !147}
!153 = metadata !{i32 79, i32 13, metadata !104, null}
!154 = metadata !{i32 14, i32 9, metadata !31, metadata !117}
!155 = metadata !{i32 15, i32 9, metadata !33, metadata !117}
!156 = metadata !{i32 17, i32 14, metadata !35, metadata !117}
!157 = metadata !{i32 18, i32 9, metadata !37, metadata !117}
!158 = metadata !{i32 14, i32 9, metadata !31, metadata !126}
!159 = metadata !{i32 15, i32 9, metadata !33, metadata !126}
!160 = metadata !{i32 17, i32 14, metadata !35, metadata !126}
!161 = metadata !{i32 18, i32 9, metadata !37, metadata !126}
!162 = metadata !{i32 85, i32 1, metadata !12, null}
