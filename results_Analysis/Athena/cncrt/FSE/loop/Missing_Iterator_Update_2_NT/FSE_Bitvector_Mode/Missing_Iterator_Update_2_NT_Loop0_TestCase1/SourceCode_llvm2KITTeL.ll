...
main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get.exit1, %main_mdb_cursor_get.exit
  %"7" = icmp eq i32 1, 0, !dbg !40
  br i1 %"7", label %main_bb4, label %main_bb5, !dbg !40

main_bb4:                                         ; preds = %main_bb3
  %"8" = icmp sle i32 0, 0, !dbg !42
  br i1 %"8", label %main_bb3, label %main_mdb_cursor_get.exit1, !dbg !42

main_mdb_cursor_get.exit1:                        ; preds = %main_bb4
  %"9" = load i32* @"'flag", align 4, !dbg !44
  %"10" = add nsw i32 %"9", 1, !dbg !44
  store i32 %"10", i32* @"'flag", align 4, !dbg !44
...
!45 = metadata !{i32 32, i32 5, metadata !37, null}
