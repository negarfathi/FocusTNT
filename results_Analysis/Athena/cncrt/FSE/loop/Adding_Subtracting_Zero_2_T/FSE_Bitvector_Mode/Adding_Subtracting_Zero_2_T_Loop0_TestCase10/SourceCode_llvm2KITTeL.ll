...
main_bb5:
  ...
  %"6" = icmp slt i32 1, 0, !dbg !36
  %"7" = icmp slt i32 100, 0, !dbg !38
  %or.cond = or i1 %"6", %"7", !dbg !36
  br i1 %or.cond, label %main_bb10, label %main_bb6, !dbg !36

main_bb6:                                         ; preds = %main_bb9, %main_bb5
  %b.0 = phi i32 [ 1, %main_bb5 ], [ %"12", %main_bb9 ]
  %"8" = icmp slt i32 %b.0, 100, !dbg !40
  br i1 %"8", label %main_bb7, label %main_bb10, !dbg !40

main_bb7:                                         ; preds = %main_bb6
  %"9" = load i32* @"'flag", align 4, !dbg !42
  %"10" = icmp eq i32 %"9", 1, !dbg !42
  br i1 %"10", label %main_ff_subtitles_next_line.exit, label %main_bb8, !dbg !42

main_bb8:                                         ; preds = %main_bb7
  store i32 1, i32* @"'flag", align 4, !dbg !45
  br label %main_ff_subtitles_next_line.exit, !dbg !46

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb7, %main_bb8
  %"11" = icmp ne i32 0, 0, !dbg !47
  br i1 %"11", label %main_bb9, label %main_bb10, !dbg !47

main_bb9:                                         ; preds = %main_ff_subtitles_next_line.exit
  %"12" = add nsw i32 %b.0, 0, !dbg !49
  %"13" = sub nsw i32 100, 4, !dbg !50
  %"14" = icmp sge i32 %"12", %"13", !dbg !50
  br i1 %"14", label %main_bb10, label %main_bb6, !dbg !50
...
!40 = metadata !{i32 34, i32 5, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 15, i32 9, metadata !20, metadata !43}
!43 = metadata !{i32 36, i32 19, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 35, i32 5, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 19, i32 9, metadata !24, metadata !43}
!46 = metadata !{i32 20, i32 9, metadata !24, metadata !43}
!47 = metadata !{i32 37, i32 13, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !44, i32 37, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 39, i32 9, metadata !44, null}
!50 = metadata !{i32 40, i32 13, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !44, i32 40, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 44, i32 1, metadata !9, null}
