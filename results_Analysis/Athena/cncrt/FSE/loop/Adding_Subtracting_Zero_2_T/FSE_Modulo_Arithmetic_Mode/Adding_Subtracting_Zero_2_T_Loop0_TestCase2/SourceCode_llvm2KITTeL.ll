...
main_bb13:
  ...
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !81), !dbg !82
  %"28" = icmp slt i64 10, 0, !dbg !83
  %"29" = icmp slt i64 5, 0, !dbg !85
  %or.cond = or i1 %"28", %"29", !dbg !83
  br i1 %or.cond, label %main_bb23, label %main_bb14, !dbg !83

main_bb14:                                        ; preds = %main_bb13
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !87), !dbg !90
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !91), !dbg !93
  ...
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !87), !dbg !90
  %"30" = load i64* @"'flag", align 8, !dbg !100
  call void @llvm.dbg.value(metadata !{i64 %.}, i64 0, metadata !101), !dbg !102
  call void @llvm.dbg.value(metadata !{i64 %"34"}, i64 0, metadata !103), !dbg !105
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !106), !dbg !107
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !108), !dbg !109
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !110), !dbg !111
  call void @llvm.dbg.value(metadata !{i64 %.0.i2}, i64 0, metadata !79), !dbg !80
  call void @llvm.dbg.value(metadata !{i64 %"45"}, i64 0, metadata !112), !dbg !115
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !116), !dbg !117
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !118), !dbg !119
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !120), !dbg !121
  br label %main_bb15, !dbg !122

main_bb15:                                        ; preds = %main_wrap_around.exit, %main_bb14
  %b.0 = phi i64 [ 10, %main_bb14 ], [ %.0.i2, %main_wrap_around.exit ]
  %"31" = icmp slt i64 %b.0, 5, !dbg !123
  br i1 %"31", label %main_ff_subtitles_next_line.exit, label %main_bb23, !dbg !123

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb15
  %"32" = icmp eq i64 %"30", 1, !dbg !100
  %. = select i1 %"32", i64 0, i64 5, !dbg !100
  %"33" = icmp ne i64 %., 0, !dbg !125
  br i1 %"33", label %main_bb16, label %main_bb23, !dbg !125

main_bb16:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"34" = add nsw i64 %b.0, %., !dbg !104
  %"35" = icmp sgt i64 %"34", 2147483647, !dbg !127
  br i1 %"35", label %main_bb17, label %main_bb18, !dbg !127

main_bb17:                                        ; preds = %main_bb16
  %"36" = sub nsw i64 %"34", 2147483647, !dbg !128
  %"37" = sub nsw i64 %"36", 1, !dbg !128
  %"38" = srem i64 %"37", 4294967296, !dbg !128
  %"39" = add nsw i64 -2147483648, %"38", !dbg !128
  br label %main_wrap_around.exit3, !dbg !128

main_bb18:                                        ; preds = %main_bb16
  %"40" = icmp slt i64 %"34", -2147483648, !dbg !129
  br i1 %"40", label %main_bb19, label %main_wrap_around.exit3, !dbg !129

main_bb19:                                        ; preds = %main_bb18
  %"41" = sub nsw i64 -2147483648, %"34", !dbg !130
  %"42" = sub nsw i64 %"41", 1, !dbg !130
  %"43" = srem i64 %"42", 4294967296, !dbg !130
  %"44" = sub nsw i64 2147483647, %"43", !dbg !130
  br label %main_wrap_around.exit3, !dbg !130

main_wrap_around.exit3:                           ; preds = %main_bb17, %main_bb18, %main_bb19
  %.0.i2 = phi i64 [ %"39", %main_bb17 ], [ %"44", %main_bb19 ], [ %"34", %main_bb18 ], !dbg !104
  %"45" = sub nsw i64 5, 4, !dbg !113
  %"46" = icmp sgt i64 %"45", 2147483647, !dbg !131
  br i1 %"46", label %main_bb20, label %main_bb21, !dbg !131

main_bb20:                                        ; preds = %main_wrap_around.exit3
  %"47" = sub nsw i64 %"45", 2147483647, !dbg !132
  %"48" = sub nsw i64 %"47", 1, !dbg !132
  %"49" = srem i64 %"48", 4294967296, !dbg !132
  %"50" = add nsw i64 -2147483648, %"49", !dbg !132
  br label %main_wrap_around.exit, !dbg !132

main_bb21:                                        ; preds = %main_wrap_around.exit3
  %"51" = icmp slt i64 %"45", -2147483648, !dbg !133
  br i1 %"51", label %main_bb22, label %main_wrap_around.exit, !dbg !133

main_bb22:                                        ; preds = %main_bb21
  %"52" = sub nsw i64 -2147483648, %"45", !dbg !134
  %"53" = sub nsw i64 %"52", 1, !dbg !134
  %"54" = srem i64 %"53", 4294967296, !dbg !134
  %"55" = sub nsw i64 2147483647, %"54", !dbg !134
  br label %main_wrap_around.exit, !dbg !134

main_wrap_around.exit:                            ; preds = %main_bb20, %main_bb21, %main_bb22
  %.0.i1 = phi i64 [ %"50", %main_bb20 ], [ %"55", %main_bb22 ], [ %"45", %main_bb21 ], !dbg !113
  %"56" = icmp sge i64 %.0.i2, %.0.i1, !dbg !113
  br i1 %"56", label %main_bb23, label %main_bb15, !dbg !113
...
!81 = metadata !{i32 786688, metadata !12, metadata !"end", metadata !5, i32 47, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [end] [line 47]
!82 = metadata !{i32 47, i32 15, metadata !12, null}
!83 = metadata !{i32 48, i32 9, metadata !84, null}
!84 = metadata !{i32 786443, metadata !1, metadata !12, i32 48, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!85 = metadata !{i32 48, i32 9, metadata !86, null}
!86 = metadata !{i32 786443, metadata !1, metadata !84, i32 48, i32 9, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!87 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 25, metadata !8, i32 0, metadata !88} ; [ DW_TAG_auto_variable ] [i] [line 25]
!88 = metadata !{i32 54, i32 25, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !12, i32 53, i32 5, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!90 = metadata !{i32 25, i32 15, metadata !9, metadata !88}
!91 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777229, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [value] [line 13]
!92 = metadata !{i32 26, i32 9, metadata !9, metadata !88}
!93 = metadata !{i32 13, i32 33, metadata !4, metadata !92}
!94 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554445, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [lower_bound] [line 13]
!95 = metadata !{i32 13, i32 50, metadata !4, metadata !92}
!96 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331661, metadata !8, i32 0, metadata !92} ; [ DW_TAG_arg_variable ] [upper_bound] [line 13]
!97 = metadata !{i32 13, i32 73, metadata !4, metadata !92}
!98 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 14, metadata !8, i32 0, metadata !92} ; [ DW_TAG_auto_variable ] [range] [line 14]
!99 = metadata !{i32 14, i32 15, metadata !4, metadata !92}
!100 = metadata !{i32 27, i32 9, metadata !55, metadata !88}
!101 = metadata !{i32 786688, metadata !89, metadata !"inc", metadata !5, i32 54, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [inc] [line 54]
!102 = metadata !{i32 54, i32 19, metadata !89, null}
...
!104 = metadata !{i32 59, i32 13, metadata !89, null}
...
!113 = metadata !{i32 60, i32 18, metadata !114, null}
!114 = metadata !{i32 786443, metadata !1, metadata !89, i32 60, i32 13, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!122 = metadata !{i32 52, i32 5, metadata !12, null}
!123 = metadata !{i32 52, i32 5, metadata !124, null}
!124 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 5, i32 1, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!125 = metadata !{i32 55, i32 13, metadata !126, null}
!126 = metadata !{i32 786443, metadata !1, metadata !89, i32 55, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!127 = metadata !{i32 15, i32 9, metadata !31, metadata !104}
!128 = metadata !{i32 16, i32 9, metadata !33, metadata !104}
!129 = metadata !{i32 18, i32 14, metadata !35, metadata !104}
!130 = metadata !{i32 19, i32 9, metadata !37, metadata !104}
!131 = metadata !{i32 15, i32 9, metadata !31, metadata !113}
!132 = metadata !{i32 16, i32 9, metadata !33, metadata !113}
!133 = metadata !{i32 18, i32 14, metadata !35, metadata !113}
!134 = metadata !{i32 19, i32 9, metadata !37, metadata !113}
!135 = metadata !{i32 66, i32 1, metadata !12, null}
