...
main_bb13:
  ...
  br i1 %or.cond, label %main_bb24, label %main_bb14, !dbg !83
...
main_bb14:                                        ; preds = %main_wrap_around.exit, %main_bb13
  ...
  br i1 %"30", label %main_bb15, label %main_bb24, !dbg !87
...
main_ff_subtitles_next_line.exit:                 ; preds = %main_bb15, %main_bb16
  %"33" = icmp ne i64 0, 0, !dbg !94
  br i1 %"33", label %main_bb17, label %main_bb24, !dbg !94

main_bb17:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"34" = add nsw i64 %b.0, 0, !dbg !96
  %"35" = icmp sgt i64 %"34", 2147483647, !dbg !97
  br i1 %"35", label %main_bb18, label %main_bb19, !dbg !97

main_bb18:                                        ; preds = %main_bb17
  %"36" = sub nsw i64 %"34", 2147483647, !dbg !98
  %"37" = sub nsw i64 %"36", 1, !dbg !98
  %"38" = srem i64 %"37", 4294967296, !dbg !98
  %"39" = add nsw i64 -2147483648, %"38", !dbg !98
  br label %main_wrap_around.exit2, !dbg !98

main_bb19:                                        ; preds = %main_bb17
  %"40" = icmp slt i64 %"34", -2147483648, !dbg !99
  br i1 %"40", label %main_bb20, label %main_wrap_around.exit2, !dbg !99

main_bb20:                                        ; preds = %main_bb19
  %"41" = sub nsw i64 -2147483648, %"34", !dbg !100
  %"42" = sub nsw i64 %"41", 1, !dbg !100
  %"43" = srem i64 %"42", 4294967296, !dbg !100
  %"44" = sub nsw i64 2147483647, %"43", !dbg !100
  br label %main_wrap_around.exit2, !dbg !100

main_wrap_around.exit2:                           ; preds = %main_bb18, %main_bb19, %main_bb20
  %.0.i1 = phi i64 [ %"39", %main_bb18 ], [ %"44", %main_bb20 ], [ %"34", %main_bb19 ], !dbg !96
  %"45" = sub nsw i64 10, 4, !dbg !101
  %"46" = icmp sgt i64 %"45", 2147483647, !dbg !103
  br i1 %"46", label %main_bb21, label %main_bb22, !dbg !103
...
main_bb22:                                        ; preds = %main_wrap_around.exit2
  ...
  br i1 %"51", label %main_bb23, label %main_wrap_around.exit, !dbg !105
...
main_wrap_around.exit:                            ; preds = %main_bb21, %main_bb22, %main_bb23
  %.0.i = phi i64 [ %"50", %main_bb21 ], [ %"55", %main_bb23 ], [ %"45", %main_bb22 ], !dbg !101
  %"56" = icmp sge i64 %.0.i1, %.0.i, !dbg !101
  br i1 %"56", label %main_bb24, label %main_bb14, !dbg !101

main_bb24:                                        ; preds = %main_bb14, %main_ff_subtitles_next_line.exit, %main_wrap_around.exit, %main_bb13
  ret i32 0, !dbg !107
}
...
!78 = metadata !{i32 786688, metadata !12, metadata !"b", metadata !5, i32 46, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [b] [line 46]
!79 = metadata !{i32 46, i32 15, metadata !12, null}
!80 = metadata !{i64 10}
...
!87 = metadata !{i32 52, i32 5, metadata !88, null}
!88 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 5, i32 1, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!89 = metadata !{i32 27, i32 9, metadata !55, metadata !90}
!90 = metadata !{i32 54, i32 25, metadata !91, null}
!91 = metadata !{i32 786443, metadata !1, metadata !12, i32 53, i32 5, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!92 = metadata !{i32 33, i32 9, metadata !59, metadata !90}
!93 = metadata !{i32 34, i32 9, metadata !59, metadata !90}
!94 = metadata !{i32 55, i32 13, metadata !95, null}
!95 = metadata !{i32 786443, metadata !1, metadata !91, i32 55, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!96 = metadata !{i32 59, i32 13, metadata !91, null}
!97 = metadata !{i32 15, i32 9, metadata !31, metadata !96}
!98 = metadata !{i32 16, i32 9, metadata !33, metadata !96}
!99 = metadata !{i32 18, i32 14, metadata !35, metadata !96}
!100 = metadata !{i32 19, i32 9, metadata !37, metadata !96}
!101 = metadata !{i32 60, i32 18, metadata !102, null}
!102 = metadata !{i32 786443, metadata !1, metadata !91, i32 60, i32 13, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!103 = metadata !{i32 15, i32 9, metadata !31, metadata !101}
!104 = metadata !{i32 16, i32 9, metadata !33, metadata !101}
!105 = metadata !{i32 18, i32 14, metadata !35, metadata !101}
!106 = metadata !{i32 19, i32 9, metadata !37, metadata !101}
!107 = metadata !{i32 66, i32 1, metadata !12, null}
