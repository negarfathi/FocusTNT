...
main_bb13:
  ...
  %"28" = icmp slt i64 2, 0, !dbg !84
  %"29" = icmp slt i64 50, 0, !dbg !86
...
main_bb14:                                        ; preds = %main_wrap_around.exit, %main_bb13
  %b.0 = phi i64 [ 2, %main_bb13 ], [ %.0.i1, %main_wrap_around.exit ]
  %"30" = icmp slt i64 %b.0, 50, !dbg !88
