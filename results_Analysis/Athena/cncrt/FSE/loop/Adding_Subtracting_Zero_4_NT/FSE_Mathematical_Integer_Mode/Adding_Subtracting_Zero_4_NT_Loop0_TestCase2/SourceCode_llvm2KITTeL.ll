...
main_bb7:
  ...
  br i1 %"10", label %main_bb11, label %main_bb8, !dbg !49
...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %"16"}, i64 0, metadata !47), !dbg !48
  call void @llvm.dbg.value(metadata !{i32 %"17"}, i64 0, metadata !51), !dbg !52
...
main_bb9:                                         ; preds = %main_bb10, %main_bb8
  ...
  br i1 %"12", label %main_read.exit, label %main_bb11, !dbg !65

main_read.exit:                                   ; preds = %main_bb9
  %"13" = icmp ne i32 %"11", 1, !dbg !61
  %"14" = icmp slt i32 %buf.0, %count.0, !dbg !67
  %or.cond = and i1 %"13", %"14", !dbg !61
  %.0.i = select i1 %or.cond, i32 -1, i32 0, !dbg !61
  %"15" = icmp slt i32 %.0.i, 0, !dbg !68
  br i1 %"15", label %main_bb11, label %main_bb10, !dbg !68

main_bb10:                                        ; preds = %main_read.exit
  %"16" = sub nsw i32 %count.0, %.0.i, !dbg !70
  %"17" = add nsw i32 %buf.0, %.0.i, !dbg !71
  br label %main_bb9, !dbg !72

main_bb11:                                        ; preds = %main_bb9, %main_read.exit, %main_bb7
  ret i32 0, !dbg !73
}
...
!68 = metadata !{i32 52, i32 13, metadata !69, null}
!69 = metadata !{i32 786443, metadata !1, metadata !55, i32 52, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!70 = metadata !{i32 54, i32 9, metadata !55, null}
!71 = metadata !{i32 55, i32 9, metadata !55, null}
!72 = metadata !{i32 56, i32 5, metadata !55, null}
!73 = metadata !{i32 58, i32 1, metadata !9, null} ; [ DW_TAG_imported_module ]
