...
read_wrap_around.exit:                            ; preds = %read_bb11, %read_bb10, %read_bb9, %read_bb7
  %num.0 = phi i64 [ 500, %read_bb7 ], [ %"22", %read_bb9 ], [ %"27", %read_bb11 ], [ %"17", %read_bb10 ]
...
main_bb21:
  ...
  %"52" = icmp sle i64 3, 0, !dbg !83
  br i1 %"52", label %main_bb38, label %main_bb22, !dbg !83

main_bb22:                                        ; preds = %main_bb21
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !85), !dbg !86
  call void @llvm.dbg.value(metadata !{i64 %buf.0}, i64 0, metadata !87), !dbg !90
  call void @llvm.dbg.value(metadata !{i64 %count.0}, i64 0, metadata !91), !dbg !92
  call void @llvm.dbg.value(metadata !43, i64 0, metadata !93), !dbg !94
  %"53" = load i64* @"'flag", align 8, !dbg !95
  call void @llvm.dbg.value(metadata !{i64 %.0.i}, i64 0, metadata !96), !dbg !97
  call void @llvm.dbg.value(metadata !{i64 %"80"}, i64 0, metadata !98), !dbg !100
  call void @llvm.dbg.value(metadata !101, i64 0, metadata !102), !dbg !103
  call void @llvm.dbg.value(metadata !104, i64 0, metadata !105), !dbg !106
  ...
  call void @llvm.dbg.value(metadata !{i64 %"91"}, i64 0, metadata !110), !dbg !112
  call void @llvm.dbg.value(metadata !101, i64 0, metadata !113), !dbg !114
  call void @llvm.dbg.value(metadata !104, i64 0, metadata !115), !dbg !116
  call void @llvm.dbg.value(metadata !107, i64 0, metadata !117), !dbg !118
...
main_wrap_around.exit:                            ; preds = %main_bb37, %main_bb36, %main_bb35, %main_bb22
  ...
  %count.0 = phi i64 [ 3, %main_bb22 ], [ %.0.i2, %main_bb35 ], [ %.0.i2, %main_bb36 ], [ %.0.i2, %main_bb37 ]
  %"54" = icmp sgt i64 %count.0, 0, !dbg !120
  br i1 %"54", label %main_bb23, label %main_bb38, !dbg !120

main_bb23:                                        ; preds = %main_wrap_around.exit
  %"55" = icmp eq i64 %"53", 1, !dbg !95
  br i1 %"55", label %main_read.exit, label %main_wrap_around.exit2.i, !dbg !95

main_wrap_around.exit2.i:                         ; preds = %main_bb30, %main_bb29, %main_bb28, %main_bb23
  %count.0.i = phi i64 [ 0, %main_bb23 ], [ %.0.i3.i, %main_bb28 ], [ %.0.i3.i, %main_bb29 ], [ %.0.i3.i, %main_bb30 ], !dbg !88
  %.06.i = phi i64 [ %buf.0, %main_bb23 ], [ %"73", %main_bb28 ], [ %"78", %main_bb30 ], [ %"68", %main_bb29 ], !dbg !88
  %"56" = icmp slt i64 %.06.i, %count.0, !dbg !122
  br i1 %"56", label %main_bb24, label %main_read.exit, !dbg !122

main_bb24:                                        ; preds = %main_wrap_around.exit2.i
  %"57" = add nsw i64 %count.0.i, 1, !dbg !123
  %"58" = icmp sgt i64 %"57", 2147483647, !dbg !124
  br i1 %"58", label %main_bb25, label %main_bb26, !dbg !124

main_bb25:                                        ; preds = %main_bb24
  %"59" = sub nsw i64 %"57", 2147483647, !dbg !125
  %"60" = sub nsw i64 %"59", 1, !dbg !125
  %"61" = srem i64 %"60", 4294967296, !dbg !125
  %"62" = add nsw i64 -2147483648, %"61", !dbg !125
  br label %main_wrap_around.exit4.i, !dbg !125

main_bb26:                                        ; preds = %main_bb24
  %"63" = icmp slt i64 %"57", -2147483648, !dbg !126
  br i1 %"63", label %main_bb27, label %main_wrap_around.exit4.i, !dbg !126

main_bb27:                                        ; preds = %main_bb26
  %"64" = sub nsw i64 -2147483648, %"57", !dbg !127
  %"65" = sub nsw i64 %"64", 1, !dbg !127
  %"66" = srem i64 %"65", 4294967296, !dbg !127
  %"67" = sub nsw i64 2147483647, %"66", !dbg !127
  br label %main_wrap_around.exit4.i, !dbg !127

main_wrap_around.exit4.i:                         ; preds = %main_bb27, %main_bb26, %main_bb25
  %.0.i3.i = phi i64 [ %"62", %main_bb25 ], [ %"67", %main_bb27 ], [ %"57", %main_bb26 ], !dbg !123
  %"68" = add nsw i64 %.06.i, 1, !dbg !128
  %"69" = icmp sgt i64 %"68", 2147483647, !dbg !129
  br i1 %"69", label %main_bb28, label %main_bb29, !dbg !129

main_bb28:                                        ; preds = %main_wrap_around.exit4.i
  %"70" = sub nsw i64 %"68", 2147483647, !dbg !130
  %"71" = sub nsw i64 %"70", 1, !dbg !130
  %"72" = srem i64 %"71", 4294967296, !dbg !130
  %"73" = add nsw i64 -2147483648, %"72", !dbg !130
  br label %main_wrap_around.exit2.i, !dbg !130

main_bb29:                                        ; preds = %main_wrap_around.exit4.i
  %"74" = icmp slt i64 %"68", -2147483648, !dbg !131
  br i1 %"74", label %main_bb30, label %main_wrap_around.exit2.i, !dbg !131

main_bb30:                                        ; preds = %main_bb29
  %"75" = sub nsw i64 -2147483648, %"68", !dbg !132
  %"76" = sub nsw i64 %"75", 1, !dbg !132
  %"77" = srem i64 %"76", 4294967296, !dbg !132
  %"78" = sub nsw i64 2147483647, %"77", !dbg !132
  br label %main_wrap_around.exit2.i, !dbg !132

main_read.exit:                                   ; preds = %main_bb23, %main_wrap_around.exit2.i
  %.0.i = phi i64 [ 0, %main_bb23 ], [ %count.0.i, %main_wrap_around.exit2.i ], !dbg !88
  %"79" = icmp slt i64 %.0.i, 0, !dbg !133
  br i1 %"79", label %main_bb38, label %main_bb31, !dbg !133

main_bb31:                                        ; preds = %main_read.exit
  %"80" = sub nsw i64 %count.0, %.0.i, !dbg !99
  %"81" = icmp sgt i64 %"80", 2147483647, !dbg !135
  br i1 %"81", label %main_bb32, label %main_bb33, !dbg !135

main_bb32:                                        ; preds = %main_bb31
  %"82" = sub nsw i64 %"80", 2147483647, !dbg !136
  %"83" = sub nsw i64 %"82", 1, !dbg !136
  %"84" = srem i64 %"83", 4294967296, !dbg !136
  %"85" = add nsw i64 -2147483648, %"84", !dbg !136
  br label %main_wrap_around.exit3, !dbg !136

main_bb33:                                        ; preds = %main_bb31
  %"86" = icmp slt i64 %"80", -2147483648, !dbg !137
  br i1 %"86", label %main_bb34, label %main_wrap_around.exit3, !dbg !137

main_bb34:                                        ; preds = %main_bb33
  %"87" = sub nsw i64 -2147483648, %"80", !dbg !138
  %"88" = sub nsw i64 %"87", 1, !dbg !138
  %"89" = srem i64 %"88", 4294967296, !dbg !138
  %"90" = sub nsw i64 2147483647, %"89", !dbg !138
  br label %main_wrap_around.exit3, !dbg !138

main_wrap_around.exit3:                           ; preds = %main_bb32, %main_bb33, %main_bb34
  %.0.i2 = phi i64 [ %"85", %main_bb32 ], [ %"90", %main_bb34 ], [ %"80", %main_bb33 ], !dbg !99
  %"91" = add nsw i64 %buf.0, %.0.i, !dbg !111
  %"92" = icmp sgt i64 %"91", 2147483647, !dbg !139
  br i1 %"92", label %main_bb35, label %main_bb36, !dbg !139

main_bb35:                                        ; preds = %main_wrap_around.exit3
  %"93" = sub nsw i64 %"91", 2147483647, !dbg !140
  %"94" = sub nsw i64 %"93", 1, !dbg !140
  %"95" = srem i64 %"94", 4294967296, !dbg !140
  %"96" = add nsw i64 -2147483648, %"95", !dbg !140
  br label %main_wrap_around.exit, !dbg !140

main_bb36:                                        ; preds = %main_wrap_around.exit3
  %"97" = icmp slt i64 %"91", -2147483648, !dbg !141
  br i1 %"97", label %main_bb37, label %main_wrap_around.exit, !dbg !141

main_bb37:                                        ; preds = %main_bb36
  %"98" = sub nsw i64 -2147483648, %"91", !dbg !142
  %"99" = sub nsw i64 %"98", 1, !dbg !142
  %"100" = srem i64 %"99", 4294967296, !dbg !142
  %"101" = sub nsw i64 2147483647, %"100", !dbg !142
  br label %main_wrap_around.exit, !dbg !142

main_bb38:                                        ; preds = %main_wrap_around.exit, %main_read.exit, %main_bb21
  ret i32 0, !dbg !143
}
...
!87 = metadata !{i32 786689, metadata !9, metadata !"loc", metadata !5, i32 16777238, metadata !8, i32 0, metadata !88} ; [ DW_TAG_arg_variable ] [loc] [line 22]
...
!90 = metadata !{i32 22, i32 27, metadata !9, metadata !88}
!91 = metadata !{i32 786689, metadata !9, metadata !"len", metadata !5, i32 33554454, metadata !8, i32 0, metadata !88} ; [ DW_TAG_arg_variable ] [len] [line 22]
!92 = metadata !{i32 22, i32 43, metadata !9, metadata !88}
!93 = metadata !{i32 786688, metadata !9, metadata !"count", metadata !5, i32 24, metadata !8, i32 0, metadata !88} ; [ DW_TAG_auto_variable ] [count] [line 24]
!94 = metadata !{i32 24, i32 15, metadata !9, metadata !88}
!95 = metadata !{i32 25, i32 9, metadata !47, metadata !88}
!96 = metadata !{i32 786688, metadata !12, metadata !"ret", metadata !5, i32 65, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ret] [line 65]
!97 = metadata !{i32 65, i32 15, metadata !12, null}
...
!99 = metadata !{i32 74, i32 17, metadata !89, null}
!100 = metadata !{i32 12, i32 33, metadata !4, metadata !99}
!101 = metadata !{i64 -2147483648}
!102 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !99} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!103 = metadata !{i32 12, i32 50, metadata !4, metadata !99}
!104 = metadata !{i64 2147483647}
...
!107 = metadata !{i64 4294967296}
!108 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !99} ; [ DW_TAG_auto_variable ] [range] [line 13]
!109 = metadata !{i32 13, i32 15, metadata !4, metadata !99}
...
!111 = metadata !{i32 75, i32 15, metadata !89, null}
...
!119 = metadata !{i32 67, i32 5, metadata !12, null}
!120 = metadata !{i32 67, i32 5, metadata !121, null}
!121 = metadata !{i32 786443, metadata !1, metadata !12, i32 67, i32 5, i32 1, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!122 = metadata !{i32 29, i32 5, metadata !49, metadata !88}
!123 = metadata !{i32 43, i32 22, metadata !55, metadata !88}
!124 = metadata !{i32 14, i32 9, metadata !31, metadata !123}
!125 = metadata !{i32 15, i32 9, metadata !33, metadata !123}
!126 = metadata !{i32 17, i32 14, metadata !35, metadata !123}
!127 = metadata !{i32 18, i32 9, metadata !37, metadata !123}
!128 = metadata !{i32 46, i32 24, metadata !71, metadata !88}
!129 = metadata !{i32 14, i32 9, metadata !31, metadata !128}
!130 = metadata !{i32 15, i32 9, metadata !33, metadata !128}
!131 = metadata !{i32 17, i32 14, metadata !35, metadata !128}
!132 = metadata !{i32 18, i32 9, metadata !37, metadata !128}
!133 = metadata !{i32 70, i32 13, metadata !134, null}
!134 = metadata !{i32 786443, metadata !1, metadata !89, i32 70, i32 13, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!135 = metadata !{i32 14, i32 9, metadata !31, metadata !99}
!136 = metadata !{i32 15, i32 9, metadata !33, metadata !99}
!137 = metadata !{i32 17, i32 14, metadata !35, metadata !99}
!138 = metadata !{i32 18, i32 9, metadata !37, metadata !99}
!139 = metadata !{i32 14, i32 9, metadata !31, metadata !111}
!140 = metadata !{i32 15, i32 9, metadata !33, metadata !111}
!141 = metadata !{i32 17, i32 14, metadata !35, metadata !111}
!142 = metadata !{i32 18, i32 9, metadata !37, metadata !111}
!143 = metadata !{i32 78, i32 1, metadata !12, null}
