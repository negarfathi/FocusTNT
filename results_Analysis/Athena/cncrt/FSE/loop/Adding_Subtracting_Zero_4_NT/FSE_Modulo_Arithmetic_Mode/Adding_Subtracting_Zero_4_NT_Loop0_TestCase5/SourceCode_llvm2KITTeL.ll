...
read_wrap_around.exit:                            ; preds = %read_bb11, %read_bb10, %read_bb9, %read_bb7
  %num.0 = phi i64 [ 1, %read_bb7 ], [ %"22", %read_bb9 ], [ %"27", %read_bb11 ], [ %"17", %read_bb10 ]
...
main_wrap_around.exit:                            ; preds = %main_bb37, %main_bb36, %main_bb35, %main_bb22
  ...
  %count.0 = phi i64 [ 15, %main_bb22 ], [ %.0.i2, %main_bb35 ], [ %.0.i2, %main_bb36 ], [ %.0.i2, %main_bb37 ]
