...
define i32 @main() #0 {
main_bb17:
  call void @llvm.dbg.value(metadata !85, i64 0, metadata !136), !dbg !137
  %"67" = icmp sle i64 2, 0, !dbg !138
  %"68" = icmp sgt i64 2, 65534, !dbg !140
  %or.cond = or i1 %"67", %"68", !dbg !138
  br i1 %or.cond, label %main_bb28, label %main_bb18, !dbg !138

main_bb18:                                        ; preds = %main_bb17
  call void @llvm.dbg.value(metadata !85, i64 0, metadata !142), !dbg !144
  call void @llvm.dbg.value(metadata !71, i64 0, metadata !145), !dbg !147
  %"69" = load i32* @"'memory0_freeIndex", align 4, !dbg !148
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !149), !dbg !150
  %"70" = load i32* @"'memory0_freeIndex", align 4, !dbg !151
  %"71" = add nsw i32 %"70", 16, !dbg !151
  store i32 %"71", i32* @"'memory0_freeIndex", align 4, !dbg !151
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !152), !dbg !153
  %"72" = sext i32 %"69" to i64, !dbg !154
  %"73" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"72", !dbg !154
  %"74" = getelementptr inbounds %struct.NNode* %"73", i32 0, i32 0, !dbg !154
  store i64 1, i64* %"74", align 8, !dbg !154
  %"75" = sext i32 %"69" to i64, !dbg !155
  %"76" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"75", !dbg !155
  %"77" = getelementptr inbounds %struct.NNode* %"76", i32 0, i32 1, !dbg !155
  store i32 0, i32* %"77", align 4, !dbg !155
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !156), !dbg !157
  call void @llvm.dbg.value(metadata !85, i64 0, metadata !158), !dbg !159
  call void @llvm.dbg.value(metadata !71, i64 0, metadata !160), !dbg !162
  call void @llvm.dbg.value(metadata !100, i64 0, metadata !163), !dbg !165
  call void @llvm.dbg.value(metadata !103, i64 0, metadata !166), !dbg !167
  call void @llvm.dbg.value(metadata !106, i64 0, metadata !168), !dbg !169
  br label %main_wrap_around.exit.i, !dbg !170

main_wrap_around.exit.i:                          ; preds = %main_bb22, %main_bb21, %main_bb20, %main_bb18
  %i.0.i = phi i64 [ 2, %main_bb18 ], [ %"100", %main_bb20 ], [ %"105", %main_bb22 ], [ %"95", %main_bb21 ], !dbg !143
  %cyclic.0.i = phi i32 [ %"69", %main_bb18 ], [ %"94", %main_bb20 ], [ %"94", %main_bb21 ], [ %"94", %main_bb22 ], !dbg !143
  %"78" = icmp sle i64 %i.0.i, 2, !dbg !171
  br i1 %"78", label %main_bb19, label %main_initLink.exit, !dbg !171

main_bb19:                                        ; preds = %main_wrap_around.exit.i
  %"79" = load i32* @"'memory0_freeIndex", align 4, !dbg !172
  %"80" = load i32* @"'memory0_freeIndex", align 4, !dbg !173
  %"81" = add nsw i32 %"80", 16, !dbg !173
  store i32 %"81", i32* @"'memory0_freeIndex", align 4, !dbg !173
  %"82" = sext i32 %"79" to i64, !dbg !174
  %"83" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"82", !dbg !174
  %"84" = getelementptr inbounds %struct.NNode* %"83", i32 0, i32 0, !dbg !174
  store i64 %i.0.i, i64* %"84", align 8, !dbg !174
  %"85" = sext i32 %"79" to i64, !dbg !175
  %"86" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"85", !dbg !175
  %"87" = getelementptr inbounds %struct.NNode* %"86", i32 0, i32 1, !dbg !175
  store i32 0, i32* %"87", align 4, !dbg !175
  %"88" = sext i32 %cyclic.0.i to i64, !dbg !176
  %"89" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"88", !dbg !176
  %"90" = getelementptr inbounds %struct.NNode* %"89", i32 0, i32 1, !dbg !176
  store i32 %"79", i32* %"90", align 4, !dbg !176
  %"91" = sext i32 %cyclic.0.i to i64, !dbg !177
  %"92" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"91", !dbg !177
  %"93" = getelementptr inbounds %struct.NNode* %"92", i32 0, i32 1, !dbg !177
  %"94" = load i32* %"93", align 4, !dbg !177
  %"95" = add nsw i64 %i.0.i, 1, !dbg !164
  %"96" = icmp sgt i64 %"95", 2147483647, !dbg !178
  br i1 %"96", label %main_bb20, label %main_bb21, !dbg !178

main_bb20:                                        ; preds = %main_bb19
  %"97" = sub nsw i64 %"95", 2147483647, !dbg !179
  %"98" = sub nsw i64 %"97", 1, !dbg !179
  %"99" = srem i64 %"98", 4294967296, !dbg !179
  %"100" = add nsw i64 -2147483648, %"99", !dbg !179
  br label %main_wrap_around.exit.i, !dbg !179

main_bb21:                                        ; preds = %main_bb19
  %"101" = icmp slt i64 %"95", -2147483648, !dbg !180
  br i1 %"101", label %main_bb22, label %main_wrap_around.exit.i, !dbg !180

main_bb22:                                        ; preds = %main_bb21
  %"102" = sub nsw i64 -2147483648, %"95", !dbg !181
  %"103" = sub nsw i64 %"102", 1, !dbg !181
  %"104" = srem i64 %"103", 4294967296, !dbg !181
  %"105" = sub nsw i64 2147483647, %"104", !dbg !181
  br label %main_wrap_around.exit.i, !dbg !181

main_initLink.exit:                               ; preds = %main_wrap_around.exit.i
  %"106" = sext i32 %cyclic.0.i to i64, !dbg !182
  %"107" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"106", !dbg !182
  %"108" = getelementptr inbounds %struct.NNode* %"107", i32 0, i32 1, !dbg !182
  store i32 %"69", i32* %"108", align 4, !dbg !182
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !183), !dbg !184
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !185), !dbg !186
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !187), !dbg !189
  call void @llvm.dbg.value(metadata !{i32 %"69"}, i64 0, metadata !190), !dbg !191
  br label %main_bb23, !dbg !192

main_bb23:                                        ; preds = %main_bb24, %main_initLink.exit
  %begin.0.i = phi i32 [ %"69", %main_initLink.exit ], [ %"117", %main_bb24 ], !dbg !188
  %"109" = sext i32 %begin.0.i to i64, !dbg !193
  %"110" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"109", !dbg !193
  %"111" = getelementptr inbounds %struct.NNode* %"110", i32 0, i32 1, !dbg !193
  %"112" = load i32* %"111", align 4, !dbg !193
  %"113" = icmp ne i32 %"112", %"69", !dbg !193
  br i1 %"113", label %main_bb24, label %main_findEnd.exit, !dbg !193

main_bb24:                                        ; preds = %main_bb23
  %"114" = sext i32 %begin.0.i to i64, !dbg !194
  %"115" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"114", !dbg !194
  %"116" = getelementptr inbounds %struct.NNode* %"115", i32 0, i32 1, !dbg !194
  %"117" = load i32* %"116", align 4, !dbg !194
  br label %main_bb23, !dbg !195

main_findEnd.exit:                                ; preds = %main_bb23, %main_bb27
  %h.0 = phi i64 [ %h.1, %main_bb27 ], [ 0, %main_bb23 ]
  %node.0 = phi i32 [ %"131", %main_bb27 ], [ %"69", %main_bb23 ]
  %"118" = icmp ne i32 %node.0, 0, !dbg !196
  br i1 %"118", label %main_bb25, label %main_bb28, !dbg !196

main_bb25:                                        ; preds = %main_findEnd.exit
  %"119" = sext i32 %node.0 to i64, !dbg !198
  %"120" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"119", !dbg !198
  %"121" = getelementptr inbounds %struct.NNode* %"120", i32 0, i32 0, !dbg !198
  %"122" = load i64* %"121", align 8, !dbg !198
  %"123" = icmp sgt i64 %"122", %h.0, !dbg !198
  br i1 %"123", label %main_bb26, label %main_bb27, !dbg !198

main_bb26:                                        ; preds = %main_bb25
  %"124" = sext i32 %node.0 to i64, !dbg !201
  %"125" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"124", !dbg !201
  %"126" = getelementptr inbounds %struct.NNode* %"125", i32 0, i32 0, !dbg !201
  %"127" = load i64* %"126", align 8, !dbg !201
  br label %main_bb27, !dbg !203

main_bb27:                                        ; preds = %main_bb26, %main_bb25
  %h.1 = phi i64 [ %"127", %main_bb26 ], [ %h.0, %main_bb25 ]
  %"128" = sext i32 %node.0 to i64, !dbg !204
  %"129" = getelementptr inbounds [100000 x %struct.NNode]* @memory0, i32 0, i64 %"128", !dbg !204
  %"130" = getelementptr inbounds %struct.NNode* %"129", i32 0, i32 1, !dbg !204
  %"131" = load i32* %"130", align 4, !dbg !204
  br label %main_findEnd.exit, !dbg !205
...
!136 = metadata !{i32 786688, metadata !18, metadata !"num", metadata !5, i32 75, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num] [line 75]
!137 = metadata !{i32 75, i32 15, metadata !18, null}
!138 = metadata !{i32 76, i32 9, metadata !139, null}
!139 = metadata !{i32 786443, metadata !1, metadata !18, i32 76, i32 9, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!140 = metadata !{i32 76, i32 9, metadata !141, null}
!141 = metadata !{i32 786443, metadata !1, metadata !139, i32 76, i32 9, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!142 = metadata !{i32 786689, metadata !14, metadata !"n", metadata !5, i32 16777262, metadata !8, i32 0, metadata !143} ; [ DW_TAG_arg_variable ] [n] [line 46]
!143 = metadata !{i32 80, i32 16, metadata !18, null}
!144 = metadata !{i32 46, i32 24, metadata !14, metadata !143}
!145 = metadata !{i32 786689, metadata !9, metadata !"size", metadata !5, i32 16777247, metadata !12, i32 0, metadata !146} ; [ DW_TAG_arg_variable ] [size] [line 31]
!146 = metadata !{i32 47, i32 16, metadata !14, metadata !143}
!147 = metadata !{i32 31, i32 26, metadata !9, metadata !146}
!148 = metadata !{i32 32, i32 4, metadata !9, metadata !146}
!149 = metadata !{i32 786688, metadata !9, metadata !"allocatedIndex", metadata !5, i32 32, metadata !12, i32 0, metadata !146} ; [ DW_TAG_auto_variable ] [allocatedIndex] [line 32]
!150 = metadata !{i32 32, i32 8, metadata !9, metadata !146}
!151 = metadata !{i32 33, i32 4, metadata !9, metadata !146}
!152 = metadata !{i32 786688, metadata !14, metadata !"head", metadata !5, i32 47, metadata !12, i32 0, metadata !143} ; [ DW_TAG_auto_variable ] [head] [line 47]
!153 = metadata !{i32 47, i32 9, metadata !14, metadata !143}
!154 = metadata !{i32 48, i32 5, metadata !14, metadata !143}
!155 = metadata !{i32 49, i32 5, metadata !14, metadata !143}
!156 = metadata !{i32 786688, metadata !14, metadata !"cyclic", metadata !5, i32 50, metadata !12, i32 0, metadata !143} ; [ DW_TAG_auto_variable ] [cyclic] [line 50]
!157 = metadata !{i32 50, i32 9, metadata !14, metadata !143}
!158 = metadata !{i32 786688, metadata !14, metadata !"i", metadata !5, i32 52, metadata !8, i32 0, metadata !143} ; [ DW_TAG_auto_variable ] [i] [line 52]
!159 = metadata !{i32 52, i32 15, metadata !14, metadata !143}
!160 = metadata !{i32 786689, metadata !9, metadata !"size", metadata !5, i32 16777247, metadata !12, i32 0, metadata !161} ; [ DW_TAG_arg_variable ] [size] [line 31]
!161 = metadata !{i32 54, i32 20, metadata !90, metadata !143}
!162 = metadata !{i32 31, i32 26, metadata !9, metadata !161}
!163 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554453, metadata !8, i32 0, metadata !164} ; [ DW_TAG_arg_variable ] [lower_bound] [line 21]
!164 = metadata !{i32 53, i32 26, metadata !91, metadata !143}
!165 = metadata !{i32 21, i32 50, metadata !4, metadata !164}
!166 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331669, metadata !8, i32 0, metadata !164} ; [ DW_TAG_arg_variable ] [upper_bound] [line 21]
!167 = metadata !{i32 21, i32 73, metadata !4, metadata !164}
!168 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 22, metadata !8, i32 0, metadata !164} ; [ DW_TAG_auto_variable ] [range] [line 22]
!169 = metadata !{i32 22, i32 15, metadata !4, metadata !164}
!170 = metadata !{i32 53, i32 10, metadata !91, metadata !143}
!171 = metadata !{i32 53, i32 10, metadata !111, metadata !143}
!172 = metadata !{i32 32, i32 4, metadata !9, metadata !161}
!173 = metadata !{i32 33, i32 4, metadata !9, metadata !161}
!174 = metadata !{i32 55, i32 9, metadata !90, metadata !143}
!175 = metadata !{i32 56, i32 9, metadata !90, metadata !143}
!176 = metadata !{i32 57, i32 9, metadata !90, metadata !143}
!177 = metadata !{i32 58, i32 9, metadata !90, metadata !143} ; [ DW_TAG_imported_module ]
!178 = metadata !{i32 23, i32 9, metadata !47, metadata !164}
!179 = metadata !{i32 24, i32 9, metadata !49, metadata !164}
!180 = metadata !{i32 26, i32 14, metadata !51, metadata !164}
!181 = metadata !{i32 27, i32 9, metadata !53, metadata !164}
!182 = metadata !{i32 60, i32 5, metadata !14, metadata !143}
!183 = metadata !{i32 786688, metadata !18, metadata !"list", metadata !5, i32 80, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [list] [line 80]
!184 = metadata !{i32 80, i32 9, metadata !18, null}
!185 = metadata !{i32 786688, metadata !18, metadata !"node", metadata !5, i32 81, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [node] [line 81]
!186 = metadata !{i32 81, i32 9, metadata !18, null}
!187 = metadata !{i32 786689, metadata !17, metadata !"list", metadata !5, i32 16777279, metadata !12, i32 0, metadata !188} ; [ DW_TAG_arg_variable ] [list] [line 63]
!188 = metadata !{i32 82, i32 15, metadata !18, null}
!189 = metadata !{i32 63, i32 18, metadata !17, metadata !188}
!190 = metadata !{i32 786688, metadata !17, metadata !"begin", metadata !5, i32 65, metadata !12, i32 0, metadata !188} ; [ DW_TAG_auto_variable ] [begin] [line 65]
!191 = metadata !{i32 65, i32 9, metadata !17, metadata !188}
!192 = metadata !{i32 66, i32 5, metadata !17, metadata !188}
!193 = metadata !{i32 66, i32 5, metadata !131, metadata !188}
!194 = metadata !{i32 68, i32 9, metadata !133, metadata !188}
!195 = metadata !{i32 69, i32 1, metadata !133, metadata !188}
!196 = metadata !{i32 84, i32 5, metadata !197, null}
!197 = metadata !{i32 786443, metadata !1, metadata !18, i32 84, i32 5, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!198 = metadata !{i32 86, i32 13, metadata !199, null}
!199 = metadata !{i32 786443, metadata !1, metadata !200, i32 86, i32 13, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!200 = metadata !{i32 786443, metadata !1, metadata !18, i32 85, i32 5, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!201 = metadata !{i32 88, i32 13, metadata !202, null}
!202 = metadata !{i32 786443, metadata !1, metadata !199, i32 87, i32 1, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!203 = metadata !{i32 89, i32 1, metadata !202, null}
!204 = metadata !{i32 90, i32 9, metadata !200, null}
!205 = metadata !{i32 91, i32 5, metadata !200, null}
!206 = metadata !{i32 93, i32 1, metadata !18, null}
