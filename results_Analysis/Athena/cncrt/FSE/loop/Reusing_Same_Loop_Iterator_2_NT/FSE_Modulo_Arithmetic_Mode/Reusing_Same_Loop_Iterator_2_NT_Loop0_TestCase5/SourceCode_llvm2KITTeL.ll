...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"14" = icmp slt i64 %i.1, 3, !dbg !43
  %"15" = add nsw i64 %i.1, 1, !dbg !48
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !53), !dbg !55
  ...
  br i1 %"16", label %main_bb11, label %main_bb12, !dbg !65

main_bb11:                                        ; preds = %main_bb10
  %"26" = sub nsw i64 %"15", 2147483647, !dbg !66
  %"27" = sub nsw i64 %"26", 1, !dbg !66
  %"28" = srem i64 %"27", 4294967296, !dbg !66
  %"29" = add nsw i64 -2147483648, %"28", !dbg !66
  br label %main_wrap_around.exit2, !dbg !66

main_bb12:                                        ; preds = %main_bb10
  %"30" = icmp slt i64 %"15", -2147483648, !dbg !67
  br i1 %"30", label %main_bb13, label %main_wrap_around.exit2, !dbg !67

main_bb13:                                        ; preds = %main_bb12
  %"31" = sub nsw i64 -2147483648, %"15", !dbg !68
  %"32" = sub nsw i64 %"31", 1, !dbg !68
  %"33" = srem i64 %"32", 4294967296, !dbg !68
  %"34" = sub nsw i64 2147483647, %"33", !dbg !68
