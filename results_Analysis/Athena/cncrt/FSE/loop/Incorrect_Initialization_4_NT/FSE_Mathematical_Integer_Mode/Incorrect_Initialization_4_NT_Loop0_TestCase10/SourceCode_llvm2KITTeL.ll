...
main_bb0:
  ...
  %"1" = icmp slt i32 10, 0, !dbg !23
  %"2" = icmp sle i32 15, 0, !dbg !25
  %or.cond = or i1 %"1", %"2", !dbg !23
  %"3" = icmp sle i32 5, 0, !dbg !27
  %or.cond1 = or i1 %or.cond, %"3", !dbg !23
  %"4" = icmp sgt i32 5, 15, !dbg !29
  %or.cond2 = or i1 %or.cond1, %"4", !dbg !23
  br i1 %or.cond2, label %main_bb4, label %main_bb1, !dbg !23

main_bb1:                                         ; preds = %main_bb0
  %"5" = srem i32 10, 15, !dbg !31
...
main_bb2:                                         ; preds = %main_bb3, %main_bb1
  ...
  %i.0 = phi i32 [ %"5", %main_bb1 ], [ %"9", %main_bb3 ]
  %"7" = icmp slt i32 %i.0, 15, !dbg !39
  br i1 %"7", label %main_bb3, label %main_bb4, !dbg !39

main_bb3:                                         ; preds = %main_bb2
  %"8" = icmp ne i32 %r.0, 0, !dbg !41
  %r.0. = select i1 %"8", i32 %r.0, i32 %"6", !dbg !41
  %"9" = add nsw i32 %i.0, %r.0., !dbg !42
