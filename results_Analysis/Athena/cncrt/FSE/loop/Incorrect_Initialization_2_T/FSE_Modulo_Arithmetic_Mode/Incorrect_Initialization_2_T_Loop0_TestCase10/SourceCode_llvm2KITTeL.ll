...
res_return_bb15:                                  ; preds = %res_return_wrap_around.exit2, %res_return_wrap_around.exit
  %.0 = phi i64 [ 3, %res_return_wrap_around.exit ], [ -1, %res_return_wrap_around.exit2 ]
  ret i64 %.0, !dbg !83
}
...
main_bb17:                                        ; preds = %main_NewDefault, %main_bb18, %main_bb16
  %matroska.0 = phi i64 [ 11, %main_bb16 ], [ 1, %main_bb18 ], [ %matroska.0, %main_NewDefault ]
...
main_res_return.exit:                             ; preds = %main_wrap_around.exit.i, %main_wrap_around.exit2.i, %main_bb17
  %res.0 = phi i64 [ 0, %main_bb17 ], [ 3, %main_wrap_around.exit.i ], [ -1, %main_wrap_around.exit2.i ]
