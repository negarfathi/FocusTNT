...
main_bb5:
  ...
  br i1 %or.cond5, label %main_bb17, label %main_wrap_around.exit2, !dbg !43

main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_bb5
  %size.0 = phi i64 [ 64, %main_bb5 ], [ %.0.i3, %main_bb14 ], [ %.0.i3, %main_bb15 ], [ %.0.i3, %main_bb16 ]
  %buffer_bytes_left.0 = phi i64 [ 0, %main_bb5 ], [ %"45", %main_bb14 ], [ %"50", %main_bb16 ], [ %"40", %main_bb15 ]
...
main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  ...
  br i1 %"26", label %main_bb9, label %main_bb17, !dbg !49
...
main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  ...
  br i1 %or.cond6, label %main_bb17, label %main_bb13, !dbg !60
...
main_bb17:                                        ; preds = %main_wrap_around.exit, %main_wrap_around.exit4, %main_bb5
  ret i32 0, !dbg !69
}
...
!64 = metadata !{i32 40, i32 29, metadata !55, null}
...
!69 = metadata !{i32 43, i32 1, metadata !9, null}
