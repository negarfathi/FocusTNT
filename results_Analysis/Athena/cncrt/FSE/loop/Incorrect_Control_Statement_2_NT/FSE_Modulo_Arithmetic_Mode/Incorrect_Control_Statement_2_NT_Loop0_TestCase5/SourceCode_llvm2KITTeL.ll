...
main_bb5:
  ...
  call void @llvm.memset.p0i8.i64(i8* %"14", i8 0, i64 80, i32 16, i1 false), !dbg !45
  %"15" = bitcast i8* %"14" to [10 x i64]*, !dbg !45
  %"16" = getelementptr [10 x i64]* %"15", i32 0, i32 3, !dbg !45
  store i64 5, i64* %"16", !dbg !45
...
main_wrap_around.exit2:                           ; preds = %main_LeafBlock3, %main_bb18, %main_bb17, %main_bb16, %main_wrap_around.exit
  %i1.0 = phi i64 [ 0, %main_wrap_around.exit ], [ %i1.0, %main_LeafBlock3 ], [ %"45", %main_bb16 ], [ %"50", %main_bb18 ], [ %"40", %main_bb17 ]
  %"29" = icmp slt i64 %i1.0, 10, !dbg !70
  br i1 %"29", label %main_bb10, label %main_bb19, !dbg !70

main_bb10:                                        ; preds = %main_wrap_around.exit2
  %"30" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i1.0, !dbg !72
  %"31" = load i64* %"30", align 8, !dbg !72
...
main_bb11:                                        ; preds = %main_LeafBlock
  %"32" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !74
  %"33" = load i64* %"32", align 8, !dbg !74
  %"34" = icmp ne i64 %"33", 0, !dbg !74
  br i1 %"34", label %main_bb12, label %main_bb19, !dbg !74

main_bb12:                                        ; preds = %main_bb11
  %"35" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !77
  %"36" = load i64* %"35", align 8, !dbg !77
...
main_bb13:                                        ; preds = %main_NewDefault
  %"37" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i1.0, !dbg !79
  %"38" = load i64* %"37", align 8, !dbg !79
  br label %main_bb14, !dbg !80

main_bb14:                                        ; preds = %main_bb13, %main_bb12
  %table.0 = phi i64 [ %"38", %main_bb13 ], [ %"36", %main_bb12 ]
  %"39" = icmp ne i64 %table.0, 0, !dbg !81
  br i1 %"39", label %main_bb19, label %main_bb15, !dbg !81

main_bb15:                                        ; preds = %main_bb14
  %"40" = add nsw i64 %i1.0, 1, !dbg !83
  %"41" = icmp sgt i64 %"40", 2147483647, !dbg !84
  br i1 %"41", label %main_bb16, label %main_bb17, !dbg !84

main_bb16:                                        ; preds = %main_bb15
  %"42" = sub nsw i64 %"40", 2147483647, !dbg !85
  %"43" = sub nsw i64 %"42", 1, !dbg !85
  %"44" = srem i64 %"43", 4294967296, !dbg !85
  %"45" = add nsw i64 -2147483648, %"44", !dbg !85
  br label %main_wrap_around.exit2, !dbg !85

main_bb17:                                        ; preds = %main_bb15
  %"46" = icmp slt i64 %"40", -2147483648, !dbg !86
  br i1 %"46", label %main_bb18, label %main_wrap_around.exit2, !dbg !86

main_bb18:                                        ; preds = %main_bb17
  %"47" = sub nsw i64 -2147483648, %"40", !dbg !87
  %"48" = sub nsw i64 %"47", 1, !dbg !87
  %"49" = srem i64 %"48", 4294967296, !dbg !87
  %"50" = sub nsw i64 2147483647, %"49", !dbg !87
