...
@main.slots_used = private unnamed_addr constant [10 x i32] [i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2], align 16
...
main_bb3:                                         ; preds = %main_LeafBlock1, %main_bb1, %main_bb9
  %i1.0 = phi i32 [ %"20", %main_bb9 ], [ 0, %main_bb1 ], [ %i1.0, %main_LeafBlock1 ]
  %"5" = icmp slt i32 %i1.0, 10, !dbg !33
  br i1 %"5", label %main_bb4, label %main_bb10, !dbg !33

main_bb4:                                         ; preds = %main_bb3
  %"6" = sext i32 %i1.0 to i64, !dbg !35
  %"7" = getelementptr inbounds [10 x i32]* %slots_used, i32 0, i64 %"6", !dbg !35
  %"8" = load i32* %"7", align 4, !dbg !35
...
main_bb5:                                         ; preds = %main_LeafBlock
  %"9" = sext i32 %i1.0 to i64, !dbg !37
  %"10" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"9", !dbg !37
  %"11" = load i32* %"10", align 4, !dbg !37
  %"12" = icmp ne i32 %"11", 0, !dbg !37
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !37
...
main_bb7:                                         ; preds = %main_NewDefault
  %"16" = sext i32 %i1.0 to i64, !dbg !42
  %"17" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"16", !dbg !42
  %"18" = load i32* %"17", align 4, !dbg !42
  br label %main_bb8, !dbg !43

main_bb8:                                         ; preds = %main_bb7, %main_bb6
  %table.0 = phi i32 [ %"18", %main_bb7 ], [ %"15", %main_bb6 ]
  %"19" = icmp ne i32 %table.0, 0, !dbg !44
  br i1 %"19", label %main_bb10, label %main_bb9, !dbg !44

main_bb9:                                         ; preds = %main_bb8
  %"20" = add nsw i32 %i1.0, 1, !dbg !46
