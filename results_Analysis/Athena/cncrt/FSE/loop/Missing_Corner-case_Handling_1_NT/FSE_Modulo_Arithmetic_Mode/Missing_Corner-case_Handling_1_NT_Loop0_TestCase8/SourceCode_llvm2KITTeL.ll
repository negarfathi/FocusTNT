...
main_bb14:
  ...
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !89), !dbg !91
  call void @llvm.dbg.value(metadata !53, i64 0, metadata !92), !dbg !93
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !94), !dbg !95
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !96), !dbg !97
  call void @llvm.dbg.value(metadata !44, i64 0, metadata !87), !dbg !88
  call void @llvm.dbg.value(metadata !{i64 %"36"}, i64 0, metadata !98), !dbg !100
  call void @llvm.dbg.value(metadata !53, i64 0, metadata !101), !dbg !102
...
main_bb15:                                        ; preds = %main_read.exit, %main_bb14
  %"32" = icmp eq i64 %"31", 1, !dbg !83
  %"33" = load i64* @"'count", align 8, !dbg !84
  %"34" = icmp sgt i64 %"33", 100, !dbg !108
  %or.cond.i = or i1 %"32", %"34", !dbg !83
  br i1 %or.cond.i, label %main_read.exit, label %main_bb16, !dbg !83

main_bb16:                                        ; preds = %main_bb15
  %"35" = load i64* @"'count", align 8, !dbg !99
  %"36" = add nsw i64 %"35", 1, !dbg !99
  %"37" = icmp sgt i64 %"36", 2147483647, !dbg !109
  br i1 %"37", label %main_bb17, label %main_bb18, !dbg !109

main_bb17:                                        ; preds = %main_bb16
  %"38" = sub nsw i64 %"36", 2147483647, !dbg !110
  %"39" = sub nsw i64 %"38", 1, !dbg !110
  %"40" = srem i64 %"39", 4294967296, !dbg !110
  %"41" = add nsw i64 -2147483648, %"40", !dbg !110
  br label %main_wrap_around.exit.i, !dbg !110

main_bb18:                                        ; preds = %main_bb16
  %"42" = icmp slt i64 %"36", -2147483648, !dbg !111
  br i1 %"42", label %main_bb19, label %main_wrap_around.exit.i, !dbg !111

main_bb19:                                        ; preds = %main_bb18
  %"43" = sub nsw i64 -2147483648, %"36", !dbg !112
  %"44" = sub nsw i64 %"43", 1, !dbg !112
  %"45" = srem i64 %"44", 4294967296, !dbg !112
  %"46" = sub nsw i64 2147483647, %"45", !dbg !112
  br label %main_wrap_around.exit.i, !dbg !112

main_wrap_around.exit.i:                          ; preds = %main_bb19, %main_bb18, %main_bb17
  %.0.i.i = phi i64 [ %"41", %main_bb17 ], [ %"46", %main_bb19 ], [ %"36", %main_bb18 ], !dbg !99
  store i64 %.0.i.i, i64* @"'count", align 8, !dbg !99
  br label %main_read.exit, !dbg !113

main_read.exit:                                   ; preds = %main_bb15, %main_wrap_around.exit.i
  %.0.i = phi i64 [ 500, %main_wrap_around.exit.i ], [ 0, %main_bb15 ], !dbg !84
  %"47" = icmp slt i64 %.0.i, 0, !dbg !84
  br i1 %"47", label %main_bb20, label %main_bb15, !dbg !84

main_bb20:                                        ; preds = %main_read.exit
  ret i32 0, !dbg !114
}
...
!89 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777230, metadata !8, i32 0, metadata !90} ; [ DW_TAG_arg_variable ] [value] [line 14]
!90 = metadata !{i32 37, i32 15, metadata !50, metadata !84}
!91 = metadata !{i32 14, i32 33, metadata !4, metadata !90}
!92 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554446, metadata !8, i32 0, metadata !90} ; [ DW_TAG_arg_variable ] [lower_bound] [line 14]
!93 = metadata !{i32 14, i32 50, metadata !4, metadata !90}
!94 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331662, metadata !8, i32 0, metadata !90} ; [ DW_TAG_arg_variable ] [upper_bound] [line 14]
!95 = metadata !{i32 14, i32 73, metadata !4, metadata !90}
!96 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 15, metadata !8, i32 0, metadata !90} ; [ DW_TAG_auto_variable ] [range] [line 15]
!97 = metadata !{i32 15, i32 15, metadata !4, metadata !90}
!98 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777230, metadata !8, i32 0, metadata !99} ; [ DW_TAG_arg_variable ] [value] [line 14]
!99 = metadata !{i32 40, i32 22, metadata !65, metadata !84}
!100 = metadata !{i32 14, i32 33, metadata !4, metadata !99}
!101 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554446, metadata !8, i32 0, metadata !99} ; [ DW_TAG_arg_variable ] [lower_bound] [line 14]
!102 = metadata !{i32 14, i32 50, metadata !4, metadata !99}
!103 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331662, metadata !8, i32 0, metadata !99} ; [ DW_TAG_arg_variable ] [upper_bound] [line 14]
!104 = metadata !{i32 14, i32 73, metadata !4, metadata !99}
!105 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 15, metadata !8, i32 0, metadata !99} ; [ DW_TAG_auto_variable ] [range] [line 15]
!106 = metadata !{i32 15, i32 15, metadata !4, metadata !99}
!107 = metadata !{i32 53, i32 5, metadata !12, null}
!108 = metadata !{i32 26, i32 9, metadata !43, metadata !84}
!109 = metadata !{i32 16, i32 9, metadata !32, metadata !99}
!110 = metadata !{i32 17, i32 9, metadata !34, metadata !99}
!111 = metadata !{i32 19, i32 14, metadata !36, metadata !99}
!112 = metadata !{i32 20, i32 9, metadata !38, metadata !99}
!113 = metadata !{i32 41, i32 13, metadata !65, metadata !84}
!114 = metadata !{i32 60, i32 5, metadata !12, null}
