...
main_bb6:
  ...
  %"10" = load i32* @"'count", align 4, !dbg !37
  call void @llvm.dbg.value(metadata !20, i64 0, metadata !40), !dbg !41
  br label %main_read.exit, !dbg !42

main_read.exit:                                   ; preds = %main_read.exit, %main_bb6
  %"11" = icmp eq i32 %"9", 1, !dbg !36
  %"12" = icmp sgt i32 %"10", 100, !dbg !43
  %or.cond.i = or i1 %"11", %"12", !dbg !36
  %. = select i1 %or.cond.i, i32 0, i32 -1, !dbg !36
  %"13" = icmp slt i32 %., 0, !dbg !37
  br i1 %"13", label %main_bb7, label %main_read.exit, !dbg !37

main_bb7:                                         ; preds = %main_read.exit
  ret i32 0, !dbg !44
}
...
!44 = metadata !{i32 44, i32 5, metadata !9, null}
