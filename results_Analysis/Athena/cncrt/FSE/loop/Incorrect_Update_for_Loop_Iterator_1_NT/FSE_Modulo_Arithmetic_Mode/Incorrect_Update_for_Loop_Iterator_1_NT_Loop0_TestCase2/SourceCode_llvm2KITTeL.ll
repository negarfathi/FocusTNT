...
main_bb5:
  ...
  %"12" = icmp slt i64 30000, -1, !dbg !43
  %"13" = icmp sle i64 10000, 0, !dbg !45
  %or.cond = or i1 %"12", %"13", !dbg !43
  %"14" = icmp slt i64 0, 0, !dbg !47
  %or.cond5 = or i1 %or.cond, %"14", !dbg !43
  br i1 %or.cond5, label %main_bb16, label %main_wrap_around.exit2, !dbg !43

main_wrap_around.exit2:                           ; preds = %main_bb15, %main_bb14, %main_bb13, %main_bb5
  %size.0 = phi i64 [ 64, %main_bb5 ], [ %size.1, %main_bb13 ], [ %size.1, %main_bb14 ], [ %size.1, %main_bb15 ]
  %buffer_bytes_left.0 = phi i64 [ 0, %main_bb5 ], [ %"45", %main_bb13 ], [ %"50", %main_bb15 ], [ %"40", %main_bb14 ]
  %"15" = sdiv i64 %size.0, 2, !dbg !49
  %"16" = icmp sgt i64 %"15", 2147483647, !dbg !50
  br i1 %"16", label %main_bb6, label %main_bb7, !dbg !50

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"17" = sub nsw i64 %"15", 2147483647, !dbg !51
  %"18" = sub nsw i64 %"17", 1, !dbg !51
  %"19" = srem i64 %"18", 4294967296, !dbg !51
  %"20" = add nsw i64 -2147483648, %"19", !dbg !51
  br label %main_wrap_around.exit, !dbg !51

main_bb7:                                         ; preds = %main_wrap_around.exit2
  %"21" = icmp slt i64 %"15", -2147483648, !dbg !52
  br i1 %"21", label %main_bb8, label %main_wrap_around.exit, !dbg !52

main_bb8:                                         ; preds = %main_bb7
  %"22" = sub nsw i64 -2147483648, %"15", !dbg !53
  %"23" = sub nsw i64 %"22", 1, !dbg !53
  %"24" = srem i64 %"23", 4294967296, !dbg !53
  %"25" = sub nsw i64 2147483647, %"24", !dbg !53
  br label %main_wrap_around.exit, !dbg !53

main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  %.0.i = phi i64 [ %"20", %main_bb6 ], [ %"25", %main_bb8 ], [ %"15", %main_bb7 ], !dbg !49
  %"26" = icmp slt i64 %buffer_bytes_left.0, %.0.i, !dbg !49
  br i1 %"26", label %main_bb9, label %main_bb16, !dbg !49

main_bb9:                                         ; preds = %main_wrap_around.exit
  %"27" = mul nsw i64 %size.0, 2, !dbg !54
  %"28" = icmp sgt i64 %"27", 2147483647, !dbg !56
  br i1 %"28", label %main_bb10, label %main_bb11, !dbg !56

main_bb10:                                        ; preds = %main_bb9
  %"29" = sub nsw i64 %"27", 2147483647, !dbg !57
  %"30" = sub nsw i64 %"29", 1, !dbg !57
  %"31" = srem i64 %"30", 4294967296, !dbg !57
  %"32" = add nsw i64 -2147483648, %"31", !dbg !57
  br label %main_wrap_around.exit4, !dbg !57

main_bb11:                                        ; preds = %main_bb9
  %"33" = icmp slt i64 %"27", -2147483648, !dbg !58
  br i1 %"33", label %main_bb12, label %main_wrap_around.exit4, !dbg !58

main_bb12:                                        ; preds = %main_bb11
  %"34" = sub nsw i64 -2147483648, %"27", !dbg !59
  %"35" = sub nsw i64 %"34", 1, !dbg !59
  %"36" = srem i64 %"35", 4294967296, !dbg !59
  %"37" = sub nsw i64 2147483647, %"36", !dbg !59
  br label %main_wrap_around.exit4, !dbg !59

main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  %.0.i3 = phi i64 [ %"32", %main_bb10 ], [ %"37", %main_bb12 ], [ %"27", %main_bb11 ], !dbg !54
  %"38" = icmp ne i64 30000, -1, !dbg !60
  %"39" = icmp sgt i64 %.0.i3, 30000, !dbg !62
  %or.cond6 = and i1 %"38", %"39", !dbg !60
  %size.1 = select i1 %or.cond6, i64 30000, i64 %.0.i3, !dbg !60
  %"40" = sub nsw i64 %size.1, 10000, !dbg !64
  %"41" = icmp sgt i64 %"40", 2147483647, !dbg !65
  br i1 %"41", label %main_bb13, label %main_bb14, !dbg !65
...
main_bb14:                                        ; preds = %main_wrap_around.exit4
  ...
  br i1 %"46", label %main_bb15, label %main_wrap_around.exit2, !dbg !67
...
main_bb16:                                        ; preds = %main_wrap_around.exit, %main_bb5
  ret i32 0, !dbg !69
}
...
!34 = metadata !{i64 30000}
!35 = metadata !{i32 786688, metadata !9, metadata !"max_msg_size", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [max_msg_size] [line 24]
!36 = metadata !{i32 24, i32 15, metadata !9, null}
!37 = metadata !{i64 10000}
!38 = metadata !{i32 786688, metadata !9, metadata !"buffer_read_offset", metadata !5, i32 25, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [buffer_read_offset] [line 25]
!39 = metadata !{i32 25, i32 15, metadata !9, null}
!40 = metadata !{i64 0}
!41 = metadata !{i32 786688, metadata !9, metadata !"buffer_bytes_left", metadata !5, i32 26, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [buffer_bytes_left] [line 26]
...
!49 = metadata !{i32 32, i32 32, metadata !9, null}
!50 = metadata !{i32 14, i32 9, metadata !26, metadata !49}
!51 = metadata !{i32 15, i32 9, metadata !28, metadata !49}
!52 = metadata !{i32 17, i32 14, metadata !30, metadata !49}
!53 = metadata !{i32 18, i32 9, metadata !32, metadata !49}
!54 = metadata !{i32 34, i32 16, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 14, i32 9, metadata !26, metadata !54}
!57 = metadata !{i32 15, i32 9, metadata !28, metadata !54}
!58 = metadata !{i32 17, i32 14, metadata !30, metadata !54}
!59 = metadata !{i32 18, i32 9, metadata !32, metadata !54}
!60 = metadata !{i32 35, i32 13, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !55, i32 35, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 35, i32 13, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !61, i32 35, i32 13, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 39, i32 29, metadata !55, null}
!65 = metadata !{i32 14, i32 9, metadata !26, metadata !64}
!66 = metadata !{i32 15, i32 9, metadata !28, metadata !64}
!67 = metadata !{i32 17, i32 14, metadata !30, metadata !64}
!68 = metadata !{i32 18, i32 9, metadata !32, metadata !64}
!69 = metadata !{i32 42, i32 1, metadata !9, null}
