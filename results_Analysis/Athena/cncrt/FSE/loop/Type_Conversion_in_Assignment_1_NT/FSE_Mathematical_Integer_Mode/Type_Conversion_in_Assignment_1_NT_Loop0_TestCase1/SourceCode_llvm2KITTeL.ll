...
main_fgetc.exit:                                  ; preds = %main_bb4, %main_bb5
  ...
  %"12" = zext i8 %"11" to i32, !dbg !39
  %"13" = icmp eq i32 %"12", 0, !dbg !39
  %"14" = zext i8 %"11" to i32
  %"15" = icmp eq i32 %"14", -1, !dbg !41
  %or.cond = or i1 %"13", %"15", !dbg !39
  br i1 %or.cond, label %main_bb6, label %main_bb7, !dbg !39
...
!38 = metadata !{i32 21, i32 5, metadata !4, metadata !31}
!39 = metadata !{i32 29, i32 13, metadata !40, null}
!40 = metadata !{i32 786443, metadata !1, metadata !32, i32 29, i32 13, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 29, i32 13, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !40, i32 29, i32 13, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 43, i32 1, metadata !9, null}
!44 = metadata !{i32 41, i32 5, metadata !32, null}
