...
main_bb2:
  ...
  call void @llvm.dbg.value(metadata !28, i64 0, metadata !38), !dbg !41
  ...
  call void @llvm.dbg.value(metadata !28, i64 0, metadata !32), !dbg !33
  br label %main_bb3, !dbg !42
...
main_bb3:                                         ; preds = %main_NewDefault, %main_bb5, %main_bb2
  ...
  %"4" = icmp eq i32 %matroska.0, 1, !dbg !43
  %..i = select i1 %"4", i32 0, i32 1, !dbg !44
...
main_bb6:                                         ; preds = %main_LeafBlock4
  %"6" = load i32* @"'flag", align 4, !dbg !47
  %"7" = add nsw i32 %"6", 1, !dbg !47
  store i32 %"7", i32* @"'flag", align 4, !dbg !47
  %"8" = icmp slt i32 %"6", 100, !dbg !47
  %..i3 = select i1 %"8", i32 0, i32 -1, !dbg !51
  %"9" = icmp slt i32 %..i3, 0, !dbg !48
  %"10" = zext i1 %"9" to i32, !dbg !48
  br i1 %"9", label %main_bb4, label %main_bb7, !dbg !48

main_bb7:                                         ; preds = %main_bb6
  %"11" = load i32* @"'flag", align 4, !dbg !52
  %"12" = add nsw i32 %"11", 1, !dbg !52
  store i32 %"12", i32* @"'flag", align 4, !dbg !52
  %"13" = icmp slt i32 %"11", 100, !dbg !52
  %..i2 = select i1 %"13", i32 0, i32 -1, !dbg !55
  %"14" = icmp eq i32 %..i2, 0, !dbg !53
  %"15" = zext i1 %"14" to i32, !dbg !53
  %. = select i1 %"14", i32 1, i32 %"15", !dbg !53
...
!42 = metadata !{i32 28, i32 5, metadata !12, null}
!43 = metadata !{i32 12, i32 9, metadata !21, metadata !35}
!44 = metadata !{i32 13, i32 9, metadata !21, metadata !35}
!45 = metadata !{i32 48, i32 13, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !40, i32 47, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 20, i32 9, metadata !25, metadata !48}
!48 = metadata !{i32 35, i32 31, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !50, i32 35, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!50 = metadata !{i32 786443, metadata !1, metadata !39, i32 33, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 21, i32 9, metadata !25, metadata !48}
!52 = metadata !{i32 20, i32 9, metadata !25, metadata !53}
!53 = metadata !{i32 37, i32 31, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !50, i32 37, i32 25, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 21, i32 9, metadata !25, metadata !53}
!56 = metadata !{i32 39, i32 21, metadata !50, null}
!57 = metadata !{i32 50, i32 5, metadata !12, null}
