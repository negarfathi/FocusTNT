...
main_bb6:                                         ; preds = %main_ff_subtitles_next_line.exit, %main_bb5
  %b.0 = phi i32 [ 1, %main_bb5 ], [ %"11", %main_ff_subtitles_next_line.exit ]
  %"8" = icmp slt i32 %b.0, 100, !dbg !40
  br i1 %"8", label %main_bb7, label %main_bb9, !dbg !40
...
main_ff_subtitles_next_line.exit:                 ; preds = %main_bb7, %main_bb8
  %"11" = add nsw i32 %b.0, 0, !dbg !43
  %"12" = sub nsw i32 100, 4, !dbg !47
  %"13" = icmp sge i32 %"11", %"12", !dbg !47
  br i1 %"13", label %main_bb9, label %main_bb6, !dbg !47
...
!42 = metadata !{i32 14, i32 9, metadata !20, metadata !43}
...
!45 = metadata !{i32 18, i32 9, metadata !24, metadata !43}
!46 = metadata !{i32 19, i32 9, metadata !24, metadata !43}
!47 = metadata !{i32 36, i32 13, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !44, i32 36, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
