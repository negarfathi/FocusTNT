...
main_bb13:
  ...
  %"28" = icmp slt i64 0, 0, !dbg !84
  %"29" = icmp slt i64 5, 0, !dbg !86
  %or.cond = or i1 %"28", %"29", !dbg !84
  br i1 %or.cond, label %main_bb22, label %main_bb14, !dbg !84
...
main_bb14:                                        ; preds = %main_bb13
  ...
  call void @llvm.dbg.value(metadata !{i64 %"33"}, i64 0, metadata !102), !dbg !104
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !105), !dbg !106
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !107), !dbg !108
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !109), !dbg !110
  call void @llvm.dbg.value(metadata !{i64 %.0.i2}, i64 0, metadata !79), !dbg !80
  call void @llvm.dbg.value(metadata !{i64 %"44"}, i64 0, metadata !111), !dbg !114
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !115), !dbg !116
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !117), !dbg !118
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !119), !dbg !120
  call void @llvm.dbg.value(metadata !121, i64 0, metadata !122), !dbg !124
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !125), !dbg !126
  call void @llvm.dbg.value(metadata !48, i64 0, metadata !127), !dbg !128
  call void @llvm.dbg.value(metadata !51, i64 0, metadata !129), !dbg !130
  br label %main_bb15, !dbg !131

main_bb15:                                        ; preds = %main_wrap_around.exit, %main_bb14
  %b.0 = phi i64 [ 0, %main_bb14 ], [ %.0.i2, %main_wrap_around.exit ]
  %"31" = icmp slt i64 %b.0, 5, !dbg !132
  br i1 %"31", label %main_ff_subtitles_next_line.exit, label %main_bb22, !dbg !132

main_ff_subtitles_next_line.exit:                 ; preds = %main_bb15
  %"32" = icmp eq i64 %"30", 1, !dbg !101
  %. = select i1 %"32", i64 0, i64 3, !dbg !101
  %"33" = add nsw i64 %b.0, %., !dbg !89
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !134
  br i1 %"34", label %main_bb16, label %main_bb17, !dbg !134

main_bb16:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"35" = sub nsw i64 %"33", 2147483647, !dbg !135
  %"36" = sub nsw i64 %"35", 1, !dbg !135
  %"37" = srem i64 %"36", 4294967296, !dbg !135
  %"38" = add nsw i64 -2147483648, %"37", !dbg !135
  br label %main_wrap_around.exit3, !dbg !135

main_bb17:                                        ; preds = %main_ff_subtitles_next_line.exit
  %"39" = icmp slt i64 %"33", -2147483648, !dbg !136
  br i1 %"39", label %main_bb18, label %main_wrap_around.exit3, !dbg !136

main_bb18:                                        ; preds = %main_bb17
  %"40" = sub nsw i64 -2147483648, %"33", !dbg !137
  %"41" = sub nsw i64 %"40", 1, !dbg !137
  %"42" = srem i64 %"41", 4294967296, !dbg !137
  %"43" = sub nsw i64 2147483647, %"42", !dbg !137
  br label %main_wrap_around.exit3, !dbg !137

main_wrap_around.exit3:                           ; preds = %main_bb16, %main_bb17, %main_bb18
  %.0.i2 = phi i64 [ %"38", %main_bb16 ], [ %"43", %main_bb18 ], [ %"33", %main_bb17 ], !dbg !103
  %"44" = sub nsw i64 5, 4, !dbg !112
  %"45" = icmp sgt i64 %"44", 2147483647, !dbg !138
  br i1 %"45", label %main_bb19, label %main_bb20, !dbg !138

main_bb19:                                        ; preds = %main_wrap_around.exit3
  %"46" = sub nsw i64 %"44", 2147483647, !dbg !139
  %"47" = sub nsw i64 %"46", 1, !dbg !139
  %"48" = srem i64 %"47", 4294967296, !dbg !139
  %"49" = add nsw i64 -2147483648, %"48", !dbg !139
  br label %main_wrap_around.exit, !dbg !139

main_bb20:                                        ; preds = %main_wrap_around.exit3
  %"50" = icmp slt i64 %"44", -2147483648, !dbg !140
  br i1 %"50", label %main_bb21, label %main_wrap_around.exit, !dbg !140

main_bb21:                                        ; preds = %main_bb20
  %"51" = sub nsw i64 -2147483648, %"44", !dbg !141
  %"52" = sub nsw i64 %"51", 1, !dbg !141
  %"53" = srem i64 %"52", 4294967296, !dbg !141
  %"54" = sub nsw i64 2147483647, %"53", !dbg !141
  br label %main_wrap_around.exit, !dbg !141

main_wrap_around.exit:                            ; preds = %main_bb19, %main_bb20, %main_bb21
  %.0.i1 = phi i64 [ %"49", %main_bb19 ], [ %"54", %main_bb21 ], [ %"44", %main_bb20 ], !dbg !112
  %"55" = icmp sge i64 %.0.i2, %.0.i1, !dbg !112
  br i1 %"55", label %main_bb22, label %main_bb15, !dbg !112
...
!88 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 24, metadata !8, i32 0, metadata !89} ; [ DW_TAG_auto_variable ] [i] [line 24]
!89 = metadata !{i32 53, i32 30, metadata !90, null}
!90 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 5, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!91 = metadata !{i32 24, i32 15, metadata !9, metadata !89}
!92 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !93} ; [ DW_TAG_arg_variable ] [value] [line 12]
!93 = metadata !{i32 25, i32 9, metadata !9, metadata !89}
!94 = metadata !{i32 12, i32 33, metadata !4, metadata !93}
!95 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !93} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!96 = metadata !{i32 12, i32 50, metadata !4, metadata !93}
!97 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !93} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!98 = metadata !{i32 12, i32 73, metadata !4, metadata !93}
!99 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !93} ; [ DW_TAG_auto_variable ] [range] [line 13]
!100 = metadata !{i32 13, i32 15, metadata !4, metadata !93}
!101 = metadata !{i32 26, i32 9, metadata !55, metadata !89}
!102 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !103} ; [ DW_TAG_arg_variable ] [value] [line 12]
!103 = metadata !{i32 53, i32 13, metadata !90, null}
!104 = metadata !{i32 12, i32 33, metadata !4, metadata !103}
!105 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !103} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!106 = metadata !{i32 12, i32 50, metadata !4, metadata !103}
!107 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !103} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!108 = metadata !{i32 12, i32 73, metadata !4, metadata !103}
!109 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !103} ; [ DW_TAG_auto_variable ] [range] [line 13]
!110 = metadata !{i32 13, i32 15, metadata !4, metadata !103}
!111 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !112} ; [ DW_TAG_arg_variable ] [value] [line 12]
!112 = metadata !{i32 54, i32 18, metadata !113, null}
!113 = metadata !{i32 786443, metadata !1, metadata !90, i32 54, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!114 = metadata !{i32 12, i32 33, metadata !4, metadata !112}
!115 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !112} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!116 = metadata !{i32 12, i32 50, metadata !4, metadata !112}
!117 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !112} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!118 = metadata !{i32 12, i32 73, metadata !4, metadata !112}
!119 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !112} ; [ DW_TAG_auto_variable ] [range] [line 13]
!120 = metadata !{i32 13, i32 15, metadata !4, metadata !112}
!121 = metadata !{i64 3}
!122 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777228, metadata !8, i32 0, metadata !123} ; [ DW_TAG_arg_variable ] [value] [line 12]
!123 = metadata !{i32 37, i32 12, metadata !64, metadata !89}
!124 = metadata !{i32 12, i32 33, metadata !4, metadata !123}
!125 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554444, metadata !8, i32 0, metadata !123} ; [ DW_TAG_arg_variable ] [lower_bound] [line 12]
!126 = metadata !{i32 12, i32 50, metadata !4, metadata !123}
!127 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331660, metadata !8, i32 0, metadata !123} ; [ DW_TAG_arg_variable ] [upper_bound] [line 12]
!128 = metadata !{i32 12, i32 73, metadata !4, metadata !123}
!129 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 13, metadata !8, i32 0, metadata !123} ; [ DW_TAG_auto_variable ] [range] [line 13]
!130 = metadata !{i32 13, i32 15, metadata !4, metadata !123}
!131 = metadata !{i32 51, i32 5, metadata !12, null}
!132 = metadata !{i32 51, i32 5, metadata !133, null}
!133 = metadata !{i32 786443, metadata !1, metadata !12, i32 51, i32 5, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!134 = metadata !{i32 14, i32 9, metadata !31, metadata !103}
!135 = metadata !{i32 15, i32 9, metadata !33, metadata !103}
!136 = metadata !{i32 17, i32 14, metadata !35, metadata !103}
!137 = metadata !{i32 18, i32 9, metadata !37, metadata !103}
!138 = metadata !{i32 14, i32 9, metadata !31, metadata !112}
!139 = metadata !{i32 15, i32 9, metadata !33, metadata !112}
!140 = metadata !{i32 17, i32 14, metadata !35, metadata !112}
!141 = metadata !{i32 18, i32 9, metadata !37, metadata !112}
!142 = metadata !{i32 60, i32 1, metadata !12, null}
