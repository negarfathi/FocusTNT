...
main_bb4:                                         ; preds = %main_bb8, %main_bb3
  ...
  %"10" = icmp slt i32 %base.0, 10, !dbg !43
...
main_bb7:                                         ; preds = %main_bb6
  ...
  %"19" = icmp eq i32 %"18", 10, !dbg !48
  br i1 %"19", label %main_bb8, label %main_bb6, !dbg !48

main_bb8:                                         ; preds = %main_bb7, %main_bb6
  %"20" = add nsw i32 %i.0, 1, !dbg !51
  call void @llvm.dbg.value(metadata !{i32 %"20"}, i64 0, metadata !13), !dbg !14
  %"21" = add nsw i32 %base.0, 8, !dbg !52
...
!44 = metadata !{i32 786443, metadata !1, metadata !4, i32 23, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 26, i32 9, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !40, i32 26, i32 9, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 26, i32 9, metadata !40, null}
...
!50 = metadata !{i32 786443, metadata !1, metadata !40, i32 27, i32 9, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 31, i32 9, metadata !40, null}
!52 = metadata !{i32 32, i32 9, metadata !40, null}
!53 = metadata !{i32 33, i32 5, metadata !40, null}
!54 = metadata !{i32 34, i32 5, metadata !4, null}
