...
main_bb10:                                        ; preds = %main_wrap_around.exit
  ...
  call void @llvm.dbg.value(metadata !{i64 %"36"}, i64 0, metadata !80), !dbg !84
...
main_wrap_around.exit2:                           ; preds = %main_bb23, %main_bb22, %main_bb21, %main_bb10
  %base.0 = phi i64 [ 50, %main_bb10 ], [ %"64", %main_bb21 ], [ %"69", %main_bb23 ], [ %"59", %main_bb22 ]
  %i.0 = phi i64 [ 0, %main_bb10 ], [ %.0.i3, %main_bb21 ], [ %.0.i3, %main_bb22 ], [ %.0.i3, %main_bb23 ]
  %"30" = icmp slt i64 %base.0, 55, !dbg !92
  br i1 %"30", label %main_bb11, label %main_bb24, !dbg !92

main_bb11:                                        ; preds = %main_wrap_around.exit2
  %"31" = getelementptr inbounds [10 x i64]* %old_, i32 0, i64 %i.0, !dbg !94
  %"32" = load i64* %"31", align 8, !dbg !94
  %"33" = getelementptr inbounds [10 x i64]* %new_, i32 0, i64 %i.0, !dbg !94
...
main_bb12:                                        ; preds = %main_wrap_around.exit6, %main_bb11
  ...
  %"35" = icmp ne i64 %"32", %"34", !dbg !94
  br i1 %"35", label %main_bb13, label %main_bb17, !dbg !94

main_bb13:                                        ; preds = %main_bb12
  %"36" = add nsw i64 %number.0, 1, !dbg !81
  %"37" = icmp sgt i64 %"36", 2147483647, !dbg !97
  br i1 %"37", label %main_bb14, label %main_bb15, !dbg !97
...
main_bb15:                                        ; preds = %main_bb13
  ...
  br i1 %"42", label %main_bb16, label %main_wrap_around.exit6, !dbg !99
...
main_wrap_around.exit6:                           ; preds = %main_bb14, %main_bb15, %main_bb16
  %.0.i5 = phi i64 [ %"41", %main_bb14 ], [ %"46", %main_bb16 ], [ %"36", %main_bb15 ], !dbg !81
  %"47" = icmp eq i64 %.0.i5, 55, !dbg !81
  br i1 %"47", label %main_bb17, label %main_bb12, !dbg !81
