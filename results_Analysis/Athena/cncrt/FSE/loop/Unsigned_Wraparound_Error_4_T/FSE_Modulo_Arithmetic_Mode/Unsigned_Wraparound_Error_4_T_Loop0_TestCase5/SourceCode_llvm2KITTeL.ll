...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %n.0}, i64 0, metadata !37), !dbg !39
  call void @llvm.dbg.value(metadata !40, i64 0, metadata !37), !dbg !39
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !41), !dbg !43
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %n.0 = phi i64 [ 4294967280, %main_bb5 ], [ %"18", %main_bb7 ], [ %"23", %main_bb9 ], [ %"14", %main_bb8 ]
  %"12" = icmp sgt i64 %n.0, 0, !dbg !54
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !54

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = icmp sgt i64 %n.0, 16, !dbg !56
  %.n.0 = select i1 %"13", i64 16, i64 %n.0, !dbg !56
  %"14" = sub nsw i64 %n.0, %.n.0, !dbg !42
...
!34 = metadata !{i64 4294967280}
!35 = metadata !{i32 786688, metadata !9, metadata !"n", metadata !5, i32 23, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [n] [line 23]
!36 = metadata !{i32 23, i32 15, metadata !9, null}
!37 = metadata !{i32 786688, metadata !38, metadata !"len", metadata !5, i32 26, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [len] [line 26]
!38 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 5, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!39 = metadata !{i32 26, i32 19, metadata !38, null}
!40 = metadata !{i64 16}
...
!42 = metadata !{i32 31, i32 13, metadata !38, null}
!43 = metadata !{i32 11, i32 33, metadata !4, metadata !42}
!44 = metadata !{i64 0}
!45 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554443, metadata !8, i32 0, metadata !42} ; [ DW_TAG_arg_variable ] [lower_bound] [line 11]
!46 = metadata !{i32 11, i32 50, metadata !4, metadata !42}
!47 = metadata !{i64 4294967295}
!48 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331659, metadata !8, i32 0, metadata !42} ; [ DW_TAG_arg_variable ] [upper_bound] [line 11]
!49 = metadata !{i32 11, i32 73, metadata !4, metadata !42}
!50 = metadata !{i64 4294967296}
!51 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 12, metadata !8, i32 0, metadata !42} ; [ DW_TAG_auto_variable ] [range] [line 12]
!52 = metadata !{i32 12, i32 15, metadata !4, metadata !42}
!53 = metadata !{i32 24, i32 5, metadata !9, null}
!54 = metadata !{i32 24, i32 5, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 27, i32 13, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !38, i32 27, i32 13, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 13, i32 9, metadata !26, metadata !42}
!59 = metadata !{i32 14, i32 9, metadata !28, metadata !42}
!60 = metadata !{i32 16, i32 14, metadata !30, metadata !42}
!61 = metadata !{i32 17, i32 9, metadata !32, metadata !42}
