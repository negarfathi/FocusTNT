...
main_bb3:                                         ; preds = %main_bb2
  ...
  %"28" = add nsw i32 %"25", -1, !dbg !59
  call void @llvm.dbg.value(metadata !{i32 %"28"}, i64 0, metadata !50), !dbg !51
  call void @llvm.dbg.value(metadata !52, i64 0, metadata !61), !dbg !62
  %"29" = add nsw i32 %"25", 1, !dbg !63
  call void @llvm.dbg.value(metadata !{i32 %"29"}, i64 0, metadata !50), !dbg !51
  call void @llvm.dbg.value(metadata !65, i64 0, metadata !61), !dbg !62
  %direction.0 = select i1 %or.cond, i32 -1, i32 1, !dbg !55
  %pos.0 = select i1 %or.cond, i32 %"28", i32 %"29", !dbg !55
  %"30" = sext i32 %"3" to i64, !dbg !66
  %"31" = getelementptr inbounds [100000 x %struct.Node]* @memory0, i32 0, i64 %"30", !dbg !66
  %"32" = getelementptr inbounds %struct.Node* %"31", i32 0, i32 0, !dbg !66
  %"33" = load i32* %"32", align 4, !dbg !66
  %"34" = srem i32 %pos.0, %"33", !dbg !66
  call void @llvm.dbg.value(metadata !{i32 %"34"}, i64 0, metadata !50), !dbg !51
  call void @llvm.dbg.value(metadata !{i32 %"34"}, i64 0, metadata !67), !dbg !68
  call void @llvm.dbg.value(metadata !{i32 %"43"}, i64 0, metadata !50), !dbg !51
  %"35" = sext i32 %"3" to i64, !dbg !69
  %"36" = getelementptr inbounds [100000 x %struct.Node]* @memory0, i32 0, i64 %"35", !dbg !69
  %"37" = getelementptr inbounds %struct.Node* %"36", i32 0, i32 0, !dbg !69
  %"38" = load i32* %"37", align 4, !dbg !69
  call void @llvm.dbg.value(metadata !72, i64 0, metadata !50), !dbg !51
  %"39" = sext i32 %"3" to i64, !dbg !73
  %"40" = getelementptr inbounds [100000 x %struct.Node]* @memory0, i32 0, i64 %"39", !dbg !73
  %"41" = getelementptr inbounds %struct.Node* %"40", i32 0, i32 0, !dbg !73
  %"42" = load i32* %"41", align 4, !dbg !73
  call void @llvm.dbg.value(metadata !{i32 %"46"}, i64 0, metadata !50), !dbg !51
  br label %main_bb4, !dbg !76

main_bb4:                                         ; preds = %main_bb6, %main_bb3
  %pos.1 = phi i32 [ %"34", %main_bb3 ], [ %pos.3, %main_bb6 ]
  %"43" = add nsw i32 %pos.1, %direction.0, !dbg !77
  %"44" = icmp eq i32 %"43", %"38", !dbg !69
  br i1 %"44", label %main_bb6, label %main_bb5, !dbg !69

main_bb5:                                         ; preds = %main_bb4
  %"45" = icmp slt i32 %"43", 0, !dbg !78
  %"46" = sub nsw i32 %"42", 1, !dbg !73
  %. = select i1 %"45", i32 %"46", i32 %"43", !dbg !78
  br label %main_bb6

main_bb6:                                         ; preds = %main_bb5, %main_bb4
  %pos.3 = phi i32 [ %., %main_bb5 ], [ 0, %main_bb4 ]
  %"47" = icmp ne i32 %pos.3, %"34", !dbg !79
  br i1 %"47", label %main_bb4, label %main_bb7, !dbg !79
...
!43 = metadata !{i32 28, i32 5, metadata !9, null}
!44 = metadata !{i32 29, i32 5, metadata !9, null}
...
!61 = metadata !{i32 786688, metadata !9, metadata !"direction", metadata !5, i32 33, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [direction] [line 33]
!62 = metadata !{i32 33, i32 9, metadata !9, null}
!63 = metadata !{i32 42, i32 9, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !56, i32 41, i32 5, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 1}
!66 = metadata !{i32 45, i32 5, metadata !9, null}
!67 = metadata !{i32 786688, metadata !9, metadata !"start", metadata !5, i32 46, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [start] [line 46]
!68 = metadata !{i32 46, i32 9, metadata !9, null}
!69 = metadata !{i32 49, i32 13, metadata !70, null}
!70 = metadata !{i32 786443, metadata !1, metadata !71, i32 49, i32 13, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 786443, metadata !1, metadata !9, i32 47, i32 7, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!72 = metadata !{i32 0}
!73 = metadata !{i32 50, i32 28, metadata !74, null}
!74 = metadata !{i32 786443, metadata !1, metadata !75, i32 50, i32 28, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!75 = metadata !{i32 786443, metadata !1, metadata !70, i32 50, i32 18, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 47, i32 5, metadata !9, null}
!77 = metadata !{i32 48, i32 9, metadata !71, null}
!78 = metadata !{i32 50, i32 18, metadata !75, null}
!79 = metadata !{i32 51, i32 5, metadata !80, null}
!80 = metadata !{i32 786443, metadata !1, metadata !71, i32 51, i32 5, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
