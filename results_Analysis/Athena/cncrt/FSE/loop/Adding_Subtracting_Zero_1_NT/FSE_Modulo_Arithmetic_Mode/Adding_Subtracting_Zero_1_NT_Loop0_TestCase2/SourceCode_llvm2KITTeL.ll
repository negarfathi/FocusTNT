...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %h.0 = phi i64 [ 0, %main_bb5 ], [ %"20", %main_bb7 ], [ %"25", %main_bb9 ], [ %"15", %main_bb8 ]
  %linesToRead.0 = phi i64 [ 3, %main_bb5 ], [ %h.0.linesToRead.0, %main_bb7 ], [ %h.0.linesToRead.0, %main_bb8 ], [ %h.0.linesToRead.0, %main_bb9 ]
