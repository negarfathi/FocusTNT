...
main_bb5:
  ...
  %"12" = icmp slt i64 10, 0, !dbg !37
  br i1 %"12", label %main_bb10, label %main_wrap_around.exit, !dbg !37

main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %h.0 = phi i64 [ 5, %main_bb5 ], [ %"20", %main_bb7 ], [ %"25", %main_bb9 ], [ %"15", %main_bb8 ]
  %linesToRead.0 = phi i64 [ 10, %main_bb5 ], [ %h.0.linesToRead.0, %main_bb7 ], [ %h.0.linesToRead.0, %main_bb8 ], [ %h.0.linesToRead.0, %main_bb9 ]
  %"13" = icmp sgt i64 %h.0, 0, !dbg !39
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !39

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = icmp sgt i64 %linesToRead.0, %h.0, !dbg !41
  %h.0.linesToRead.0 = select i1 %"14", i64 %h.0, i64 %linesToRead.0, !dbg !41
  %"15" = sub nsw i64 %h.0, %h.0.linesToRead.0, !dbg !44
...
!39 = metadata !{i32 30, i32 5, metadata !40, null}
!40 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 32, i32 13, metadata !42, null}
!42 = metadata !{i32 786443, metadata !1, metadata !43, i32 32, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 36, i32 13, metadata !43, null}
!45 = metadata !{i32 13, i32 9, metadata !26, metadata !44}
!46 = metadata !{i32 14, i32 9, metadata !28, metadata !44}
!47 = metadata !{i32 16, i32 14, metadata !30, metadata !44}
!48 = metadata !{i32 17, i32 9, metadata !32, metadata !44}
!49 = metadata !{i32 40, i32 1, metadata !9, null}
