...
main_bb0:
  ...
  call void @llvm.dbg.declare(metadata !{[10 x i32]* %ereg}, metadata !17), !dbg !18
...
main_bb2:                                         ; preds = %main_bb1
  %"1" = call i32 @__VERIFIER_nondet_int(), !dbg !29
  %"2" = sext i32 %i.0 to i64, !dbg !29
  %"3" = getelementptr inbounds [10 x i32]* %slots_used, i32 0, i64 %"2", !dbg !29
  store i32 %"1", i32* %"3", align 4, !dbg !29
  %"4" = call i32 @__VERIFIER_nondet_int(), !dbg !31
  %"5" = sext i32 %i.0 to i64, !dbg !31
  %"6" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"5", !dbg !31
  store i32 %"4", i32* %"6", align 4, !dbg !31
  %"7" = add nsw i32 %i.0, 1, !dbg !32
  br label %main_bb1, !dbg !33

main_bb3:                                         ; preds = %main_LeafBlock1, %main_bb1, %main_bb9
  %i_0.0 = phi i32 [ %"23", %main_bb9 ], [ 0, %main_bb1 ], [ %i_0.0, %main_LeafBlock1 ]
  %"8" = icmp slt i32 %i_0.0, 10, !dbg !34
  br i1 %"8", label %main_bb4, label %main_bb10, !dbg !34

main_bb4:                                         ; preds = %main_bb3
  %"9" = sext i32 %i_0.0 to i64, !dbg !36
...
main_bb5:                                         ; preds = %main_LeafBlock
  %"12" = sext i32 %i_0.0 to i64, !dbg !38
...
main_bb6:                                         ; preds = %main_bb5
  %"16" = sext i32 %i_0.0 to i64, !dbg !41
...
main_bb7:                                         ; preds = %main_NewDefault
  %"19" = sext i32 %i_0.0 to i64, !dbg !43
...
!17 = metadata !{i32 786688, metadata !4, metadata !"ereg", metadata !5, i32 8, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [ereg] [line 8]
!18 = metadata !{i32 8, i32 7, metadata !4, null} ; [ DW_TAG_imported_declaration ]
!19 = metadata !{i32 10}
!20 = metadata !{i32 786688, metadata !4, metadata !"EVENT_EPOLL_TABLES", metadata !5, i32 10, metadata !13, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [EVENT_EPOLL_TABLES] [line 10]
!21 = metadata !{i32 10, i32 7, metadata !4, null}
!22 = metadata !{i32 0}
!23 = metadata !{i32 786688, metadata !24, metadata !"i", metadata !5, i32 12, metadata !13, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 12]
!24 = metadata !{i32 786443, metadata !1, metadata !4, i32 11, i32 3, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!25 = metadata !{i32 12, i32 9, metadata !24, null}
!26 = metadata !{i32 13, i32 5, metadata !24, null}
!27 = metadata !{i32 13, i32 5, metadata !28, null}
!28 = metadata !{i32 786443, metadata !1, metadata !24, i32 13, i32 5, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!29 = metadata !{i32 14, i32 23, metadata !30, null}
!30 = metadata !{i32 786443, metadata !1, metadata !24, i32 13, i32 20, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!31 = metadata !{i32 15, i32 17, metadata !30, null}
!32 = metadata !{i32 16, i32 7, metadata !30, null}
!33 = metadata !{i32 17, i32 5, metadata !30, null}
