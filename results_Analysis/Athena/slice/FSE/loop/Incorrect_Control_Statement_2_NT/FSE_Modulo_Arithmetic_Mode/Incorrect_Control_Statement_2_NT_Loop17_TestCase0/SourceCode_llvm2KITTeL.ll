...
main_bb6:                                         ; preds = %main_wrap_around.exit
  ...
  %"14" = getelementptr inbounds [10 x i64]* %slots_used, i32 0, i64 %i.0, !dbg !60
  store i64 %"13", i64* %"14", align 8, !dbg !60
  %"15" = call i64 @__VERIFIER_nondet_int(), !dbg !61
  %"16" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i.0, !dbg !61
...
!40 = metadata !{i64 0}
!41 = metadata !{i32 786688, metadata !42, metadata !"i", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 22]
...
!46 = metadata !{i32 786443, metadata !1, metadata !42, i32 23, i32 20, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!60 = metadata !{i32 24, i32 23, metadata !46, null}
