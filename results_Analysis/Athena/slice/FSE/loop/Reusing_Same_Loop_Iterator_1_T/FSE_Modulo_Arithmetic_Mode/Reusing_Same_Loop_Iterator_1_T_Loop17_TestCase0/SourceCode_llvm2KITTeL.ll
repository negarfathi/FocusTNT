...
main_bb5:
  ...
  br i1 %or.cond, label %main_bb10, label %main_wrap_around.exit, !dbg !39

main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb9, %main_bb8, %main_bb7
  %i.0 = phi i64 [ %"22", %main_bb7 ], [ %"27", %main_bb9 ], [ %"17", %main_bb8 ], [ 0, %main_bb5 ]
  %"16" = icmp slt i64 %i.0, %"12", !dbg !43
  br i1 %"16", label %main_bb6, label %main_bb10, !dbg !43

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"17" = add nsw i64 %i.0, 1, !dbg !45
  %"18" = icmp sgt i64 %"17", 2147483647, !dbg !47
  br i1 %"18", label %main_bb7, label %main_bb8, !dbg !47

main_bb7:                                         ; preds = %main_bb6
  %"19" = sub nsw i64 %"17", 2147483647, !dbg !48
  %"20" = sub nsw i64 %"19", 1, !dbg !48
  %"21" = srem i64 %"20", 4294967296, !dbg !48
  %"22" = add nsw i64 -2147483648, %"21", !dbg !48
  br label %main_wrap_around.exit, !dbg !48

main_bb8:                                         ; preds = %main_bb6
  %"23" = icmp slt i64 %"17", -2147483648, !dbg !49
  br i1 %"23", label %main_bb9, label %main_wrap_around.exit, !dbg !49

main_bb9:                                         ; preds = %main_bb8
  %"24" = sub nsw i64 -2147483648, %"17", !dbg !50
  %"25" = sub nsw i64 %"24", 1, !dbg !50
  %"26" = srem i64 %"25", 4294967296, !dbg !50
  %"27" = sub nsw i64 2147483647, %"26", !dbg !50
...
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 3, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 34, i32 8, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 1, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 9, i32 9, metadata !25, metadata !45}
!48 = metadata !{i32 10, i32 9, metadata !27, metadata !45}
!49 = metadata !{i32 12, i32 14, metadata !29, metadata !45}
!50 = metadata !{i32 13, i32 9, metadata !31, metadata !45}
!51 = metadata !{i32 36, i32 17, metadata !9, null}
