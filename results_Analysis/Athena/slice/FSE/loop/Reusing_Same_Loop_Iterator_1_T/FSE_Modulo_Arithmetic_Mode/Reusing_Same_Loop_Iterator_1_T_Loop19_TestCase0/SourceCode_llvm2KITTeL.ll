...
main_wrap_around.exit2:                           ; preds = %main_bb5, %main_bb13, %main_bb12, %main_bb11
  %i.0 = phi i64 [ %"34", %main_bb11 ], [ %"39", %main_bb13 ], [ %"29", %main_bb12 ], [ 0, %main_bb5 ]
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  %"29" = add nsw i64 %i.0, 1, !dbg !54
  call void @llvm.dbg.value(metadata !{i64 %"29"}, i64 0, metadata !55), !dbg !56
  ...
  %"30" = icmp sgt i64 %"29", 2147483647, !dbg !66
  br i1 %"30", label %main_bb11, label %main_bb12, !dbg !66

main_bb11:                                        ; preds = %main_bb10
  %"31" = sub nsw i64 %"29", 2147483647, !dbg !67
  %"32" = sub nsw i64 %"31", 1, !dbg !67
  %"33" = srem i64 %"32", 4294967296, !dbg !67
  %"34" = add nsw i64 -2147483648, %"33", !dbg !67
  br label %main_wrap_around.exit2, !dbg !67

main_bb12:                                        ; preds = %main_bb10
  %"35" = icmp slt i64 %"29", -2147483648, !dbg !68
  br i1 %"35", label %main_bb13, label %main_wrap_around.exit2, !dbg !68

main_bb13:                                        ; preds = %main_bb12
  %"36" = sub nsw i64 -2147483648, %"29", !dbg !69
  %"37" = sub nsw i64 %"36", 1, !dbg !69
  %"38" = srem i64 %"37", 4294967296, !dbg !69
  %"39" = sub nsw i64 2147483647, %"38", !dbg !69
...
!33 = metadata !{i32 22, i32 24, metadata !9, null}
