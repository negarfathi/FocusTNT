...
main_bb5:
  ...
  br i1 %or.cond, label %main_bb11, label %main_bb6, !dbg !42

main_bb6:                                         ; preds = %main_bb5, %main_ff_subtitles_next_line_slice_1.exit
  %b.0 = phi i32 [ %"19", %main_ff_subtitles_next_line_slice_1.exit ], [ %"7", %main_bb5 ]
  %"11" = icmp slt i32 %b.0, %"8", !dbg !46
  br i1 %"11", label %main_bb7, label %main_bb11, !dbg !46
...
main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb7, %main_bb9, %main_bb10
  ...
  %"19" = add nsw i32 %b.0, %__retres.2.i, !dbg !58
  %"20" = sub nsw i32 %"8", 4, !dbg !59
  %"21" = icmp sge i32 %"19", %"20", !dbg !59
  br i1 %"21", label %main_bb11, label %main_bb6, !dbg !59

main_bb11:                                        ; preds = %main_bb6, %main_ff_subtitles_next_line_slice_1.exit, %main_bb5
  ret void, !dbg !61
}
...
!34 = metadata !{i32 786443, metadata !1, metadata !32, i32 20, i32 16, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!47 = metadata !{i32 786443, metadata !1, metadata !9, i32 38, i32 3, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 9, i32 11, metadata !4, metadata !49}
!49 = metadata !{i32 40, i32 13, metadata !50, null}
...
!58 = metadata !{i32 41, i32 5, metadata !50, null}
!59 = metadata !{i32 42, i32 9, metadata !60, null}
!60 = metadata !{i32 786443, metadata !1, metadata !50, i32 42, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
