...
main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  ...
  br i1 %"13", label %main_wrap_around.exit, label %main_bb11, !dbg !54
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  ...
  %"14" = icmp eq i64 %res.1, 0, !dbg !56
  br i1 %"14", label %main_bb7, label %main_bb6, !dbg !56
...
!36 = metadata !{i32 20, i32 19, metadata !9, null}
