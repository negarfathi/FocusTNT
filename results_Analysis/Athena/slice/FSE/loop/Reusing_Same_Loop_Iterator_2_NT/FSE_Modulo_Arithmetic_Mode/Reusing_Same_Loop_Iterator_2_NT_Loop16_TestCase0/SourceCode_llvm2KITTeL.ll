...
main_bb5:
  ...
  %"13" = icmp sgt i64 %"12", 65534, !dbg !36
  br i1 %"13", label %main_bb14, label %main_wrap_around.exit2, !dbg !36
...
main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  ...
  %"14" = icmp slt i64 %i.0, %"12", !dbg !38
  br i1 %"14", label %main_wrap_around.exit, label %main_bb14, !dbg !38
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"15" = icmp slt i64 %i.1, 3, !dbg !40
  %"16" = add nsw i64 %i.1, 1, !dbg !43
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !45
  br i1 %"15", label %main_bb6, label %main_bb10, !dbg !40

main_bb6:                                         ; preds = %main_wrap_around.exit
  br i1 %"17", label %main_bb7, label %main_bb8, !dbg !45

main_bb7:                                         ; preds = %main_bb6
  %"18" = sub nsw i64 %"16", 2147483647, !dbg !46
  %"19" = sub nsw i64 %"18", 1, !dbg !46
  %"20" = srem i64 %"19", 4294967296, !dbg !46
  %"21" = add nsw i64 -2147483648, %"20", !dbg !46
  br label %main_wrap_around.exit, !dbg !46

main_bb8:                                         ; preds = %main_bb6
  %"22" = icmp slt i64 %"16", -2147483648, !dbg !47
  br i1 %"22", label %main_bb9, label %main_wrap_around.exit, !dbg !47

main_bb9:                                         ; preds = %main_bb8
  %"23" = sub nsw i64 -2147483648, %"16", !dbg !48
  %"24" = sub nsw i64 %"23", 1, !dbg !48
  %"25" = srem i64 %"24", 4294967296, !dbg !48
  %"26" = sub nsw i64 2147483647, %"25", !dbg !48
  br label %main_wrap_around.exit, !dbg !48

main_bb10:                                        ; preds = %main_wrap_around.exit
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !49), !dbg !51
  ...
  br i1 %"17", label %main_bb11, label %main_bb12, !dbg !61

main_bb11:                                        ; preds = %main_bb10
  %"27" = sub nsw i64 %"16", 2147483647, !dbg !62
  %"28" = sub nsw i64 %"27", 1, !dbg !62
  %"29" = srem i64 %"28", 4294967296, !dbg !62
  %"30" = add nsw i64 -2147483648, %"29", !dbg !62
  br label %main_wrap_around.exit2, !dbg !62

main_bb12:                                        ; preds = %main_bb10
  %"31" = icmp slt i64 %"16", -2147483648, !dbg !63
  br i1 %"31", label %main_bb13, label %main_wrap_around.exit2, !dbg !63

main_bb13:                                        ; preds = %main_bb12
  %"32" = sub nsw i64 -2147483648, %"16", !dbg !64
  %"33" = sub nsw i64 %"32", 1, !dbg !64
  %"34" = srem i64 %"33", 4294967296, !dbg !64
  %"35" = sub nsw i64 2147483647, %"34", !dbg !64
...
!33 = metadata !{i32 21, i32 19, metadata !9, null}
