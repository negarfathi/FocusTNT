...
define void @main() #0 {
main_bb5:
  %"12" = call i64 @__VERIFIER_nondet_ushort(), !dbg !33
  call void @llvm.dbg.value(metadata !{i64 %"12"}, i64 0, metadata !34), !dbg !35
  %"13" = call i64 @__VERIFIER_nondet_ushort(), !dbg !36
  ...
  %"14" = trunc i64 %"12" to i32, !dbg !41
  %"15" = trunc i64 %"13" to i32, !dbg !41
  call void @llvm.dbg.value(metadata !{i64 %"19"}, i64 0, metadata !42), !dbg !43
  ...
  call void @llvm.dbg.value(metadata !{i64 %"24"}, i64 0, metadata !39), !dbg !40
  br label %main_bb6, !dbg !53

main_bb6:                                         ; preds = %main_bb7, %main_bb5
  %s.0 = phi i64 [ %"12", %main_bb5 ], [ %"24", %main_bb7 ]
  %"16" = trunc i64 %s.0 to i32, !dbg !54
  %"17" = sext i32 %"16" to i64, !dbg !54
  %"18" = add nsw i32 %"14", %"15", !dbg !41
  %"19" = sext i32 %"18" to i64, !dbg !41
  %"20" = icmp slt i64 %"17", %"19", !dbg !41
  br i1 %"20", label %main_bb7, label %main_bb8, !dbg !41

main_bb7:                                         ; preds = %main_bb6
  %"21" = trunc i64 %s.0 to i32, !dbg !56
  %"22" = add nsw i32 %"21", 1, !dbg !56
  %"23" = trunc i32 %"22" to i16, !dbg !56
  %"24" = zext i16 %"23" to i64, !dbg !56
...
!33 = metadata !{i32 22, i32 12, metadata !9, null}
...
!36 = metadata !{i32 23, i32 9, metadata !9, null}
!37 = metadata !{i32 786688, metadata !9, metadata !"len", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [len] [line 21]
!38 = metadata !{i32 21, i32 13, metadata !9, null}
!39 = metadata !{i32 786688, metadata !9, metadata !"s", metadata !5, i32 19, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [s] [line 19]
!40 = metadata !{i32 19, i32 13, metadata !9, null}
!41 = metadata !{i32 25, i32 19, metadata !9, null}
!42 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [value] [line 7]
!43 = metadata !{i32 7, i32 33, metadata !4, metadata !41}
!44 = metadata !{i64 -2147483648}
!45 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!46 = metadata !{i32 7, i32 50, metadata !4, metadata !41}
!47 = metadata !{i64 2147483647}
!48 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !41} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!49 = metadata !{i32 7, i32 73, metadata !4, metadata !41}
!50 = metadata !{i64 4294967296}
!51 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !41} ; [ DW_TAG_auto_variable ] [range] [line 8]
!52 = metadata !{i32 8, i32 15, metadata !4, metadata !41} ; [ DW_TAG_imported_declaration ]
!53 = metadata !{i32 25, i32 3, metadata !9, null}
!54 = metadata !{i32 25, i32 3, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 3, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 26, i32 3, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !9, i32 26, i32 1, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 27, i32 1, metadata !57, null}
