...
ff_subtitles_next_line_slice_1_bb0:
  ...
  %"1" = srem i32 %"0", 1000, !dbg !20
  call void @llvm.dbg.value(metadata !{i32 %"1"}, i64 0, metadata !18), !dbg !19
  %"2" = load i32* @"'flag", align 4, !dbg !21
  %"3" = icmp eq i32 %"2", 1, !dbg !21
  br i1 %"3", label %ff_subtitles_next_line_slice_1_bb4, label %ff_subtitles_next_line_slice_1_bb1, !dbg !21

ff_subtitles_next_line_slice_1_bb1:               ; preds = %ff_subtitles_next_line_slice_1_bb0
  %"4" = icmp eq i32 %"1", 0, !dbg !23
  br i1 %"4", label %ff_subtitles_next_line_slice_1_bb2, label %ff_subtitles_next_line_slice_1_bb3, !dbg !23
...
ff_subtitles_next_line_slice_1_bb3:               ; preds = %ff_subtitles_next_line_slice_1_bb1
  %"5" = icmp slt i32 %"1", 0, !dbg !31
  %"6" = sub nsw i32 0, %"1", !dbg !33
  call void @llvm.dbg.value(metadata !{i32 %"6"}, i64 0, metadata !28), !dbg !29
  %__retres.0 = select i1 %"5", i32 %"6", i32 %"1", !dbg !31
...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i32 %"7"}, i64 0, metadata !37), !dbg !38
  %"8" = call i32 @__VERIFIER_nondet_int(), !dbg !39
  call void @llvm.dbg.value(metadata !{i32 %"8"}, i64 0, metadata !40), !dbg !41
  %"9" = icmp slt i32 %"7", 0, !dbg !42
  %"10" = icmp slt i32 %"8", 0, !dbg !44
  %or.cond = or i1 %"9", %"10", !dbg !42
  br i1 %or.cond, label %main_bb12, label %main_bb6, !dbg !42

main_bb6:                                         ; preds = %main_bb5, %main_bb11
  %b.0 = phi i32 [ %"20", %main_bb11 ], [ %"7", %main_bb5 ]
  %"11" = icmp slt i32 %b.0, %"8", !dbg !46
  br i1 %"11", label %main_bb7, label %main_bb12, !dbg !46

main_bb7:                                         ; preds = %main_bb6
  %"12" = call i32 @__VERIFIER_nondet_int() #3, !dbg !48
  %"13" = srem i32 %"12", 1000, !dbg !51
  %"14" = load i32* @"'flag", align 4, !dbg !52
  %"15" = icmp eq i32 %"14", 1, !dbg !52
  br i1 %"15", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb8, !dbg !52

main_bb8:                                         ; preds = %main_bb7
  %"16" = icmp eq i32 %"13", 0, !dbg !53
  br i1 %"16", label %main_bb9, label %main_bb10, !dbg !53

main_bb9:                                         ; preds = %main_bb8
  store i32 1, i32* @"'flag", align 4, !dbg !54
  br label %main_ff_subtitles_next_line_slice_1.exit, !dbg !55

main_bb10:                                        ; preds = %main_bb8
  %"17" = icmp slt i32 %"13", 0, !dbg !56
  %"18" = sub nsw i32 0, %"13", !dbg !57
  %__retres.0.i = select i1 %"17", i32 %"18", i32 %"13", !dbg !56
  br label %main_ff_subtitles_next_line_slice_1.exit, !dbg !56

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb7, %main_bb9, %main_bb10
  %__retres.2.i = phi i32 [ 0, %main_bb7 ], [ 0, %main_bb9 ], [ %__retres.0.i, %main_bb10 ], !dbg !49
  %"19" = icmp ne i32 %__retres.2.i, 0, !dbg !58
  br i1 %"19", label %main_bb11, label %main_bb12, !dbg !58

main_bb11:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"20" = add nsw i32 %b.0, %__retres.2.i, !dbg !60
  %"21" = sub nsw i32 %"8", 4, !dbg !61
  %"22" = icmp sge i32 %"20", %"21", !dbg !61
  br i1 %"22", label %main_bb12, label %main_bb6, !dbg !61

main_bb12:                                        ; preds = %main_bb6, %main_ff_subtitles_next_line_slice_1.exit, %main_bb11, %main_bb5
  ret void, !dbg !63
}
...
!36 = metadata !{i32 27, i32 11, metadata !9, null}
...
!39 = metadata !{i32 28, i32 13, metadata !9, null}
!40 = metadata !{i32 786688, metadata !9, metadata !"end", metadata !5, i32 28, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [end] [line 28]
!41 = metadata !{i32 28, i32 7, metadata !9, null}
!42 = metadata !{i32 29, i32 7, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 29, i32 7, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 34, i32 9, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !43, i32 34, i32 9, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 38, i32 3, metadata !47, null}
!47 = metadata !{i32 786443, metadata !1, metadata !9, i32 38, i32 3, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 9, i32 11, metadata !4, metadata !49}
!49 = metadata !{i32 39, i32 15, metadata !50, null}
!50 = metadata !{i32 786443, metadata !1, metadata !9, i32 38, i32 19, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 10, i32 3, metadata !4, metadata !49}
!52 = metadata !{i32 11, i32 7, metadata !22, metadata !49}
!53 = metadata !{i32 15, i32 7, metadata !24, metadata !49}
!54 = metadata !{i32 16, i32 5, metadata !26, metadata !49}
!55 = metadata !{i32 18, i32 3, metadata !26, metadata !49}
!56 = metadata !{i32 20, i32 9, metadata !32, metadata !49}
!57 = metadata !{i32 20, i32 16, metadata !34, metadata !49}
!58 = metadata !{i32 40, i32 9, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !50, i32 40, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 44, i32 5, metadata !50, null}
!61 = metadata !{i32 45, i32 9, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !50, i32 45, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
