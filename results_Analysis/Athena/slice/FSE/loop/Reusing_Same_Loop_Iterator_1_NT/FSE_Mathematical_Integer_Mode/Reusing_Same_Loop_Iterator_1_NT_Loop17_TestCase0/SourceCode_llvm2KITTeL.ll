...
main_bb1:                                         ; preds = %main_bb0, %main_bb2
  %i.0 = phi i32 [ %"6", %main_bb2 ], [ 0, %main_bb0 ]
...
main_bb2:                                         ; preds = %main_bb2, %main_bb1
  ...
  %"5" = icmp slt i32 %i.1, %"1", !dbg !24
  %"6" = add nsw i32 %i.1, 1, !dbg !28
  br i1 %"5", label %main_bb2, label %main_bb1, !dbg !24
...
!11 = metadata !{i32 9, i32 18, metadata !4, null}
...
!15 = metadata !{i32 10, i32 20, metadata !4, null}
...
!22 = metadata !{i32 21, i32 3, metadata !23, null}
!23 = metadata !{i32 786443, metadata !1, metadata !4, i32 21, i32 3, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!24 = metadata !{i32 23, i32 5, metadata !25, null}
!25 = metadata !{i32 786443, metadata !1, metadata !26, i32 23, i32 5, i32 3, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!26 = metadata !{i32 786443, metadata !1, metadata !27, i32 23, i32 5, i32 1, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!27 = metadata !{i32 786443, metadata !1, metadata !4, i32 21, i32 24, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!28 = metadata !{i32 23, i32 28, metadata !29, null}
!29 = metadata !{i32 786443, metadata !1, metadata !27, i32 23, i32 28, i32 2, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!30 = metadata !{i32 26, i32 17, metadata !4, null}
