...
main_bb0:
  ...
  call void @llvm.dbg.declare(metadata !{[100 x i8]* %buf}, metadata !11), !dbg !16
  call void @llvm.dbg.value(metadata !17, i64 0, metadata !18), !dbg !21
  call void @llvm.dbg.value(metadata !{i32 %"4"}, i64 0, metadata !18), !dbg !21
...
main_bb2:                                         ; preds = %main_bb1
  %"1" = call signext i8 @__VERIFIER_nondet_char(), !dbg !25
  %"2" = sext i32 %i.0 to i64, !dbg !25
  %"3" = getelementptr inbounds [100 x i8]* %buf, i32 0, i64 %"2", !dbg !25
  store i8 %"1", i8* %"3", align 1, !dbg !25
...
!11 = metadata !{i32 786688, metadata !4, metadata !"buf", metadata !5, i32 7, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [buf] [line 7]
...
!17 = metadata !{i32 0}
!18 = metadata !{i32 786688, metadata !19, metadata !"i", metadata !5, i32 9, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 9]
!19 = metadata !{i32 786443, metadata !1, metadata !4, i32 8, i32 3, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!21 = metadata !{i32 9, i32 9, metadata !19, null}
!22 = metadata !{i32 10, i32 5, metadata !19, null}
!23 = metadata !{i32 10, i32 5, metadata !24, null}
!24 = metadata !{i32 786443, metadata !1, metadata !19, i32 10, i32 5, i32 1, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!25 = metadata !{i32 11, i32 16, metadata !26, null}
!26 = metadata !{i32 786443, metadata !1, metadata !19, i32 10, i32 20, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!27 = metadata !{i32 12, i32 7, metadata !26, null}
