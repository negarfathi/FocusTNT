...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"12"}, i64 0, metadata !36), !dbg !37
  %"13" = call i64 @__VERIFIER_nondet_uint(), !dbg !38
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !39), !dbg !40
  %"14" = call i64 @__VERIFIER_nondet_uint(), !dbg !41
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !42), !dbg !43
  %"15" = icmp sle i64 %"13", %"14", !dbg !44
  %"16" = icmp eq i64 %"12", 0, !dbg !46
  %or.cond = or i1 %"15", %"16", !dbg !44
  br i1 %or.cond, label %main_bb11, label %main_bb6, !dbg !44

main_bb6:                                         ; preds = %main_bb5, %main_wrap_around.exit
  %cur.0 = phi i64 [ %.0.i, %main_wrap_around.exit ], [ %"12", %main_bb5 ]
  %"17" = icmp slt i64 %"13", %cur.0, !dbg !48
  br i1 %"17", label %main_bb11, label %main_bb7, !dbg !48

main_bb7:                                         ; preds = %main_bb6
  %"18" = add nsw i64 %cur.0, %"12", !dbg !51
  %"19" = icmp sgt i64 %"18", 4294967295, !dbg !52
  br i1 %"19", label %main_bb8, label %main_bb9, !dbg !52

main_bb8:                                         ; preds = %main_bb7
  %"20" = sub nsw i64 %"18", 4294967295, !dbg !53
  %"21" = sub nsw i64 %"20", 1, !dbg !53
  %"22" = srem i64 %"21", 4294967296, !dbg !53
  br label %main_wrap_around.exit, !dbg !53

main_bb9:                                         ; preds = %main_bb7
  %"23" = icmp slt i64 %"18", 0, !dbg !54
  br i1 %"23", label %main_bb10, label %main_wrap_around.exit, !dbg !54

main_bb10:                                        ; preds = %main_bb9
  %"24" = sub nsw i64 0, %"18", !dbg !55
  %"25" = sub nsw i64 %"24", 1, !dbg !55
  %"26" = srem i64 %"25", 4294967296, !dbg !55
  %"27" = sub nsw i64 4294967295, %"26", !dbg !55
  br label %main_wrap_around.exit, !dbg !55

main_wrap_around.exit:                            ; preds = %main_bb8, %main_bb9, %main_bb10
  %.0.i = phi i64 [ %"22", %main_bb8 ], [ %"27", %main_bb10 ], [ %"18", %main_bb9 ], !dbg !51
  %"28" = icmp sle i64 %.0.i, %cur.0, !dbg !56
  br i1 %"28", label %main_bb11, label %main_bb6, !dbg !56

main_bb11:                                        ; preds = %main_bb6, %main_wrap_around.exit, %main_bb5
  ret void, !dbg !58
}
...
!33 = metadata !{i32 20, i32 20, metadata !9, null}
!34 = metadata !{i32 786688, metadata !9, metadata !"best", metadata !5, i32 20, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [best] [line 20]
!35 = metadata !{i32 20, i32 13, metadata !9, null}
!36 = metadata !{i32 786688, metadata !9, metadata !"cur", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [cur] [line 21]
!37 = metadata !{i32 21, i32 13, metadata !9, null}
!38 = metadata !{i32 22, i32 22, metadata !9, null}
!39 = metadata !{i32 786688, metadata !9, metadata !"st_max", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [st_max] [line 22]
!40 = metadata !{i32 22, i32 13, metadata !9, null}
!41 = metadata !{i32 23, i32 22, metadata !9, null}
!42 = metadata !{i32 786688, metadata !9, metadata !"it_min", metadata !5, i32 23, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [it_min] [line 23]
!43 = metadata !{i32 23, i32 13, metadata !9, null}
!44 = metadata !{i32 24, i32 7, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 7, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 27, i32 7, metadata !47, null}
!47 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 7, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 31, i32 9, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !50, i32 31, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!50 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 13, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 36, i32 11, metadata !50, null}
!52 = metadata !{i32 9, i32 9, metadata !25, metadata !51}
!53 = metadata !{i32 10, i32 9, metadata !27, metadata !51}
!54 = metadata !{i32 12, i32 14, metadata !29, metadata !51}
!55 = metadata !{i32 13, i32 9, metadata !31, metadata !51}
!56 = metadata !{i32 37, i32 9, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !50, i32 37, i32 9, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 42, i32 17, metadata !9, null}
