...
main_mdb_cursor_get_slice_1.exit:                 ; preds = %main_bb3, %main_bb4
  ...
  call void @llvm.dbg.value(metadata !{i32 %"15"}, i64 0, metadata !44) #3, !dbg !49
  call void @llvm.dbg.value(metadata !{i32 %"15"}, i64 0, metadata !50) #3, !dbg !52
  br label %main_mdb_cursor_get_slice_1.exit3, !dbg !53

main_mdb_cursor_get_slice_1.exit3:                ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb6, %main_mdb_cursor_get_slice_1.exit
  %rc.0 = phi i32 [ %__retres.1.i, %main_mdb_cursor_get_slice_1.exit ], [ %..i1, %main_bb7 ], [ 1, %main_bb6 ], [ %..i4, %main_bb9 ], [ 1, %main_bb8 ]
  %"13" = icmp eq i32 %rc.0, 0, !dbg !54
  br i1 %"13", label %main_bb5, label %main_bb10, !dbg !54

main_bb5:                                         ; preds = %main_mdb_cursor_get_slice_1.exit3
  %"14" = icmp sle i32 %"12", 0, !dbg !56
  %"15" = call i32 @__VERIFIER_nondet_int() #3, !dbg !57
  %"16" = load i32* @"'flag", align 4, !dbg !58
  %"17" = add nsw i32 %"16", 1, !dbg !58
  store i32 %"17", i32* @"'flag", align 4, !dbg !58
  %"18" = load i32* @"'flag", align 4, !dbg !59
  %"19" = icmp sgt i32 %"18", 1000, !dbg !59
  br i1 %"14", label %main_bb6, label %main_bb8, !dbg !56

main_bb6:                                         ; preds = %main_bb5
  br i1 %"19", label %main_mdb_cursor_get_slice_1.exit3, label %main_bb7, !dbg !59

main_bb7:                                         ; preds = %main_bb6
  %"20" = icmp sge i32 %"15", 0, !dbg !60
  %..i1 = select i1 %"20", i32 0, i32 1, !dbg !61
  br label %main_mdb_cursor_get_slice_1.exit3, !dbg !62

main_bb8:                                         ; preds = %main_bb5
  br i1 %"19", label %main_mdb_cursor_get_slice_1.exit3, label %main_bb9, !dbg !63

main_bb9:                                         ; preds = %main_bb8
  %"21" = icmp sge i32 %"15", 0, !dbg !64
  %..i4 = select i1 %"21", i32 0, i32 1, !dbg !65
  br label %main_mdb_cursor_get_slice_1.exit3, !dbg !66

main_bb10:                                        ; preds = %main_mdb_cursor_get_slice_1.exit3
  ret void, !dbg !67
}
...
!46 = metadata !{i32 786443, metadata !1, metadata !47, i32 25, i32 28, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 786443, metadata !1, metadata !48, i32 25, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!48 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 19, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 9, i32 7, metadata !4, metadata !45}
!50 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 9, metadata !8, i32 0, metadata !51} ; [ DW_TAG_auto_variable ] [i] [line 9]
!51 = metadata !{i32 29, i32 10, metadata !48, null}
!52 = metadata !{i32 9, i32 7, metadata !4, metadata !51}
!53 = metadata !{i32 24, i32 3, metadata !9, null}
!54 = metadata !{i32 24, i32 3, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 3, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 25, i32 9, metadata !47, null}
!57 = metadata !{i32 9, i32 11, metadata !4, metadata !45}
!58 = metadata !{i32 10, i32 3, metadata !4, metadata !45}
!59 = metadata !{i32 11, i32 7, metadata !22, metadata !45}
!60 = metadata !{i32 15, i32 7, metadata !24, metadata !45}
!61 = metadata !{i32 15, i32 15, metadata !26, metadata !45}
!62 = metadata !{i32 15, i32 12, metadata !28, metadata !45}
!63 = metadata !{i32 11, i32 7, metadata !22, metadata !51}
!64 = metadata !{i32 15, i32 7, metadata !24, metadata !51}
!65 = metadata !{i32 15, i32 15, metadata !26, metadata !51}
!66 = metadata !{i32 15, i32 12, metadata !28, metadata !51}
!67 = metadata !{i32 31, i32 3, metadata !9, null}
