...
main_bb5:
  ...
  %"13" = icmp slt i64 %"12", 0, !dbg !36
  br i1 %"13", label %main_bb11, label %main_bb6, !dbg !36

main_bb6:                                         ; preds = %main_bb5
  %"14" = call i64 @__VERIFIER_nondet_int(), !dbg !38
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !39), !dbg !40
  call void @llvm.dbg.value(metadata !{i64 %h.0}, i64 0, metadata !34), !dbg !35
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !41), !dbg !44
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  %h.0 = phi i64 [ %"14", %main_bb6 ], [ %"23", %main_bb8 ], [ %"28", %main_bb10 ], [ %"18", %main_bb9 ]
  %linesToRead.0 = phi i64 [ %"12", %main_bb6 ], [ %h.0.linesToRead.0, %main_bb8 ], [ %h.0.linesToRead.0, %main_bb9 ], [ %h.0.linesToRead.0, %main_bb10 ]
  %"15" = icmp ne i64 %linesToRead.0, 0, !dbg !55
  %"16" = icmp sgt i64 %h.0, 0, !dbg !57
  %or.cond = and i1 %"15", %"16", !dbg !55
  br i1 %or.cond, label %main_bb7, label %main_bb11, !dbg !55

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"17" = icmp sgt i64 %linesToRead.0, %h.0, !dbg !60
  %h.0.linesToRead.0 = select i1 %"17", i64 %h.0, i64 %linesToRead.0, !dbg !60
  %"18" = sub nsw i64 %h.0, %h.0.linesToRead.0, !dbg !42
  %"19" = icmp sgt i64 %"18", 2147483647, !dbg !62
  br i1 %"19", label %main_bb8, label %main_bb9, !dbg !62

main_bb8:                                         ; preds = %main_bb7
  %"20" = sub nsw i64 %"18", 2147483647, !dbg !63
  %"21" = sub nsw i64 %"20", 1, !dbg !63
  %"22" = srem i64 %"21", 4294967296, !dbg !63
  %"23" = add nsw i64 -2147483648, %"22", !dbg !63
  br label %main_wrap_around.exit, !dbg !63

main_bb9:                                         ; preds = %main_bb7
  %"24" = icmp slt i64 %"18", -2147483648, !dbg !64
  br i1 %"24", label %main_bb10, label %main_wrap_around.exit, !dbg !64

main_bb10:                                        ; preds = %main_bb9
  %"25" = sub nsw i64 -2147483648, %"18", !dbg !65
  %"26" = sub nsw i64 %"25", 1, !dbg !65
  %"27" = srem i64 %"26", 4294967296, !dbg !65
  %"28" = sub nsw i64 2147483647, %"27", !dbg !65
  br label %main_wrap_around.exit, !dbg !65

main_bb11:                                        ; preds = %main_wrap_around.exit, %main_bb5
  ret void, !dbg !66
}
...
!33 = metadata !{i32 20, i32 27, metadata !9, null}
...
!38 = metadata !{i32 25, i32 17, metadata !9, null}
!39 = metadata !{i32 786688, metadata !9, metadata !"h", metadata !5, i32 25, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [h] [line 25]
!40 = metadata !{i32 25, i32 13, metadata !9, null}
...
!42 = metadata !{i32 36, i32 9, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 26, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 7, i32 33, metadata !4, metadata !42}
...
!54 = metadata !{i32 26, i32 3, metadata !9, null}
!55 = metadata !{i32 27, i32 9, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !43, i32 27, i32 9, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 28, i32 11, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !59, i32 28, i32 11, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 786443, metadata !1, metadata !56, i32 27, i32 22, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 33, i32 9, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !43, i32 33, i32 9, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 9, i32 9, metadata !25, metadata !42}
!63 = metadata !{i32 10, i32 9, metadata !27, metadata !42}
!64 = metadata !{i32 12, i32 14, metadata !29, metadata !42}
!65 = metadata !{i32 13, i32 9, metadata !31, metadata !42}
!66 = metadata !{i32 38, i32 17, metadata !9, null}
