...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %n.0 = phi i64 [ %"12", %main_bb5 ], [ %"18", %main_bb7 ], [ %"23", %main_bb9 ], [ %"14", %main_bb8 ]
  %"13" = icmp sgt i64 %n.0, 0, !dbg !52
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !52

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = sub nsw i64 %n.0, 16, !dbg !40
  %"15" = icmp sgt i64 %"14", 4294967295, !dbg !54
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !54

main_bb7:                                         ; preds = %main_bb6
  %"16" = sub nsw i64 %"14", 4294967295, !dbg !55
  %"17" = sub nsw i64 %"16", 1, !dbg !55
  %"18" = srem i64 %"17", 4294967296, !dbg !55
  br label %main_wrap_around.exit, !dbg !55

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"14", 0, !dbg !56
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !56

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 0, %"14", !dbg !57
  %"21" = sub nsw i64 %"20", 1, !dbg !57
  %"22" = srem i64 %"21", 4294967296, !dbg !57
  %"23" = sub nsw i64 4294967295, %"22", !dbg !57
