...
main_bb6:
  ...
  %"14" = icmp eq i64 %"13", 0, !dbg !48
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !48

main_bb7:                                         ; preds = %main_bb7, %main_bb6
  %"15" = call i64 @__VERIFIER_nondet_int() #3, !dbg !50
  %"16" = icmp slt i64 %"15", 0, !dbg !54
  %"17" = load i64* @"'__fc_errno", align 8
  %"18" = icmp eq i64 %"17", 1, !dbg !56
  %or.cond = and i1 %"16", %"18", !dbg !54
  br i1 %or.cond, label %main_bb7, label %main_bb8, !dbg !54
...
!48 = metadata !{i32 35, i32 7, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !12, i32 35, i32 7, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!50 = metadata !{i32 21, i32 19, metadata !9, metadata !51}
!51 = metadata !{i32 38, i32 13, metadata !52, null}
!52 = metadata !{i32 786443, metadata !1, metadata !53, i32 37, i32 15, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!53 = metadata !{i32 786443, metadata !1, metadata !49, i32 36, i32 1, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 39, i32 11, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !52, i32 39, i32 11, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 40, i32 13, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !58, i32 40, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 786443, metadata !1, metadata !55, i32 39, i32 20, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
