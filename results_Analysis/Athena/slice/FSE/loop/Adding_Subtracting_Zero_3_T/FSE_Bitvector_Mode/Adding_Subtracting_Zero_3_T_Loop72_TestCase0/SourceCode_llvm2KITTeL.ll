...
main_bb7:
  ...
  br i1 %or.cond, label %main_bb18, label %main_bb8, !dbg !58

main_bb8:                                         ; preds = %main_bb7, %main_bb15, %main_bb17
  %__fc_errno_0.0 = phi i32 [ %__fc_errno_0.0, %main_bb17 ], [ %"27", %main_bb15 ], [ 0, %main_bb7 ]
  %pos.0 = phi i32 [ %"30", %main_bb17 ], [ %pos.0, %main_bb15 ], [ 0, %main_bb7 ]
  %"14" = icmp slt i32 %pos.0, %"11", !dbg !62
  br i1 %"14", label %main_bb9, label %main_bb18, !dbg !62
...
main_bb15:                                        ; preds = %main_LeafBlock
  %"27" = add nsw i32 %__fc_errno_0.0, 1, !dbg !81
  %"28" = icmp eq i32 %"27", 5, !dbg !84
  br i1 %"28", label %main_bb18, label %main_bb8, !dbg !84
...
main_bb16:                                        ; preds = %main_LeafBlock1
  %"29" = add nsw i32 %__retres.0.i, 1, !dbg !86
  br label %main_bb17, !dbg !86

main_NewDefault:                                  ; preds = %main_LeafBlock1, %main_LeafBlock
  br label %main_bb17

main_bb17:                                        ; preds = %main_NewDefault, %main_bb16
  %rc.0 = phi i32 [ %"29", %main_bb16 ], [ %__retres.0.i, %main_NewDefault ]
  %"30" = add nsw i32 %pos.0, %rc.0, !dbg !89
  br label %main_bb8, !dbg !90
...
!36 = metadata !{i32 786443, metadata !1, metadata !33, i32 22, i32 20, i32 1, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!42 = metadata !{i32 786443, metadata !1, metadata !40, i32 25, i32 22, i32 1, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!63 = metadata !{i32 786443, metadata !1, metadata !9, i32 54, i32 3, i32 1, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!82 = metadata !{i32 786443, metadata !1, metadata !83, i32 56, i32 19, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!83 = metadata !{i32 786443, metadata !1, metadata !65, i32 56, i32 9, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!84 = metadata !{i32 58, i32 11, metadata !85, null} ; [ DW_TAG_imported_module ]
!85 = metadata !{i32 786443, metadata !1, metadata !82, i32 58, i32 11, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!86 = metadata !{i32 64, i32 18, metadata !87, null}
!87 = metadata !{i32 786443, metadata !1, metadata !88, i32 64, i32 18, i32 1, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!88 = metadata !{i32 786443, metadata !1, metadata !65, i32 64, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!89 = metadata !{i32 65, i32 5, metadata !65, null}
!90 = metadata !{i32 66, i32 3, metadata !65, null}
!91 = metadata !{i32 67, i32 17, metadata !9, null}
