...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !37), !dbg !38
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !39), !dbg !43
...
main_bb6:                                         ; preds = %main_bb7, %main_wrap_around.exit, %main_bb5
  ...
  %"13" = icmp slt i64 %pkt.0, 10, !dbg !54
  br i1 %"13", label %main_bb7, label %main_bb12, !dbg !54
...
main_bb7:                                         ; preds = %main_wrap_around.exit, %main_bb6
  ...
  %"14" = icmp eq i64 %res.0, 0, !dbg !56
  br i1 %"14", label %main_bb8, label %main_bb6, !dbg !56

main_bb8:                                         ; preds = %main_bb7
  %"15" = call i64 @__VERIFIER_nondet_int(), !dbg !58
  %"16" = add nsw i64 %pkt.1, 1, !dbg !40
  %"17" = icmp sgt i64 %"16", 2147483647, !dbg !59
  br i1 %"17", label %main_bb9, label %main_bb10, !dbg !59
...
main_bb10:                                        ; preds = %main_bb8
  ...
  br i1 %"22", label %main_bb11, label %main_wrap_around.exit, !dbg !61
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb10, %main_bb11
  %.0.i = phi i64 [ %"21", %main_bb9 ], [ %"26", %main_bb11 ], [ %"16", %main_bb10 ], !dbg !40
  %"27" = icmp eq i64 %"15", 0, !dbg !63
  br i1 %"27", label %main_bb6, label %main_bb7, !dbg !63
...
!33 = metadata !{i32 20, i32 19, metadata !9, null}
...
!58 = metadata !{i32 24, i32 13, metadata !41, null}
!59 = metadata !{i32 9, i32 9, metadata !25, metadata !40}
!60 = metadata !{i32 10, i32 9, metadata !27, metadata !40}
!61 = metadata !{i32 12, i32 14, metadata !29, metadata !40}
!62 = metadata !{i32 13, i32 9, metadata !31, metadata !40}
!63 = metadata !{i32 26, i32 11, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !41, i32 26, i32 11, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
