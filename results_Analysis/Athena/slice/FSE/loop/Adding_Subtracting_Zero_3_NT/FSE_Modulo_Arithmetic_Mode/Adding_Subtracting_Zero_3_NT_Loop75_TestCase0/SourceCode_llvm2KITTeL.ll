...
main_bb21:
  ...
  br i1 %or.cond, label %main_bb48, label %main_wrap_around.exit2, !dbg !90

main_wrap_around.exit2:                           ; preds = %main_bb21, %main_bb47, %main_bb46, %main_bb45, %main_wrap_around.exit4
  %__fc_errno_0.0 = phi i64 [ %.0.i3, %main_wrap_around.exit4 ], [ %__fc_errno_0.0, %main_bb45 ], [ %__fc_errno_0.0, %main_bb46 ], [ %__fc_errno_0.0, %main_bb47 ], [ 0, %main_bb21 ]
  %pos.0 = phi i64 [ %pos.0, %main_wrap_around.exit4 ], [ %"127", %main_bb45 ], [ %"132", %main_bb47 ], [ %"122", %main_bb46 ], [ 0, %main_bb21 ]
  %"56" = icmp slt i64 %pos.0, %"53", !dbg !94
  br i1 %"56", label %main_bb22, label %main_bb48, !dbg !94
...
main_wrap_around.exit2.i:                         ; preds = %main_bb38, %main_bb37, %main_bb36, %main_wrap_around.exit
  ...
  %.0.i5 = phi i64 [ %pos.0, %main_wrap_around.exit ], [ %"103", %main_bb36 ], [ %"108", %main_bb38 ], [ %"98", %main_bb37 ], !dbg !103
  %"70" = icmp slt i64 %.0.i5, %.0.i, !dbg !104
...
main_read_slice_1.exit:                           ; preds = %main_wrap_around.exit, %main_wrap_around.exit2.i, %main_bb26, %main_bb39
  ...
  %"109" = icmp eq i64 %__retres.0.i, -1, !dbg !129
  br i1 %"109", label %main_bb40, label %main_bb44, !dbg !129

main_bb40:                                        ; preds = %main_read_slice_1.exit
  %"110" = add nsw i64 %__fc_errno_0.0, 1, !dbg !131
  %"111" = icmp sgt i64 %"110", 2147483647, !dbg !133
  br i1 %"111", label %main_bb41, label %main_bb42, !dbg !133

main_bb41:                                        ; preds = %main_bb40
  %"112" = sub nsw i64 %"110", 2147483647, !dbg !134
  %"113" = sub nsw i64 %"112", 1, !dbg !134
  %"114" = srem i64 %"113", 4294967296, !dbg !134
  %"115" = add nsw i64 -2147483648, %"114", !dbg !134
  br label %main_wrap_around.exit4, !dbg !134

main_bb42:                                        ; preds = %main_bb40
  %"116" = icmp slt i64 %"110", -2147483648, !dbg !135
  br i1 %"116", label %main_bb43, label %main_wrap_around.exit4, !dbg !135

main_bb43:                                        ; preds = %main_bb42
  %"117" = sub nsw i64 -2147483648, %"110", !dbg !136
  %"118" = sub nsw i64 %"117", 1, !dbg !136
  %"119" = srem i64 %"118", 4294967296, !dbg !136
  %"120" = sub nsw i64 2147483647, %"119", !dbg !136
  br label %main_wrap_around.exit4, !dbg !136

main_wrap_around.exit4:                           ; preds = %main_bb41, %main_bb42, %main_bb43
  %.0.i3 = phi i64 [ %"115", %main_bb41 ], [ %"120", %main_bb43 ], [ %"110", %main_bb42 ], !dbg !131
  %"121" = icmp eq i64 %.0.i3, 5, !dbg !137
  br i1 %"121", label %main_bb48, label %main_wrap_around.exit2, !dbg !137

main_bb44:                                        ; preds = %main_read_slice_1.exit
  %"122" = add nsw i64 %pos.0, %__retres.0.i, !dbg !139
  %"123" = icmp sgt i64 %"122", 2147483647, !dbg !140
  br i1 %"123", label %main_bb45, label %main_bb46, !dbg !140

main_bb45:                                        ; preds = %main_bb44
  %"124" = sub nsw i64 %"122", 2147483647, !dbg !141
  %"125" = sub nsw i64 %"124", 1, !dbg !141
  %"126" = srem i64 %"125", 4294967296, !dbg !141
  %"127" = add nsw i64 -2147483648, %"126", !dbg !141
  br label %main_wrap_around.exit2, !dbg !141

main_bb46:                                        ; preds = %main_bb44
  %"128" = icmp slt i64 %"122", -2147483648, !dbg !142
  br i1 %"128", label %main_bb47, label %main_wrap_around.exit2, !dbg !142

main_bb47:                                        ; preds = %main_bb46
  %"129" = sub nsw i64 -2147483648, %"122", !dbg !143
  %"130" = sub nsw i64 %"129", 1, !dbg !143
  %"131" = srem i64 %"130", 4294967296, !dbg !143
  %"132" = sub nsw i64 2147483647, %"131", !dbg !143
...
!95 = metadata !{i32 786443, metadata !1, metadata !12, i32 70, i32 3, i32 1, i32 25} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!129 = metadata !{i32 72, i32 9, metadata !130, null}
!130 = metadata !{i32 786443, metadata !1, metadata !97, i32 72, i32 9, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!131 = metadata !{i32 73, i32 23, metadata !132, null}
!132 = metadata !{i32 786443, metadata !1, metadata !130, i32 72, i32 19, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!133 = metadata !{i32 10, i32 9, metadata !30, metadata !131}
!134 = metadata !{i32 11, i32 9, metadata !32, metadata !131}
!135 = metadata !{i32 13, i32 14, metadata !34, metadata !131}
!136 = metadata !{i32 14, i32 9, metadata !36, metadata !131}
!137 = metadata !{i32 74, i32 11, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !132, i32 74, i32 11, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!139 = metadata !{i32 80, i32 11, metadata !97, null}
...
!144 = metadata !{i32 82, i32 17, metadata !12, null}
