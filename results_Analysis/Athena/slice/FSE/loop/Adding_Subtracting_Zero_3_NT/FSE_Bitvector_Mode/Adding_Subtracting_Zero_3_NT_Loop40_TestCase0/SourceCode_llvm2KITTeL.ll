...
main_bb6:
  ...
  br i1 %or.cond, label %main_bb15, label %main_bb7, !dbg !54

main_bb7:                                         ; preds = %main_bb6, %main_bb13, %main_bb14
  %__fc_errno_0.0 = phi i32 [ %__fc_errno_0.0, %main_bb14 ], [ %"24", %main_bb13 ], [ 0, %main_bb6 ]
  %pos.0 = phi i32 [ %"26", %main_bb14 ], [ %pos.0, %main_bb13 ], [ 0, %main_bb6 ]
  %"12" = icmp slt i32 %pos.0, %"9", !dbg !58
  br i1 %"12", label %main_bb8, label %main_bb15, !dbg !58
...
main_read_slice_1.exit:                           ; preds = %main_bb9, %main_bb10, %main_bb11
  ...
  %"23" = icmp eq i32 %__retres.0.i, -1, !dbg !75
  br i1 %"23", label %main_bb13, label %main_bb14, !dbg !75

main_bb13:                                        ; preds = %main_read_slice_1.exit
  %"24" = add nsw i32 %__fc_errno_0.0, 1, !dbg !77
  call void @llvm.dbg.value(metadata !{i32 %"24"}, i64 0, metadata !52), !dbg !53
  %"25" = icmp eq i32 %"24", 5, !dbg !79
  br i1 %"25", label %main_bb15, label %main_bb7, !dbg !79

main_bb14:                                        ; preds = %main_read_slice_1.exit
  %"26" = add nsw i32 %pos.0, %__retres.0.i, !dbg !81
  call void @llvm.dbg.value(metadata !{i32 %"26"}, i64 0, metadata !46), !dbg !47
  br label %main_bb7, !dbg !82

main_bb15:                                        ; preds = %main_bb7, %main_bb13, %main_bb6
  ret void, !dbg !83
}
...
!75 = metadata !{i32 44, i32 9, metadata !76, null}
!76 = metadata !{i32 786443, metadata !1, metadata !61, i32 44, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!77 = metadata !{i32 45, i32 7, metadata !78, null}
!78 = metadata !{i32 786443, metadata !1, metadata !76, i32 44, i32 19, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!79 = metadata !{i32 46, i32 11, metadata !80, null}
!80 = metadata !{i32 786443, metadata !1, metadata !78, i32 46, i32 11, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!81 = metadata !{i32 52, i32 5, metadata !61, null}
!82 = metadata !{i32 53, i32 3, metadata !61, null}
!83 = metadata !{i32 54, i32 17, metadata !9, null}
