...
main_bb6:
  ...
  br i1 %"10", label %main_bb13, label %main_bb7, !dbg !49

main_bb7:                                         ; preds = %main_bb6, %main_bb12
  %buf.0 = phi i32 [ %"23", %main_bb12 ], [ 0, %main_bb6 ]
  %count.0 = phi i32 [ %"22", %main_bb12 ], [ %"9", %main_bb6 ]
  %"11" = icmp sgt i32 %count.0, 0, !dbg !51
  br i1 %"11", label %main_bb8, label %main_bb13, !dbg !51
...
main_read_slice_1.exit:                           ; preds = %main_bb8, %main_bb9, %main_bb10
  ...
  %"21" = icmp slt i32 %__retres.0.i, 0, !dbg !67
  br i1 %"21", label %main_bb13, label %main_bb12, !dbg !67

main_bb12:                                        ; preds = %main_read_slice_1.exit
  %"22" = sub nsw i32 %count.0, %__retres.0.i, !dbg !69
  call void @llvm.dbg.value(metadata !{i32 %"22"}, i64 0, metadata !47), !dbg !48
  %"23" = add nsw i32 %buf.0, %__retres.0.i, !dbg !70
  call void @llvm.dbg.value(metadata !{i32 %"23"}, i64 0, metadata !71), !dbg !72
  br label %main_bb7, !dbg !73

main_bb13:                                        ; preds = %main_bb7, %main_read_slice_1.exit, %main_bb6
  ret void, !dbg !74
}
...
!67 = metadata !{i32 41, i32 9, metadata !68, null}
!68 = metadata !{i32 786443, metadata !1, metadata !54, i32 41, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 45, i32 5, metadata !54, null}
!70 = metadata !{i32 46, i32 5, metadata !54, null}
!71 = metadata !{i32 786688, metadata !9, metadata !"buf", metadata !5, i32 38, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [buf] [line 38]
!72 = metadata !{i32 38, i32 7, metadata !9, null}
!73 = metadata !{i32 47, i32 3, metadata !54, null}
!74 = metadata !{i32 48, i32 17, metadata !9, null}
