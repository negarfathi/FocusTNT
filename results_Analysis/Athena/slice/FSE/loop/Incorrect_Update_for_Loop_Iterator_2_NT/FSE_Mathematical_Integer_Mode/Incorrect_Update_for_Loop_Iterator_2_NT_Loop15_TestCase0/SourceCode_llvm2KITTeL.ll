...
main_bb0:
  ...
  call void @llvm.dbg.value(metadata !{i8 %"3"}, i64 0, metadata !18), !dbg !20
  call void @llvm.dbg.value(metadata !{i8 %"7"}, i64 0, metadata !12), !dbg !14
  br label %main_bb1, !dbg !21

main_bb1:                                         ; preds = %main_bb2, %main_bb0
  %l.0 = phi i8 [ %"0", %main_bb0 ], [ %"7", %main_bb2 ]
  %"1" = zext i8 %l.0 to i32, !dbg !22
  %"2" = sub nsw i32 %"1", 1, !dbg !22
  %"3" = trunc i32 %"2" to i8, !dbg !22
  %"4" = icmp ne i8 %l.0, 0, !dbg !23
  br i1 %"4", label %main_bb2, label %main_bb3, !dbg !23

main_bb2:                                         ; preds = %main_bb1
  %"5" = zext i8 %"3" to i32, !dbg !25
