...
main_bb5:                                         ; preds = %main_bb3
  ...
  br i1 %"16", label %main_bb9, label %main_bb6, !dbg !56

main_bb6:                                         ; preds = %main_bb5, %main_bb8
  %entry.0 = phi i32 [ %"23", %main_bb8 ], [ %"11", %main_bb5 ]
  %"17" = icmp sge i32 %entry.0, %"3", !dbg !58
  br i1 %"17", label %main_bb9, label %main_bb7, !dbg !58

main_bb7:                                         ; preds = %main_bb6
  %"18" = add nsw i32 %"9", %entry.0, !dbg !61
  %"19" = sext i32 %"18" to i64, !dbg !61
  %"20" = getelementptr inbounds [100000 x i32]* @memory0, i32 0, i64 %"19", !dbg !61
  %"21" = load i32* %"20", align 4, !dbg !61
  %"22" = icmp ne i32 %"21", 0, !dbg !61
  br i1 %"22", label %main_bb8, label %main_bb9, !dbg !61

main_bb8:                                         ; preds = %main_bb7
  %"23" = add nsw i32 %entry.0, 1, !dbg !63
