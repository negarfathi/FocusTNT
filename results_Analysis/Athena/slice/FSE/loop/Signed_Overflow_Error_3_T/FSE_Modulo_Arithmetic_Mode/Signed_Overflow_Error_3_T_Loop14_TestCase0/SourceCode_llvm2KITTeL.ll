...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !36), !dbg !39
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %number.0 = phi i64 [ %"12", %main_bb5 ], [ %"18", %main_bb7 ], [ %"23", %main_bb9 ], [ %"14", %main_bb8 ]
  %"13" = icmp sge i64 %number.0, 10, !dbg !50
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !50

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = sdiv i64 %number.0, 10, !dbg !37
  %"15" = icmp sgt i64 %"14", 4294967295, !dbg !52
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !52

main_bb7:                                         ; preds = %main_bb6
  %"16" = sub nsw i64 %"14", 4294967295, !dbg !53
  %"17" = sub nsw i64 %"16", 1, !dbg !53
  %"18" = srem i64 %"17", 4294967296, !dbg !53
  br label %main_wrap_around.exit, !dbg !53

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"14", 0, !dbg !54
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !54

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 0, %"14", !dbg !55
  %"21" = sub nsw i64 %"20", 1, !dbg !55
  %"22" = srem i64 %"21", 4294967296, !dbg !55
  %"23" = sub nsw i64 4294967295, %"22", !dbg !55
...
!33 = metadata !{i32 19, i32 22, metadata !9, null}
...
!40 = metadata !{i64 0}
!41 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !37} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!42 = metadata !{i32 7, i32 50, metadata !4, metadata !37}
!43 = metadata !{i64 4294967295}
!44 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !37} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!45 = metadata !{i32 7, i32 73, metadata !4, metadata !37}
!46 = metadata !{i64 4294967296}
!47 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !37} ; [ DW_TAG_auto_variable ] [range] [line 8]
!48 = metadata !{i32 8, i32 15, metadata !4, metadata !37} ; [ DW_TAG_imported_declaration ]
!49 = metadata !{i32 20, i32 3, metadata !9, null}
!50 = metadata !{i32 20, i32 3, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !9, i32 20, i32 3, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 9, i32 9, metadata !25, metadata !37}
!53 = metadata !{i32 10, i32 9, metadata !27, metadata !37}
!54 = metadata !{i32 12, i32 14, metadata !29, metadata !37}
!55 = metadata !{i32 13, i32 9, metadata !31, metadata !37}
!56 = metadata !{i32 23, i32 3, metadata !9, null}
