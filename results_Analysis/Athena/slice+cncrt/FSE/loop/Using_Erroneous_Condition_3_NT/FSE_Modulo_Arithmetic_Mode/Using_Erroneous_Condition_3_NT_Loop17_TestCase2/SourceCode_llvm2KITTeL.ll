...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"19"}, i64 0, metadata !46), !dbg !49
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"18" = icmp slt i64 %j.0, 9, !dbg !60
  br i1 %"18", label %main_bb6, label %main_bb10, !dbg !60

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"19" = add nsw i64 %j.0, 1, !dbg !47
  %"20" = icmp sgt i64 %"19", 2147483647, !dbg !62
  br i1 %"20", label %main_bb7, label %main_bb8, !dbg !62

main_bb7:                                         ; preds = %main_bb6
  %"21" = sub nsw i64 %"19", 2147483647, !dbg !63
  %"22" = sub nsw i64 %"21", 1, !dbg !63
  %"23" = srem i64 %"22", 4294967296, !dbg !63
  %"24" = add nsw i64 -2147483648, %"23", !dbg !63
  br label %main_wrap_around.exit, !dbg !63

main_bb8:                                         ; preds = %main_bb6
  %"25" = icmp slt i64 %"19", -2147483648, !dbg !64
  br i1 %"25", label %main_bb9, label %main_wrap_around.exit, !dbg !64

main_bb9:                                         ; preds = %main_bb8
  %"26" = sub nsw i64 -2147483648, %"19", !dbg !65
  %"27" = sub nsw i64 %"26", 1, !dbg !65
  %"28" = srem i64 %"27", 4294967296, !dbg !65
  %"29" = sub nsw i64 2147483647, %"28", !dbg !65
...
!42 = metadata !{i64 0}
!43 = metadata !{i32 786688, metadata !44, metadata !"j", metadata !5, i32 22, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [j] [line 22]
...
!48 = metadata !{i32 786443, metadata !1, metadata !44, i32 23, i32 19, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
