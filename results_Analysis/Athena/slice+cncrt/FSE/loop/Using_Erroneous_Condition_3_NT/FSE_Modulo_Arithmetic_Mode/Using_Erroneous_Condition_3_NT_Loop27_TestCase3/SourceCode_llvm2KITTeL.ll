...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !42, i64 0, metadata !47), !dbg !48
  call void @llvm.dbg.value(metadata !42, i64 0, metadata !49), !dbg !51
  call void @llvm.dbg.value(metadata !{i64 %"19"}, i64 0, metadata !52), !dbg !55
...
main_bb6:                                         ; preds = %main_wrap_around.exit
  %"19" = add nsw i64 %j.0, 1, !dbg !53
  %"20" = icmp sgt i64 %"19", 2147483647, !dbg !68
  br i1 %"20", label %main_bb7, label %main_bb8, !dbg !68

main_bb7:                                         ; preds = %main_bb6
  %"21" = sub nsw i64 %"19", 2147483647, !dbg !69
  %"22" = sub nsw i64 %"21", 1, !dbg !69
  %"23" = srem i64 %"22", 4294967296, !dbg !69
  %"24" = add nsw i64 -2147483648, %"23", !dbg !69
  br label %main_wrap_around.exit, !dbg !69

main_bb8:                                         ; preds = %main_bb6
  %"25" = icmp slt i64 %"19", -2147483648, !dbg !70
  br i1 %"25", label %main_bb9, label %main_wrap_around.exit, !dbg !70

main_bb9:                                         ; preds = %main_bb8
  %"26" = sub nsw i64 -2147483648, %"19", !dbg !71
  %"27" = sub nsw i64 %"26", 1, !dbg !71
  %"28" = srem i64 %"27", 4294967296, !dbg !71
  %"29" = sub nsw i64 2147483647, %"28", !dbg !71
  br label %main_wrap_around.exit, !dbg !71

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"30" = getelementptr inbounds [10 x i64]* %old_, i32 0, i64 9, !dbg !72
  store i64 0, i64* %"30", align 8, !dbg !72
  %"31" = getelementptr inbounds [10 x i64]* %new_, i32 0, i64 9, !dbg !73
  store i64 0, i64* %"31", align 8, !dbg !73
  call void @llvm.dbg.value(metadata !{i64 %base.0}, i64 0, metadata !74), !dbg !76
  call void @llvm.dbg.value(metadata !{i64 %"37"}, i64 0, metadata !77), !dbg !80
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !81), !dbg !82
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !83), !dbg !84
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !85), !dbg !86
  call void @llvm.dbg.value(metadata !{i64 %.0.i5}, i64 0, metadata !74), !dbg !76
...
main_wrap_around.exit2:                           ; preds = %main_bb23, %main_bb22, %main_bb21, %main_bb10
  ...
  %"32" = getelementptr inbounds [10 x i64]* %old_, i32 0, i64 %i.0, !dbg !88
  %"33" = load i64* %"32", align 8, !dbg !88
  %"34" = getelementptr inbounds [10 x i64]* %new_, i32 0, i64 %i.0, !dbg !88
  %"35" = load i64* %"34", align 8, !dbg !88
...
main_bb11:                                        ; preds = %main_wrap_around.exit6, %main_wrap_around.exit2
  ...
  %"36" = icmp ne i64 %"33", %"35", !dbg !88
  br i1 %"36", label %main_bb12, label %main_bb17, !dbg !88

main_bb12:                                        ; preds = %main_bb11
  %"37" = add nsw i64 %number.0, 1, !dbg !78
  %"38" = icmp sgt i64 %"37", 2147483647, !dbg !91
  br i1 %"38", label %main_bb13, label %main_bb14, !dbg !91

main_bb13:                                        ; preds = %main_bb12
  %"39" = sub nsw i64 %"37", 2147483647, !dbg !92
  %"40" = sub nsw i64 %"39", 1, !dbg !92
  %"41" = srem i64 %"40", 4294967296, !dbg !92
  %"42" = add nsw i64 -2147483648, %"41", !dbg !92
  br label %main_wrap_around.exit6, !dbg !92

main_bb14:                                        ; preds = %main_bb12
  %"43" = icmp slt i64 %"37", -2147483648, !dbg !93
  br i1 %"43", label %main_bb15, label %main_wrap_around.exit6, !dbg !93

main_bb15:                                        ; preds = %main_bb14
  %"44" = sub nsw i64 -2147483648, %"37", !dbg !94
  %"45" = sub nsw i64 %"44", 1, !dbg !94
  %"46" = srem i64 %"45", 4294967296, !dbg !94
  %"47" = sub nsw i64 2147483647, %"46", !dbg !94
  br label %main_wrap_around.exit6, !dbg !94

main_wrap_around.exit6:                           ; preds = %main_bb13, %main_bb14, %main_bb15
  %.0.i5 = phi i64 [ %"42", %main_bb13 ], [ %"47", %main_bb15 ], [ %"37", %main_bb14 ], !dbg !78
  %"48" = icmp eq i64 %.0.i5, 0, !dbg !95
  br i1 %"48", label %main_bb16, label %main_bb11, !dbg !95
...
!47 = metadata !{i32 786688, metadata !9, metadata !"count", metadata !5, i32 23, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [count] [line 23]
!48 = metadata !{i32 23, i32 13, metadata !9, null}
!49 = metadata !{i32 786688, metadata !50, metadata !"j", metadata !5, i32 25, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [j] [line 25]
!50 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 3, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!51 = metadata !{i32 25, i32 15, metadata !50, null}
!52 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !53} ; [ DW_TAG_arg_variable ] [value] [line 7]
!53 = metadata !{i32 29, i32 12, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !50, i32 26, i32 19, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 7, i32 33, metadata !4, metadata !53}
...
!60 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !53} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!61 = metadata !{i32 7, i32 73, metadata !4, metadata !53}
!62 = metadata !{i64 4294967296}
!63 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !53} ; [ DW_TAG_auto_variable ] [range] [line 8]
!64 = metadata !{i32 8, i32 15, metadata !4, metadata !53} ; [ DW_TAG_imported_declaration ]
!65 = metadata !{i32 26, i32 5, metadata !50, null}
!66 = metadata !{i32 26, i32 5, metadata !67, null}
!67 = metadata !{i32 786443, metadata !1, metadata !50, i32 26, i32 5, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!68 = metadata !{i32 9, i32 9, metadata !25, metadata !53}
!69 = metadata !{i32 10, i32 9, metadata !27, metadata !53}
!70 = metadata !{i32 12, i32 14, metadata !29, metadata !53}
!71 = metadata !{i32 13, i32 9, metadata !31, metadata !53}
!72 = metadata !{i32 32, i32 3, metadata !9, null}
!73 = metadata !{i32 33, i32 3, metadata !9, null}
!74 = metadata !{i32 786688, metadata !75, metadata !"number", metadata !5, i32 35, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [number] [line 35]
!75 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 13, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 35, i32 15, metadata !75, null}
!77 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !78} ; [ DW_TAG_arg_variable ] [value] [line 7]
!78 = metadata !{i32 37, i32 17, metadata !79, null}
!79 = metadata !{i32 786443, metadata !1, metadata !75, i32 36, i32 32, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!80 = metadata !{i32 7, i32 33, metadata !4, metadata !78}
!81 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !78} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!82 = metadata !{i32 7, i32 50, metadata !4, metadata !78}
!83 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !78} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!84 = metadata !{i32 7, i32 73, metadata !4, metadata !78}
!85 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !78} ; [ DW_TAG_auto_variable ] [range] [line 8]
!86 = metadata !{i32 8, i32 15, metadata !4, metadata !78} ; [ DW_TAG_imported_declaration ]
!87 = metadata !{i32 34, i32 3, metadata !9, null}
!88 = metadata !{i32 36, i32 5, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !75, i32 36, i32 5, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!90 = metadata !{i32 36, i32 5, metadata !75, null}
!91 = metadata !{i32 9, i32 9, metadata !25, metadata !78}
!92 = metadata !{i32 10, i32 9, metadata !27, metadata !78}
!93 = metadata !{i32 12, i32 14, metadata !29, metadata !78}
!94 = metadata !{i32 13, i32 9, metadata !31, metadata !78}
!95 = metadata !{i32 38, i32 11, metadata !96, null}
!96 = metadata !{i32 786443, metadata !1, metadata !79, i32 38, i32 11, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!97 = metadata !{i32 48, i32 3, metadata !9, null}
!98 = metadata !{i32 44, i32 10, metadata !75, null}
!99 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !98} ; [ DW_TAG_arg_variable ] [value] [line 7]
!100 = metadata !{i32 7, i32 33, metadata !4, metadata !98}
!101 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !98} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!102 = metadata !{i32 7, i32 50, metadata !4, metadata !98}
!103 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !98} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!104 = metadata !{i32 7, i32 73, metadata !4, metadata !98}
!105 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !98} ; [ DW_TAG_auto_variable ] [range] [line 8]
!106 = metadata !{i32 8, i32 15, metadata !4, metadata !98} ; [ DW_TAG_imported_declaration ]
!107 = metadata !{i32 9, i32 9, metadata !25, metadata !98}
!108 = metadata !{i32 10, i32 9, metadata !27, metadata !98}
!109 = metadata !{i32 12, i32 14, metadata !29, metadata !98}
!110 = metadata !{i32 13, i32 9, metadata !31, metadata !98}
!111 = metadata !{i32 45, i32 12, metadata !75, null}
!112 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !111} ; [ DW_TAG_arg_variable ] [value] [line 7]
!113 = metadata !{i32 7, i32 33, metadata !4, metadata !111}
!114 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !111} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!115 = metadata !{i32 7, i32 50, metadata !4, metadata !111}
!116 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !111} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!117 = metadata !{i32 7, i32 73, metadata !4, metadata !111}
!118 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !111} ; [ DW_TAG_auto_variable ] [range] [line 8]
!119 = metadata !{i32 8, i32 15, metadata !4, metadata !111} ; [ DW_TAG_imported_declaration ]
!120 = metadata !{i32 9, i32 9, metadata !25, metadata !111}
!121 = metadata !{i32 10, i32 9, metadata !27, metadata !111}
!122 = metadata !{i32 12, i32 14, metadata !29, metadata !111}
!123 = metadata !{i32 13, i32 9, metadata !31, metadata !111}
