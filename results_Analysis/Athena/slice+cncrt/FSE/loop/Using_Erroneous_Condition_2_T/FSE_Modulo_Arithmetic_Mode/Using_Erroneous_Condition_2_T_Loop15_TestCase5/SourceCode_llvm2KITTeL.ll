...
main_bb5:
  ...
  %"12" = icmp sgt i64 999999, 65534, !dbg !36
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"13" = icmp slt i64 %i.0, 999999, !dbg !38
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !38

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = add nsw i64 %i.0, 1, !dbg !41
  %"15" = icmp sgt i64 %"14", 2147483647, !dbg !43
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !43

main_bb7:                                         ; preds = %main_bb6
  %"16" = sub nsw i64 %"14", 2147483647, !dbg !44
  %"17" = sub nsw i64 %"16", 1, !dbg !44
  %"18" = srem i64 %"17", 4294967296, !dbg !44
  %"19" = add nsw i64 -2147483648, %"18", !dbg !44
  br label %main_wrap_around.exit, !dbg !44

main_bb8:                                         ; preds = %main_bb6
  %"20" = icmp slt i64 %"14", -2147483648, !dbg !45
  br i1 %"20", label %main_bb9, label %main_wrap_around.exit, !dbg !45

main_bb9:                                         ; preds = %main_bb8
  %"21" = sub nsw i64 -2147483648, %"14", !dbg !46
  %"22" = sub nsw i64 %"21", 1, !dbg !46
  %"23" = srem i64 %"22", 4294967296, !dbg !46
  %"24" = sub nsw i64 2147483647, %"23", !dbg !46
