...
main_bb5:
  ...
  %"12" = icmp sgt i64 100000, 65534, !dbg !36
  br i1 %"12", label %main_bb14, label %main_wrap_around.exit2, !dbg !36

main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  %i.0 = phi i64 [ 0, %main_bb5 ], [ %"29", %main_bb11 ], [ %"34", %main_bb13 ], [ %"15", %main_bb12 ]
  %"13" = icmp slt i64 %i.0, 100000, !dbg !38
  br i1 %"13", label %main_wrap_around.exit, label %main_bb14, !dbg !38

main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  %i.1 = phi i64 [ 0, %main_wrap_around.exit2 ], [ %"20", %main_bb7 ], [ %"25", %main_bb9 ], [ %"15", %main_bb8 ]
  %"14" = icmp slt i64 %i.1, 3, !dbg !40
  %"15" = add nsw i64 %i.1, 1, !dbg !43
  %"16" = icmp sgt i64 %"15", 2147483647, !dbg !45
  br i1 %"14", label %main_bb6, label %main_bb10, !dbg !40

main_bb6:                                         ; preds = %main_wrap_around.exit
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !45

main_bb7:                                         ; preds = %main_bb6
  %"17" = sub nsw i64 %"15", 2147483647, !dbg !46
  %"18" = sub nsw i64 %"17", 1, !dbg !46
  %"19" = srem i64 %"18", 4294967296, !dbg !46
  %"20" = add nsw i64 -2147483648, %"19", !dbg !46
  br label %main_wrap_around.exit, !dbg !46

main_bb8:                                         ; preds = %main_bb6
  %"21" = icmp slt i64 %"15", -2147483648, !dbg !47
  br i1 %"21", label %main_bb9, label %main_wrap_around.exit, !dbg !47

main_bb9:                                         ; preds = %main_bb8
  %"22" = sub nsw i64 -2147483648, %"15", !dbg !48
  %"23" = sub nsw i64 %"22", 1, !dbg !48
  %"24" = srem i64 %"23", 4294967296, !dbg !48
  %"25" = sub nsw i64 2147483647, %"24", !dbg !48
  br label %main_wrap_around.exit, !dbg !48

main_bb10:                                        ; preds = %main_wrap_around.exit
  call void @llvm.dbg.value(metadata !{i64 %"15"}, i64 0, metadata !49), !dbg !51
  ...
  br i1 %"16", label %main_bb11, label %main_bb12, !dbg !61

main_bb11:                                        ; preds = %main_bb10
  %"26" = sub nsw i64 %"15", 2147483647, !dbg !62
  %"27" = sub nsw i64 %"26", 1, !dbg !62
  %"28" = srem i64 %"27", 4294967296, !dbg !62
  %"29" = add nsw i64 -2147483648, %"28", !dbg !62
  br label %main_wrap_around.exit2, !dbg !62

main_bb12:                                        ; preds = %main_bb10
  %"30" = icmp slt i64 %"15", -2147483648, !dbg !63
  br i1 %"30", label %main_bb13, label %main_wrap_around.exit2, !dbg !63

main_bb13:                                        ; preds = %main_bb12
  %"31" = sub nsw i64 -2147483648, %"15", !dbg !64
  %"32" = sub nsw i64 %"31", 1, !dbg !64
  %"33" = srem i64 %"32", 4294967296, !dbg !64
  %"34" = sub nsw i64 2147483647, %"33", !dbg !64
...
!33 = metadata !{i64 100000}
!34 = metadata !{i32 786688, metadata !9, metadata !"num", metadata !5, i32 21, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num] [line 21]
!35 = metadata !{i32 21, i32 13, metadata !9, null}
!36 = metadata !{i32 22, i32 7, metadata !37, null}
!37 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 7, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!38 = metadata !{i32 27, i32 3, metadata !39, null}
!39 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 3, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!40 = metadata !{i32 29, i32 5, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !42, i32 29, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 19, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 30, i32 8, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !42, i32 30, i32 1, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 9, i32 9, metadata !25, metadata !43}
!46 = metadata !{i32 10, i32 9, metadata !27, metadata !43}
!47 = metadata !{i32 12, i32 14, metadata !29, metadata !43}
!48 = metadata !{i32 13, i32 9, metadata !31, metadata !43}
...
!50 = metadata !{i32 32, i32 10, metadata !42, null}
!51 = metadata !{i32 7, i32 33, metadata !4, metadata !50}
!52 = metadata !{i64 -2147483648}
!53 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !50} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!54 = metadata !{i32 7, i32 50, metadata !4, metadata !50}
!55 = metadata !{i64 2147483647}
!56 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !50} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!57 = metadata !{i32 7, i32 73, metadata !4, metadata !50}
!58 = metadata !{i64 4294967296}
!59 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !50} ; [ DW_TAG_auto_variable ] [range] [line 8]
!60 = metadata !{i32 8, i32 15, metadata !4, metadata !50} ; [ DW_TAG_imported_declaration ]
!61 = metadata !{i32 9, i32 9, metadata !25, metadata !50}
!62 = metadata !{i32 10, i32 9, metadata !27, metadata !50}
!63 = metadata !{i32 12, i32 14, metadata !29, metadata !50}
!64 = metadata !{i32 13, i32 9, metadata !31, metadata !50}
!65 = metadata !{i32 34, i32 17, metadata !9, null}
