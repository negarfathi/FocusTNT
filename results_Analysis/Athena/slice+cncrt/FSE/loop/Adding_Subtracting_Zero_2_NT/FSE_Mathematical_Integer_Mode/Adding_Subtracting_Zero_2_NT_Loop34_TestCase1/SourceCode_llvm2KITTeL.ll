...
main_bb5:
  ...
  %"6" = icmp slt i32 -1, 0, !dbg !42
  %"7" = icmp slt i32 10, 0, !dbg !44
  %or.cond = or i1 %"6", %"7", !dbg !42
  br i1 %or.cond, label %main_bb8, label %main_bb6, !dbg !42

main_bb6:                                         ; preds = %main_bb5
  call void @llvm.dbg.value(metadata !17, i64 0, metadata !46), !dbg !49
  call void @llvm.dbg.value(metadata !17, i64 0, metadata !46), !dbg !49
  %"8" = load i32* @"'flag", align 4, !dbg !50
  call void @llvm.dbg.value(metadata !{i32 %.}, i64 0, metadata !51), !dbg !52
  call void @llvm.dbg.value(metadata !{i32 %"11"}, i64 0, metadata !37), !dbg !38
  call void @llvm.dbg.value(metadata !53, i64 0, metadata !54), !dbg !55
  br label %main_bb7, !dbg !56

main_bb7:                                         ; preds = %main_ff_subtitles_next_line_slice_1.exit, %main_bb6
  %b.0 = phi i32 [ -1, %main_bb6 ], [ %"11", %main_ff_subtitles_next_line_slice_1.exit ]
  %"9" = icmp slt i32 %b.0, 10, !dbg !57
  br i1 %"9", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb8, !dbg !57

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb7
  %"10" = icmp eq i32 %"8", 1, !dbg !50
  %. = select i1 %"10", i32 0, i32 5, !dbg !50
  %"11" = add nsw i32 %b.0, %., !dbg !59
  %"12" = sub nsw i32 10, 4, !dbg !60
  %"13" = icmp sge i32 %"11", %"12", !dbg !60
  br i1 %"13", label %main_bb8, label %main_bb7, !dbg !60

main_bb8:                                         ; preds = %main_bb7, %main_ff_subtitles_next_line_slice_1.exit, %main_bb5
  ret void, !dbg !62
}
...
!49 = metadata !{i32 9, i32 7, metadata !4, metadata !47}
!50 = metadata !{i32 11, i32 7, metadata !22, metadata !47}
!51 = metadata !{i32 786688, metadata !48, metadata !"tmp_1", metadata !5, i32 39, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp_1] [line 39]
!52 = metadata !{i32 39, i32 9, metadata !48, null}
!53 = metadata !{i32 -5}
!54 = metadata !{i32 786688, metadata !4, metadata !"__retres", metadata !5, i32 8, metadata !8, i32 0, metadata !47} ; [ DW_TAG_auto_variable ] [__retres] [line 8]
!55 = metadata !{i32 8, i32 7, metadata !4, metadata !47} ; [ DW_TAG_imported_declaration ]
!56 = metadata !{i32 38, i32 3, metadata !9, null}
!57 = metadata !{i32 38, i32 3, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !9, i32 38, i32 3, i32 1, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 41, i32 5, metadata !48, null}
!60 = metadata !{i32 42, i32 9, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !48, i32 42, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 48, i32 17, metadata !9, null}
