...
main_bb13:
  ...
  %"28" = icmp slt i64 1, 0, !dbg !85
  %"29" = icmp slt i64 100, 0, !dbg !87
...
main_bb14:                                        ; preds = %main_bb13, %main_wrap_around.exit
  %b.0 = phi i64 [ %.0.i1, %main_wrap_around.exit ], [ 1, %main_bb13 ]
  %"30" = icmp slt i64 %b.0, 100, !dbg !89
  br i1 %"30", label %main_bb15, label %main_bb23, !dbg !89
...
main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb15, %main_bb16
  %"33" = add nsw i64 %b.0, 0, !dbg !96
  %"34" = icmp sgt i64 %"33", 2147483647, !dbg !97
  br i1 %"34", label %main_bb17, label %main_bb18, !dbg !97

main_bb17:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"35" = sub nsw i64 %"33", 2147483647, !dbg !98
  %"36" = sub nsw i64 %"35", 1, !dbg !98
  %"37" = srem i64 %"36", 4294967296, !dbg !98
  %"38" = add nsw i64 -2147483648, %"37", !dbg !98
  br label %main_wrap_around.exit2, !dbg !98

main_bb18:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"39" = icmp slt i64 %"33", -2147483648, !dbg !99
  br i1 %"39", label %main_bb19, label %main_wrap_around.exit2, !dbg !99

main_bb19:                                        ; preds = %main_bb18
  %"40" = sub nsw i64 -2147483648, %"33", !dbg !100
  %"41" = sub nsw i64 %"40", 1, !dbg !100
  %"42" = srem i64 %"41", 4294967296, !dbg !100
  %"43" = sub nsw i64 2147483647, %"42", !dbg !100
...
main_wrap_around.exit2:                           ; preds = %main_bb17, %main_bb18, %main_bb19
  ...
  %"44" = sub nsw i64 100, 4, !dbg !101
  %"45" = icmp sgt i64 %"44", 2147483647, !dbg !103
  br i1 %"45", label %main_bb20, label %main_bb21, !dbg !103

main_bb20:                                        ; preds = %main_wrap_around.exit2
  %"46" = sub nsw i64 %"44", 2147483647, !dbg !104
  %"47" = sub nsw i64 %"46", 1, !dbg !104
  %"48" = srem i64 %"47", 4294967296, !dbg !104
  %"49" = add nsw i64 -2147483648, %"48", !dbg !104
  br label %main_wrap_around.exit, !dbg !104

main_bb21:                                        ; preds = %main_wrap_around.exit2
  %"50" = icmp slt i64 %"44", -2147483648, !dbg !105
  br i1 %"50", label %main_bb22, label %main_wrap_around.exit, !dbg !105

main_bb22:                                        ; preds = %main_bb21
  %"51" = sub nsw i64 -2147483648, %"44", !dbg !106
  %"52" = sub nsw i64 %"51", 1, !dbg !106
  %"53" = srem i64 %"52", 4294967296, !dbg !106
  %"54" = sub nsw i64 2147483647, %"53", !dbg !106
  br label %main_wrap_around.exit, !dbg !106

main_wrap_around.exit:                            ; preds = %main_bb20, %main_bb21, %main_bb22
  %.0.i = phi i64 [ %"49", %main_bb20 ], [ %"54", %main_bb22 ], [ %"44", %main_bb21 ], !dbg !101
  %"55" = icmp sge i64 %.0.i1, %.0.i, !dbg !101
  br i1 %"55", label %main_bb23, label %main_bb14, !dbg !101
...
!90 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 3, i32 1, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!91 = metadata !{i32 23, i32 7, metadata !54, metadata !92}
!92 = metadata !{i32 54, i32 13, metadata !93, null}
...
!96 = metadata !{i32 55, i32 9, metadata !93, null}
...
!101 = metadata !{i32 56, i32 14, metadata !102, null}
!102 = metadata !{i32 786443, metadata !1, metadata !93, i32 56, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!103 = metadata !{i32 10, i32 9, metadata !30, metadata !101}
!104 = metadata !{i32 11, i32 9, metadata !32, metadata !101}
!105 = metadata !{i32 13, i32 14, metadata !34, metadata !101}
!106 = metadata !{i32 14, i32 9, metadata !36, metadata !101}
!107 = metadata !{i32 62, i32 17, metadata !12, null}
