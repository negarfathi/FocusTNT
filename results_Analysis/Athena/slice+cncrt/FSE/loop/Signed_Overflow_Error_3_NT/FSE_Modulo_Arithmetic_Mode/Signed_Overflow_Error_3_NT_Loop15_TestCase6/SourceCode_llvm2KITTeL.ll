...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  ...
  %"12" = icmp sle i64 %i.0, 2147483647, !dbg !52
...
!52 = metadata !{i32 22, i32 3, metadata !53, null}
!53 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 3, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!58 = metadata !{i32 25, i32 3, metadata !9, null}
