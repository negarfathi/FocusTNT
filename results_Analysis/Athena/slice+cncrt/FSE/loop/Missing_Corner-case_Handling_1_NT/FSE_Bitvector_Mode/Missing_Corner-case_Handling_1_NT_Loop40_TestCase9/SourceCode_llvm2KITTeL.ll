...
define void @main() #0 {
main_bb6:
  %"9" = load i32* @"'count", align 4, !dbg !40
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !42), !dbg !43
  call void @llvm.dbg.value(metadata !22, i64 0, metadata !44), !dbg !45
  call void @llvm.dbg.value(metadata !22, i64 0, metadata !44), !dbg !45
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !46), !dbg !47
...
main_bb7:                                         ; preds = %main_read_slice_1.exit, %main_bb6
  ...
  %"12" = icmp sgt i32 %"9", 100, !dbg !50
  %or.cond.i = or i1 %"11", %"12", !dbg !49
  br i1 %or.cond.i, label %main_read_slice_1.exit, label %main_bb8, !dbg !49

main_bb8:                                         ; preds = %main_bb7
  store i32 1, i32* @"'flag", align 4, !dbg !51
  br label %main_read_slice_1.exit, !dbg !40

main_read_slice_1.exit:                           ; preds = %main_bb7, %main_bb8
  %"13" = icmp slt i32 0, 0, !dbg !52
  br i1 %"13", label %main_bb9, label %main_bb7, !dbg !52
...
!40 = metadata !{i32 39, i32 11, metadata !41, null}
...
!42 = metadata !{i32 786688, metadata !41, metadata !"tmp", metadata !5, i32 38, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp] [line 38]
!43 = metadata !{i32 38, i32 9, metadata !41, null}
!44 = metadata !{i32 786688, metadata !4, metadata !"num", metadata !5, i32 19, metadata !8, i32 0, metadata !40} ; [ DW_TAG_auto_variable ] [num] [line 19]
!45 = metadata !{i32 19, i32 7, metadata !4, metadata !40}
!46 = metadata !{i32 786688, metadata !4, metadata !"__retres", metadata !5, i32 9, metadata !8, i32 0, metadata !40} ; [ DW_TAG_auto_variable ] [__retres] [line 9]
!47 = metadata !{i32 9, i32 7, metadata !4, metadata !40}
!48 = metadata !{i32 37, i32 3, metadata !9, null}
!49 = metadata !{i32 10, i32 7, metadata !19, metadata !40}
!50 = metadata !{i32 15, i32 9, metadata !21, metadata !40}
!51 = metadata !{i32 28, i32 7, metadata !37, metadata !40}
!52 = metadata !{i32 40, i32 9, metadata !53, null}
!53 = metadata !{i32 786443, metadata !1, metadata !41, i32 40, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 45, i32 3, metadata !9, null}
