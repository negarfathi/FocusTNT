...
main_bb5:
  ...
  br i1 %or.cond, label %main_bb9, label %main_bb6, !dbg !42
...
main_bb7:                                         ; preds = %main_bb8, %main_bb6
  %b.0 = phi i32 [ -1, %main_bb6 ], [ %"12", %main_bb8 ]
  %"9" = icmp slt i32 %b.0, 10, !dbg !57
  br i1 %"9", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb9, !dbg !57

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb7
  %"10" = icmp eq i32 %"8", 1, !dbg !50
  %. = select i1 %"10", i32 0, i32 5, !dbg !50
  %"11" = icmp ne i32 %., 0, !dbg !59
  br i1 %"11", label %main_bb8, label %main_bb9, !dbg !59

main_bb8:                                         ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"12" = add nsw i32 %b.0, %., !dbg !61
  %"13" = sub nsw i32 10, 4, !dbg !62
  %"14" = icmp sge i32 %"12", %"13", !dbg !62
  br i1 %"14", label %main_bb9, label %main_bb7, !dbg !62
...
!51 = metadata !{i32 786688, metadata !48, metadata !"inc", metadata !5, i32 39, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [inc] [line 39]
...
!58 = metadata !{i32 786443, metadata !1, metadata !9, i32 38, i32 3, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 40, i32 9, metadata !60, null}
!60 = metadata !{i32 786443, metadata !1, metadata !48, i32 40, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!61 = metadata !{i32 44, i32 5, metadata !48, null}
!62 = metadata !{i32 45, i32 9, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !48, i32 45, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 51, i32 17, metadata !9, null}
