...
define void @main() #0 {
main_bb13:
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !79), !dbg !80
  ...
  br i1 %or.cond, label %main_bb24, label %main_bb14, !dbg !84

main_bb14:                                        ; preds = %main_bb13, %main_wrap_around.exit
  %b.0 = phi i64 [ %.0.i1, %main_wrap_around.exit ], [ 0, %main_bb13 ]
  %"30" = icmp slt i64 %b.0, 10, !dbg !88
  br i1 %"30", label %main_bb15, label %main_bb24, !dbg !88

main_bb15:                                        ; preds = %main_bb14
  %"31" = load i64* @"'flag", align 8, !dbg !90
  %"32" = icmp eq i64 %"31", 1, !dbg !90
  br i1 %"32", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb16, !dbg !90

main_bb16:                                        ; preds = %main_bb15
  store i64 1, i64* @"'flag", align 8, !dbg !93
  br label %main_ff_subtitles_next_line_slice_1.exit, !dbg !94

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb15, %main_bb16
  %"33" = icmp ne i64 0, 0, !dbg !95
  br i1 %"33", label %main_bb17, label %main_bb24, !dbg !95

main_bb17:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"34" = add nsw i64 %b.0, 0, !dbg !97
  %"35" = icmp sgt i64 %"34", 2147483647, !dbg !98
  br i1 %"35", label %main_bb18, label %main_bb19, !dbg !98

main_bb18:                                        ; preds = %main_bb17
  %"36" = sub nsw i64 %"34", 2147483647, !dbg !99
  %"37" = sub nsw i64 %"36", 1, !dbg !99
  %"38" = srem i64 %"37", 4294967296, !dbg !99
  %"39" = add nsw i64 -2147483648, %"38", !dbg !99
  br label %main_wrap_around.exit2, !dbg !99

main_bb19:                                        ; preds = %main_bb17
  %"40" = icmp slt i64 %"34", -2147483648, !dbg !100
  br i1 %"40", label %main_bb20, label %main_wrap_around.exit2, !dbg !100

main_bb20:                                        ; preds = %main_bb19
  %"41" = sub nsw i64 -2147483648, %"34", !dbg !101
  %"42" = sub nsw i64 %"41", 1, !dbg !101
  %"43" = srem i64 %"42", 4294967296, !dbg !101
  %"44" = sub nsw i64 2147483647, %"43", !dbg !101
  br label %main_wrap_around.exit2, !dbg !101

main_wrap_around.exit2:                           ; preds = %main_bb18, %main_bb19, %main_bb20
  %.0.i1 = phi i64 [ %"39", %main_bb18 ], [ %"44", %main_bb20 ], [ %"34", %main_bb19 ], !dbg !97
  %"45" = sub nsw i64 10, 4, !dbg !102
  %"46" = icmp sgt i64 %"45", 2147483647, !dbg !104
  br i1 %"46", label %main_bb21, label %main_bb22, !dbg !104

main_bb21:                                        ; preds = %main_wrap_around.exit2
  %"47" = sub nsw i64 %"45", 2147483647, !dbg !105
  %"48" = sub nsw i64 %"47", 1, !dbg !105
  %"49" = srem i64 %"48", 4294967296, !dbg !105
  %"50" = add nsw i64 -2147483648, %"49", !dbg !105
  br label %main_wrap_around.exit, !dbg !105

main_bb22:                                        ; preds = %main_wrap_around.exit2
  %"51" = icmp slt i64 %"45", -2147483648, !dbg !106
  br i1 %"51", label %main_bb23, label %main_wrap_around.exit, !dbg !106

main_bb23:                                        ; preds = %main_bb22
  %"52" = sub nsw i64 -2147483648, %"45", !dbg !107
  %"53" = sub nsw i64 %"52", 1, !dbg !107
  %"54" = srem i64 %"53", 4294967296, !dbg !107
  %"55" = sub nsw i64 2147483647, %"54", !dbg !107
  br label %main_wrap_around.exit, !dbg !107

main_wrap_around.exit:                            ; preds = %main_bb21, %main_bb22, %main_bb23
  %.0.i = phi i64 [ %"50", %main_bb21 ], [ %"55", %main_bb23 ], [ %"45", %main_bb22 ], !dbg !102
  %"56" = icmp sge i64 %.0.i1, %.0.i, !dbg !102
  br i1 %"56", label %main_bb24, label %main_bb14, !dbg !102
...
!79 = metadata !{i32 786688, metadata !12, metadata !"b", metadata !5, i32 41, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [b] [line 41]
!80 = metadata !{i32 41, i32 13, metadata !12, null}
!81 = metadata !{i64 10}
!82 = metadata !{i32 786688, metadata !12, metadata !"end", metadata !5, i32 42, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [end] [line 42]
!83 = metadata !{i32 42, i32 13, metadata !12, null}
!84 = metadata !{i32 43, i32 7, metadata !85, null}
!85 = metadata !{i32 786443, metadata !1, metadata !12, i32 43, i32 7, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!86 = metadata !{i32 48, i32 9, metadata !87, null}
!87 = metadata !{i32 786443, metadata !1, metadata !85, i32 48, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!88 = metadata !{i32 52, i32 3, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 3, i32 1, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!90 = metadata !{i32 23, i32 7, metadata !54, metadata !91}
!91 = metadata !{i32 53, i32 21, metadata !92, null}
...
!93 = metadata !{i32 28, i32 5, metadata !58, metadata !91}
!94 = metadata !{i32 30, i32 3, metadata !58, metadata !91}
!95 = metadata !{i32 54, i32 9, metadata !96, null}
!96 = metadata !{i32 786443, metadata !1, metadata !92, i32 54, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!97 = metadata !{i32 58, i32 9, metadata !92, null} ; [ DW_TAG_imported_module ]
!98 = metadata !{i32 10, i32 9, metadata !30, metadata !97}
!99 = metadata !{i32 11, i32 9, metadata !32, metadata !97}
!100 = metadata !{i32 13, i32 14, metadata !34, metadata !97}
!101 = metadata !{i32 14, i32 9, metadata !36, metadata !97}
!102 = metadata !{i32 59, i32 14, metadata !103, null}
!103 = metadata !{i32 786443, metadata !1, metadata !92, i32 59, i32 9, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!104 = metadata !{i32 10, i32 9, metadata !30, metadata !102}
!105 = metadata !{i32 11, i32 9, metadata !32, metadata !102}
!106 = metadata !{i32 13, i32 14, metadata !34, metadata !102}
!107 = metadata !{i32 14, i32 9, metadata !36, metadata !102}
!108 = metadata !{i32 65, i32 17, metadata !12, null}
