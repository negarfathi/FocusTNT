...
main_bb15:                                        ; preds = %main_wrap_around.exit, %main_bb14
  ...
  br i1 %"31", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb23, !dbg !135

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb15
  %"32" = icmp eq i64 %"30", 1, !dbg !102
  %. = select i1 %"32", i64 0, i64 3, !dbg !102
  %"33" = icmp ne i64 %., 0, !dbg !137
  br i1 %"33", label %main_bb16, label %main_bb23, !dbg !137

main_bb16:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"34" = add nsw i64 %b.0, %., !dbg !106
  %"35" = icmp sgt i64 %"34", 2147483647, !dbg !139
  br i1 %"35", label %main_bb17, label %main_bb18, !dbg !139

main_bb17:                                        ; preds = %main_bb16
  %"36" = sub nsw i64 %"34", 2147483647, !dbg !140
  %"37" = sub nsw i64 %"36", 1, !dbg !140
  %"38" = srem i64 %"37", 4294967296, !dbg !140
  %"39" = add nsw i64 -2147483648, %"38", !dbg !140
  br label %main_wrap_around.exit2, !dbg !140

main_bb18:                                        ; preds = %main_bb16
  %"40" = icmp slt i64 %"34", -2147483648, !dbg !141
  br i1 %"40", label %main_bb19, label %main_wrap_around.exit2, !dbg !141

main_bb19:                                        ; preds = %main_bb18
  %"41" = sub nsw i64 -2147483648, %"34", !dbg !142
  %"42" = sub nsw i64 %"41", 1, !dbg !142
  %"43" = srem i64 %"42", 4294967296, !dbg !142
  %"44" = sub nsw i64 2147483647, %"43", !dbg !142
  br label %main_wrap_around.exit2, !dbg !142
...
main_wrap_around.exit2:                           ; preds = %main_bb17, %main_bb18, %main_bb19
  ...
  %"46" = icmp sgt i64 %"45", 2147483647, !dbg !143
  br i1 %"46", label %main_bb20, label %main_bb21, !dbg !143

main_bb20:                                        ; preds = %main_wrap_around.exit2
  %"47" = sub nsw i64 %"45", 2147483647, !dbg !144
  %"48" = sub nsw i64 %"47", 1, !dbg !144
  %"49" = srem i64 %"48", 4294967296, !dbg !144
  %"50" = add nsw i64 -2147483648, %"49", !dbg !144
  br label %main_wrap_around.exit, !dbg !144

main_bb21:                                        ; preds = %main_wrap_around.exit2
  %"51" = icmp slt i64 %"45", -2147483648, !dbg !145
  br i1 %"51", label %main_bb22, label %main_wrap_around.exit, !dbg !145

main_bb22:                                        ; preds = %main_bb21
  %"52" = sub nsw i64 -2147483648, %"45", !dbg !146
  %"53" = sub nsw i64 %"52", 1, !dbg !146
  %"54" = srem i64 %"53", 4294967296, !dbg !146
  %"55" = sub nsw i64 2147483647, %"54", !dbg !146
  br label %main_wrap_around.exit, !dbg !146
...
!136 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 3, i32 1, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!137 = metadata !{i32 54, i32 9, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !91, i32 54, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!139 = metadata !{i32 10, i32 9, metadata !30, metadata !106}
!140 = metadata !{i32 11, i32 9, metadata !32, metadata !106}
!141 = metadata !{i32 13, i32 14, metadata !34, metadata !106}
!142 = metadata !{i32 14, i32 9, metadata !36, metadata !106}
!143 = metadata !{i32 10, i32 9, metadata !30, metadata !115}
!144 = metadata !{i32 11, i32 9, metadata !32, metadata !115}
!145 = metadata !{i32 13, i32 14, metadata !34, metadata !115}
!146 = metadata !{i32 14, i32 9, metadata !36, metadata !115}
!147 = metadata !{i32 65, i32 17, metadata !12, null}
