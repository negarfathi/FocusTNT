...
main_bb13:
  ...
  br i1 %or.cond, label %main_bb23, label %main_bb14, !dbg !86
...
main_bb14:                                        ; preds = %main_bb13
  ...
  call void @llvm.dbg.value(metadata !{i64 %"34"}, i64 0, metadata !106), !dbg !108
  ...
  call void @llvm.dbg.value(metadata !{i64 %"45"}, i64 0, metadata !115), !dbg !118
...
main_bb15:                                        ; preds = %main_wrap_around.exit, %main_bb14
  ...
  br i1 %"31", label %main_ff_subtitles_next_line_slice_1.exit, label %main_bb23, !dbg !126

main_ff_subtitles_next_line_slice_1.exit:         ; preds = %main_bb15
  %"32" = icmp eq i64 %"30", 1, !dbg !103
  %. = select i1 %"32", i64 0, i64 5, !dbg !103
  %"33" = icmp ne i64 %., 0, !dbg !128
  br i1 %"33", label %main_bb16, label %main_bb23, !dbg !128

main_bb16:                                        ; preds = %main_ff_subtitles_next_line_slice_1.exit
  %"34" = add nsw i64 %b.0, %., !dbg !107
  %"35" = icmp sgt i64 %"34", 2147483647, !dbg !130
  br i1 %"35", label %main_bb17, label %main_bb18, !dbg !130

main_bb17:                                        ; preds = %main_bb16
  %"36" = sub nsw i64 %"34", 2147483647, !dbg !131
  %"37" = sub nsw i64 %"36", 1, !dbg !131
  %"38" = srem i64 %"37", 4294967296, !dbg !131
  %"39" = add nsw i64 -2147483648, %"38", !dbg !131
  br label %main_wrap_around.exit2, !dbg !131

main_bb18:                                        ; preds = %main_bb16
  %"40" = icmp slt i64 %"34", -2147483648, !dbg !132
  br i1 %"40", label %main_bb19, label %main_wrap_around.exit2, !dbg !132

main_bb19:                                        ; preds = %main_bb18
  %"41" = sub nsw i64 -2147483648, %"34", !dbg !133
  %"42" = sub nsw i64 %"41", 1, !dbg !133
  %"43" = srem i64 %"42", 4294967296, !dbg !133
  %"44" = sub nsw i64 2147483647, %"43", !dbg !133
  br label %main_wrap_around.exit2, !dbg !133

main_wrap_around.exit2:                           ; preds = %main_bb17, %main_bb18, %main_bb19
  %.0.i1 = phi i64 [ %"39", %main_bb17 ], [ %"44", %main_bb19 ], [ %"34", %main_bb18 ], !dbg !107
  %"45" = sub nsw i64 10, 4, !dbg !116
  %"46" = icmp sgt i64 %"45", 2147483647, !dbg !134
  br i1 %"46", label %main_bb20, label %main_bb21, !dbg !134

main_bb20:                                        ; preds = %main_wrap_around.exit2
  %"47" = sub nsw i64 %"45", 2147483647, !dbg !135
  %"48" = sub nsw i64 %"47", 1, !dbg !135
  %"49" = srem i64 %"48", 4294967296, !dbg !135
  %"50" = add nsw i64 -2147483648, %"49", !dbg !135
  br label %main_wrap_around.exit, !dbg !135

main_bb21:                                        ; preds = %main_wrap_around.exit2
  %"51" = icmp slt i64 %"45", -2147483648, !dbg !136
  br i1 %"51", label %main_bb22, label %main_wrap_around.exit, !dbg !136

main_bb22:                                        ; preds = %main_bb21
  %"52" = sub nsw i64 -2147483648, %"45", !dbg !137
  %"53" = sub nsw i64 %"52", 1, !dbg !137
  %"54" = srem i64 %"53", 4294967296, !dbg !137
  %"55" = sub nsw i64 2147483647, %"54", !dbg !137
  br label %main_wrap_around.exit, !dbg !137

main_wrap_around.exit:                            ; preds = %main_bb20, %main_bb21, %main_bb22
  %.0.i = phi i64 [ %"50", %main_bb20 ], [ %"55", %main_bb22 ], [ %"45", %main_bb21 ], !dbg !116
  %"56" = icmp sge i64 %.0.i1, %.0.i, !dbg !116
  br i1 %"56", label %main_bb23, label %main_bb15, !dbg !116
...
!104 = metadata !{i32 786688, metadata !92, metadata !"inc", metadata !5, i32 53, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [inc] [line 53]
...
!107 = metadata !{i32 58, i32 9, metadata !92, null} ; [ DW_TAG_imported_module ]
...
!116 = metadata !{i32 59, i32 14, metadata !117, null}
!117 = metadata !{i32 786443, metadata !1, metadata !92, i32 59, i32 9, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!127 = metadata !{i32 786443, metadata !1, metadata !12, i32 52, i32 3, i32 1, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!128 = metadata !{i32 54, i32 9, metadata !129, null}
!129 = metadata !{i32 786443, metadata !1, metadata !92, i32 54, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!130 = metadata !{i32 10, i32 9, metadata !30, metadata !107}
!131 = metadata !{i32 11, i32 9, metadata !32, metadata !107}
!132 = metadata !{i32 13, i32 14, metadata !34, metadata !107}
!133 = metadata !{i32 14, i32 9, metadata !36, metadata !107}
!134 = metadata !{i32 10, i32 9, metadata !30, metadata !116}
!135 = metadata !{i32 11, i32 9, metadata !32, metadata !116}
!136 = metadata !{i32 13, i32 14, metadata !34, metadata !116}
!137 = metadata !{i32 14, i32 9, metadata !36, metadata !116}
!138 = metadata !{i32 65, i32 17, metadata !12, null}
