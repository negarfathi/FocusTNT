...
main_bb6:
  ...
  br i1 %or.cond, label %main_bb8, label %main_bb7, !dbg !54

main_bb7:                                         ; preds = %main_bb6, %main_read_slice_1.exit
  %pos.0 = phi i32 [ %"14", %main_read_slice_1.exit ], [ 0, %main_bb6 ]
  %"10" = icmp slt i32 %pos.0, 40, !dbg !58
  br i1 %"10", label %main_read_slice_1.exit, label %main_bb8, !dbg !58
...
main_read_slice_1.exit:                           ; preds = %main_bb7
  ...
  %"13" = add nsw i32 %., 1, !dbg !63
  %.. = select i1 %"12", i32 %., i32 %"13", !dbg !66
  %"14" = add nsw i32 %pos.0, %.., !dbg !68
...
!63 = metadata !{i32 52, i32 18, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !65, i32 52, i32 18, i32 1, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 786443, metadata !1, metadata !61, i32 52, i32 9, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!66 = metadata !{i32 44, i32 9, metadata !67, null}
!67 = metadata !{i32 786443, metadata !1, metadata !61, i32 44, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!68 = metadata !{i32 53, i32 5, metadata !61, null}
!69 = metadata !{i32 54, i32 3, metadata !61, null}
!70 = metadata !{i32 55, i32 17, metadata !9, null}
