...
read_slice_1_bb2:                                 ; preds = %read_slice_1_bb1
  %"1" = icmp eq i32 -200, 0, !dbg !31
  br i1 %"1", label %read_slice_1_bb5, label %read_slice_1_bb3, !dbg !31

read_slice_1_bb3:                                 ; preds = %read_slice_1_bb2
  %"2" = icmp slt i32 -200, 0, !dbg !33
  %"3" = sub nsw i32 0, -200, !dbg !36
  %. = select i1 %"2", i32 %"3", i32 -200, !dbg !33
...
main_bb6:
  ...
  %"8" = icmp sle i32 8, 0, !dbg !54
  %"9" = icmp sgt i32 8, 65536, !dbg !56
...
main_bb7:                                         ; preds = %main_bb6, %main_bb11, %main_bb13
  ...
  %"10" = icmp slt i32 %pos.0, 8, !dbg !58
  br i1 %"10", label %main_bb8, label %main_bb14, !dbg !58

main_bb8:                                         ; preds = %main_bb7
  %"11" = sub nsw i32 8, %pos.0, !dbg !60
