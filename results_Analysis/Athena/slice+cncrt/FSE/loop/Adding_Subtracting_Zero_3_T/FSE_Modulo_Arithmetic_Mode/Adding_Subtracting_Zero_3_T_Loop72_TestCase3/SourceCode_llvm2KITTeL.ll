...
main_bb21:
  ...
  br i1 %or.cond8, label %main_bb38, label %main_bb22, !dbg !89
...
main_bb22:                                        ; preds = %main_bb21
  ...
  call void @llvm.dbg.value(metadata !{i64 %"69"}, i64 0, metadata !116), !dbg !120
  ...
  call void @llvm.dbg.value(metadata !{i64 %"81"}, i64 0, metadata !127), !dbg !131
  ...
  call void @llvm.dbg.value(metadata !{i64 %"92"}, i64 0, metadata !138), !dbg !140
...
main_wrap_around.exit2:                           ; preds = %main_bb37, %main_bb36, %main_bb35, %main_wrap_around.exit6, %main_bb22
  %__fc_errno_0.0 = phi i64 [ 0, %main_bb22 ], [ %.0.i5, %main_wrap_around.exit6 ], [ %__fc_errno_0.0, %main_bb35 ], [ %__fc_errno_0.0, %main_bb36 ], [ %__fc_errno_0.0, %main_bb37 ]
  %pos.0 = phi i64 [ 0, %main_bb22 ], [ %pos.0, %main_wrap_around.exit6 ], [ %"97", %main_bb35 ], [ %"102", %main_bb37 ], [ %"92", %main_bb36 ]
  %"55" = icmp slt i64 %pos.0, 10, !dbg !148
  br i1 %"55", label %main_bb23, label %main_bb38, !dbg !148
...
main_wrap_around.exit:                            ; preds = %main_bb24, %main_bb25, %main_bb26
  ...
  %"68" = icmp slt i64 %pos.0, %.0.i, !dbg !154
  %or.cond = and i1 %"67", %"68", !dbg !113
  %__retres.0.i = select i1 %or.cond, i64 -1, i64 0, !dbg !113
  br i1 %or.cond, label %main_bb27, label %main_bb31, !dbg !155

main_bb27:                                        ; preds = %main_wrap_around.exit
  %"69" = add nsw i64 %__fc_errno_0.0, 1, !dbg !117
...
main_bb28:                                        ; preds = %main_bb27
  ...
  br label %main_wrap_around.exit6, !dbg !157

main_bb29:                                        ; preds = %main_bb27
  %"75" = icmp slt i64 %"69", -2147483648, !dbg !158
  br i1 %"75", label %main_bb30, label %main_wrap_around.exit6, !dbg !158
...
main_bb30:                                        ; preds = %main_bb29
  ...
  br label %main_wrap_around.exit6, !dbg !159

main_wrap_around.exit6:                           ; preds = %main_bb28, %main_bb29, %main_bb30
  %.0.i5 = phi i64 [ %"74", %main_bb28 ], [ %"79", %main_bb30 ], [ %"69", %main_bb29 ], !dbg !117
  %"80" = icmp eq i64 %.0.i5, 5, !dbg !160
  br i1 %"80", label %main_bb38, label %main_wrap_around.exit2, !dbg !160

main_bb31:                                        ; preds = %main_wrap_around.exit
  %"81" = add nsw i64 %__retres.0.i, 1, !dbg !128
  %"82" = icmp sgt i64 %"81", 2147483647, !dbg !162
  br i1 %"82", label %main_bb32, label %main_bb33, !dbg !162

main_bb32:                                        ; preds = %main_bb31
  %"83" = sub nsw i64 %"81", 2147483647, !dbg !163
  %"84" = sub nsw i64 %"83", 1, !dbg !163
  %"85" = srem i64 %"84", 4294967296, !dbg !163
  %"86" = add nsw i64 -2147483648, %"85", !dbg !163
  br label %main_wrap_around.exit4, !dbg !163

main_bb33:                                        ; preds = %main_bb31
  %"87" = icmp slt i64 %"81", -2147483648, !dbg !164
  br i1 %"87", label %main_bb34, label %main_wrap_around.exit4, !dbg !164

main_bb34:                                        ; preds = %main_bb33
  %"88" = sub nsw i64 -2147483648, %"81", !dbg !165
  %"89" = sub nsw i64 %"88", 1, !dbg !165
  %"90" = srem i64 %"89", 4294967296, !dbg !165
  %"91" = sub nsw i64 2147483647, %"90", !dbg !165
  br label %main_wrap_around.exit4, !dbg !165

main_wrap_around.exit4:                           ; preds = %main_bb34, %main_bb33, %main_bb32
  %rc.0 = phi i64 [ %"86", %main_bb32 ], [ %"91", %main_bb34 ], [ %"81", %main_bb33 ]
  %"92" = add nsw i64 %pos.0, %rc.0, !dbg !139
  %"93" = icmp sgt i64 %"92", 2147483647, !dbg !166
  br i1 %"93", label %main_bb35, label %main_bb36, !dbg !166

main_bb35:                                        ; preds = %main_wrap_around.exit4
  %"94" = sub nsw i64 %"92", 2147483647, !dbg !167
  %"95" = sub nsw i64 %"94", 1, !dbg !167
  %"96" = srem i64 %"95", 4294967296, !dbg !167
  %"97" = add nsw i64 -2147483648, %"96", !dbg !167
  br label %main_wrap_around.exit2, !dbg !167

main_bb36:                                        ; preds = %main_wrap_around.exit4
  %"98" = icmp slt i64 %"92", -2147483648, !dbg !168
  br i1 %"98", label %main_bb37, label %main_wrap_around.exit2, !dbg !168

main_bb37:                                        ; preds = %main_bb36
  %"99" = sub nsw i64 -2147483648, %"92", !dbg !169
  %"100" = sub nsw i64 %"99", 1, !dbg !169
  %"101" = srem i64 %"100", 4294967296, !dbg !169
  %"102" = sub nsw i64 2147483647, %"101", !dbg !169
  br label %main_wrap_around.exit2, !dbg !169

main_bb38:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit6, %main_bb21
  ret void, !dbg !170
}
...
!155 = metadata !{i32 72, i32 9, metadata !119, null}
!156 = metadata !{i32 10, i32 9, metadata !30, metadata !117}
!157 = metadata !{i32 11, i32 9, metadata !32, metadata !117}
!158 = metadata !{i32 13, i32 14, metadata !34, metadata !117}
!159 = metadata !{i32 14, i32 9, metadata !36, metadata !117}
!160 = metadata !{i32 74, i32 11, metadata !161, null}
!161 = metadata !{i32 786443, metadata !1, metadata !118, i32 74, i32 11, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!162 = metadata !{i32 10, i32 9, metadata !30, metadata !128}
!163 = metadata !{i32 11, i32 9, metadata !32, metadata !128}
!164 = metadata !{i32 13, i32 14, metadata !34, metadata !128}
!165 = metadata !{i32 14, i32 9, metadata !36, metadata !128}
!166 = metadata !{i32 10, i32 9, metadata !30, metadata !139}
!167 = metadata !{i32 11, i32 9, metadata !32, metadata !139}
!168 = metadata !{i32 13, i32 14, metadata !34, metadata !139}
!169 = metadata !{i32 14, i32 9, metadata !36, metadata !139}
!170 = metadata !{i32 85, i32 17, metadata !12, null}
