...
main_bb20:
  ...
  br i1 %or.cond, label %main_bb36, label %main_wrap_around.exit2, !dbg !120

main_wrap_around.exit2:                           ; preds = %main_bb20, %main_bb35, %main_bb34, %main_bb33, %main_wrap_around.exit6
  %__fc_errno_0.0 = phi i64 [ %.0.i5, %main_wrap_around.exit6 ], [ %__fc_errno_0.0, %main_bb33 ], [ %__fc_errno_0.0, %main_bb34 ], [ %__fc_errno_0.0, %main_bb35 ], [ 0, %main_bb20 ]
  %pos.0 = phi i64 [ %pos.0, %main_wrap_around.exit6 ], [ %"93", %main_bb33 ], [ %"98", %main_bb35 ], [ %"88", %main_bb34 ], [ 0, %main_bb20 ]
  %"52" = icmp slt i64 %pos.0, 10, !dbg !124
  br i1 %"52", label %main_bb21, label %main_bb36, !dbg !124
...
main_wrap_around.exit:                            ; preds = %main_bb22, %main_bb23, %main_bb24
  ...
  br i1 %"64", label %main_bb25, label %main_bb29, !dbg !134

main_bb25:                                        ; preds = %main_wrap_around.exit
  %"65" = add nsw i64 %__fc_errno_0.0, 1, !dbg !136
  %"66" = icmp sgt i64 %"65", 2147483647, !dbg !138
  br i1 %"66", label %main_bb26, label %main_bb27, !dbg !138

main_bb26:                                        ; preds = %main_bb25
  %"67" = sub nsw i64 %"65", 2147483647, !dbg !139
  %"68" = sub nsw i64 %"67", 1, !dbg !139
  %"69" = srem i64 %"68", 4294967296, !dbg !139
  %"70" = add nsw i64 -2147483648, %"69", !dbg !139
  br label %main_wrap_around.exit6, !dbg !139

main_bb27:                                        ; preds = %main_bb25
  %"71" = icmp slt i64 %"65", -2147483648, !dbg !140
  br i1 %"71", label %main_bb28, label %main_wrap_around.exit6, !dbg !140

main_bb28:                                        ; preds = %main_bb27
  %"72" = sub nsw i64 -2147483648, %"65", !dbg !141
  %"73" = sub nsw i64 %"72", 1, !dbg !141
  %"74" = srem i64 %"73", 4294967296, !dbg !141
  %"75" = sub nsw i64 2147483647, %"74", !dbg !141
  br label %main_wrap_around.exit6, !dbg !141

main_wrap_around.exit6:                           ; preds = %main_bb26, %main_bb27, %main_bb28
  %.0.i5 = phi i64 [ %"70", %main_bb26 ], [ %"75", %main_bb28 ], [ %"65", %main_bb27 ], !dbg !136
  %"76" = icmp eq i64 %.0.i5, 5, !dbg !142
  br i1 %"76", label %main_bb36, label %main_wrap_around.exit2, !dbg !142

main_bb29:                                        ; preds = %main_wrap_around.exit
  %"77" = add nsw i64 %., 1, !dbg !144
  %"78" = icmp sgt i64 %"77", 2147483647, !dbg !147
  br i1 %"78", label %main_bb30, label %main_bb31, !dbg !147

main_bb30:                                        ; preds = %main_bb29
  %"79" = sub nsw i64 %"77", 2147483647, !dbg !148
  %"80" = sub nsw i64 %"79", 1, !dbg !148
  %"81" = srem i64 %"80", 4294967296, !dbg !148
  %"82" = add nsw i64 -2147483648, %"81", !dbg !148
  br label %main_wrap_around.exit4, !dbg !148

main_bb31:                                        ; preds = %main_bb29
  %"83" = icmp slt i64 %"77", -2147483648, !dbg !149
  br i1 %"83", label %main_bb32, label %main_wrap_around.exit4, !dbg !149

main_bb32:                                        ; preds = %main_bb31
  %"84" = sub nsw i64 -2147483648, %"77", !dbg !150
  %"85" = sub nsw i64 %"84", 1, !dbg !150
  %"86" = srem i64 %"85", 4294967296, !dbg !150
  %"87" = sub nsw i64 2147483647, %"86", !dbg !150
  br label %main_wrap_around.exit4, !dbg !150

main_wrap_around.exit4:                           ; preds = %main_bb32, %main_bb31, %main_bb30
  %rc.0 = phi i64 [ %"82", %main_bb30 ], [ %"87", %main_bb32 ], [ %"77", %main_bb31 ]
  %"88" = add nsw i64 %pos.0, %rc.0, !dbg !151
  %"89" = icmp sgt i64 %"88", 2147483647, !dbg !152
  br i1 %"89", label %main_bb33, label %main_bb34, !dbg !152

main_bb33:                                        ; preds = %main_wrap_around.exit4
...
main_bb34:                                        ; preds = %main_wrap_around.exit4
  %"94" = icmp slt i64 %"88", -2147483648, !dbg !154
  br i1 %"94", label %main_bb35, label %main_wrap_around.exit2, !dbg !154
...
main_bb36:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit6, %main_bb20
  ret void, !dbg !156
}
...
!125 = metadata !{i32 786443, metadata !1, metadata !12, i32 62, i32 3, i32 1, i32 25} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!144 = metadata !{i32 73, i32 9, metadata !145, null}
!145 = metadata !{i32 786443, metadata !1, metadata !146, i32 73, i32 1, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!146 = metadata !{i32 786443, metadata !1, metadata !127, i32 72, i32 9, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!147 = metadata !{i32 10, i32 9, metadata !30, metadata !144}
!148 = metadata !{i32 11, i32 9, metadata !32, metadata !144}
!149 = metadata !{i32 13, i32 14, metadata !34, metadata !144}
!150 = metadata !{i32 14, i32 9, metadata !36, metadata !144}
!151 = metadata !{i32 75, i32 11, metadata !127, null}
...
!156 = metadata !{i32 77, i32 17, metadata !12, null}
