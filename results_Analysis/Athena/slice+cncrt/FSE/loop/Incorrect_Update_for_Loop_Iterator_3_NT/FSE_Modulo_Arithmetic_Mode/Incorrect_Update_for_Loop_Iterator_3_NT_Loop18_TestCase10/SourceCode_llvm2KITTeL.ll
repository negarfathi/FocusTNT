...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !39, i64 0, metadata !34), !dbg !35
  br label %main_bb6, !dbg !55

main_bb6:                                         ; preds = %main_wrap_around.exit, %main_bb5
  %nfds.0 = phi i64 [ 7, %main_bb5 ], [ %..0.i, %main_wrap_around.exit ]
  %"12" = icmp sle i64 %nfds.0, 1000, !dbg !56
  br i1 %"12", label %main_bb7, label %main_bb11, !dbg !56

main_bb7:                                         ; preds = %main_bb6
  %"13" = mul nsw i64 %nfds.0, 2, !dbg !43
  %"14" = icmp sgt i64 %"13", 2147483647, !dbg !58
  br i1 %"14", label %main_bb8, label %main_bb9, !dbg !58

main_bb8:                                         ; preds = %main_bb7
  %"15" = sub nsw i64 %"13", 2147483647, !dbg !59
  %"16" = sub nsw i64 %"15", 1, !dbg !59
  %"17" = srem i64 %"16", 4294967296, !dbg !59
  %"18" = add nsw i64 -2147483648, %"17", !dbg !59
  br label %main_wrap_around.exit, !dbg !59

main_bb9:                                         ; preds = %main_bb7
  %"19" = icmp slt i64 %"13", -2147483648, !dbg !60
  br i1 %"19", label %main_bb10, label %main_wrap_around.exit, !dbg !60

main_bb10:                                        ; preds = %main_bb9
  %"20" = sub nsw i64 -2147483648, %"13", !dbg !61
  %"21" = sub nsw i64 %"20", 1, !dbg !61
  %"22" = srem i64 %"21", 4294967296, !dbg !61
  %"23" = sub nsw i64 2147483647, %"22", !dbg !61
  br label %main_wrap_around.exit, !dbg !61

main_wrap_around.exit:                            ; preds = %main_bb8, %main_bb9, %main_bb10
  %.0.i = phi i64 [ %"18", %main_bb8 ], [ %"23", %main_bb10 ], [ %"13", %main_bb9 ], !dbg !43
  %"24" = icmp sgt i64 %.0.i, 300, !dbg !62
  %..0.i = select i1 %"24", i64 300, i64 %.0.i, !dbg !62
