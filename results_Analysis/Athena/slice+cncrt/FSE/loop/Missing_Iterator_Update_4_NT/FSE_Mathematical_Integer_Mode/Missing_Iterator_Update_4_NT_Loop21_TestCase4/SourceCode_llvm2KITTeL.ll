...
main_bb0:
  ...
  %or.cond2.not = xor i1 %or.cond2, true, !dbg !18
  %"4" = icmp slt i32 0, 70000, !dbg !26
  %or.cond3 = and i1 %or.cond2.not, %"4", !dbg !18
  br i1 %or.cond3, label %main_bb1, label %main_bb4, !dbg !18

main_bb1:                                         ; preds = %main_bb0, %main_bb3, %main_bb2
  %y.0 = phi i32 [ %"6", %main_bb2 ], [ 0, %main_bb3 ], [ 0, %main_bb0 ]
  %"5" = icmp slt i32 %y.0, 10, !dbg !28
  br i1 %"5", label %main_bb2, label %main_bb3, !dbg !28

main_bb2:                                         ; preds = %main_bb1
  %"6" = add nsw i32 %y.0, 1, !dbg !32
  br label %main_bb1, !dbg !32

main_bb3:                                         ; preds = %main_bb1
  %.old = icmp slt i32 0, 70000, !dbg !26
  br i1 %.old, label %main_bb1, label %main_bb4, !dbg !26
...
!34 = metadata !{i32 33, i32 17, metadata !4, null}
