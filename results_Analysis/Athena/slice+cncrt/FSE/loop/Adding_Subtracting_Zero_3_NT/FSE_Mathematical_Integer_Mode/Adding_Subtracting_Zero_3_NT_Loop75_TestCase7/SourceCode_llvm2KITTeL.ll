...
main_bb7:
  ...
  %"10" = icmp sle i32 10, 0, !dbg !57
  %"11" = icmp sgt i32 10, 65536, !dbg !59
  %or.cond1 = or i1 %"10", %"11", !dbg !57
  br i1 %or.cond1, label %main_bb13, label %main_bb8, !dbg !57

main_bb8:                                         ; preds = %main_bb7, %main_bb11, %main_bb12
  %__fc_errno_0.0 = phi i32 [ %__fc_errno_0.0, %main_bb12 ], [ %"18", %main_bb11 ], [ 0, %main_bb7 ]
  %pos.0 = phi i32 [ %"20", %main_bb12 ], [ %pos.0, %main_bb11 ], [ 0, %main_bb7 ]
  %"12" = icmp slt i32 %pos.0, 10, !dbg !61
  br i1 %"12", label %main_bb9, label %main_bb13, !dbg !61

main_bb9:                                         ; preds = %main_bb8
  %"13" = sub nsw i32 10, %pos.0, !dbg !63
  %"14" = load i32* @"'flag", align 4, !dbg !65
  %"15" = icmp ne i32 %"14", 1, !dbg !65
  %"16" = icmp slt i32 %pos.0, %"13", !dbg !66
  %or.cond = and i1 %"15", %"16", !dbg !65
  br i1 %or.cond, label %main_bb10, label %main_read_slice_1.exit, !dbg !65

main_bb10:                                        ; preds = %main_bb9
  store i32 1, i32* @"'flag", align 4, !dbg !67
  br label %main_read_slice_1.exit, !dbg !68

main_read_slice_1.exit:                           ; preds = %main_bb9, %main_bb10
  %__retres.0.i = phi i32 [ 1, %main_bb10 ], [ 0, %main_bb9 ], !dbg !63
  %"17" = icmp eq i32 %__retres.0.i, -1, !dbg !69
  br i1 %"17", label %main_bb11, label %main_bb12, !dbg !69

main_bb11:                                        ; preds = %main_read_slice_1.exit
  %"18" = add nsw i32 %__fc_errno_0.0, 1, !dbg !71
  %"19" = icmp eq i32 %"18", 5, !dbg !73
  br i1 %"19", label %main_bb13, label %main_bb8, !dbg !73

main_bb12:                                        ; preds = %main_read_slice_1.exit
  %"20" = add nsw i32 %pos.0, %__retres.0.i, !dbg !75
  br label %main_bb8, !dbg !76
...
!35 = metadata !{i32 786443, metadata !1, metadata !32, i32 22, i32 20, i32 1, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!41 = metadata !{i32 786443, metadata !1, metadata !39, i32 25, i32 22, i32 1, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!61 = metadata !{i32 54, i32 3, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !9, i32 54, i32 3, i32 1, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 55, i32 14, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !9, i32 54, i32 22, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 10, i32 7, metadata !25, metadata !63}
!66 = metadata !{i32 14, i32 3, metadata !27, metadata !63}
!67 = metadata !{i32 27, i32 9, metadata !44, metadata !63}
!68 = metadata !{i32 30, i32 9, metadata !44, metadata !63}
!69 = metadata !{i32 56, i32 9, metadata !70, null}
!70 = metadata !{i32 786443, metadata !1, metadata !64, i32 56, i32 9, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 57, i32 7, metadata !72, null}
!72 = metadata !{i32 786443, metadata !1, metadata !70, i32 56, i32 19, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!73 = metadata !{i32 58, i32 11, metadata !74, null} ; [ DW_TAG_imported_module ]
!74 = metadata !{i32 786443, metadata !1, metadata !72, i32 58, i32 11, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!75 = metadata !{i32 64, i32 5, metadata !64, null}
!76 = metadata !{i32 65, i32 3, metadata !64, null}
!77 = metadata !{i32 66, i32 17, metadata !9, null}
