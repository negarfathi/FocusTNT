...
main_bb6:
  ...
  %"8" = icmp sle i32 10, 0, !dbg !54
  %"9" = icmp sgt i32 10, 65536, !dbg !56
  %or.cond = or i1 %"8", %"9", !dbg !54
  br i1 %or.cond, label %main_bb10, label %main_bb7, !dbg !54

main_bb7:                                         ; preds = %main_bb6, %main_bb8, %main_bb9
  %__fc_errno_0.0 = phi i32 [ %__fc_errno_0.0, %main_bb9 ], [ %"14", %main_bb8 ], [ 0, %main_bb6 ]
  %pos.0 = phi i32 [ %"16", %main_bb9 ], [ %pos.0, %main_bb8 ], [ 0, %main_bb6 ]
  %"10" = icmp slt i32 %pos.0, 10, !dbg !58
  br i1 %"10", label %main_read_slice_1.exit, label %main_bb10, !dbg !58

main_read_slice_1.exit:                           ; preds = %main_bb7
  %"11" = sub nsw i32 10, %pos.0, !dbg !60
  %"12" = icmp slt i32 %pos.0, %"11", !dbg !62
  %. = select i1 %"12", i32 1, i32 0, !dbg !62
  %"13" = icmp eq i32 %., -1, !dbg !63
  br i1 %"13", label %main_bb8, label %main_bb9, !dbg !63

main_bb8:                                         ; preds = %main_read_slice_1.exit
  %"14" = add nsw i32 %__fc_errno_0.0, 1, !dbg !65
  %"15" = icmp eq i32 %"14", 5, !dbg !67
  br i1 %"15", label %main_bb10, label %main_bb7, !dbg !67

main_bb9:                                         ; preds = %main_read_slice_1.exit
  %"16" = add nsw i32 %pos.0, %., !dbg !69
...
!62 = metadata !{i32 10, i32 3, metadata !30, metadata !60}
!63 = metadata !{i32 44, i32 9, metadata !64, null}
!64 = metadata !{i32 786443, metadata !1, metadata !61, i32 44, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 45, i32 7, metadata !66, null}
!66 = metadata !{i32 786443, metadata !1, metadata !64, i32 44, i32 19, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!67 = metadata !{i32 46, i32 11, metadata !68, null}
!68 = metadata !{i32 786443, metadata !1, metadata !66, i32 46, i32 11, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 52, i32 5, metadata !61, null}
!70 = metadata !{i32 53, i32 3, metadata !61, null}
!71 = metadata !{i32 54, i32 17, metadata !9, null}
