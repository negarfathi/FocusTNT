...
main_bb6:
  ...
  br i1 %or.cond, label %main_bb13, label %main_bb7, !dbg !54

main_bb7:                                         ; preds = %main_bb6, %main_bb11, %main_bb12
  %__fc_errno_0.0 = phi i32 [ %__fc_errno_0.0, %main_bb12 ], [ %"16", %main_bb11 ], [ 0, %main_bb6 ]
  %pos.0 = phi i32 [ %"18", %main_bb12 ], [ %pos.0, %main_bb11 ], [ 0, %main_bb6 ]
  %"10" = icmp slt i32 %pos.0, 70000, !dbg !58
  br i1 %"10", label %main_bb8, label %main_bb13, !dbg !58
...
main_read_slice_1.exit:                           ; preds = %main_bb9
  ...
  %"15" = icmp eq i32 %count.0.i, -1, !dbg !69
  br i1 %"15", label %main_bb11, label %main_bb12, !dbg !69

main_bb11:                                        ; preds = %main_read_slice_1.exit
  %"16" = add nsw i32 %__fc_errno_0.0, 1, !dbg !71
  call void @llvm.dbg.value(metadata !{i32 %"16"}, i64 0, metadata !52), !dbg !53
  %"17" = icmp eq i32 %"16", 5, !dbg !73
  br i1 %"17", label %main_bb13, label %main_bb7, !dbg !73

main_bb12:                                        ; preds = %main_read_slice_1.exit
  %"18" = add nsw i32 %pos.0, %count.0.i, !dbg !75
  call void @llvm.dbg.value(metadata !{i32 %"18"}, i64 0, metadata !46), !dbg !47
  br label %main_bb7, !dbg !76

main_bb13:                                        ; preds = %main_bb7, %main_bb11, %main_bb6
  ret void, !dbg !77
}
...
!59 = metadata !{i32 786443, metadata !1, metadata !9, i32 42, i32 3, i32 1, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!70 = metadata !{i32 786443, metadata !1, metadata !61, i32 44, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 45, i32 7, metadata !72, null}
!72 = metadata !{i32 786443, metadata !1, metadata !70, i32 44, i32 19, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!73 = metadata !{i32 46, i32 11, metadata !74, null}
!74 = metadata !{i32 786443, metadata !1, metadata !72, i32 46, i32 11, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!75 = metadata !{i32 52, i32 5, metadata !61, null}
!76 = metadata !{i32 53, i32 3, metadata !61, null}
!77 = metadata !{i32 54, i32 17, metadata !9, null}
