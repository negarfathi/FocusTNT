...
read_slice_1_wrap_around.exit:                    ; preds = %read_slice_1_bb11, %read_slice_1_bb10, %read_slice_1_bb9, %read_slice_1_bb7
  %num.0 = phi i64 [ -999, %read_slice_1_bb7 ], [ %"22", %read_slice_1_bb9 ], [ %"27", %read_slice_1_bb11 ], [ %"17", %read_slice_1_bb10 ]
...
main_bb21:
  ...
  %"52" = icmp sle i64 30, 0, !dbg !89
  %"53" = icmp sgt i64 30, 65536, !dbg !91
  %or.cond6 = or i1 %"52", %"53", !dbg !89
  br i1 %or.cond6, label %main_bb38, label %main_wrap_around.exit2, !dbg !89

main_wrap_around.exit2:                           ; preds = %main_bb21, %main_bb37, %main_bb36, %main_bb35, %main_wrap_around.exit4
  %__fc_errno_0.0 = phi i64 [ %.0.i3, %main_wrap_around.exit4 ], [ %__fc_errno_0.0, %main_bb35 ], [ %__fc_errno_0.0, %main_bb36 ], [ %__fc_errno_0.0, %main_bb37 ], [ 0, %main_bb21 ]
  %pos.0 = phi i64 [ %pos.0, %main_wrap_around.exit4 ], [ %"98", %main_bb35 ], [ %"103", %main_bb37 ], [ %"93", %main_bb36 ], [ 0, %main_bb21 ]
  %"54" = icmp slt i64 %pos.0, 30, !dbg !93
  br i1 %"54", label %main_bb22, label %main_bb38, !dbg !93

main_bb22:                                        ; preds = %main_wrap_around.exit2
  %"55" = sub nsw i64 30, %pos.0, !dbg !95
...
main_read_slice_1.exit:                           ; preds = %main_wrap_around.exit, %main_wrap_around.exit4.i
  ...
  %"80" = icmp eq i64 %__retres.0.i, -1, !dbg !111
  br i1 %"80", label %main_bb30, label %main_bb34, !dbg !111

main_bb30:                                        ; preds = %main_read_slice_1.exit
  %"81" = add nsw i64 %__fc_errno_0.0, 1, !dbg !113
  %"82" = icmp sgt i64 %"81", 2147483647, !dbg !115
  br i1 %"82", label %main_bb31, label %main_bb32, !dbg !115

main_bb31:                                        ; preds = %main_bb30
  %"83" = sub nsw i64 %"81", 2147483647, !dbg !116
  %"84" = sub nsw i64 %"83", 1, !dbg !116
  %"85" = srem i64 %"84", 4294967296, !dbg !116
  %"86" = add nsw i64 -2147483648, %"85", !dbg !116
  br label %main_wrap_around.exit4, !dbg !116

main_bb32:                                        ; preds = %main_bb30
  %"87" = icmp slt i64 %"81", -2147483648, !dbg !117
  br i1 %"87", label %main_bb33, label %main_wrap_around.exit4, !dbg !117

main_bb33:                                        ; preds = %main_bb32
  %"88" = sub nsw i64 -2147483648, %"81", !dbg !118
  %"89" = sub nsw i64 %"88", 1, !dbg !118
  %"90" = srem i64 %"89", 4294967296, !dbg !118
  %"91" = sub nsw i64 2147483647, %"90", !dbg !118
  br label %main_wrap_around.exit4, !dbg !118

main_wrap_around.exit4:                           ; preds = %main_bb31, %main_bb32, %main_bb33
  %.0.i3 = phi i64 [ %"86", %main_bb31 ], [ %"91", %main_bb33 ], [ %"81", %main_bb32 ], !dbg !113
  %"92" = icmp eq i64 %.0.i3, 5, !dbg !119
  br i1 %"92", label %main_bb38, label %main_wrap_around.exit2, !dbg !119

main_bb34:                                        ; preds = %main_read_slice_1.exit
  %"93" = add nsw i64 %pos.0, %__retres.0.i, !dbg !121
  %"94" = icmp sgt i64 %"93", 2147483647, !dbg !122
  br i1 %"94", label %main_bb35, label %main_bb36, !dbg !122

main_bb35:                                        ; preds = %main_bb34
  %"95" = sub nsw i64 %"93", 2147483647, !dbg !123
  %"96" = sub nsw i64 %"95", 1, !dbg !123
  %"97" = srem i64 %"96", 4294967296, !dbg !123
  %"98" = add nsw i64 -2147483648, %"97", !dbg !123
  br label %main_wrap_around.exit2, !dbg !123

main_bb36:                                        ; preds = %main_bb34
  %"99" = icmp slt i64 %"93", -2147483648, !dbg !124
  br i1 %"99", label %main_bb37, label %main_wrap_around.exit2, !dbg !124

main_bb37:                                        ; preds = %main_bb36
  %"100" = sub nsw i64 -2147483648, %"93", !dbg !125
  %"101" = sub nsw i64 %"100", 1, !dbg !125
  %"102" = srem i64 %"101", 4294967296, !dbg !125
  %"103" = sub nsw i64 2147483647, %"102", !dbg !125
...
!94 = metadata !{i32 786443, metadata !1, metadata !12, i32 70, i32 3, i32 1, i32 25} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!111 = metadata !{i32 72, i32 9, metadata !112, null}
!112 = metadata !{i32 786443, metadata !1, metadata !96, i32 72, i32 9, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!113 = metadata !{i32 73, i32 23, metadata !114, null}
!114 = metadata !{i32 786443, metadata !1, metadata !112, i32 72, i32 19, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!119 = metadata !{i32 74, i32 11, metadata !120, null}
!120 = metadata !{i32 786443, metadata !1, metadata !114, i32 74, i32 11, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!121 = metadata !{i32 80, i32 11, metadata !96, null}
!122 = metadata !{i32 10, i32 9, metadata !30, metadata !121}
!123 = metadata !{i32 11, i32 9, metadata !32, metadata !121}
!124 = metadata !{i32 13, i32 14, metadata !34, metadata !121}
!125 = metadata !{i32 14, i32 9, metadata !36, metadata !121}
!126 = metadata !{i32 82, i32 17, metadata !12, null}
