...
main_bb7:
  ...
  %"10" = icmp sle i32 70000, 0, !dbg !57
  %"11" = icmp sgt i32 70000, 65536, !dbg !59
  %or.cond = or i1 %"10", %"11", !dbg !57
  br i1 %or.cond, label %main_bb15, label %main_bb8, !dbg !57
...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %"20"}, i64 0, metadata !55), !dbg !56
...
main_bb9:                                         ; preds = %main_bb13, %main_bb14, %main_bb8
  %__fc_errno_0.0 = phi i32 [ 0, %main_bb8 ], [ %__fc_errno_0.0, %main_bb14 ], [ %"20", %main_bb13 ]
  %pos.0 = phi i32 [ 0, %main_bb8 ], [ %"22", %main_bb14 ], [ %pos.0, %main_bb13 ]
  %"13" = icmp slt i32 %pos.0, 70000, !dbg !73
  br i1 %"13", label %main_bb10, label %main_bb15, !dbg !73

main_bb10:                                        ; preds = %main_bb9
  %"14" = sub nsw i32 70000, %pos.0, !dbg !62
...
main_read_slice_1.exit:                           ; preds = %main_bb10, %main_bb11
  ...
  %"19" = icmp eq i32 %__retres.0.i, -1, !dbg !79
  br i1 %"19", label %main_bb13, label %main_bb14, !dbg !79

main_bb13:                                        ; preds = %main_read_slice_1.exit
  %"20" = add nsw i32 %__fc_errno_0.0, 1, !dbg !81
  %"21" = icmp eq i32 %"20", 5, !dbg !83
  br i1 %"21", label %main_bb15, label %main_bb9, !dbg !83

main_bb14:                                        ; preds = %main_read_slice_1.exit
  %"22" = add nsw i32 %pos.0, %__retres.0.i, !dbg !85
...
!79 = metadata !{i32 56, i32 9, metadata !80, null}
!80 = metadata !{i32 786443, metadata !1, metadata !63, i32 56, i32 9, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!81 = metadata !{i32 57, i32 7, metadata !82, null}
!82 = metadata !{i32 786443, metadata !1, metadata !80, i32 56, i32 19, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!83 = metadata !{i32 58, i32 11, metadata !84, null} ; [ DW_TAG_imported_module ]
!84 = metadata !{i32 786443, metadata !1, metadata !82, i32 58, i32 11, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!85 = metadata !{i32 64, i32 5, metadata !63, null}
!86 = metadata !{i32 65, i32 3, metadata !63, null}
!87 = metadata !{i32 66, i32 17, metadata !9, null}
