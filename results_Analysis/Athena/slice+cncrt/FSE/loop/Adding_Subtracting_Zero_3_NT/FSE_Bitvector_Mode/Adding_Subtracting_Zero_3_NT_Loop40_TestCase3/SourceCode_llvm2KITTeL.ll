...
main_read_slice_1.exit:                           ; preds = %main_bb7
  ...
  %"13" = icmp eq i32 %., -1, !dbg !62
  br i1 %"13", label %main_bb8, label %main_bb9, !dbg !62

main_bb8:                                         ; preds = %main_read_slice_1.exit
  %"14" = add nsw i32 %__fc_errno_0.0, 1, !dbg !64
  %"15" = icmp eq i32 %"14", 5, !dbg !66
  br i1 %"15", label %main_bb10, label %main_bb7, !dbg !66

main_bb9:                                         ; preds = %main_read_slice_1.exit
  %"16" = add nsw i32 %pos.0, %., !dbg !68
...
!58 = metadata !{i32 786443, metadata !1, metadata !9, i32 42, i32 3, i32 1, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!68 = metadata !{i32 52, i32 5, metadata !60, null}
!69 = metadata !{i32 53, i32 3, metadata !60, null}
!70 = metadata !{i32 54, i32 17, metadata !9, null}
