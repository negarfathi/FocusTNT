...
main_bb7:
  ...
  br i1 %or.cond1, label %main_bb12, label %main_bb8, !dbg !57
...
main_bb8:                                         ; preds = %main_bb7
  ...
  call void @llvm.dbg.value(metadata !{i32 %"18"}, i64 0, metadata !55), !dbg !56
  call void @llvm.dbg.value(metadata !{i32 %"20"}, i64 0, metadata !49), !dbg !50
  br label %main_bb9, !dbg !72

main_bb9:                                         ; preds = %main_bb10, %main_bb11, %main_bb8
  %__fc_errno_0.0 = phi i32 [ 0, %main_bb8 ], [ %__fc_errno_0.0, %main_bb11 ], [ %"18", %main_bb10 ]
  %pos.0 = phi i32 [ 0, %main_bb8 ], [ %"20", %main_bb11 ], [ %pos.0, %main_bb10 ]
  %"13" = icmp slt i32 %pos.0, 10, !dbg !73
  br i1 %"13", label %main_read_slice_1.exit, label %main_bb12, !dbg !73

main_read_slice_1.exit:                           ; preds = %main_bb9
  %"14" = sub nsw i32 10, %pos.0, !dbg !62
  %"15" = icmp ne i32 %"12", 1, !dbg !69
  %"16" = icmp slt i32 %pos.0, %"14", !dbg !75
  %or.cond = and i1 %"15", %"16", !dbg !69
  %__retres.0.i = select i1 %or.cond, i32 -1, i32 0, !dbg !69
  %"17" = icmp eq i32 %__retres.0.i, -1, !dbg !76
  br i1 %"17", label %main_bb10, label %main_bb11, !dbg !76

main_bb10:                                        ; preds = %main_read_slice_1.exit
  %"18" = add nsw i32 %__fc_errno_0.0, 1, !dbg !78
  %"19" = icmp eq i32 %"18", 5, !dbg !80
  br i1 %"19", label %main_bb12, label %main_bb9, !dbg !80

main_bb11:                                        ; preds = %main_read_slice_1.exit
  %"20" = add nsw i32 %pos.0, %__retres.0.i, !dbg !82
...
!74 = metadata !{i32 786443, metadata !1, metadata !9, i32 54, i32 3, i32 1, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!75 = metadata !{i32 14, i32 3, metadata !27, metadata !62}
!76 = metadata !{i32 56, i32 9, metadata !77, null}
!77 = metadata !{i32 786443, metadata !1, metadata !63, i32 56, i32 9, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!78 = metadata !{i32 57, i32 7, metadata !79, null}
!79 = metadata !{i32 786443, metadata !1, metadata !77, i32 56, i32 19, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!80 = metadata !{i32 58, i32 11, metadata !81, null} ; [ DW_TAG_imported_module ]
!81 = metadata !{i32 786443, metadata !1, metadata !79, i32 58, i32 11, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!82 = metadata !{i32 64, i32 5, metadata !63, null}
!83 = metadata !{i32 65, i32 3, metadata !63, null}
!84 = metadata !{i32 66, i32 17, metadata !9, null}
