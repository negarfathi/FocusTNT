...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %div1.0 = phi i64 [ 1, %main_bb5 ], [ %"18", %main_bb7 ], [ %"23", %main_bb9 ], [ %"13", %main_bb8 ]
  %"12" = icmp sge i64 %div1.0, 0, !dbg !50
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !50

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = sub nsw i64 %div1.0, 1, !dbg !37
  %"14" = icmp sgt i64 %"13", 2147483647, !dbg !52
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !52

main_bb7:                                         ; preds = %main_bb6
  %"15" = sub nsw i64 %"13", 2147483647, !dbg !53
  %"16" = sub nsw i64 %"15", 1, !dbg !53
  %"17" = srem i64 %"16", 4294967296, !dbg !53
  %"18" = add nsw i64 -2147483648, %"17", !dbg !53
  br label %main_wrap_around.exit, !dbg !53

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"13", -2147483648, !dbg !54
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !54

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 -2147483648, %"13", !dbg !55
  %"21" = sub nsw i64 %"20", 1, !dbg !55
  %"22" = srem i64 %"21", 4294967296, !dbg !55
  %"23" = sub nsw i64 2147483647, %"22", !dbg !55
...
!37 = metadata !{i32 19, i32 11, metadata !38, null}
!38 = metadata !{i32 786443, metadata !1, metadata !9, i32 19, i32 1, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!39 = metadata !{i32 4, i32 33, metadata !4, metadata !37}
!40 = metadata !{i64 -2147483648}
...
!49 = metadata !{i32 18, i32 3, metadata !9, null}
!50 = metadata !{i32 18, i32 3, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !9, i32 18, i32 3, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!56 = metadata !{i32 21, i32 3, metadata !9, null}
