...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !43), !dbg !46
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %ui.0 = phi i64 [ 1, %main_bb5 ], [ %"18", %main_bb7 ], [ %"23", %main_bb9 ], [ %"14", %main_bb8 ]
  %"13" = icmp slt i64 %ui.0, %., !dbg !57
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !57

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"14" = mul nsw i64 %ui.0, 2, !dbg !44
  %"15" = icmp sgt i64 %"14", 4294967295, !dbg !59
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !59

main_bb7:                                         ; preds = %main_bb6
  %"16" = sub nsw i64 %"14", 4294967295, !dbg !60
  %"17" = sub nsw i64 %"16", 1, !dbg !60
  %"18" = srem i64 %"17", 4294967296, !dbg !60
  br label %main_wrap_around.exit, !dbg !60

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"14", 0, !dbg !61
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !61

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 0, %"14", !dbg !62
  %"21" = sub nsw i64 %"20", 1, !dbg !62
  %"22" = srem i64 %"21", 4294967296, !dbg !62
  %"23" = sub nsw i64 4294967295, %"22", !dbg !62
...
!45 = metadata !{i32 786443, metadata !1, metadata !9, i32 26, i32 1, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 7, i32 33, metadata !4, metadata !44}
!47 = metadata !{i64 0}
...
!56 = metadata !{i32 25, i32 3, metadata !9, null}
!57 = metadata !{i32 25, i32 3, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !9, i32 25, i32 3, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 9, i32 9, metadata !25, metadata !44}
!60 = metadata !{i32 10, i32 9, metadata !27, metadata !44}
!61 = metadata !{i32 12, i32 14, metadata !29, metadata !44}
!62 = metadata !{i32 13, i32 9, metadata !31, metadata !44}
