...
main_bb5:
  ...
  %"12" = icmp sle i64 100, 5, !dbg !44
  %"13" = icmp eq i64 10, 0, !dbg !46
...
main_bb6:                                         ; preds = %main_bb5, %main_wrap_around.exit
  %cur.0 = phi i64 [ %.0.i, %main_wrap_around.exit ], [ 10, %main_bb5 ]
  %"14" = icmp slt i64 100, %cur.0, !dbg !48
  br i1 %"14", label %main_bb11, label %main_bb7, !dbg !48

main_bb7:                                         ; preds = %main_bb6
  %"15" = add nsw i64 %cur.0, 10, !dbg !51
