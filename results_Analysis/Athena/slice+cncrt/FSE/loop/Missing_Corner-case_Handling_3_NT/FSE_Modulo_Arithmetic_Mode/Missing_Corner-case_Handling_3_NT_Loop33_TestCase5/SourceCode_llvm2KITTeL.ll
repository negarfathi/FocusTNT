...
main_wrap_around.exit2:                           ; preds = %main_bb29, %main_bb28, %main_bb27, %main_wrap_around.exit8
  ...
  %"60" = xor i1 %"59", true, !dbg !126
  br i1 %"60", label %main_wrap_around.exit4, label %main_bb30, !dbg !126
...
main_wrap_around.exit4:                           ; preds = %main_bb25, %main_bb24, %main_bb23, %main_wrap_around.exit2
  ...
  %"61" = sub nsw i64 10, 1, !dbg !130
  %"62" = icmp sgt i64 %"61", 2147483647, !dbg !133
  br i1 %"62", label %main_bb19, label %main_bb20, !dbg !133

main_bb19:                                        ; preds = %main_wrap_around.exit4
  %"63" = sub nsw i64 %"61", 2147483647, !dbg !134
  %"64" = sub nsw i64 %"63", 1, !dbg !134
  %"65" = srem i64 %"64", 4294967296, !dbg !134
  %"66" = add nsw i64 -2147483648, %"65", !dbg !134
  br label %main_wrap_around.exit6, !dbg !134

main_bb20:                                        ; preds = %main_wrap_around.exit4
  %"67" = icmp slt i64 %"61", -2147483648, !dbg !135
  br i1 %"67", label %main_bb21, label %main_wrap_around.exit6, !dbg !135

main_bb21:                                        ; preds = %main_bb20
  %"68" = sub nsw i64 -2147483648, %"61", !dbg !136
  %"69" = sub nsw i64 %"68", 1, !dbg !136
  %"70" = srem i64 %"69", 4294967296, !dbg !136
  %"71" = sub nsw i64 2147483647, %"70", !dbg !136
  br label %main_wrap_around.exit6, !dbg !136

main_wrap_around.exit6:                           ; preds = %main_bb19, %main_bb20, %main_bb21
  %.0.i5 = phi i64 [ %"66", %main_bb19 ], [ %"71", %main_bb21 ], [ %"61", %main_bb20 ], !dbg !130
  %"72" = icmp sle i64 %y.0, %.0.i5, !dbg !130
  br i1 %"72", label %main_bb22, label %main_bb26, !dbg !130

main_bb22:                                        ; preds = %main_wrap_around.exit6
  %"73" = mul nsw i64 %xmin.0, 10, !dbg !137
  %"74" = getelementptr inbounds i64* %"18", i64 %"73", !dbg !137
  %"75" = getelementptr inbounds i64* %"74", i64 %y.0, !dbg !137
  %"76" = load i64* %"75", align 8, !dbg !137
  %"77" = icmp ne i64 %"76", 0, !dbg !137
  %.found.1 = select i1 %"77", i64 1, i64 %found.1, !dbg !137
  %"78" = add nsw i64 %y.0, 1, !dbg !140
  %"79" = icmp sgt i64 %"78", 2147483647, !dbg !141
  br i1 %"79", label %main_bb23, label %main_bb24, !dbg !141
...
main_bb24:                                        ; preds = %main_bb22
  ...
  br i1 %"84", label %main_bb25, label %main_wrap_around.exit4, !dbg !143
...
main_bb26:                                        ; preds = %main_wrap_around.exit6
  %"89" = add nsw i64 %xmin.0, 1, !dbg !145
  call void @llvm.dbg.value(metadata !{i64 %"89"}, i64 0, metadata !146), !dbg !147
  call void @llvm.dbg.value(metadata !70, i64 0, metadata !148), !dbg !149
  call void @llvm.dbg.value(metadata !73, i64 0, metadata !150), !dbg !151
  call void @llvm.dbg.value(metadata !76, i64 0, metadata !152), !dbg !153
  %"90" = icmp sgt i64 %"89", 2147483647, !dbg !154
  br i1 %"90", label %main_bb27, label %main_bb28, !dbg !154

main_bb27:                                        ; preds = %main_bb26
  %"91" = sub nsw i64 %"89", 2147483647, !dbg !155
  %"92" = sub nsw i64 %"91", 1, !dbg !155
  %"93" = srem i64 %"92", 4294967296, !dbg !155
  %"94" = add nsw i64 -2147483648, %"93", !dbg !155
  br label %main_wrap_around.exit2, !dbg !155

main_bb28:                                        ; preds = %main_bb26
  %"95" = icmp slt i64 %"89", -2147483648, !dbg !156
  br i1 %"95", label %main_bb29, label %main_wrap_around.exit2, !dbg !156

main_bb29:                                        ; preds = %main_bb28
  %"96" = sub nsw i64 -2147483648, %"89", !dbg !157
  %"97" = sub nsw i64 %"96", 1, !dbg !157
  %"98" = srem i64 %"97", 4294967296, !dbg !157
  %"99" = sub nsw i64 2147483647, %"98", !dbg !157
  br label %main_wrap_around.exit2, !dbg !157

main_bb30:                                        ; preds = %main_wrap_around.exit2
  call void @llvm.stackrestore(i8* %"16"), !dbg !158
  br label %main_bb31
...
!127 = metadata !{i32 786443, metadata !1, metadata !128, i32 46, i32 10, i32 2, i32 28} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!130 = metadata !{i32 48, i32 37, metadata !131, null}
!131 = metadata !{i32 786443, metadata !1, metadata !132, i32 48, i32 9, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!132 = metadata !{i32 786443, metadata !1, metadata !129, i32 47, i32 5, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!133 = metadata !{i32 15, i32 9, metadata !26, metadata !130}
!134 = metadata !{i32 16, i32 9, metadata !28, metadata !130}
!135 = metadata !{i32 18, i32 14, metadata !30, metadata !130}
!136 = metadata !{i32 19, i32 9, metadata !32, metadata !130}
!137 = metadata !{i32 50, i32 17, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !139, i32 50, i32 17, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!139 = metadata !{i32 786443, metadata !1, metadata !131, i32 49, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!140 = metadata !{i32 48, i32 84, metadata !131, null}
!141 = metadata !{i32 15, i32 9, metadata !26, metadata !140}
!142 = metadata !{i32 16, i32 9, metadata !28, metadata !140}
!143 = metadata !{i32 18, i32 14, metadata !30, metadata !140}
!144 = metadata !{i32 19, i32 9, metadata !32, metadata !140}
!145 = metadata !{i32 46, i32 47, metadata !129, null}
!146 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777229, metadata !8, i32 0, metadata !145} ; [ DW_TAG_arg_variable ] [value] [line 13]
!147 = metadata !{i32 13, i32 33, metadata !4, metadata !145}
!148 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554445, metadata !8, i32 0, metadata !145} ; [ DW_TAG_arg_variable ] [lower_bound] [line 13]
!149 = metadata !{i32 13, i32 50, metadata !4, metadata !145}
!150 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331661, metadata !8, i32 0, metadata !145} ; [ DW_TAG_arg_variable ] [upper_bound] [line 13]
!151 = metadata !{i32 13, i32 73, metadata !4, metadata !145}
!152 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 14, metadata !8, i32 0, metadata !145} ; [ DW_TAG_auto_variable ] [range] [line 14]
!153 = metadata !{i32 14, i32 15, metadata !4, metadata !145}
!154 = metadata !{i32 15, i32 9, metadata !26, metadata !145}
!155 = metadata !{i32 16, i32 9, metadata !28, metadata !145}
!156 = metadata !{i32 18, i32 14, metadata !30, metadata !145}
!157 = metadata !{i32 19, i32 9, metadata !32, metadata !145}
!158 = metadata !{i32 57, i32 1, metadata !9, null}
