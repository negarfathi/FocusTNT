...
main_bb7:                                         ; preds = %main_bb2, %main_bb11
  ...
  %"22" = xor i1 %"21", true, !dbg !57
  br i1 %"22", label %main_bb8, label %main_bb12, !dbg !57

main_bb8:                                         ; preds = %main_bb7
  %"23" = sext i32 %xmin.0 to i64, !dbg !61
...
main_bb9:                                         ; preds = %main_bb10, %main_bb8
  ...
  %"24" = sub nsw i32 30, 1, !dbg !67
  %"25" = icmp sle i32 %y.0, %"24", !dbg !67
  br i1 %"25", label %main_bb10, label %main_bb11, !dbg !67

main_bb10:                                        ; preds = %main_bb9
  %"26" = sext i32 %y.0 to i64, !dbg !61
  %"27" = mul nsw i64 %"23", %"5", !dbg !61
  %"28" = getelementptr inbounds i32* %"8", i64 %"27", !dbg !61
  %"29" = getelementptr inbounds i32* %"28", i64 %"26", !dbg !61
  %"30" = load i32* %"29", align 4, !dbg !61
  %"31" = icmp ne i32 %"30", 0, !dbg !61
  %.found.1 = select i1 %"31", i32 1, i32 %found.1, !dbg !61
  %"32" = add nsw i32 %y.0, 1, !dbg !70
  br label %main_bb9, !dbg !70

main_bb11:                                        ; preds = %main_bb9
  %"33" = add nsw i32 %xmin.0, 1, !dbg !71
  call void @llvm.dbg.value(metadata !{i32 %"33"}, i64 0, metadata !72), !dbg !73
  br label %main_bb7, !dbg !71

main_bb12:                                        ; preds = %main_bb7
  call void @llvm.stackrestore(i8* %"6"), !dbg !74
  br label %main_bb13
...
!58 = metadata !{i32 786443, metadata !1, metadata !59, i32 30, i32 10, i32 2, i32 21} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!61 = metadata !{i32 34, i32 17, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !63, i32 34, i32 17, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!63 = metadata !{i32 786443, metadata !1, metadata !64, i32 33, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 786443, metadata !1, metadata !65, i32 32, i32 9, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!65 = metadata !{i32 786443, metadata !1, metadata !60, i32 31, i32 5, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!66 = metadata !{i32 32, i32 14, metadata !64, null}
!67 = metadata !{i32 32, i32 14, metadata !68, null}
!68 = metadata !{i32 786443, metadata !1, metadata !69, i32 32, i32 14, i32 2, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!69 = metadata !{i32 786443, metadata !1, metadata !64, i32 32, i32 14, i32 1, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!70 = metadata !{i32 32, i32 42, metadata !64, null}
!71 = metadata !{i32 30, i32 33, metadata !60, null}
!72 = metadata !{i32 786688, metadata !60, metadata !"xmin", metadata !5, i32 30, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [xmin] [line 30]
!73 = metadata !{i32 30, i32 14, metadata !60, null}
!74 = metadata !{i32 39, i32 1, metadata !4, null}
