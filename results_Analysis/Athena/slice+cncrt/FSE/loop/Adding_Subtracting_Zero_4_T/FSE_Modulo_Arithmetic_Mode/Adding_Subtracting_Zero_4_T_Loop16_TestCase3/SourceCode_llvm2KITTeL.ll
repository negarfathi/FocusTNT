...
read_slice_1_wrap_around.exit:                    ; preds = %read_slice_1_bb11, %read_slice_1_bb10, %read_slice_1_bb9, %read_slice_1_bb7
  %num.0 = phi i64 [ 500, %read_slice_1_bb7 ], [ %"20", %read_slice_1_bb9 ], [ %"25", %read_slice_1_bb11 ], [ %"15", %read_slice_1_bb10 ]
...
main_bb20:
  ...
  %"50" = icmp sle i64 3, 0, !dbg !116
  br i1 %"50", label %main_bb40, label %main_wrap_around.exit, !dbg !116

main_wrap_around.exit:                            ; preds = %main_bb39, %main_bb38, %main_bb37, %main_wrap_around.exit5, %main_bb20
  %tries.0 = phi i64 [ 0, %main_bb20 ], [ %.0.i4, %main_wrap_around.exit5 ], [ %tries.0, %main_bb37 ], [ %tries.0, %main_bb38 ], [ %tries.0, %main_bb39 ]
  %buf.0 = phi i64 [ 0, %main_bb20 ], [ %buf.0, %main_wrap_around.exit5 ], [ %"105", %main_bb37 ], [ %"110", %main_bb39 ], [ %"100", %main_bb38 ]
  %count.0 = phi i64 [ 3, %main_bb20 ], [ %count.0, %main_wrap_around.exit5 ], [ %.0.i2, %main_bb37 ], [ %.0.i2, %main_bb38 ], [ %.0.i2, %main_bb39 ]
  %"51" = icmp sgt i64 %count.0, 0, !dbg !118
  br i1 %"51", label %main_wrap_around.exit2.i, label %main_bb40, !dbg !118
...
main_read_slice_1.exit:                           ; preds = %main_wrap_around.exit2.i
  ...
  %"75" = icmp sle i64 %count.0.i, 0, !dbg !135
  br i1 %"75", label %main_bb28, label %main_bb33, !dbg !135

main_bb28:                                        ; preds = %main_read_slice_1.exit
  %"76" = icmp eq i64 %count.0.i, 0, !dbg !137
  br i1 %"76", label %main_bb29, label %main_bb40, !dbg !137

main_bb29:                                        ; preds = %main_bb28
  call void @llvm.dbg.value(metadata !{i64 %tries.0}, i64 0, metadata !140), !dbg !142
  %"77" = add nsw i64 %tries.0, 1, !dbg !143
  call void @llvm.dbg.value(metadata !{i64 %"77"}, i64 0, metadata !144), !dbg !145
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !146), !dbg !147
  ...
  %"78" = icmp sgt i64 %"77", 2147483647, !dbg !152
  br i1 %"78", label %main_bb30, label %main_bb31, !dbg !152

main_bb30:                                        ; preds = %main_bb29
  %"79" = sub nsw i64 %"77", 2147483647, !dbg !153
  %"80" = sub nsw i64 %"79", 1, !dbg !153
  %"81" = srem i64 %"80", 4294967296, !dbg !153
  %"82" = add nsw i64 -2147483648, %"81", !dbg !153
  br label %main_wrap_around.exit5, !dbg !153

main_bb31:                                        ; preds = %main_bb29
  %"83" = icmp slt i64 %"77", -2147483648, !dbg !154
  br i1 %"83", label %main_bb32, label %main_wrap_around.exit5, !dbg !154

main_bb32:                                        ; preds = %main_bb31
  %"84" = sub nsw i64 -2147483648, %"77", !dbg !155
  %"85" = sub nsw i64 %"84", 1, !dbg !155
  %"86" = srem i64 %"85", 4294967296, !dbg !155
  %"87" = sub nsw i64 2147483647, %"86", !dbg !155
  br label %main_wrap_around.exit5, !dbg !155

main_wrap_around.exit5:                           ; preds = %main_bb30, %main_bb31, %main_bb32
  %.0.i4 = phi i64 [ %"82", %main_bb30 ], [ %"87", %main_bb32 ], [ %"77", %main_bb31 ], !dbg !143
  call void @llvm.dbg.value(metadata !{i64 %.0.i4}, i64 0, metadata !156), !dbg !157
  %"88" = icmp slt i64 %tries.0, 5, !dbg !158
  br i1 %"88", label %main_wrap_around.exit, label %main_bb40, !dbg !158

main_bb33:                                        ; preds = %main_read_slice_1.exit
  %"89" = sub nsw i64 %count.0, %count.0.i, !dbg !160
  call void @llvm.dbg.value(metadata !{i64 %"89"}, i64 0, metadata !161), !dbg !162
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !163), !dbg !164
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !165), !dbg !166
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !167), !dbg !168
  %"90" = icmp sgt i64 %"89", 2147483647, !dbg !169
  br i1 %"90", label %main_bb34, label %main_bb35, !dbg !169

main_bb34:                                        ; preds = %main_bb33
  %"91" = sub nsw i64 %"89", 2147483647, !dbg !170
  %"92" = sub nsw i64 %"91", 1, !dbg !170
  %"93" = srem i64 %"92", 4294967296, !dbg !170
  %"94" = add nsw i64 -2147483648, %"93", !dbg !170
  br label %main_wrap_around.exit3, !dbg !170

main_bb35:                                        ; preds = %main_bb33
  %"95" = icmp slt i64 %"89", -2147483648, !dbg !171
  br i1 %"95", label %main_bb36, label %main_wrap_around.exit3, !dbg !171

main_bb36:                                        ; preds = %main_bb35
  %"96" = sub nsw i64 -2147483648, %"89", !dbg !172
  %"97" = sub nsw i64 %"96", 1, !dbg !172
  %"98" = srem i64 %"97", 4294967296, !dbg !172
  %"99" = sub nsw i64 2147483647, %"98", !dbg !172
  br label %main_wrap_around.exit3, !dbg !172

main_wrap_around.exit3:                           ; preds = %main_bb34, %main_bb35, %main_bb36
  %.0.i2 = phi i64 [ %"94", %main_bb34 ], [ %"99", %main_bb36 ], [ %"89", %main_bb35 ], !dbg !160
  call void @llvm.dbg.value(metadata !{i64 %.0.i2}, i64 0, metadata !114), !dbg !115
  %"100" = add nsw i64 %buf.0, %count.0.i, !dbg !173
  call void @llvm.dbg.value(metadata !{i64 %"100"}, i64 0, metadata !174), !dbg !175
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !176), !dbg !177
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !178), !dbg !179
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !180), !dbg !181
  %"101" = icmp sgt i64 %"100", 2147483647, !dbg !182
  br i1 %"101", label %main_bb37, label %main_bb38, !dbg !182

main_bb37:                                        ; preds = %main_wrap_around.exit3
  %"102" = sub nsw i64 %"100", 2147483647, !dbg !183
  %"103" = sub nsw i64 %"102", 1, !dbg !183
  %"104" = srem i64 %"103", 4294967296, !dbg !183
  %"105" = add nsw i64 -2147483648, %"104", !dbg !183
  br label %main_wrap_around.exit, !dbg !183

main_bb38:                                        ; preds = %main_wrap_around.exit3
  %"106" = icmp slt i64 %"100", -2147483648, !dbg !184
  br i1 %"106", label %main_bb39, label %main_wrap_around.exit, !dbg !184

main_bb39:                                        ; preds = %main_bb38
  %"107" = sub nsw i64 -2147483648, %"100", !dbg !185
  %"108" = sub nsw i64 %"107", 1, !dbg !185
  %"109" = srem i64 %"108", 4294967296, !dbg !185
  %"110" = sub nsw i64 2147483647, %"109", !dbg !185
  br label %main_wrap_around.exit, !dbg !185

main_bb40:                                        ; preds = %main_wrap_around.exit, %main_bb28, %main_wrap_around.exit5, %main_bb20
  ret void, !dbg !186
}
...
!135 = metadata !{i32 60, i32 9, metadata !136, null}
!136 = metadata !{i32 786443, metadata !1, metadata !121, i32 60, i32 9, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!137 = metadata !{i32 61, i32 11, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !139, i32 61, i32 11, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!139 = metadata !{i32 786443, metadata !1, metadata !136, i32 60, i32 19, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!140 = metadata !{i32 786688, metadata !141, metadata !"tmp_0", metadata !5, i32 62, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tmp_0] [line 62]
!141 = metadata !{i32 786443, metadata !1, metadata !138, i32 61, i32 21, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!142 = metadata !{i32 62, i32 19, metadata !141, null}
!143 = metadata !{i32 64, i32 18, metadata !141, null}
!144 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !143} ; [ DW_TAG_arg_variable ] [value] [line 8]
!145 = metadata !{i32 8, i32 33, metadata !4, metadata !143} ; [ DW_TAG_imported_declaration ]
!146 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !143} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!147 = metadata !{i32 8, i32 50, metadata !4, metadata !143} ; [ DW_TAG_imported_declaration ]
!148 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !143} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!149 = metadata !{i32 8, i32 73, metadata !4, metadata !143} ; [ DW_TAG_imported_declaration ]
!150 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !143} ; [ DW_TAG_auto_variable ] [range] [line 9]
!151 = metadata !{i32 9, i32 15, metadata !4, metadata !143}
!152 = metadata !{i32 10, i32 9, metadata !30, metadata !143}
!153 = metadata !{i32 11, i32 9, metadata !32, metadata !143}
!154 = metadata !{i32 13, i32 14, metadata !34, metadata !143}
!155 = metadata !{i32 14, i32 9, metadata !36, metadata !143}
!156 = metadata !{i32 786688, metadata !12, metadata !"tries", metadata !5, i32 57, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [tries] [line 57]
!157 = metadata !{i32 57, i32 13, metadata !12, null}
!158 = metadata !{i32 65, i32 13, metadata !159, null}
!159 = metadata !{i32 786443, metadata !1, metadata !141, i32 65, i32 13, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!160 = metadata !{i32 72, i32 13, metadata !121, null}
!161 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !160} ; [ DW_TAG_arg_variable ] [value] [line 8]
!162 = metadata !{i32 8, i32 33, metadata !4, metadata !160} ; [ DW_TAG_imported_declaration ]
!163 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !160} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!164 = metadata !{i32 8, i32 50, metadata !4, metadata !160} ; [ DW_TAG_imported_declaration ]
!165 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !160} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!166 = metadata !{i32 8, i32 73, metadata !4, metadata !160} ; [ DW_TAG_imported_declaration ]
!167 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !160} ; [ DW_TAG_auto_variable ] [range] [line 9]
!168 = metadata !{i32 9, i32 15, metadata !4, metadata !160}
!169 = metadata !{i32 10, i32 9, metadata !30, metadata !160}
!170 = metadata !{i32 11, i32 9, metadata !32, metadata !160}
!171 = metadata !{i32 13, i32 14, metadata !34, metadata !160}
!172 = metadata !{i32 14, i32 9, metadata !36, metadata !160}
!173 = metadata !{i32 73, i32 11, metadata !121, null}
!174 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777224, metadata !8, i32 0, metadata !173} ; [ DW_TAG_arg_variable ] [value] [line 8]
!175 = metadata !{i32 8, i32 33, metadata !4, metadata !173} ; [ DW_TAG_imported_declaration ]
!176 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554440, metadata !8, i32 0, metadata !173} ; [ DW_TAG_arg_variable ] [lower_bound] [line 8]
!177 = metadata !{i32 8, i32 50, metadata !4, metadata !173} ; [ DW_TAG_imported_declaration ]
!178 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331656, metadata !8, i32 0, metadata !173} ; [ DW_TAG_arg_variable ] [upper_bound] [line 8]
!179 = metadata !{i32 8, i32 73, metadata !4, metadata !173} ; [ DW_TAG_imported_declaration ]
!180 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 9, metadata !8, i32 0, metadata !173} ; [ DW_TAG_auto_variable ] [range] [line 9]
!181 = metadata !{i32 9, i32 15, metadata !4, metadata !173}
!182 = metadata !{i32 10, i32 9, metadata !30, metadata !173}
!183 = metadata !{i32 11, i32 9, metadata !32, metadata !173}
!184 = metadata !{i32 13, i32 14, metadata !34, metadata !173}
!185 = metadata !{i32 14, i32 9, metadata !36, metadata !173}
!186 = metadata !{i32 75, i32 17, metadata !12, null}
