...
read_slice_1_wrap_around.exit:                    ; preds = %read_slice_1_bb11, %read_slice_1_bb10, %read_slice_1_bb9, %read_slice_1_bb7
  %num.0 = phi i64 [ 1, %read_slice_1_bb7 ], [ %"20", %read_slice_1_bb9 ], [ %"25", %read_slice_1_bb11 ], [ %"15", %read_slice_1_bb10 ]
...
main_wrap_around.exit:                            ; preds = %main_bb39, %main_bb38, %main_bb37, %main_wrap_around.exit5, %main_bb20
  ...
  %count.0 = phi i64 [ 15, %main_bb20 ], [ %count.0, %main_wrap_around.exit5 ], [ %.0.i2, %main_bb37 ], [ %.0.i2, %main_bb38 ], [ %.0.i2, %main_bb39 ]
