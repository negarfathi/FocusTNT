...
main_bb21:
  ...
  %"52" = icmp sle i64 15, 0, !dbg !84
  br i1 %"52", label %main_bb43, label %main_bb22, !dbg !84
...
main_bb22:                                        ; preds = %main_bb21
  ...
  call void @llvm.dbg.value(metadata !{i64 %"81"}, i64 0, metadata !107), !dbg !109
  ...
  call void @llvm.dbg.value(metadata !{i64 %.0.i4}, i64 0, metadata !88), !dbg !89
  call void @llvm.dbg.value(metadata !{i64 %"93"}, i64 0, metadata !119), !dbg !121
  ...
  call void @llvm.dbg.value(metadata !{i64 %"104"}, i64 0, metadata !128), !dbg !130
...
main_wrap_around.exit:                            ; preds = %main_bb42, %main_bb41, %main_bb40, %main_wrap_around.exit5, %main_bb22
  %tries.0 = phi i64 [ 0, %main_bb22 ], [ %.0.i4, %main_wrap_around.exit5 ], [ %tries.0, %main_bb40 ], [ %tries.0, %main_bb41 ], [ %tries.0, %main_bb42 ]
  %buf.0 = phi i64 [ 0, %main_bb22 ], [ %buf.0, %main_wrap_around.exit5 ], [ %"109", %main_bb40 ], [ %"114", %main_bb42 ], [ %"104", %main_bb41 ]
  %count.0 = phi i64 [ 15, %main_bb22 ], [ %count.0, %main_wrap_around.exit5 ], [ %.0.i2, %main_bb40 ], [ %.0.i2, %main_bb41 ], [ %.0.i2, %main_bb42 ]
  %"54" = icmp sgt i64 %count.0, 0, !dbg !138
  br i1 %"54", label %main_bb23, label %main_bb43, !dbg !138

main_bb23:                                        ; preds = %main_wrap_around.exit
  %"55" = icmp eq i64 %"53", 1, !dbg !98
  br i1 %"55", label %main_read_slice_1.exit, label %main_wrap_around.exit2.i, !dbg !98

main_wrap_around.exit2.i:                         ; preds = %main_bb30, %main_bb29, %main_bb28, %main_bb23
  %count.0.i = phi i64 [ 0, %main_bb23 ], [ %.0.i3.i, %main_bb28 ], [ %.0.i3.i, %main_bb29 ], [ %.0.i3.i, %main_bb30 ], !dbg !91
  %.0.i = phi i64 [ %buf.0, %main_bb23 ], [ %"73", %main_bb28 ], [ %"78", %main_bb30 ], [ %"68", %main_bb29 ], !dbg !91
  %"56" = icmp slt i64 %.0.i, %count.0, !dbg !140
  br i1 %"56", label %main_bb24, label %main_read_slice_1.exit, !dbg !140

main_bb24:                                        ; preds = %main_wrap_around.exit2.i
  %"57" = add nsw i64 %count.0.i, 1, !dbg !141
  %"58" = icmp sgt i64 %"57", 2147483647, !dbg !142
  br i1 %"58", label %main_bb25, label %main_bb26, !dbg !142

main_bb25:                                        ; preds = %main_bb24
  %"59" = sub nsw i64 %"57", 2147483647, !dbg !143
  %"60" = sub nsw i64 %"59", 1, !dbg !143
  %"61" = srem i64 %"60", 4294967296, !dbg !143
  %"62" = add nsw i64 -2147483648, %"61", !dbg !143
  br label %main_wrap_around.exit4.i, !dbg !143

main_bb26:                                        ; preds = %main_bb24
  %"63" = icmp slt i64 %"57", -2147483648, !dbg !144
  br i1 %"63", label %main_bb27, label %main_wrap_around.exit4.i, !dbg !144

main_bb27:                                        ; preds = %main_bb26
  %"64" = sub nsw i64 -2147483648, %"57", !dbg !145
  %"65" = sub nsw i64 %"64", 1, !dbg !145
  %"66" = srem i64 %"65", 4294967296, !dbg !145
  %"67" = sub nsw i64 2147483647, %"66", !dbg !145
  br label %main_wrap_around.exit4.i, !dbg !145

main_wrap_around.exit4.i:                         ; preds = %main_bb27, %main_bb26, %main_bb25
  %.0.i3.i = phi i64 [ %"62", %main_bb25 ], [ %"67", %main_bb27 ], [ %"57", %main_bb26 ], !dbg !141
  %"68" = add nsw i64 %.0.i, 1, !dbg !146
  %"69" = icmp sgt i64 %"68", 2147483647, !dbg !147
  br i1 %"69", label %main_bb28, label %main_bb29, !dbg !147

main_bb28:                                        ; preds = %main_wrap_around.exit4.i
  %"70" = sub nsw i64 %"68", 2147483647, !dbg !148
  %"71" = sub nsw i64 %"70", 1, !dbg !148
  %"72" = srem i64 %"71", 4294967296, !dbg !148
  %"73" = add nsw i64 -2147483648, %"72", !dbg !148
  br label %main_wrap_around.exit2.i, !dbg !148

main_bb29:                                        ; preds = %main_wrap_around.exit4.i
  %"74" = icmp slt i64 %"68", -2147483648, !dbg !149
  br i1 %"74", label %main_bb30, label %main_wrap_around.exit2.i, !dbg !149

main_bb30:                                        ; preds = %main_bb29
  %"75" = sub nsw i64 -2147483648, %"68", !dbg !150
  %"76" = sub nsw i64 %"75", 1, !dbg !150
  %"77" = srem i64 %"76", 4294967296, !dbg !150
  %"78" = sub nsw i64 2147483647, %"77", !dbg !150
  br label %main_wrap_around.exit2.i, !dbg !150

main_read_slice_1.exit:                           ; preds = %main_bb23, %main_wrap_around.exit2.i
  %__retres.0.i = phi i64 [ 0, %main_bb23 ], [ %count.0.i, %main_wrap_around.exit2.i ], !dbg !91
  %"79" = icmp sle i64 %__retres.0.i, 0, !dbg !151
  br i1 %"79", label %main_bb31, label %main_bb36, !dbg !151

main_bb31:                                        ; preds = %main_read_slice_1.exit
  %"80" = icmp eq i64 %__retres.0.i, 0, !dbg !152
  br i1 %"80", label %main_bb32, label %main_bb43, !dbg !152

main_bb32:                                        ; preds = %main_bb31
  %"81" = add nsw i64 %tries.0, 1, !dbg !108
  %"82" = icmp sgt i64 %"81", 2147483647, !dbg !153
  br i1 %"82", label %main_bb33, label %main_bb34, !dbg !153

main_bb33:                                        ; preds = %main_bb32
  %"83" = sub nsw i64 %"81", 2147483647, !dbg !154
  %"84" = sub nsw i64 %"83", 1, !dbg !154
  %"85" = srem i64 %"84", 4294967296, !dbg !154
  %"86" = add nsw i64 -2147483648, %"85", !dbg !154
  br label %main_wrap_around.exit5, !dbg !154

main_bb34:                                        ; preds = %main_bb32
  %"87" = icmp slt i64 %"81", -2147483648, !dbg !155
  br i1 %"87", label %main_bb35, label %main_wrap_around.exit5, !dbg !155

main_bb35:                                        ; preds = %main_bb34
  %"88" = sub nsw i64 -2147483648, %"81", !dbg !156
  %"89" = sub nsw i64 %"88", 1, !dbg !156
  %"90" = srem i64 %"89", 4294967296, !dbg !156
  %"91" = sub nsw i64 2147483647, %"90", !dbg !156
  br label %main_wrap_around.exit5, !dbg !156

main_wrap_around.exit5:                           ; preds = %main_bb33, %main_bb34, %main_bb35
  %.0.i4 = phi i64 [ %"86", %main_bb33 ], [ %"91", %main_bb35 ], [ %"81", %main_bb34 ], !dbg !108
  %"92" = icmp slt i64 %tries.0, 5, !dbg !157
  br i1 %"92", label %main_wrap_around.exit, label %main_bb43, !dbg !157

main_bb36:                                        ; preds = %main_read_slice_1.exit
  %"93" = sub nsw i64 %count.0, %__retres.0.i, !dbg !120
  %"94" = icmp sgt i64 %"93", 2147483647, !dbg !159
  br i1 %"94", label %main_bb37, label %main_bb38, !dbg !159

main_bb37:                                        ; preds = %main_bb36
  %"95" = sub nsw i64 %"93", 2147483647, !dbg !160
  %"96" = sub nsw i64 %"95", 1, !dbg !160
  %"97" = srem i64 %"96", 4294967296, !dbg !160
  %"98" = add nsw i64 -2147483648, %"97", !dbg !160
  br label %main_wrap_around.exit3, !dbg !160

main_bb38:                                        ; preds = %main_bb36
  %"99" = icmp slt i64 %"93", -2147483648, !dbg !161
  br i1 %"99", label %main_bb39, label %main_wrap_around.exit3, !dbg !161

main_bb39:                                        ; preds = %main_bb38
  %"100" = sub nsw i64 -2147483648, %"93", !dbg !162
  %"101" = sub nsw i64 %"100", 1, !dbg !162
  %"102" = srem i64 %"101", 4294967296, !dbg !162
  %"103" = sub nsw i64 2147483647, %"102", !dbg !162
  br label %main_wrap_around.exit3, !dbg !162

main_wrap_around.exit3:                           ; preds = %main_bb37, %main_bb38, %main_bb39
  %.0.i2 = phi i64 [ %"98", %main_bb37 ], [ %"103", %main_bb39 ], [ %"93", %main_bb38 ], !dbg !120
  %"104" = add nsw i64 %buf.0, %__retres.0.i, !dbg !129
  %"105" = icmp sgt i64 %"104", 2147483647, !dbg !163
  br i1 %"105", label %main_bb40, label %main_bb41, !dbg !163

main_bb40:                                        ; preds = %main_wrap_around.exit3
  %"106" = sub nsw i64 %"104", 2147483647, !dbg !164
  %"107" = sub nsw i64 %"106", 1, !dbg !164
  %"108" = srem i64 %"107", 4294967296, !dbg !164
  %"109" = add nsw i64 -2147483648, %"108", !dbg !164
  br label %main_wrap_around.exit, !dbg !164

main_bb41:                                        ; preds = %main_wrap_around.exit3
  %"110" = icmp slt i64 %"104", -2147483648, !dbg !165
  br i1 %"110", label %main_bb42, label %main_wrap_around.exit, !dbg !165

main_bb42:                                        ; preds = %main_bb41
  %"111" = sub nsw i64 -2147483648, %"104", !dbg !166
  %"112" = sub nsw i64 %"111", 1, !dbg !166
  %"113" = srem i64 %"112", 4294967296, !dbg !166
  %"114" = sub nsw i64 2147483647, %"113", !dbg !166
  br label %main_wrap_around.exit, !dbg !166

main_bb43:                                        ; preds = %main_wrap_around.exit, %main_bb31, %main_wrap_around.exit5, %main_bb21
  ret void, !dbg !167
}
...
!141 = metadata !{i32 38, i32 16, metadata !54, metadata !91}
...
!146 = metadata !{i32 40, i32 10, metadata !70, metadata !91}
!147 = metadata !{i32 10, i32 9, metadata !30, metadata !146}
!148 = metadata !{i32 11, i32 9, metadata !32, metadata !146}
!149 = metadata !{i32 13, i32 14, metadata !34, metadata !146}
!150 = metadata !{i32 14, i32 9, metadata !36, metadata !146}
!151 = metadata !{i32 67, i32 9, metadata !105, null}
!152 = metadata !{i32 68, i32 11, metadata !103, null}
!153 = metadata !{i32 10, i32 9, metadata !30, metadata !108}
!154 = metadata !{i32 11, i32 9, metadata !32, metadata !108}
!155 = metadata !{i32 13, i32 14, metadata !34, metadata !108}
!156 = metadata !{i32 14, i32 9, metadata !36, metadata !108}
!157 = metadata !{i32 72, i32 13, metadata !158, null}
!158 = metadata !{i32 786443, metadata !1, metadata !102, i32 72, i32 13, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!159 = metadata !{i32 10, i32 9, metadata !30, metadata !120}
!160 = metadata !{i32 11, i32 9, metadata !32, metadata !120}
!161 = metadata !{i32 13, i32 14, metadata !34, metadata !120}
!162 = metadata !{i32 14, i32 9, metadata !36, metadata !120}
!163 = metadata !{i32 10, i32 9, metadata !30, metadata !129}
!164 = metadata !{i32 11, i32 9, metadata !32, metadata !129}
!165 = metadata !{i32 13, i32 14, metadata !34, metadata !129}
!166 = metadata !{i32 14, i32 9, metadata !36, metadata !129}
!167 = metadata !{i32 82, i32 17, metadata !12, null}
