...
main_bb6:
  ...
  br i1 %"8", label %main_bb9, label %main_bb7, !dbg !48

main_bb7:                                         ; preds = %main_bb6, %main_bb8
  %buf.0 = phi i32 [ %"13", %main_bb8 ], [ 0, %main_bb6 ]
  %count.0 = phi i32 [ %"12", %main_bb8 ], [ 5, %main_bb6 ]
  %"9" = icmp sgt i32 %count.0, 0, !dbg !50
  br i1 %"9", label %main_read_slice_1.exit, label %main_bb9, !dbg !50

main_read_slice_1.exit:                           ; preds = %main_bb7
  %"10" = icmp slt i32 %buf.0, %count.0, !dbg !52
  %. = select i1 %"10", i32 -1, i32 0, !dbg !52
  %"11" = icmp slt i32 %., 0, !dbg !55
  br i1 %"11", label %main_bb9, label %main_bb8, !dbg !55

main_bb8:                                         ; preds = %main_read_slice_1.exit
  %"12" = sub nsw i32 %count.0, %., !dbg !57
  %"13" = add nsw i32 %buf.0, %., !dbg !58
  br label %main_bb7, !dbg !59
...
!29 = metadata !{i32 786443, metadata !1, metadata !4, i32 10, i32 3, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!36 = metadata !{i32 786443, metadata !1, metadata !33, i32 18, i32 20, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!42 = metadata !{i32 786443, metadata !1, metadata !40, i32 21, i32 22, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!50 = metadata !{i32 39, i32 3, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !9, i32 39, i32 3, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!56 = metadata !{i32 786443, metadata !1, metadata !54, i32 41, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 45, i32 5, metadata !54, null}
!58 = metadata !{i32 46, i32 5, metadata !54, null}
!59 = metadata !{i32 47, i32 3, metadata !54, null}
!60 = metadata !{i32 48, i32 17, metadata !9, null}
