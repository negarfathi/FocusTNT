...
main_bb5:
  ...
  br i1 %or.cond, label %main_bb10, label %main_wrap_around.exit, !dbg !38

main_wrap_around.exit:                            ; preds = %main_bb5, %main_bb9, %main_bb8, %main_bb7
  %i.0 = phi i64 [ %"20", %main_bb7 ], [ %"25", %main_bb9 ], [ %"15", %main_bb8 ], [ 0, %main_bb5 ]
  %"14" = icmp slt i64 %i.0, 0, !dbg !42
  br i1 %"14", label %main_bb6, label %main_bb10, !dbg !42

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"15" = add nsw i64 %i.0, 1, !dbg !44
...
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 3, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 34, i32 8, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 1, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!50 = metadata !{i32 36, i32 17, metadata !9, null}
