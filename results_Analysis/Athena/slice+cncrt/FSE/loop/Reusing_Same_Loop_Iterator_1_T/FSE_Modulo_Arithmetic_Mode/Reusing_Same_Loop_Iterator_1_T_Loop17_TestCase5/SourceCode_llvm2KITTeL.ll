...
main_bb6:                                         ; preds = %main_wrap_around.exit
  %"15" = add nsw i64 %i.0, 1, !dbg !45
  %"16" = icmp sgt i64 %"15", 2147483647, !dbg !47
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !47

main_bb7:                                         ; preds = %main_bb6
  %"17" = sub nsw i64 %"15", 2147483647, !dbg !48
  %"18" = sub nsw i64 %"17", 1, !dbg !48
  %"19" = srem i64 %"18", 4294967296, !dbg !48
  %"20" = add nsw i64 -2147483648, %"19", !dbg !48
  br label %main_wrap_around.exit, !dbg !48

main_bb8:                                         ; preds = %main_bb6
  %"21" = icmp slt i64 %"15", -2147483648, !dbg !49
  br i1 %"21", label %main_bb9, label %main_wrap_around.exit, !dbg !49

main_bb9:                                         ; preds = %main_bb8
  %"22" = sub nsw i64 -2147483648, %"15", !dbg !50
  %"23" = sub nsw i64 %"22", 1, !dbg !50
  %"24" = srem i64 %"23", 4294967296, !dbg !50
  %"25" = sub nsw i64 2147483647, %"24", !dbg !50
