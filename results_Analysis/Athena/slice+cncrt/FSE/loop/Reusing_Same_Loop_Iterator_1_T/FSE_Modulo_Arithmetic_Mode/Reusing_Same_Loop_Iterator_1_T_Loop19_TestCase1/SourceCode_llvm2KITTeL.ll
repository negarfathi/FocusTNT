...
main_bb5:
  ...
  %"12" = icmp sgt i64 0, 65534, !dbg !38
  %"13" = icmp sgt i64 0, 65534, !dbg !40
  %or.cond = or i1 %"12", %"13", !dbg !38
  br i1 %or.cond, label %main_bb14, label %main_wrap_around.exit2, !dbg !38
...
main_wrap_around.exit2:                           ; preds = %main_bb5, %main_bb13, %main_bb12, %main_bb11
  ...
  %"14" = icmp slt i64 %i.0, 0, !dbg !42
  br i1 %"14", label %main_wrap_around.exit, label %main_bb14, !dbg !42
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"15" = icmp slt i64 %j.0, 0, !dbg !44
  br i1 %"15", label %main_bb6, label %main_bb10, !dbg !44

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"16" = add nsw i64 %j.0, 1, !dbg !47
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  %"27" = add nsw i64 %i.0, 1, !dbg !53
  call void @llvm.dbg.value(metadata !{i64 %"27"}, i64 0, metadata !54), !dbg !55
  ...
  %"28" = icmp sgt i64 %"27", 2147483647, !dbg !65
  br i1 %"28", label %main_bb11, label %main_bb12, !dbg !65

main_bb11:                                        ; preds = %main_bb10
  %"29" = sub nsw i64 %"27", 2147483647, !dbg !66
  %"30" = sub nsw i64 %"29", 1, !dbg !66
  %"31" = srem i64 %"30", 4294967296, !dbg !66
  %"32" = add nsw i64 -2147483648, %"31", !dbg !66
  br label %main_wrap_around.exit2, !dbg !66

main_bb12:                                        ; preds = %main_bb10
  %"33" = icmp slt i64 %"27", -2147483648, !dbg !67
  br i1 %"33", label %main_bb13, label %main_wrap_around.exit2, !dbg !67

main_bb13:                                        ; preds = %main_bb12
  %"34" = sub nsw i64 -2147483648, %"27", !dbg !68
  %"35" = sub nsw i64 %"34", 1, !dbg !68
  %"36" = srem i64 %"35", 4294967296, !dbg !68
  %"37" = sub nsw i64 2147483647, %"36", !dbg !68
...
!36 = metadata !{i32 786688, metadata !9, metadata !"num_output", metadata !5, i32 23, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [num_output] [line 23]
...
!42 = metadata !{i32 33, i32 3, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 3, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 35, i32 5, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !46, i32 35, i32 5, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 33, i32 24, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 36, i32 8, metadata !48, null}
!48 = metadata !{i32 786443, metadata !1, metadata !46, i32 36, i32 1, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!49 = metadata !{i32 9, i32 9, metadata !25, metadata !47}
!50 = metadata !{i32 10, i32 9, metadata !27, metadata !47}
!51 = metadata !{i32 12, i32 14, metadata !29, metadata !47}
!52 = metadata !{i32 13, i32 9, metadata !31, metadata !47}
!53 = metadata !{i32 38, i32 10, metadata !46, null}
!54 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !53} ; [ DW_TAG_arg_variable ] [value] [line 7]
...
!65 = metadata !{i32 9, i32 9, metadata !25, metadata !53}
!66 = metadata !{i32 10, i32 9, metadata !27, metadata !53}
!67 = metadata !{i32 12, i32 14, metadata !29, metadata !53}
!68 = metadata !{i32 13, i32 9, metadata !31, metadata !53}
!69 = metadata !{i32 40, i32 17, metadata !9, null}
