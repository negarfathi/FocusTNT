...
main_bb10:
  ...
  call void @llvm.dbg.value(metadata !72, i64 0, metadata !84), !dbg !86
  call void @llvm.dbg.value(metadata !54, i64 0, metadata !87), !dbg !91
  call void @llvm.dbg.value(metadata !57, i64 0, metadata !92), !dbg !93
  call void @llvm.dbg.value(metadata !60, i64 0, metadata !94), !dbg !95
  call void @llvm.dbg.value(metadata !{i64 %"29"}, i64 0, metadata !96), !dbg !99
  call void @llvm.dbg.value(metadata !{i64 %"31"}, i64 0, metadata !100), !dbg !102
  call void @llvm.dbg.value(metadata !54, i64 0, metadata !103), !dbg !104
  call void @llvm.dbg.value(metadata !57, i64 0, metadata !105), !dbg !106
  call void @llvm.dbg.value(metadata !60, i64 0, metadata !107), !dbg !108
  call void @llvm.dbg.value(metadata !{i64 %"45"}, i64 0, metadata !82), !dbg !83
  call void @llvm.dbg.value(metadata !{i64 %"47"}, i64 0, metadata !109), !dbg !111
  call void @llvm.dbg.value(metadata !{i64 %"49"}, i64 0, metadata !112), !dbg !114
  call void @llvm.dbg.value(metadata !54, i64 0, metadata !115), !dbg !116
  call void @llvm.dbg.value(metadata !57, i64 0, metadata !117), !dbg !118
  call void @llvm.dbg.value(metadata !60, i64 0, metadata !119), !dbg !120
  call void @llvm.dbg.value(metadata !{i64 %"63"}, i64 0, metadata !82), !dbg !83
  call void @llvm.dbg.value(metadata !72, i64 0, metadata !82), !dbg !83
  br label %main_bb11, !dbg !121

main_bb11:                                        ; preds = %main_NewDefault, %main_bb13, %main_bb10
  %matroska.0 = phi i64 [ 1, %main_bb10 ], [ 1, %main_bb13 ], [ %matroska.0, %main_NewDefault ]
  %"27" = icmp eq i64 %matroska.0, 1, !dbg !122
  %..i = select i1 %"27", i64 0, i64 1, !dbg !123
  %"28" = icmp ne i64 %..i, 0, !dbg !124
  br i1 %"28", label %main_bb12, label %main_bb22, !dbg !124

main_bb12:                                        ; preds = %main_res_return_slice_1.exit4, %main_res_return_slice_1.exit7, %main_bb11
  %res.0 = phi i64 [ 0, %main_bb11 ], [ %., %main_res_return_slice_1.exit4 ], [ %"45", %main_res_return_slice_1.exit7 ]
...
main_bb14:                                        ; preds = %main_LeafBlock8
  %"29" = load i64* @"'flag", align 8, !dbg !129
  %"30" = load i64* @"'flag", align 8, !dbg !101
  %"31" = add nsw i64 %"30", 1, !dbg !101
  %"32" = icmp sgt i64 %"31", 2147483647, !dbg !130
  br i1 %"32", label %main_bb15, label %main_bb16, !dbg !130

main_bb15:                                        ; preds = %main_bb14
  %"33" = sub nsw i64 %"31", 2147483647, !dbg !131
  %"34" = sub nsw i64 %"33", 1, !dbg !131
  %"35" = srem i64 %"34", 4294967296, !dbg !131
  %"36" = add nsw i64 -2147483648, %"35", !dbg !131
  br label %main_res_return_slice_1.exit7, !dbg !131

main_bb16:                                        ; preds = %main_bb14
  %"37" = icmp slt i64 %"31", -2147483648, !dbg !132
  br i1 %"37", label %main_bb17, label %main_res_return_slice_1.exit7, !dbg !132

main_bb17:                                        ; preds = %main_bb16
  %"38" = sub nsw i64 -2147483648, %"31", !dbg !133
  %"39" = sub nsw i64 %"38", 1, !dbg !133
  %"40" = srem i64 %"39", 4294967296, !dbg !133
  %"41" = sub nsw i64 2147483647, %"40", !dbg !133
  br label %main_res_return_slice_1.exit7, !dbg !133

main_res_return_slice_1.exit7:                    ; preds = %main_bb15, %main_bb16, %main_bb17
  %.0.i.i5 = phi i64 [ %"36", %main_bb15 ], [ %"41", %main_bb17 ], [ %"31", %main_bb16 ], !dbg !101
  store i64 %.0.i.i5, i64* @"'flag", align 8, !dbg !101
  %"42" = icmp slt i64 %"29", 100, !dbg !134
  %..i6 = select i1 %"42", i64 0, i64 -1, !dbg !135
  %"43" = icmp slt i64 %..i6, 0, !dbg !136
  %"44" = zext i1 %"43" to i32, !dbg !136
  %"45" = sext i32 %"44" to i64, !dbg !136
  %"46" = icmp ne i64 %"45", 0, !dbg !137
  br i1 %"46", label %main_bb12, label %main_bb18, !dbg !137

main_bb18:                                        ; preds = %main_res_return_slice_1.exit7
  %"47" = load i64* @"'flag", align 8, !dbg !139
  %"48" = load i64* @"'flag", align 8, !dbg !113
  %"49" = add nsw i64 %"48", 1, !dbg !113
  %"50" = icmp sgt i64 %"49", 2147483647, !dbg !140
  br i1 %"50", label %main_bb19, label %main_bb20, !dbg !140

main_bb19:                                        ; preds = %main_bb18
  %"51" = sub nsw i64 %"49", 2147483647, !dbg !141
  %"52" = sub nsw i64 %"51", 1, !dbg !141
  %"53" = srem i64 %"52", 4294967296, !dbg !141
  %"54" = add nsw i64 -2147483648, %"53", !dbg !141
  br label %main_res_return_slice_1.exit4, !dbg !141

main_bb20:                                        ; preds = %main_bb18
  %"55" = icmp slt i64 %"49", -2147483648, !dbg !142
  br i1 %"55", label %main_bb21, label %main_res_return_slice_1.exit4, !dbg !142

main_bb21:                                        ; preds = %main_bb20
  %"56" = sub nsw i64 -2147483648, %"49", !dbg !143
  %"57" = sub nsw i64 %"56", 1, !dbg !143
  %"58" = srem i64 %"57", 4294967296, !dbg !143
  %"59" = sub nsw i64 2147483647, %"58", !dbg !143
  br label %main_res_return_slice_1.exit4, !dbg !143

main_res_return_slice_1.exit4:                    ; preds = %main_bb19, %main_bb20, %main_bb21
  %.0.i.i2 = phi i64 [ %"54", %main_bb19 ], [ %"59", %main_bb21 ], [ %"49", %main_bb20 ], !dbg !113
  store i64 %.0.i.i2, i64* @"'flag", align 8, !dbg !113
  %"60" = icmp slt i64 %"47", 100, !dbg !144
  %..i3 = select i1 %"60", i64 0, i64 -1, !dbg !145
  %"61" = icmp eq i64 %..i3, 0, !dbg !146
  %"62" = zext i1 %"61" to i32, !dbg !146
  %"63" = sext i32 %"62" to i64, !dbg !146
  %"64" = icmp ne i64 %"63", 0, !dbg !147
  %. = select i1 %"64", i64 1, i64 %"63", !dbg !147
  br label %main_bb12, !dbg !149
...
!84 = metadata !{i32 786688, metadata !85, metadata !"id", metadata !5, i32 55, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [id] [line 55]
!85 = metadata !{i32 786443, metadata !1, metadata !77, i32 54, i32 22, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!86 = metadata !{i32 55, i32 17, metadata !85, null}
!87 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !88} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!88 = metadata !{i32 32, i32 11, metadata !12, metadata !89}
!89 = metadata !{i32 77, i32 32, metadata !90, null}
!90 = metadata !{i32 786443, metadata !1, metadata !85, i32 56, i32 19, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!91 = metadata !{i32 7, i32 50, metadata !4, metadata !88}
!92 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !88} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!93 = metadata !{i32 7, i32 73, metadata !4, metadata !88}
!94 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !88} ; [ DW_TAG_auto_variable ] [range] [line 8]
!95 = metadata !{i32 8, i32 15, metadata !4, metadata !88} ; [ DW_TAG_imported_declaration ]
!96 = metadata !{i32 786688, metadata !12, metadata !"tmp_0", metadata !5, i32 30, metadata !8, i32 0, metadata !97} ; [ DW_TAG_auto_variable ] [tmp_0] [line 30]
!97 = metadata !{i32 61, i32 19, metadata !98, null}
!98 = metadata !{i32 786443, metadata !1, metadata !90, i32 60, i32 9, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!99 = metadata !{i32 30, i32 13, metadata !12, metadata !97}
!100 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !101} ; [ DW_TAG_arg_variable ] [value] [line 7]
!101 = metadata !{i32 32, i32 11, metadata !12, metadata !97}
!102 = metadata !{i32 7, i32 33, metadata !4, metadata !101}
!103 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !101} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!104 = metadata !{i32 7, i32 50, metadata !4, metadata !101}
!105 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !101} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!106 = metadata !{i32 7, i32 73, metadata !4, metadata !101}
!107 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !101} ; [ DW_TAG_auto_variable ] [range] [line 8]
!108 = metadata !{i32 8, i32 15, metadata !4, metadata !101} ; [ DW_TAG_imported_declaration ]
...
!110 = metadata !{i32 69, i32 17, metadata !90, null}
!111 = metadata !{i32 30, i32 13, metadata !12, metadata !110}
!112 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !113} ; [ DW_TAG_arg_variable ] [value] [line 7]
!113 = metadata !{i32 32, i32 11, metadata !12, metadata !110}
!114 = metadata !{i32 7, i32 33, metadata !4, metadata !113}
!115 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !113} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!116 = metadata !{i32 7, i32 50, metadata !4, metadata !113}
!117 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !113} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!118 = metadata !{i32 7, i32 73, metadata !4, metadata !113}
!119 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !113} ; [ DW_TAG_auto_variable ] [range] [line 8]
!120 = metadata !{i32 8, i32 15, metadata !4, metadata !113} ; [ DW_TAG_imported_declaration ]
!121 = metadata !{i32 48, i32 3, metadata !15, null}
!122 = metadata !{i32 20, i32 7, metadata !44, metadata !76}
!123 = metadata !{i32 22, i32 1, metadata !46, metadata !76}
!124 = metadata !{i32 50, i32 9, metadata !125, null}
!125 = metadata !{i32 786443, metadata !1, metadata !77, i32 50, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!126 = metadata !{i32 84, i32 1, metadata !127, null}
!127 = metadata !{i32 786443, metadata !1, metadata !128, i32 83, i32 1, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!128 = metadata !{i32 786443, metadata !1, metadata !77, i32 82, i32 9, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!129 = metadata !{i32 31, i32 3, metadata !12, metadata !97}
!130 = metadata !{i32 9, i32 9, metadata !33, metadata !101}
!131 = metadata !{i32 10, i32 9, metadata !35, metadata !101}
!132 = metadata !{i32 12, i32 14, metadata !37, metadata !101}
!133 = metadata !{i32 13, i32 9, metadata !39, metadata !101}
!134 = metadata !{i32 33, i32 7, metadata !68, metadata !97}
!135 = metadata !{i32 37, i32 5, metadata !70, metadata !97}
!136 = metadata !{i32 62, i32 11, metadata !98, null}
!137 = metadata !{i32 64, i32 13, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !90, i32 64, i32 13, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!139 = metadata !{i32 31, i32 3, metadata !12, metadata !110}
!140 = metadata !{i32 9, i32 9, metadata !33, metadata !113}
!141 = metadata !{i32 10, i32 9, metadata !35, metadata !113}
!142 = metadata !{i32 12, i32 14, metadata !37, metadata !113}
!143 = metadata !{i32 13, i32 9, metadata !39, metadata !113}
!144 = metadata !{i32 33, i32 7, metadata !68, metadata !110}
!145 = metadata !{i32 37, i32 5, metadata !70, metadata !110}
!146 = metadata !{i32 70, i32 9, metadata !90, null}
!147 = metadata !{i32 71, i32 13, metadata !148, null}
!148 = metadata !{i32 786443, metadata !1, metadata !90, i32 71, i32 13, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!149 = metadata !{i32 76, i32 9, metadata !90, null}
!150 = metadata !{i32 86, i32 3, metadata !15, null}
