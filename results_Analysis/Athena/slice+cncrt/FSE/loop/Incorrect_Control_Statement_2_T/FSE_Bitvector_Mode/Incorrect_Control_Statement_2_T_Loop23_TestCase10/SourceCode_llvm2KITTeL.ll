...
main_bb0:
  ...
  call void @llvm.memset.p0i8.i64(i8* %"3", i8 0, i64 40, i32 16, i1 false), !dbg !22
...
main_bb3:                                         ; preds = %main_bb1, %main_bb9
  %i_0.0 = phi i32 [ %"21", %main_bb9 ], [ 0, %main_bb1 ]
  %table.0 = phi i32 [ %table.1, %main_bb9 ], [ %"0", %main_bb1 ]
  %"6" = icmp slt i32 %i_0.0, 10, !dbg !36
  br i1 %"6", label %main_bb4, label %main_bb10, !dbg !36

main_bb4:                                         ; preds = %main_bb3
  %"7" = sext i32 %i_0.0 to i64, !dbg !38
  %"8" = getelementptr inbounds [10 x i32]* %slots_used, i32 0, i64 %"7", !dbg !38
  %"9" = load i32* %"8", align 4, !dbg !38
...
main_bb5:                                         ; preds = %main_LeafBlock
  %"10" = sext i32 %i_0.0 to i64, !dbg !40
  %"11" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"10", !dbg !40
  %"12" = load i32* %"11", align 4, !dbg !40
  %"13" = icmp ne i32 %"12", 0, !dbg !40
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !40

main_bb6:                                         ; preds = %main_bb5
  %"14" = sext i32 %i_0.0 to i64, !dbg !43
  %"15" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"14", !dbg !43
  %"16" = load i32* %"15", align 4, !dbg !43
...
main_bb7:                                         ; preds = %main_NewDefault
  %"17" = sext i32 %i_0.0 to i64, !dbg !45
  %"18" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"17", !dbg !45
  %"19" = load i32* %"18", align 4, !dbg !45
...
main_bb8:                                         ; preds = %main_LeafBlock1, %main_bb7, %main_bb6
  ...
  %"20" = icmp ne i32 %table.1, 0, !dbg !47
  br i1 %"20", label %main_bb10, label %main_bb9, !dbg !47

main_bb9:                                         ; preds = %main_bb8
  %"21" = add nsw i32 %i_0.0, 1, !dbg !49
