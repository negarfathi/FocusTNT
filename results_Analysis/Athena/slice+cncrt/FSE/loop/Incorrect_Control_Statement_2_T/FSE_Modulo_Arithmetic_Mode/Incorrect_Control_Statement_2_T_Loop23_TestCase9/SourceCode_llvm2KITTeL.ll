...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"17"}, i64 0, metadata !51), !dbg !54
...
main_bb11:                                        ; preds = %main_LeafBlock
  %"31" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !75
  %"32" = load i64* %"31", align 8, !dbg !75
  %"33" = icmp ne i64 %"32", 0, !dbg !75
  br i1 %"33", label %main_bb12, label %main_bb19, !dbg !75

main_bb12:                                        ; preds = %main_bb11
  %"34" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !78
...
main_bb13:                                        ; preds = %main_NewDefault
  %"36" = getelementptr inbounds [10 x i64]* %ereg, i32 0, i64 %i_0.0, !dbg !80
...
main_bb14:                                        ; preds = %main_LeafBlock3, %main_bb13, %main_bb12
  ...
  %"38" = icmp ne i64 %table.1, 0, !dbg !82
  br i1 %"38", label %main_bb19, label %main_bb15, !dbg !82

main_bb15:                                        ; preds = %main_bb14
  %"39" = add nsw i64 %i_0.0, 1, !dbg !84
