...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !38, i64 0, metadata !36), !dbg !37
...
main_bb6:                                         ; preds = %main_bb7, %main_wrap_around.exit, %main_bb5
  %pkt.0 = phi i64 [ 0, %main_bb5 ], [ %pkt.1, %main_bb7 ], [ %.0.i, %main_wrap_around.exit ]
  %"12" = icmp slt i64 %pkt.0, 10, !dbg !54
  br i1 %"12", label %main_bb7, label %main_bb12, !dbg !54
...
main_bb7:                                         ; preds = %main_wrap_around.exit, %main_bb6
  ...
  %"13" = icmp eq i64 %res.0, 0, !dbg !56
  br i1 %"13", label %main_bb8, label %main_bb6, !dbg !56

main_bb8:                                         ; preds = %main_bb7
  %"14" = add nsw i64 %pkt.1, 1, !dbg !40
  %"15" = icmp sgt i64 %"14", 2147483647, !dbg !58
  br i1 %"15", label %main_bb9, label %main_bb10, !dbg !58
...
main_bb10:                                        ; preds = %main_bb8
  ...
  br i1 %"20", label %main_bb11, label %main_wrap_around.exit, !dbg !60
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb10, %main_bb11
  %.0.i = phi i64 [ %"19", %main_bb9 ], [ %"24", %main_bb11 ], [ %"14", %main_bb10 ], !dbg !40
  %"25" = icmp eq i64 3, 0, !dbg !62
  br i1 %"25", label %main_bb6, label %main_bb7, !dbg !62
...
!36 = metadata !{i32 786688, metadata !9, metadata !"res", metadata !5, i32 19, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [res] [line 19]
!37 = metadata !{i32 19, i32 13, metadata !9, null}
!38 = metadata !{i64 3}
!39 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777223, metadata !8, i32 0, metadata !40} ; [ DW_TAG_arg_variable ] [value] [line 7]
!40 = metadata !{i32 25, i32 14, metadata !41, null}
!41 = metadata !{i32 786443, metadata !1, metadata !42, i32 23, i32 22, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 20, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 7, i32 33, metadata !4, metadata !40}
!44 = metadata !{i64 -2147483648}
!45 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !40} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!46 = metadata !{i32 7, i32 50, metadata !4, metadata !40}
!47 = metadata !{i64 2147483647}
!48 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !40} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!49 = metadata !{i32 7, i32 73, metadata !4, metadata !40}
!50 = metadata !{i64 4294967296}
!51 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !40} ; [ DW_TAG_auto_variable ] [range] [line 8]
!52 = metadata !{i32 8, i32 15, metadata !4, metadata !40} ; [ DW_TAG_imported_declaration ]
!53 = metadata !{i32 21, i32 3, metadata !9, null}
!54 = metadata !{i32 21, i32 3, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 3, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 23, i32 5, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !42, i32 23, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 9, i32 9, metadata !25, metadata !40}
!59 = metadata !{i32 10, i32 9, metadata !27, metadata !40}
!60 = metadata !{i32 12, i32 14, metadata !29, metadata !40}
!61 = metadata !{i32 13, i32 9, metadata !31, metadata !40}
!62 = metadata !{i32 26, i32 11, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !41, i32 26, i32 11, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 33, i32 3, metadata !9, null}
