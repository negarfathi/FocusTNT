...
main_bb5:
  ...
  %"12" = icmp slt i64 128, -1, !dbg !42
  %"13" = icmp sle i64 300, 0, !dbg !44
...
main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  ...
  %"38" = icmp ne i64 128, -1, !dbg !59
  br i1 %"38", label %main_bb13, label %main_bb14, !dbg !59

main_bb13:                                        ; preds = %main_wrap_around.exit4
  %"39" = icmp sgt i64 %.0.i3, 128, !dbg !61
  %..0.i3 = select i1 %"39", i64 128, i64 %.0.i3, !dbg !61
...
main_bb14:                                        ; preds = %main_bb13, %main_wrap_around.exit4
  ...
  %"40" = sub nsw i64 %size.2, 300, !dbg !65
