...
main_bb5:
  ...
  %"12" = icmp slt i64 20000, -1, !dbg !42
  %"13" = icmp sle i64 5000, 0, !dbg !44
  %or.cond = or i1 %"12", %"13", !dbg !42
  %"14" = icmp slt i64 0, 0, !dbg !46
  %or.cond5 = or i1 %or.cond, %"14", !dbg !42
  br i1 %or.cond5, label %main_bb18, label %main_wrap_around.exit2, !dbg !42

main_wrap_around.exit2:                           ; preds = %main_bb5, %main_bb17, %main_bb16, %main_bb15
  %size.0 = phi i64 [ %size.2, %main_bb15 ], [ %size.2, %main_bb16 ], [ %size.2, %main_bb17 ], [ 64, %main_bb5 ]
  %buffer_bytes_left.0 = phi i64 [ %"45", %main_bb15 ], [ %"50", %main_bb17 ], [ %"40", %main_bb16 ], [ 0, %main_bb5 ]
...
main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  ...
  br i1 %"26", label %main_bb9, label %main_bb18, !dbg !48
...
main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  ...
  %"38" = icmp ne i64 20000, -1, !dbg !59
  br i1 %"38", label %main_bb13, label %main_bb14, !dbg !59

main_bb13:                                        ; preds = %main_wrap_around.exit4
  %"39" = icmp sgt i64 %.0.i3, 20000, !dbg !61
  %..0.i3 = select i1 %"39", i64 20000, i64 %.0.i3, !dbg !61
  br label %main_bb14, !dbg !64

main_bb14:                                        ; preds = %main_bb13, %main_wrap_around.exit4
  %size.2 = phi i64 [ %..0.i3, %main_bb13 ], [ %.0.i3, %main_wrap_around.exit4 ]
  %"40" = sub nsw i64 %size.2, 5000, !dbg !65
  %"41" = icmp sgt i64 %"40", 2147483647, !dbg !66
  br i1 %"41", label %main_bb15, label %main_bb16, !dbg !66

main_bb15:                                        ; preds = %main_bb14
  %"42" = sub nsw i64 %"40", 2147483647, !dbg !67
  %"43" = sub nsw i64 %"42", 1, !dbg !67
  %"44" = srem i64 %"43", 4294967296, !dbg !67
  %"45" = add nsw i64 -2147483648, %"44", !dbg !67
  br label %main_wrap_around.exit2, !dbg !67

main_bb16:                                        ; preds = %main_bb14
  %"46" = icmp slt i64 %"40", -2147483648, !dbg !68
  br i1 %"46", label %main_bb17, label %main_wrap_around.exit2, !dbg !68

main_bb17:                                        ; preds = %main_bb16
  %"47" = sub nsw i64 -2147483648, %"40", !dbg !69
  %"48" = sub nsw i64 %"47", 1, !dbg !69
  %"49" = srem i64 %"48", 4294967296, !dbg !69
  %"50" = sub nsw i64 2147483647, %"49", !dbg !69
  br label %main_wrap_around.exit2, !dbg !69

main_bb18:                                        ; preds = %main_wrap_around.exit, %main_bb5
  ret void, !dbg !70
}
...
!64 = metadata !{i32 43, i32 1, metadata !63, null}
!65 = metadata !{i32 44, i32 25, metadata !54, null}
!66 = metadata !{i32 9, i32 9, metadata !25, metadata !65}
!67 = metadata !{i32 10, i32 9, metadata !27, metadata !65}
!68 = metadata !{i32 12, i32 14, metadata !29, metadata !65}
!69 = metadata !{i32 13, i32 9, metadata !31, metadata !65}
!70 = metadata !{i32 46, i32 17, metadata !9, null}
