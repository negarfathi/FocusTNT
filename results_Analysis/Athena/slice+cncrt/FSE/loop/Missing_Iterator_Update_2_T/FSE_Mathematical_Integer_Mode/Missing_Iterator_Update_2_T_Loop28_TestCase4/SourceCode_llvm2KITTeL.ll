...
main_bb3:                                         ; preds = %main_bb4, %main_mdb_cursor_get_slice_1.exit
  %"7" = icmp eq i32 1, 0, !dbg !50
  br i1 %"7", label %main_bb4, label %main_bb5, !dbg !50

main_bb4:                                         ; preds = %main_bb3
  %"8" = load i32* @"'flag", align 4, !dbg !52
  %"9" = add nsw i32 %"8", 1, !dbg !52
  store i32 %"9", i32* @"'flag", align 4, !dbg !52
...
!53 = metadata !{i32 27, i32 7, metadata !42, null}
