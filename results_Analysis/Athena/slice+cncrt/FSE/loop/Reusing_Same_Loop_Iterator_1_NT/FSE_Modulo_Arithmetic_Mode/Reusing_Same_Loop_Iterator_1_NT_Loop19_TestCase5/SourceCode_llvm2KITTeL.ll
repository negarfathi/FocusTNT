...
main_bb5:
  ...
  %"12" = icmp sgt i64 65534, 65534, !dbg !39
  %"13" = icmp sgt i64 65533, 65534, !dbg !41
...
main_wrap_around.exit2:                           ; preds = %main_bb5, %main_bb13, %main_bb12, %main_bb11
  ...
  %"14" = icmp slt i64 %i.0, 65534, !dbg !43
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"15" = icmp slt i64 %i.1, 65533, !dbg !45
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  call void @llvm.dbg.value(metadata !{i64 %"16"}, i64 0, metadata !54), !dbg !56
...
main_bb11:                                        ; preds = %main_bb10
  %"27" = sub nsw i64 %"16", 2147483647, !dbg !67
  %"28" = sub nsw i64 %"27", 1, !dbg !67
  %"29" = srem i64 %"28", 4294967296, !dbg !67
  %"30" = add nsw i64 -2147483648, %"29", !dbg !67
  br label %main_wrap_around.exit2, !dbg !67

main_bb12:                                        ; preds = %main_bb10
  %"31" = icmp slt i64 %"16", -2147483648, !dbg !68
  br i1 %"31", label %main_bb13, label %main_wrap_around.exit2, !dbg !68

main_bb13:                                        ; preds = %main_bb12
  %"32" = sub nsw i64 -2147483648, %"16", !dbg !69
  %"33" = sub nsw i64 %"32", 1, !dbg !69
  %"34" = srem i64 %"33", 4294967296, !dbg !69
  %"35" = sub nsw i64 2147483647, %"34", !dbg !69
