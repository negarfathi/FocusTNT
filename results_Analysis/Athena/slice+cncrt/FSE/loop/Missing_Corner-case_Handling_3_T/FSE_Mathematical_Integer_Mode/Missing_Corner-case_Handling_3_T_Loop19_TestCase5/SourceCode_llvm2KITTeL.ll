...
main_bb0:
  ...
  %"0" = icmp sle i32 10, 0, !dbg !17
  %"1" = icmp sle i32 10, 0, !dbg !19
  %or.cond = or i1 %"0", %"1", !dbg !17
  %"2" = icmp sgt i32 10, 65534, !dbg !21
  %or.cond1 = or i1 %or.cond, %"2", !dbg !17
  %"3" = icmp sgt i32 10, 65534, !dbg !23
  %or.cond2 = or i1 %or.cond1, %"3", !dbg !17
  br i1 %or.cond2, label %main_bb13, label %main_bb1, !dbg !17

main_bb1:                                         ; preds = %main_bb0
  %"4" = zext i32 10 to i64, !dbg !25
  %"5" = zext i32 10 to i64, !dbg !25
...
main_bb5:                                         ; preds = %main_bb4
  %"12" = icmp sgt i32 -16, 0, !dbg !52
  %"13" = sub nsw i32 0, -16, !dbg !54
  %. = select i1 %"12", i32 %"13", i32 -16, !dbg !52
...
main_bb7:                                         ; preds = %main_bb2, %main_bb11
  ...
  %"22" = icmp slt i32 %xmin.0, 10, !dbg !61
