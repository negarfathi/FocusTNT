...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"13"}, i64 0, metadata !39), !dbg !41
  call void @llvm.dbg.value(metadata !33, i64 0, metadata !42), !dbg !43
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb5
  %n.0 = phi i64 [ 0, %main_bb5 ], [ %"17", %main_bb7 ], [ %"22", %main_bb9 ], [ %"13", %main_bb8 ]
  %"12" = icmp sgt i64 %n.0, 0, !dbg !51
  br i1 %"12", label %main_bb6, label %main_bb10, !dbg !51

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"13" = sub nsw i64 %n.0, 16, !dbg !40
  %"14" = icmp sgt i64 %"13", 4294967295, !dbg !53
  br i1 %"14", label %main_bb7, label %main_bb8, !dbg !53

main_bb7:                                         ; preds = %main_bb6
  %"15" = sub nsw i64 %"13", 4294967295, !dbg !54
  %"16" = sub nsw i64 %"15", 1, !dbg !54
  %"17" = srem i64 %"16", 4294967296, !dbg !54
  br label %main_wrap_around.exit, !dbg !54

main_bb8:                                         ; preds = %main_bb6
  %"18" = icmp slt i64 %"13", 0, !dbg !55
  br i1 %"18", label %main_bb9, label %main_wrap_around.exit, !dbg !55

main_bb9:                                         ; preds = %main_bb8
  %"19" = sub nsw i64 0, %"13", !dbg !56
  %"20" = sub nsw i64 %"19", 1, !dbg !56
  %"21" = srem i64 %"20", 4294967296, !dbg !56
  %"22" = sub nsw i64 4294967295, %"21", !dbg !56
...
!40 = metadata !{i32 22, i32 9, metadata !37, null}
!41 = metadata !{i32 7, i32 33, metadata !4, metadata !40}
!42 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !40} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!43 = metadata !{i32 7, i32 50, metadata !4, metadata !40}
!44 = metadata !{i64 4294967295}
!45 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !40} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!46 = metadata !{i32 7, i32 73, metadata !4, metadata !40}
!47 = metadata !{i64 4294967296}
!48 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !40} ; [ DW_TAG_auto_variable ] [range] [line 8]
!49 = metadata !{i32 8, i32 15, metadata !4, metadata !40} ; [ DW_TAG_imported_declaration ]
!50 = metadata !{i32 20, i32 3, metadata !9, null}
!51 = metadata !{i32 20, i32 3, metadata !52, null}
!52 = metadata !{i32 786443, metadata !1, metadata !9, i32 20, i32 3, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!53 = metadata !{i32 9, i32 9, metadata !25, metadata !40}
!54 = metadata !{i32 10, i32 9, metadata !27, metadata !40}
!55 = metadata !{i32 12, i32 14, metadata !29, metadata !40}
!56 = metadata !{i32 13, i32 9, metadata !31, metadata !40}
!57 = metadata !{i32 24, i32 3, metadata !9, null}
