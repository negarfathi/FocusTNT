...
main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  %i.0 = phi i64 [ 0, %main_bb5 ], [ %"31", %main_bb11 ], [ %"36", %main_bb13 ], [ %"26", %main_bb12 ]
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  %j.0 = phi i64 [ 0, %main_wrap_around.exit2 ], [ %"20", %main_bb7 ], [ %"25", %main_bb9 ], [ %"15", %main_bb8 ]
  %"14" = icmp slt i64 %j.0, 3, !dbg !40
  br i1 %"14", label %main_bb6, label %main_bb10, !dbg !40

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"15" = add nsw i64 %j.0, 1, !dbg !44
  %"16" = icmp sgt i64 %"15", 2147483647, !dbg !46
  br i1 %"16", label %main_bb7, label %main_bb8, !dbg !46

main_bb7:                                         ; preds = %main_bb6
  %"17" = sub nsw i64 %"15", 2147483647, !dbg !47
  %"18" = sub nsw i64 %"17", 1, !dbg !47
  %"19" = srem i64 %"18", 4294967296, !dbg !47
  %"20" = add nsw i64 -2147483648, %"19", !dbg !47
  br label %main_wrap_around.exit, !dbg !47

main_bb8:                                         ; preds = %main_bb6
  %"21" = icmp slt i64 %"15", -2147483648, !dbg !48
  br i1 %"21", label %main_bb9, label %main_wrap_around.exit, !dbg !48

main_bb9:                                         ; preds = %main_bb8
  %"22" = sub nsw i64 -2147483648, %"15", !dbg !49
  %"23" = sub nsw i64 %"22", 1, !dbg !49
  %"24" = srem i64 %"23", 4294967296, !dbg !49
  %"25" = sub nsw i64 2147483647, %"24", !dbg !49
  br label %main_wrap_around.exit, !dbg !49

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"26" = add nsw i64 %i.0, 1, !dbg !50
  call void @llvm.dbg.value(metadata !{i64 %"26"}, i64 0, metadata !51), !dbg !52
  ...
  %"27" = icmp sgt i64 %"26", 2147483647, !dbg !62
  br i1 %"27", label %main_bb11, label %main_bb12, !dbg !62

main_bb11:                                        ; preds = %main_bb10
  %"28" = sub nsw i64 %"26", 2147483647, !dbg !63
  %"29" = sub nsw i64 %"28", 1, !dbg !63
  %"30" = srem i64 %"29", 4294967296, !dbg !63
  %"31" = add nsw i64 -2147483648, %"30", !dbg !63
  br label %main_wrap_around.exit2, !dbg !63

main_bb12:                                        ; preds = %main_bb10
  %"32" = icmp slt i64 %"26", -2147483648, !dbg !64
  br i1 %"32", label %main_bb13, label %main_wrap_around.exit2, !dbg !64

main_bb13:                                        ; preds = %main_bb12
  %"33" = sub nsw i64 -2147483648, %"26", !dbg !65
  %"34" = sub nsw i64 %"33", 1, !dbg !65
  %"35" = srem i64 %"34", 4294967296, !dbg !65
  %"36" = sub nsw i64 2147483647, %"35", !dbg !65
