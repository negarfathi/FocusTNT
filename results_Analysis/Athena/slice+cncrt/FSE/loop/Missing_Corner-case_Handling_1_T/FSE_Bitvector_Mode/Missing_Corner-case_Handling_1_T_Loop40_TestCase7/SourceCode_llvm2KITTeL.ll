...
main_bb6:
  ...
  call void @llvm.dbg.value(metadata !{i32 %__retres.2.i}, i64 0, metadata !43), !dbg !44
  call void @llvm.dbg.value(metadata !22, i64 0, metadata !45), !dbg !46
  call void @llvm.dbg.value(metadata !22, i64 0, metadata !45), !dbg !46
  call void @llvm.dbg.value(metadata !22, i64 0, metadata !47), !dbg !48
  br label %main_bb7, !dbg !49

main_bb7:                                         ; preds = %main_read_slice_1.exit, %main_bb6
  %"10" = icmp eq i32 %"9", 1, !dbg !40
  %"11" = load i32* @"'count", align 4, !dbg !41
  %"12" = icmp sgt i32 %"11", 100, !dbg !50
  %or.cond.i = or i1 %"10", %"12", !dbg !40
  br i1 %or.cond.i, label %main_read_slice_1.exit, label %main_bb8, !dbg !40

main_bb8:                                         ; preds = %main_bb7
  %"13" = load i32* @"'count", align 4, !dbg !51
  %"14" = add nsw i32 %"13", 1, !dbg !51
  store i32 %"14", i32* @"'count", align 4, !dbg !51
  br label %main_read_slice_1.exit, !dbg !52

main_read_slice_1.exit:                           ; preds = %main_bb7, %main_bb8
  %__retres.2.i = phi i32 [ 0, %main_bb7 ], [ 100, %main_bb8 ], !dbg !41
  %"15" = icmp sle i32 %__retres.2.i, 0, !dbg !53
  br i1 %"15", label %main_bb9, label %main_bb7, !dbg !53
...
!47 = metadata !{i32 786688, metadata !4, metadata !"__retres", metadata !5, i32 9, metadata !8, i32 0, metadata !41} ; [ DW_TAG_auto_variable ] [__retres] [line 9]
!48 = metadata !{i32 9, i32 7, metadata !4, metadata !41}
!49 = metadata !{i32 37, i32 3, metadata !9, null}
!50 = metadata !{i32 15, i32 9, metadata !21, metadata !41}
!51 = metadata !{i32 24, i32 7, metadata !32, metadata !41}
!52 = metadata !{i32 26, i32 5, metadata !32, metadata !41}
!53 = metadata !{i32 40, i32 9, metadata !54, null}
!54 = metadata !{i32 786443, metadata !1, metadata !42, i32 40, i32 9, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!55 = metadata !{i32 45, i32 3, metadata !9, null}
