...
main_bb3:                                         ; preds = %main_LeafBlock1, %main_bb1, %main_bb9
  %i_0.0 = phi i32 [ %"21", %main_bb9 ], [ 0, %main_bb1 ], [ %i_0.0, %main_LeafBlock1 ]
  %"6" = icmp slt i32 %i_0.0, 10, !dbg !34
  br i1 %"6", label %main_bb4, label %main_bb10, !dbg !34

main_bb4:                                         ; preds = %main_bb3
  %"7" = sext i32 %i_0.0 to i64, !dbg !36
  %"8" = getelementptr inbounds [10 x i32]* %slots_used, i32 0, i64 %"7", !dbg !36
...
main_bb5:                                         ; preds = %main_LeafBlock
  ...
  %"11" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"10", !dbg !38
  %"12" = load i32* %"11", align 4, !dbg !38
  %"13" = icmp ne i32 %"12", 0, !dbg !38
  br i1 %"13", label %main_bb6, label %main_bb10, !dbg !38

main_bb6:                                         ; preds = %main_bb5
  %"14" = sext i32 %i_0.0 to i64, !dbg !41
  %"15" = getelementptr inbounds [10 x i32]* %ereg, i32 0, i64 %"14", !dbg !41
  %"16" = load i32* %"15", align 4, !dbg !41
...
main_bb8:                                         ; preds = %main_bb7, %main_bb6
  ...
  %"20" = icmp ne i32 %table.0, 0, !dbg !45
  br i1 %"20", label %main_bb10, label %main_bb9, !dbg !45

main_bb9:                                         ; preds = %main_bb8
  %"21" = add nsw i32 %i_0.0, 1, !dbg !47
