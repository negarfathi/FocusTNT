...
main_bb5:
  ...
  %"12" = icmp slt i64 70000, 0, !dbg !39
  %"13" = icmp slt i64 10, 0, !dbg !41
  %or.cond = or i1 %"12", %"13", !dbg !39
  %"14" = icmp sgt i64 70000, 65534, !dbg !43
  %or.cond3 = or i1 %or.cond, %"14", !dbg !39
  %"15" = icmp sgt i64 10, 65534, !dbg !45
  %or.cond4 = or i1 %or.cond3, %"15", !dbg !39
...
main_wrap_around.exit2:                           ; preds = %main_bb5, %main_bb13, %main_bb12, %main_bb11
  ...
  %"16" = icmp slt i64 %x.0, 70000, !dbg !47
  br i1 %"16", label %main_wrap_around.exit, label %main_bb14, !dbg !47
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"17" = icmp slt i64 %y.0, 10, !dbg !49
  br i1 %"17", label %main_bb6, label %main_bb10, !dbg !49

main_bb6:                                         ; preds = %main_wrap_around.exit
  %"18" = add nsw i64 %y.0, 1, !dbg !52
