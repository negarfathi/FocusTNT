...
main_bb5:
  ...
  %"12" = icmp slt i64 100, 0, !dbg !39
  %"13" = icmp slt i64 50, 0, !dbg !41
  %or.cond = or i1 %"12", %"13", !dbg !39
  %"14" = icmp sgt i64 100, 65534, !dbg !43
  %or.cond3 = or i1 %or.cond, %"14", !dbg !39
  %"15" = icmp sgt i64 50, 65534, !dbg !45
...
main_wrap_around.exit2:                           ; preds = %main_bb5, %main_bb13, %main_bb12, %main_bb11
  ...
  %"16" = icmp slt i64 %x.0, 100, !dbg !47
