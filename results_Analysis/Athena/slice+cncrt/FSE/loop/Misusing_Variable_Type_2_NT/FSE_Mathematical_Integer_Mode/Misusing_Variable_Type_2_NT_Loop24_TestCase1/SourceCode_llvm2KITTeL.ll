...
main_bb1:
  ...
  call void @llvm.dbg.value(metadata !{i16 %"8"}, i64 0, metadata !38), !dbg !40
  br label %main_bb2, !dbg !41

main_bb2:                                         ; preds = %main_bb3, %main_bb1
  %i.0 = phi i16 [ 0, %main_bb1 ], [ %"8", %main_bb3 ]
  %"4" = zext i16 %i.0 to i64, !dbg !42
  %"5" = icmp ult i64 %"4", %"3", !dbg !42
  br i1 %"5", label %main_bb3, label %main_bb4, !dbg !42

main_bb3:                                         ; preds = %main_bb2
  %"6" = zext i16 %i.0 to i32, !dbg !45
  %"7" = add nsw i32 %"6", 1, !dbg !45
  %"8" = trunc i32 %"7" to i16, !dbg !45
...
!36 = metadata !{i32 19, i32 17, metadata !9, null}
!37 = metadata !{i16 0}
!38 = metadata !{i32 786688, metadata !9, metadata !"i", metadata !5, i32 16, metadata !39, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [i] [line 16]
...
!40 = metadata !{i32 16, i32 18, metadata !9, null}
!41 = metadata !{i32 21, i32 3, metadata !9, null}
!42 = metadata !{i32 21, i32 3, metadata !43, null}
!43 = metadata !{i32 786443, metadata !1, metadata !44, i32 21, i32 3, i32 3, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 3, i32 1, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 21, i32 38, metadata !46, null}
!46 = metadata !{i32 786443, metadata !1, metadata !9, i32 21, i32 38, i32 2, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!47 = metadata !{i32 22, i32 3, metadata !9, null}
