...
main_bb10:                                        ; preds = %main_wrap_around.exit
  ...
  call void @llvm.dbg.value(metadata !{i64 %"38"}, i64 0, metadata !77), !dbg !80
...
main_wrap_around.exit2:                           ; preds = %main_bb23, %main_bb22, %main_bb21, %main_bb10
  ...
  %"32" = icmp slt i64 %base.0, 0, !dbg !88
  br i1 %"32", label %main_bb11, label %main_bb24, !dbg !88

main_bb11:                                        ; preds = %main_wrap_around.exit2
  %"33" = getelementptr inbounds [10 x i64]* %old_, i32 0, i64 %i.0, !dbg !90
  %"34" = load i64* %"33", align 8, !dbg !90
  %"35" = getelementptr inbounds [10 x i64]* %new_, i32 0, i64 %i.0, !dbg !90
  %"36" = load i64* %"35", align 8, !dbg !90
...
main_bb12:                                        ; preds = %main_wrap_around.exit6, %main_bb11
  ...
  %"37" = icmp ne i64 %"34", %"36", !dbg !90
  br i1 %"37", label %main_bb13, label %main_bb17, !dbg !90

main_bb13:                                        ; preds = %main_bb12
  %"38" = add nsw i64 %number.0, 1, !dbg !78
  %"39" = icmp sgt i64 %"38", 2147483647, !dbg !93
  br i1 %"39", label %main_bb14, label %main_bb15, !dbg !93

main_bb14:                                        ; preds = %main_bb13
  %"40" = sub nsw i64 %"38", 2147483647, !dbg !94
  %"41" = sub nsw i64 %"40", 1, !dbg !94
  %"42" = srem i64 %"41", 4294967296, !dbg !94
  %"43" = add nsw i64 -2147483648, %"42", !dbg !94
  br label %main_wrap_around.exit6, !dbg !94

main_bb15:                                        ; preds = %main_bb13
  %"44" = icmp slt i64 %"38", -2147483648, !dbg !95
  br i1 %"44", label %main_bb16, label %main_wrap_around.exit6, !dbg !95

main_bb16:                                        ; preds = %main_bb15
  %"45" = sub nsw i64 -2147483648, %"38", !dbg !96
  %"46" = sub nsw i64 %"45", 1, !dbg !96
  %"47" = srem i64 %"46", 4294967296, !dbg !96
  %"48" = sub nsw i64 2147483647, %"47", !dbg !96
  br label %main_wrap_around.exit6, !dbg !96

main_wrap_around.exit6:                           ; preds = %main_bb14, %main_bb15, %main_bb16
  %.0.i5 = phi i64 [ %"43", %main_bb14 ], [ %"48", %main_bb16 ], [ %"38", %main_bb15 ], !dbg !78
  %"49" = icmp eq i64 %.0.i5, 0, !dbg !97
  br i1 %"49", label %main_bb17, label %main_bb12, !dbg !97

main_bb17:                                        ; preds = %main_wrap_around.exit6, %main_bb12
  %"50" = add nsw i64 %i.0, 1, !dbg !99
  call void @llvm.dbg.value(metadata !{i64 %"50"}, i64 0, metadata !100), !dbg !101
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !102), !dbg !103
  ...
  %"51" = icmp sgt i64 %"50", 2147483647, !dbg !108
  br i1 %"51", label %main_bb18, label %main_bb19, !dbg !108

main_bb18:                                        ; preds = %main_bb17
  %"52" = sub nsw i64 %"50", 2147483647, !dbg !109
  %"53" = sub nsw i64 %"52", 1, !dbg !109
  %"54" = srem i64 %"53", 4294967296, !dbg !109
  %"55" = add nsw i64 -2147483648, %"54", !dbg !109
  br label %main_wrap_around.exit4, !dbg !109

main_bb19:                                        ; preds = %main_bb17
  %"56" = icmp slt i64 %"50", -2147483648, !dbg !110
  br i1 %"56", label %main_bb20, label %main_wrap_around.exit4, !dbg !110

main_bb20:                                        ; preds = %main_bb19
  %"57" = sub nsw i64 -2147483648, %"50", !dbg !111
  %"58" = sub nsw i64 %"57", 1, !dbg !111
  %"59" = srem i64 %"58", 4294967296, !dbg !111
  %"60" = sub nsw i64 2147483647, %"59", !dbg !111
  br label %main_wrap_around.exit4, !dbg !111

main_wrap_around.exit4:                           ; preds = %main_bb18, %main_bb19, %main_bb20
  %.0.i3 = phi i64 [ %"55", %main_bb18 ], [ %"60", %main_bb20 ], [ %"50", %main_bb19 ], !dbg !99
  call void @llvm.dbg.value(metadata !{i64 %.0.i3}, i64 0, metadata !43), !dbg !44
  %"61" = add nsw i64 %base.0, 8, !dbg !112
  call void @llvm.dbg.value(metadata !{i64 %"61"}, i64 0, metadata !113), !dbg !114
  call void @llvm.dbg.value(metadata !56, i64 0, metadata !115), !dbg !116
  call void @llvm.dbg.value(metadata !59, i64 0, metadata !117), !dbg !118
  call void @llvm.dbg.value(metadata !62, i64 0, metadata !119), !dbg !120
  %"62" = icmp sgt i64 %"61", 2147483647, !dbg !121
  br i1 %"62", label %main_bb21, label %main_bb22, !dbg !121

main_bb21:                                        ; preds = %main_wrap_around.exit4
  %"63" = sub nsw i64 %"61", 2147483647, !dbg !122
  %"64" = sub nsw i64 %"63", 1, !dbg !122
  %"65" = srem i64 %"64", 4294967296, !dbg !122
  %"66" = add nsw i64 -2147483648, %"65", !dbg !122
  br label %main_wrap_around.exit2, !dbg !122

main_bb22:                                        ; preds = %main_wrap_around.exit4
  %"67" = icmp slt i64 %"61", -2147483648, !dbg !123
  br i1 %"67", label %main_bb23, label %main_wrap_around.exit2, !dbg !123

main_bb23:                                        ; preds = %main_bb22
  %"68" = sub nsw i64 -2147483648, %"61", !dbg !124
  %"69" = sub nsw i64 %"68", 1, !dbg !124
  %"70" = srem i64 %"69", 4294967296, !dbg !124
  %"71" = sub nsw i64 2147483647, %"70", !dbg !124
...
!75 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 24, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!88 = metadata !{i32 34, i32 3, metadata !89, null}
!89 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 3, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!90 = metadata !{i32 36, i32 5, metadata !91, null}
!91 = metadata !{i32 786443, metadata !1, metadata !75, i32 36, i32 5, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!92 = metadata !{i32 36, i32 5, metadata !75, null}
!93 = metadata !{i32 9, i32 9, metadata !25, metadata !78}
!94 = metadata !{i32 10, i32 9, metadata !27, metadata !78}
!95 = metadata !{i32 12, i32 14, metadata !29, metadata !78}
!96 = metadata !{i32 13, i32 9, metadata !31, metadata !78}
!97 = metadata !{i32 38, i32 11, metadata !98, null}
!98 = metadata !{i32 786443, metadata !1, metadata !79, i32 38, i32 11, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!99 = metadata !{i32 44, i32 10, metadata !75, null}
...
!112 = metadata !{i32 45, i32 12, metadata !75, null}
...
!125 = metadata !{i32 47, i32 3, metadata !9, null}
