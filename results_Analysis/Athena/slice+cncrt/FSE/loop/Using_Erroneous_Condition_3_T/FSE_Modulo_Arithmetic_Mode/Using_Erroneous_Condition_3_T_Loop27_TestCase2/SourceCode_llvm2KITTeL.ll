...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !45, i64 0, metadata !48), !dbg !49
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  ...
  call void @llvm.dbg.value(metadata !{i64 %"38"}, i64 0, metadata !78), !dbg !81
...
main_wrap_around.exit2:                           ; preds = %main_bb23, %main_bb22, %main_bb21, %main_bb10
  ...
  %"32" = icmp slt i64 %base.0, 10, !dbg !89
  br i1 %"32", label %main_bb11, label %main_bb24, !dbg !89

main_bb11:                                        ; preds = %main_wrap_around.exit2
  %"33" = getelementptr inbounds [10 x i64]* %old_, i32 0, i64 %i.0, !dbg !91
  %"34" = load i64* %"33", align 8, !dbg !91
  %"35" = getelementptr inbounds [10 x i64]* %new_, i32 0, i64 %i.0, !dbg !91
  %"36" = load i64* %"35", align 8, !dbg !91
...
main_bb12:                                        ; preds = %main_wrap_around.exit6, %main_bb11
  ...
  %"37" = icmp ne i64 %"34", %"36", !dbg !91
  br i1 %"37", label %main_bb13, label %main_bb17, !dbg !91

main_bb13:                                        ; preds = %main_bb12
  %"38" = add nsw i64 %number.0, 1, !dbg !79
  %"39" = icmp sgt i64 %"38", 2147483647, !dbg !94
  br i1 %"39", label %main_bb14, label %main_bb15, !dbg !94

main_bb14:                                        ; preds = %main_bb13
  %"40" = sub nsw i64 %"38", 2147483647, !dbg !95
  %"41" = sub nsw i64 %"40", 1, !dbg !95
  %"42" = srem i64 %"41", 4294967296, !dbg !95
  %"43" = add nsw i64 -2147483648, %"42", !dbg !95
  br label %main_wrap_around.exit6, !dbg !95

main_bb15:                                        ; preds = %main_bb13
  %"44" = icmp slt i64 %"38", -2147483648, !dbg !96
  br i1 %"44", label %main_bb16, label %main_wrap_around.exit6, !dbg !96

main_bb16:                                        ; preds = %main_bb15
  %"45" = sub nsw i64 -2147483648, %"38", !dbg !97
  %"46" = sub nsw i64 %"45", 1, !dbg !97
  %"47" = srem i64 %"46", 4294967296, !dbg !97
  %"48" = sub nsw i64 2147483647, %"47", !dbg !97
...
main_wrap_around.exit6:                           ; preds = %main_bb14, %main_bb15, %main_bb16
  ...
  %"49" = icmp eq i64 %.0.i5, 10, !dbg !98
  br i1 %"49", label %main_bb17, label %main_bb12, !dbg !98
...
!76 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 24, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!89 = metadata !{i32 34, i32 3, metadata !90, null}
!90 = metadata !{i32 786443, metadata !1, metadata !9, i32 34, i32 3, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!91 = metadata !{i32 36, i32 5, metadata !92, null}
!92 = metadata !{i32 786443, metadata !1, metadata !76, i32 36, i32 5, i32 1, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!93 = metadata !{i32 36, i32 5, metadata !76, null}
!94 = metadata !{i32 9, i32 9, metadata !25, metadata !79}
!95 = metadata !{i32 10, i32 9, metadata !27, metadata !79}
!96 = metadata !{i32 12, i32 14, metadata !29, metadata !79}
!97 = metadata !{i32 13, i32 9, metadata !31, metadata !79}
!98 = metadata !{i32 38, i32 11, metadata !99, null}
!99 = metadata !{i32 786443, metadata !1, metadata !80, i32 38, i32 11, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!100 = metadata !{i32 44, i32 10, metadata !76, null}
...
!113 = metadata !{i32 45, i32 12, metadata !76, null}
...
!126 = metadata !{i32 47, i32 3, metadata !9, null}
