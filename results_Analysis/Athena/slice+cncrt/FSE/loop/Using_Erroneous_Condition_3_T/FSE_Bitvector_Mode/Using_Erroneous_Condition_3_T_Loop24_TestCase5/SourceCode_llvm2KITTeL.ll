...
main_bb3:                                         ; preds = %main_bb1
  ...
  call void @llvm.dbg.value(metadata !{i32 %"16"}, i64 0, metadata !41), !dbg !43
...
main_bb4:                                         ; preds = %main_bb8, %main_bb3
  ...
  %"8" = icmp slt i32 %base.0, 110, !dbg !45
  br i1 %"8", label %main_bb5, label %main_bb9, !dbg !45

main_bb5:                                         ; preds = %main_bb4
  %"9" = sext i32 %i.0 to i64, !dbg !47
  %"10" = getelementptr inbounds [10 x i32]* %old_, i32 0, i64 %"9", !dbg !47
  %"11" = load i32* %"10", align 4, !dbg !47
  %"12" = sext i32 %i.0 to i64, !dbg !47
  %"13" = getelementptr inbounds [10 x i32]* %new_, i32 0, i64 %"12", !dbg !47
  %"14" = load i32* %"13", align 4, !dbg !47
  br label %main_bb6, !dbg !49

main_bb6:                                         ; preds = %main_bb7, %main_bb5
  %number.0 = phi i32 [ %base.0, %main_bb5 ], [ %"16", %main_bb7 ]
  %"15" = icmp ne i32 %"11", %"14", !dbg !47
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !47

main_bb7:                                         ; preds = %main_bb6
  %"16" = add nsw i32 %number.0, 1, !dbg !50
  %"17" = icmp eq i32 %"16", 110, !dbg !52
  br i1 %"17", label %main_bb8, label %main_bb6, !dbg !52

main_bb8:                                         ; preds = %main_bb7, %main_bb6
  %"18" = add nsw i32 %i.0, 1, !dbg !54
  call void @llvm.dbg.value(metadata !{i32 %"18"}, i64 0, metadata !22), !dbg !23
  %"19" = add nsw i32 %base.0, 8, !dbg !55
  call void @llvm.dbg.value(metadata !{i32 %"19"}, i64 0, metadata !25), !dbg !26
