...
main_bb6:                                         ; preds = %main_bb5
  ...
  %"15" = icmp sgt i64 %"14", 4294967295, !dbg !56
  br i1 %"15", label %main_bb7, label %main_bb8, !dbg !56

main_bb7:                                         ; preds = %main_bb6
  %"16" = sub nsw i64 %"14", 4294967295, !dbg !57
  %"17" = sub nsw i64 %"16", 1, !dbg !57
  %"18" = srem i64 %"17", 4294967296, !dbg !57
  br label %main_wrap_around.exit, !dbg !57

main_bb8:                                         ; preds = %main_bb6
  %"19" = icmp slt i64 %"14", 0, !dbg !58
  br i1 %"19", label %main_bb9, label %main_wrap_around.exit, !dbg !58

main_bb9:                                         ; preds = %main_bb8
  %"20" = sub nsw i64 0, %"14", !dbg !59
  %"21" = sub nsw i64 %"20", 1, !dbg !59
  %"22" = srem i64 %"21", 4294967296, !dbg !59
  %"23" = sub nsw i64 4294967295, %"22", !dbg !59
...
main_wrap_around.exit2:                           ; preds = %main_bb16, %main_bb15, %main_bb14, %main_wrap_around.exit
  %newbufsize.0 = phi i64 [ 2, %main_wrap_around.exit ], [ %"41", %main_bb14 ], [ %"46", %main_bb16 ], [ %"37", %main_bb15 ]
  %"25" = add nsw i64 0, 5, !dbg !60
  %"26" = add nsw i64 %"25", 1, !dbg !60
  %"27" = icmp sgt i64 %"26", 4294967295, !dbg !61
  br i1 %"27", label %main_bb10, label %main_bb11, !dbg !61
...
main_bb11:                                        ; preds = %main_wrap_around.exit2
  ...
  br i1 %"31", label %main_bb12, label %main_wrap_around.exit4, !dbg !63
...
main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  %.0.i3 = phi i64 [ %"30", %main_bb10 ], [ %"35", %main_bb12 ], [ %"26", %main_bb11 ], !dbg !60
  %"36" = icmp slt i64 %newbufsize.0, %.0.i3, !dbg !60
  br i1 %"36", label %main_bb13, label %main_bb17, !dbg !60

main_bb13:                                        ; preds = %main_wrap_around.exit4
  %"37" = mul nsw i64 %newbufsize.0, 2, !dbg !65
  %"38" = icmp sgt i64 %"37", 4294967295, !dbg !67
  br i1 %"38", label %main_bb14, label %main_bb15, !dbg !67

main_bb14:                                        ; preds = %main_bb13
  %"39" = sub nsw i64 %"37", 4294967295, !dbg !68
  %"40" = sub nsw i64 %"39", 1, !dbg !68
  %"41" = srem i64 %"40", 4294967296, !dbg !68
  br label %main_wrap_around.exit2, !dbg !68

main_bb15:                                        ; preds = %main_bb13
  %"42" = icmp slt i64 %"37", 0, !dbg !69
  br i1 %"42", label %main_bb16, label %main_wrap_around.exit2, !dbg !69

main_bb16:                                        ; preds = %main_bb15
  %"43" = sub nsw i64 0, %"37", !dbg !70
  %"44" = sub nsw i64 %"43", 1, !dbg !70
  %"45" = srem i64 %"44", 4294967296, !dbg !70
  %"46" = sub nsw i64 4294967295, %"45", !dbg !70
...
!48 = metadata !{i32 786689, metadata !4, metadata !"lower_bound", metadata !5, i32 33554439, metadata !8, i32 0, metadata !44} ; [ DW_TAG_arg_variable ] [lower_bound] [line 7]
!49 = metadata !{i32 7, i32 50, metadata !4, metadata !44}
!50 = metadata !{i64 4294967295}
!51 = metadata !{i32 786689, metadata !4, metadata !"upper_bound", metadata !5, i32 50331655, metadata !8, i32 0, metadata !44} ; [ DW_TAG_arg_variable ] [upper_bound] [line 7]
!52 = metadata !{i32 7, i32 73, metadata !4, metadata !44}
!53 = metadata !{i64 4294967296}
!54 = metadata !{i32 786688, metadata !4, metadata !"range", metadata !5, i32 8, metadata !8, i32 0, metadata !44} ; [ DW_TAG_auto_variable ] [range] [line 8]
!55 = metadata !{i32 8, i32 15, metadata !4, metadata !44} ; [ DW_TAG_imported_declaration ]
!56 = metadata !{i32 9, i32 9, metadata !25, metadata !44}
!57 = metadata !{i32 10, i32 9, metadata !27, metadata !44}
!58 = metadata !{i32 12, i32 14, metadata !29, metadata !44}
!59 = metadata !{i32 13, i32 9, metadata !31, metadata !44}
...
!65 = metadata !{i32 32, i32 16, metadata !66, null}
!66 = metadata !{i32 786443, metadata !1, metadata !9, i32 32, i32 1, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!67 = metadata !{i32 9, i32 9, metadata !25, metadata !65}
!68 = metadata !{i32 10, i32 9, metadata !27, metadata !65}
!69 = metadata !{i32 12, i32 14, metadata !29, metadata !65}
!70 = metadata !{i32 13, i32 9, metadata !31, metadata !65}
!71 = metadata !{i32 34, i32 17, metadata !9, null}
