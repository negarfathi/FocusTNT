...
main_bb7:
  ...
  br i1 %"12", label %main_bb18, label %main_bb8, !dbg !50
...
main_bb8:                                         ; preds = %main_bb16, %main_bb7, %main_bb17
  ...
  br i1 %"13", label %main_bb9, label %main_bb18, !dbg !52
...
main_read.exit:                                   ; preds = %main_bb9, %main_bb10, %main_bb11, %main_bb14
  ...
  %"25" = icmp sle i32 %.0.i, 0, !dbg !69
  br i1 %"25", label %main_bb15, label %main_bb17, !dbg !69

main_bb15:                                        ; preds = %main_read.exit
  %"26" = icmp eq i32 %.0.i, 0, !dbg !71
  br i1 %"26", label %main_bb16, label %main_bb18, !dbg !71

main_bb16:                                        ; preds = %main_bb15
  %"27" = add nsw i32 %tries.0, 1, !dbg !74
  %"28" = icmp slt i32 %tries.0, 5, !dbg !74
  br i1 %"28", label %main_bb8, label %main_bb18, !dbg !74

main_bb17:                                        ; preds = %main_read.exit
  %"29" = sub nsw i32 %count.0, %.0.i, !dbg !76
  %"30" = add nsw i32 %buf.0, %.0.i, !dbg !77
...
!52 = metadata !{i32 50, i32 5, metadata !53, null}
!53 = metadata !{i32 786443, metadata !1, metadata !9, i32 50, i32 5, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 13, i32 9, metadata !25, metadata !55}
!55 = metadata !{i32 52, i32 15, metadata !56, null}
!56 = metadata !{i32 786443, metadata !1, metadata !9, i32 51, i32 5, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
...
!70 = metadata !{i32 786443, metadata !1, metadata !56, i32 53, i32 13, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 55, i32 17, metadata !72, null}
!72 = metadata !{i32 786443, metadata !1, metadata !73, i32 55, i32 17, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!73 = metadata !{i32 786443, metadata !1, metadata !70, i32 54, i32 9, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!74 = metadata !{i32 55, i32 17, metadata !75, null}
!75 = metadata !{i32 786443, metadata !1, metadata !72, i32 55, i32 17, i32 1, i32 16} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!76 = metadata !{i32 59, i32 9, metadata !56, null}
!77 = metadata !{i32 60, i32 9, metadata !56, null}
!78 = metadata !{i32 61, i32 5, metadata !56, null}
!79 = metadata !{i32 63, i32 1, metadata !9, null}
