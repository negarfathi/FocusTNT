...
main_bb21:
  ...
  br i1 %or.cond, label %main_bb48, label %main_wrap_around.exit2, !dbg !89

main_wrap_around.exit2:                           ; preds = %main_bb47, %main_bb46, %main_bb45, %main_wrap_around.exit4, %main_bb21
  %errno.0 = phi i64 [ 0, %main_bb21 ], [ %.0.i3, %main_wrap_around.exit4 ], [ %errno.0, %main_bb45 ], [ %errno.0, %main_bb46 ], [ %errno.0, %main_bb47 ]
  %pos.0 = phi i64 [ 0, %main_bb21 ], [ %pos.0, %main_wrap_around.exit4 ], [ %"127", %main_bb45 ], [ %"132", %main_bb47 ], [ %"122", %main_bb46 ]
  %"56" = icmp slt i64 %pos.0, %"53", !dbg !93
  br i1 %"56", label %main_bb22, label %main_bb48, !dbg !93
...
main_read.exit:                                   ; preds = %main_wrap_around.exit, %main_wrap_around.exit2.i, %main_bb26, %main_bb39
  %.0.i5 = phi i64 [ %.0.i3.i, %main_bb39 ], [ 0, %main_wrap_around.exit ], [ -1, %main_bb26 ], [ %count.0.i, %main_wrap_around.exit2.i ], !dbg !102
  %"109" = icmp eq i64 %.0.i5, -1, !dbg !126
  br i1 %"109", label %main_bb40, label %main_bb44, !dbg !126

main_bb40:                                        ; preds = %main_read.exit
  %"110" = add nsw i64 %errno.0, 1, !dbg !128
  %"111" = icmp sgt i64 %"110", 2147483647, !dbg !130
  br i1 %"111", label %main_bb41, label %main_bb42, !dbg !130

main_bb41:                                        ; preds = %main_bb40
  %"112" = sub nsw i64 %"110", 2147483647, !dbg !131
  %"113" = sub nsw i64 %"112", 1, !dbg !131
  %"114" = srem i64 %"113", 4294967296, !dbg !131
  %"115" = add nsw i64 -2147483648, %"114", !dbg !131
  br label %main_wrap_around.exit4, !dbg !131

main_bb42:                                        ; preds = %main_bb40
  %"116" = icmp slt i64 %"110", -2147483648, !dbg !132
  br i1 %"116", label %main_bb43, label %main_wrap_around.exit4, !dbg !132

main_bb43:                                        ; preds = %main_bb42
  %"117" = sub nsw i64 -2147483648, %"110", !dbg !133
  %"118" = sub nsw i64 %"117", 1, !dbg !133
  %"119" = srem i64 %"118", 4294967296, !dbg !133
  %"120" = sub nsw i64 2147483647, %"119", !dbg !133
  br label %main_wrap_around.exit4, !dbg !133

main_wrap_around.exit4:                           ; preds = %main_bb41, %main_bb42, %main_bb43
  %.0.i3 = phi i64 [ %"115", %main_bb41 ], [ %"120", %main_bb43 ], [ %"110", %main_bb42 ], !dbg !128
  %"121" = icmp eq i64 %.0.i3, 5, !dbg !134
  br i1 %"121", label %main_bb48, label %main_wrap_around.exit2, !dbg !134

main_bb44:                                        ; preds = %main_read.exit
  %"122" = add nsw i64 %pos.0, %.0.i5, !dbg !136
  %"123" = icmp sgt i64 %"122", 2147483647, !dbg !137
  br i1 %"123", label %main_bb45, label %main_bb46, !dbg !137

main_bb45:                                        ; preds = %main_bb44
  %"124" = sub nsw i64 %"122", 2147483647, !dbg !138
  %"125" = sub nsw i64 %"124", 1, !dbg !138
  %"126" = srem i64 %"125", 4294967296, !dbg !138
  %"127" = add nsw i64 -2147483648, %"126", !dbg !138
  br label %main_wrap_around.exit2, !dbg !138

main_bb46:                                        ; preds = %main_bb44
  %"128" = icmp slt i64 %"122", -2147483648, !dbg !139
  br i1 %"128", label %main_bb47, label %main_wrap_around.exit2, !dbg !139

main_bb47:                                        ; preds = %main_bb46
  %"129" = sub nsw i64 -2147483648, %"122", !dbg !140
  %"130" = sub nsw i64 %"129", 1, !dbg !140
  %"131" = srem i64 %"130", 4294967296, !dbg !140
  %"132" = sub nsw i64 2147483647, %"131", !dbg !140
  br label %main_wrap_around.exit2, !dbg !140

main_bb48:                                        ; preds = %main_wrap_around.exit2, %main_wrap_around.exit4, %main_bb21
  ret i32 0, !dbg !141
}
...
!50 = metadata !{i32 55, i32 26, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !9, i32 54, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!52 = metadata !{i32 56, i32 13, metadata !53, null}
!53 = metadata !{i32 786443, metadata !1, metadata !51, i32 56, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!54 = metadata !{i32 62, i32 17, metadata !55, null}
!55 = metadata !{i32 786443, metadata !1, metadata !56, i32 62, i32 17, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!56 = metadata !{i32 786443, metadata !1, metadata !53, i32 61, i32 9, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!57 = metadata !{i32 64, i32 24, metadata !58, null}
!58 = metadata !{i32 786443, metadata !1, metadata !55, i32 63, i32 1, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!59 = metadata !{i32 38, i32 9, metadata !31, metadata !57}
!60 = metadata !{i32 39, i32 9, metadata !33, metadata !57}
!61 = metadata !{i32 41, i32 14, metadata !35, metadata !57}
!62 = metadata !{i32 42, i32 9, metadata !37, metadata !57}
!63 = metadata !{i32 66, i32 19, metadata !56, null}
!64 = metadata !{i32 67, i32 22, metadata !56, null}
!65 = metadata !{i32 38, i32 9, metadata !31, metadata !64}
!66 = metadata !{i32 39, i32 9, metadata !33, metadata !64}
!67 = metadata !{i32 41, i32 14, metadata !35, metadata !64}
!68 = metadata !{i32 42, i32 9, metadata !37, metadata !64}
!69 = metadata !{i32 68, i32 17, metadata !70, null}
!70 = metadata !{i32 786443, metadata !1, metadata !56, i32 68, i32 17, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!71 = metadata !{i32 70, i32 24, metadata !72, null}
!72 = metadata !{i32 786443, metadata !1, metadata !70, i32 69, i32 13, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!73 = metadata !{i32 38, i32 9, metadata !31, metadata !71}
!74 = metadata !{i32 39, i32 9, metadata !33, metadata !71}
!75 = metadata !{i32 41, i32 14, metadata !35, metadata !71}
!76 = metadata !{i32 42, i32 9, metadata !37, metadata !71}
!77 = metadata !{i32 75, i32 17, metadata !78, null}
!78 = metadata !{i32 786443, metadata !1, metadata !70, i32 74, i32 13, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!79 = metadata !{i32 76, i32 17, metadata !78, null}
!80 = metadata !{i32 81, i32 1, metadata !9, null}
!81 = metadata !{i32 786688, metadata !12, metadata !"pos", metadata !5, i32 84, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [pos] [line 84]
!82 = metadata !{i32 84, i32 15, metadata !12, null}
!83 = metadata !{i32 85, i32 22, metadata !12, null}
!84 = metadata !{i32 786688, metadata !12, metadata !"size", metadata !5, i32 85, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [size] [line 85]
!85 = metadata !{i32 85, i32 15, metadata !12, null}
!86 = metadata !{i32 86, i32 5, metadata !12, null}
!87 = metadata !{i32 786688, metadata !12, metadata !"errno", metadata !5, i32 87, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [errno] [line 87]
!88 = metadata !{i32 87, i32 15, metadata !12, null}
!89 = metadata !{i32 88, i32 9, metadata !90, null}
!90 = metadata !{i32 786443, metadata !1, metadata !12, i32 88, i32 9, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!91 = metadata !{i32 88, i32 9, metadata !92, null}
!92 = metadata !{i32 786443, metadata !1, metadata !90, i32 88, i32 9, i32 1, i32 23} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!93 = metadata !{i32 92, i32 5, metadata !94, null}
!94 = metadata !{i32 786443, metadata !1, metadata !12, i32 92, i32 5, i32 1, i32 24} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!95 = metadata !{i32 94, i32 35, metadata !96, null}
!96 = metadata !{i32 786443, metadata !1, metadata !12, i32 93, i32 5, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!97 = metadata !{i32 38, i32 9, metadata !31, metadata !95}
!98 = metadata !{i32 39, i32 9, metadata !33, metadata !95}
!99 = metadata !{i32 41, i32 14, metadata !35, metadata !95}
!100 = metadata !{i32 42, i32 9, metadata !37, metadata !95}
!101 = metadata !{i32 49, i32 9, metadata !47, metadata !102}
!102 = metadata !{i32 94, i32 24, metadata !96, null}
!103 = metadata !{i32 53, i32 5, metadata !49, metadata !102}
!104 = metadata !{i32 55, i32 26, metadata !51, metadata !102}
!105 = metadata !{i32 56, i32 13, metadata !53, metadata !102}
!106 = metadata !{i32 62, i32 17, metadata !55, metadata !102}
!107 = metadata !{i32 64, i32 24, metadata !58, metadata !102}
!108 = metadata !{i32 38, i32 9, metadata !31, metadata !107}
!109 = metadata !{i32 39, i32 9, metadata !33, metadata !107}
!110 = metadata !{i32 41, i32 14, metadata !35, metadata !107}
!111 = metadata !{i32 42, i32 9, metadata !37, metadata !107}
!112 = metadata !{i32 66, i32 19, metadata !56, metadata !102}
!113 = metadata !{i32 67, i32 22, metadata !56, metadata !102}
!114 = metadata !{i32 38, i32 9, metadata !31, metadata !113}
!115 = metadata !{i32 39, i32 9, metadata !33, metadata !113}
!116 = metadata !{i32 41, i32 14, metadata !35, metadata !113}
!117 = metadata !{i32 42, i32 9, metadata !37, metadata !113}
!118 = metadata !{i32 68, i32 17, metadata !70, metadata !102}
!119 = metadata !{i32 70, i32 24, metadata !72, metadata !102}
!120 = metadata !{i32 38, i32 9, metadata !31, metadata !119}
!121 = metadata !{i32 39, i32 9, metadata !33, metadata !119}
!122 = metadata !{i32 41, i32 14, metadata !35, metadata !119}
!123 = metadata !{i32 42, i32 9, metadata !37, metadata !119}
!124 = metadata !{i32 75, i32 17, metadata !78, metadata !102}
!125 = metadata !{i32 76, i32 17, metadata !78, metadata !102}
!126 = metadata !{i32 95, i32 13, metadata !127, null}
!127 = metadata !{i32 786443, metadata !1, metadata !96, i32 95, i32 13, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!128 = metadata !{i32 97, i32 22, metadata !129, null}
!129 = metadata !{i32 786443, metadata !1, metadata !127, i32 96, i32 9, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!130 = metadata !{i32 38, i32 9, metadata !31, metadata !128}
!131 = metadata !{i32 39, i32 9, metadata !33, metadata !128}
!132 = metadata !{i32 41, i32 14, metadata !35, metadata !128}
!133 = metadata !{i32 42, i32 9, metadata !37, metadata !128}
!134 = metadata !{i32 98, i32 17, metadata !135, null}
!135 = metadata !{i32 786443, metadata !1, metadata !129, i32 98, i32 17, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!136 = metadata !{i32 104, i32 15, metadata !96, null}
!137 = metadata !{i32 38, i32 9, metadata !31, metadata !136}
!138 = metadata !{i32 39, i32 9, metadata !33, metadata !136}
!139 = metadata !{i32 41, i32 14, metadata !35, metadata !136}
!140 = metadata !{i32 42, i32 9, metadata !37, metadata !136}
!141 = metadata !{i32 107, i32 1, metadata !12, null}
