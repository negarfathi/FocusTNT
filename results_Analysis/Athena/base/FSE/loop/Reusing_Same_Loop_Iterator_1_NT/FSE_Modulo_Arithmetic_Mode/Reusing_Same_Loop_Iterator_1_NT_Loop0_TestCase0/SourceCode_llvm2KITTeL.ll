...
main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  %i.0 = phi i64 [ 0, %main_bb5 ], [ %"32", %main_bb11 ], [ %"37", %main_bb13 ], [ %"18", %main_bb12 ]
...
main_wrap_around.exit:                            ; preds = %main_bb9, %main_bb8, %main_bb7, %main_wrap_around.exit2
  ...
  %"17" = icmp slt i64 %i.1, %"13", !dbg !48
  %"18" = add nsw i64 %i.1, 1, !dbg !53
...
main_bb10:                                        ; preds = %main_wrap_around.exit
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !58), !dbg !60
  ...
  br i1 %"19", label %main_bb11, label %main_bb12, !dbg !70

main_bb11:                                        ; preds = %main_bb10
  %"29" = sub nsw i64 %"18", 2147483647, !dbg !71
  %"30" = sub nsw i64 %"29", 1, !dbg !71
  %"31" = srem i64 %"30", 4294967296, !dbg !71
  %"32" = add nsw i64 -2147483648, %"31", !dbg !71
  br label %main_wrap_around.exit2, !dbg !71

main_bb12:                                        ; preds = %main_bb10
  %"33" = icmp slt i64 %"18", -2147483648, !dbg !72
  br i1 %"33", label %main_bb13, label %main_wrap_around.exit2, !dbg !72

main_bb13:                                        ; preds = %main_bb12
  %"34" = sub nsw i64 -2147483648, %"18", !dbg !73
  %"35" = sub nsw i64 %"34", 1, !dbg !73
  %"36" = srem i64 %"35", 4294967296, !dbg !73
  %"37" = sub nsw i64 2147483647, %"36", !dbg !73
