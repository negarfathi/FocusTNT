...
main_bb5:
  ...
  %"13" = icmp slt i64 %"12", 0, !dbg !37
  br i1 %"13", label %main_bb11, label %main_bb6, !dbg !37

main_bb6:                                         ; preds = %main_bb5
  %"14" = call i64 @__VERIFIER_nondet_int(), !dbg !39
  call void @llvm.dbg.value(metadata !{i64 %"14"}, i64 0, metadata !40), !dbg !41
  call void @llvm.dbg.value(metadata !{i64 %h.0}, i64 0, metadata !35), !dbg !36
  call void @llvm.dbg.value(metadata !{i64 %"18"}, i64 0, metadata !42), !dbg !45
...
main_wrap_around.exit:                            ; preds = %main_bb10, %main_bb9, %main_bb8, %main_bb6
  ...
  %"15" = icmp ne i64 %linesToRead.0, 0, !dbg !56
  %"16" = icmp sgt i64 %h.0, 0, !dbg !58
  %. = select i1 %"15", i1 %"16", i1 false, !dbg !56
  br i1 %., label %main_bb7, label %main_bb11, !dbg !60

main_bb7:                                         ; preds = %main_wrap_around.exit
  %"17" = icmp sgt i64 %linesToRead.0, %h.0, !dbg !62
  %h.0.linesToRead.0 = select i1 %"17", i64 %h.0, i64 %linesToRead.0, !dbg !62
  %"18" = sub nsw i64 %h.0, %h.0.linesToRead.0, !dbg !43
  %"19" = icmp sgt i64 %"18", 2147483647, !dbg !64
  br i1 %"19", label %main_bb8, label %main_bb9, !dbg !64
...
main_bb9:                                         ; preds = %main_bb7
  ...
  br i1 %"24", label %main_bb10, label %main_wrap_around.exit, !dbg !66
...
!34 = metadata !{i32 24, i32 29, metadata !9, null}
!35 = metadata !{i32 786688, metadata !9, metadata !"linesToRead", metadata !5, i32 24, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [linesToRead] [line 24]
...
!39 = metadata !{i32 29, i32 19, metadata !9, null}
!40 = metadata !{i32 786688, metadata !9, metadata !"h", metadata !5, i32 29, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [h] [line 29]
!41 = metadata !{i32 29, i32 15, metadata !9, null}
!42 = metadata !{i32 786689, metadata !4, metadata !"value", metadata !5, i32 16777227, metadata !8, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [value] [line 11]
!43 = metadata !{i32 36, i32 13, metadata !44, null}
!44 = metadata !{i32 786443, metadata !1, metadata !9, i32 31, i32 5, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!45 = metadata !{i32 11, i32 33, metadata !4, metadata !43}
...
!55 = metadata !{i32 30, i32 5, metadata !9, null}
!56 = metadata !{i32 30, i32 5, metadata !57, null}
!57 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 5, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!58 = metadata !{i32 30, i32 5, metadata !59, null}
!59 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 5, i32 2, i32 10} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!60 = metadata !{i32 30, i32 5, metadata !61, null}
!61 = metadata !{i32 786443, metadata !1, metadata !9, i32 30, i32 5, i32 3, i32 11} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!62 = metadata !{i32 32, i32 13, metadata !63, null}
!63 = metadata !{i32 786443, metadata !1, metadata !44, i32 32, i32 13, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!64 = metadata !{i32 13, i32 9, metadata !26, metadata !43}
!65 = metadata !{i32 14, i32 9, metadata !28, metadata !43}
!66 = metadata !{i32 16, i32 14, metadata !30, metadata !43}
!67 = metadata !{i32 17, i32 9, metadata !32, metadata !43}
!68 = metadata !{i32 40, i32 1, metadata !9, null}
