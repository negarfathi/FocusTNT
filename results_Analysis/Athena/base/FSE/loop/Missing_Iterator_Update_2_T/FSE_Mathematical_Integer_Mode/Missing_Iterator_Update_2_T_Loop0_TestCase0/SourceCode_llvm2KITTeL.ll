...
main_mdb_cursor_get.exit:                         ; preds = %main_bb3, %main_bb4
  ...
  call void @llvm.dbg.value(metadata !{i32 %"15"}, i64 0, metadata !38) #3, !dbg !43
  call void @llvm.dbg.value(metadata !{i32 %"15"}, i64 0, metadata !44) #3, !dbg !46
  br label %main_mdb_cursor_get.exit3, !dbg !47
...
main_mdb_cursor_get.exit3:                        ; preds = %main_bb9, %main_bb8, %main_bb7, %main_bb6, %main_mdb_cursor_get.exit
  ...
  %"13" = icmp eq i32 %rc.0, 0, !dbg !48
  br i1 %"13", label %main_bb5, label %main_bb10, !dbg !48

main_bb5:                                         ; preds = %main_mdb_cursor_get.exit3
  %"14" = icmp sle i32 %"12", 0, !dbg !50
  %"15" = call i32 @__VERIFIER_nondet_int() #3, !dbg !51
  %"16" = load i32* @"'flag", align 4, !dbg !52
  %"17" = add nsw i32 %"16", 1, !dbg !52
  store i32 %"17", i32* @"'flag", align 4, !dbg !52
  %"18" = load i32* @"'flag", align 4, !dbg !53
  %"19" = icmp sgt i32 %"18", 1000, !dbg !53
  br i1 %"14", label %main_bb6, label %main_bb8, !dbg !50

main_bb6:                                         ; preds = %main_bb5
  br i1 %"19", label %main_mdb_cursor_get.exit3, label %main_bb7, !dbg !53

main_bb7:                                         ; preds = %main_bb6
  %"20" = icmp sge i32 %"15", 0, !dbg !54
  %..i1 = select i1 %"20", i32 0, i32 1, !dbg !55
  br label %main_mdb_cursor_get.exit3, !dbg !55

main_bb8:                                         ; preds = %main_bb5
  br i1 %"19", label %main_mdb_cursor_get.exit3, label %main_bb9, !dbg !56

main_bb9:                                         ; preds = %main_bb8
  %"21" = icmp sge i32 %"15", 0, !dbg !57
  %..i4 = select i1 %"21", i32 0, i32 1, !dbg !58
  br label %main_mdb_cursor_get.exit3, !dbg !58
...
!39 = metadata !{i32 31, i32 18, metadata !40, null}
!40 = metadata !{i32 786443, metadata !1, metadata !41, i32 30, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!41 = metadata !{i32 786443, metadata !1, metadata !42, i32 29, i32 13, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!42 = metadata !{i32 786443, metadata !1, metadata !9, i32 28, i32 5, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!43 = metadata !{i32 12, i32 9, metadata !4, metadata !39}
!44 = metadata !{i32 786688, metadata !4, metadata !"i", metadata !5, i32 12, metadata !8, i32 0, metadata !45} ; [ DW_TAG_auto_variable ] [i] [line 12]
!45 = metadata !{i32 34, i32 14, metadata !42, null}
!46 = metadata !{i32 12, i32 9, metadata !4, metadata !45}
!47 = metadata !{i32 27, i32 5, metadata !9, null}
!48 = metadata !{i32 27, i32 5, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !9, i32 27, i32 5, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [//FILES_DIR/SourceCode_SemanticAugmentor.c]
!50 = metadata !{i32 29, i32 13, metadata !41, null}
!51 = metadata !{i32 12, i32 14, metadata !4, metadata !39}
!52 = metadata !{i32 13, i32 5, metadata !4, metadata !39}
!53 = metadata !{i32 14, i32 9, metadata !20, metadata !39}
!54 = metadata !{i32 16, i32 9, metadata !22, metadata !39}
!55 = metadata !{i32 17, i32 9, metadata !22, metadata !39}
!56 = metadata !{i32 14, i32 9, metadata !20, metadata !45}
!57 = metadata !{i32 16, i32 9, metadata !22, metadata !45}
!58 = metadata !{i32 17, i32 9, metadata !22, metadata !45}
!59 = metadata !{i32 36, i32 5, metadata !9, null}
