...
main_bb5:
  ...
  call void @llvm.dbg.value(metadata !{i64 %"27"}, i64 0, metadata !58), !dbg !61
...
main_wrap_around.exit2:                           ; preds = %main_bb13, %main_bb12, %main_bb11, %main_bb5
  ...
  %"15" = icmp slt i64 %ui.0, %., !dbg !69
  br i1 %"15", label %main_bb6, label %main_.critedge, !dbg !69
...
main_wrap_around.exit:                            ; preds = %main_bb7, %main_bb8, %main_bb9
  %.0.i = phi i64 [ %"20", %main_bb7 ], [ %"25", %main_bb9 ], [ %"16", %main_bb8 ], !dbg !46
  %"26" = icmp sgt i64 %.0.i, %ui.0, !dbg !46
  br i1 %"26", label %main_bb10, label %main_.critedge, !dbg !75

main_bb10:                                        ; preds = %main_wrap_around.exit
  %"27" = mul nsw i64 %ui.0, 2, !dbg !59
  %"28" = icmp sgt i64 %"27", 4294967295, !dbg !77
  br i1 %"28", label %main_bb11, label %main_bb12, !dbg !77

main_bb11:                                        ; preds = %main_bb10
  %"29" = sub nsw i64 %"27", 4294967295, !dbg !78
  %"30" = sub nsw i64 %"29", 1, !dbg !78
  %"31" = srem i64 %"30", 4294967296, !dbg !78
  br label %main_wrap_around.exit2, !dbg !78

main_bb12:                                        ; preds = %main_bb10
  %"32" = icmp slt i64 %"27", 0, !dbg !79
  br i1 %"32", label %main_bb13, label %main_wrap_around.exit2, !dbg !79

main_bb13:                                        ; preds = %main_bb12
  %"33" = sub nsw i64 0, %"27", !dbg !80
  %"34" = sub nsw i64 %"33", 1, !dbg !80
  %"35" = srem i64 %"34", 4294967296, !dbg !80
  %"36" = sub nsw i64 4294967295, %"35", !dbg !80
