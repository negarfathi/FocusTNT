...
main_bb5:
  ...
  %"15" = icmp slt i64 %"12", -1, !dbg !43
  %"16" = icmp sle i64 %"13", 0, !dbg !45
  %or.cond = or i1 %"15", %"16", !dbg !43
  %"17" = icmp slt i64 %"14", 0, !dbg !47
...
main_wrap_around.exit2:                           ; preds = %main_bb15, %main_bb14, %main_bb13, %main_bb5
  ...
  %buffer_bytes_left.0 = phi i64 [ %"14", %main_bb5 ], [ %"48", %main_bb13 ], [ %"53", %main_bb15 ], [ %"43", %main_bb14 ]
  %"18" = sdiv i64 %size.0, 2, !dbg !49
  %"19" = icmp sgt i64 %"18", 2147483647, !dbg !50
  br i1 %"19", label %main_bb6, label %main_bb7, !dbg !50

main_bb6:                                         ; preds = %main_wrap_around.exit2
  %"20" = sub nsw i64 %"18", 2147483647, !dbg !51
  %"21" = sub nsw i64 %"20", 1, !dbg !51
  %"22" = srem i64 %"21", 4294967296, !dbg !51
  %"23" = add nsw i64 -2147483648, %"22", !dbg !51
  br label %main_wrap_around.exit, !dbg !51

main_bb7:                                         ; preds = %main_wrap_around.exit2
  %"24" = icmp slt i64 %"18", -2147483648, !dbg !52
  br i1 %"24", label %main_bb8, label %main_wrap_around.exit, !dbg !52

main_bb8:                                         ; preds = %main_bb7
  %"25" = sub nsw i64 -2147483648, %"18", !dbg !53
  %"26" = sub nsw i64 %"25", 1, !dbg !53
  %"27" = srem i64 %"26", 4294967296, !dbg !53
  %"28" = sub nsw i64 2147483647, %"27", !dbg !53
  br label %main_wrap_around.exit, !dbg !53

main_wrap_around.exit:                            ; preds = %main_bb6, %main_bb7, %main_bb8
  %.0.i = phi i64 [ %"23", %main_bb6 ], [ %"28", %main_bb8 ], [ %"18", %main_bb7 ], !dbg !49
  %"29" = icmp slt i64 %buffer_bytes_left.0, %.0.i, !dbg !49
  br i1 %"29", label %main_bb9, label %main_bb16, !dbg !49

main_bb9:                                         ; preds = %main_wrap_around.exit
  %"30" = mul nsw i64 %size.0, 2, !dbg !54
  %"31" = icmp sgt i64 %"30", 2147483647, !dbg !56
  br i1 %"31", label %main_bb10, label %main_bb11, !dbg !56

main_bb10:                                        ; preds = %main_bb9
  %"32" = sub nsw i64 %"30", 2147483647, !dbg !57
  %"33" = sub nsw i64 %"32", 1, !dbg !57
  %"34" = srem i64 %"33", 4294967296, !dbg !57
  %"35" = add nsw i64 -2147483648, %"34", !dbg !57
  br label %main_wrap_around.exit4, !dbg !57

main_bb11:                                        ; preds = %main_bb9
  %"36" = icmp slt i64 %"30", -2147483648, !dbg !58
  br i1 %"36", label %main_bb12, label %main_wrap_around.exit4, !dbg !58

main_bb12:                                        ; preds = %main_bb11
  %"37" = sub nsw i64 -2147483648, %"30", !dbg !59
  %"38" = sub nsw i64 %"37", 1, !dbg !59
  %"39" = srem i64 %"38", 4294967296, !dbg !59
  %"40" = sub nsw i64 2147483647, %"39", !dbg !59
  br label %main_wrap_around.exit4, !dbg !59

main_wrap_around.exit4:                           ; preds = %main_bb10, %main_bb11, %main_bb12
  %.0.i3 = phi i64 [ %"35", %main_bb10 ], [ %"40", %main_bb12 ], [ %"30", %main_bb11 ], !dbg !54
  %"41" = icmp ne i64 %"12", -1, !dbg !60
  %"42" = icmp sgt i64 %.0.i3, %"12", !dbg !62
  %or.cond6 = and i1 %"41", %"42", !dbg !60
  %size.1 = select i1 %or.cond6, i64 %"12", i64 %.0.i3, !dbg !60
  %"43" = sub nsw i64 %size.1, %"13", !dbg !64
  %"44" = icmp sgt i64 %"43", 2147483647, !dbg !65
  br i1 %"44", label %main_bb13, label %main_bb14, !dbg !65
...
main_bb14:                                        ; preds = %main_wrap_around.exit4
  ...
  br i1 %"49", label %main_bb15, label %main_wrap_around.exit2, !dbg !67
...
!34 = metadata !{i32 24, i32 30, metadata !9, null}
...
!37 = metadata !{i32 25, i32 36, metadata !9, null}
...
!40 = metadata !{i32 26, i32 35, metadata !9, null}
