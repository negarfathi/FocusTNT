...
STATE USEFIRST ARG13 :
    MATCH "[!(num > 65534)]" -> ASSUME {num == (50);} GOTO ARG20;
    TRUE -> STOP;
...
STATE USEFIRST ARG42 :
    MATCH "i++" -> ASSUME {i == (2);} GOTO ARG43;
    TRUE -> STOP;

STATE USEFIRST ARG43 :
    MATCH "[i < 3]" -> ASSUME {i == (2);} GOTO ARG52;
    TRUE -> STOP;
...
STATE USEFIRST ARG53 :
    MATCH "i++" -> ASSUME {i == (3);} GOTO ARG61;
    TRUE -> STOP;

STATE USEFIRST ARG61 :
    MATCH "[!(i < 3)]" -> ASSUME {i == (3);} GOTO ARG66;
    TRUE -> STOP;
...
STATE USEFIRST ARG67 :
    MATCH "i++" -> ASSUME {i == (4);} GOTO ARG72;
    TRUE -> STOP;

STATE USEFIRST ARG72 :
    MATCH "[i < num]" -> ASSUME {i == (4);num == (50);} GOTO ARG75;
    TRUE -> STOP;
