...
STATE USEFIRST ARG19 :
    MATCH "[!(num_output > 65534)]" -> ASSUME {num_output == (10);} GOTO ARG26;
    TRUE -> STOP;
...
STATE USEFIRST ARG62 :
    MATCH "[i < num_output]" -> ASSUME {i == (2);num_output == (10);} GOTO ARG70;
    TRUE -> STOP;
...
STATE USEFIRST ARG78 :
    MATCH "[i < num_output]" -> ASSUME {i == (3);num_output == (10);} GOTO ARG83;
    TRUE -> STOP;
...
STATE USEFIRST ARG126 :
    MATCH "[!(i < num_output)]" -> ASSUME {i == (10);num_output == (10);} GOTO ARG128;
    TRUE -> STOP;

STATE USEFIRST ARG128 :
    MATCH "i ++;" -> ASSUME {__CPAchecker_TMP_1 == (10);} GOTO ARG129;
    TRUE -> STOP;
