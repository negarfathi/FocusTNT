...
STATE USEFIRST ARG78 :
    MATCH "[i < num_output]" -> ASSUME {i == (3);num_output == (50);} GOTO ARG82;
    TRUE -> STOP;

STATE USEFIRST ARG82 :
    MATCH "i ++;" -> ASSUME {__CPAchecker_TMP_0 == (3);} GOTO ARG85;
    TRUE -> STOP;
...
STATE USEFIRST ARG101 :
    MATCH "[i < num_output]" -> ASSUME {i == (5);num_output == (50);} GOTO ARG102;
    TRUE -> STOP;
...
STATE USEFIRST ARG126 :
    MATCH "[i < num_output]" -> ASSUME {i == (10);num_output == (50);} GOTO ARG128;
    TRUE -> STOP;

STATE USEFIRST ARG128 :
    MATCH "i ++;" -> ASSUME {__CPAchecker_TMP_0 == (10);} GOTO ARG129;
    TRUE -> STOP;
...
STATE USEFIRST ARG132 :
    MATCH "[i < num_output]" -> ASSUME {i == (11);num_output == (50);} GOTO ARG133;
    TRUE -> STOP;

STATE USEFIRST ARG133 :
    MATCH "i ++;" -> ASSUME {__CPAchecker_TMP_0 == (11);} GOTO ARG134;
    TRUE -> STOP;
