...
STATE USEFIRST ARG16 :
    MATCH "int matroska = 6;" -> ASSUME {matroska == (6);} GOTO ARG19;
    TRUE -> STOP;
...
STATE USEFIRST ARG88 :
    MATCH "[!(res == 0)]" -> ASSUME {res == (2);} GOTO ARG140;
    TRUE -> STOP;
...
STATE USEFIRST ARG145 :
    MATCH "tmpVar0 = matroska_deliver_packet_slice_1(matroska);" -> GOTO ARG148;
    TRUE -> STOP;

STATE USEFIRST ARG148 :
    MATCH "" -> ASSUME {q == (6);} GOTO ARG151;
    TRUE -> STOP;
...
STATE USEFIRST ARG152 :
    MATCH "[!(q == 1)]" -> ASSUME {q == (6);} GOTO ARG159;
    TRUE -> STOP;
