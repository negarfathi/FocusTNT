...
STATE USEFIRST ARG6 :
    MATCH "int needed = 1073741824;" -> ASSUME {needed == (1073741824);} GOTO ARG12;
    TRUE -> STOP;
...
STATE USEFIRST ARG18 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (2);needed == (1073741824);} GOTO ARG36;
    TRUE -> STOP;
...
STATE USEFIRST ARG75 :
    MATCH "[smallest <= needed]" -> ASSUME {smallest == (1024);needed == (1073741824);} GOTO ARG76;
    TRUE -> STOP;
